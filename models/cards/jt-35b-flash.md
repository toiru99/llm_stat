...
is_reasoning: false
radar:
  knowledge: { s: 45.7, z: 0.25, r: 53.7, estimated: false }  # 전문 지식
  reasoning: { s: 32.2, z: -0.08, r: 48.8, estimated: false }  # 추론
  coding: { s: 46.9, z: 0.02, r: 50.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 53.7 | +0.25 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 48.8 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 50.4 | +0.02 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
