...
radar:
  ...
  coding: { s: 46.9, z: -0.07, r: 49.0, estimated: false }  # 코딩
  agentic: { s: 72.0, z: 1.35, r: 70.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 51.1 | +0.08 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 47.1 | -0.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 49.0 | -0.07 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 70.2 | +1.35 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
