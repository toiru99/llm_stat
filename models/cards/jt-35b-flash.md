...
radar:
  ...
  reasoning: { s: 32.2, z: -0.08, r: 48.7, estimated: false }  # 추론
  coding: { s: 46.9, z: 0.02, r: 50.2, estimated: false }  # 코딩
...
| 추론 | 48.7 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 50.2 | +0.02 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 70.8 | +1.39 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
