...
radar:
  ...
  agentic: { s: 36.3, z: -0.59, r: 41.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.15 · 혼합 $0.11/1M · 43.0 t/s · TTFT 1.77s · 262k ctx` · 가성비 190.9
...
| 에이전트 | 41.1 | -0.59 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
