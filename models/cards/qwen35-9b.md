...
radar:
  ...
  agentic: { s: 44.7, z: -0.29, r: 45.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.15 · 혼합 $0.11/1M · 58.0 t/s · TTFT 1.85s · 262k ctx` · 가성비 227.3
...
| 에이전트 | 45.7 | -0.29 | 실측 | [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
