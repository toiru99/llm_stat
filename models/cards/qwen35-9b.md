...
radar:
  ...
  coding: { s: 43.8, z: -0.75, r: 38.8, estimated: false }  # 코딩
  agentic: { s: 40.7, z: -0.46, r: 43.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 77.5, z: 0.37, r: 55.5, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.1 · 출력 $0.15 · 혼합 $0.11/1M · 58.0 t/s · TTFT 1.75s · 262k ctx` · 가성비 190.9
...
| 코딩 | 38.8 | -0.75 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 43.0 | -0.46 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
| 신뢰성 | 41.7 | -0.55 | 실측 | [[aa-omniscience]] 19.0%×1.0 |
| 멀티모달 | 48.6 | -0.09 | 실측 | [[mmmu-pro]] 69.0%×1.0 |
| 긴문맥 | 54.6 | +0.31 | 실측 | [[aa-lcr]] 59.0%×1.0 |
| 지시 따르기 | 55.5 | +0.37 | 실측 | [[ifbench]] 67.0%×1.0 |
