...
radar:
  ...
  reasoning: { s: 35.9, z: 0.12, r: 51.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.15 · 혼합 $0.11/1M · 56.0 t/s · TTFT 1.77s · 262k ctx` · 가성비 190.9
...
| 추론 | 51.7 | +0.12 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 48.1 | -0.13 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
