...
radar:
  ...
  reasoning: { s: 36.5, z: 0.04, r: 50.6, estimated: false }  # 추론
  coding: { s: 43.2, z: -0.22, r: 46.7, estimated: false }  # 코딩
  agentic: { s: 37.1, z: -0.0, r: 49.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.2 · 혼합 $0.1415/1M · 82.0 t/s · TTFT 1.82s · 262k ctx` · 가성비 155.5
...
| 추론 | 50.6 | +0.04 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 46.7 | -0.22 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 49.9 | +-0.0 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
