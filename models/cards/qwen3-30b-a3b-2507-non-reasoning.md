...
is_reasoning: false
radar:
  knowledge: { s: 30.3, z: -0.51, r: 42.3, estimated: false }  # 전문 지식
...
Alibaba · Open · Small(30.5B) · 컨텍스트 262k · 종합지능 **3.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 150.0 t/s · TTFT 2.08s · 262k ctx` · 가성비 11.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.3 | -0.51 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
