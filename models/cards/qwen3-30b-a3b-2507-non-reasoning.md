...
is_reasoning: false
radar:
  knowledge: { s: 30.5, z: -0.49, r: 42.7, estimated: false }  # 전문 지식
  reasoning: { s: 25.4, z: -0.45, r: 43.2, estimated: false }  # 추론
  coding: { s: 35.3, z: -0.48, r: 42.7, estimated: false }  # 코딩
  agentic: { s: 9.6, z: -1.07, r: 33.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 137.0 t/s · TTFT 1.88s · 262k ctx` · 가성비 34.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.7 | -0.49 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.2 | -0.45 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 42.7 | -0.48 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 33.9 | -1.07 | 실측 | [[tau2-bench]] 10.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
