...
is_reasoning: false
radar:
  knowledge: { s: 3.7, z: -1.78, r: 23.2, estimated: false }  # 전문 지식
  reasoning: { s: 3.7, z: -1.55, r: 26.8, estimated: false }  # 추론
  coding: { s: 53.3, z: 0.25, r: 53.7, estimated: false }  # 코딩
  agentic: { s: 18.3, z: -0.7, r: 39.5, estimated: true }  # 에이전트
  trust: { s: 32.1, z: 0.27, r: 54.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 21.0, z: -0.87, r: 37.0, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $10.0 · 출력 $30.0 · 혼합 $12/1M · 32.0 t/s · TTFT 3.63s · 128k ctx` · 가성비 0.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 23.2 | -1.78 | 실측 | [[humanitys-last-exam]] 3.0%×0.3 |
