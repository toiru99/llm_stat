...
radar:
  ...
  trust: { s: 44.8, z: 0.74, r: 61.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 30.8, z: -0.56, r: 41.5, estimated: true }  # 긴문맥
  instruction: { s: 34.1, z: -0.79, r: 38.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $10.0 · 출력 $30.0 · 혼합 $12/1M · 31.0 t/s · TTFT 2.91s · 128k ctx` · 가성비 0.7
