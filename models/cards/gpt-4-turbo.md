...
radar:
  ...
  agentic: { s: 19.9, z: -0.64, r: 40.5, estimated: true }  # 에이전트
  trust: { s: 30.6, z: 0.14, r: 52.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 28.9, z: -0.59, r: 41.2, estimated: true }  # 긴문맥
  instruction: { s: 28.7, z: -0.98, r: 35.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $10.0 · 출력 $30.0 · 혼합 $12.0/1M · 33.0 t/s · TTFT 2.66s · 128k ctx` · 가성비 0.7
