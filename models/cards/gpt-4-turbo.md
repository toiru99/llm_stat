...
is_reasoning: false
radar:
  knowledge: { s: 3.8, z: -1.76, r: 23.6, estimated: false }  # 전문 지식
  reasoning: { s: 3.8, z: -1.54, r: 26.9, estimated: false }  # 추론
  coding: { s: 53.3, z: 0.26, r: 54.0, estimated: false }  # 코딩
  agentic: { s: 18.5, z: -0.7, r: 39.5, estimated: true }  # 에이전트
  trust: { s: 43.4, z: 0.72, r: 60.9, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $10.0 · 출력 $30.0 · 혼합 $None/1M · 31.0 t/s · TTFT 2.87s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 23.6 | -1.76 | 실측 | [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 26.9 | -1.54 | 실측 | [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 54.0 | +0.26 | 실측 | [[scicode]] 32.0%×1.0 |
| 에이전트 | 39.5 | -0.7 | 추정 | (추정) |
| 신뢰성 | 60.9 | +0.72 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 41.7 | -0.55 | 추정 | (추정) |
