...
is_reasoning: true
radar:
  knowledge: { s: 70.6, z: 1.51, r: 72.6, estimated: false }  # 전문 지식
  reasoning: { s: 66.3, z: 1.6, r: 73.9, estimated: false }  # 추론
  coding: { s: 80.6, z: 1.44, r: 71.6, estimated: false }  # 코딩
  agentic: { s: 63.6, z: 1.03, r: 65.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 86.0 t/s · TTFT 1.71s · 1M ctx` · 가성비 27.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.6 | +1.51 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 73.9 | +1.6 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.6 | +1.44 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 65.5 | +1.03 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 26.0%×1.0 |
