...
radar:
  ...
  agentic: { s: 65.3, z: 1.12, r: 66.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $None/1M · 104.0 t/s · TTFT 1.62s · 1M ctx`
...
| 추론 | 75.4 | +1.7 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 72.7 | +1.51 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 66.9 | +1.12 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 19.0%×1.0 |
