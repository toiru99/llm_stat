...
radar:
  ...
  reasoning: { s: 68.0, z: 1.64, r: 74.7, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.49, r: 72.4, estimated: false }  # 코딩
  agentic: { s: 64.0, z: 1.11, r: 66.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 113.0 t/s · TTFT 1.51s · 1M ctx` · 가성비 27.0
...
| 추론 | 74.7 | +1.64 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 26.0%×1.0 |
