...
radar:
  ...
  coding: { s: 68.5, z: 1.28, r: 69.2, estimated: true }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 81.0 t/s · TTFT 1.98s · 1M ctx` · 가성비 21.3
...
| 코딩 | 69.2 | +1.28 | 추정 | (추정) |
| 에이전트 | 64.6 | +0.97 | 실측 | [[gdpval]] 41.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 26.0%×1.0 |
