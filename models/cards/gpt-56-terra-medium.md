...
radar:
  ...
  reasoning: { s: 68.1, z: 1.8, r: 77.0, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.55, r: 73.3, estimated: false }  # 코딩
  agentic: { s: 68.0, z: 1.23, r: 68.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 121.0 t/s · TTFT 1.35s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 74.3 | +1.62 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 77.0 | +1.8 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
