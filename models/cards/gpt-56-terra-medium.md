...
is_reasoning: true
radar:
  knowledge: { s: 74.2, z: 1.64, r: 74.7, estimated: false }  # 전문 지식
  reasoning: { s: 68.1, z: 1.84, r: 77.5, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.58, r: 73.7, estimated: false }  # 코딩
  agentic: { s: 67.6, z: 1.22, r: 68.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.17/1M · 116.0 t/s · TTFT 1.62s · 1M ctx` · 가성비 21.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 74.7 | +1.64 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 77.5 | +1.84 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
