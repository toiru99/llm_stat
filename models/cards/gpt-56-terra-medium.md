...
radar:
  ...
  reasoning: { s: 68.1, z: 1.83, r: 77.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.17/1M · 107.0 t/s · TTFT 1.56s · 1M ctx` · 가성비 21.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 74.6 | +1.64 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 77.5 | +1.83 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
