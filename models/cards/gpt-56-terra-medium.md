...
radar:
  ...
  agentic: { s: 68.0, z: 1.23, r: 68.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 113.0 t/s · TTFT 1.77s · 1M ctx`
...
| 에이전트 | 68.5 | +1.23 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 19.0%×1.0 |
