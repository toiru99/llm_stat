...
radar:
  ...
  reasoning: { s: 67.7, z: 1.55, r: 73.2, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.41, r: 71.2, estimated: false }  # 코딩
  agentic: { s: 64.0, z: 1.03, r: 65.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 96.0 t/s · TTFT 1.77s · 1M ctx` · 가성비 27.0
...
| 추론 | 73.2 | +1.55 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.2 | +1.41 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 65.4 | +1.03 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 26.0%×1.0 |
