...
radar:
  ...
  coding: { s: 54.1, z: 0.35, r: 55.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $1.25 · 혼합 $1.25/1M · 91.0 t/s · TTFT 0.85s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.5 | +0.5 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 49.7 | -0.02 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 55.2 | +0.35 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 43.9 | -0.4 | 실측 | [[terminal-bench]] 17.0%×1.0 |
