...
radar:
  ...
  agentic: { s: 30.9, z: -0.25, r: 46.2, estimated: false }  # 에이전트
  ...
  instruction: { s: 50.4, z: -0.11, r: 48.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 106.0 t/s · TTFT 0.81s · 1M ctx` · 가성비 155.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.4 | +0.09 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 42.8 | -0.48 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 61.0 | +0.73 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 46.2 | -0.25 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 10.0%×1.0 |
| 신뢰성 | 49.3 | -0.04 | 실측 | [[aa-omniscience]] 25.0%×1.0 |
| 멀티모달 | 44.7 | -0.35 | 실측 | [[mmmu-pro]] 60.0%×1.0 |
| 긴문맥 | 48.5 | -0.1 | 실측 | [[aa-lcr]] 39.0%×1.0 |
| 지시 따르기 | 48.4 | -0.11 | 추정 | (추정) |
