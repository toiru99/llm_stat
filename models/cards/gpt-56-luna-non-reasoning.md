...
radar:
  ...
  agentic: { s: 31.4, z: -0.23, r: 46.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 108.0 t/s · TTFT 0.93s · 1M ctx` · 가성비 155.2
...
| 에이전트 | 46.6 | -0.23 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 10.0%×1.0 |
