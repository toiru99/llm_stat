...
radar:
  ...
  coding: { s: 66.7, z: 0.85, r: 62.8, estimated: false }  # 코딩
  agentic: { s: 37.0, z: 0.03, r: 50.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $None/1M · 172.0 t/s · TTFT 0.67s · 1M ctx`
...
| 코딩 | 62.8 | +0.85 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 50.4 | +0.03 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 9.0%×1.0 |
