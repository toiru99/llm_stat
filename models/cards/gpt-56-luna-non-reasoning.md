...
radar:
  ...
  agentic: { s: 31.4, z: -0.2, r: 46.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 52.7, z: -0.06, r: 49.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 160.0 t/s · TTFT 0.79s · 1M ctx` · 가성비 155.2
