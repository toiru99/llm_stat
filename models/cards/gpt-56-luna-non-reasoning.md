...
radar:
  ...
  agentic: { s: 30.3, z: -0.28, r: 45.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 62.0, z: 0.39, r: 55.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 110.0 t/s · TTFT 0.8s · 1M ctx` · 가성비 109.2
...
| 코딩 | 50.9 | +0.06 | 추정 | (추정) |
| 에이전트 | 45.8 | -0.28 | 실측 | [[gdpval]] 26.0%×1.0, [[tau3-banking]] 10.0%×1.0 |
