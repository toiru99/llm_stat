...
radar:
  ...
  agentic: { s: 31.4, z: -0.22, r: 46.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 136.0 t/s · TTFT 0.75s · 1M ctx` · 가성비 155.2
...
| 추론 | 42.4 | -0.51 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 61.1 | +0.74 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 46.7 | -0.22 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 10.0%×1.0 |
