...
radar:
  ...
  reasoning: { s: 25.0, z: -0.47, r: 42.9, estimated: false }  # 추론
  coding: { s: 64.5, z: 0.75, r: 61.3, estimated: false }  # 코딩
  agentic: { s: 31.1, z: -0.24, r: 46.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 50.4, z: -0.1, r: 48.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 125.0 t/s · TTFT 0.79s · 1M ctx` · 가성비 155.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.6 | +0.11 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 42.9 | -0.47 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 61.3 | +0.75 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 46.5 | -0.24 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 10.0%×1.0 |
