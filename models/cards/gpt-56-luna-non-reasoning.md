...
radar:
  ...
  agentic: { s: 35.9, z: -0.02, r: 49.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 174.0 t/s · TTFT 0.64s · 1M ctx` · 가성비 31.0
...
| 에이전트 | 49.8 | -0.02 | 실측 | [[gdpval]] 28.0%×1.0, [[tau3-banking]] 9.0%×1.0 |
