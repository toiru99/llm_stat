...
radar:
  ...
  agentic: { s: 32.0, z: -0.15, r: 47.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 50.1, z: -0.13, r: 48.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 163.0 t/s · TTFT 0.88s · 1M ctx` · 가성비 155.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.8 | +0.12 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.2 | -0.45 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 62.0 | +0.8 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 47.8 | -0.15 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 9.0%×1.0 |
