...
radar:
  ...
  reasoning: { s: 25.3, z: -0.49, r: 42.6, estimated: false }  # 추론
  coding: { s: 66.7, z: 0.76, r: 61.3, estimated: false }  # 코딩
  agentic: { s: 31.4, z: -0.2, r: 47.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 54.9, z: 0.03, r: 50.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 171.0 t/s · TTFT 0.78s · 1M ctx` · 가성비 155.2
...
| 추론 | 42.6 | -0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 61.3 | +0.76 | 실측 | [[scicode]] 40.0%×1.0 |
