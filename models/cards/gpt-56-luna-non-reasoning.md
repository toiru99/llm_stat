...
radar:
  ...
  coding: { s: 66.7, z: 0.88, r: 63.1, estimated: false }  # 코딩
  agentic: { s: 35.9, z: -0.01, r: 49.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 50.1, z: -0.09, r: 48.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 195.0 t/s · TTFT 0.69s · 1M ctx` · 가성비 31.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.6 | +0.17 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.8 | -0.41 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 63.1 | +0.88 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 49.8 | -0.01 | 실측 | [[gdpval]] 28.0%×1.0, [[tau3-banking]] 9.0%×1.0 |
