...
radar:
  ...
  reasoning: { s: 35.8, z: -0.0, r: 49.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.23 · 출력 $0.88 · 혼합 $0.243/1M · 172.0 t/s · TTFT 1.16s · 512k ctx` · 가성비 78.2
...
| 추론 | 49.9 | +-0.0 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 51.7 | +0.11 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
| 에이전트 | 48.9 | -0.07 | 실측 | [[gdpval]] 3.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 23.0%×1.0 |
