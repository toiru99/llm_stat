...
is_reasoning: true
radar:
  knowledge: { s: 43.3, z: 0.12, r: 51.9, estimated: false }  # 전문 지식
  reasoning: { s: 36.1, z: 0.06, r: 50.9, estimated: false }  # 추론
  coding: { s: 51.6, z: 0.18, r: 52.7, estimated: false }  # 코딩
  agentic: { s: 35.5, z: -0.01, r: 49.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.23 · 출력 $0.88 · 혼합 $0.243/1M · 203.0 t/s · TTFT 1.06s · 512k ctx` · 가성비 78.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.9 | +0.12 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
...
| 에이전트 | 49.9 | -0.01 | 실측 | [[gdpval]] 3.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 23.0%×1.0 |
