...
radar:
  ...
  agentic: { s: 14.5, z: -0.88, r: 36.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.065/1M · 270.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 107.7
...
| 코딩 | 39.9 | -0.67 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 12.0%×0.5 |
| 에이전트 | 36.7 | -0.88 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
