...
radar:
  ...
  coding: { s: 31.4, z: -0.61, r: 40.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 293.0 t/s · TTFT 0.46s · 128k ctx` · 가성비 37.5
...
| 코딩 | 40.8 | -0.61 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
