...
radar:
  ...
  instruction: { s: 28.2, z: -1.74, r: 24.0, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 291.0 t/s · TTFT 0.44s · 128k ctx` · 가성비 37.5
...
| 지시 따르기 | 24.0 | -1.74 | 실측 | [[ifbench]] 32.0%×1.0 |
