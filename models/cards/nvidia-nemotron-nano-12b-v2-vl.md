...
radar:
  ...
  agentic: { s: 14.6, z: -1.45, r: 28.2, estimated: false }  # 에이전트
  ...
  instruction: { s: 28.2, z: -1.62, r: 25.7, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 267.0 t/s · TTFT 0.44s · 128k ctx` · 가성비 37.5
