...
radar:
  ...
  coding: { s: 31.4, z: -0.71, r: 39.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 104.0 t/s · TTFT 8.24s · 128k ctx` · 가성비 37.5
...
| 추론 | 39.6 | -0.69 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 39.4 | -0.71 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
