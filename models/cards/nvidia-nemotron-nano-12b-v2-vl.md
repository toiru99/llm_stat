...
NVIDIA · Open · Small(13.2B) · 컨텍스트 128k · 종합지능 **3.0**
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 30.0 t/s · TTFT 14.92s · 128k ctx` · 가성비 12.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.3 | -0.64 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 39.9 | -0.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
