...
is_reasoning: false
radar:
  knowledge: { s: 27.3, z: -0.64, r: 40.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 293.0 t/s · TTFT 0.44s · 128k ctx` · 가성비 37.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.5 | -0.64 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
