...
radar:
  ...
  coding: { s: 31.4, z: -0.65, r: 40.2, estimated: false }  # 코딩
  agentic: { s: 14.4, z: -0.86, r: 37.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $None/1M · 108.0 t/s · TTFT 3.89s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.1 | -0.66 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.0 | -0.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 40.2 | -0.65 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 37.2 | -0.86 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
