...
radar:
  ...
  reasoning: { s: 36.0, z: 0.14, r: 52.1, estimated: false }  # 추론
  coding: { s: 56.7, z: 0.46, r: 56.9, estimated: false }  # 코딩
  agentic: { s: 49.2, z: 0.51, r: 57.7, estimated: true }  # 에이전트
  trust: { s: 42.9, z: 0.72, r: 60.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 63.2, z: 0.44, r: 56.6, estimated: true }  # 긴문맥
...
| 추론 | 52.1 | +0.14 | 실측 | [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 56.9 | +0.46 | 실측 | [[scicode]] 34.0%×1.0 |
| 에이전트 | 57.7 | +0.51 | 추정 | (추정) |
| 신뢰성 | 60.8 | +0.72 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 56.6 | +0.44 | 추정 | (추정) |
