...
radar:
  ...
  agentic: { s: 47.6, z: 0.42, r: 56.4, estimated: true }  # 에이전트
  trust: { s: 47.9, z: 0.91, r: 63.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 77.2, z: 0.8, r: 62.1, estimated: true }  # 긴문맥
  instruction: { s: 78.3, z: 0.97, r: 64.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 49.3 | -0.05 | 실측 | [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
