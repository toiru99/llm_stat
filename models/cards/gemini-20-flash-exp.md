...
radar:
  ...
  trust: { s: 47.9, z: 0.92, r: 63.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 77.2, z: 0.81, r: 62.1, estimated: true }  # 긴문맥
  instruction: { s: 78.3, z: 0.98, r: 64.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
