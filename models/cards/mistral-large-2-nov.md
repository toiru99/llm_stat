...
is_reasoning: false
radar:
  knowledge: { s: 30.6, z: -0.5, r: 42.4, estimated: false }  # 전문 지식
  reasoning: { s: 17.4, z: -0.86, r: 37.1, estimated: false }  # 추론
  coding: { s: 35.3, z: -0.49, r: 42.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 42.4 | -0.5 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 37.1 | -0.86 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 42.7 | -0.49 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
