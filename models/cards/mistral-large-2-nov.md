...
is_reasoning: false
radar:
  knowledge: { s: 29.0, z: -0.56, r: 41.5, estimated: false }  # 전문 지식
  reasoning: { s: 16.4, z: -0.9, r: 36.5, estimated: false }  # 추론
  coding: { s: 34.2, z: -0.53, r: 42.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 41.5 | -0.56 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 36.5 | -0.9 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 42.1 | -0.53 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
