...
radar:
  ...
  reasoning: { s: 12.0, z: -1.14, r: 33.0, estimated: false }  # 추론
  coding: { s: 4.4, z: -1.78, r: 23.2, estimated: false }  # 코딩
  agentic: { s: 0.0, z: -1.43, r: 28.5, estimated: false }  # 에이전트
  trust: { s: 14.2, z: -0.55, r: 41.7, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 29.7 | -1.35 | 실측 | [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 33.0 | -1.14 | 실측 | [[gpqa-diamond]] 24.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
