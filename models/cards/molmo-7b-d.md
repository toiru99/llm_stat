...
radar:
  ...
  trust: { s: 14.2, z: -0.57, r: 41.5, estimated: true }  # 신뢰성
  multimodal: { s: 14.3, z: -2.78, r: 8.2, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 29.6 | -1.36 | 실측 | [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 신뢰성 | 41.5 | -0.57 | 추정 | (추정) |
| 멀티모달 | 8.2 | -2.78 | 실측 | [[mmmu-pro]] 25.0%×1.0 |
