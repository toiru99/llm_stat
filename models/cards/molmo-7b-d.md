...
is_reasoning: false
radar:
  knowledge: { s: 12.8, z: -1.33, r: 30.0, estimated: false }  # 전문 지식
  ...
  multimodal: { s: 14.5, z: -2.71, r: 9.3, estimated: false }  # 멀티모달
...
Allen Institute for AI · Open · Unknown · 컨텍스트 4k · 종합지능 **4.0**
...
|---|---|---|---|---|
| 전문 지식 | 30.0 | -1.33 | 실측 | [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 신뢰성 | 42.4 | -0.5 | 추정 | (추정) |
| 멀티모달 | 9.3 | -2.71 | 실측 | [[mmmu-pro]] 25.0%×1.0 |
