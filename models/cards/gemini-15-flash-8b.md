...
radar:
  ...
  agentic: { s: 17.5, z: -0.73, r: 39.1, estimated: true }  # 에이전트
  trust: { s: 26.0, z: -0.12, r: 48.1, estimated: true }  # 신뢰성
  multimodal: { s: 31.4, z: -1.95, r: 20.8, estimated: false }  # 멀티모달
  long_context: { s: 28.5, z: -0.63, r: 40.5, estimated: true }  # 긴문맥
...
| 추론 | 38.5 | -0.77 | 실측 | [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
