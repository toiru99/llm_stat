...
radar:
  ...
  reasoning: { s: 19.0, z: -0.82, r: 37.8, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.43, r: 43.6, estimated: false }  # 코딩
  agentic: { s: 13.8, z: -0.9, r: 36.5, estimated: true }  # 에이전트
  trust: { s: 21.6, z: -0.3, r: 45.5, estimated: true }  # 신뢰성
  multimodal: { s: 31.4, z: -2.0, r: 20.0, estimated: false }  # 멀티모달
  long_context: { s: 20.3, z: -0.92, r: 36.3, estimated: true }  # 긴문맥
...
| 추론 | 37.8 | -0.82 | 실측 | [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
