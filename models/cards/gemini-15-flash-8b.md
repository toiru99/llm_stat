...
radar:
  ...
  agentic: { s: 17.9, z: -0.72, r: 39.3, estimated: true }  # 에이전트
  trust: { s: 27.3, z: -0.04, r: 49.4, estimated: true }  # 신뢰성
  multimodal: { s: 31.4, z: -1.93, r: 21.0, estimated: false }  # 멀티모달
...
| 추론 | 38.7 | -0.76 | 실측 | [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 44.7 | -0.36 | 실측 | [[scicode]] 23.0%×1.0 |
| 에이전트 | 39.3 | -0.72 | 추정 | (추정) |
| 신뢰성 | 49.4 | -0.04 | 추정 | (추정) |
| 멀티모달 | 21.0 | -1.93 | 실측 | [[mmmu-pro]] 37.0%×1.0 |
| 긴문맥 | 36.0 | -0.93 | 추정 | (추정) |
