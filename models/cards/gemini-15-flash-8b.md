...
radar:
  ...
  trust: { s: 21.0, z: -0.24, r: 46.4, estimated: true }  # 신뢰성
  multimodal: { s: 31.4, z: -1.95, r: 20.7, estimated: false }  # 멀티모달
  long_context: { s: 27.9, z: -0.65, r: 40.2, estimated: true }  # 긴문맥
  instruction: { s: 30.8, z: -0.94, r: 35.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 38.3 | -0.78 | 실측 | [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 44.4 | -0.38 | 실측 | [[scicode]] 23.0%×1.0 |
| 에이전트 | 41.1 | -0.59 | 추정 | (추정) |
| 신뢰성 | 46.4 | -0.24 | 추정 | (추정) |
| 멀티모달 | 20.7 | -1.95 | 실측 | [[mmmu-pro]] 37.0%×1.0 |
| 긴문맥 | 40.2 | -0.65 | 추정 | (추정) |
