...
is_reasoning: false
radar:
  knowledge: { s: 20.4, z: -0.99, r: 35.2, estimated: false }  # 전문 지식
  reasoning: { s: 18.7, z: -0.79, r: 38.2, estimated: false }  # 추론
  coding: { s: 37.1, z: -0.41, r: 43.9, estimated: false }  # 코딩
  agentic: { s: 13.4, z: -0.93, r: 36.1, estimated: true }  # 에이전트
  trust: { s: 16.4, z: -0.38, r: 44.4, estimated: true }  # 신뢰성
  multimodal: { s: 31.4, z: -1.94, r: 20.9, estimated: false }  # 멀티모달
  long_context: { s: 19.3, z: -0.93, r: 36.0, estimated: true }  # 긴문맥
...
| 추론 | 38.2 | -0.79 | 실측 | [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
