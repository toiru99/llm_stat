...
radar:
  ...
  reasoning: { s: 13.6, z: -1.04, r: 34.5, estimated: false }  # 추론
...
Sarvam · Open · Small(23.6B) · 컨텍스트 32k · 종합지능 **1.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 36.7 | -0.89 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 42.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
