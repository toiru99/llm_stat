...
radar:
  ...
  coding: { s: 52.4, z: 0.23, r: 53.4, estimated: false }  # 코딩
  agentic: { s: 39.1, z: 0.07, r: 51.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.13 · 출력 $0.4 · 혼합 $0.1535/1M · 80.0 t/s · TTFT 1.16s · 256k ctx` · 가성비 130.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.4 | -0.37 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 46.2 | -0.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 53.4 | +0.23 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 51.0 | +0.07 | 실측 | [[tau2-bench]] 40.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
