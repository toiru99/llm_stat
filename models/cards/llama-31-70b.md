...
radar:
  ...
  coding: { s: 31.5, z: -0.7, r: 39.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.56 · 출력 $0.56 · 혼합 $0.56/1M · 59.0 t/s · TTFT 1.33s · 128k ctx` · 가성비 12.5
...
| 코딩 | 39.6 | -0.7 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
