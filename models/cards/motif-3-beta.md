...
is_reasoning: true
radar:
  knowledge: { s: 53.1, z: 0.62, r: 59.2, estimated: false }  # 전문 지식
  reasoning: { s: 60.5, z: 1.32, r: 69.8, estimated: false }  # 추론
  ...
  instruction: { s: 84.1, z: 1.34, r: 70.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 59.2 | +0.62 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 69.8 | +1.32 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
