...
radar:
  ...
  reasoning: { s: 60.5, z: 1.19, r: 67.9, estimated: false }  # 추론
  ...
  instruction: { s: 83.7, z: 1.19, r: 67.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 67.9 | +1.19 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
