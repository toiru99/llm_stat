...
is_reasoning: true
radar:
  knowledge: { s: 51.6, z: 0.56, r: 58.5, estimated: false }  # 전문 지식
  reasoning: { s: 58.9, z: 1.22, r: 68.4, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 58.5 | +0.56 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 68.4 | +1.22 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 65.4 | +1.03 | 실측 | [[scicode]] 44.0%×1.0 |
| 에이전트 | 61.0 | +0.73 | 실측 | [[gdpval]] 38.0%×1.0 |
