...
radar:
  ...
  coding: { s: 34.7, z: -0.48, r: 42.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 111.0 t/s · TTFT 2.17s · 256k ctx` · 가성비 31.0
...
| 코딩 | 42.8 | -0.48 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
