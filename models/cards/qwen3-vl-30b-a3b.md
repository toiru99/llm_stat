...
radar:
  ...
  reasoning: { s: 29.3, z: -0.3, r: 45.4, estimated: false }  # 추론
  coding: { s: 34.7, z: -0.56, r: 41.7, estimated: false }  # 코딩
  agentic: { s: 13.9, z: -0.9, r: 36.6, estimated: false }  # 에이전트
  trust: { s: 9.3, z: -0.79, r: 38.2, estimated: false }  # 신뢰성
  multimodal: { s: 67.1, z: -0.25, r: 46.2, estimated: false }  # 멀티모달
  long_context: { s: 51.8, z: 0.04, r: 50.6, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 111.0 t/s · TTFT 2.16s · 256k ctx` · 가성비 31.0
...
| 추론 | 45.4 | -0.3 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 41.7 | -0.56 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 36.6 | -0.9 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
| 신뢰성 | 38.2 | -0.79 | 실측 | [[aa-omniscience]] 10.0%×1.0 |
| 멀티모달 | 46.2 | -0.25 | 실측 | [[mmmu-pro]] 62.0%×1.0 |
| 긴문맥 | 50.6 | +0.04 | 실측 | [[aa-lcr]] 43.0%×1.0 |
