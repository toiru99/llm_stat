...
is_reasoning: false
radar:
  knowledge: { s: 35.8, z: -0.23, r: 46.5, estimated: false }  # 전문 지식
  reasoning: { s: 29.7, z: -0.21, r: 46.9, estimated: false }  # 추론
  coding: { s: 34.7, z: -0.49, r: 42.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 113.0 t/s · TTFT 2.28s · 256k ctx` · 가성비 31.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.5 | -0.23 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 72.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 46.9 | -0.21 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 42.7 | -0.49 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
