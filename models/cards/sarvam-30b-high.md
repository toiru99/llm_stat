...
radar:
  ...
  reasoning: { s: 24.6, z: -0.51, r: 42.4, estimated: false }  # 추론
...
Sarvam · Open · Small(32.2B) · 컨텍스트 65k · 종합지능 **1.0**
...
## 실용 지표
`입력 $0.03 · 출력 $0.11 · 혼합 $0.0274/1M · None t/s · TTFT Nones · 65k ctx` · 가성비 36.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.7 | -0.62 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
