...
radar:
  ...
  reasoning: { s: 24.9, z: -0.47, r: 43.0, estimated: false }  # 추론
  coding: { s: 22.1, z: -1.03, r: 34.6, estimated: false }  # 코딩
  agentic: { s: 19.2, z: -0.66, r: 40.1, estimated: false }  # 에이전트
  trust: { s: 2.3, z: -1.2, r: 32.0, estimated: false }  # 신뢰성
...
| 추론 | 43.0 | -0.47 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 34.6 | -1.03 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
