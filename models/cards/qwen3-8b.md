...
radar:
  ...
  coding: { s: 26.6, z: -0.83, r: 37.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.37/1M · 38.0 t/s · TTFT 3.79s · 131k ctx` · 가성비 21.6
...
| 코딩 | 37.6 | -0.83 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
