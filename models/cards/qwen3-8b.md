...
radar:
  ...
  agentic: { s: 11.5, z: -0.97, r: 35.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $None/1M · 41.0 t/s · TTFT 3.67s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.6 | -0.7 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 35.5 | -0.97 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 28.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
