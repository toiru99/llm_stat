...
radar:
  ...
  coding: { s: 25.7, z: -0.89, r: 36.7, estimated: false }  # 코딩
  agentic: { s: 10.3, z: -1.05, r: 34.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.372/1M · 41.0 t/s · TTFT 3.77s · 131k ctx` · 가성비 21.5
...
| 에이전트 | 34.3 | -1.05 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 28.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
