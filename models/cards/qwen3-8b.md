...
radar:
  ...
  coding: { s: 26.6, z: -0.89, r: 36.7, estimated: false }  # 코딩
  agentic: { s: 10.3, z: -1.04, r: 34.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.232/1M · 39.0 t/s · TTFT 3.71s · 131k ctx` · 가성비 34.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.5 | -0.7 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 39.5 | -0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 36.7 | -0.89 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 34.5 | -1.04 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 28.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
