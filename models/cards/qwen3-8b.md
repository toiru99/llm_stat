...
radar:
  ...
  agentic: { s: 10.8, z: -1.0, r: 35.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.232/1M · 37.0 t/s · TTFT 3.72s · 131k ctx` · 가성비 34.5
...
| 에이전트 | 35.0 | -1.0 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 28.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
