...
radar:
  ...
  coding: { s: 26.6, z: -0.9, r: 36.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.232/1M · 40.0 t/s · TTFT 3.73s · 131k ctx` · 가성비 34.5
...
| 코딩 | 36.5 | -0.9 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
