...
radar:
  ...
  reasoning: { s: 17.8, z: -0.84, r: 37.5, estimated: false }  # 추론
  coding: { s: 30.4, z: -0.68, r: 39.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.59 · 출력 $0.71 · 혼합 $None/1M · 76.0 t/s · TTFT 1.74s · 128k ctx`
...
| 추론 | 37.5 | -0.84 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 50.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.8 | -0.68 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
