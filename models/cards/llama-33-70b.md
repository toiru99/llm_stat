...
is_reasoning: false
radar:
  knowledge: { s: 28.9, z: -0.56, r: 41.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.58 · 출력 $0.71 · 혼합 $0.59/1M · 89.0 t/s · TTFT 1.55s · 128k ctx` · 가성비 15.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.7 | -0.56 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 50.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
