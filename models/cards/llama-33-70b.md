...
radar:
  ...
  reasoning: { s: 17.5, z: -0.88, r: 36.9, estimated: false }  # 추론
  coding: { s: 30.4, z: -0.73, r: 39.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.66 · 출력 $0.72 · 혼합 $0.6615/1M · 88.0 t/s · TTFT 1.61s · 128k ctx` · 가성비 13.6
...
| 추론 | 36.9 | -0.88 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 50.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
