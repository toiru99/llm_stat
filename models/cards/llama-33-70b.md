...
## 실용 지표
`입력 $0.6 · 출력 $0.72 · 혼합 $0.612/1M · 82.0 t/s · TTFT 1.58s · 128k ctx` · 가성비 14.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.2 | -0.58 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 50.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
