...
radar:
  ...
  agentic: { s: 68.9, z: 1.2, r: 68.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.4 · 혼합 $0.51/1M · 77.0 t/s · TTFT 5.71s · 262k ctx` · 가성비 52.9
...
| 에이전트 | 68.1 | +1.2 | 실측 | [[itbench]] 35.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
