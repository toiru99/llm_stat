...
radar:
  ...
  reasoning: { s: 15.7, z: -0.93, r: 36.0, estimated: false }  # 추론
...
NVIDIA · Open · Medium(70B) · 컨텍스트 128k · 종합지능 **2.0**
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 18.0 t/s · TTFT 13.85s · 128k ctx` · 가성비 1.7
