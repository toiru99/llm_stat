...
radar:
  ...
  coding: { s: 28.1, z: -0.79, r: 38.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 101.0 t/s · TTFT 6.25s · 128k ctx` · 가성비 6.7
...
| 코딩 | 38.1 | -0.79 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
