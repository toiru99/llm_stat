...
radar:
  ...
  agentic: { s: 15.6, z: -1.44, r: 28.4, estimated: false }  # 에이전트
  trust: { s: 33.8, z: 0.0, r: 50.0, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 9.5, z: -2.19, r: 17.2, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 253.0 t/s · TTFT 5.35s · 128k ctx` · 가성비 6.7
...
| 에이전트 | 28.4 | -1.44 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
| 신뢰성 | 50.0 | +0.0 | 실측 | [[aa-omniscience]] 31.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 17.2 | -2.19 | 실측 | [[aa-lcr]] 7.0%×1.0 |
