...
radar:
  ...
  agentic: { s: 15.6, z: -1.39, r: 29.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 306.0 t/s · TTFT 3.83s · 128k ctx` · 가성비 6.7
...
| 에이전트 | 29.2 | -1.39 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
