...
radar:
  ...
  agentic: { s: 15.6, z: -1.41, r: 28.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 268.0 t/s · TTFT 3.93s · 128k ctx` · 가성비 6.7
...
| 에이전트 | 28.8 | -1.41 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
