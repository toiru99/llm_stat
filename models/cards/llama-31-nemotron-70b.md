...
radar:
  ...
  reasoning: { s: 16.1, z: -0.92, r: 36.1, estimated: false }  # 추론
  coding: { s: 28.1, z: -0.8, r: 38.0, estimated: false }  # 코딩
  agentic: { s: 15.4, z: -0.81, r: 37.9, estimated: false }  # 에이전트
  trust: { s: 31.4, z: 0.23, r: 53.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 114.0 t/s · TTFT 5.03s · 128k ctx` · 가성비 5.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.9 | -0.67 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 36.1 | -0.92 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
