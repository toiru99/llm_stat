...
radar:
  ...
  coding: { s: 28.1, z: -0.76, r: 38.5, estimated: false }  # 코딩
  agentic: { s: 15.4, z: -0.81, r: 37.9, estimated: false }  # 에이전트
  trust: { s: 35.3, z: 0.36, r: 55.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.2 · 출력 $1.2 · 혼합 $1.2/1M · 299.0 t/s · TTFT 2.39s · 128k ctx` · 가성비 6.7
...
| 코딩 | 38.5 | -0.76 | 실측 | [[scicode]] 23.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 37.9 | -0.81 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
| 신뢰성 | 55.3 | +0.36 | 실측 | [[aa-omniscience]] 31.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
