...
is_reasoning: false
radar:
  knowledge: { s: 30.6, z: -0.5, r: 42.6, estimated: false }  # 전문 지식
  reasoning: { s: 22.7, z: -0.6, r: 41.0, estimated: false }  # 추론
  coding: { s: 25.8, z: -0.22, r: 46.7, estimated: false }  # 코딩
  agentic: { s: 33.4, z: -0.16, r: 47.6, estimated: false }  # 에이전트
...
Amazon · Proprietary · Unknown · 컨텍스트 256k · 종합지능 **8.0**
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · 104.0 t/s · TTFT 1.06s · 256k ctx` · 가성비 3.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.6 | -0.5 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 41.0 | -0.6 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 46.7 | -0.22 | 실측 | [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 47.6 | -0.16 | 실측 | [[gdpval]] 1.0%×1.0, [[tau2-bench]] 72.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
