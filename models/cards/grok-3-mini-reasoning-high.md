...
radar:
  ...
  reasoning: { s: 33.5, z: -0.07, r: 48.9, estimated: false }  # 추론
  coding: { s: 25.8, z: -0.22, r: 46.7, estimated: false }  # 코딩
  agentic: { s: 58.3, z: 0.8, r: 62.0, estimated: false }  # 에이전트
...
SpaceXAI · Proprietary · Unknown · 컨텍스트 1M · 종합지능 **16.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.3 · 출력 $0.5 · 혼합 $0.1625/1M · 68.0 t/s · TTFT 0.69s · 1M ctx` · 가성비 98.5
...
| 에이전트 | 62.0 | +0.8 | 실측 | [[tau2-bench]] 90.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
