...
radar:
  ...
  coding: { s: 52.7, z: 0.24, r: 53.5, estimated: false }  # 코딩
  agentic: { s: 58.3, z: 0.81, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $0.5 · 혼합 $0.1625/1M · 78.0 t/s · TTFT 0.67s · 1M ctx` · 가성비 141.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.1 | -0.26 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 49.3 | -0.05 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 53.5 | +0.24 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 62.2 | +0.81 | 실측 | [[tau2-bench]] 90.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
