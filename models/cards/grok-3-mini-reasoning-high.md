...
radar:
  ...
  agentic: { s: 58.3, z: 0.9, r: 63.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $0.5 · 혼합 $0.1625/1M · 88.0 t/s · TTFT 0.68s · 1M ctx` · 가성비 141.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.2 | -0.25 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 49.8 | -0.01 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 54.2 | +0.28 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 63.5 | +0.9 | 실측 | [[tau2-bench]] 90.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
