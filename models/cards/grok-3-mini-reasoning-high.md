...
is_reasoning: true
radar:
  knowledge: { s: 36.4, z: -0.19, r: 47.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.3 · 출력 $0.5 · 혼합 $0.16/1M · 65.0 t/s · TTFT 0.76s · 1M ctx` · 가성비 143.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.2 | -0.19 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
