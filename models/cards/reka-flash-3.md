...
Reka AI · Open · Small(21B) · 컨텍스트 128k · 종합지능 **1.0**
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · None t/s · TTFT Nones · 128k ctx` · 가성비 3.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.5 | -0.77 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 53.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
