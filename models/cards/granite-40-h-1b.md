...
is_reasoning: false
radar:
  knowledge: { s: 9.5, z: -1.51, r: 27.4, estimated: false }  # 전문 지식
  reasoning: { s: 8.8, z: -1.29, r: 30.6, estimated: false }  # 추론
  coding: { s: 8.9, z: -1.6, r: 26.0, estimated: false }  # 코딩
...
| 코딩 | 26.0 | -1.6 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 34.6 | -1.03 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
