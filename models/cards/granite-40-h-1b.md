...
is_reasoning: false
radar:
  knowledge: { s: 9.5, z: -1.49, r: 27.6, estimated: false }  # 전문 지식
  reasoning: { s: 8.5, z: -1.3, r: 30.5, estimated: false }  # 추론
  coding: { s: 8.9, z: -1.59, r: 26.2, estimated: false }  # 코딩
...
IBM · Open · Tiny(1.5B) · 컨텍스트 128k · 종합지능 **3.0**
...
|---|---|---|---|---|
| 전문 지식 | 27.6 | -1.49 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 25.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.5 | -1.3 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 25.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 26.2 | -1.59 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
