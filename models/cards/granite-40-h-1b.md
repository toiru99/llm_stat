...
is_reasoning: false
radar:
  knowledge: { s: 9.4, z: -1.52, r: 27.1, estimated: false }  # 전문 지식
  reasoning: { s: 8.7, z: -1.31, r: 30.3, estimated: false }  # 추론
  coding: { s: 8.9, z: -1.63, r: 25.5, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 27.1 | -1.52 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 26.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.3 | -1.31 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 26.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 25.5 | -1.63 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
