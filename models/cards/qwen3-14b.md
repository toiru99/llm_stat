...
radar:
  ...
  reasoning: { s: 21.9, z: -0.63, r: 40.6, estimated: false }  # 추론
  coding: { s: 36.4, z: -0.44, r: 43.5, estimated: false }  # 코딩
  agentic: { s: 13.3, z: -0.93, r: 36.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $0.735/1M · 63.0 t/s · TTFT 2.68s · 32k ctx` · 가성비 13.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.0 | -0.6 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 60.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 36.0 | -0.93 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 35.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
