...
is_reasoning: false
radar:
  knowledge: { s: 28.0, z: -0.63, r: 40.5, estimated: false }  # 전문 지식
  reasoning: { s: 22.1, z: -0.66, r: 40.1, estimated: false }  # 추론
  coding: { s: 37.6, z: -0.45, r: 43.3, estimated: false }  # 코딩
  agentic: { s: 13.3, z: -0.93, r: 36.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $0.455/1M · 60.0 t/s · TTFT 2.72s · 32k ctx` · 가성비 22.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.5 | -0.63 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 60.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.1 | -0.66 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
