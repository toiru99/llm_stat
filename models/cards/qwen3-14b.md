...
radar:
  ...
  coding: { s: 37.6, z: -0.44, r: 43.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $0.455/1M · 59.0 t/s · TTFT 2.68s · 32k ctx` · 가성비 22.0
...
| 추론 | 40.2 | -0.65 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 43.4 | -0.44 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
