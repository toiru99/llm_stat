...
is_reasoning: false
radar:
  knowledge: { s: 28.7, z: -0.58, r: 41.2, estimated: false }  # 전문 지식
  reasoning: { s: 21.8, z: -0.63, r: 40.5, estimated: false }  # 추론
  coding: { s: 37.6, z: -0.39, r: 44.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $None/1M · 49.0 t/s · TTFT 2.86s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.2 | -0.58 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 60.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 40.5 | -0.63 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 44.2 | -0.39 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
