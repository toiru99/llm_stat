...
radar:
  ...
  reasoning: { s: 22.1, z: -0.67, r: 40.0, estimated: false }  # 추론
  coding: { s: 37.6, z: -0.46, r: 43.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $0.455/1M · 59.0 t/s · TTFT 2.7s · 32k ctx` · 가성비 22.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.4 | -0.64 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 60.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.0 | -0.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 43.1 | -0.46 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
