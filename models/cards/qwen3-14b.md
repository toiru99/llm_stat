...
radar:
  ...
  coding: { s: 37.6, z: -0.37, r: 44.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.35 · 출력 $4.2 · 혼합 $0.73/1M · 62.0 t/s · TTFT 2.69s · 32k ctx` · 가성비 13.7
...
| 코딩 | 44.5 | -0.37 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
