...
is_reasoning: false
radar:
  knowledge: { s: 41.0, z: 0.03, r: 50.5, estimated: false }  # 전문 지식
  reasoning: { s: 23.7, z: -0.54, r: 41.9, estimated: false }  # 추론
  coding: { s: 51.5, z: 0.2, r: 53.0, estimated: false }  # 코딩
  agentic: { s: 41.2, z: 0.16, r: 52.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 50.5 | +0.03 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 41.9 | -0.54 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 53.0 | +0.2 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 52.3 | +0.16 | 실측 | [[tau2-bench]] 50.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
