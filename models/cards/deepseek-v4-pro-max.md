...
is_reasoning: true
radar:
  knowledge: { s: 75.2, z: 1.7, r: 75.4, estimated: false }  # 전문 지식
  reasoning: { s: 67.3, z: 1.8, r: 77.0, estimated: false }  # 추론
  coding: { s: 78.8, z: 1.4, r: 71.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 75.4 | +1.7 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 77.0 | +1.8 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 71.0 | +1.4 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
