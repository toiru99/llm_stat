...
radar:
  ...
  coding: { s: 79.9, z: 0.85, r: 62.8, estimated: false }  # 코딩
  agentic: { s: 74.0, z: 0.87, r: 63.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 90.0 t/s · TTFT 1.69s · 1M ctx` · 가성비 244.4
...
| 코딩 | 62.8 | +0.85 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
