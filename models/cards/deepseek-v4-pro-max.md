...
radar:
  ...
  coding: { s: 79.9, z: 0.88, r: 63.2, estimated: false }  # 코딩
  agentic: { s: 74.0, z: 0.88, r: 63.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 77.0 t/s · TTFT 1.76s · 1M ctx` · 가성비 244.4
...
| 코딩 | 63.2 | +0.88 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 63.2 | +0.88 | 실측 | [[apex-agents]] 24.0%×1.0, [[gdpval]] 41.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
