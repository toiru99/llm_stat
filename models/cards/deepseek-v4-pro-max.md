...
radar:
  ...
  reasoning: { s: 67.7, z: 1.63, r: 74.4, estimated: false }  # 추론
  coding: { s: 78.8, z: 1.31, r: 69.6, estimated: false }  # 코딩
  agentic: { s: 67.1, z: 1.25, r: 68.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 71.0 t/s · TTFT 1.74s · 1M ctx` · 가성비 255.0
...
| 추론 | 74.4 | +1.63 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 69.6 | +1.31 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 68.7 | +1.25 | 실측 | [[apex-agents]] 24.0%×1.0, [[gdpval]] 40.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
