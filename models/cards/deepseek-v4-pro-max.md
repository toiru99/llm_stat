...
radar:
  ...
  agentic: { s: 74.0, z: 0.9, r: 63.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 66.0 t/s · TTFT 1.77s · 1M ctx` · 가성비 244.4
...
| 에이전트 | 63.6 | +0.9 | 실측 | [[apex-agents]] 24.0%×1.0, [[gdpval]] 40.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
