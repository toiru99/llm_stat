...
is_reasoning: true
radar:
  knowledge: { s: 75.2, z: 1.68, r: 75.2, estimated: false }  # 전문 지식
  reasoning: { s: 67.3, z: 1.79, r: 76.8, estimated: false }  # 추론
  coding: { s: 78.8, z: 1.38, r: 70.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 62.0 t/s · TTFT 1.78s · 1M ctx` · 가성비 244.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.2 | +1.68 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 76.8 | +1.79 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 70.7 | +1.38 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
