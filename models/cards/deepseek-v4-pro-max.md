...
radar:
  knowledge: { s: 75.2, z: 1.07, r: 66.1, estimated: false }  # 전문 지식
  reasoning: { s: 67.7, z: 1.07, r: 66.1, estimated: false }  # 추론
  coding: { s: 79.9, z: 0.86, r: 62.9, estimated: false }  # 코딩
  agentic: { s: 74.6, z: 0.87, r: 63.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 70.0 t/s · TTFT 1.84s · 1M ctx` · 가성비 244.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.1 | +1.07 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
...
| 에이전트 | 63.1 | +0.87 | 실측 | [[apex-agents]] 24.0%×1.0, [[gdpval]] 40.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
