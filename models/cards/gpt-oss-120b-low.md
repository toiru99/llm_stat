...
OpenAI · Open · Medium(117B) · 컨텍스트 131k · 종합지능 **18.0**
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 319.0 t/s · TTFT 0.82s · 131k ctx` · 가성비 90.0
...
| 에이전트 | 41.0 | -0.6 | 실측 | [[tau2-bench]] 45.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
