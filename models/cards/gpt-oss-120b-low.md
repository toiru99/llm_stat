...
## 실용 지표
`입력 $0.15 · 출력 $0.59 · 혼합 $0.1945/1M · 224.0 t/s · TTFT 0.85s · 131k ctx` · 가성비 77.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.4 | -0.31 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
