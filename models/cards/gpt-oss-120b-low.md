...
radar:
  ...
  agentic: { s: 26.7, z: -0.97, r: 35.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 330.0 t/s · TTFT 1.01s · 131k ctx` · 가성비 90.0
...
| 에이전트 | 35.4 | -0.97 | 실측 | [[tau2-bench]] 45.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
