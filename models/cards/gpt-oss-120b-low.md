...
is_reasoning: true
radar:
  knowledge: { s: 32.0, z: -0.42, r: 43.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 314.0 t/s · TTFT 0.91s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.8 | -0.42 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
