...
radar:
  ...
  trust: { s: 23.5, z: -0.43, r: 43.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 318.0 t/s · TTFT 0.82s · 131k ctx` · 가성비 90.0
...
| 에이전트 | 34.7 | -1.02 | 실측 | [[tau2-bench]] 45.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
| 신뢰성 | 43.6 | -0.43 | 실측 | [[aa-omniscience]] 22.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
