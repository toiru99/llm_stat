...
radar:
  ...
  agentic: { s: 15.5, z: -0.8, r: 38.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 316.0 t/s · TTFT 0.83s · 131k ctx` · 가성비 75.0
...
| 에이전트 | 38.0 | -0.8 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 45.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
