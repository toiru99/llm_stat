...
radar:
  ...
  coding: { s: 42.5, z: -0.23, r: 46.5, estimated: false }  # 코딩
  agentic: { s: 14.7, z: -0.86, r: 37.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.59 · 혼합 $0.1945/1M · 225.0 t/s · TTFT 0.98s · 131k ctx` · 가성비 77.1
...
| 에이전트 | 37.1 | -0.86 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 45.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
