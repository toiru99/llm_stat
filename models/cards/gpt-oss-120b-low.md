...
is_reasoning: true
radar:
  knowledge: { s: 32.0, z: -0.44, r: 43.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.15 · 출력 $0.59 · 혼합 $0.1945/1M · 209.0 t/s · TTFT 0.88s · 131k ctx` · 가성비 77.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.4 | -0.44 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 37.6 | -0.83 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 45.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
