...
is_reasoning: false
radar:
  knowledge: { s: 23.8, z: -0.84, r: 37.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 104.0 t/s · TTFT 2.17s · 32k ctx` · 가성비 26.9
...
| 에이전트 | 38.0 | -0.8 | 실측 | [[tau2-bench]] 22.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
