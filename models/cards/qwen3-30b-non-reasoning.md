...
Alibaba · Open · Small(30.5B) · 컨텍스트 32k · 종합지능 **1.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 106.0 t/s · TTFT 2.18s · 32k ctx` · 가성비 3.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 37.2 | -0.85 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
