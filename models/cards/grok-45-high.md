...
radar:
  ...
  reasoning: { s: 74.1, z: 2.0, r: 80.0, estimated: false }  # 추론
  ...
  instruction: { s: 75.3, z: 0.96, r: 64.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 80.0 | +2.0 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
