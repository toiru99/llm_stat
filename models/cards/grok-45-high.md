...
is_reasoning: true
radar:
  knowledge: { s: 81.4, z: 2.05, r: 80.7, estimated: false }  # 전문 지식
  reasoning: { s: 72.3, z: 1.9, r: 78.5, estimated: false }  # 추론
  coding: { s: 87.1, z: 1.71, r: 75.7, estimated: false }  # 코딩
  agentic: { s: 78.7, z: 1.62, r: 74.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.21/1M · 48.0 t/s · TTFT 12.68s · 500k ctx` · 가성비 46.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.7 | +2.05 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 43.0%×0.3 |
| 추론 | 78.5 | +1.9 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 75.7 | +1.71 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 74.3 | +1.62 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
