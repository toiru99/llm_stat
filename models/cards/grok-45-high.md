...
radar:
  ...
  agentic: { s: 91.3, z: 2.14, r: 82.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 93.0 t/s · TTFT 10.47s · 500k ctx` · 가성비 40.0
...
| 에이전트 | 82.0 | +2.14 | 실측 | [[gdpval]] 52.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
