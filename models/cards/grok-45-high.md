...
is_reasoning: true
radar:
  knowledge: { s: 86.5, z: 2.23, r: 83.4, estimated: false }  # 전문 지식
  reasoning: { s: 73.6, z: 2.12, r: 81.7, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.86, r: 77.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 123.0 t/s · TTFT 8.88s · 500k ctx` · 가성비 40.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 83.4 | +2.23 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 81.7 | +2.12 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 77.8 | +1.86 | 실측 | [[scicode]] 54.0%×1.0 |
