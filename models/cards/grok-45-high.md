...
radar:
  ...
  reasoning: { s: 74.1, z: 1.85, r: 77.8, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.68, r: 75.2, estimated: false }  # 코딩
  agentic: { s: 79.2, z: 1.61, r: 74.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.21/1M · 56.0 t/s · TTFT 12.09s · 500k ctx` · 가성비 46.3
...
| 추론 | 77.8 | +1.85 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 75.2 | +1.68 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 74.1 | +1.61 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
