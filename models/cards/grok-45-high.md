...
radar:
  ...
  reasoning: { s: 74.1, z: 1.89, r: 78.3, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.7, r: 75.6, estimated: false }  # 코딩
  agentic: { s: 79.2, z: 1.66, r: 74.9, estimated: false }  # 에이전트
  trust: { s: 51.2, z: 1.05, r: 65.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.21/1M · 50.0 t/s · TTFT 14.03s · 500k ctx` · 가성비 46.3
...
| 추론 | 78.3 | +1.89 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 75.6 | +1.7 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 74.9 | +1.66 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
| 신뢰성 | 65.7 | +1.05 | 실측 | [[aa-omniscience]] 46.0%×1.0 |
