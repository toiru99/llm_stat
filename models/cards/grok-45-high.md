...
radar:
  ...
  reasoning: { s: 74.5, z: 1.96, r: 79.4, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.77, r: 76.6, estimated: false }  # 코딩
  agentic: { s: 79.2, z: 1.73, r: 75.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 76.3, z: 0.94, r: 64.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.21/1M · 61.0 t/s · TTFT 7.86s · 500k ctx` · 가성비 46.3
...
| 추론 | 79.4 | +1.96 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 76.6 | +1.77 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 75.9 | +1.73 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
