...
radar:
  ...
  agentic: { s: 79.2, z: 1.68, r: 75.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.21/1M · 67.0 t/s · TTFT 9.64s · 500k ctx` · 가성비 46.3
...
| 에이전트 | 75.2 | +1.68 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
