...
radar:
  ...
  agentic: { s: 77.5, z: 1.53, r: 73.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 151.0 t/s · TTFT 144.65s · 1M ctx` · 가성비 19.8
...
| 에이전트 | 73.0 | +1.53 | 실측 | [[apex-agents]] 33.0%×1.0, [[gdpval]] 41.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 40.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
