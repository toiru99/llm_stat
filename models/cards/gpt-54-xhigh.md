...
radar:
  ...
  agentic: { s: 81.5, z: 1.76, r: 76.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.17/1M · 139.0 t/s · TTFT 106.14s · 1M ctx` · 가성비 23.5
...
| 에이전트 | 76.4 | +1.76 | 실측 | [[apex-agents]] 33.0%×1.0, [[gdpval]] 45.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
