...
radar:
  ...
  reasoning: { s: 82.8, z: 2.57, r: 88.6, estimated: false }  # 추론
  coding: { s: 92.6, z: 1.95, r: 79.2, estimated: false }  # 코딩
  agentic: { s: 81.5, z: 1.75, r: 76.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 152.0 t/s · TTFT 124.01s · 1M ctx`
...
| 추론 | 88.6 | +2.57 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 79.2 | +1.95 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 76.3 | +1.75 | 실측 | [[apex-agents]] 33.0%×1.0, [[gdpval]] 45.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
