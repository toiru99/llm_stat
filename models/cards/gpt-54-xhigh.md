...
radar:
  ...
  agentic: { s: 78.2, z: 1.63, r: 74.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 121.0 t/s · TTFT 142.25s · 1M ctx` · 가성비 24.4
...
| 에이전트 | 74.5 | +1.63 | 실측 | [[apex-agents]] 33.0%×1.0, [[gdpval]] 45.0%×1.0, [[tau2-bench]] 87.0%×1.0, [[tau3-banking]] 40.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
