...
radar:
  ...
  coding: { s: 55.1, z: 0.39, r: 55.9, estimated: false }  # 코딩
  agentic: { s: 43.7, z: 0.3, r: 54.5, estimated: false }  # 에이전트
...
| 코딩 | 55.9 | +0.39 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 54.5 | +0.3 | 실측 | [[tau2-bench]] 55.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
