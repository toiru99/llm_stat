...
is_reasoning: false
radar:
  knowledge: { s: 48.3, z: 0.34, r: 55.0, estimated: false }  # 전문 지식
  reasoning: { s: 33.4, z: -0.05, r: 49.3, estimated: false }  # 추론
  coding: { s: 55.1, z: 0.34, r: 55.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 55.0 | +0.34 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 49.3 | -0.05 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 55.1 | +0.34 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
