...
is_reasoning: true
radar:
  knowledge: { s: 45.9, z: 0.26, r: 53.9, estimated: false }  # 전문 지식
  reasoning: { s: 32.5, z: -0.11, r: 48.3, estimated: false }  # 추론
  coding: { s: 53.6, z: 0.28, r: 54.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 53.9 | +0.26 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 48.3 | -0.11 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 54.1 | +0.28 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
