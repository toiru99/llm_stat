...
radar:
  ...
  trust: { s: 28.2, z: 0.18, r: 52.7, estimated: true }  # 신뢰성
...
Kimi · Open · Medium(49.1B) · 컨텍스트 1M · 종합지능 **3.0**
...
|---|---|---|---|---|
| 전문 지식 | 35.8 | -0.94 | 실측 | [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 2.0%×0.3 |
| 추론 | 38.3 | -0.78 | 실측 | [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 2.0%×1.0 |
| 코딩 | 41.9 | -0.54 | 실측 | [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 33.3 | -1.12 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
| 신뢰성 | 52.7 | +0.18 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
