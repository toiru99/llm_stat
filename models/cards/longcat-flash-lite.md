...
radar:
  ...
  reasoning: { s: 24.6, z: -0.48, r: 42.8, estimated: false }  # 추론
  coding: { s: 36.7, z: -0.41, r: 43.8, estimated: false }  # 코딩
...
| 추론 | 42.8 | -0.48 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 43.8 | -0.41 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
