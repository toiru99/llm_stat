...
radar:
  ...
  coding: { s: 36.7, z: -0.45, r: 43.3, estimated: false }  # 코딩
  agentic: { s: 48.7, z: 0.51, r: 57.6, estimated: false }  # 에이전트
...
| 코딩 | 43.3 | -0.45 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 57.6 | +0.51 | 실측 | [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
