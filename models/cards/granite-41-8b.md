...
radar:
  ...
  coding: { s: 23.7, z: -0.98, r: 35.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.1 · 혼합 $0.055/1M · 108.0 t/s · TTFT 0.77s · 131k ctx` · 가성비 109.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 35.3 | -0.98 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 35.1 | -0.99 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 35.4 | -0.98 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 36.5 | -0.9 | 실측 | [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
