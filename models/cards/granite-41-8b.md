...
radar:
  ...
  coding: { s: 23.7, z: -0.98, r: 35.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.1 · 혼합 $0.055/1M · 101.0 t/s · TTFT 0.77s · 131k ctx` · 가성비 109.1
...
| 에이전트 | 36.4 | -0.9 | 실측 | [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
