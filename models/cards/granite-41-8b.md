...
is_reasoning: false
radar:
  knowledge: { s: 20.3, z: -0.98, r: 35.3, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.05 · 출력 $0.1 · 혼합 $0.055/1M · 102.0 t/s · TTFT 0.81s · 131k ctx` · 가성비 109.1
...
| 에이전트 | 35.5 | -0.97 | 실측 | [[tau2-bench]] 28.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
