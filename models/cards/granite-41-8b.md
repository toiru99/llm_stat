...
is_reasoning: false
radar:
  knowledge: { s: 20.2, z: -1.0, r: 34.9, estimated: false }  # 전문 지식
  reasoning: { s: 14.8, z: -1.02, r: 34.8, estimated: false }  # 추론
  coding: { s: 24.4, z: -0.98, r: 35.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.1 · 혼합 $0.055/1M · 122.0 t/s · TTFT 0.75s · 131k ctx` · 가성비 109.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 34.9 | -1.0 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.8 | -1.02 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 35.2 | -0.98 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
