...
radar:
  ...
  coding: { s: 24.4, z: -0.97, r: 35.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.1 · 혼합 $0.055/1M · 118.0 t/s · TTFT 0.75s · 131k ctx` · 가성비 109.1
...
| 코딩 | 35.5 | -0.97 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
