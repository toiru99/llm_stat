...
radar:
  ...
  reasoning: { s: 26.2, z: -0.41, r: 43.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $None/1M · 81.0 t/s · TTFT 1.79s · 64k ctx`
...
| 추론 | 43.8 | -0.41 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
