...
is_reasoning: true
radar:
  knowledge: { s: 37.6, z: -0.18, r: 47.4, estimated: false }  # 전문 지식
  reasoning: { s: 26.2, z: -0.42, r: 43.8, estimated: false }  # 추론
  coding: { s: 27.0, z: -0.84, r: 37.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $None/1M · 84.0 t/s · TTFT 1.79s · 64k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.4 | -0.18 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 43.8 | -0.42 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 37.5 | -0.84 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
