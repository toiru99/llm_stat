...
is_reasoning: true
radar:
  knowledge: { s: 36.1, z: -0.26, r: 46.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $0.72/1M · 73.0 t/s · TTFT 1.92s · 64k ctx` · 가성비 12.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.2 | -0.26 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
