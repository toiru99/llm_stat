...
radar:
  ...
  agentic: { s: 82.2, z: 1.79, r: 76.8, estimated: false }  # 에이전트
  trust: { s: 72.4, z: 2.1, r: 81.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 48.0 t/s · TTFT 14.07s · 1M ctx`
...
| 에이전트 | 76.8 | +1.79 | 실측 | [[gdpval]] 50.0%×1.0, [[itbench]] 47.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
| 신뢰성 | 81.4 | +2.1 | 실측 | [[aa-omniscience]] 64.0%×1.0 |
