...
radar:
  ...
  reasoning: { s: 69.6, z: 1.78, r: 76.7, estimated: false }  # 추론
  coding: { s: 87.4, z: 1.67, r: 75.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 52.0 t/s · TTFT 22.53s · 1M ctx` · 가성비 14.3
...
| 추론 | 76.7 | +1.78 | 실측 | [[critpt]] 12.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 75.0 | +1.67 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
