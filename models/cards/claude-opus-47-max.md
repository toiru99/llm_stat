...
radar:
  ...
  instruction: { s: 66.2, z: 0.56, r: 58.4, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 50.0 t/s · TTFT 15.95s · 1M ctx` · 가성비 11.4
...
| 지시 따르기 | 58.4 | +0.56 | 실측 | [[ifbench]] 59.0%×1.0 |
