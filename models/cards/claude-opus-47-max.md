...
is_reasoning: true
radar:
  knowledge: { s: 80.0, z: 1.89, r: 78.4, estimated: false }  # 전문 지식
  reasoning: { s: 69.6, z: 1.87, r: 78.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 53.0 t/s · TTFT 20.58s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 78.4 | +1.89 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 78.1 | +1.87 | 실측 | [[critpt]] 12.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
