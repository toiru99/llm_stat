...
radar:
  ...
  agentic: { s: 88.8, z: 1.48, r: 72.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 51.0 t/s · TTFT 18.32s · 1M ctx` · 가성비 14.0
...
| 에이전트 | 72.2 | +1.48 | 실측 | [[gdpval]] 50.0%×1.0, [[itbench]] 47.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
