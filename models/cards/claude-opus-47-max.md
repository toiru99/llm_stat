...
radar:
  ...
  agentic: { s: 78.8, z: 1.71, r: 75.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 46.0 t/s · TTFT 13.64s · 1M ctx` · 가성비 14.3
...
| 에이전트 | 75.6 | +1.71 | 실측 | [[gdpval]] 49.0%×1.0, [[itbench]] 47.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 35.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
