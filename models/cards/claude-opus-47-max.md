...
radar:
  ...
  agentic: { s: 89.1, z: 1.43, r: 71.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 50.0 t/s · TTFT 19.57s · 1M ctx` · 가성비 14.0
...
| 에이전트 | 71.4 | +1.43 | 실측 | [[gdpval]] 50.0%×1.0, [[itbench]] 47.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
