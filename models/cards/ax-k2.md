...
radar:
  ...
  reasoning: { s: 57.1, z: 1.14, r: 67.2, estimated: false }  # 추론
  ...
  instruction: { s: 89.0, z: 1.54, r: 73.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 67.2 | +1.14 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
