...
is_reasoning: true
radar:
  knowledge: { s: 64.6, z: 1.18, r: 67.7, estimated: false }  # 전문 지식
  reasoning: { s: 49.4, z: 0.72, r: 60.8, estimated: false }  # 추론
  ...
  instruction: { s: 75.6, z: 0.95, r: 64.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 107.0 t/s · TTFT 2.75s · 1M ctx` · 가성비 224.1
...
| 에이전트 | 54.5 | +0.3 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
