...
radar:
  ...
  agentic: { s: 47.2, z: 0.41, r: 56.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 117.0 t/s · TTFT 2.49s · 1M ctx` · 가성비 224.1
...
| 에이전트 | 56.1 | +0.41 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
