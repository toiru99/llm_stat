...
radar:
  ...
  reasoning: { s: 50.8, z: 0.79, r: 61.8, estimated: false }  # 추론
  coding: { s: 76.7, z: 1.22, r: 68.2, estimated: false }  # 코딩
  agentic: { s: 46.8, z: 0.43, r: 56.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 157.0 t/s · TTFT 2.39s · 1M ctx` · 가성비 224.1
...
| 추론 | 61.8 | +0.79 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 68.2 | +1.22 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 56.4 | +0.43 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
