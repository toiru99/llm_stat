...
radar:
  ...
  reasoning: { s: 50.4, z: 0.71, r: 60.7, estimated: false }  # 추론
  ...
  instruction: { s: 76.1, z: 0.88, r: 63.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 120.0 t/s · TTFT 2.73s · 1M ctx` · 가성비 224.1
...
| 추론 | 60.7 | +0.71 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
