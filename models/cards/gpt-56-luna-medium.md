...
radar:
  ...
  agentic: { s: 46.8, z: 0.4, r: 55.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 75.2, z: 0.85, r: 62.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 141.0 t/s · TTFT 2.31s · 1M ctx` · 가성비 224.1
...
| 에이전트 | 55.9 | +0.4 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
