...
radar:
  ...
  agentic: { s: 50.7, z: 0.56, r: 58.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $None/1M · 164.0 t/s · TTFT 2.08s · 1M ctx`
...
| 추론 | 61.8 | +0.79 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 68.5 | +1.24 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 58.4 | +0.56 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 15.0%×1.0 |
