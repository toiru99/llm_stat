...
radar:
  knowledge: { s: 57.3, z: 0.26, r: 54.0, estimated: false }  # 전문 지식
  ...
  long_context: { s: 79.7, z: 0.32, r: 54.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 47.0 t/s · TTFT 1.24s · 1M ctx` · 가성비 14.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.0 | +0.26 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
...
| 긴문맥 | 54.9 | +0.32 | 실측 | [[aa-lcr]] 59.0%×1.0 |
