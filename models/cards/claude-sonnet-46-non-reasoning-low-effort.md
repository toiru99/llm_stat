...
radar:
  ...
  coding: { s: 70.1, z: 0.96, r: 64.4, estimated: false }  # 코딩
  agentic: { s: 71.7, z: 1.37, r: 70.6, estimated: false }  # 에이전트
  trust: { s: 44.8, z: 0.77, r: 61.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 43.0 t/s · TTFT 1.23s · 1M ctx` · 가성비 14.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.3 | +0.76 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 50.5 | +0.04 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 64.4 | +0.96 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 70.6 | +1.37 | 실측 | [[tau2-bench]] 79.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
| 신뢰성 | 61.5 | +0.77 | 실측 | [[aa-omniscience]] 40.0%×1.0 |
