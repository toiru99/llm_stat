...
radar:
  ...
  coding: { s: 70.1, z: 0.9, r: 63.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 43.0 t/s · TTFT 1.85s · 1M ctx` · 가성비 15.2
...
| 코딩 | 63.4 | +0.9 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
