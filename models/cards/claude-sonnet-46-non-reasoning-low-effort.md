...
radar:
  ...
  coding: { s: 70.1, z: 1.0, r: 65.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 45.0 t/s · TTFT 1.28s · 1M ctx`
...
| 코딩 | 65.0 | +1.0 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
