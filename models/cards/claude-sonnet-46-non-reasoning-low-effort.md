...
radar:
  ...
  reasoning: { s: 34.7, z: -0.06, r: 49.2, estimated: false }  # 추론
  coding: { s: 70.1, z: 0.87, r: 63.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 48.0 t/s · TTFT 1.56s · 1M ctx` · 가성비 15.2
...
| 추론 | 49.2 | -0.06 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
