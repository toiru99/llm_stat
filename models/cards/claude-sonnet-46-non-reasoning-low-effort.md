...
radar:
  ...
  reasoning: { s: 35.0, z: 0.0, r: 50.1, estimated: false }  # 추론
  coding: { s: 70.1, z: 0.94, r: 64.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 42.0 t/s · TTFT 1.52s · 1M ctx` · 가성비 15.2
...
| 추론 | 50.1 | +0.0 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 64.1 | +0.94 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 71.4 | +1.42 | 실측 | [[tau2-bench]] 79.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
