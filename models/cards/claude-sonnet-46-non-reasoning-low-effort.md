...
radar:
  ...
  agentic: { s: 73.2, z: 0.84, r: 62.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 46.0 t/s · TTFT 1.36s · 1M ctx` · 가성비 14.7
...
| 에이전트 | 62.6 | +0.84 | 실측 | [[tau2-bench]] 79.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
