...
is_reasoning: false
radar:
  knowledge: { s: 57.3, z: 0.75, r: 61.3, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 43.0 t/s · TTFT 1.17s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.3 | +0.75 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
