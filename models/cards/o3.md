...
is_reasoning: true
radar:
  knowledge: { s: 63.2, z: 1.03, r: 65.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $None/1M · 125.0 t/s · TTFT 4.97s · 200k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.4 | +1.03 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
