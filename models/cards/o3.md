...
radar:
  ...
  coding: { s: 64.2, z: 0.76, r: 61.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $1.55/1M · 123.0 t/s · TTFT 5.53s · 200k ctx` · 가성비 19.4
...
| 코딩 | 61.3 | +0.76 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 37.0%×0.5 |
