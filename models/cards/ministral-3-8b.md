...
is_reasoning: false
radar:
  knowledge: { s: 21.2, z: -0.93, r: 36.1, estimated: false }  # 전문 지식
  reasoning: { s: 16.6, z: -0.89, r: 36.7, estimated: false }  # 추론
  coding: { s: 25.9, z: -0.85, r: 37.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $0.15 · 혼합 $0.15/1M · 82.0 t/s · TTFT 0.79s · 256k ctx` · 가성비 60.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 36.1 | -0.93 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 36.7 | -0.89 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 37.2 | -0.85 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
