...
radar:
  ...
  instruction: { s: 23.9, z: -1.18, r: 32.3, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.15 · 혼합 $0.15/1M · 105.0 t/s · TTFT 0.76s · 256k ctx` · 가성비 60.0
...
| 지시 따르기 | 32.3 | -1.18 | 실측 | [[ifbench]] 29.0%×1.0 |
