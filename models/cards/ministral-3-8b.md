...
radar:
  ...
  coding: { s: 25.1, z: -0.92, r: 36.3, estimated: false }  # 코딩
  agentic: { s: 10.7, z: -1.03, r: 34.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.15 · 혼합 $0.15/1M · 117.0 t/s · TTFT 0.78s · 256k ctx` · 가성비 60.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 36.7 | -0.88 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 34.5 | -1.03 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 27.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
