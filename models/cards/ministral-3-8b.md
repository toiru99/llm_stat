...
is_reasoning: false
radar:
  knowledge: { s: 22.3, z: -0.91, r: 36.4, estimated: false }  # 전문 지식
  reasoning: { s: 16.4, z: -0.94, r: 35.9, estimated: false }  # 추론
  coding: { s: 25.9, z: -0.93, r: 36.1, estimated: false }  # 코딩
  agentic: { s: 10.7, z: -1.03, r: 34.6, estimated: false }  # 에이전트
  trust: { s: 4.7, z: -1.0, r: 34.9, estimated: false }  # 신뢰성
  multimodal: { s: 44.3, z: -1.36, r: 29.6, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.15 · 출력 $0.15 · 혼합 $0.15/1M · 122.0 t/s · TTFT 0.77s · 256k ctx` · 가성비 60.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 36.4 | -0.91 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 35.9 | -0.94 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 36.1 | -0.93 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
...
| 멀티모달 | 29.6 | -1.36 | 실측 | [[mmmu-pro]] 46.0%×1.0 |
