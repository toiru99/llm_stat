...
is_reasoning: false
radar:
  knowledge: { s: 23.7, z: -0.83, r: 37.6, estimated: false }  # 전문 지식
  reasoning: { s: 16.6, z: -0.89, r: 36.6, estimated: false }  # 추론
  coding: { s: 29.0, z: -0.75, r: 38.7, estimated: false }  # 코딩
...
| 에이전트 | 37.1 | -0.86 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 42.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
