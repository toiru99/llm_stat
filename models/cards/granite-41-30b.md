...
radar:
  ...
  reasoning: { s: 16.9, z: -0.89, r: 36.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 37.6 | -0.83 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 37.6 | -0.83 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 42.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
