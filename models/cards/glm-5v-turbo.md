...
is_reasoning: true
radar:
  knowledge: { s: 50.0, z: 0.48, r: 57.2, estimated: false }  # 전문 지식
  reasoning: { s: 38.1, z: 0.18, r: 52.7, estimated: false }  # 추론
  coding: { s: 64.0, z: 0.73, r: 61.0, estimated: false }  # 코딩
  agentic: { s: 75.0, z: 1.48, r: 72.1, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 57.2 | +0.48 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 52.7 | +0.18 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 61.0 | +0.73 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 72.1 | +1.48 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
