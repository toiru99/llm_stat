...
is_reasoning: true
radar:
  knowledge: { s: 50.0, z: 0.46, r: 56.9, estimated: false }  # 전문 지식
  reasoning: { s: 38.1, z: 0.16, r: 52.5, estimated: false }  # 추론
  coding: { s: 64.0, z: 0.71, r: 60.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 56.9 | +0.46 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 52.5 | +0.16 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
