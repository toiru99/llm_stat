...
is_reasoning: true
radar:
  knowledge: { s: 50.9, z: 0.48, r: 57.3, estimated: false }  # 전문 지식
  reasoning: { s: 39.1, z: 0.21, r: 53.2, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 57.3 | +0.48 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 53.2 | +0.21 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
