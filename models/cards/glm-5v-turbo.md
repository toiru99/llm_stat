...
radar:
  knowledge: { s: 52.4, z: -0.17, r: 47.4, estimated: false }  # 전문 지식
  reasoning: { s: 38.8, z: -0.46, r: 43.1, estimated: false }  # 추론
  coding: { s: 65.6, z: 0.06, r: 51.0, estimated: false }  # 코딩
  agentic: { s: 75.0, z: 0.82, r: 62.3, estimated: false }  # 에이전트
  trust: { s: 35.0, z: 0.13, r: 52.0, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 47.4 | -0.17 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 43.1 | -0.46 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 51.0 | +0.06 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 62.3 | +0.82 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
| 신뢰성 | 52.0 | +0.13 | 실측 | [[aa-omniscience]] 32.0%×1.0 |
