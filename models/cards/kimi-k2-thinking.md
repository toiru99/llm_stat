...
radar:
  ...
  coding: { s: 62.3, z: 0.69, r: 60.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $2.5 · 혼합 $0.79/1M · 161.0 t/s · TTFT 1.28s · 256k ctx` · 가성비 41.8
...
| 코딩 | 60.3 | +0.69 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
