...
is_reasoning: true
radar:
  knowledge: { s: 56.1, z: 0.76, r: 61.4, estimated: false }  # 전문 지식
  reasoning: { s: 46.3, z: 0.6, r: 59.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.6 · 출력 $2.5 · 혼합 $0.79/1M · 134.0 t/s · TTFT 1.2s · 256k ctx` · 가성비 41.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.4 | +0.76 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 59.0 | +0.6 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
