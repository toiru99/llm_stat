...
is_reasoning: false
radar:
  knowledge: { s: 56.5, z: 0.76, r: 61.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.12 · 출력 $0.43 · 혼합 $None/1M · 105.0 t/s · TTFT 2.95s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.4 | +0.76 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
