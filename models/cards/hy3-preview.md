...
is_reasoning: false
radar:
  knowledge: { s: 56.5, z: 0.76, r: 61.5, estimated: false }  # 전문 지식
  reasoning: { s: 51.8, z: 0.95, r: 64.2, estimated: false }  # 추론
  coding: { s: 62.7, z: 0.69, r: 60.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.12 · 출력 $0.43 · 혼합 $None/1M · 128.0 t/s · TTFT 3.06s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.5 | +0.76 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 64.2 | +0.95 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 60.3 | +0.69 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
