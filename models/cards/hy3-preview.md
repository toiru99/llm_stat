...
is_reasoning: true
radar:
  knowledge: { s: 54.1, z: 0.69, r: 60.3, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 60.3 | +0.69 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
...
| 에이전트 | 70.8 | +1.39 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
