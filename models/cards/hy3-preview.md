...
is_reasoning: true
radar:
  knowledge: { s: 54.1, z: 0.66, r: 60.0, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 60.0 | +0.66 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
...
| 에이전트 | 70.5 | +1.37 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
