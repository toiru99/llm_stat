...
## 실용 지표
`입력 $0.12 · 출력 $0.43 · 혼합 $0.1/1M · 186.0 t/s · TTFT 3.1s · 256k ctx` · 가성비 340.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.8 | +0.79 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
...
| 에이전트 | 71.5 | +1.43 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
