...
radar:
  ...
  reasoning: { s: 69.3, z: 1.65, r: 74.8, estimated: false }  # 추론
  ...
  instruction: { s: 92.3, z: 1.65, r: 74.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 74.8 | +1.65 | 실측 | [[critpt]] 16.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
