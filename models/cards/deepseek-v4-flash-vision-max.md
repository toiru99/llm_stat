...
is_reasoning: true
radar:
  knowledge: { s: 66.4, z: 1.23, r: 68.5, estimated: false }  # 전문 지식
  reasoning: { s: 61.8, z: 1.29, r: 69.3, estimated: false }  # 추론
  ...
  instruction: { s: 84.8, z: 1.34, r: 70.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
DeepSeek · Proprietary · Large(284B) · 컨텍스트 1M · 종합지능 **42.0**
...
## 실용 지표
`입력 $0.44 · 출력 $1.32 · 혼합 $0.2298/1M · 124.0 t/s · TTFT 1.14s · 1M ctx` · 가성비 182.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.5 | +1.23 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 69.3 | +1.29 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 71.6 | +1.44 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 75.7 | +1.72 | 실측 | [[gdpval]] 54.0%×1.0, [[tau3-banking]] 41.0%×1.0 |
