...
is_reasoning: true
radar:
  knowledge: { s: 66.7, z: 1.28, r: 69.3, estimated: false }  # 전문 지식
  reasoning: { s: 62.2, z: 1.36, r: 70.3, estimated: false }  # 추론
  ...
  instruction: { s: 85.8, z: 1.37, r: 70.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.44 · 출력 $1.32 · 혼합 $0.2298/1M · 120.0 t/s · TTFT 1.11s · 1M ctx` · 가성비 221.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.3 | +1.28 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 70.3 | +1.36 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
