...
is_reasoning: false
radar:
  knowledge: { s: 54.9, z: 0.73, r: 60.9, estimated: false }  # 전문 지식
  reasoning: { s: 34.2, z: -0.01, r: 49.8, estimated: false }  # 추론
  coding: { s: 68.5, z: 0.92, r: 63.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 44.0 t/s · TTFT 2.09s · 1M ctx` · 가성비 15.2
...
| 추론 | 49.8 | -0.01 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 63.9 | +0.92 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 70.2 | +1.35 | 실측 | [[tau2-bench]] 79.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
