...
radar:
  ...
  trust: { s: 41.2, z: 0.82, r: 62.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.375/1M · 74.0 t/s · TTFT 1.29s · 128k ctx` · 가성비 3.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.35 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 2.0%×0.3 |
...
| 신뢰성 | 62.3 | +0.82 | 실측 | [[aa-omniscience]] 42.0%×1.0 |
