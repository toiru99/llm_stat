...
is_reasoning: false
radar:
  knowledge: { s: 35.0, z: -0.26, r: 46.0, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.38/1M · 108.0 t/s · TTFT 1.33s · 128k ctx` · 가성비 4.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.0 | -0.26 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
