...
radar:
  ...
  coding: { s: 40.7, z: -0.27, r: 45.9, estimated: false }  # 코딩
  agentic: { s: 20.7, z: -0.6, r: 41.0, estimated: false }  # 에이전트
  trust: { s: 46.5, z: 0.93, r: 63.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.375/1M · 89.0 t/s · TTFT 1.05s · 128k ctx` · 가성비 3.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.6 | -0.36 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 2.0%×0.3 |
| 추론 | 37.0 | -0.87 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 2.0%×1.0 |
| 코딩 | 45.9 | -0.27 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 41.0 | -0.6 | 실측 | [[tau2-bench]] 29.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
| 신뢰성 | 63.9 | +0.93 | 실측 | [[aa-omniscience]] 42.0%×1.0 |
