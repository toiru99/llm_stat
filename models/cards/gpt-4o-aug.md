...
is_reasoning: false
radar:
  knowledge: { s: 35.0, z: -0.3, r: 45.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $None/1M · 92.0 t/s · TTFT 1.04s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.6 | -0.3 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
