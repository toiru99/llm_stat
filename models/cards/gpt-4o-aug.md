...
radar:
  ...
  coding: { s: 40.7, z: -0.23, r: 46.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.38/1M · 89.0 t/s · TTFT 1.6s · 128k ctx` · 가성비 4.2
...
| 코딩 | 46.5 | -0.23 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
