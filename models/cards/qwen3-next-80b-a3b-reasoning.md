...
is_reasoning: true
radar:
  knowledge: { s: 38.6, z: -0.08, r: 48.7, estimated: false }  # 전문 지식
  reasoning: { s: 32.8, z: -0.08, r: 48.7, estimated: false }  # 추론
  coding: { s: 47.0, z: 0.01, r: 50.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $1.2 · 혼합 $0.255/1M · 195.0 t/s · TTFT 2.23s · 262k ctx` · 가성비 66.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.7 | -0.08 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
| 추론 | 48.7 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 50.2 | +0.01 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
