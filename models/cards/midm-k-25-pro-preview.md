...
is_reasoning: true
radar:
  knowledge: { s: 33.6, z: -0.33, r: 45.0, estimated: false }  # 전문 지식
  reasoning: { s: 28.9, z: -0.28, r: 45.8, estimated: false }  # 추론
  coding: { s: 33.8, z: -0.55, r: 41.8, estimated: false }  # 코딩
  agentic: { s: 27.0, z: -0.4, r: 44.1, estimated: false }  # 에이전트
...
| 에이전트 | 44.1 | -0.4 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
