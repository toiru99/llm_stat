...
is_reasoning: true
radar:
  knowledge: { s: 33.6, z: -0.34, r: 44.8, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.34 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 72.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
...
| 에이전트 | 43.9 | -0.4 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
