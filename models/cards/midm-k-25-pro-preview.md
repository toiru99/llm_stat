...
radar:
  ...
  coding: { s: 34.8, z: -0.51, r: 42.4, estimated: false }  # 코딩
  agentic: { s: 27.0, z: -0.37, r: 44.5, estimated: false }  # 에이전트
...
| 코딩 | 42.4 | -0.51 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
| 에이전트 | 44.5 | -0.37 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
