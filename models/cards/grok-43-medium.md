...
radar:
  ...
  agentic: { s: 68.7, z: 1.2, r: 67.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 117.0 t/s · TTFT 11.04s · 1M ctx` · 가성비 45.3
...
| 에이전트 | 67.9 | +1.2 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
