...
is_reasoning: true
radar:
  knowledge: { s: 57.8, z: 0.84, r: 62.5, estimated: false }  # 전문 지식
  reasoning: { s: 53.9, z: 1.07, r: 66.1, estimated: false }  # 추론
  coding: { s: 65.2, z: 0.8, r: 62.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 102.0 t/s · TTFT 13.61s · 1M ctx` · 가성비 56.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.5 | +0.84 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 66.1 | +1.07 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 62.1 | +0.8 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
