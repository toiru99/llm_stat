...
is_reasoning: true
radar:
  knowledge: { s: 57.8, z: 0.78, r: 61.7, estimated: false }  # 전문 지식
  reasoning: { s: 53.9, z: 0.98, r: 64.7, estimated: false }  # 추론
  coding: { s: 65.2, z: 0.76, r: 61.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $None/1M · 102.0 t/s · TTFT 12.84s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.7 | +0.78 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 64.7 | +0.98 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 61.5 | +0.76 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
