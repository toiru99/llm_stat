...
is_reasoning: true
radar:
  knowledge: { s: 56.2, z: 0.79, r: 61.8, estimated: false }  # 전문 지식
  reasoning: { s: 52.9, z: 0.92, r: 63.8, estimated: false }  # 추론
  coding: { s: 63.5, z: 0.71, r: 60.7, estimated: false }  # 코딩
  agentic: { s: 68.7, z: 1.23, r: 68.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 110.0 t/s · TTFT 9.33s · 1M ctx` · 가성비 57.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.8 | +0.79 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 30.0%×0.3 |
| 추론 | 63.8 | +0.92 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
| 코딩 | 60.7 | +0.71 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 68.4 | +1.23 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
