...
is_reasoning: true
radar:
  knowledge: { s: 57.8, z: 0.82, r: 62.4, estimated: false }  # 전문 지식
  reasoning: { s: 53.9, z: 1.05, r: 65.8, estimated: false }  # 추론
  coding: { s: 65.2, z: 0.79, r: 61.8, estimated: false }  # 코딩
  agentic: { s: 68.7, z: 1.26, r: 68.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $None/1M · 98.0 t/s · TTFT 14.07s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.4 | +0.82 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 65.8 | +1.05 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 61.8 | +0.79 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 68.8 | +1.26 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
