...
radar:
  ...
  coding: { s: 65.2, z: 0.8, r: 61.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 113.0 t/s · TTFT 13.08s · 1M ctx` · 가성비 56.2
...
| 코딩 | 61.9 | +0.8 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
