...
radar:
  ...
  reasoning: { s: 54.1, z: 0.99, r: 64.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 108.0 t/s · TTFT 12.83s · 1M ctx` · 가성비 57.8
...
| 추론 | 64.9 | +0.99 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
