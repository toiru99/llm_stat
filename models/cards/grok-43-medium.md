...
radar:
  ...
  agentic: { s: 69.8, z: 0.74, r: 61.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 140.0 t/s · TTFT 10.95s · 1M ctx` · 가성비 56.2
...
| 에이전트 | 61.1 | +0.74 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
