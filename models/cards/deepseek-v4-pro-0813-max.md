...
is_reasoning: true
radar:
  knowledge: { s: 78.2, z: 1.89, r: 78.3, estimated: false }  # 전문 지식
  reasoning: { s: 74.3, z: 2.0, r: 80.0, estimated: false }  # 추론
  coding: { s: 79.0, z: 1.37, r: 70.5, estimated: false }  # 코딩
  agentic: { s: 78.9, z: 1.63, r: 74.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.32 · 출력 $3.96 · 혼합 $0.6908/1M · 54.0 t/s · TTFT 1.65s · 1M ctx` · 가성비 76.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 78.3 | +1.89 | 실측 | [[aa-omniscience]] 49.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 41.0%×0.3 |
| 추론 | 80.0 | +2.0 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
