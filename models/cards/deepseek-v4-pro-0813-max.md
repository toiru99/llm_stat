...
radar:
  ...
  reasoning: { s: 76.0, z: 2.1, r: 81.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.32 · 출력 $3.96 · 혼합 $0.6908/1M · 64.0 t/s · TTFT 1.76s · 1M ctx` · 가성비 76.7
...
| 추론 | 81.4 | +2.1 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
