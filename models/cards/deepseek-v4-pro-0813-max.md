...
radar:
  ...
  reasoning: { s: 76.0, z: 1.98, r: 79.7, estimated: false }  # 추론
  coding: { s: 81.7, z: 1.36, r: 70.4, estimated: false }  # 코딩
  agentic: { s: 80.3, z: 1.7, r: 75.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.32 · 출력 $3.96 · 혼합 $0.6908/1M · 74.0 t/s · TTFT 1.67s · 1M ctx` · 가성비 76.7
...
| 추론 | 79.7 | +1.98 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 70.4 | +1.36 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 75.5 | +1.7 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 40.0%×1.0 |
