...
radar:
  ...
  reasoning: { s: 76.0, z: 1.94, r: 79.2, estimated: false }  # 추론
  coding: { s: 81.7, z: 1.34, r: 70.1, estimated: false }  # 코딩
  agentic: { s: 79.5, z: 1.62, r: 74.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.32 · 출력 $3.96 · 혼합 $0.6908/1M · 68.0 t/s · TTFT 1.48s · 1M ctx` · 가성비 76.7
...
| 추론 | 79.2 | +1.94 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 70.1 | +1.34 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 74.3 | +1.62 | 실측 | [[gdpval]] 54.0%×1.0, [[tau3-banking]] 40.0%×1.0 |
