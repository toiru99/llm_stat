...
radar:
  ...
  trust: { s: 69.8, z: 1.99, r: 79.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.55/1M · 125.0 t/s · TTFT 0.83s · 128k ctx` · 가성비 4.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.4 | -0.51 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 54.0%×0.4, [[humanitys-last-exam]] 2.0%×0.3 |
| 추론 | 37.6 | -0.83 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 54.0%×1.0, [[humanitys-last-exam]] 2.0%×1.0 |
