...
is_reasoning: false
radar:
  knowledge: { s: 31.6, z: -0.43, r: 43.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $2.55/1M · 209.0 t/s · TTFT 0.8s · 128k ctx` · 가성비 4.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.6 | -0.43 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 54.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
