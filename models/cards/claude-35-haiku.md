...
radar:
  ...
  coding: { s: 31.0, z: -0.7, r: 39.4, estimated: false }  # 코딩
  agentic: { s: 9.4, z: -1.07, r: 34.0, estimated: false }  # 에이전트
...
| 코딩 | 39.4 | -0.7 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 34.0 | -1.07 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
