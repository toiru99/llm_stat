...
radar:
  ...
  coding: { s: 31.0, z: -0.68, r: 39.8, estimated: false }  # 코딩
  agentic: { s: 9.4, z: -1.06, r: 34.2, estimated: false }  # 에이전트
  trust: { s: 66.3, z: 1.84, r: 77.6, estimated: false }  # 신뢰성
...
| 코딩 | 39.8 | -0.68 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 34.2 | -1.06 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
| 신뢰성 | 77.6 | +1.84 | 실측 | [[aa-omniscience]] 59.0%×1.0 |
