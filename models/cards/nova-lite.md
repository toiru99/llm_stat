...
is_reasoning: false
radar:
  knowledge: { s: 18.4, z: -1.1, r: 33.6, estimated: false }  # 전문 지식
  reasoning: { s: 14.8, z: -1.02, r: 34.7, estimated: false }  # 추론
  coding: { s: 16.1, z: -1.34, r: 29.9, estimated: false }  # 코딩
  agentic: { s: 9.8, z: -1.06, r: 34.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.24 · 혼합 $0.0465/1M · 160.0 t/s · TTFT 0.93s · 300k ctx` · 가성비 150.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 33.6 | -1.1 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.7 | -1.02 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 29.9 | -1.34 | 실측 | [[scicode]] 14.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 34.2 | -1.06 | 실측 | [[tau2-bench]] 18.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
