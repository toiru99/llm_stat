...
is_reasoning: true
radar:
  knowledge: { s: 85.2, z: 2.18, r: 82.7, estimated: false }  # 전문 지식
  reasoning: { s: 69.0, z: 1.89, r: 78.4, estimated: false }  # 추론
  coding: { s: 78.6, z: 1.39, r: 70.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 152.0 t/s · TTFT 16.42s · 1M ctx` · 가성비 34.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 82.7 | +2.18 | 실측 | [[aa-omniscience]] 51.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 78.4 | +1.89 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 70.9 | +1.39 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
