...
radar:
  ...
  coding: { s: 78.6, z: 1.38, r: 70.7, estimated: false }  # 코딩
  agentic: { s: 78.0, z: 1.63, r: 74.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 154.0 t/s · TTFT 21.38s · 1M ctx` · 가성비 34.4
...
| 코딩 | 70.7 | +1.38 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 74.4 | +1.63 | 실측 | [[tau2-bench]] 96.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
