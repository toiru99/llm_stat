...
radar:
  ...
  agentic: { s: 79.4, z: 1.09, r: 66.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 187.0 t/s · TTFT 16.8s · 1M ctx` · 가성비 34.4
...
| 에이전트 | 66.4 | +1.09 | 실측 | [[tau2-bench]] 96.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
