...
radar:
  ...
  reasoning: { s: 68.3, z: 1.6, r: 74.1, estimated: false }  # 추론
  coding: { s: 78.6, z: 1.24, r: 68.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 180.0 t/s · TTFT 20.69s · 1M ctx` · 가성비 36.0
...
| 추론 | 74.1 | +1.6 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 68.5 | +1.24 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
