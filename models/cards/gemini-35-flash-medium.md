...
radar:
  ...
  agentic: { s: 79.4, z: 1.12, r: 66.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 173.0 t/s · TTFT 16.18s · 1M ctx` · 가성비 34.4
...
| 에이전트 | 66.8 | +1.12 | 실측 | [[tau2-bench]] 96.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
