...
is_reasoning: true
radar:
  knowledge: { s: 81.7, z: 1.92, r: 78.8, estimated: false }  # 전문 지식
  reasoning: { s: 68.3, z: 1.58, r: 73.7, estimated: false }  # 추론
  coding: { s: 78.6, z: 1.22, r: 68.3, estimated: false }  # 코딩
  agentic: { s: 78.0, z: 1.57, r: 73.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 196.0 t/s · TTFT 15.75s · 1M ctx` · 가성비 36.0
...
| 추론 | 73.7 | +1.58 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 68.3 | +1.22 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 73.5 | +1.57 | 실측 | [[tau2-bench]] 96.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
