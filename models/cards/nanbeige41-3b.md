...
radar:
  ...
  reasoning: { s: 35.5, z: 0.1, r: 51.5, estimated: false }  # 추론
  coding: { s: 30.0, z: -0.69, r: 39.7, estimated: false }  # 코딩
  agentic: { s: 5.6, z: -1.19, r: 32.1, estimated: false }  # 에이전트
  trust: { s: 49.4, z: 1.02, r: 65.4, estimated: false }  # 신뢰성
...
| 추론 | 51.5 | +0.1 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
...
| 신뢰성 | 65.4 | +1.02 | 실측 | [[aa-omniscience]] 43.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
