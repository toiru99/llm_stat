...
radar:
  ...
  agentic: { s: 66.0, z: 1.15, r: 67.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.7/1M · 46.0 t/s · TTFT 2.67s · 256k ctx` · 가성비 62.9
...
| 에이전트 | 67.3 | +1.15 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 35.0%×1.0, [[itbench]] 31.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
