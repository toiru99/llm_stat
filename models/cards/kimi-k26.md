...
radar:
  ...
  agentic: { s: 67.7, z: 0.66, r: 59.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.7/1M · 43.0 t/s · TTFT 2.31s · 256k ctx` · 가성비 61.4
...
| 에이전트 | 59.9 | +0.66 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 35.0%×1.0, [[itbench]] 31.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
