...
is_reasoning: true
radar:
  knowledge: { s: 68.9, z: 1.39, r: 70.8, estimated: false }  # 전문 지식
  reasoning: { s: 47.8, z: 0.77, r: 61.5, estimated: false }  # 추론
  coding: { s: 70.3, z: 1.04, r: 65.6, estimated: false }  # 코딩
  agentic: { s: 66.7, z: 1.19, r: 67.9, estimated: false }  # 에이전트
  trust: { s: 41.2, z: 0.64, r: 59.6, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.39 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 61.5 | +0.77 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 65.6 | +1.04 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 67.9 | +1.19 | 실측 | [[tau2-bench]] 75.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
| 신뢰성 | 59.6 | +0.64 | 실측 | [[aa-omniscience]] 36.0%×1.0 |
