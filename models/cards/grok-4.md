...
is_reasoning: true
radar:
  knowledge: { s: 65.9, z: 1.16, r: 67.5, estimated: false }  # 전문 지식
  reasoning: { s: 48.7, z: 0.64, r: 59.5, estimated: false }  # 추론
  coding: { s: 70.3, z: 0.89, r: 63.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 67.5 | +1.16 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 59.5 | +0.64 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 63.3 | +0.89 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 67.1 | +1.14 | 실측 | [[tau2-bench]] 75.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
