...
radar:
  ...
  reasoning: { s: 49.1, z: 0.71, r: 60.6, estimated: false }  # 추론
...
| 추론 | 60.6 | +0.71 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 64.3 | +0.95 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 68.4 | +1.23 | 실측 | [[tau2-bench]] 75.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
