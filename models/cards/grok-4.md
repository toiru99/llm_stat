...
is_reasoning: true
radar:
  knowledge: { s: 68.9, z: 1.38, r: 70.7, estimated: false }  # 전문 지식
  reasoning: { s: 47.8, z: 0.75, r: 61.3, estimated: false }  # 추론
  coding: { s: 70.3, z: 1.03, r: 65.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 70.7 | +1.38 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 61.3 | +0.75 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 65.4 | +1.03 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
