...
is_reasoning: true
radar:
  knowledge: { s: 68.9, z: 1.29, r: 69.4, estimated: false }  # 전문 지식
  reasoning: { s: 47.8, z: 0.65, r: 59.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $4.2/1M · None t/s · TTFT Nones · 256k ctx` · 가성비 7.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.4 | +1.29 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 59.8 | +0.65 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 64.3 | +0.95 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 68.5 | +1.24 | 실측 | [[tau2-bench]] 75.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
