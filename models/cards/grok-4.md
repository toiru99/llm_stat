...
is_reasoning: true
radar:
  knowledge: { s: 68.9, z: 1.36, r: 70.4, estimated: false }  # 전문 지식
  reasoning: { s: 47.8, z: 0.74, r: 61.0, estimated: false }  # 추론
  coding: { s: 70.3, z: 1.0, r: 65.1, estimated: false }  # 코딩
  agentic: { s: 66.7, z: 1.18, r: 67.7, estimated: false }  # 에이전트
  trust: { s: 40.2, z: 0.61, r: 59.2, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 70.4 | +1.36 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 61.0 | +0.74 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 65.1 | +1.0 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
