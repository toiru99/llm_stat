...
radar:
  ...
  reasoning: { s: 37.8, z: 0.09, r: 51.4, estimated: false }  # 추론
  coding: { s: 60.2, z: 0.47, r: 57.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 90.0 t/s · TTFT 12.28s · 400k ctx` · 가성비 119.6
...
| 추론 | 51.4 | +0.09 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.0 | +0.47 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
