...
radar:
  ...
  reasoning: { s: 37.8, z: 0.1, r: 51.5, estimated: false }  # 추론
  coding: { s: 60.2, z: 0.47, r: 57.1, estimated: false }  # 코딩
  agentic: { s: 57.8, z: 0.8, r: 62.0, estimated: false }  # 에이전트
  trust: { s: 62.8, z: 1.49, r: 72.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 110.0 t/s · TTFT 15.46s · 400k ctx` · 가성비 119.6
...
| 추론 | 51.5 | +0.1 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.1 | +0.47 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 62.0 | +0.8 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
| 신뢰성 | 72.3 | +1.49 | 실측 | [[aa-omniscience]] 56.0%×1.0 |
