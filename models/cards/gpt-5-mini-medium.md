...
is_reasoning: true
radar:
  knowledge: { s: 44.1, z: 0.19, r: 52.9, estimated: false }  # 전문 지식
  reasoning: { s: 37.1, z: 0.13, r: 52.0, estimated: false }  # 추론
  coding: { s: 58.7, z: 0.51, r: 57.6, estimated: false }  # 코딩
  agentic: { s: 57.8, z: 0.81, r: 62.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 111.0 t/s · TTFT 11.11s · 400k ctx` · 가성비 119.6
...
| 추론 | 52.0 | +0.13 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.6 | +0.51 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 62.1 | +0.81 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
