...
is_reasoning: true
radar:
  knowledge: { s: 44.7, z: 0.19, r: 52.8, estimated: false }  # 전문 지식
  reasoning: { s: 38.1, z: 0.16, r: 52.4, estimated: false }  # 추론
  coding: { s: 60.2, z: 0.53, r: 58.0, estimated: false }  # 코딩
  agentic: { s: 57.8, z: 0.87, r: 63.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 92.0 t/s · TTFT 12.24s · 400k ctx` · 가성비 119.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.8 | +0.19 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
...
| 에이전트 | 63.1 | +0.87 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
