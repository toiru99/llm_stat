...
is_reasoning: true
radar:
  knowledge: { s: 44.9, z: 0.22, r: 53.2, estimated: false }  # 전문 지식
  reasoning: { s: 37.8, z: 0.22, r: 53.4, estimated: false }  # 추론
  coding: { s: 60.2, z: 0.59, r: 58.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.27/1M · 92.0 t/s · TTFT 12.05s · 400k ctx` · 가성비 114.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.2 | +0.22 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 53.4 | +0.22 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 58.9 | +0.59 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
