...
radar:
  knowledge: { s: 86.2, z: 1.56, r: 73.4, estimated: false }  # 전문 지식
  reasoning: { s: 75.8, z: 1.47, r: 72.1, estimated: false }  # 추론
  coding: { s: 86.9, z: 1.19, r: 67.8, estimated: false }  # 코딩
  agentic: { s: 85.5, z: 1.33, r: 70.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 88.0 t/s · TTFT 85.73s · 400k ctx` · 가성비 23.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.4 | +1.56 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
...
| 에이전트 | 70.0 | +1.33 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
