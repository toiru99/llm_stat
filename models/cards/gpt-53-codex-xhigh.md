...
is_reasoning: true
radar:
  knowledge: { s: 86.2, z: 2.22, r: 83.3, estimated: false }  # 전문 지식
  reasoning: { s: 75.2, z: 2.21, r: 83.1, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.68, r: 75.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 81.0 t/s · TTFT 123.84s · 400k ctx` · 가성비 23.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 83.3 | +2.22 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 83.1 | +2.21 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 75.1 | +1.68 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
