...
radar:
  ...
  reasoning: { s: 73.4, z: 1.91, r: 78.7, estimated: false }  # 추론
  coding: { s: 83.8, z: 1.54, r: 73.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 118.0 t/s · TTFT 63.6s · 400k ctx` · 가성비 24.6
...
| 코딩 | 73.1 | +1.54 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
