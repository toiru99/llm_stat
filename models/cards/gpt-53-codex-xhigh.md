...
is_reasoning: true
radar:
  knowledge: { s: 84.1, z: 2.16, r: 82.3, estimated: false }  # 전문 지식
  reasoning: { s: 75.2, z: 2.06, r: 80.9, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.6, r: 73.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 123.0 t/s · TTFT 65.51s · 400k ctx` · 가성비 24.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 82.3 | +2.16 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 80.9 | +2.06 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 73.9 | +1.6 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
