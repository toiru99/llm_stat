...
radar:
  ...
  agentic: { s: 85.5, z: 1.36, r: 70.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 92.0 t/s · TTFT 109.34s · 400k ctx` · 가성비 23.5
...
| 에이전트 | 70.3 | +1.36 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
