...
radar:
  ...
  coding: { s: 80.3, z: 1.69, r: 75.4, estimated: false }  # 코딩
  agentic: { s: 83.6, z: 1.76, r: 76.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 88.7, z: 1.51, r: 72.7, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 134.0 t/s · TTFT 70.0s · 400k ctx` · 가성비 19.8
...
| 코딩 | 75.4 | +1.69 | 실측 | [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 76.5 | +1.76 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
| 신뢰성 | 39.3 | -0.72 | 실측 | [[aa-omniscience]] 11.0%×1.0 |
| 멀티모달 | 62.9 | +0.86 | 실측 | [[mmmu-pro]] 78.0%×1.0 |
| 긴문맥 | 70.4 | +1.36 | 실측 | [[aa-lcr]] 83.0%×1.0 |
| 지시 따르기 | 72.7 | +1.51 | 실측 | [[ifbench]] 75.0%×1.0 |
