...
is_reasoning: true
radar:
  knowledge: { s: 84.2, z: 2.08, r: 81.3, estimated: false }  # 전문 지식
  reasoning: { s: 75.6, z: 2.02, r: 80.3, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.59, r: 73.8, estimated: false }  # 코딩
  agentic: { s: 83.6, z: 1.9, r: 78.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 126.0 t/s · TTFT 62.62s · 400k ctx` · 가성비 24.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 81.3 | +2.08 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 80.3 | +2.02 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 73.8 | +1.59 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 78.4 | +1.9 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
