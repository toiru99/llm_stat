...
radar:
  ...
  reasoning: { s: 75.2, z: 1.94, r: 79.1, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.53, r: 72.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 125.0 t/s · TTFT 74.62s · 400k ctx` · 가성비 24.6
...
| 추론 | 79.1 | +1.94 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 72.9 | +1.53 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
