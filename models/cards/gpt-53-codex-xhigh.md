...
radar:
  ...
  agentic: { s: 85.5, z: 1.32, r: 69.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 85.0 t/s · TTFT 84.67s · 400k ctx` · 가성비 23.5
...
| 에이전트 | 69.8 | +1.32 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
