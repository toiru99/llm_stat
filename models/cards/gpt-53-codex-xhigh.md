...
is_reasoning: true
radar:
  knowledge: { s: 81.7, z: 2.06, r: 80.9, estimated: false }  # 전문 지식
  reasoning: { s: 73.4, z: 1.95, r: 79.3, estimated: false }  # 추론
  coding: { s: 83.8, z: 1.57, r: 73.6, estimated: false }  # 코딩
  agentic: { s: 83.6, z: 1.81, r: 77.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 118.0 t/s · TTFT 54.46s · 400k ctx` · 가성비 24.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.9 | +2.06 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 79.3 | +1.95 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 73.6 | +1.57 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 77.2 | +1.81 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
