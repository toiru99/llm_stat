...
is_reasoning: true
radar:
  knowledge: { s: 86.2, z: 2.23, r: 83.5, estimated: false }  # 전문 지식
  reasoning: { s: 75.2, z: 2.22, r: 83.3, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.69, r: 75.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 83.5 | +2.23 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 83.3 | +2.22 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 75.4 | +1.69 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
