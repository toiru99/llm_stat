...
radar:
  ...
  reasoning: { s: 75.2, z: 2.18, r: 82.6, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.66, r: 74.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 143.0 t/s · TTFT 62.98s · 400k ctx`
...
| 추론 | 82.6 | +2.18 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 74.8 | +1.66 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
