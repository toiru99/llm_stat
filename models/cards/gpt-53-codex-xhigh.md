...
radar:
  knowledge: { s: 86.2, z: 1.57, r: 73.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 92.0 t/s · TTFT 88.52s · 400k ctx` · 가성비 23.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.5 | +1.57 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
