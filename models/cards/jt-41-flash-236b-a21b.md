...
is_reasoning: false
radar:
  knowledge: { s: 47.7, z: 0.36, r: 55.3, estimated: false }  # 전문 지식
  reasoning: { s: 39.4, z: 0.31, r: 54.7, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.73, r: 61.0, estimated: false }  # 코딩
  agentic: { s: 72.6, z: 1.42, r: 71.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 55.3 | +0.36 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 54.7 | +0.31 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 61.0 | +0.73 | 실측 | [[scicode]] 38.0%×1.0 |
| 에이전트 | 71.2 | +1.42 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
