...
is_reasoning: false
radar:
  knowledge: { s: 47.7, z: 0.31, r: 54.6, estimated: false }  # 전문 지식
  reasoning: { s: 39.4, z: 0.25, r: 53.8, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.69, r: 60.3, estimated: false }  # 코딩
  agentic: { s: 70.4, z: 1.32, r: 69.7, estimated: false }  # 에이전트
  trust: { s: 64.4, z: 1.71, r: 75.6, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 54.6 | +0.31 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 53.8 | +0.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 60.3 | +0.69 | 실측 | [[scicode]] 38.0%×1.0 |
| 에이전트 | 69.7 | +1.32 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
| 신뢰성 | 75.6 | +1.71 | 실측 | [[aa-omniscience]] 57.0%×1.0 |
