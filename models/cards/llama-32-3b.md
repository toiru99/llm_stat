...
is_reasoning: false
radar:
  knowledge: { s: 13.0, z: -1.36, r: 29.6, estimated: false }  # 전문 지식
  reasoning: { s: 12.3, z: -1.11, r: 33.3, estimated: false }  # 추론
  coding: { s: 8.1, z: -1.64, r: 25.4, estimated: false }  # 코딩
  agentic: { s: 21.2, z: -0.63, r: 40.6, estimated: false }  # 에이전트
  trust: { s: 5.6, z: -0.9, r: 36.5, estimated: true }  # 신뢰성
...
| 에이전트 | 40.6 | -0.63 | 실측 | [[tau2-bench]] 21.0%×1.0 |
| 신뢰성 | 36.5 | -0.9 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
