...
radar:
  ...
  coding: { s: 8.3, z: -1.6, r: 26.1, estimated: false }  # 코딩
  agentic: { s: 21.2, z: -0.58, r: 41.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.15 · 혼합 $0.15/1M · 51.0 t/s · TTFT 1.07s · 128k ctx` · 가성비 26.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 30.5 | -1.3 | 실측 | [[gpqa-diamond]] 25.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 33.6 | -1.09 | 실측 | [[gpqa-diamond]] 25.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 26.1 | -1.6 | 실측 | [[scicode]] 5.0%×1.0 |
| 에이전트 | 41.4 | -0.58 | 실측 | [[tau2-bench]] 21.0%×1.0 |
| 신뢰성 | 36.5 | -0.9 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
