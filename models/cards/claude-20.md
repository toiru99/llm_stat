...
radar:
  ...
  trust: { s: 14.0, z: -0.67, r: 39.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 34.7, z: -0.45, r: 43.3, estimated: true }  # 긴문맥
  instruction: { s: 53.5, z: 0.01, r: 50.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 40.9 | -0.6 | 실측 | [[gpqa-diamond]] 34.0%×0.4 |
