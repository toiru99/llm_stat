...
radar:
  ...
  reasoning: { s: 28.2, z: -0.37, r: 44.4, estimated: false }  # 추론
  coding: { s: 31.7, z: -0.7, r: 39.5, estimated: false }  # 코딩
  agentic: { s: 23.9, z: -0.51, r: 42.3, estimated: true }  # 에이전트
  trust: { s: 15.6, z: -0.56, r: 41.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 36.4, z: -0.44, r: 43.4, estimated: true }  # 긴문맥
  instruction: { s: 64.0, z: 0.39, r: 55.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 44.4 | -0.37 | 실측 | [[gpqa-diamond]] 34.0%×1.0 |
