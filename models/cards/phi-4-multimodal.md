...
radar:
  ...
  coding: { s: 18.3, z: -1.19, r: 32.2, estimated: false }  # 코딩
  ...
  long_context: { s: 4.5, z: -1.32, r: 30.2, estimated: true }  # 긴문맥
  instruction: { s: 26.5, z: -1.09, r: 33.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 18.0 t/s · TTFT 0.82s · 128k ctx`
...
| 코딩 | 32.2 | -1.19 | 실측 | [[scicode]] 11.0%×1.0 |
| 에이전트 | 38.0 | -0.8 | 추정 | (추정) |
| 신뢰성 | 49.0 | -0.07 | 추정 | (추정) |
