...
radar:
  ...
  agentic: { s: 15.5, z: -0.81, r: 37.8, estimated: true }  # 에이전트
  trust: { s: 24.4, z: -0.2, r: 47.0, estimated: true }  # 신뢰성
  multimodal: { s: 0.0, z: -3.46, r: 0, estimated: false }  # 멀티모달
  long_context: { s: 7.6, z: -1.25, r: 31.2, estimated: true }  # 긴문맥
  instruction: { s: 24.8, z: -1.18, r: 32.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
