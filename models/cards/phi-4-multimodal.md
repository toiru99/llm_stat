...
radar:
  ...
  coding: { s: 18.3, z: -1.25, r: 31.3, estimated: false }  # 코딩
  agentic: { s: 16.2, z: -0.81, r: 37.8, estimated: true }  # 에이전트
  trust: { s: 24.7, z: -0.18, r: 47.4, estimated: true }  # 신뢰성
  multimodal: { s: 0.0, z: -3.53, r: 0, estimated: false }  # 멀티모달
  long_context: { s: 9.4, z: -1.25, r: 31.3, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 17.0 t/s · TTFT 0.82s · 128k ctx`
...
| 코딩 | 31.3 | -1.25 | 실측 | [[scicode]] 11.0%×1.0 |
| 에이전트 | 37.8 | -0.81 | 추정 | (추정) |
| 신뢰성 | 47.4 | -0.18 | 추정 | (추정) |
| 멀티모달 | 0 | -3.53 | 실측 | [[mmmu-pro]] 15.0%×1.0 |
| 긴문맥 | 31.3 | -1.25 | 추정 | (추정) |
