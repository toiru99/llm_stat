...
radar:
  ...
  coding: { s: 17.7, z: -1.23, r: 31.6, estimated: false }  # 코딩
  agentic: { s: 8.3, z: -1.13, r: 33.1, estimated: true }  # 에이전트
  ...
  instruction: { s: 35.8, z: -0.71, r: 39.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 18.0 t/s · TTFT 0.85s · 128k ctx`
