...
radar:
  ...
  coding: { s: 18.3, z: -1.23, r: 31.6, estimated: false }  # 코딩
  agentic: { s: 16.2, z: -0.81, r: 37.9, estimated: true }  # 에이전트
  trust: { s: 24.7, z: -0.11, r: 48.3, estimated: true }  # 신뢰성
  multimodal: { s: 0.0, z: -3.48, r: 0, estimated: false }  # 멀티모달
  long_context: { s: 9.4, z: -1.24, r: 31.3, estimated: true }  # 긴문맥
  instruction: { s: 28.5, z: -1.05, r: 34.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 18.0 t/s · TTFT 0.88s · 128k ctx`
...
| 코딩 | 31.6 | -1.23 | 실측 | [[scicode]] 11.0%×1.0 |
