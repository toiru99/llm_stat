...
radar:
  ...
  coding: { s: 18.3, z: -1.22, r: 31.6, estimated: false }  # 코딩
  agentic: { s: 16.2, z: -0.8, r: 37.9, estimated: true }  # 에이전트
  trust: { s: 24.7, z: -0.1, r: 48.4, estimated: true }  # 신뢰성
...
| 코딩 | 31.6 | -1.22 | 실측 | [[scicode]] 11.0%×1.0 |
| 에이전트 | 37.9 | -0.8 | 추정 | (추정) |
| 신뢰성 | 48.4 | -0.1 | 추정 | (추정) |
