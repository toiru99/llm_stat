...
is_reasoning: true
radar:
  knowledge: { s: 45.4, z: 0.23, r: 53.4, estimated: false }  # 전문 지식
  reasoning: { s: 38.9, z: 0.27, r: 54.0, estimated: false }  # 추론
  coding: { s: 54.9, z: 0.36, r: 55.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 264.0 t/s · TTFT 0.89s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.4 | +0.23 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.0 | +0.27 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 55.3 | +0.36 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
