...
radar:
  ...
  agentic: { s: 27.2, z: -0.98, r: 35.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 343.0 t/s · TTFT 0.93s · 131k ctx` · 가성비 120.0
...
| 에이전트 | 35.3 | -0.98 | 실측 | [[apex-agents]] 3.0%×1.0, [[gdpval]] 14.0%×1.0, [[itbench]] 6.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 23.0%×1.0 |
