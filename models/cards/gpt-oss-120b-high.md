...
radar:
  ...
  coding: { s: 54.9, z: 0.37, r: 55.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.2/1M · 256.0 t/s · TTFT 0.87s · 131k ctx` · 가성비 120.0
...
| 코딩 | 55.5 | +0.37 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
