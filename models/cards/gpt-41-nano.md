...
is_reasoning: false
radar:
  knowledge: { s: 24.3, z: -0.82, r: 37.8, estimated: false }  # 전문 지식
  ...
  multimodal: { s: 35.7, z: -1.79, r: 23.1, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.0775/1M · 133.0 t/s · TTFT 0.67s · 1M ctx` · 가성비 129.0
...
| 멀티모달 | 23.1 | -1.79 | 실측 | [[mmmu-pro]] 40.0%×1.0 |
