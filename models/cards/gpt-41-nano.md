...
is_reasoning: false
radar:
  knowledge: { s: 24.3, z: -0.8, r: 37.9, estimated: false }  # 전문 지식
  reasoning: { s: 17.9, z: -0.85, r: 37.2, estimated: false }  # 추론
  coding: { s: 30.9, z: -0.71, r: 39.4, estimated: false }  # 코딩
  agentic: { s: 7.8, z: -1.13, r: 33.0, estimated: false }  # 에이전트
  trust: { s: 17.4, z: -0.43, r: 43.6, estimated: false }  # 신뢰성
  multimodal: { s: 35.7, z: -1.76, r: 23.7, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.0775/1M · 161.0 t/s · TTFT 0.66s · 1M ctx` · 가성비 129.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 37.9 | -0.8 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 33.0 | -1.13 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 17.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
| 신뢰성 | 43.6 | -0.43 | 실측 | [[aa-omniscience]] 17.0%×1.0 |
| 멀티모달 | 23.7 | -1.76 | 실측 | [[mmmu-pro]] 40.0%×1.0 |
