...
radar:
  ...
  multimodal: { s: 35.7, z: -1.72, r: 24.1, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $None/1M · 201.0 t/s · TTFT 0.67s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.1 | -0.8 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 멀티모달 | 24.1 | -1.72 | 실측 | [[mmmu-pro]] 40.0%×1.0 |
