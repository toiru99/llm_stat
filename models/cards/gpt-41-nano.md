...
radar:
  ...
  agentic: { s: 8.7, z: -1.08, r: 33.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $None/1M · 198.0 t/s · TTFT 0.65s · 1M ctx`
...
| 에이전트 | 33.9 | -1.08 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 17.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
