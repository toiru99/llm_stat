...
radar:
  ...
  multimodal: { s: 34.7, z: -1.75, r: 23.7, estimated: false }  # 멀티모달
  long_context: { s: 15.1, z: -1.05, r: 34.3, estimated: true }  # 긴문맥
...
OpenAI · Proprietary · Unknown · 컨텍스트 1M · 종합지능 **4.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.0775/1M · 119.0 t/s · TTFT 0.71s · 1M ctx` · 가성비 51.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.1 | -0.79 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 멀티모달 | 23.7 | -1.75 | 실측 | [[mmmu-pro]] 40.0%×1.0 |
| 긴문맥 | 34.3 | -1.05 | 추정 | (추정) |
