...
radar:
  ...
  multimodal: { s: 35.7, z: -1.73, r: 24.0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.0775/1M · 135.0 t/s · TTFT 0.74s · 1M ctx` · 가성비 129.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.2 | -0.78 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 멀티모달 | 24.0 | -1.73 | 실측 | [[mmmu-pro]] 40.0%×1.0 |
