...
radar:
  ...
  reasoning: { s: 52.7, z: 0.91, r: 63.7, estimated: false }  # 추론
  coding: { s: 64.4, z: 0.72, r: 60.9, estimated: false }  # 코딩
  agentic: { s: 59.3, z: 0.89, r: 63.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 95.0 t/s · TTFT 91.16s · 400k ctx` · 가성비 26.2
...
| 추론 | 63.7 | +0.91 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 60.9 | +0.72 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 63.3 | +0.89 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
