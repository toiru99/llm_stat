...
is_reasoning: true
radar:
  knowledge: { s: 69.0, z: 1.38, r: 70.7, estimated: false }  # 전문 지식
  reasoning: { s: 52.7, z: 1.01, r: 65.2, estimated: false }  # 추론
  ...
  long_context: { s: 100.0, z: 1.52, r: 72.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 99.0 t/s · TTFT 91.98s · 400k ctx` · 가성비 26.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.7 | +1.38 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 65.2 | +1.01 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
...
| 긴문맥 | 72.9 | +1.52 | 실측 | [[aa-lcr]] 76.0%×1.0 |
