...
radar:
  ...
  reasoning: { s: 52.3, z: 0.82, r: 62.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 79.0 t/s · TTFT 98.85s · 400k ctx` · 가성비 26.2
...
| 추론 | 62.4 | +0.82 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 59.9 | +0.66 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 61.0 | +0.73 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 22.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
