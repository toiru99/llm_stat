...
radar:
  ...
  agentic: { s: 54.9, z: 0.66, r: 60.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 92.0 t/s · TTFT 79.64s · 400k ctx` · 가성비 20.2
...
| 에이전트 | 60.0 | +0.66 | 실측 | [[gdpval]] 26.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 22.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
