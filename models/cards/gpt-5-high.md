...
is_reasoning: true
radar:
  knowledge: { s: 65.7, z: 1.2, r: 67.9, estimated: false }  # 전문 지식
  reasoning: { s: 52.7, z: 0.88, r: 63.2, estimated: false }  # 추론
  coding: { s: 64.4, z: 0.71, r: 60.6, estimated: false }  # 코딩
  agentic: { s: 55.6, z: 0.78, r: 61.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 91.0 t/s · TTFT 82.62s · 400k ctx` · 가성비 26.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.9 | +1.2 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
...
| 에이전트 | 61.7 | +0.78 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 22.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
