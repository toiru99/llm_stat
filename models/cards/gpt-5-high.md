...
is_reasoning: true
radar:
  knowledge: { s: 69.0, z: 1.39, r: 70.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 100.0 t/s · TTFT 95.53s · 400k ctx` · 가성비 26.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.39 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
