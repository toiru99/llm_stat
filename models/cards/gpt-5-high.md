...
radar:
  ...
  reasoning: { s: 52.7, z: 1.02, r: 65.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 99.0 t/s · TTFT 96.09s · 400k ctx` · 가성비 26.1
...
| 추론 | 65.2 | +1.02 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 61.7 | +0.78 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 64.3 | +0.96 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
