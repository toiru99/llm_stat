...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 119.0 t/s · TTFT 65.87s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.7 | +1.31 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
...
| 에이전트 | 63.6 | +0.91 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
