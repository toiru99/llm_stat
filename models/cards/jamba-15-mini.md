...
radar:
  ...
  agentic: { s: 5.2, z: -1.21, r: 31.8, estimated: true }  # 에이전트
  trust: { s: 20.5, z: -0.36, r: 44.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 8.1, z: -1.22, r: 31.7, estimated: true }  # 긴문맥
  instruction: { s: 28.8, z: -1.0, r: 34.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 29.0 | -1.4 | 실측 | [[scicode]] 8.0%×1.0 |
