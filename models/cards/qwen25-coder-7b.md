...
is_reasoning: null
radar:
  knowledge: { s: 19.1, z: -1.06, r: 34.1, estimated: false }  # 전문 지식
  reasoning: { s: 17.6, z: -0.85, r: 37.2, estimated: false }  # 추론
  coding: { s: 24.2, z: -0.96, r: 35.6, estimated: false }  # 코딩
  agentic: { s: 8.8, z: -1.11, r: 33.3, estimated: true }  # 에이전트
  trust: { s: 29.2, z: 0.21, r: 53.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 20.9, z: -0.89, r: 36.6, estimated: true }  # 긴문맥
  instruction: { s: 30.2, z: -0.95, r: 35.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 37.2 | -0.85 | 실측 | [[gpqa-diamond]] 34.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
