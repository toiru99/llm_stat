...
is_reasoning: null
radar:
  knowledge: { s: 19.6, z: -1.01, r: 34.9, estimated: false }  # 전문 지식
  reasoning: { s: 18.1, z: -0.81, r: 37.8, estimated: false }  # 추론
  ...
  long_context: { s: 20.5, z: -0.83, r: 37.6, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 34.9 | -1.01 | 실측 | [[gpqa-diamond]] 34.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 37.8 | -0.81 | 실측 | [[gpqa-diamond]] 34.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
