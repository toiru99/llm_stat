...
radar:
  ...
  trust: { s: 31.1, z: 0.14, r: 52.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 8.2, z: -1.22, r: 31.7, estimated: true }  # 긴문맥
  instruction: { s: 27.8, z: -1.04, r: 34.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
