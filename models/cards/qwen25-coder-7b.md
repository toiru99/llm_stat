...
is_reasoning: null
radar:
  knowledge: { s: 19.6, z: -1.0, r: 34.9, estimated: false }  # 전문 지식
  ...
  long_context: { s: 20.5, z: -0.82, r: 37.6, estimated: true }  # 긴문맥
  instruction: { s: 34.6, z: -0.73, r: 39.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 34.9 | -1.0 | 실측 | [[gpqa-diamond]] 34.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
