...
is_reasoning: false
radar:
  knowledge: { s: 7.6, z: -1.58, r: 26.3, estimated: false }  # 전문 지식
  ...
  instruction: { s: 4.2, z: -2.02, r: 19.7, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 26.3 | -1.58 | 실측 | [[aa-omniscience]] 3.0%×1.0, [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 30.7 | -1.29 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 24.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
...
| 지시 따르기 | 19.7 | -2.02 | 실측 | [[ifbench]] 15.0%×1.0 |
