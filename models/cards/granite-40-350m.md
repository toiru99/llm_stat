...
is_reasoning: false
radar:
  knowledge: { s: 8.9, z: -1.53, r: 27.0, estimated: false }  # 전문 지식
  reasoning: { s: 9.4, z: -1.26, r: 31.0, estimated: false }  # 추론
...
| 추론 | 31.0 | -1.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 26.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
