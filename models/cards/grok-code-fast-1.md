...
radar:
  ...
  reasoning: { s: 29.0, z: -0.33, r: 45.0, estimated: false }  # 추론
  coding: { s: 48.6, z: -0.01, r: 49.8, estimated: false }  # 코딩
  agentic: { s: 51.3, z: 0.53, r: 58.0, estimated: false }  # 에이전트
...
| 추론 | 45.0 | -0.33 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 49.8 | -0.01 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 58.0 | +0.53 | 실측 | [[tau2-bench]] 76.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
