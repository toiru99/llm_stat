...
radar:
  ...
  coding: { s: 34.8, z: -0.49, r: 42.7, estimated: true }  # 코딩
  agentic: { s: 19.4, z: -0.66, r: 40.1, estimated: true }  # 에이전트
  trust: { s: 35.3, z: 0.35, r: 55.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 10.9, z: -1.12, r: 33.1, estimated: true }  # 긴문맥
  instruction: { s: 24.9, z: -1.15, r: 32.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
