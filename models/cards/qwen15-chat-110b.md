...
radar:
  ...
  trust: { s: 35.3, z: 0.36, r: 55.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 10.9, z: -1.12, r: 33.2, estimated: true }  # 긴문맥
  instruction: { s: 24.9, z: -1.14, r: 32.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
