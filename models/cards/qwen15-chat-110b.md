...
radar:
  ...
  coding: { s: 34.8, z: -0.48, r: 42.7, estimated: true }  # 코딩
  agentic: { s: 19.4, z: -0.66, r: 40.2, estimated: true }  # 에이전트
  trust: { s: 36.4, z: 0.4, r: 56.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 9.9, z: -1.14, r: 32.8, estimated: true }  # 긴문맥
  instruction: { s: 23.6, z: -1.18, r: 32.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
