...
is_reasoning: false
radar:
  knowledge: { s: 27.8, z: -0.61, r: 40.8, estimated: false }  # 전문 지식
  reasoning: { s: 13.4, z: -1.06, r: 34.1, estimated: false }  # 추론
  coding: { s: 22.1, z: -1.01, r: 34.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $2.6/1M · 58.0 t/s · TTFT 1.44s · 256k ctx` · 가성비 1.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.8 | -0.61 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 39.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.1 | -1.06 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 39.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 34.8 | -1.01 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
