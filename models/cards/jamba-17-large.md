...
is_reasoning: false
radar:
  knowledge: { s: 27.5, z: -0.64, r: 40.4, estimated: false }  # 전문 지식
  reasoning: { s: 13.4, z: -1.07, r: 34.0, estimated: false }  # 추론
  coding: { s: 22.1, z: -1.05, r: 34.3, estimated: false }  # 코딩
  agentic: { s: 8.1, z: -1.11, r: 33.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $2.6/1M · 51.0 t/s · TTFT 1.33s · 256k ctx` · 가성비 1.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.4 | -0.64 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 39.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.0 | -1.07 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 39.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 34.3 | -1.05 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 33.4 | -1.11 | 실측 | [[tau2-bench]] 13.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
