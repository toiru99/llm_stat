...
radar:
  ...
  agentic: { s: 21.9, z: -0.6, r: 40.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 27.0 | -1.53 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 40.9 | -0.6 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
