...
radar:
  ...
  reasoning: { s: 58.4, z: 1.09, r: 66.4, estimated: true }  # 추론
  coding: { s: 71.6, z: 0.93, r: 63.9, estimated: true }  # 코딩
  agentic: { s: 67.2, z: 1.14, r: 67.2, estimated: false }  # 에이전트
  trust: { s: 61.6, z: 1.38, r: 70.6, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 68.0 t/s · TTFT 10.06s · 1M ctx`
...
| 추론 | 66.4 | +1.09 | 추정 | (추정) |
| 코딩 | 63.9 | +0.93 | 추정 | (추정) |
| 에이전트 | 67.2 | +1.14 | 실측 | [[gdpval]] 45.0%×1.0 |
| 신뢰성 | 70.6 | +1.38 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 65.7 | +1.05 | 추정 | (추정) |
