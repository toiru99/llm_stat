...
radar:
  ...
  coding: { s: 71.0, z: 0.98, r: 64.7, estimated: true }  # 코딩
  agentic: { s: 67.2, z: 1.24, r: 68.6, estimated: false }  # 에이전트
  trust: { s: 46.0, z: 0.91, r: 63.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 86.0, z: 1.11, r: 66.6, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 67.0 t/s · TTFT 10.42s · 1M ctx`
...
| 추론 | 67.9 | +1.19 | 추정 | (추정) |
| 코딩 | 64.7 | +0.98 | 추정 | (추정) |
| 에이전트 | 68.6 | +1.24 | 실측 | [[gdpval]] 45.0%×1.0 |
| 신뢰성 | 63.7 | +0.91 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 66.6 | +1.11 | 추정 | (추정) |
