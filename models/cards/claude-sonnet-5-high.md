...
is_reasoning: true
radar:
  knowledge: { s: 61.6, z: 0.96, r: 64.4, estimated: true }  # 전문 지식
  reasoning: { s: 57.9, z: 1.18, r: 67.7, estimated: true }  # 추론
  coding: { s: 71.5, z: 1.02, r: 65.3, estimated: true }  # 코딩
  agentic: { s: 66.2, z: 1.16, r: 67.3, estimated: false }  # 에이전트
  trust: { s: 47.1, z: 0.87, r: 63.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 84.3, z: 1.03, r: 65.5, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 66.0 t/s · TTFT 10.84s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 64.4 | +0.96 | 추정 | (추정) |
| 추론 | 67.7 | +1.18 | 추정 | (추정) |
| 코딩 | 65.3 | +1.02 | 추정 | (추정) |
