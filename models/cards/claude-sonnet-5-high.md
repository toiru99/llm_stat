...
is_reasoning: true
radar:
  knowledge: { s: 56.1, z: 0.74, r: 61.1, estimated: true }  # 전문 지식
  reasoning: { s: 47.7, z: 0.73, r: 60.9, estimated: true }  # 추론
  ...
  instruction: { s: 79.7, z: 1.11, r: 66.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 70.0 t/s · TTFT 11.49s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.1 | +0.74 | 추정 | (추정) |
| 추론 | 60.9 | +0.73 | 추정 | (추정) |
| 코딩 | 60.5 | +0.7 | 추정 | (추정) |
