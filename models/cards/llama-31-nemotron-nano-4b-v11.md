...
radar:
  ...
  reasoning: { s: 22.3, z: -0.61, r: 40.8, estimated: false }  # 추론
  coding: { s: 16.7, z: -1.26, r: 31.0, estimated: false }  # 코딩
  agentic: { s: 12.1, z: -0.94, r: 35.8, estimated: false }  # 에이전트
  trust: { s: 17.3, z: -0.51, r: 42.4, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 38.1 | -0.8 | 실측 | [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.8 | -0.61 | 실측 | [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 31.0 | -1.26 | 실측 | [[scicode]] 10.0%×1.0 |
| 에이전트 | 35.8 | -0.94 | 실측 | [[tau2-bench]] 12.0%×1.0 |
| 신뢰성 | 42.4 | -0.51 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
