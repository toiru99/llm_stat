...
radar:
  ...
  reasoning: { s: 21.9, z: -0.66, r: 40.1, estimated: false }  # 추론
  coding: { s: 16.7, z: -1.3, r: 30.6, estimated: false }  # 코딩
  agentic: { s: 12.1, z: -0.97, r: 35.5, estimated: false }  # 에이전트
  trust: { s: 6.9, z: -0.89, r: 36.6, estimated: true }  # 신뢰성
...
| 추론 | 40.1 | -0.66 | 실측 | [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
