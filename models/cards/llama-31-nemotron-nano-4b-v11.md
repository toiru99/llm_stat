...
is_reasoning: true
radar:
  knowledge: { s: 24.0, z: -0.82, r: 37.8, estimated: false }  # 전문 지식
  reasoning: { s: 21.9, z: -0.66, r: 40.2, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 37.8 | -0.82 | 실측 | [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.2 | -0.66 | 실측 | [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 30.6 | -1.29 | 실측 | [[scicode]] 10.0%×1.0 |
| 에이전트 | 35.5 | -0.96 | 실측 | [[tau2-bench]] 12.0%×1.0 |
| 신뢰성 | 36.6 | -0.89 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
