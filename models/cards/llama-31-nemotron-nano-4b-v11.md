...
is_reasoning: true
radar:
  knowledge: { s: 24.4, z: -0.78, r: 38.4, estimated: false }  # 전문 지식
  reasoning: { s: 22.3, z: -0.59, r: 41.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 38.4 | -0.78 | 실측 | [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.1 | -0.59 | 실측 | [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
