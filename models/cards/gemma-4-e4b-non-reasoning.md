...
radar:
  ...
  reasoning: { s: 19.9, z: -0.73, r: 39.0, estimated: false }  # 추론
  coding: { s: 8.3, z: -1.63, r: 25.6, estimated: false }  # 코딩
  agentic: { s: 19.2, z: -0.71, r: 39.4, estimated: false }  # 에이전트
  trust: { s: 45.4, z: 0.98, r: 64.7, estimated: false }  # 신뢰성
  multimodal: { s: 50.7, z: -0.98, r: 35.4, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.028/1M · 42.0 t/s · TTFT 0.75s · 128k ctx` · 가성비 321.4
...
| 추론 | 39.0 | -0.73 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 55.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 25.6 | -1.63 | 실측 | [[scicode]] 4.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 39.4 | -0.71 | 실측 | [[tau2-bench]] 26.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
| 신뢰성 | 64.7 | +0.98 | 실측 | [[aa-omniscience]] 46.0%×1.0 |
| 멀티모달 | 35.4 | -0.98 | 실측 | [[mmmu-pro]] 51.0%×1.0 |
