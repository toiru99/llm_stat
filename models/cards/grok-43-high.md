...
radar:
  ...
  reasoning: { s: 61.9, z: 1.3, r: 69.5, estimated: false }  # 추론
  coding: { s: 71.4, z: 0.95, r: 64.3, estimated: false }  # 코딩
  agentic: { s: 52.7, z: 0.64, r: 59.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 125.0 t/s · TTFT 26.32s · 1M ctx` · 가성비 59.4
...
| 에이전트 | 59.5 | +0.64 | 실측 | [[apex-agents]] 17.0%×1.0, [[gdpval]] 29.0%×1.0, [[itbench]] 33.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
