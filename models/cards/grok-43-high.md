...
radar:
  ...
  coding: { s: 72.3, z: 0.52, r: 57.9, estimated: false }  # 코딩
  agentic: { s: 58.1, z: 0.22, r: 53.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 166.0 t/s · TTFT 20.84s · 1M ctx` · 가성비 59.4
...
| 코딩 | 57.9 | +0.52 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 53.3 | +0.22 | 실측 | [[apex-agents]] 17.0%×1.0, [[gdpval]] 29.0%×1.0, [[itbench]] 33.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
