...
radar:
  ...
  reasoning: { s: 61.9, z: 1.36, r: 70.3, estimated: false }  # 추론
  coding: { s: 71.4, z: 1.0, r: 65.0, estimated: false }  # 코딩
  agentic: { s: 53.5, z: 0.71, r: 60.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 127.0 t/s · TTFT 21.61s · 1M ctx` · 가성비 59.4
...
| 추론 | 70.3 | +1.36 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
