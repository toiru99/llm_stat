...
radar:
  ...
  reasoning: { s: 61.9, z: 1.29, r: 69.4, estimated: false }  # 추론
  coding: { s: 71.4, z: 0.94, r: 64.1, estimated: false }  # 코딩
  agentic: { s: 52.7, z: 0.62, r: 59.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 118.0 t/s · TTFT 20.48s · 1M ctx` · 가성비 59.4
...
| 추론 | 69.4 | +1.29 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 64.1 | +0.94 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 59.3 | +0.62 | 실측 | [[apex-agents]] 17.0%×1.0, [[gdpval]] 29.0%×1.0, [[itbench]] 33.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
