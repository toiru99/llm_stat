...
is_reasoning: false
radar:
  knowledge: { s: 13.9, z: -1.29, r: 30.6, estimated: false }  # 전문 지식
  reasoning: { s: 12.8, z: -1.1, r: 33.6, estimated: false }  # 추론
  coding: { s: 2.2, z: -1.88, r: 21.9, estimated: false }  # 코딩
  agentic: { s: 5.6, z: -1.21, r: 31.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 30.6 | -1.29 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 33.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 33.6 | -1.1 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 33.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 21.9 | -1.88 | 실측 | [[scicode]] 2.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 31.8 | -1.21 | 실측 | [[tau2-bench]] 11.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
