...
radar:
  ...
  coding: { s: 66.1, z: 0.7, r: 60.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 179.0 t/s · TTFT 10.81s · 400k ctx` · 가성비 46.0
...
| 코딩 | 60.5 | +0.7 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
