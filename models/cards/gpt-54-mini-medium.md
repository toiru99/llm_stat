...
is_reasoning: true
radar:
  knowledge: { s: 60.9, z: 0.92, r: 63.9, estimated: false }  # 전문 지식
  reasoning: { s: 42.0, z: 0.37, r: 55.6, estimated: false }  # 추론
  coding: { s: 66.1, z: 0.79, r: 61.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 182.0 t/s · TTFT 10.16s · 400k ctx` · 가성비 46.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.9 | +0.92 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 55.6 | +0.37 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 61.9 | +0.79 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
