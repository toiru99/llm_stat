...
is_reasoning: true
radar:
  knowledge: { s: 57.0, z: 0.81, r: 62.1, estimated: false }  # 전문 지식
  reasoning: { s: 41.7, z: 0.34, r: 55.1, estimated: false }  # 추론
  coding: { s: 64.5, z: 0.73, r: 61.0, estimated: false }  # 코딩
  agentic: { s: 44.4, z: 0.27, r: 54.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 177.0 t/s · TTFT 5.94s · 400k ctx` · 가성비 46.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.1 | +0.81 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
...
| 에이전트 | 54.1 | +0.27 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
