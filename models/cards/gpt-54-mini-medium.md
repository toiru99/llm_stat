...
is_reasoning: true
radar:
  knowledge: { s: 57.0, z: 0.83, r: 62.5, estimated: false }  # 전문 지식
  reasoning: { s: 41.7, z: 0.36, r: 55.5, estimated: false }  # 추론
  coding: { s: 64.5, z: 0.75, r: 61.3, estimated: false }  # 코딩
  agentic: { s: 44.4, z: 0.28, r: 54.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 175.0 t/s · TTFT 4.32s · 400k ctx` · 가성비 46.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.5 | +0.83 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 55.5 | +0.36 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 61.3 | +0.75 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 54.3 | +0.28 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
