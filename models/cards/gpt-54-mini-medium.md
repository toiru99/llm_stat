...
radar:
  ...
  agentic: { s: 45.7, z: -0.22, r: 46.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.65/1M · 166.0 t/s · TTFT 12.14s · 400k ctx` · 가성비 46.2
...
| 에이전트 | 46.7 | -0.22 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
