...
radar:
  ...
  coding: { s: 66.1, z: 0.83, r: 62.4, estimated: false }  # 코딩
  agentic: { s: 44.4, z: 0.32, r: 54.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $None/1M · 178.0 t/s · TTFT 8.75s · 400k ctx`
...
| 코딩 | 62.4 | +0.83 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 54.7 | +0.32 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
