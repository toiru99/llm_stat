...
is_reasoning: true
radar:
  knowledge: { s: 58.0, z: 0.8, r: 61.9, estimated: false }  # 전문 지식
  reasoning: { s: 42.5, z: 0.34, r: 55.1, estimated: false }  # 추론
  coding: { s: 66.1, z: 0.72, r: 60.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 160.0 t/s · TTFT 7.38s · 400k ctx` · 가성비 46.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.9 | +0.8 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 55.1 | +0.34 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 60.9 | +0.72 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
