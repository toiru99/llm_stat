...
radar:
  ...
  reasoning: { s: 42.5, z: 0.33, r: 55.0, estimated: false }  # 추론
  coding: { s: 66.1, z: 0.71, r: 60.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 182.0 t/s · TTFT 5.17s · 400k ctx` · 가성비 46.0
...
| 추론 | 55.0 | +0.33 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 60.7 | +0.71 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
