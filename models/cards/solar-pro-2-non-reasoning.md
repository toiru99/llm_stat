---
type: Model
title: Solar Pro 2 (Non-reasoning)
creator: Upstage
license: Proprietary
...
radar:
  ...
  coding: { s: 29.4, z: -0.73, r: 39.0, estimated: false }  # 코딩
...
Upstage · Proprietary · Unknown · 컨텍스트 65k · 종합지능 **8.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 40.6 | -0.63 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 56.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 39.0 | -0.74 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 56.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.0 | -0.73 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
