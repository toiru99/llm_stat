...
radar:
  ...
  reasoning: { s: 26.7, z: -0.39, r: 44.1, estimated: false }  # 추론
  coding: { s: 61.9, z: 0.6, r: 59.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $3.2 · 혼합 $0.66/1M · 63.0 t/s · TTFT 1.39s · 200k ctx` · 가성비 50.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.7 | -0.09 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 44.1 | -0.39 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 59.0 | +0.6 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 74.5 | +1.63 | 실측 | [[tau2-bench]] 97.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
