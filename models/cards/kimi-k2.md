...
radar:
  ...
  agentic: { s: 42.9, z: 0.26, r: 53.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.57 · 출력 $2.3 · 혼합 $None/1M · 37.0 t/s · TTFT 2.37s · 128k ctx`
...
| 에이전트 | 53.8 | +0.26 | 실측 | [[tau2-bench]] 61.0%×1.0, [[terminal-bench]] 16.0%×1.0 |
