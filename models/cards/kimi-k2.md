...
radar:
  ...
  agentic: { s: 42.9, z: 0.26, r: 54.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.58 · 출력 $2.4 · 혼합 $0.61/1M · 36.0 t/s · TTFT 2.21s · 128k ctx` · 가성비 31.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.2 | +0.28 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
...
| 에이전트 | 54.0 | +0.26 | 실측 | [[tau2-bench]] 61.0%×1.0, [[terminal-bench]] 16.0%×1.0 |
