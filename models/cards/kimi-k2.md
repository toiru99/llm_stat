...
radar:
  ...
  reasoning: { s: 30.4, z: -0.2, r: 47.1, estimated: false }  # 추론
  coding: { s: 45.9, z: -0.04, r: 49.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.57 · 출력 $2.3 · 혼합 $None/1M · 37.0 t/s · TTFT 1.85s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.6 | +0.24 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 47.1 | -0.2 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 49.4 | -0.04 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
