...
radar:
  ...
  coding: { s: 45.9, z: -0.02, r: 49.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.57 · 출력 $2.3 · 혼합 $None/1M · 35.0 t/s · TTFT 2.2s · 128k ctx`
...
| 코딩 | 49.6 | -0.02 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
