...
radar:
  ...
  coding: { s: 24.0, z: -0.96, r: 35.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $0.72/1M · 67.0 t/s · TTFT 2.07s · 64k ctx` · 가성비 9.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.9 | -0.54 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 38.8 | -0.75 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 35.5 | -0.96 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
