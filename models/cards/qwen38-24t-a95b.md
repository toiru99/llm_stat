...
radar:
  ...
  reasoning: { s: 79.1, z: 2.25, r: 83.8, estimated: false }  # 추론
  ...
  instruction: { s: 74.9, z: 0.95, r: 64.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.175/1M · 27.0 t/s · TTFT 2.5s · 984k ctx` · 가성비 49.4
...
| 추론 | 83.8 | +2.25 | 실측 | [[critpt]] 20.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
