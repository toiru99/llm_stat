...
radar:
  ...
  agentic: { s: 16.0, z: -0.79, r: 38.1, estimated: true }  # 에이전트
  trust: { s: 13.0, z: -0.6, r: 40.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 26.3, z: -0.7, r: 39.4, estimated: true }  # 긴문맥
  instruction: { s: 34.3, z: -0.8, r: 38.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
