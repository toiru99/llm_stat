...
radar:
  ...
  reasoning: { s: 66.1, z: 1.69, r: 75.3, estimated: true }  # 추론
  ...
  long_context: { s: 95.0, z: 1.36, r: 70.5, estimated: true }  # 긴문맥
  instruction: { s: 83.7, z: 1.27, r: 69.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 72.0 t/s · TTFT 37.38s · 1M ctx`
