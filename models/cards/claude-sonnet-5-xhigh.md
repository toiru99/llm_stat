...
radar:
  ...
  reasoning: { s: 52.0, z: 0.78, r: 61.8, estimated: true }  # 추론
  coding: { s: 65.5, z: 0.68, r: 60.2, estimated: true }  # 코딩
  agentic: { s: 74.6, z: 1.43, r: 71.4, estimated: false }  # 에이전트
  trust: { s: 50.7, z: 0.92, r: 63.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 74.9, z: 0.72, r: 60.8, estimated: true }  # 긴문맥
  instruction: { s: 70.7, z: 0.66, r: 59.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 70.0 t/s · TTFT 25.42s · 1M ctx`
...
| 추론 | 61.8 | +0.78 | 추정 | (추정) |
| 코딩 | 60.2 | +0.68 | 추정 | (추정) |
| 에이전트 | 71.4 | +1.43 | 실측 | [[gdpval]] 50.0%×1.0 |
| 신뢰성 | 63.8 | +0.92 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 60.8 | +0.72 | 추정 | (추정) |
