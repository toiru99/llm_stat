...
radar:
  ...
  reasoning: { s: 52.0, z: 0.81, r: 62.1, estimated: true }  # 추론
  coding: { s: 65.5, z: 0.7, r: 60.5, estimated: true }  # 코딩
  agentic: { s: 74.6, z: 1.48, r: 72.2, estimated: false }  # 에이전트
  trust: { s: 50.7, z: 1.03, r: 65.4, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 71.0 t/s · TTFT 35.69s · 1M ctx`
...
| 추론 | 62.1 | +0.81 | 추정 | (추정) |
| 코딩 | 60.5 | +0.7 | 추정 | (추정) |
| 에이전트 | 72.2 | +1.48 | 실측 | [[gdpval]] 50.0%×1.0 |
| 신뢰성 | 65.4 | +1.03 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 61.1 | +0.74 | 추정 | (추정) |
