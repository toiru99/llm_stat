...
radar:
  ...
  agentic: { s: 74.6, z: 1.49, r: 72.4, estimated: false }  # 에이전트
  trust: { s: 50.7, z: 1.05, r: 65.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 74.9, z: 0.74, r: 61.2, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 70.0 t/s · TTFT 25.94s · 1M ctx`
...
| 추론 | 62.3 | +0.82 | 추정 | (추정) |
| 코딩 | 60.6 | +0.71 | 추정 | (추정) |
| 에이전트 | 72.4 | +1.49 | 실측 | [[gdpval]] 50.0%×1.0 |
| 신뢰성 | 65.8 | +1.05 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 61.2 | +0.74 | 추정 | (추정) |
