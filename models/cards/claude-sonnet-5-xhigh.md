...
radar:
  ...
  agentic: { s: 74.6, z: 1.55, r: 73.2, estimated: false }  # 에이전트
  trust: { s: 50.7, z: 1.12, r: 66.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 84.1, z: 1.06, r: 65.8, estimated: true }  # 긴문맥
  instruction: { s: 74.9, z: 0.88, r: 63.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 71.0 t/s · TTFT 42.59s · 1M ctx`
...
| 추론 | 61.8 | +0.79 | 추정 | (추정) |
| 코딩 | 62.0 | +0.8 | 추정 | (추정) |
| 에이전트 | 73.2 | +1.55 | 실측 | [[gdpval]] 50.0%×1.0 |
| 신뢰성 | 66.8 | +1.12 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 65.8 | +1.06 | 추정 | (추정) |
