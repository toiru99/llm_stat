...
radar:
  ...
  agentic: { s: 57.3, z: 0.78, r: 61.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 58.0 t/s · TTFT 3.68s · 262k ctx` · 가성비 42.2
...
| 추론 | 55.8 | +0.39 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 58.3 | +0.55 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 61.6 | +0.78 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 17.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
