...
radar:
  ...
  agentic: { s: 57.3, z: 0.86, r: 62.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 53.0 t/s · TTFT 3.75s · 262k ctx` · 가성비 42.2
...
| 에이전트 | 62.8 | +0.86 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 17.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
