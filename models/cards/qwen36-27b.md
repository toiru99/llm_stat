...
radar:
  ...
  coding: { s: 62.1, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 57.3, z: 0.81, r: 62.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 55.0 t/s · TTFT 3.8s · 262k ctx` · 가성비 42.2
...
| 코딩 | 58.5 | +0.57 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
