...
radar:
  ...
  reasoning: { s: 43.9, z: 0.56, r: 58.4, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.69, r: 60.4, estimated: false }  # 코딩
  agentic: { s: 61.1, z: 0.98, r: 64.6, estimated: false }  # 에이전트
  trust: { s: 60.0, z: 1.53, r: 73.0, estimated: false }  # 신뢰성
...
| 추론 | 58.4 | +0.56 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 60.4 | +0.69 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 64.6 | +0.98 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
| 신뢰성 | 73.0 | +1.53 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
