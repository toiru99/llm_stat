...
is_reasoning: true
radar:
  knowledge: { s: 45.5, z: 0.19, r: 52.9, estimated: false }  # 전문 지식
  reasoning: { s: 43.9, z: 0.46, r: 56.9, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.61, r: 59.2, estimated: false }  # 코딩
  agentic: { s: 57.7, z: 0.88, r: 63.1, estimated: false }  # 에이전트
...
| 추론 | 56.9 | +0.46 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 59.2 | +0.61 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 63.1 | +0.88 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
