...
radar:
  ...
  agentic: { s: 59.8, z: 0.91, r: 63.7, estimated: false }  # 에이전트
  trust: { s: 58.6, z: 1.44, r: 71.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $None/1M · 54.0 t/s · TTFT 3.82s · 262k ctx`
...
| 에이전트 | 63.7 | +0.91 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
| 신뢰성 | 71.6 | +1.44 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
