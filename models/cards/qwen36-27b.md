...
radar:
  ...
  agentic: { s: 59.3, z: 0.3, r: 54.4, estimated: false }  # 에이전트
  trust: { s: 60.0, z: 0.93, r: 63.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 62.0 t/s · TTFT 3.7s · 262k ctx` · 가성비 41.1
...
| 에이전트 | 54.4 | +0.3 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
| 신뢰성 | 63.9 | +0.93 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
