...
radar:
  ...
  agentic: { s: 33.5, z: -0.15, r: 47.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $1.2 · 혼합 $0.435/1M · 130.0 t/s · TTFT 1.14s · 256k ctx` · 가성비 48.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.5 | -0.3 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
...
| 에이전트 | 47.7 | -0.15 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
