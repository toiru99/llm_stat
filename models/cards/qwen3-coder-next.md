...
radar:
  ...
  agentic: { s: 42.3, z: -0.34, r: 44.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $1.2 · 혼합 $0.43/1M · 100.0 t/s · TTFT 1.61s · 256k ctx` · 가성비 48.8
...
| 에이전트 | 44.9 | -0.34 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
