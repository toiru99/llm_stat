...
radar:
  ...
  agentic: { s: 33.6, z: -0.13, r: 48.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $1.2 · 혼합 $0.435/1M · 120.0 t/s · TTFT 1.28s · 256k ctx` · 가성비 48.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.9 | -0.28 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 47.1 | -0.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 48.2 | -0.12 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 48.1 | -0.13 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
