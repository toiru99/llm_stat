...
radar:
  ...
  coding: { s: 45.1, z: -0.61, r: 40.9, estimated: false }  # 코딩
  agentic: { s: 54.7, z: 0.12, r: 51.9, estimated: false }  # 에이전트
  trust: { s: 6.2, z: -0.96, r: 35.6, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 54.1, z: -0.59, r: 41.2, estimated: false }  # 긴문맥
  instruction: { s: 32.4, z: -1.43, r: 28.5, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.35 · 출력 $1.2 · 혼합 $0.43/1M · 131.0 t/s · TTFT 1.89s · 256k ctx` · 가성비 48.8
...
| 코딩 | 40.9 | -0.61 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 51.9 | +0.12 | 실측 | [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
| 신뢰성 | 35.6 | -0.96 | 실측 | [[aa-omniscience]] 9.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 41.2 | -0.59 | 실측 | [[aa-lcr]] 40.0%×1.0 |
| 지시 따르기 | 28.5 | -1.43 | 실측 | [[ifbench]] 35.0%×1.0 |
