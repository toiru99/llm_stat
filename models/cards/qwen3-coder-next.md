...
radar:
  ...
  agentic: { s: 33.6, z: -0.12, r: 48.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.35 · 출력 $1.2 · 혼합 $0.435/1M · 151.0 t/s · TTFT 1.31s · 256k ctx` · 가성비 48.3
...
| 코딩 | 47.8 | -0.15 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 48.2 | -0.12 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
