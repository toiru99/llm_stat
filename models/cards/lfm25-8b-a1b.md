...
radar:
  ...
  reasoning: { s: 20.1, z: -0.72, r: 39.1, estimated: false }  # 추론
  coding: { s: 11.4, z: -1.48, r: 27.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 338.0 t/s · TTFT 3.31s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 35.9 | -0.94 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 39.1 | -0.72 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 51.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 27.7 | -1.48 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
