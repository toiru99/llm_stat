...
is_reasoning: true
radar:
  knowledge: { s: 21.5, z: -0.96, r: 35.7, estimated: false }  # 전문 지식
  reasoning: { s: 19.8, z: -0.74, r: 38.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 336.0 t/s · TTFT 1.61s · 32k ctx`
...
| 추론 | 38.8 | -0.74 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 51.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
