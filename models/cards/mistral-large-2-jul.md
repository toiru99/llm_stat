...
radar:
  ...
  agentic: { s: 33.3, z: -0.1, r: 48.5, estimated: false }  # 에이전트
  trust: { s: 34.6, z: 0.27, r: 54.0, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 39.7 | -0.69 | 실측 | [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 41.9 | -0.54 | 실측 | [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 48.6 | -0.1 | 실측 | [[scicode]] 27.0%×1.0 |
| 에이전트 | 48.5 | -0.1 | 실측 | [[tau2-bench]] 33.0%×1.0 |
| 신뢰성 | 54.0 | +0.27 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
