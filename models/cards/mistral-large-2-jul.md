...
radar:
  ...
  agentic: { s: 33.3, z: -0.1, r: 48.6, estimated: false }  # 에이전트
  trust: { s: 39.0, z: 0.58, r: 58.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 2.4, z: -1.42, r: 28.7, estimated: false }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 40.0 | -0.67 | 실측 | [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 41.9 | -0.54 | 실측 | [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 48.6 | -0.1 | 실측 | [[scicode]] 27.0%×1.0 |
| 에이전트 | 48.6 | -0.1 | 실측 | [[tau2-bench]] 33.0%×1.0 |
| 신뢰성 | 58.7 | +0.58 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 28.7 | -1.42 | 실측 | [[aa-lcr]] 2.0%×1.0 |
