...
radar:
  ...
  trust: { s: 31.7, z: 0.33, r: 55.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 2.4, z: -1.46, r: 28.2, estimated: false }  # 긴문맥
...
| 추론 | 41.6 | -0.56 | 실측 | [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 47.8 | -0.15 | 실측 | [[scicode]] 27.0%×1.0 |
| 에이전트 | 47.6 | -0.16 | 실측 | [[tau2-bench]] 33.0%×1.0 |
| 신뢰성 | 55.0 | +0.33 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 28.2 | -1.46 | 실측 | [[aa-lcr]] 2.0%×1.0 |
