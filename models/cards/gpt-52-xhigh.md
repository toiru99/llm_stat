...
radar:
  ...
  reasoning: { s: 66.7, z: 1.5, r: 72.5, estimated: false }  # 추론
  coding: { s: 81.5, z: 1.34, r: 70.1, estimated: false }  # 코딩
  agentic: { s: 78.5, z: 1.59, r: 73.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 81.0 t/s · TTFT 183.02s · 400k ctx` · 가성비 23.0
...
| 에이전트 | 73.8 | +1.59 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
