...
radar:
  ...
  coding: { s: 81.5, z: 1.48, r: 72.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 81.0 t/s · TTFT 138.39s · 400k ctx`
...
| 코딩 | 72.2 | +1.48 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
