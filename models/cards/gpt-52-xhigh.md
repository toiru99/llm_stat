...
is_reasoning: true
radar:
  knowledge: { s: 72.0, z: 1.55, r: 73.2, estimated: false }  # 전문 지식
  reasoning: { s: 65.1, z: 1.5, r: 72.5, estimated: false }  # 추론
  coding: { s: 79.7, z: 1.37, r: 70.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 68.0 t/s · TTFT 108.17s · 400k ctx` · 가성비 23.0
...
| 추론 | 72.5 | +1.5 | 실측 | [[critpt]] 12.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 70.5 | +1.37 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
| 에이전트 | 73.9 | +1.59 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
