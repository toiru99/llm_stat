...
is_reasoning: true
radar:
  knowledge: { s: 76.1, z: 1.71, r: 75.6, estimated: false }  # 전문 지식
  reasoning: { s: 66.0, z: 1.69, r: 75.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 73.0 t/s · TTFT 191.07s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.6 | +1.71 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 35.0%×0.3 |
| 추론 | 75.4 | +1.69 | 실측 | [[critpt]] 12.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 72.1 | +1.48 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
