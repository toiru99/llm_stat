...
radar:
  ...
  agentic: { s: 41.5, z: 0.23, r: 53.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 400.0 t/s · TTFT 9.84s · 1M ctx` · 가성비 111.8
...
| 에이전트 | 53.5 | +0.23 | 실측 | [[gdpval]] 32.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
