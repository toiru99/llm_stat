...
radar:
  ...
  instruction: { s: 90.3, z: 1.59, r: 73.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 368.0 t/s · TTFT 9.92s · 1M ctx` · 가성비 111.8
...
| 추론 | 54.3 | +0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
