...
radar:
  ...
  agentic: { s: 47.1, z: 0.42, r: 56.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 368.0 t/s · TTFT 7.9s · 1M ctx`
...
| 추론 | 54.4 | +0.29 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 63.3 | +0.89 | 실측 | [[scicode]] 41.0%×1.0 |
| 에이전트 | 56.2 | +0.42 | 실측 | [[gdpval]] 32.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
