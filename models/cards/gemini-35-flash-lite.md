...
is_reasoning: true
radar:
  knowledge: { s: 54.9, z: 0.68, r: 60.3, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 389.0 t/s · TTFT 10.75s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.3 | +0.68 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 55.1 | +0.34 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 63.8 | +0.92 | 실측 | [[scicode]] 41.0%×1.0 |
| 에이전트 | 57.9 | +0.53 | 실측 | [[gdpval]] 32.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
