...
radar:
  ...
  coding: { s: 23.3, z: -0.98, r: 35.3, estimated: false }  # 코딩
  agentic: { s: 12.0, z: -0.94, r: 35.9, estimated: true }  # 에이전트
  trust: { s: 22.5, z: -0.27, r: 46.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 11.4, z: -1.13, r: 33.1, estimated: true }  # 긴문맥
  instruction: { s: 32.3, z: -0.86, r: 37.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 35.3 | -0.98 | 실측 | [[scicode]] 14.0%×1.0 |
