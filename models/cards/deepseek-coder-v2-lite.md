...
radar:
  ...
  coding: { s: 23.3, z: -0.99, r: 35.2, estimated: false }  # 코딩
  agentic: { s: 11.9, z: -0.96, r: 35.7, estimated: true }  # 에이전트
  trust: { s: 35.8, z: 0.36, r: 55.4, estimated: true }  # 신뢰성
...
| 코딩 | 35.2 | -0.99 | 실측 | [[scicode]] 14.0%×1.0 |
