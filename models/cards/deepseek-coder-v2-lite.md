...
radar:
  ...
  coding: { s: 22.6, z: -1.03, r: 34.6, estimated: false }  # 코딩
  agentic: { s: 10.7, z: -1.04, r: 34.4, estimated: true }  # 에이전트
  trust: { s: 26.6, z: 0.09, r: 51.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 20.0, z: -0.92, r: 36.2, estimated: true }  # 긴문맥
  instruction: { s: 30.7, z: -0.93, r: 36.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 34.6 | -1.03 | 실측 | [[scicode]] 14.0%×1.0 |
