...
radar:
  ...
  agentic: { s: 3.3, z: -1.31, r: 30.4, estimated: true }  # 에이전트
  trust: { s: 24.2, z: -0.01, r: 49.8, estimated: true }  # 신뢰성
...
DeepSeek · Open · Small(16B) · 컨텍스트 128k · 종합지능 **1.0** · ⚠️ past(구세대)
