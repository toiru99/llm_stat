...
radar:
  ...
  coding: { s: 23.3, z: -0.96, r: 35.5, estimated: false }  # 코딩
  agentic: { s: 12.7, z: -0.91, r: 36.3, estimated: true }  # 에이전트
  trust: { s: 36.3, z: 0.4, r: 56.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 9.3, z: -1.16, r: 32.6, estimated: true }  # 긴문맥
  instruction: { s: 27.9, z: -1.0, r: 35.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 36.9 | -0.88 | 실측 | [[gpqa-diamond]] 32.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 35.5 | -0.96 | 실측 | [[scicode]] 14.0%×1.0 |
