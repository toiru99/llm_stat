...
radar:
  ...
  reasoning: { s: 31.2, z: -0.17, r: 47.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.23 · 출력 $0.92 · 혼합 $0.299/1M · 57.0 t/s · TTFT 2.35s · 256k ctx` · 가성비 60.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.9 | -0.14 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 47.4 | -0.17 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 49.5 | -0.03 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 44.5 | -0.37 | 실측 | [[tau2-bench]] 33.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
