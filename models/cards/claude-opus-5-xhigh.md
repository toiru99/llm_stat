...
radar:
  ...
  reasoning: { s: 95.8, z: 3.08, r: 96.3, estimated: false }  # 추론
  ...
  instruction: { s: 77.3, z: 1.0, r: 64.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 57.0 t/s · TTFT 30.18s · 1M ctx` · 가성비 15.6
...
| 추론 | 96.3 | +3.08 | 실측 | [[critpt]] 28.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 53.0%×1.0 |
