...
radar:
  ...
  agentic: { s: 95.6, z: 2.31, r: 84.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 54.0 t/s · TTFT 24.63s · 1M ctx`
...
| 에이전트 | 84.6 | +2.31 | 실측 | [[gdpval]] 66.0%×1.0, [[tau3-banking]] 32.0%×1.0 |
