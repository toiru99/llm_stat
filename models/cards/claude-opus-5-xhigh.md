...
radar:
  ...
  reasoning: { s: 94.8, z: 2.86, r: 93.0, estimated: false }  # 추론
  coding: { s: 91.7, z: 1.75, r: 76.3, estimated: false }  # 코딩
  agentic: { s: 90.7, z: 2.06, r: 80.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 54.0 t/s · TTFT 32.67s · 1M ctx` · 가성비 16.4
...
| 추론 | 93.0 | +2.86 | 실측 | [[critpt]] 28.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 54.0%×1.0 |
| 코딩 | 76.3 | +1.75 | 실측 | [[scicode]] 55.0%×1.0 |
| 에이전트 | 80.8 | +2.06 | 실측 | [[gdpval]] 65.0%×1.0, [[tau3-banking]] 43.0%×1.0 |
