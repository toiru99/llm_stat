...
radar:
  ...
  agentic: { s: 91.4, z: 2.15, r: 82.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.8, z: 1.0, r: 65.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 53.0 t/s · TTFT 25.75s · 1M ctx` · 가성비 16.4
...
| 에이전트 | 82.3 | +2.15 | 실측 | [[gdpval]] 66.0%×1.0, [[tau3-banking]] 43.0%×1.0 |
