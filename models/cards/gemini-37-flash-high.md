...
radar:
  ...
  coding: { s: 95.0, z: 1.92, r: 78.8, estimated: false }  # 코딩
  agentic: { s: 70.4, z: 1.33, r: 70.0, estimated: false }  # 에이전트
...
| 에이전트 | 70.0 | +1.33 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
