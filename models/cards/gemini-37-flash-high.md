...
radar:
  ...
  reasoning: { s: 76.9, z: 2.04, r: 80.5, estimated: false }  # 추론
  coding: { s: 95.0, z: 1.92, r: 78.7, estimated: false }  # 코딩
  agentic: { s: 70.4, z: 1.33, r: 69.9, estimated: false }  # 에이전트
  trust: { s: 38.4, z: 0.5, r: 57.6, estimated: false }  # 신뢰성
  multimodal: { s: 100.0, z: 1.33, r: 69.9, estimated: false }  # 멀티모달
  long_context: { s: 96.4, z: 1.39, r: 70.9, estimated: false }  # 긴문맥
  instruction: { s: 84.5, z: 1.23, r: 68.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 340.0 t/s · TTFT 9.83s · 1M ctx` · 가성비 97.0
...
| 추론 | 80.5 | +2.04 | 실측 | [[critpt]] 14.0%×1.0, [[gpqa-diamond]] 95.0%×1.0, [[humanitys-last-exam]] 48.0%×1.0 |
| 코딩 | 78.7 | +1.92 | 실측 | [[scicode]] 57.0%×1.0 |
| 에이전트 | 69.9 | +1.33 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
| 신뢰성 | 57.6 | +0.5 | 실측 | [[aa-omniscience]] 35.0%×1.0 |
