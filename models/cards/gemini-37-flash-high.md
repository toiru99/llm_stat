...
radar:
  ...
  reasoning: { s: 76.9, z: 1.99, r: 79.9, estimated: false }  # 추론
  coding: { s: 95.0, z: 1.89, r: 78.3, estimated: false }  # 코딩
  agentic: { s: 70.4, z: 1.27, r: 69.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 362.0 t/s · TTFT 12.75s · 1M ctx` · 가성비 97.0
...
| 추론 | 79.9 | +1.99 | 실측 | [[critpt]] 14.0%×1.0, [[gpqa-diamond]] 95.0%×1.0, [[humanitys-last-exam]] 48.0%×1.0 |
| 코딩 | 78.3 | +1.89 | 실측 | [[scicode]] 57.0%×1.0 |
| 에이전트 | 69.0 | +1.27 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
