...
radar:
  ...
  agentic: { s: 38.5, z: 0.1, r: 51.5, estimated: false }  # 에이전트
  trust: { s: 82.6, z: 2.59, r: 88.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 93.0 t/s · TTFT 10.91s · 200k ctx` · 가성비 39.0
...
| 추론 | 45.0 | -0.33 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 58.7 | +0.58 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 51.5 | +0.1 | 실측 | [[gdpval]] 21.0%×1.0, [[itbench]] 27.0%×1.0, [[tau2-bench]] 55.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 88.8 | +2.59 | 실측 | [[aa-omniscience]] 73.0%×1.0 |
