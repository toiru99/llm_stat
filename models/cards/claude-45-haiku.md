...
radar:
  ...
  reasoning: { s: 27.9, z: -0.37, r: 44.5, estimated: false }  # 추론
  coding: { s: 61.4, z: 0.53, r: 58.0, estimated: false }  # 코딩
  agentic: { s: 38.5, z: 0.07, r: 51.0, estimated: false }  # 에이전트
  trust: { s: 82.6, z: 2.43, r: 86.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 88.0 t/s · TTFT 17.66s · 200k ctx` · 가성비 39.0
...
| 추론 | 44.5 | -0.37 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 58.0 | +0.53 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 51.0 | +0.07 | 실측 | [[gdpval]] 21.0%×1.0, [[itbench]] 27.0%×1.0, [[tau2-bench]] 55.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 86.4 | +2.43 | 실측 | [[aa-omniscience]] 73.0%×1.0 |
