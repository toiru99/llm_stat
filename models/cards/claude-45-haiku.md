...
radar:
  ...
  agentic: { s: 41.0, z: 0.18, r: 52.8, estimated: false }  # 에이전트
  trust: { s: 83.9, z: 2.66, r: 89.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $None/1M · 98.0 t/s · TTFT 13.2s · 200k ctx`
...
| 에이전트 | 52.8 | +0.18 | 실측 | [[gdpval]] 21.0%×1.0, [[itbench]] 27.0%×1.0, [[tau2-bench]] 55.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 89.9 | +2.66 | 실측 | [[aa-omniscience]] 74.0%×1.0 |
