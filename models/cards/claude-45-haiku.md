...
radar:
  ...
  trust: { s: 83.9, z: 2.59, r: 88.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 108.0 t/s · TTFT 17.83s · 200k ctx` · 가성비 39.0
...
| 신뢰성 | 88.8 | +2.59 | 실측 | [[aa-omniscience]] 74.0%×1.0 |
