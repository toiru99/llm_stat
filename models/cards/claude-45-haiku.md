...
radar:
  ...
  reasoning: { s: 27.3, z: -0.38, r: 44.4, estimated: false }  # 추론
  coding: { s: 51.7, z: 0.69, r: 60.4, estimated: false }  # 코딩
  agentic: { s: 37.9, z: 0.02, r: 50.3, estimated: false }  # 에이전트
  trust: { s: 73.2, z: 2.31, r: 84.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 103.0 t/s · TTFT 20.2s · 200k ctx` · 가성비 28.6
...
| 추론 | 44.4 | -0.38 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 60.4 | +0.69 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 50.3 | +0.02 | 실측 | [[gdpval]] 18.0%×1.0, [[itbench]] 27.0%×1.0, [[tau2-bench]] 55.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 84.6 | +2.31 | 실측 | [[aa-omniscience]] 73.0%×1.0 |
