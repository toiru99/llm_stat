...
is_reasoning: false
radar:
  knowledge: { s: 34.7, z: -0.31, r: 45.4, estimated: false }  # 전문 지식
  ...
  trust: { s: 83.9, z: 2.64, r: 89.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $None/1M · 97.0 t/s · TTFT 15.91s · 200k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.4 | -0.31 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
