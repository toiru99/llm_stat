...
radar:
  ...
  agentic: { s: 38.6, z: 0.07, r: 51.1, estimated: false }  # 에이전트
  trust: { s: 73.2, z: 2.32, r: 84.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 119.0 t/s · TTFT 18.74s · 200k ctx` · 가성비 39.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.8 | -0.28 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
...
| 신뢰성 | 84.8 | +2.32 | 실측 | [[aa-omniscience]] 73.0%×1.0 |
