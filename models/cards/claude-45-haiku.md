...
radar:
  ...
  agentic: { s: 39.7, z: -0.45, r: 43.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $5.0 · 혼합 $0.77/1M · 92.0 t/s · TTFT 21.66s · 200k ctx` · 가성비 39.0
...
| 에이전트 | 43.2 | -0.45 | 실측 | [[gdpval]] 20.0%×1.0, [[itbench]] 27.0%×1.0, [[tau2-bench]] 55.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
