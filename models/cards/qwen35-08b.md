...
is_reasoning: true
radar:
  knowledge: { s: 3.8, z: -1.81, r: 22.8, estimated: false }  # 전문 지식
  reasoning: { s: 0.4, z: -1.7, r: 24.5, estimated: false }  # 추론
...
| 추론 | 24.5 | -1.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 11.0%×1.0, [[humanitys-last-exam]] 1.0%×1.0 |
| 코딩 | 20.4 | -1.98 | 실측 | [[scicode]] 0.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 37.6 | -0.83 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 48.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
