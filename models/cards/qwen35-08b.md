...
is_reasoning: true
radar:
  knowledge: { s: 3.8, z: -1.79, r: 23.2, estimated: false }  # 전문 지식
  reasoning: { s: 0.4, z: -1.67, r: 25.0, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 23.2 | -1.79 | 실측 | [[aa-omniscience]] 4.0%×1.0, [[gpqa-diamond]] 11.0%×0.4, [[humanitys-last-exam]] 1.0%×0.3 |
| 추론 | 25.0 | -1.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 11.0%×1.0, [[humanitys-last-exam]] 1.0%×1.0 |
| 코딩 | 33.2 | -1.12 | 실측 | [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 37.8 | -0.82 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 48.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
