...
radar:
  ...
  agentic: { s: 24.2, z: -1.09, r: 33.7, estimated: false }  # 에이전트
  trust: { s: 73.8, z: 1.41, r: 71.1, estimated: false }  # 신뢰성
  multimodal: { s: 0.0, z: -3.77, r: 0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.01 · 출력 $0.05 · 혼합 $0.01/1M · 32.0 t/s · TTFT 0.8s · 262k ctx` · 가성비 500.0
...
| 에이전트 | 33.7 | -1.09 | 실측 | [[tau2-bench]] 48.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 71.1 | +1.41 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
| 멀티모달 | 0 | -3.77 | 실측 | [[mmmu-pro]] 26.0%×1.0 |
