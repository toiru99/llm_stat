...
radar:
  ...
  agentic: { s: 24.2, z: -1.1, r: 33.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.01 · 출력 $0.05 · 혼합 $0.01/1M · 45.0 t/s · TTFT 0.73s · 262k ctx` · 가성비 500.0
...
| 에이전트 | 33.6 | -1.1 | 실측 | [[tau2-bench]] 48.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
