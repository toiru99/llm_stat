...
radar:
  ...
  reasoning: { s: 42.8, z: 0.35, r: 55.2, estimated: false }  # 추론
  coding: { s: 65.5, z: 0.69, r: 60.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.201/1M · 101.0 t/s · TTFT 1.67s · 205k ctx` · 가성비 169.2
...
| 추론 | 55.2 | +0.35 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 60.3 | +0.69 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 71.6 | +1.44 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
