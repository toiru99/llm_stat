...
radar:
  ...
  coding: { s: 63.9, z: 0.73, r: 60.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.201/1M · 90.0 t/s · TTFT 1.68s · 205k ctx` · 가성비 169.2
...
| 에이전트 | 71.8 | +1.46 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
