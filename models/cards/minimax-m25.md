...
is_reasoning: true
radar:
  knowledge: { s: 51.6, z: 0.48, r: 57.2, estimated: false }  # 전문 지식
  reasoning: { s: 42.3, z: 0.38, r: 55.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.201/1M · 95.0 t/s · TTFT 1.73s · 205k ctx` · 가성비 169.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.2 | +0.48 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 55.7 | +0.38 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 61.3 | +0.75 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 73.2 | +1.55 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
