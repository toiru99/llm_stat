...
is_reasoning: true
radar:
  knowledge: { s: 51.6, z: 0.49, r: 57.4, estimated: false }  # 전문 지식
  reasoning: { s: 42.3, z: 0.4, r: 56.0, estimated: false }  # 추론
  coding: { s: 65.5, z: 0.78, r: 61.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $None/1M · 77.0 t/s · TTFT 1.67s · 205k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.4 | +0.49 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 56.0 | +0.4 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 61.7 | +0.78 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
