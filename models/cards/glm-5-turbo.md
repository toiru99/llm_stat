...
is_reasoning: true
radar:
  knowledge: { s: 56.6, z: 0.76, r: 61.5, estimated: false }  # 전문 지식
  ...
  trust: { s: 43.5, z: 0.74, r: 61.0, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 61.5 | +0.76 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
...
| 신뢰성 | 61.0 | +0.74 | 실측 | [[aa-omniscience]] 38.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
