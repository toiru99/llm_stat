...
is_reasoning: true
radar:
  knowledge: { s: 54.4, z: 0.62, r: 59.2, estimated: false }  # 전문 지식
  reasoning: { s: 46.1, z: 0.49, r: 57.4, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 59.2 | +0.62 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 57.4 | +0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
