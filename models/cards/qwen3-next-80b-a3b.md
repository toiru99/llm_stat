...
radar:
  ...
  reasoning: { s: 33.3, z: -0.12, r: 48.3, estimated: false }  # 추론
  coding: { s: 48.4, z: -0.01, r: 49.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $1.2 · 혼합 $0.255/1M · 203.0 t/s · TTFT 2.24s · 262k ctx` · 가성비 66.7
...
| 추론 | 48.3 | -0.12 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 49.9 | -0.01 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
