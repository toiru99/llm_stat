...
radar:
  ...
  coding: { s: 48.4, z: -0.02, r: 49.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $1.2 · 혼합 $0.255/1M · 190.0 t/s · TTFT 2.26s · 262k ctx` · 가성비 66.7
...
| 코딩 | 49.8 | -0.02 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
