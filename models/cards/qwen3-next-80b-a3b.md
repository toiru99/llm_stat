...
radar:
  ...
  coding: { s: 48.4, z: 0.09, r: 51.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $6.0 · 혼합 $1.05/1M · 174.0 t/s · TTFT 2.1s · 262k ctx` · 가성비 16.2
...
| 코딩 | 51.4 | +0.09 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
