...
radar:
  ...
  agentic: { s: 18.9, z: -0.68, r: 39.9, estimated: false }  # 에이전트
  trust: { s: 20.0, z: -0.37, r: 44.5, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 78.9, z: 0.89, r: 63.4, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.5 · 출력 $6.0 · 혼합 $None/1M · 177.0 t/s · TTFT 2.08s · 262k ctx`
...
| 에이전트 | 39.9 | -0.68 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 42.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 10.0%×1.0 |
| 신뢰성 | 44.5 | -0.37 | 실측 | [[aa-omniscience]] 18.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 63.4 | +0.89 | 실측 | [[aa-lcr]] 60.0%×1.0 |
