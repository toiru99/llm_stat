...
radar:
  ...
  coding: { s: 48.4, z: 0.06, r: 50.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $6.0 · 혼합 $None/1M · 201.0 t/s · TTFT 2.28s · 262k ctx`
...
| 추론 | 49.1 | -0.06 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 50.9 | +0.06 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
