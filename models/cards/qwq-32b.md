...
is_reasoning: true
radar:
  knowledge: { s: 39.1, z: -0.08, r: 48.9, estimated: false }  # 전문 지식
  ...
  trust: { s: 20.7, z: -0.33, r: 45.1, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.66 · 출력 $1.0 · 혼합 $None/1M · 30.0 t/s · TTFT 2.19s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.9 | -0.08 | 실측 | [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
