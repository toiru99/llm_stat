...
radar:
  ...
  agentic: { s: 38.7, z: 0.09, r: 51.3, estimated: true }  # 에이전트
...
## 실용 지표
`입력 $0.66 · 출력 $1.0 · 혼합 $None/1M · 31.0 t/s · TTFT 2.14s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.8 | -0.08 | 실측 | [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
