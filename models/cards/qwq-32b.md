...
radar:
  ...
  reasoning: { s: 35.9, z: 0.12, r: 51.8, estimated: false }  # 추론
  coding: { s: 60.0, z: 0.58, r: 58.7, estimated: false }  # 코딩
  agentic: { s: 38.7, z: 0.09, r: 51.4, estimated: true }  # 에이전트
  trust: { s: 21.2, z: -0.32, r: 45.3, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.66 · 출력 $1.0 · 혼합 $0.69/1M · 30.0 t/s · TTFT 2.16s · 131k ctx` · 가성비 18.8
...
| 추론 | 51.8 | +0.12 | 실측 | [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 58.7 | +0.58 | 실측 | [[scicode]] 36.0%×1.0 |
