...
radar:
  ...
  reasoning: { s: 50.2, z: 0.7, r: 60.4, estimated: false }  # 추론
  coding: { s: 58.3, z: 0.39, r: 55.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $2.95 · 혼합 $0.4555/1M · 41.0 t/s · TTFT 2.8s · 1M ctx` · 가성비 74.6
...
| 추론 | 60.4 | +0.7 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
