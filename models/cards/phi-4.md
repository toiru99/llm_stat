...
is_reasoning: false
radar:
  knowledge: { s: 25.9, z: -0.7, r: 39.6, estimated: false }  # 전문 지식
  reasoning: { s: 20.6, z: -0.68, r: 39.8, estimated: false }  # 추론
  coding: { s: 30.9, z: -0.64, r: 40.5, estimated: false }  # 코딩
  agentic: { s: 3.0, z: -1.28, r: 30.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.13 · 출력 $0.5 · 혼합 $0.16/1M · 33.0 t/s · TTFT 2.17s · 16k ctx` · 가성비 31.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.6 | -0.7 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 30.7 | -1.28 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
