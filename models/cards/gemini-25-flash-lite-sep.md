...
radar:
  ...
  coding: { s: 38.8, z: -0.39, r: 44.1, estimated: false }  # 코딩
  agentic: { s: 25.5, z: -0.44, r: 43.4, estimated: false }  # 에이전트
...
| 에이전트 | 43.4 | -0.44 | 실측 | [[tau2-bench]] 31.0%×1.0, [[terminal-bench]] 13.0%×1.0 |
