...
radar:
  ...
  reasoning: { s: 28.1, z: -0.28, r: 45.8, estimated: false }  # 추론
  coding: { s: 38.8, z: -0.3, r: 45.5, estimated: false }  # 코딩
...
| 추론 | 45.8 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 45.5 | -0.3 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 13.0%×0.5 |
