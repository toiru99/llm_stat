...
is_reasoning: true
radar:
  knowledge: { s: 35.8, z: -0.26, r: 46.1, estimated: false }  # 전문 지식
  reasoning: { s: 28.1, z: -0.32, r: 45.1, estimated: false }  # 추론
  coding: { s: 38.8, z: -0.35, r: 44.8, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 46.1 | -0.26 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 45.1 | -0.32 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 44.8 | -0.35 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 13.0%×0.5 |
| 에이전트 | 43.6 | -0.43 | 실측 | [[tau2-bench]] 31.0%×1.0, [[terminal-bench]] 13.0%×1.0 |
