...
radar:
  ...
  coding: { s: 38.8, z: -0.34, r: 44.8, estimated: false }  # 코딩
  agentic: { s: 25.5, z: -0.42, r: 43.6, estimated: false }  # 에이전트
...
| 코딩 | 44.8 | -0.34 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 13.0%×0.5 |
| 에이전트 | 43.6 | -0.42 | 실측 | [[tau2-bench]] 31.0%×1.0, [[terminal-bench]] 13.0%×1.0 |
