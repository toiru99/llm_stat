...
is_reasoning: true
radar:
  knowledge: { s: 40.9, z: 0.02, r: 50.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 158.0 t/s · TTFT 17.41s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.2 | +0.02 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
...
| 에이전트 | 47.3 | -0.18 | 실측 | [[gdpval]] 4.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
