...
radar:
  ...
  reasoning: { s: 34.6, z: 0.05, r: 50.8, estimated: false }  # 추론
  coding: { s: 49.7, z: 0.15, r: 52.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 156.0 t/s · TTFT 18.21s · 1M ctx` · 가성비 34.6
...
| 추론 | 50.8 | +0.05 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 52.2 | +0.15 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
