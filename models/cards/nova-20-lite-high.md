...
is_reasoning: true
radar:
  knowledge: { s: 40.9, z: 0.03, r: 50.5, estimated: false }  # 전문 지식
  reasoning: { s: 34.6, z: 0.07, r: 51.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 143.0 t/s · TTFT 16.78s · 1M ctx` · 가성비 34.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.5 | +0.03 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 51.0 | +0.07 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
