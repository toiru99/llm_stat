...
radar:
  ...
  coding: { s: 49.7, z: 0.06, r: 50.8, estimated: false }  # 코딩
  agentic: { s: 35.2, z: -0.06, r: 49.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 152.0 t/s · TTFT 11.41s · 1M ctx` · 가성비 40.4
...
| 코딩 | 50.8 | +0.06 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 49.0 | -0.06 | 실측 | [[gdpval]] 4.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
