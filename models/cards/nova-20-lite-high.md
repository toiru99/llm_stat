...
is_reasoning: true
radar:
  knowledge: { s: 39.8, z: -0.08, r: 48.8, estimated: false }  # 전문 지식
  reasoning: { s: 34.6, z: -0.06, r: 49.1, estimated: false }  # 추론
  coding: { s: 49.7, z: 0.03, r: 50.5, estimated: false }  # 코딩
  agentic: { s: 35.2, z: -0.08, r: 48.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 161.0 t/s · TTFT 17.2s · 1M ctx` · 가성비 40.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.8 | -0.08 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 49.1 | -0.06 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 50.5 | +0.03 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 48.7 | -0.08 | 실측 | [[gdpval]] 4.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
