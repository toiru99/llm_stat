...
radar:
  ...
  agentic: { s: 30.5, z: -0.21, r: 46.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 142.0 t/s · TTFT 16.25s · 1M ctx` · 가성비 34.6
...
| 추론 | 49.9 | -0.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 51.5 | +0.1 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 46.8 | -0.21 | 실측 | [[gdpval]] 4.0%×1.0, [[tau2-bench]] 73.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
