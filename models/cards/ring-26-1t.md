...
radar:
  ...
  reasoning: { s: 46.9, z: 0.63, r: 59.5, estimated: false }  # 추론
  coding: { s: 61.3, z: 0.58, r: 58.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 126.0 t/s · TTFT 3.86s · 262k ctx` · 가성비 61.5
...
| 추론 | 59.5 | +0.63 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 58.6 | +0.58 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
