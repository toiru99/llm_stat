...
radar:
  ...
  reasoning: { s: 25.3, z: -0.44, r: 43.5, estimated: false }  # 추론
  coding: { s: 29.2, z: -0.72, r: 39.3, estimated: false }  # 코딩
  agentic: { s: 17.4, z: -0.73, r: 39.1, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 45.2 | -0.32 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.5 | -0.44 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 39.3 | -0.72 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 39.1 | -0.73 | 실측 | [[tau2-bench]] 27.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
