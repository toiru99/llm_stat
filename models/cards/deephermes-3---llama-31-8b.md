...
radar:
  ...
  trust: { s: 23.8, z: -0.11, r: 48.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 15.5, z: -1.03, r: 34.5, estimated: true }  # 긴문맥
  instruction: { s: 24.5, z: -1.2, r: 32.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 30.6 | -1.29 | 실측 | [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
