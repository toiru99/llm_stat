...
is_reasoning: false
radar:
  knowledge: { s: 13.9, z: -1.28, r: 30.8, estimated: false }  # 전문 지식
  reasoning: { s: 12.9, z: -1.08, r: 33.7, estimated: false }  # 추론
  coding: { s: 15.0, z: -1.34, r: 29.9, estimated: false }  # 코딩
  agentic: { s: 6.5, z: -1.16, r: 32.6, estimated: true }  # 에이전트
  trust: { s: 23.8, z: -0.11, r: 48.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 13.8, z: -1.07, r: 33.9, estimated: true }  # 긴문맥
  instruction: { s: 21.6, z: -1.32, r: 30.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
