...
is_reasoning: false
radar:
  knowledge: { s: 14.0, z: -1.29, r: 30.7, estimated: false }  # 전문 지식
  ...
  trust: { s: 22.4, z: -0.29, r: 45.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 11.4, z: -1.14, r: 32.9, estimated: true }  # 긴문맥
  instruction: { s: 21.0, z: -1.33, r: 30.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 30.7 | -1.29 | 실측 | [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
