...
radar:
  ...
  reasoning: { s: 13.0, z: -1.09, r: 33.7, estimated: false }  # 추론
  coding: { s: 15.0, z: -1.33, r: 30.1, estimated: false }  # 코딩
  agentic: { s: 5.5, z: -1.19, r: 32.1, estimated: true }  # 에이전트
  trust: { s: 24.1, z: -0.17, r: 47.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 10.5, z: -1.14, r: 32.9, estimated: true }  # 긴문맥
  instruction: { s: 27.5, z: -1.05, r: 34.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 30.1 | -1.33 | 실측 | [[scicode]] 9.0%×1.0 |
