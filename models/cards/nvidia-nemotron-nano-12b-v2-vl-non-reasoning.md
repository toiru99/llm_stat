...
is_reasoning: false
radar:
  knowledge: { s: 20.8, z: -0.97, r: 35.4, estimated: false }  # 전문 지식
  reasoning: { s: 14.9, z: -0.97, r: 35.4, estimated: false }  # 추론
...
NVIDIA · Open · Small(13.2B) · 컨텍스트 128k · 종합지능 **1.0**
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 113.0 t/s · TTFT 2.04s · 128k ctx` · 가성비 4.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 35.4 | -0.97 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 44.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
