...
radar:
  ...
  coding: { s: 79.8, z: 1.41, r: 71.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 179.0 t/s · TTFT 57.51s · 400k ctx`
...
| 코딩 | 71.1 | +1.41 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 37.0%×0.5 |
