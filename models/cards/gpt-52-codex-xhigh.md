...
is_reasoning: true
radar:
  knowledge: { s: 70.7, z: 1.49, r: 72.3, estimated: false }  # 전문 지식
  reasoning: { s: 62.4, z: 1.41, r: 71.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 72.3 | +1.49 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 71.1 | +1.41 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
