...
is_reasoning: true
radar:
  knowledge: { s: 70.3, z: 1.38, r: 70.8, estimated: false }  # 전문 지식
  reasoning: { s: 62.4, z: 1.31, r: 69.7, estimated: false }  # 추론
  coding: { s: 79.8, z: 1.29, r: 69.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.38 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 69.7 | +1.31 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 69.3 | +1.29 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 37.0%×0.5 |
