...
radar:
  ...
  reasoning: { s: 40.0, z: 0.26, r: 53.9, estimated: false }  # 추론
  coding: { s: 66.1, z: 0.8, r: 62.0, estimated: false }  # 코딩
  agentic: { s: 29.2, z: -0.32, r: 45.2, estimated: false }  # 에이전트
  trust: { s: 77.3, z: 2.49, r: 87.3, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 47.4 | -0.17 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 53.9 | +0.26 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 62.0 | +0.8 | 실측 | [[scicode]] 41.0%×1.0 |
| 에이전트 | 45.2 | -0.32 | 실측 | [[gdpval]] 24.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
| 신뢰성 | 87.3 | +2.49 | 실측 | [[aa-omniscience]] 77.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
