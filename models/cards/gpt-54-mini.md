...
radar:
  ...
  agentic: { s: 27.2, z: -0.93, r: 36.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.65/1M · 180.0 t/s · TTFT 0.66s · 400k ctx` · 가성비 26.2
...
| 에이전트 | 36.0 | -0.93 | 실측 | [[gdpval]] 14.0%×1.0, [[itbench]] 17.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
