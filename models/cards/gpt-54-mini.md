...
radar:
  ...
  agentic: { s: 26.8, z: -0.97, r: 35.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.65/1M · 170.0 t/s · TTFT 0.65s · 400k ctx` · 가성비 26.2
...
| 에이전트 | 35.5 | -0.97 | 실측 | [[gdpval]] 13.0%×1.0, [[itbench]] 17.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
