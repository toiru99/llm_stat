...
radar:
  ...
  coding: { s: 53.5, z: 0.3, r: 54.5, estimated: false }  # 코딩
  ...
  long_context: { s: 39.5, z: -0.28, r: 45.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $None/1M · 183.0 t/s · TTFT 0.62s · 400k ctx`
...
| 코딩 | 54.5 | +0.3 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
...
| 긴문맥 | 45.9 | -0.28 | 실측 | [[aa-lcr]] 30.0%×1.0 |
