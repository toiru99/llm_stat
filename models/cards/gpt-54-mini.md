...
radar:
  ...
  coding: { s: 53.5, z: 0.32, r: 54.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.65/1M · 164.0 t/s · TTFT 0.7s · 400k ctx` · 가성비 26.2
...
| 코딩 | 54.7 | +0.32 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
