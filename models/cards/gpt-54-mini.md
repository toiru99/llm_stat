...
radar:
  ...
  coding: { s: 53.5, z: 0.22, r: 53.3, estimated: false }  # 코딩
  agentic: { s: 26.0, z: -0.42, r: 43.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 185.0 t/s · TTFT 0.65s · 400k ctx` · 가성비 26.1
...
| 코딩 | 53.3 | +0.22 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 43.8 | -0.42 | 실측 | [[gdpval]] 14.0%×1.0, [[itbench]] 19.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
