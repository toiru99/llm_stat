...
is_reasoning: false
radar:
  knowledge: { s: 31.9, z: -0.45, r: 43.3, estimated: false }  # 전문 지식
  ...
  trust: { s: 17.3, z: -0.52, r: 42.1, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 43.3 | -0.45 | 실측 | [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 45.6 | -0.29 | 실측 | [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
