...
radar:
  ...
  reasoning: { s: 27.5, z: -0.38, r: 44.2, estimated: false }  # 추론
  coding: { s: 5.0, z: -1.77, r: 23.5, estimated: false }  # 코딩
  agentic: { s: 19.2, z: -0.69, r: 39.7, estimated: false }  # 에이전트
  trust: { s: 11.2, z: -0.7, r: 39.5, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 42.5 | -0.5 | 실측 | [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 44.2 | -0.38 | 실측 | [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 23.5 | -1.77 | 실측 | [[scicode]] 3.0%×1.0 |
| 에이전트 | 39.7 | -0.69 | 실측 | [[tau2-bench]] 19.0%×1.0 |
| 신뢰성 | 39.5 | -0.7 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
