...
radar:
  ...
  reasoning: { s: 27.5, z: -0.39, r: 44.1, estimated: false }  # 추론
  coding: { s: 5.0, z: -1.77, r: 23.4, estimated: false }  # 코딩
  agentic: { s: 19.2, z: -0.69, r: 39.7, estimated: false }  # 에이전트
  trust: { s: 11.2, z: -0.71, r: 39.4, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 42.4 | -0.51 | 실측 | [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 44.1 | -0.39 | 실측 | [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
