...
radar:
  ...
  agentic: { s: 55.3, z: 0.7, r: 60.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 58.0 t/s · TTFT 3.98s · 262k ctx` · 가성비 15.5
...
| 에이전트 | 60.5 | +0.7 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
