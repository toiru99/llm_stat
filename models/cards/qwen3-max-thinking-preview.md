...
is_reasoning: true
radar:
  knowledge: { s: 49.3, z: 0.41, r: 56.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $None/1M · 55.0 t/s · TTFT 4.01s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.2 | +0.41 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
