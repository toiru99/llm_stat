...
is_reasoning: true
radar:
  knowledge: { s: 46.2, z: 0.29, r: 54.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 57.0 t/s · TTFT 4.03s · 262k ctx` · 가성비 15.5
...
| 에이전트 | 60.6 | +0.71 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
