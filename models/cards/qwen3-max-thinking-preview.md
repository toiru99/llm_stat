...
radar:
  ...
  reasoning: { s: 34.4, z: -0.02, r: 49.7, estimated: false }  # 추론
  coding: { s: 51.9, z: 0.19, r: 52.9, estimated: false }  # 코딩
  agentic: { s: 55.3, z: 0.78, r: 61.7, estimated: false }  # 에이전트
...
| 에이전트 | 61.7 | +0.78 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
