...
radar:
  ...
  reasoning: { s: 68.4, z: 1.72, r: 75.7, estimated: false }  # 추론
  ...
  instruction: { s: 81.9, z: 1.24, r: 68.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 117.0 t/s · TTFT 18.48s · 1M ctx` · 가성비 270.1
...
| 추론 | 75.7 | +1.72 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
