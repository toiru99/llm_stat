...
is_reasoning: true
radar:
  knowledge: { s: 70.3, z: 1.41, r: 71.2, estimated: false }  # 전문 지식
  reasoning: { s: 68.8, z: 1.68, r: 75.2, estimated: false }  # 추론
  coding: { s: 85.0, z: 1.56, r: 73.5, estimated: false }  # 코딩
  agentic: { s: 60.3, z: 0.98, r: 64.7, estimated: false }  # 에이전트
  ...
  instruction: { s: 85.0, z: 1.29, r: 69.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 181.0 t/s · TTFT 8.13s · 1M ctx` · 가성비 270.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.2 | +1.41 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 75.2 | +1.68 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 73.5 | +1.56 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 64.7 | +0.98 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
