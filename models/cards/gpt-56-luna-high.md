...
radar:
  ...
  agentic: { s: 60.3, z: 0.93, r: 63.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 84.1, z: 1.22, r: 68.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 148.0 t/s · TTFT 16.98s · 1M ctx` · 가성비 270.1
...
| 에이전트 | 63.9 | +0.93 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
