...
is_reasoning: true
radar:
  knowledge: { s: 68.5, z: 1.4, r: 71.0, estimated: false }  # 전문 지식
  reasoning: { s: 67.1, z: 1.64, r: 74.5, estimated: false }  # 추론
  coding: { s: 82.3, z: 1.51, r: 72.6, estimated: false }  # 코딩
  agentic: { s: 59.8, z: 0.88, r: 63.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 84.1, z: 1.32, r: 69.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 120.0 t/s · TTFT 14.56s · 1M ctx` · 가성비 270.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.0 | +1.4 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 74.5 | +1.64 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 72.6 | +1.51 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 63.3 | +0.88 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
