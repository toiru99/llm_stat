...
is_reasoning: true
radar:
  knowledge: { s: 71.9, z: 1.53, r: 73.0, estimated: false }  # 전문 지식
  reasoning: { s: 68.9, z: 1.89, r: 78.3, estimated: false }  # 추론
  coding: { s: 85.0, z: 1.66, r: 75.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 73.0 | +1.53 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 78.3 | +1.89 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 75.0 | +1.66 | 실측 | [[scicode]] 51.0%×1.0 |
