...
is_reasoning: true
radar:
  knowledge: { s: 70.3, z: 1.47, r: 72.1, estimated: false }  # 전문 지식
  reasoning: { s: 68.4, z: 1.72, r: 75.8, estimated: false }  # 추론
  ...
  instruction: { s: 81.9, z: 1.24, r: 68.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 121.0 t/s · TTFT 16.23s · 1M ctx` · 가성비 270.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.1 | +1.47 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 75.8 | +1.72 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 73.5 | +1.57 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 64.1 | +0.94 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
