...
radar:
  ...
  reasoning: { s: 68.9, z: 1.73, r: 75.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $None/1M · 162.0 t/s · TTFT 8.87s · 1M ctx`
...
| 추론 | 75.9 | +1.73 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
