...
radar:
  ...
  reasoning: { s: 68.9, z: 1.74, r: 76.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $None/1M · 166.0 t/s · TTFT 8.7s · 1M ctx`
...
| 추론 | 76.0 | +1.74 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 73.7 | +1.58 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 68.3 | +1.22 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 22.0%×1.0 |
