...
is_reasoning: true
radar:
  knowledge: { s: 71.9, z: 1.52, r: 72.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 175.0 t/s · TTFT 5.1s · 1M ctx` · 가성비 52.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.8 | +1.52 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 78.1 | +1.87 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 74.7 | +1.64 | 실측 | [[scicode]] 51.0%×1.0 |
