...
radar:
  ...
  reasoning: { s: 68.4, z: 1.58, r: 73.7, estimated: false }  # 추론
  coding: { s: 85.0, z: 1.48, r: 72.2, estimated: false }  # 코딩
  agentic: { s: 60.3, z: 0.88, r: 63.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 123.0 t/s · TTFT 11.33s · 1M ctx` · 가성비 270.1
...
| 추론 | 73.7 | +1.58 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 72.2 | +1.48 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 63.2 | +0.88 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
