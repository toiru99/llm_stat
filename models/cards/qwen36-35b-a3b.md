...
radar:
  ...
  coding: { s: 57.7, z: 0.42, r: 56.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.38 · 출력 $2.25 · 혼합 $0.5625/1M · 123.0 t/s · TTFT 2.08s · 262k ctx` · 가성비 56.9
...
| 코딩 | 56.3 | +0.42 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
