...
is_reasoning: true
radar:
  knowledge: { s: 43.6, z: 0.16, r: 52.4, estimated: false }  # 전문 지식
  reasoning: { s: 41.1, z: 0.33, r: 55.0, estimated: false }  # 추론
  coding: { s: 56.4, z: 0.41, r: 56.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.38 · 출력 $2.25 · 혼합 $0.5625/1M · 119.0 t/s · TTFT 2.03s · 262k ctx` · 가성비 56.9
...
| 추론 | 55.0 | +0.33 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 56.2 | +0.41 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 58.7 | +0.58 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
