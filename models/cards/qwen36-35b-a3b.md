...
radar:
  ...
  coding: { s: 57.7, z: 0.45, r: 56.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $1.49 · 혼합 $None/1M · 141.0 t/s · TTFT 2.25s · 262k ctx`
...
| 코딩 | 56.7 | +0.45 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 60.4 | +0.69 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
