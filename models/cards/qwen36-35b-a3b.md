...
radar:
  ...
  reasoning: { s: 41.5, z: -0.18, r: 47.2, estimated: false }  # 추론
  coding: { s: 58.5, z: -0.09, r: 48.6, estimated: false }  # 코딩
  agentic: { s: 55.9, z: 0.14, r: 52.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.49 · 혼합 $0.37/1M · 172.0 t/s · TTFT 2.45s · 262k ctx` · 가성비 86.5
...
| 추론 | 47.2 | -0.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 48.6 | -0.09 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 52.0 | +0.14 | 실측 | [[gdpval]] 27.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
