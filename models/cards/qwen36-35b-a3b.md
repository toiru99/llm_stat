...
radar:
  knowledge: { s: 44.8, z: -0.3, r: 45.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.25 · 출력 $1.49 · 혼합 $0.37/1M · 175.0 t/s · TTFT 2.31s · 262k ctx` · 가성비 86.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.6 | -0.3 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
