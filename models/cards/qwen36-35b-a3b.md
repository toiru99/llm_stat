...
radar:
  ...
  agentic: { s: 52.0, z: 0.02, r: 50.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.49 · 혼합 $0.37/1M · 163.0 t/s · TTFT 2.42s · 262k ctx` · 가성비 86.5
...
| 에이전트 | 50.2 | +0.02 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
