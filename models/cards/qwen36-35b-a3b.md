...
radar:
  ...
  agentic: { s: 51.5, z: 0.54, r: 58.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.38 · 출력 $2.25 · 혼합 $0.5625/1M · 131.0 t/s · TTFT 2.04s · 262k ctx` · 가성비 46.2
...
| 에이전트 | 58.1 | +0.54 | 실측 | [[gdpval]] 25.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
