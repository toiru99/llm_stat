...
radar:
  ...
  reasoning: { s: 41.5, z: 0.36, r: 55.4, estimated: false }  # 추론
  coding: { s: 57.7, z: 0.45, r: 56.8, estimated: false }  # 코딩
  agentic: { s: 54.4, z: 0.7, r: 60.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.49 · 혼합 $None/1M · 158.0 t/s · TTFT 2.21s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.6 | +0.17 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 55.4 | +0.36 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 56.8 | +0.45 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 60.4 | +0.7 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
