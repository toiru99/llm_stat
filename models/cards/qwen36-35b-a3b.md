...
radar:
  ...
  reasoning: { s: 42.0, z: 0.32, r: 54.8, estimated: false }  # 추론
  coding: { s: 57.7, z: 0.38, r: 55.7, estimated: false }  # 코딩
  agentic: { s: 52.1, z: 0.6, r: 59.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.38 · 출력 $2.25 · 혼합 $0.5625/1M · 118.0 t/s · TTFT 2.05s · 262k ctx` · 가성비 56.9
...
| 추론 | 54.8 | +0.32 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 55.7 | +0.38 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 59.0 | +0.6 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
