...
radar:
  ...
  reasoning: { s: 36.8, z: 0.12, r: 51.8, estimated: false }  # 추론
  coding: { s: 56.0, z: 0.38, r: 55.7, estimated: false }  # 코딩
...
| 추론 | 51.8 | +0.12 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 55.7 | +0.38 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
