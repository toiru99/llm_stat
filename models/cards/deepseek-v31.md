...
radar:
  ...
  reasoning: { s: 37.1, z: 0.11, r: 51.7, estimated: false }  # 추론
  coding: { s: 56.0, z: 0.36, r: 55.4, estimated: false }  # 코딩
  agentic: { s: 37.6, z: 0.08, r: 51.1, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 56.0 | +0.4 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 51.7 | +0.11 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 55.4 | +0.36 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 51.1 | +0.08 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
