...
radar:
  ...
  reasoning: { s: 36.8, z: 0.05, r: 50.8, estimated: false }  # 추론
  coding: { s: 56.0, z: 0.3, r: 54.5, estimated: false }  # 코딩
  agentic: { s: 37.6, z: 0.02, r: 50.2, estimated: false }  # 에이전트
...
| 추론 | 50.8 | +0.05 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 54.5 | +0.3 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 50.2 | +0.02 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
