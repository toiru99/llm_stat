...
radar:
  ...
  coding: { s: 54.6, z: 0.33, r: 55.0, estimated: false }  # 코딩
  agentic: { s: 37.6, z: 0.02, r: 50.3, estimated: false }  # 에이전트
...
| 추론 | 51.3 | +0.09 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 55.0 | +0.33 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 50.3 | +0.02 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
