...
radar:
  ...
  agentic: { s: 23.7, z: -0.53, r: 42.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 37.8 | -0.81 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 42.0 | -0.53 | 실측 | [[tau2-bench]] 38.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
