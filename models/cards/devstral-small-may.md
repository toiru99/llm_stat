...
radar:
  ...
  coding: { s: 30.8, z: -0.71, r: 39.3, estimated: false }  # 코딩
  agentic: { s: 23.7, z: -0.51, r: 42.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 37.7 | -0.82 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 42.4 | -0.51 | 실측 | [[tau2-bench]] 38.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
