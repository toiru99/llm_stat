...
radar:
  ...
  coding: { s: 30.8, z: -0.65, r: 40.2, estimated: false }  # 코딩
  agentic: { s: 23.7, z: -0.48, r: 42.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 38.7 | -0.75 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 35.3 | -0.98 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 40.2 | -0.65 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 42.7 | -0.48 | 실측 | [[tau2-bench]] 38.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
