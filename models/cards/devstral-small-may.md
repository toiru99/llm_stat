...
is_reasoning: false
radar:
  knowledge: { s: 25.0, z: -0.77, r: 38.4, estimated: false }  # 전문 지식
  reasoning: { s: 15.0, z: -0.98, r: 35.3, estimated: false }  # 추론
  coding: { s: 30.8, z: -0.68, r: 39.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 38.4 | -0.77 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 35.3 | -0.98 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.7 | -0.68 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
