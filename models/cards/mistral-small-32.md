...
radar:
  ...
  coding: { s: 32.4, z: -0.58, r: 41.2, estimated: false }  # 코딩
  agentic: { s: 14.8, z: -0.84, r: 37.5, estimated: false }  # 에이전트
  trust: { s: 27.1, z: -0.03, r: 49.5, estimated: false }  # 신뢰성
  multimodal: { s: 47.8, z: -1.14, r: 32.9, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 146.0 t/s · TTFT 0.67s · 128k ctx` · 가성비 91.7
...
| 코딩 | 41.2 | -0.58 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 37.5 | -0.84 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
| 신뢰성 | 49.5 | -0.03 | 실측 | [[aa-omniscience]] 24.0%×1.0 |
| 멀티모달 | 32.9 | -1.14 | 실측 | [[mmmu-pro]] 48.0%×1.0 |
