...
radar:
  ...
  coding: { s: 32.4, z: -0.67, r: 39.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 141.0 t/s · TTFT 0.85s · 128k ctx` · 가성비 91.7
...
| 코딩 | 39.9 | -0.67 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
