...
radar:
  ...
  coding: { s: 32.4, z: -0.59, r: 41.2, estimated: false }  # 코딩
  agentic: { s: 14.8, z: -0.84, r: 37.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 152.0 t/s · TTFT 0.69s · 128k ctx`
...
| 코딩 | 41.2 | -0.59 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 37.4 | -0.84 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
