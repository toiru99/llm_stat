...
radar:
  ...
  agentic: { s: 13.2, z: -0.94, r: 36.0, estimated: false }  # 에이전트
  trust: { s: 21.6, z: -0.13, r: 48.1, estimated: false }  # 신뢰성
  multimodal: { s: 47.1, z: -1.17, r: 32.4, estimated: false }  # 멀티모달
  long_context: { s: 22.9, z: -0.82, r: 37.6, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 145.0 t/s · TTFT 0.87s · 128k ctx` · 가성비 91.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.9 | -0.74 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 51.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 36.0 | -0.94 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
| 신뢰성 | 48.1 | -0.13 | 실측 | [[aa-omniscience]] 23.0%×1.0 |
| 멀티모달 | 32.4 | -1.17 | 실측 | [[mmmu-pro]] 48.0%×1.0 |
| 긴문맥 | 37.6 | -0.82 | 실측 | [[aa-lcr]] 19.0%×1.0 |
