...
radar:
  ...
  long_context: { s: 66.4, z: 0.5, r: 57.5, estimated: true }  # 긴문맥
  instruction: { s: 83.4, z: 1.25, r: 68.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 49.3 | -0.04 | 실측 | [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
