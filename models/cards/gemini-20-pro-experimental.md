...
radar:
  ...
  reasoning: { s: 35.6, z: 0.03, r: 50.5, estimated: false }  # 추론
  coding: { s: 51.7, z: 0.18, r: 52.7, estimated: false }  # 코딩
  agentic: { s: 32.6, z: -0.13, r: 48.0, estimated: true }  # 에이전트
  trust: { s: 13.1, z: -0.6, r: 41.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 63.6, z: 0.43, r: 56.4, estimated: true }  # 긴문맥
  instruction: { s: 77.4, z: 0.98, r: 64.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 50.5 | +0.03 | 실측 | [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
