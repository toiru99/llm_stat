...
radar:
  ...
  agentic: { s: 14.0, z: -0.87, r: 37.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $0.2 · 혼합 $0.2/1M · 62.0 t/s · TTFT 0.93s · 256k ctx` · 가성비 55.0
...
| 에이전트 | 37.0 | -0.87 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 27.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
