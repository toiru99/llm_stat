...
radar:
  ...
  coding: { s: 29.2, z: -0.72, r: 39.3, estimated: false }  # 코딩
  ...
  long_context: { s: 28.9, z: -0.58, r: 41.4, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $0.2 · 혼합 $0.2/1M · 83.0 t/s · TTFT 0.84s · 256k ctx` · 가성비 55.0
...
| 코딩 | 39.3 | -0.72 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
...
| 긴문맥 | 41.4 | -0.58 | 실측 | [[aa-lcr]] 22.0%×1.0 |
