...
is_reasoning: false
radar:
  knowledge: { s: 25.3, z: -0.75, r: 38.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.2 · 출력 $0.2 · 혼합 $None/1M · 66.0 t/s · TTFT 0.87s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.8 | -0.75 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
