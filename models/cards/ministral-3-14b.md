...
radar:
  ...
  reasoning: { s: 20.9, z: -0.73, r: 39.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $0.2 · 혼합 $0.2/1M · 94.0 t/s · TTFT 0.93s · 256k ctx` · 가성비 55.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.2 | -0.72 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
