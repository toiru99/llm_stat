...
is_reasoning: false
radar:
  knowledge: { s: 38.4, z: -0.11, r: 48.4, estimated: false }  # 전문 지식
  reasoning: { s: 25.4, z: -0.46, r: 43.1, estimated: false }  # 추론
  coding: { s: 49.4, z: 0.1, r: 51.5, estimated: false }  # 코딩
  agentic: { s: 38.7, z: 0.05, r: 50.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 101.0 t/s · TTFT 0.87s · 1M ctx` · 가성비 39.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.4 | -0.11 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
...
| 에이전트 | 50.8 | +0.05 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
