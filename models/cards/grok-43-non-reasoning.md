...
radar:
  ...
  coding: { s: 50.7, z: 0.08, r: 51.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 124.0 t/s · TTFT 0.75s · 1M ctx` · 가성비 39.1
...
| 코딩 | 51.2 | +0.08 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
