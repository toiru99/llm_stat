...
is_reasoning: false
radar:
  knowledge: { s: 39.9, z: -0.02, r: 49.6, estimated: false }  # 전문 지식
  reasoning: { s: 25.4, z: -0.43, r: 43.6, estimated: false }  # 추론
  coding: { s: 50.7, z: 0.2, r: 52.9, estimated: false }  # 코딩
  agentic: { s: 41.8, z: 0.22, r: 53.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 97.0 t/s · TTFT 0.94s · 1M ctx` · 가성비 39.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.6 | -0.02 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 43.6 | -0.43 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 52.9 | +0.2 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
