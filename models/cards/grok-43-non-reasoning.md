...
radar:
  ...
  agentic: { s: 40.8, z: 0.17, r: 52.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $None/1M · 122.0 t/s · TTFT 0.79s · 1M ctx`
...
| 에이전트 | 52.6 | +0.17 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
