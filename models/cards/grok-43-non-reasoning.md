...
radar:
  ...
  agentic: { s: 38.1, z: -0.5, r: 42.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 132.0 t/s · TTFT 0.72s · 1M ctx` · 가성비 39.1
...
| 에이전트 | 42.4 | -0.5 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
