...
radar:
  ...
  coding: { s: 50.7, z: 0.19, r: 52.8, estimated: false }  # 코딩
  agentic: { s: 41.8, z: 0.22, r: 53.2, estimated: false }  # 에이전트
  trust: { s: 29.4, z: 0.07, r: 51.1, estimated: false }  # 신뢰성
  multimodal: { s: 72.5, z: 0.04, r: 50.6, estimated: false }  # 멀티모달
  long_context: { s: 32.9, z: -0.46, r: 43.0, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 106.0 t/s · TTFT 0.76s · 1M ctx` · 가성비 39.1
...
| 코딩 | 52.8 | +0.19 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 53.2 | +0.22 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
| 신뢰성 | 51.1 | +0.07 | 실측 | [[aa-omniscience]] 26.0%×1.0 |
| 멀티모달 | 50.6 | +0.04 | 실측 | [[mmmu-pro]] 65.0%×1.0 |
| 긴문맥 | 43.0 | -0.46 | 실측 | [[aa-lcr]] 25.0%×1.0 |
