...
radar:
  ...
  coding: { s: 50.7, z: 0.18, r: 52.8, estimated: false }  # 코딩
  agentic: { s: 41.8, z: 0.21, r: 53.2, estimated: false }  # 에이전트
  trust: { s: 29.4, z: 0.08, r: 51.2, estimated: false }  # 신뢰성
  multimodal: { s: 72.5, z: 0.04, r: 50.6, estimated: false }  # 멀티모달
  long_context: { s: 32.9, z: -0.47, r: 42.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $None/1M · 105.0 t/s · TTFT 0.98s · 1M ctx`
...
| 코딩 | 52.8 | +0.18 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 53.2 | +0.21 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
| 신뢰성 | 51.2 | +0.08 | 실측 | [[aa-omniscience]] 26.0%×1.0 |
| 멀티모달 | 50.6 | +0.04 | 실측 | [[mmmu-pro]] 65.0%×1.0 |
| 긴문맥 | 42.9 | -0.47 | 실측 | [[aa-lcr]] 25.0%×1.0 |
