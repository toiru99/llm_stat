...
is_reasoning: false
radar:
  knowledge: { s: 38.6, z: -0.13, r: 48.1, estimated: false }  # 전문 지식
  reasoning: { s: 25.7, z: -0.48, r: 42.8, estimated: false }  # 추론
  coding: { s: 50.7, z: 0.1, r: 51.4, estimated: false }  # 코딩
  agentic: { s: 39.0, z: 0.09, r: 51.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 98.0 t/s · TTFT 0.82s · 1M ctx` · 가성비 39.1
...
| 코딩 | 51.4 | +0.1 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 51.3 | +0.09 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 66.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
