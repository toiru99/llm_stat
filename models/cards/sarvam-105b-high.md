...
radar:
  ...
  coding: { s: 29.9, z: -0.72, r: 39.3, estimated: false }  # 코딩
  agentic: { s: 25.3, z: -0.44, r: 43.5, estimated: false }  # 에이전트
...
| 코딩 | 39.3 | -0.72 | 실측 | [[scicode]] 26.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 43.5 | -0.44 | 실측 | [[tau2-bench]] 47.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
