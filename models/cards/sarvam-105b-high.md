...
Sarvam · Open · Medium(106B) · 컨텍스트 128k · 종합지능 **6.0**
...
## 실용 지표
`입력 $0.04 · 출력 $0.17 · 혼합 $0.0436/1M · None t/s · TTFT Nones · 128k ctx` · 가성비 137.6
...
| 에이전트 | 43.0 | -0.47 | 실측 | [[tau2-bench]] 47.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
