...
radar:
  ...
  agentic: { s: 38.7, z: 0.05, r: 50.7, estimated: false }  # 에이전트
  trust: { s: 37.1, z: 0.59, r: 58.8, estimated: false }  # 신뢰성
  multimodal: { s: 71.8, z: 0.07, r: 51.0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 65.0 t/s · TTFT 0.9s · 400k ctx` · 가성비 14.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.1 | +0.28 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 45.7 | -0.29 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 57.6 | +0.51 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
| 에이전트 | 50.7 | +0.05 | 실측 | [[tau2-bench]] 46.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 32.0%×1.0 |
| 신뢰성 | 58.8 | +0.59 | 실측 | [[aa-omniscience]] 38.0%×1.0 |
| 멀티모달 | 51.0 | +0.07 | 실측 | [[mmmu-pro]] 66.0%×1.0 |
