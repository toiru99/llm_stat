...
radar:
  ...
  multimodal: { s: 70.8, z: 0.03, r: 50.5, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 65.0 t/s · TTFT 0.92s · 400k ctx` · 가성비 10.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.7 | +0.25 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 45.4 | -0.31 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
...
| 멀티모달 | 50.5 | +0.03 | 실측 | [[mmmu-pro]] 66.0%×1.0 |
