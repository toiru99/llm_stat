...
radar:
  ...
  coding: { s: 76.1, z: 1.55, r: 73.2, estimated: false }  # 코딩
  agentic: { s: 77.6, z: 1.54, r: 73.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.902/1M · 71.0 t/s · TTFT 1.6s · 1M ctx` · 가성비 47.7
...
| 코딩 | 73.2 | +1.55 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 51.0%×0.5 |
| 에이전트 | 73.0 | +1.54 | 실측 | [[apex-agents]] 34.0%×1.0, [[gdpval]] 46.0%×1.0, [[itbench]] 43.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 35.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
