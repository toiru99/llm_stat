...
radar:
  ...
  agentic: { s: 78.1, z: 1.63, r: 74.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.8845/1M · 108.0 t/s · TTFT 1.38s · 1M ctx` · 가성비 59.9
...
| 에이전트 | 74.4 | +1.63 | 실측 | [[apex-agents]] 34.0%×1.0, [[gdpval]] 50.0%×1.0, [[itbench]] 43.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 35.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
