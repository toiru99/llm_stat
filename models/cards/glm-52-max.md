...
radar:
  ...
  reasoning: { s: 77.9, z: 2.14, r: 82.0, estimated: false }  # 추론
  coding: { s: 81.3, z: 1.41, r: 71.1, estimated: false }  # 코딩
  agentic: { s: 78.1, z: 1.68, r: 75.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.8635/1M · 132.0 t/s · TTFT 1.49s · 1M ctx` · 가성비 61.4
...
| 추론 | 82.0 | +2.14 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 71.1 | +1.41 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 51.0%×0.5 |
| 에이전트 | 75.2 | +1.68 | 실측 | [[apex-agents]] 34.0%×1.0, [[gdpval]] 50.0%×1.0, [[itbench]] 43.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 35.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
