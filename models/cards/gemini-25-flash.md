...
is_reasoning: true
radar:
  knowledge: { s: 45.3, z: 0.25, r: 53.7, estimated: false }  # 전문 지식
  reasoning: { s: 34.4, z: -0.0, r: 50.0, estimated: false }  # 추론
  coding: { s: 49.0, z: 0.1, r: 51.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 217.0 t/s · TTFT 17.13s · 1M ctx` · 가성비 60.4
...
| 추론 | 50.0 | +-0.0 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 51.5 | +0.1 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
