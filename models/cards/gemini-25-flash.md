...
radar:
  ...
  reasoning: { s: 35.2, z: 0.02, r: 50.2, estimated: false }  # 추론
  coding: { s: 50.4, z: 0.12, r: 51.9, estimated: false }  # 코딩
  agentic: { s: 26.8, z: -0.37, r: 44.5, estimated: false }  # 에이전트
  trust: { s: 26.7, z: 0.02, r: 50.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 235.0 t/s · TTFT 15.77s · 1M ctx` · 가성비 60.4
...
| 추론 | 50.2 | +0.02 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 51.9 | +0.12 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
