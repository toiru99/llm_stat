...
radar:
  ...
  coding: { s: 50.4, z: 0.17, r: 52.5, estimated: false }  # 코딩
  agentic: { s: 26.8, z: -0.37, r: 44.5, estimated: false }  # 에이전트
  trust: { s: 32.2, z: 0.23, r: 53.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 229.0 t/s · TTFT 16.81s · 1M ctx`
...
| 코딩 | 52.5 | +0.17 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
