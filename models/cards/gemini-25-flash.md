...
radar:
  ...
  reasoning: { s: 34.9, z: -0.03, r: 49.6, estimated: false }  # 추론
  coding: { s: 50.4, z: 0.08, r: 51.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 225.0 t/s · TTFT 19.09s · 1M ctx` · 가성비 60.4
...
| 추론 | 49.6 | -0.03 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 51.3 | +0.08 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
