...
radar:
  ...
  reasoning: { s: 34.9, z: -0.05, r: 49.3, estimated: false }  # 추론
  coding: { s: 50.4, z: 0.06, r: 51.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 218.0 t/s · TTFT 20.81s · 1M ctx` · 가성비 60.4
...
| 코딩 | 51.0 | +0.06 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
