...
radar:
  ...
  reasoning: { s: 34.8, z: 0.02, r: 50.4, estimated: false }  # 추론
  coding: { s: 50.4, z: 0.15, r: 52.2, estimated: false }  # 코딩
  agentic: { s: 26.8, z: -0.37, r: 44.4, estimated: false }  # 에이전트
  trust: { s: 32.2, z: 0.19, r: 52.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 229.0 t/s · TTFT 20.64s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.6 | +0.24 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 50.4 | +0.02 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 52.2 | +0.15 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 44.4 | -0.37 | 실측 | [[tau2-bench]] 32.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
| 신뢰성 | 52.9 | +0.19 | 실측 | [[aa-omniscience]] 29.0%×1.0 |
