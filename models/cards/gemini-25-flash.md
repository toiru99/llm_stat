...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 199.0 t/s · TTFT 18.11s · 1M ctx` · 가성비 60.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.1 | +0.27 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
