...
radar:
  ...
  agentic: { s: 16.7, z: -0.78, r: 38.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $1.47/1M · 58.0 t/s · TTFT 2.74s · 32k ctx` · 가성비 8.8
...
| 에이전트 | 38.2 | -0.78 | 실측 | [[tau2-bench]] 24.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
