...
radar:
  ...
  reasoning: { s: 29.7, z: -0.28, r: 45.9, estimated: false }  # 추론
  coding: { s: 47.5, z: -0.03, r: 49.5, estimated: false }  # 코딩
  agentic: { s: 16.7, z: -0.79, r: 38.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $1.47/1M · 59.0 t/s · TTFT 2.78s · 32k ctx` · 가성비 8.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.6 | -0.23 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 45.9 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 49.5 | -0.03 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 38.2 | -0.79 | 실측 | [[tau2-bench]] 24.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
