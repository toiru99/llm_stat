...
Alibaba · Open · Large(235B) · 컨텍스트 32k · 종합지능 **8.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $1.47/1M · 65.0 t/s · TTFT 2.76s · 32k ctx` · 가성비 5.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.5 | -0.23 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 45.6 | -0.29 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 37.9 | -0.81 | 실측 | [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 38.0 | -0.8 | 실측 | [[tau2-bench]] 24.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
