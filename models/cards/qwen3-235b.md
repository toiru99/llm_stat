...
is_reasoning: true
radar:
  knowledge: { s: 37.2, z: -0.19, r: 47.2, estimated: false }  # 전문 지식
  reasoning: { s: 30.9, z: -0.18, r: 47.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $None/1M · 59.0 t/s · TTFT 2.81s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.2 | -0.19 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 47.4 | -0.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
