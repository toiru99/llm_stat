...
is_reasoning: false
radar:
  knowledge: { s: 27.3, z: -0.66, r: 40.0, estimated: true }  # 전문 지식
  reasoning: { s: 22.2, z: -0.65, r: 40.3, estimated: true }  # 추론
  coding: { s: 34.3, z: -0.57, r: 41.4, estimated: true }  # 코딩
  agentic: { s: 20.2, z: -0.65, r: 40.3, estimated: false }  # 에이전트
  trust: { s: 23.6, z: -0.16, r: 47.6, estimated: true }  # 신뢰성
