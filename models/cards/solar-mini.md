...
is_reasoning: false
radar:
  knowledge: { s: 27.9, z: -0.62, r: 40.8, estimated: true }  # 전문 지식
  reasoning: { s: 22.4, z: -0.61, r: 40.8, estimated: true }  # 추론
  coding: { s: 34.3, z: -0.54, r: 41.9, estimated: true }  # 코딩
  agentic: { s: 20.2, z: -0.62, r: 40.7, estimated: false }  # 에이전트
  trust: { s: 23.6, z: -0.12, r: 48.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 17.1, z: -0.97, r: 35.4, estimated: true }  # 긴문맥
  instruction: { s: 32.3, z: -0.88, r: 36.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
