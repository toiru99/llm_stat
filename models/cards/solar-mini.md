...
is_reasoning: false
radar:
  knowledge: { s: 27.9, z: -0.62, r: 40.7, estimated: true }  # 전문 지식
  reasoning: { s: 22.4, z: -0.62, r: 40.7, estimated: true }  # 추론
  ...
  long_context: { s: 15.8, z: -1.02, r: 34.7, estimated: true }  # 긴문맥
  instruction: { s: 29.3, z: -1.01, r: 34.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
