...
radar:
  ...
  agentic: { s: 48.5, z: 0.43, r: 56.4, estimated: false }  # 에이전트
...
| 추론 | 39.1 | -0.72 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 54.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 33.2 | -1.12 | 실측 | [[scicode]] 18.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 56.4 | +0.43 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
