...
is_reasoning: true
radar:
  knowledge: { s: 36.2, z: -0.22, r: 46.8, estimated: false }  # 전문 지식
  reasoning: { s: 32.7, z: -0.1, r: 48.4, estimated: false }  # 추론
  coding: { s: 39.3, z: -0.32, r: 45.1, estimated: false }  # 코딩
  agentic: { s: 18.5, z: -0.73, r: 39.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.065/1M · 248.0 t/s · TTFT 1.19s · 1M ctx` · 가성비 230.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.8 | -0.22 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 48.4 | -0.1 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 45.1 | -0.32 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 39.0 | -0.73 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
