...
radar:
  ...
  agentic: { s: 18.6, z: -0.69, r: 39.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.065/1M · 250.0 t/s · TTFT 1.33s · 1M ctx` · 가성비 230.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.9 | -0.21 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
...
| 에이전트 | 39.6 | -0.69 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
