...
is_reasoning: false
radar:
  knowledge: { s: 17.1, z: -1.17, r: 32.5, estimated: false }  # 전문 지식
  reasoning: { s: 14.6, z: -1.0, r: 34.9, estimated: false }  # 추론
  coding: { s: 23.2, z: -1.02, r: 34.7, estimated: false }  # 코딩
...
| 코딩 | 34.7 | -1.02 | 실측 | [[scicode]] 20.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
