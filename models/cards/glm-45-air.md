...
radar:
  ...
  coding: { s: 44.5, z: -0.11, r: 48.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.17 · 출력 $0.98 · 혼합 $0.251/1M · 90.0 t/s · TTFT 2.59s · 128k ctx` · 가성비 67.7
...
| 코딩 | 48.4 | -0.11 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
