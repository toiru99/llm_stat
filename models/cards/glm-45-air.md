...
radar:
  ...
  coding: { s: 44.5, z: -0.06, r: 49.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.17 · 출력 $0.98 · 혼합 $0.25/1M · 75.0 t/s · TTFT 2.71s · 128k ctx` · 가성비 68.0
...
| 코딩 | 49.1 | -0.06 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
