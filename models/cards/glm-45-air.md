...
radar:
  ...
  coding: { s: 44.5, z: -0.15, r: 47.7, estimated: false }  # 코딩
  agentic: { s: 38.4, z: 0.07, r: 51.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.17 · 출력 $0.98 · 혼합 $0.251/1M · 68.0 t/s · TTFT 2.81s · 128k ctx` · 가성비 67.7
...
| 에이전트 | 51.0 | +0.07 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
