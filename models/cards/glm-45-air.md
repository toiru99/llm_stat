...
is_reasoning: true
radar:
  knowledge: { s: 34.4, z: -0.3, r: 45.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.17 · 출력 $0.98 · 혼합 $0.25/1M · 73.0 t/s · TTFT 2.7s · 128k ctx` · 가성비 68.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.6 | -0.3 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
