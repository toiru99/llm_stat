...
is_reasoning: false
radar:
  knowledge: { s: 31.3, z: -0.45, r: 43.2, estimated: false }  # 전문 지식
  reasoning: { s: 24.5, z: -0.49, r: 42.7, estimated: false }  # 추론
  coding: { s: 32.1, z: -0.6, r: 40.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $None/1M · 101.0 t/s · TTFT 2.18s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.2 | -0.45 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 42.7 | -0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 40.9 | -0.6 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
