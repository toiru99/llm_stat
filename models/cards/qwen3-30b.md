...
radar:
  ...
  reasoning: { s: 24.5, z: -0.48, r: 42.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $None/1M · 108.0 t/s · TTFT 2.15s · 32k ctx`
...
| 추론 | 42.7 | -0.48 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
