...
radar:
  ...
  reasoning: { s: 24.5, z: -0.48, r: 42.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 100.0 t/s · TTFT 2.29s · 32k ctx` · 가성비 21.4
...
| 추론 | 42.8 | -0.48 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
