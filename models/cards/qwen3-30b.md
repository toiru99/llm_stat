...
radar:
  ...
  coding: { s: 32.1, z: -0.59, r: 41.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 101.0 t/s · TTFT 2.36s · 32k ctx` · 가성비 21.4
...
| 코딩 | 41.2 | -0.59 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
