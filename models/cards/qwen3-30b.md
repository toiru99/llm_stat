...
is_reasoning: true
radar:
  knowledge: { s: 29.8, z: -0.54, r: 42.0, estimated: false }  # 전문 지식
...
Alibaba · Open · Small(30.5B) · 컨텍스트 32k · 종합지능 **4.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 107.0 t/s · TTFT 2.17s · 32k ctx` · 가성비 9.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.0 | -0.54 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
