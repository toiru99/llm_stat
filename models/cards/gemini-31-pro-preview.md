...
radar:
  ...
  reasoning: { s: 80.3, z: 2.48, r: 87.2, estimated: false }  # 추론
  coding: { s: 92.8, z: 1.98, r: 79.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 136.0 t/s · TTFT 28.35s · 1M ctx` · 가성비 26.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.1 | +2.48 | 실측 | [[aa-omniscience]] 55.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 87.2 | +2.48 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
| 코딩 | 79.8 | +1.98 | 실측 | [[scicode]] 59.0%×1.0, [[terminal-bench]] 54.0%×0.5 |
