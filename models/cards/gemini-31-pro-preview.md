...
is_reasoning: true
radar:
  knowledge: { s: 88.2, z: 2.28, r: 84.2, estimated: false }  # 전문 지식
  reasoning: { s: 80.5, z: 2.26, r: 83.9, estimated: false }  # 추론
  coding: { s: 92.8, z: 1.89, r: 78.3, estimated: false }  # 코딩
  agentic: { s: 62.4, z: 1.05, r: 65.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 126.0 t/s · TTFT 31.61s · 1M ctx` · 가성비 27.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 84.2 | +2.28 | 실측 | [[aa-omniscience]] 55.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 47.0%×0.3 |
...
| 에이전트 | 65.8 | +1.05 | 실측 | [[apex-agents]] 32.0%×1.0, [[gdpval]] 23.0%×1.0, [[itbench]] 30.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 54.0%×1.0 |
