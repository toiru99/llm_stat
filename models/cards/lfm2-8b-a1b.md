...
is_reasoning: false
radar:
  knowledge: { s: 14.4, z: -1.28, r: 30.8, estimated: false }  # 전문 지식
  reasoning: { s: 11.9, z: -1.15, r: 32.7, estimated: false }  # 추론
  coding: { s: 7.8, z: -1.66, r: 25.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 30.8 | -1.28 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 34.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
