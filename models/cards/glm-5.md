...
radar:
  ...
  reasoning: { s: 47.3, z: 0.65, r: 59.7, estimated: false }  # 추론
  coding: { s: 72.8, z: 1.08, r: 66.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $3.2 · 혼합 $None/1M · 40.0 t/s · TTFT 1.58s · 200k ctx`
...
| 추론 | 59.7 | +0.65 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 66.1 | +1.08 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
