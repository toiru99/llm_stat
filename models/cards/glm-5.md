...
is_reasoning: false
radar:
  knowledge: { s: 54.5, z: 0.67, r: 60.0, estimated: false }  # 전문 지식
  reasoning: { s: 47.3, z: 0.71, r: 60.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.0 · 출력 $3.2 · 혼합 $None/1M · 56.0 t/s · TTFT 1.47s · 200k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.0 | +0.67 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 60.7 | +0.71 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
