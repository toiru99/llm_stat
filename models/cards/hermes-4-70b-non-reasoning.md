...
is_reasoning: false
radar:
  knowledge: { s: 28.4, z: -0.59, r: 41.1, estimated: false }  # 전문 지식
  reasoning: { s: 17.0, z: -0.87, r: 36.9, estimated: false }  # 추론
  coding: { s: 30.1, z: -0.7, r: 39.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.13 · 출력 $0.4 · 혼합 $0.157/1M · 73.0 t/s · TTFT 1.43s · 128k ctx` · 가성비 44.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.1 | -0.59 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 36.9 | -0.87 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.5 | -0.7 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 34.8 | -1.02 | 실측 | [[tau2-bench]] 22.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
