...
radar:
  ...
  agentic: { s: 33.1, z: -0.16, r: 47.5, estimated: true }  # 에이전트
  trust: { s: 30.9, z: 0.09, r: 51.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.6, z: -0.79, r: 38.1, estimated: true }  # 긴문맥
  instruction: { s: 39.4, z: -0.61, r: 40.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
