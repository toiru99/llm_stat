...
radar:
  ...
  agentic: { s: 33.1, z: -0.11, r: 48.4, estimated: true }  # 에이전트
  trust: { s: 20.0, z: -0.4, r: 44.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 38.7, z: -0.33, r: 45.0, estimated: true }  # 긴문맥
  instruction: { s: 46.8, z: -0.27, r: 46.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 40.3 | -0.65 | 실측 | [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.7 | -0.49 | 실측 | [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
