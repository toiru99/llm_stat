...
radar:
  ...
  agentic: { s: 33.1, z: -0.14, r: 47.9, estimated: true }  # 에이전트
  trust: { s: 30.6, z: 0.15, r: 52.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.6, z: -0.78, r: 38.3, estimated: true }  # 긴문맥
  instruction: { s: 40.4, z: -0.56, r: 41.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
