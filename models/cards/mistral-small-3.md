...
radar:
  ...
  trust: { s: 25.7, z: 0.07, r: 51.0, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 139.0 t/s · TTFT 0.89s · 32k ctx` · 가성비 58.3
...
| 추론 | 42.0 | -0.54 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
