...
is_reasoning: false
radar:
  knowledge: { s: 27.0, z: -0.67, r: 40.0, estimated: false }  # 전문 지식
  reasoning: { s: 24.3, z: -0.5, r: 42.4, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.29, r: 45.7, estimated: false }  # 코딩
  agentic: { s: 20.2, z: -0.63, r: 40.6, estimated: false }  # 에이전트
  trust: { s: 39.8, z: 0.55, r: 58.2, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 149.0 t/s · TTFT 0.74s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.0 | -0.67 | 실측 | [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.4 | -0.5 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
