...
is_reasoning: false
radar:
  knowledge: { s: 27.0, z: -0.68, r: 39.9, estimated: false }  # 전문 지식
  reasoning: { s: 24.3, z: -0.51, r: 42.3, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.29, r: 45.6, estimated: false }  # 코딩
  agentic: { s: 20.2, z: -0.63, r: 40.5, estimated: false }  # 에이전트
  trust: { s: 39.8, z: 0.53, r: 58.0, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 150.0 t/s · TTFT 0.82s · 32k ctx` · 가성비 58.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.9 | -0.68 | 실측 | [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.3 | -0.51 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
