...
radar:
  ...
  reasoning: { s: 11.6, z: -1.14, r: 32.8, estimated: false }  # 추론
  coding: { s: 4.2, z: -1.78, r: 23.3, estimated: true }  # 코딩
  agentic: { s: 7.6, z: -1.11, r: 33.3, estimated: true }  # 에이전트
  trust: { s: 16.8, z: -0.53, r: 42.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 3.4, z: -1.36, r: 29.5, estimated: true }  # 긴문맥
...
| 추론 | 32.8 | -1.14 | 실측 | [[gpqa-diamond]] 23.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 23.3 | -1.78 | 추정 | (추정) |
