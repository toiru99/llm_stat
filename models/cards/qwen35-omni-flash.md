...
radar:
  ...
  agentic: { s: 49.0, z: 0.45, r: 56.8, estimated: false }  # 에이전트
  trust: { s: 5.8, z: -0.97, r: 35.5, estimated: false }  # 신뢰성
  multimodal: { s: 71.4, z: -0.06, r: 49.1, estimated: false }  # 멀티모달
  long_context: { s: 59.0, z: 0.24, r: 53.7, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.1 · 출력 $0.8 · 혼합 $0.17/1M · 253.0 t/s · TTFT 1.82s · 256k ctx` · 가성비 111.8
...
| 에이전트 | 56.8 | +0.45 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
| 신뢰성 | 35.5 | -0.97 | 실측 | [[aa-omniscience]] 7.0%×1.0 |
| 멀티모달 | 49.1 | -0.06 | 실측 | [[mmmu-pro]] 65.0%×1.0 |
| 긴문맥 | 53.7 | +0.24 | 실측 | [[aa-lcr]] 49.0%×1.0 |
