...
is_reasoning: false
radar:
  knowledge: { s: 32.7, z: -0.4, r: 43.9, estimated: false }  # 전문 지식
  reasoning: { s: 29.2, z: -0.26, r: 46.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.8 · 혼합 $None/1M · 239.0 t/s · TTFT 2.03s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.9 | -0.4 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.0 | -0.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
