...
radar:
  ...
  coding: { s: 36.3, z: -0.45, r: 43.2, estimated: false }  # 코딩
  ...
  long_context: { s: 41.0, z: -0.28, r: 45.8, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 59.0 t/s · TTFT 2.78s · 256k ctx` · 가성비 52.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.7 | -0.48 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.3 | -0.44 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 43.2 | -0.45 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
...
| 긴문맥 | 45.8 | -0.28 | 실측 | [[aa-lcr]] 34.0%×1.0 |
