...
is_reasoning: false
radar:
  knowledge: { s: 30.8, z: -0.47, r: 42.9, estimated: false }  # 전문 지식
  reasoning: { s: 25.8, z: -0.43, r: 43.5, estimated: false }  # 추론
  coding: { s: 36.3, z: -0.44, r: 43.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 56.0 t/s · TTFT 2.73s · 256k ctx` · 가성비 52.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.9 | -0.47 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.5 | -0.43 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 43.4 | -0.44 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
