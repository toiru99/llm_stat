...
is_reasoning: true
radar:
  knowledge: { s: 59.6, z: 0.85, r: 62.8, estimated: false }  # 전문 지식
  reasoning: { s: 39.2, z: 0.23, r: 53.4, estimated: false }  # 추론
  coding: { s: 58.8, z: 0.47, r: 57.1, estimated: false }  # 코딩
  agentic: { s: 24.7, z: -0.44, r: 43.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.5 · 혼합 $0.2175/1M · 312.0 t/s · TTFT 6.58s · 1M ctx` · 가성비 114.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.8 | +0.85 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 53.4 | +0.23 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.1 | +0.47 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 43.3 | -0.44 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 7.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
