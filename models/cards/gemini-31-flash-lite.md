...
radar:
  ...
  agentic: { s: 22.7, z: -1.15, r: 32.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.5 · 혼합 $0.22/1M · 357.0 t/s · TTFT 5.6s · 1M ctx` · 가성비 113.6
...
| 에이전트 | 32.7 | -1.15 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 5.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
