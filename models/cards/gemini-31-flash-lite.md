...
radar:
  ...
  agentic: { s: 23.3, z: -1.09, r: 33.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.5 · 혼합 $0.22/1M · 290.0 t/s · TTFT 5.16s · 1M ctx` · 가성비 113.6
...
| 에이전트 | 33.6 | -1.09 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 7.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
