...
is_reasoning: true
radar:
  knowledge: { s: 59.6, z: 0.93, r: 63.9, estimated: false }  # 전문 지식
  reasoning: { s: 39.2, z: 0.3, r: 54.6, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $1.5 · 혼합 $0.22/1M · 292.0 t/s · TTFT 5.85s · 1M ctx` · 가성비 113.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.9 | +0.93 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 54.6 | +0.3 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 44.1 | -0.39 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 7.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
