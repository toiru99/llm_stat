...
radar:
  ...
  agentic: { s: 24.3, z: -0.48, r: 42.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $1.5 · 혼합 $0.2175/1M · 318.0 t/s · TTFT 5.7s · 1M ctx` · 가성비 119.5
...
| 에이전트 | 42.7 | -0.48 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 7.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
