...
radar:
  ...
  agentic: { s: 39.3, z: 0.09, r: 51.3, estimated: true }  # 에이전트
  trust: { s: 34.6, z: 0.49, r: 57.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 46.7, z: -0.09, r: 48.6, estimated: true }  # 긴문맥
  instruction: { s: 47.8, z: -0.21, r: 46.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
