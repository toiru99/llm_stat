...
radar:
  ...
  trust: { s: 68.1, z: 1.81, r: 77.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 50.8, z: 0.01, r: 50.2, estimated: true }  # 긴문맥
  instruction: { s: 44.5, z: -0.4, r: 44.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
