...
radar:
  ...
  agentic: { s: 38.7, z: 0.08, r: 51.2, estimated: true }  # 에이전트
  trust: { s: 55.3, z: 1.26, r: 68.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 48.4, z: -0.06, r: 49.1, estimated: true }  # 긴문맥
  instruction: { s: 60.3, z: 0.25, r: 53.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
