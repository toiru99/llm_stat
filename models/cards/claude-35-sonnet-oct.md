...
radar:
  ...
  agentic: { s: 41.6, z: 0.21, r: 53.1, estimated: true }  # 에이전트
  trust: { s: 40.7, z: 0.64, r: 59.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 49.4, z: 0.01, r: 50.1, estimated: true }  # 긴문맥
  instruction: { s: 47.9, z: -0.2, r: 46.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 49.2 | -0.06 | 실측 | [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 59.6 | +0.64 | 실측 | [[scicode]] 37.0%×1.0 |
| 에이전트 | 53.1 | +0.21 | 추정 | (추정) |
| 신뢰성 | 59.5 | +0.64 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 50.1 | +0.01 | 추정 | (추정) |
| 지시 따르기 | 46.9 | -0.2 | 추정 | (추정) |
