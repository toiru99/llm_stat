...
radar:
  ...
  trust: { s: 12.2, z: -0.56, r: 41.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 71.3, z: 0.67, r: 60.1, estimated: true }  # 긴문맥
  instruction: { s: 59.7, z: 0.31, r: 54.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
