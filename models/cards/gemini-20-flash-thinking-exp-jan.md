...
radar:
  ...
  trust: { s: 14.0, z: -0.57, r: 41.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 64.1, z: 0.45, r: 56.7, estimated: true }  # 긴문맥
  instruction: { s: 55.8, z: 0.09, r: 51.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
