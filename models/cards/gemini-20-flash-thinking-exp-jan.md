...
radar:
  ...
  agentic: { s: 43.5, z: 0.26, r: 53.9, estimated: true }  # 에이전트
  trust: { s: 12.2, z: -0.57, r: 41.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 71.3, z: 0.68, r: 60.1, estimated: true }  # 긴문맥
  instruction: { s: 59.7, z: 0.31, r: 54.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 54.1 | +0.28 | 실측 | [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
