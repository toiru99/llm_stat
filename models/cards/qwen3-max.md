...
radar:
  ...
  agentic: { s: 52.5, z: 0.67, r: 60.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 65.0 t/s · TTFT 2.37s · 262k ctx` · 가성비 14.3
...
| 에이전트 | 60.0 | +0.67 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
