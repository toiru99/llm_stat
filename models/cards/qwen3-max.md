...
is_reasoning: false
radar:
  knowledge: { s: 44.4, z: 0.18, r: 52.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $None/1M · 54.0 t/s · TTFT 2.37s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.8 | +0.18 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
