...
radar:
  ...
  coding: { s: 52.3, z: 0.17, r: 52.5, estimated: false }  # 코딩
  agentic: { s: 52.5, z: 0.62, r: 59.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 62.0 t/s · TTFT 2.4s · 262k ctx` · 가성비 14.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.3 | +0.09 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 48.0 | -0.13 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 52.5 | +0.17 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
| 에이전트 | 59.3 | +0.62 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
