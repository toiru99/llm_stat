...
radar:
  ...
  coding: { s: 52.3, z: 0.27, r: 54.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 57.0 t/s · TTFT 2.58s · 262k ctx` · 가성비 14.3
...
| 코딩 | 54.1 | +0.27 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
