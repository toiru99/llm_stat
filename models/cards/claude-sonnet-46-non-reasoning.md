...
radar:
  ...
  agentic: { s: 76.9, z: 0.98, r: 64.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 45.0 t/s · TTFT 1.39s · 1M ctx` · 가성비 15.6
...
| 에이전트 | 64.8 | +0.98 | 실측 | [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
