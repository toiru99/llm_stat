...
radar:
  ...
  reasoning: { s: 35.9, z: 0.02, r: 50.3, estimated: false }  # 추론
  coding: { s: 75.5, z: 1.11, r: 66.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 43.0 t/s · TTFT 1.24s · 1M ctx` · 가성비 16.0
...
| 추론 | 50.3 | +0.02 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 66.6 | +1.11 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
