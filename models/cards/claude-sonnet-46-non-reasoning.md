...
is_reasoning: false
radar:
  knowledge: { s: 60.0, z: 0.89, r: 63.3, estimated: false }  # 전문 지식
  reasoning: { s: 36.5, z: 0.11, r: 51.6, estimated: false }  # 추론
  coding: { s: 75.5, z: 1.19, r: 67.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 43.0 t/s · TTFT 1.56s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.3 | +0.89 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
| 추론 | 51.6 | +0.11 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 67.9 | +1.19 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
