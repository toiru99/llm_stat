...
radar:
  ...
  coding: { s: 7.8, z: -2.22, r: 16.6, estimated: false }  # 코딩
  agentic: { s: 10.1, z: -1.66, r: 25.1, estimated: false }  # 에이전트
...
| 코딩 | 16.6 | -2.22 | 실측 | [[scicode]] 7.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 25.1 | -1.66 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
