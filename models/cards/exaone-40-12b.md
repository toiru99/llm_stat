...
radar:
  ...
  agentic: { s: 8.1, z: -1.14, r: 32.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 34.2 | -1.05 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
...
| 에이전트 | 32.9 | -1.14 | 실측 | [[tau2-bench]] 16.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
