...
radar:
  ...
  coding: { s: 7.5, z: -1.66, r: 25.1, estimated: false }  # 코딩
  agentic: { s: 10.1, z: -1.06, r: 34.1, estimated: false }  # 에이전트
...
LG AI Research · Open · Tiny(1.28B) · 컨텍스트 64k · 종합지능 **2.0**
...
| 추론 | 35.6 | -0.96 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 42.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 25.1 | -1.66 | 실측 | [[scicode]] 7.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 34.1 | -1.06 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
