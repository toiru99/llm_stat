...
is_reasoning: false
radar:
  knowledge: { s: 44.3, z: 0.18, r: 52.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 173.0 t/s · TTFT 0.79s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.6 | +0.18 | 실측 | [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
