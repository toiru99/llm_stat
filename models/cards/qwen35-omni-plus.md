...
radar:
  ...
  coding: { s: 54.7, z: 0.32, r: 54.8, estimated: false }  # 코딩
  agentic: { s: 60.4, z: 0.89, r: 63.3, estimated: false }  # 에이전트
  trust: { s: 62.9, z: 1.81, r: 77.1, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 125.0 t/s · TTFT 2.06s · 256k ctx` · 가성비 36.9
...
| 신뢰성 | 77.1 | +1.81 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
