...
is_reasoning: false
radar:
  knowledge: { s: 39.4, z: -0.05, r: 49.3, estimated: false }  # 전문 지식
  reasoning: { s: 37.7, z: 0.16, r: 52.5, estimated: false }  # 추론
  coding: { s: 54.7, z: 0.34, r: 55.1, estimated: false }  # 코딩
  agentic: { s: 60.4, z: 0.9, r: 63.6, estimated: false }  # 에이전트
  trust: { s: 62.9, z: 1.84, r: 77.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 127.0 t/s · TTFT 2.01s · 256k ctx` · 가성비 36.9
...
| 추론 | 52.5 | +0.16 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 55.1 | +0.34 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 63.6 | +0.9 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
| 신뢰성 | 77.6 | +1.84 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
