...
radar:
  ...
  coding: { s: 56.2, z: 0.31, r: 54.6, estimated: false }  # 코딩
  agentic: { s: 60.4, z: 0.9, r: 63.4, estimated: false }  # 에이전트
  trust: { s: 70.9, z: 1.84, r: 77.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 48.0 t/s · TTFT 2.41s · 256k ctx` · 가성비 36.9
...
| 추론 | 51.9 | +0.13 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 54.6 | +0.31 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 63.4 | +0.9 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
