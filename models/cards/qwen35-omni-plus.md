...
radar:
  ...
  agentic: { s: 61.1, z: 0.36, r: 55.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 50.0 t/s · TTFT 2.37s · 256k ctx` · 가성비 36.9
...
| 에이전트 | 55.4 | +0.36 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
