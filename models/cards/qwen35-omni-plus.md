...
radar:
  ...
  trust: { s: 70.9, z: 1.77, r: 76.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 134.0 t/s · TTFT 2.24s · 256k ctx` · 가성비 36.9
...
| 에이전트 | 63.2 | +0.88 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
| 신뢰성 | 76.5 | +1.77 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
