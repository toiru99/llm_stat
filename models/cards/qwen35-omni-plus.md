...
radar:
  ...
  coding: { s: 56.2, z: 0.32, r: 54.8, estimated: false }  # 코딩
  agentic: { s: 60.4, z: 0.92, r: 63.8, estimated: false }  # 에이전트
  trust: { s: 70.9, z: 1.92, r: 78.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $4.8 · 혼합 $0.84/1M · 49.0 t/s · TTFT 2.49s · 256k ctx` · 가성비 36.9
...
| 추론 | 52.1 | +0.14 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 54.8 | +0.32 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 63.8 | +0.92 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
| 신뢰성 | 78.8 | +1.92 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
