...
is_reasoning: true
radar:
  knowledge: { s: 40.6, z: 0.01, r: 50.1, estimated: false }  # 전문 지식
  reasoning: { s: 31.2, z: -0.12, r: 48.1, estimated: false }  # 추론
  coding: { s: 49.9, z: 0.16, r: 52.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $5.0 · 혼합 $2.3/1M · 39.0 t/s · TTFT 1.72s · 128k ctx` · 가성비 7.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.1 | +0.01 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 48.1 | -0.12 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 52.4 | +0.16 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 13.0%×0.5 |
