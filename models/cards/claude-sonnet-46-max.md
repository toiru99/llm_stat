...
is_reasoning: true
radar:
  knowledge: { s: 69.2, z: 1.42, r: 71.2, estimated: false }  # 전문 지식
  ...
  trust: { s: 51.5, z: 1.31, r: 69.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 66.0 t/s · TTFT 138.26s · 1M ctx` · 가성비 20.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.2 | +1.42 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 64.5 | +0.97 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
...
| 신뢰성 | 69.6 | +1.31 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
