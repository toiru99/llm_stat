...
radar:
  ...
  agentic: { s: 69.8, z: 1.31, r: 69.6, estimated: false }  # 에이전트
  trust: { s: 58.1, z: 1.37, r: 70.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 54.0 t/s · TTFT 111.85s · 1M ctx` · 가성비 20.8
...
| 에이전트 | 69.6 | +1.31 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 44.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 34.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
| 신뢰성 | 70.6 | +1.37 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
