...
radar:
  ...
  reasoning: { s: 52.3, z: 0.88, r: 63.1, estimated: false }  # 추론
  coding: { s: 79.0, z: 1.31, r: 69.7, estimated: false }  # 코딩
  agentic: { s: 70.9, z: 1.4, r: 71.1, estimated: false }  # 에이전트
  trust: { s: 60.9, z: 1.47, r: 72.1, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 60.0 t/s · TTFT 89.07s · 1M ctx` · 가성비 20.3
...
| 추론 | 63.1 | +0.88 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
| 코딩 | 69.7 | +1.31 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 71.1 | +1.4 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 44.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
