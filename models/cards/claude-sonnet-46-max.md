...
radar:
  ...
  coding: { s: 79.0, z: 1.33, r: 69.9, estimated: false }  # 코딩
  agentic: { s: 73.8, z: 1.45, r: 71.8, estimated: false }  # 에이전트
  trust: { s: 60.9, z: 1.52, r: 72.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 56.0 t/s · TTFT 90.17s · 1M ctx` · 가성비 20.3
...
| 코딩 | 69.9 | +1.33 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 71.8 | +1.45 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 44.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
| 신뢰성 | 72.7 | +1.52 | 실측 | [[aa-omniscience]] 54.0%×1.0 |
