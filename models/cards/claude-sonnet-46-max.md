...
is_reasoning: true
radar:
  knowledge: { s: 69.2, z: 1.42, r: 71.3, estimated: false }  # 전문 지식
  reasoning: { s: 53.7, z: 0.97, r: 64.6, estimated: false }  # 추론
  coding: { s: 79.0, z: 1.32, r: 69.7, estimated: false }  # 코딩
  agentic: { s: 70.0, z: 1.3, r: 69.5, estimated: false }  # 에이전트
  trust: { s: 51.5, z: 1.3, r: 69.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 58.0 t/s · TTFT 128.19s · 1M ctx` · 가성비 20.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.3 | +1.42 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 64.6 | +0.97 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 69.7 | +1.32 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
...
| 신뢰성 | 69.4 | +1.3 | 실측 | [[aa-omniscience]] 52.0%×1.0 |
