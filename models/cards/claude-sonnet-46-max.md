...
radar:
  ...
  agentic: { s: 69.3, z: 1.22, r: 68.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 65.0 t/s · TTFT 132.16s · 1M ctx` · 가성비 16.5
...
| 에이전트 | 68.2 | +1.22 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 40.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 34.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
