...
radar:
  ...
  coding: { s: 79.0, z: 1.25, r: 68.8, estimated: false }  # 코딩
  agentic: { s: 69.8, z: 1.29, r: 69.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 55.0 t/s · TTFT 149.24s · 1M ctx` · 가성비 20.8
...
| 추론 | 63.3 | +0.89 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 68.8 | +1.25 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 53.0%×0.5 |
| 에이전트 | 69.4 | +1.29 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 44.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 34.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
