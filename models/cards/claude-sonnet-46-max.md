...
radar:
  ...
  agentic: { s: 73.8, z: 1.46, r: 71.8, estimated: false }  # 에이전트
  trust: { s: 60.9, z: 1.55, r: 73.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 55.0 t/s · TTFT 106.32s · 1M ctx`
...
| 에이전트 | 71.8 | +1.46 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 44.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 53.0%×1.0 |
| 신뢰성 | 73.3 | +1.55 | 실측 | [[aa-omniscience]] 54.0%×1.0 |
