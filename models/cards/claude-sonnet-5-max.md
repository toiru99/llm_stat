...
radar:
  ...
  coding: { s: 90.0, z: 1.31, r: 69.7, estimated: false }  # 코딩
  agentic: { s: 88.8, z: 1.44, r: 71.6, estimated: false }  # 에이전트
  ...
  instruction: { s: 82.0, z: 0.56, r: 58.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 79.0 t/s · TTFT 191.31s · 1M ctx` · 가성비 34.4
...
| 코딩 | 69.7 | +1.31 | 실측 | [[scicode]] 54.0%×1.0 |
