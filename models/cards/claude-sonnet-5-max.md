...
radar:
  ...
  agentic: { s: 86.1, z: 1.95, r: 79.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 71.0 t/s · TTFT 204.14s · 1M ctx` · 가성비 34.4
...
| 에이전트 | 79.3 | +1.95 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
