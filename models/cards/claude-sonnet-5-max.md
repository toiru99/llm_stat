...
radar:
  ...
  agentic: { s: 77.3, z: 1.6, r: 73.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 67.0 t/s · TTFT 176.94s · 1M ctx` · 가성비 35.7
...
| 에이전트 | 73.9 | +1.6 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 37.0%×1.0 |
