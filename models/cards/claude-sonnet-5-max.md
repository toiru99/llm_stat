...
radar:
  ...
  reasoning: { s: 74.9, z: 2.04, r: 80.5, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.8, r: 77.0, estimated: false }  # 코딩
  agentic: { s: 82.9, z: 1.8, r: 77.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.1, z: 1.04, r: 65.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 75.0 t/s · TTFT 192.97s · 1M ctx`
...
| 추론 | 80.5 | +2.04 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 77.0 | +1.8 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 77.0 | +1.8 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
