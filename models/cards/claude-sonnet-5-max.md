...
radar:
  ...
  reasoning: { s: 74.2, z: 1.89, r: 78.3, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.7, r: 75.6, estimated: false }  # 코딩
  agentic: { s: 77.3, z: 1.59, r: 73.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 76.0 t/s · TTFT 184.48s · 1M ctx` · 가성비 35.7
...
| 추론 | 78.3 | +1.89 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 75.6 | +1.7 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 73.8 | +1.59 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 37.0%×1.0 |
