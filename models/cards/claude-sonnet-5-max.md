...
radar:
  ...
  reasoning: { s: 74.9, z: 2.03, r: 80.5, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.79, r: 76.9, estimated: false }  # 코딩
  agentic: { s: 81.6, z: 1.76, r: 76.4, estimated: false }  # 에이전트
  trust: { s: 71.3, z: 2.04, r: 80.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 75.0 t/s · TTFT 155.55s · 1M ctx`
...
| 추론 | 80.5 | +2.03 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 76.4 | +1.76 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
| 신뢰성 | 80.6 | +2.04 | 실측 | [[aa-omniscience]] 63.0%×1.0 |
