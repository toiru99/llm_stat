...
radar:
  ...
  agentic: { s: 87.7, z: 1.44, r: 71.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 78.0 t/s · TTFT 156.15s · 1M ctx` · 가성비 22.9
...
| 에이전트 | 71.5 | +1.44 | 실측 | [[gdpval]] 55.0%×1.0, [[tau3-banking]] 28.0%×1.0 |
