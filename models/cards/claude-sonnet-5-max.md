...
is_reasoning: true
radar:
  knowledge: { s: 72.2, z: 1.45, r: 71.8, estimated: false }  # 전문 지식
  ...
  trust: { s: 71.3, z: 2.05, r: 80.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 74.0 t/s · TTFT 168.57s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.8 | +1.45 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
