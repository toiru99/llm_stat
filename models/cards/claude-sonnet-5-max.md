...
radar:
  ...
  reasoning: { s: 74.2, z: 2.01, r: 80.1, estimated: false }  # 추론
  ...
  instruction: { s: 82.0, z: 1.25, r: 68.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 92.0 t/s · TTFT 240.75s · 1M ctx` · 가성비 35.7
...
| 추론 | 80.1 | +2.01 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
