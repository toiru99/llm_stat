...
is_reasoning: true
radar:
  knowledge: { s: 72.2, z: 1.52, r: 72.9, estimated: false }  # 전문 지식
  reasoning: { s: 74.9, z: 2.16, r: 82.3, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 84.0 t/s · TTFT 157.99s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.9 | +1.52 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 82.3 | +2.16 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
