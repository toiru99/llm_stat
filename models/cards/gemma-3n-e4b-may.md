...
radar:
  ...
  trust: { s: 19.2, z: -0.33, r: 45.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 12.7, z: -1.11, r: 33.4, estimated: true }  # 긴문맥
  instruction: { s: 23.4, z: -1.24, r: 31.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
