...
radar:
  ...
  long_context: { s: 41.0, z: -0.26, r: 46.2, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 38.0 t/s · TTFT 0.66s · 262k ctx` · 가성비 381.0
...
| 긴문맥 | 46.2 | -0.26 | 실측 | [[aa-lcr]] 34.0%×1.0 |
