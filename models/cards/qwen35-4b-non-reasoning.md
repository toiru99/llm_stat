...
radar:
  ...
  coding: { s: 24.9, z: -0.93, r: 36.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 21.0 t/s · TTFT 0.96s · 262k ctx` · 가성비 381.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.2 | -0.59 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 44.9 | -0.34 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 36.1 | -0.93 | 실측 | [[scicode]] 18.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
