...
is_reasoning: true
radar:
  knowledge: { s: 31.4, z: -0.46, r: 43.1, estimated: false }  # 전문 지식
  reasoning: { s: 29.3, z: -0.26, r: 46.1, estimated: false }  # 추론
  coding: { s: 37.0, z: -0.44, r: 43.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 43.1 | -0.46 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 46.1 | -0.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 43.3 | -0.44 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
