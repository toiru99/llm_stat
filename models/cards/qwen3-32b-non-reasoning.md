...
radar:
  ...
  agentic: { s: 16.3, z: -0.82, r: 37.7, estimated: true }  # 에이전트
  trust: { s: 28.5, z: 0.18, r: 52.7, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 106.0 t/s · TTFT 2.47s · 32k ctx` · 가성비 38.5
