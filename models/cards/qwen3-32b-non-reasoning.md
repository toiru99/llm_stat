...
radar:
  ...
  coding: { s: 45.2, z: -0.07, r: 49.0, estimated: false }  # 코딩
  agentic: { s: 16.3, z: -0.81, r: 37.8, estimated: true }  # 에이전트
  trust: { s: 28.5, z: 0.2, r: 53.0, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 106.0 t/s · TTFT 2.45s · 32k ctx` · 가성비 38.5
...
| 코딩 | 49.0 | -0.07 | 실측 | [[scicode]] 28.0%×1.0 |
