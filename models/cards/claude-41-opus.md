...
radar:
  ...
  coding: { s: 62.7, z: 0.66, r: 59.9, estimated: false }  # 코딩
  agentic: { s: 61.6, z: 0.98, r: 64.7, estimated: false }  # 에이전트
  trust: { s: 39.3, z: 0.53, r: 57.9, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 61.4 | +0.76 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 50.7 | +0.04 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 59.9 | +0.66 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
