...
radar:
  ...
  agentic: { s: 61.6, z: 0.94, r: 64.2, estimated: false }  # 에이전트
  trust: { s: 45.3, z: 0.74, r: 61.1, estimated: true }  # 신뢰성
...
| 에이전트 | 64.2 | +0.94 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
| 신뢰성 | 61.1 | +0.74 | 추정 | (추정) |
