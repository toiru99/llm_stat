...
radar:
  ...
  agentic: { s: 61.6, z: 1.02, r: 65.3, estimated: false }  # 에이전트
  trust: { s: 45.3, z: 0.88, r: 63.2, estimated: true }  # 신뢰성
...
| 에이전트 | 65.3 | +1.02 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
| 신뢰성 | 63.2 | +0.88 | 추정 | (추정) |
