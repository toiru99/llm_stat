...
is_reasoning: false
radar:
  knowledge: { s: 56.5, z: 0.71, r: 60.7, estimated: false }  # 전문 지식
  reasoning: { s: 34.6, z: -0.06, r: 49.1, estimated: false }  # 추론
  coding: { s: 62.7, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 61.6, z: 0.93, r: 64.0, estimated: false }  # 에이전트
  trust: { s: 45.3, z: 0.69, r: 60.4, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 60.7 | +0.71 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
...
| 에이전트 | 64.0 | +0.93 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
| 신뢰성 | 60.4 | +0.69 | 추정 | (추정) |
