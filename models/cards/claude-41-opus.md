...
radar:
  ...
  coding: { s: 62.7, z: 0.64, r: 59.5, estimated: false }  # 코딩
  agentic: { s: 61.6, z: 0.97, r: 64.6, estimated: false }  # 에이전트
  trust: { s: 40.2, z: 0.76, r: 61.4, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 61.8 | +0.78 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 50.1 | +0.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 59.5 | +0.64 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
