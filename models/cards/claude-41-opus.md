...
is_reasoning: false
radar:
  knowledge: { s: 57.4, z: 0.81, r: 62.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $15.0 · 출력 $75.0 · 혼합 $11.55/1M · 30.0 t/s · TTFT 11.53s · 200k ctx` · 가성비 2.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.2 | +0.81 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
