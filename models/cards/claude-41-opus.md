...
is_reasoning: false
radar:
  knowledge: { s: 57.4, z: 0.8, r: 62.1, estimated: false }  # 전문 지식
  ...
  trust: { s: 34.3, z: 0.33, r: 54.9, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 62.1 | +0.8 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
