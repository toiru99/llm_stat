...
radar:
  ...
  agentic: { s: 61.6, z: 0.99, r: 64.8, estimated: false }  # 에이전트
  trust: { s: 45.3, z: 0.81, r: 62.1, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 60.9 | +0.73 | 실측 | [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
...
| 에이전트 | 64.8 | +0.99 | 실측 | [[tau2-bench]] 71.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
| 신뢰성 | 62.1 | +0.81 | 추정 | (추정) |
