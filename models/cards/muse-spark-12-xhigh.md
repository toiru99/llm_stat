...
is_reasoning: true
radar:
  knowledge: { s: 77.2, z: 1.75, r: 76.3, estimated: false }  # 전문 지식
  reasoning: { s: 77.7, z: 2.12, r: 81.8, estimated: false }  # 추론
  coding: { s: 93.3, z: 1.91, r: 78.6, estimated: false }  # 코딩
  agentic: { s: 76.1, z: 1.6, r: 74.0, estimated: false }  # 에이전트
  trust: { s: 75.6, z: 2.27, r: 84.0, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 76.3 | +1.75 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 81.8 | +2.12 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
| 코딩 | 78.6 | +1.91 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 74.0 | +1.6 | 실측 | [[gdpval]] 56.0%×1.0, [[tau3-banking]] 35.0%×1.0 |
| 신뢰성 | 84.0 | +2.27 | 실측 | [[aa-omniscience]] 67.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
