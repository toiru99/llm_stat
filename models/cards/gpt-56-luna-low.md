...
radar:
  ...
  instruction: { s: 66.7, z: 0.51, r: 57.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 167.0 t/s · TTFT 1.44s · 1M ctx` · 가성비 195.4
...
| 에이전트 | 50.5 | +0.03 | 실측 | [[gdpval]] 33.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
