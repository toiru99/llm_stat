...
radar:
  ...
  instruction: { s: 66.7, z: 0.5, r: 57.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 137.0 t/s · TTFT 1.84s · 1M ctx` · 가성비 195.4
...
| 추론 | 56.0 | +0.4 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 67.2 | +1.15 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 50.1 | +0.01 | 실측 | [[gdpval]] 33.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
| 신뢰성 | 37.9 | -0.8 | 실측 | [[aa-omniscience]] 10.0%×1.0 |
| 멀티모달 | 58.5 | +0.57 | 실측 | [[mmmu-pro]] 74.0%×1.0 |
| 긴문맥 | 62.4 | +0.83 | 실측 | [[aa-lcr]] 65.0%×1.0 |
| 지시 따르기 | 57.6 | +0.5 | 추정 | (추정) |
