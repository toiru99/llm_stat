...
is_reasoning: true
radar:
  knowledge: { s: 64.1, z: 1.15, r: 67.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 191.0 t/s · TTFT 1.42s · 1M ctx` · 가성비 37.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.2 | +1.15 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
