...
is_reasoning: true
radar:
  knowledge: { s: 62.9, z: 1.1, r: 66.6, estimated: false }  # 전문 지식
  ...
  instruction: { s: 64.7, z: 0.52, r: 57.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 66.6 | +1.1 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 57.1 | +0.48 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
