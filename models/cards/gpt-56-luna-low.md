...
is_reasoning: true
radar:
  knowledge: { s: 61.4, z: 1.05, r: 65.7, estimated: false }  # 전문 지식
  ...
  instruction: { s: 67.2, z: 0.61, r: 59.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 112.0 t/s · TTFT 1.64s · 1M ctx` · 가성비 195.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.7 | +1.05 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 56.5 | +0.43 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 67.5 | +1.16 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 49.9 | -0.01 | 실측 | [[gdpval]] 33.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
