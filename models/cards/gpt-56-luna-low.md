...
radar:
  ...
  coding: { s: 47.8, z: 0.55, r: 58.3, estimated: true }  # 코딩
  agentic: { s: 35.5, z: -0.08, r: 48.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 67.5, z: 0.62, r: 59.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 110.0 t/s · TTFT 1.74s · 1M ctx` · 가성비 149.4
...
| 코딩 | 58.3 | +0.55 | 추정 | (추정) |
| 에이전트 | 48.9 | -0.08 | 실측 | [[gdpval]] 29.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
