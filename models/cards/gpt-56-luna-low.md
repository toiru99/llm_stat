...
is_reasoning: true
radar:
  knowledge: { s: 64.1, z: 1.13, r: 67.0, estimated: false }  # 전문 지식
  ...
  instruction: { s: 71.4, z: 0.78, r: 61.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $None/1M · 198.0 t/s · TTFT 1.28s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.0 | +1.13 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 58.1 | +0.54 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 69.2 | +1.28 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 54.7 | +0.31 | 실측 | [[gdpval]] 33.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
