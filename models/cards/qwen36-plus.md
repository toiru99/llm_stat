...
radar:
  ...
  reasoning: { s: 50.1, z: 0.79, r: 61.8, estimated: false }  # 추론
  coding: { s: 67.8, z: 0.87, r: 63.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $None/1M · 54.0 t/s · TTFT 2.47s · 1M ctx`
...
| 추론 | 61.8 | +0.79 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 63.0 | +0.87 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 44.0%×0.5 |
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
