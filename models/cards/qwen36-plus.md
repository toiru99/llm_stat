...
radar:
  ...
  trust: { s: 64.9, z: 1.92, r: 78.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 55.0 t/s · TTFT 2.07s · 1M ctx` · 가성비 73.6
...
| 에이전트 | 64.7 | +0.98 | 실측 | [[gdpval]] 29.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
| 신뢰성 | 78.7 | +1.92 | 실측 | [[aa-omniscience]] 65.0%×1.0 |
