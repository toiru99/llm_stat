...
is_reasoning: true
radar:
  knowledge: { s: 54.8, z: 0.7, r: 60.5, estimated: false }  # 전문 지식
  reasoning: { s: 50.1, z: 0.88, r: 63.2, estimated: false }  # 추론
  coding: { s: 67.8, z: 0.92, r: 63.8, estimated: false }  # 코딩
  agentic: { s: 66.2, z: 1.18, r: 67.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.43/1M · 53.0 t/s · TTFT 2.58s · 1M ctx` · 가성비 93.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.5 | +0.7 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
...
| 에이전트 | 67.6 | +1.18 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
