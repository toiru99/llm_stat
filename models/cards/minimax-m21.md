...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 92.0 t/s · TTFT 1.74s · 205k ctx` · 가성비 82.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.5 | +0.23 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
...
| 에이전트 | 66.0 | +1.07 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
