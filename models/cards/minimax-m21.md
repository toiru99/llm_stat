...
radar:
  ...
  reasoning: { s: 40.9, z: 0.28, r: 54.3, estimated: false }  # 추론
...
MiniMax · Open · Large(230B) · 컨텍스트 205k · 종합지능 **25.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 96.0 t/s · TTFT 1.73s · 205k ctx` · 가성비 64.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.0 | +0.2 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 54.3 | +0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 56.2 | +0.41 | 실측 | [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 65.8 | +1.05 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
