...
is_reasoning: true
radar:
  knowledge: { s: 45.3, z: 0.25, r: 53.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 92.0 t/s · TTFT 1.71s · 205k ctx` · 가성비 82.1
...
| 추론 | 55.1 | +0.34 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 57.6 | +0.51 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 66.2 | +1.08 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
