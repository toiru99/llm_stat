...
radar:
  ...
  agentic: { s: 64.9, z: 1.15, r: 67.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 90.0 t/s · TTFT 1.6s · 205k ctx` · 가성비 82.1
...
| 에이전트 | 67.3 | +1.15 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
