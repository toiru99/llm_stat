...
radar:
  ...
  agentic: { s: 64.9, z: 1.06, r: 66.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 93.0 t/s · TTFT 1.64s · 205k ctx` · 가성비 82.1
...
| 추론 | 54.7 | +0.31 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 57.0 | +0.47 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 66.0 | +1.06 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
