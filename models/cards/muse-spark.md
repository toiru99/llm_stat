...
radar:
  ...
  coding: { s: 80.5, z: 1.29, r: 69.4, estimated: false }  # 코딩
  agentic: { s: 69.6, z: 1.24, r: 68.6, estimated: false }  # 에이전트
...
| 코딩 | 69.4 | +1.29 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
