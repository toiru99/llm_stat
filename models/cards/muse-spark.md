...
radar:
  ...
  coding: { s: 80.5, z: 1.38, r: 70.6, estimated: false }  # 코딩
  agentic: { s: 69.6, z: 1.34, r: 70.1, estimated: false }  # 에이전트
...
| 추론 | 74.0 | +1.6 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 70.6 | +1.38 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 70.1 | +1.34 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
