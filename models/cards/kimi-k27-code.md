...
radar:
  ...
  agentic: { s: 62.3, z: 1.01, r: 65.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.723/1M · 36.0 t/s · TTFT 2.92s · 256k ctx` · 가성비 59.5
...
| 에이전트 | 65.1 | +1.01 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
