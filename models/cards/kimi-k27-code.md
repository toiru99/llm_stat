...
radar:
  ...
  coding: { s: 76.0, z: 0.72, r: 60.7, estimated: false }  # 코딩
  agentic: { s: 66.1, z: 0.56, r: 58.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.7/1M · 52.0 t/s · TTFT 2.31s · 256k ctx` · 가성비 60.0
...
| 코딩 | 60.7 | +0.72 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 58.5 | +0.56 | 실측 | [[gdpval]] 35.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
