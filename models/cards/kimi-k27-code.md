...
radar:
  ...
  reasoning: { s: 62.8, z: 1.33, r: 70.0, estimated: false }  # 추론
  coding: { s: 74.9, z: 1.09, r: 66.3, estimated: false }  # 코딩
  agentic: { s: 62.3, z: 1.0, r: 64.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.723/1M · 37.0 t/s · TTFT 2.95s · 256k ctx` · 가성비 59.5
...
| 추론 | 70.0 | +1.33 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 66.3 | +1.09 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 64.9 | +1.0 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
