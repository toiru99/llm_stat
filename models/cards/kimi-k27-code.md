...
is_reasoning: true
radar:
  knowledge: { s: 70.5, z: 1.45, r: 71.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.7/1M · 46.0 t/s · TTFT 2.96s · 256k ctx` · 가성비 60.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.8 | +1.45 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
