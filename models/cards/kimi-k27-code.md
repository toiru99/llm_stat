...
radar:
  ...
  coding: { s: 74.9, z: 1.16, r: 67.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $None/1M · 45.0 t/s · TTFT 2.85s · 256k ctx`
...
| 코딩 | 67.5 | +1.16 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 67.0 | +1.13 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
