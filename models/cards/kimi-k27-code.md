...
radar:
  ...
  reasoning: { s: 62.7, z: 1.42, r: 71.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $None/1M · 50.0 t/s · TTFT 2.89s · 256k ctx`
...
| 추론 | 71.4 | +1.42 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 67.6 | +1.17 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 67.2 | +1.14 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
