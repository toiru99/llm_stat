...
is_reasoning: true
radar:
  knowledge: { s: 70.5, z: 1.47, r: 72.0, estimated: false }  # 전문 지식
  reasoning: { s: 62.7, z: 1.56, r: 73.3, estimated: false }  # 추론
  coding: { s: 74.9, z: 1.24, r: 68.6, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 72.0 | +1.47 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 73.3 | +1.56 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 68.6 | +1.24 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
