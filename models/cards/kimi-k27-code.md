...
radar:
  ...
  coding: { s: 76.0, z: 0.69, r: 60.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.7/1M · 51.0 t/s · TTFT 2.92s · 256k ctx` · 가성비 60.0
...
| 코딩 | 60.4 | +0.69 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
