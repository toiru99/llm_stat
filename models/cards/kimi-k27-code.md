...
radar:
  ...
  reasoning: { s: 62.8, z: 1.34, r: 70.1, estimated: false }  # 추론
  coding: { s: 74.9, z: 1.1, r: 66.4, estimated: false }  # 코딩
  agentic: { s: 62.3, z: 1.01, r: 65.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.95 · 출력 $4.0 · 혼합 $0.723/1M · 37.0 t/s · TTFT 2.88s · 256k ctx` · 가성비 59.5
...
| 추론 | 70.1 | +1.34 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 66.4 | +1.1 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 65.2 | +1.01 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 90.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
