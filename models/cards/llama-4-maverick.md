...
radar:
  ...
  reasoning: { s: 24.7, z: -0.49, r: 42.6, estimated: false }  # 추론
  coding: { s: 39.0, z: -0.33, r: 45.1, estimated: false }  # 코딩
  agentic: { s: 9.2, z: -1.09, r: 33.6, estimated: false }  # 에이전트
  trust: { s: 9.3, z: -0.72, r: 39.2, estimated: false }  # 신뢰성
  multimodal: { s: 67.1, z: -0.19, r: 47.1, estimated: false }  # 멀티모달
  long_context: { s: 60.2, z: 0.32, r: 54.8, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.26 · 출력 $0.91 · 혼합 $0.3145/1M · 86.0 t/s · TTFT 0.85s · 1M ctx` · 가성비 44.5
...
| 추론 | 42.6 | -0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 45.1 | -0.33 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 33.6 | -1.09 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 18.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
| 신뢰성 | 39.2 | -0.72 | 실측 | [[aa-omniscience]] 11.0%×1.0 |
| 멀티모달 | 47.1 | -0.19 | 실측 | [[mmmu-pro]] 62.0%×1.0 |
| 긴문맥 | 54.8 | +0.32 | 실측 | [[aa-lcr]] 50.0%×1.0 |
