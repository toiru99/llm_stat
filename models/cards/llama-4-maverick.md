...
radar:
  ...
  reasoning: { s: 25.1, z: -0.49, r: 42.7, estimated: false }  # 추론
  coding: { s: 40.2, z: -0.3, r: 45.5, estimated: false }  # 코딩
  agentic: { s: 9.2, z: -1.07, r: 34.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.27 · 출력 $0.85 · 혼합 $0.314/1M · 133.0 t/s · TTFT 1.01s · 1M ctx` · 가성비 44.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.9 | -0.07 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 34.0 | -1.07 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 18.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
