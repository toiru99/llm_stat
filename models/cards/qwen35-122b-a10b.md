...
radar:
  knowledge: { s: 52.3, z: 0.04, r: 50.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.4 · 출력 $3.2 · 혼합 $0.68/1M · 142.0 t/s · TTFT 2.44s · 262k ctx` · 가성비 47.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.6 | +0.04 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
