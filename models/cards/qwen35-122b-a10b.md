...
Alibaba · Open · Medium(125B) · 컨텍스트 262k · 종합지능 **25.0**
...
## 실용 지표
`입력 $0.4 · 출력 $3.2 · 혼합 $0.68/1M · 133.0 t/s · TTFT 2.37s · 262k ctx` · 가성비 36.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.0 | +0.4 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 56.7 | +0.44 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 57.9 | +0.52 | 실측 | [[terminal-bench]] 31.0%×0.5 |
| 에이전트 | 57.8 | +0.52 | 실측 | [[gdpval]] 21.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
