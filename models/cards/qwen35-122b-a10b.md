...
is_reasoning: true
radar:
  knowledge: { s: 52.3, z: 0.51, r: 57.7, estimated: false }  # 전문 지식
  reasoning: { s: 45.3, z: 0.53, r: 57.9, estimated: false }  # 추론
  coding: { s: 62.3, z: 0.62, r: 59.3, estimated: false }  # 코딩
  agentic: { s: 52.6, z: 0.67, r: 60.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $3.2 · 혼합 $0.68/1M · 116.0 t/s · TTFT 2.6s · 262k ctx` · 가성비 47.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.7 | +0.51 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
...
| 에이전트 | 60.1 | +0.67 | 실측 | [[gdpval]] 24.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
