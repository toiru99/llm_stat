...
radar:
  ...
  coding: { s: 36.2, z: -0.45, r: 43.2, estimated: false }  # 코딩
  agentic: { s: 21.7, z: -0.61, r: 40.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 46.4 | -0.24 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
...
| 에이전트 | 40.9 | -0.61 | 실측 | [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 10.0%×1.0 |
