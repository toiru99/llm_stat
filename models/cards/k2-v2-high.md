...
is_reasoning: true
radar:
  knowledge: { s: 36.0, z: -0.24, r: 46.3, estimated: false }  # 전문 지식
  reasoning: { s: 28.8, z: -0.28, r: 45.8, estimated: false }  # 추론
  coding: { s: 37.3, z: -0.4, r: 44.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 46.3 | -0.24 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 45.8 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 44.0 | -0.4 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 10.0%×0.5 |
