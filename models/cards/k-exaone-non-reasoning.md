...
radar:
  ...
  coding: { s: 32.6, z: -0.6, r: 41.0, estimated: false }  # 코딩
  agentic: { s: 35.1, z: -0.08, r: 48.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 42.4 | -0.51 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 43.7 | -0.42 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 41.0 | -0.6 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 48.8 | -0.08 | 실측 | [[tau2-bench]] 59.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
