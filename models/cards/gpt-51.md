...
is_reasoning: false
radar:
  knowledge: { s: 43.9, z: 0.13, r: 52.0, estimated: false }  # 전문 지식
  reasoning: { s: 24.0, z: -0.52, r: 42.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 88.0 t/s · TTFT 0.98s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.0 | +0.13 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 42.2 | -0.52 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
