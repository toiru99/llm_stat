...
radar:
  ...
  coding: { s: 52.4, z: 0.2, r: 53.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 74.0 t/s · TTFT 1.2s · 400k ctx` · 가성비 12.7
...
| 코딩 | 53.0 | +0.2 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
