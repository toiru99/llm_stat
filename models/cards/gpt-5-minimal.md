...
is_reasoning: false
radar:
  knowledge: { s: 44.1, z: 0.13, r: 52.0, estimated: false }  # 전문 지식
  reasoning: { s: 25.4, z: -0.49, r: 42.7, estimated: false }  # 추론
  coding: { s: 52.4, z: 0.17, r: 52.5, estimated: false }  # 코딩
  agentic: { s: 47.5, z: 0.42, r: 56.3, estimated: false }  # 에이전트
  trust: { s: 9.3, z: -0.79, r: 38.2, estimated: false }  # 신뢰성
  multimodal: { s: 67.1, z: -0.25, r: 46.2, estimated: false }  # 멀티모달
  long_context: { s: 32.5, z: -0.54, r: 41.8, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 78.0 t/s · TTFT 1.35s · 400k ctx` · 가성비 12.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.0 | +0.13 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 42.7 | -0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 52.5 | +0.17 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 56.3 | +0.42 | 실측 | [[tau2-bench]] 67.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
| 신뢰성 | 38.2 | -0.79 | 실측 | [[aa-omniscience]] 10.0%×1.0 |
| 멀티모달 | 46.2 | -0.25 | 실측 | [[mmmu-pro]] 62.0%×1.0 |
| 긴문맥 | 41.8 | -0.54 | 실측 | [[aa-lcr]] 27.0%×1.0 |
