...
radar:
  ...
  coding: { s: 52.4, z: 0.21, r: 53.2, estimated: false }  # 코딩
  agentic: { s: 47.5, z: 0.47, r: 57.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 64.0 t/s · TTFT 1.28s · 400k ctx` · 가성비 12.7
...
| 코딩 | 53.2 | +0.21 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 57.0 | +0.47 | 실측 | [[tau2-bench]] 67.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
