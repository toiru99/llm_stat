...
is_reasoning: true
radar:
  knowledge: { s: 50.9, z: 0.46, r: 56.8, estimated: false }  # 전문 지식
  reasoning: { s: 35.1, z: 0.04, r: 50.5, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 56.8 | +0.46 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
| 추론 | 50.5 | +0.04 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
