...
is_reasoning: true
radar:
  knowledge: { s: 48.2, z: 0.33, r: 55.0, estimated: false }  # 전문 지식
  reasoning: { s: 35.1, z: -0.01, r: 49.8, estimated: false }  # 추론
  coding: { s: 54.1, z: 0.24, r: 53.6, estimated: false }  # 코딩
  agentic: { s: 36.1, z: -0.02, r: 49.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 55.0 | +0.33 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
...
| 에이전트 | 49.7 | -0.02 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
