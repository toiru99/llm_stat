...
radar:
  ...
  reasoning: { s: 35.1, z: -0.04, r: 49.4, estimated: false }  # 추론
  coding: { s: 54.1, z: 0.22, r: 53.2, estimated: false }  # 코딩
  agentic: { s: 36.1, z: -0.05, r: 49.3, estimated: false }  # 에이전트
...
| 에이전트 | 49.3 | -0.05 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
