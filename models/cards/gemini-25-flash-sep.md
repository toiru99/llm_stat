...
is_reasoning: true
radar:
  knowledge: { s: 48.2, z: 0.32, r: 54.8, estimated: false }  # 전문 지식
  reasoning: { s: 35.1, z: -0.03, r: 49.6, estimated: false }  # 추론
  coding: { s: 54.1, z: 0.23, r: 53.4, estimated: false }  # 코딩
  agentic: { s: 36.1, z: -0.04, r: 49.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 54.8 | +0.32 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 49.6 | -0.03 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 53.4 | +0.23 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 49.4 | -0.04 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
