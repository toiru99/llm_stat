...
is_reasoning: true
radar:
  knowledge: { s: 48.2, z: 0.33, r: 54.9, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 54.9 | +0.33 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 49.7 | -0.02 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
