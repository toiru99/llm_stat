...
radar:
  ...
  agentic: { s: 37.5, z: 0.07, r: 51.1, estimated: false }  # 에이전트
  trust: { s: 97.7, z: 3.16, r: 97.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 205.0 t/s · TTFT 0.42s · 192k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.7 | -0.55 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
...
| 에이전트 | 51.1 | +0.07 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
| 신뢰성 | 97.4 | +3.16 | 실측 | [[aa-omniscience]] 86.0%×1.0 |
