...
radar:
  ...
  agentic: { s: 37.0, z: -0.01, r: 49.8, estimated: false }  # 에이전트
  trust: { s: 97.7, z: 2.89, r: 93.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 253.0 t/s · TTFT 0.38s · 192k ctx`
...
| 에이전트 | 49.8 | -0.01 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
| 신뢰성 | 93.3 | +2.89 | 실측 | [[aa-omniscience]] 86.0%×1.0 |
