...
radar:
  ...
  coding: { s: 46.6, z: 0.51, r: 57.7, estimated: false }  # 코딩
  agentic: { s: 36.0, z: -0.06, r: 49.1, estimated: false }  # 에이전트
  trust: { s: 86.6, z: 2.94, r: 94.1, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 256.0 t/s · TTFT 0.39s · 192k ctx`
