...
radar:
  knowledge: { s: 64.0, z: 0.56, r: 58.5, estimated: false }  # 전문 지식
  reasoning: { s: 70.2, z: 1.21, r: 68.2, estimated: false }  # 추론
  coding: { s: 81.4, z: 0.95, r: 64.2, estimated: false }  # 코딩
  agentic: { s: 69.3, z: 0.69, r: 60.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $7.5 · 혼합 $1.43/1M · 201.0 t/s · TTFT 2.54s · 1M ctx` · 가성비 32.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 58.5 | +0.56 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
...
| 에이전트 | 60.4 | +0.69 | 실측 | [[gdpval]] 39.0%×1.0, [[itbench]] 42.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
