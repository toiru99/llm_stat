...
radar:
  ...
  agentic: { s: 69.6, z: 0.73, r: 61.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $7.5 · 혼합 $1.43/1M · 205.0 t/s · TTFT 2.48s · 1M ctx` · 가성비 32.2
...
| 에이전트 | 61.0 | +0.73 | 실측 | [[gdpval]] 39.0%×1.0, [[itbench]] 42.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
