...
radar:
  ...
  agentic: { s: 69.3, z: 0.69, r: 60.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $7.5 · 혼합 $1.43/1M · 198.0 t/s · TTFT 2.54s · 1M ctx` · 가성비 32.2
...
| 에이전트 | 60.3 | +0.69 | 실측 | [[gdpval]] 39.0%×1.0, [[itbench]] 42.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
