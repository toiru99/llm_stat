...
is_reasoning: true
radar:
  knowledge: { s: 64.0, z: 1.15, r: 67.3, estimated: false }  # 전문 지식
  reasoning: { s: 69.8, z: 1.93, r: 79.0, estimated: false }  # 추론
  coding: { s: 80.2, z: 1.46, r: 71.9, estimated: false }  # 코딩
  agentic: { s: 68.6, z: 1.27, r: 69.0, estimated: false }  # 에이전트
  trust: { s: 89.4, z: 2.92, r: 93.8, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 67.3 | +1.15 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 79.0 | +1.93 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 71.9 | +1.46 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 51.0%×0.5 |
| 에이전트 | 69.0 | +1.27 | 실측 | [[gdpval]] 39.0%×1.0, [[itbench]] 42.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 51.0%×1.0 |
| 신뢰성 | 93.8 | +2.92 | 실측 | [[aa-omniscience]] 77.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
