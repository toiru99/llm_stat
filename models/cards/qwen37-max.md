...
radar:
  ...
  coding: { s: 80.2, z: 1.38, r: 70.8, estimated: false }  # 코딩
  agentic: { s: 67.5, z: 1.21, r: 68.2, estimated: false }  # 에이전트
  trust: { s: 87.4, z: 2.8, r: 92.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $2.5 · 출력 $7.5 · 혼합 $None/1M · 200.0 t/s · TTFT 2.43s · 1M ctx`
