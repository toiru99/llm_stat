...
is_reasoning: false
radar:
  knowledge: { s: 40.1, z: -0.03, r: 49.6, estimated: false }  # 전문 지식
  reasoning: { s: 26.1, z: -0.43, r: 43.6, estimated: false }  # 추론
  coding: { s: 37.2, z: -0.41, r: 43.8, estimated: false }  # 코딩
  agentic: { s: 16.7, z: -0.81, r: 37.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.331/1M · 204.0 t/s · TTFT 0.43s · 1M ctx` · 가성비 42.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.6 | -0.03 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 43.6 | -0.43 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 43.8 | -0.41 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 12.0%×0.5 |
| 에이전트 | 37.9 | -0.81 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
