...
radar:
  ...
  agentic: { s: 48.9, z: 0.51, r: 57.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.22 · 혼합 $0.0475/1M · 394.0 t/s · TTFT 2.04s · 262k ctx` · 가성비 800.0
...
| 에이전트 | 57.7 | +0.51 | 실측 | [[gdpval]] 30.0%×1.0, [[tau3-banking]] 27.0%×1.0 |
