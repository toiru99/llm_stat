...
radar:
  ...
  reasoning: { s: 44.7, z: 0.49, r: 57.4, estimated: false }  # 추론
  coding: { s: 66.1, z: 0.8, r: 62.0, estimated: false }  # 코딩
  agentic: { s: 48.0, z: 0.41, r: 56.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.22 · 혼합 $0.0475/1M · 345.0 t/s · TTFT 2.63s · 262k ctx` · 가성비 800.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.2 | +0.14 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 57.4 | +0.49 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 62.0 | +0.8 | 실측 | [[scicode]] 41.0%×1.0 |
| 에이전트 | 56.2 | +0.41 | 실측 | [[gdpval]] 30.0%×1.0, [[tau3-banking]] 27.0%×1.0 |
