...
is_reasoning: true
radar:
  knowledge: { s: 87.6, z: 2.31, r: 84.7, estimated: false }  # 전문 지식
  reasoning: { s: 85.5, z: 2.51, r: 87.6, estimated: false }  # 추론
  coding: { s: 92.6, z: 1.91, r: 78.7, estimated: false }  # 코딩
  agentic: { s: 82.8, z: 1.76, r: 76.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 70.0 t/s · TTFT 10.48s · 1M ctx` · 가성비 18.5
...
| 추론 | 87.6 | +2.51 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 78.7 | +1.91 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
| 에이전트 | 76.4 | +1.76 | 실측 | [[gdpval]] 56.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 37.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
