...
is_reasoning: true
radar:
  knowledge: { s: 92.7, z: 2.51, r: 87.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 58.0 t/s · TTFT 11.72s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.6 | +2.51 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 44.0%×0.3 |
...
| 에이전트 | 81.5 | +2.1 | 실측 | [[gdpval]] 56.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
