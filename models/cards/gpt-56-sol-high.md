...
radar:
  ...
  reasoning: { s: 87.6, z: 2.86, r: 93.0, estimated: false }  # 추론
  coding: { s: 94.6, z: 2.06, r: 80.9, estimated: false }  # 코딩
  agentic: { s: 90.5, z: 2.12, r: 81.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 63.0 t/s · TTFT 10.84s · 1M ctx` · 가성비 12.9
...
| 추론 | 93.0 | +2.86 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 44.0%×1.0 |
| 코딩 | 80.9 | +2.06 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
| 에이전트 | 81.7 | +2.12 | 실측 | [[gdpval]] 57.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
