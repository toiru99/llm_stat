...
radar:
  ...
  reasoning: { s: 87.4, z: 2.67, r: 90.1, estimated: false }  # 추론
  coding: { s: 94.6, z: 1.97, r: 79.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 74.0 t/s · TTFT 25.82s · 1M ctx` · 가성비 18.5
...
| 추론 | 90.1 | +2.67 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 79.5 | +1.97 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
