...
radar:
  ...
  reasoning: { s: 87.4, z: 2.54, r: 88.1, estimated: false }  # 추론
  coding: { s: 94.6, z: 1.89, r: 78.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 63.0 t/s · TTFT 16.09s · 1M ctx` · 가성비 13.1
...
| 추론 | 88.1 | +2.54 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 78.4 | +1.89 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
| 에이전트 | 77.4 | +1.83 | 실측 | [[gdpval]] 56.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 37.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
