...
radar:
  ...
  reasoning: { s: 85.1, z: 2.41, r: 86.2, estimated: false }  # 추론
  coding: { s: 91.2, z: 2.06, r: 80.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 75.0 t/s · TTFT 18.83s · 1M ctx` · 가성비 15.6
...
| 추론 | 86.2 | +2.41 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 80.9 | +2.06 | 실측 | [[scicode]] 58.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
| 에이전트 | 75.9 | +1.72 | 실측 | [[gdpval]] 51.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 37.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
