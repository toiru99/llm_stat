...
radar:
  ...
  reasoning: { s: 87.4, z: 2.52, r: 87.8, estimated: false }  # 추론
  coding: { s: 94.6, z: 1.88, r: 78.2, estimated: false }  # 코딩
  agentic: { s: 83.5, z: 1.79, r: 76.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 66.0 t/s · TTFT 10.09s · 1M ctx` · 가성비 13.1
...
| 추론 | 87.8 | +2.52 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 78.2 | +1.88 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 62.0%×0.5 |
