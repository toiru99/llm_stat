...
is_reasoning: true
radar:
  knowledge: { s: 92.7, z: 2.54, r: 88.0, estimated: false }  # 전문 지식
  reasoning: { s: 87.6, z: 2.86, r: 92.9, estimated: false }  # 추론
  coding: { s: 94.6, z: 2.06, r: 80.8, estimated: false }  # 코딩
  agentic: { s: 90.5, z: 2.13, r: 81.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 56.0 t/s · TTFT 10.17s · 1M ctx` · 가성비 12.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 88.0 | +2.54 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 44.0%×0.3 |
...
| 에이전트 | 81.9 | +2.13 | 실측 | [[gdpval]] 57.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 62.0%×1.0 |
