...
radar:
  ...
  reasoning: { s: 89.9, z: 2.14, r: 82.2, estimated: false }  # 추론
  coding: { s: 94.5, z: 1.5, r: 72.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 79.0 t/s · TTFT 74.91s · 922k ctx` · 가성비 12.6
...
| 추론 | 82.2 | +2.14 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 44.0%×1.0 |
| 코딩 | 72.6 | +1.5 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
