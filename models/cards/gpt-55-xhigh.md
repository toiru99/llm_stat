...
is_reasoning: true
radar:
  knowledge: { s: 93.0, z: 2.44, r: 86.5, estimated: false }  # 전문 지식
  reasoning: { s: 89.0, z: 2.74, r: 91.1, estimated: false }  # 추론
  coding: { s: 93.0, z: 1.91, r: 78.7, estimated: false }  # 코딩
  agentic: { s: 85.7, z: 1.91, r: 78.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 67.0 t/s · TTFT 90.18s · 922k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 86.5 | +2.44 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 44.0%×0.3 |
| 추론 | 91.1 | +2.74 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 44.0%×1.0 |
| 코딩 | 78.7 | +1.91 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
| 에이전트 | 78.7 | +1.91 | 실측 | [[apex-agents]] 38.0%×1.0, [[gdpval]] 50.0%×1.0, [[itbench]] 46.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
