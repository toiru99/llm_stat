...
radar:
  ...
  reasoning: { s: 88.8, z: 2.57, r: 88.6, estimated: false }  # 추론
  coding: { s: 93.0, z: 1.81, r: 77.1, estimated: false }  # 코딩
  agentic: { s: 83.2, z: 1.77, r: 76.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 83.0 t/s · TTFT 62.74s · 922k ctx` · 가성비 12.9
...
| 추론 | 88.6 | +2.57 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 77.1 | +1.81 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
| 에이전트 | 76.5 | +1.77 | 실측 | [[apex-agents]] 38.0%×1.0, [[gdpval]] 49.0%×1.0, [[itbench]] 46.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 39.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
