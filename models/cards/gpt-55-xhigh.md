...
is_reasoning: true
radar:
  knowledge: { s: 93.0, z: 2.52, r: 87.7, estimated: false }  # 전문 지식
  reasoning: { s: 89.0, z: 2.89, r: 93.3, estimated: false }  # 추론
  coding: { s: 93.0, z: 1.96, r: 79.4, estimated: false }  # 코딩
  agentic: { s: 87.1, z: 1.96, r: 79.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 76.0 t/s · TTFT 94.83s · 922k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.7 | +2.52 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 44.0%×0.3 |
...
| 에이전트 | 79.4 | +1.96 | 실측 | [[apex-agents]] 38.0%×1.0, [[gdpval]] 49.0%×1.0, [[itbench]] 46.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
