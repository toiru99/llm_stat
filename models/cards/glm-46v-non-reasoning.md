...
radar:
  ...
  coding: { s: 30.5, z: -0.69, r: 39.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $0.9 · 혼합 $0.36/1M · 68.0 t/s · TTFT 3.01s · 128k ctx` · 가성비 30.6
...
| 코딩 | 39.6 | -0.69 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
