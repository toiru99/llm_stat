...
radar:
  ...
  coding: { s: 30.5, z: -0.68, r: 39.7, estimated: false }  # 코딩
  ...
  long_context: { s: 16.9, z: -1.01, r: 34.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.3 · 출력 $0.9 · 혼합 $0.36/1M · 68.0 t/s · TTFT 3.23s · 128k ctx` · 가성비 30.6
...
| 긴문맥 | 34.9 | -1.01 | 실측 | [[aa-lcr]] 14.0%×1.0 |
