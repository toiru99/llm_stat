...
radar:
  ...
  agentic: { s: 19.4, z: -0.66, r: 40.2, estimated: true }  # 에이전트
  trust: { s: 27.3, z: -0.03, r: 49.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 17.4, z: -0.92, r: 36.2, estimated: true }  # 긴문맥
  instruction: { s: 28.0, z: -1.0, r: 35.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
