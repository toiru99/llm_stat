...
is_reasoning: false
radar:
  knowledge: { s: 24.2, z: -0.8, r: 37.9, estimated: false }  # 전문 지식
  reasoning: { s: 21.9, z: -0.63, r: 40.5, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.29, r: 45.6, estimated: false }  # 코딩
  agentic: { s: 19.6, z: -0.65, r: 40.2, estimated: true }  # 에이전트
  trust: { s: 23.9, z: -0.21, r: 46.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.9, z: -0.91, r: 36.4, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 37.9 | -0.8 | 실측 | [[gpqa-diamond]] 42.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
