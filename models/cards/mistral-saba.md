...
radar:
  ...
  trust: { s: 19.0, z: -0.33, r: 45.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.8, z: -0.75, r: 38.8, estimated: true }  # 긴문맥
  instruction: { s: 31.6, z: -0.91, r: 36.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
