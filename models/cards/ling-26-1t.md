...
radar:
  ...
  coding: { s: 56.8, z: 0.34, r: 55.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 49.0 | -0.06 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 46.3 | -0.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 55.2 | +0.34 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
