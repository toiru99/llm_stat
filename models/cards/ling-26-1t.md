...
is_reasoning: false
radar:
  knowledge: { s: 39.7, z: -0.04, r: 49.4, estimated: false }  # 전문 지식
  reasoning: { s: 30.1, z: -0.23, r: 46.5, estimated: false }  # 추론
  coding: { s: 55.4, z: 0.35, r: 55.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 49.4 | -0.04 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
...
| 에이전트 | 68.3 | +1.22 | 실측 | [[tau2-bench]] 90.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
