...
radar:
  ...
  agentic: { s: 20.0, z: -0.68, r: 39.8, estimated: true }  # 에이전트
  trust: { s: 26.3, z: 0.08, r: 51.2, estimated: true }  # 신뢰성
...
| 추론 | 46.2 | -0.25 | 실측 | [[gpqa-diamond]] 56.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
