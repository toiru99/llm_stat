...
radar:
  ...
  agentic: { s: 49.4, z: 0.54, r: 58.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.56 · 혼합 $0.1067/1M · 63.0 t/s · TTFT 2.85s · 256k ctx` · 가성비 393.6
...
| 에이전트 | 58.0 | +0.54 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
