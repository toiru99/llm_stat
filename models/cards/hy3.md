...
radar:
  ...
  reasoning: { s: 56.3, z: 1.11, r: 66.6, estimated: false }  # 추론
  ...
  instruction: { s: 81.3, z: 1.22, r: 68.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.14 · 출력 $0.55 · 혼합 $0.1064/1M · 67.0 t/s · TTFT 2.82s · 256k ctx` · 가성비 394.7
...
| 추론 | 66.6 | +1.11 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
