...
is_reasoning: true
radar:
  knowledge: { s: 60.0, z: 0.98, r: 64.7, estimated: false }  # 전문 지식
  reasoning: { s: 55.0, z: 1.03, r: 65.4, estimated: false }  # 추론
  coding: { s: 77.4, z: 1.3, r: 69.5, estimated: false }  # 코딩
  agentic: { s: 49.0, z: 0.46, r: 56.9, estimated: false }  # 에이전트
  trust: { s: 24.7, z: 0.02, r: 50.3, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 90.4, z: 1.24, r: 68.6, estimated: false }  # 긴문맥
  instruction: { s: 83.4, z: 1.29, r: 69.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.14 · 출력 $0.55 · 혼합 $0.1064/1M · 97.0 t/s · TTFT 2.69s · 256k ctx` · 가성비 394.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 64.7 | +0.98 | 실측 | [[aa-omniscience]] 32.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
