...
radar:
  ...
  reasoning: { s: 56.8, z: 1.22, r: 68.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.0/1M · 59.0 t/s · TTFT 2.47s · 256k ctx`
...
| 추론 | 68.2 | +1.22 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
