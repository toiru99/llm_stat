...
radar:
  ...
  reasoning: { s: 56.3, z: 1.0, r: 64.9, estimated: false }  # 추론
  coding: { s: 80.0, z: 1.28, r: 69.1, estimated: false }  # 코딩
  agentic: { s: 49.4, z: 0.47, r: 57.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.55 · 혼합 $0.1064/1M · 68.0 t/s · TTFT 2.84s · 256k ctx` · 가성비 394.7
...
| 추론 | 64.9 | +1.0 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 69.1 | +1.28 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 57.0 | +0.47 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
