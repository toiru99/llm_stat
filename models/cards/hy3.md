...
radar:
  ...
  reasoning: { s: 56.8, z: 1.13, r: 66.9, estimated: false }  # 추론
  coding: { s: 80.0, z: 1.38, r: 70.6, estimated: false }  # 코딩
  agentic: { s: 57.4, z: 0.82, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.56 · 혼합 $None/1M · 68.0 t/s · TTFT 2.64s · 256k ctx`
...
| 추론 | 66.9 | +1.13 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 70.6 | +1.38 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 62.2 | +0.82 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 21.0%×1.0 |
