...
radar:
  ...
  instruction: { s: 79.4, z: 1.03, r: 65.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.14 · 출력 $0.56 · 혼합 $0.1067/1M · 64.0 t/s · TTFT 2.98s · 256k ctx` · 가성비 393.6
...
| 에이전트 | 57.5 | +0.5 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
