...
is_reasoning: true
radar:
  knowledge: { s: 63.3, z: 1.1, r: 66.4, estimated: false }  # 전문 지식
  reasoning: { s: 56.8, z: 1.21, r: 68.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 59.0 t/s · TTFT 2.45s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.4 | +1.1 | 실측 | [[aa-omniscience]] 32.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 68.2 | +1.21 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 71.3 | +1.42 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 64.0 | +0.93 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 21.0%×1.0 |
