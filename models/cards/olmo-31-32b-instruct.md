...
radar:
  ...
  coding: { s: 18.9, z: -1.16, r: 32.6, estimated: false }  # 코딩
  agentic: { s: 10.6, z: -0.99, r: 35.1, estimated: false }  # 에이전트
  trust: { s: 33.3, z: 0.27, r: 54.0, estimated: false }  # 신뢰성
...
| 코딩 | 32.6 | -1.16 | 실측 | [[scicode]] 17.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 35.1 | -0.99 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 54.0 | +0.27 | 실측 | [[aa-omniscience]] 30.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
