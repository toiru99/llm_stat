...
is_reasoning: true
radar:
  knowledge: { s: 34.3, z: -0.32, r: 45.3, estimated: false }  # 전문 지식
...
Korea Telecom · Proprietary · Small(32B) · 컨텍스트 128k · 종합지능 **10.0**
...
|---|---|---|---|---|
| 전문 지식 | 45.3 | -0.32 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 44.4 | -0.37 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 34.7 | -1.02 | 실측 | [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 54.6 | +0.31 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
