...
is_reasoning: true
radar:
  knowledge: { s: 34.9, z: -0.28, r: 45.9, estimated: false }  # 전문 지식
  reasoning: { s: 28.3, z: -0.28, r: 45.8, estimated: false }  # 추론
  coding: { s: 37.7, z: -0.36, r: 44.6, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 45.9 | -0.28 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 45.8 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 44.6 | -0.36 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 55.3 | +0.36 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
