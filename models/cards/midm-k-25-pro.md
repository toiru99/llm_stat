...
is_reasoning: true
radar:
  knowledge: { s: 34.9, z: -0.27, r: 45.9, estimated: false }  # 전문 지식
  ...
  long_context: { s: 11.8, z: -1.08, r: 33.7, estimated: false }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 45.9 | -0.27 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
...
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 33.7 | -1.08 | 실측 | [[aa-lcr]] 9.0%×1.0 |
