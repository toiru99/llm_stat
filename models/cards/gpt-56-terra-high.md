...
radar:
  ...
  reasoning: { s: 78.8, z: 2.12, r: 81.7, estimated: false }  # 추론
  coding: { s: 84.8, z: 1.49, r: 72.4, estimated: false }  # 코딩
  agentic: { s: 74.9, z: 1.49, r: 72.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 104.0 t/s · TTFT 2.8s · 1M ctx` · 가성비 28.7
...
| 추론 | 81.7 | +2.12 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 72.4 | +1.49 | 실측 | [[gdpval]] 51.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
