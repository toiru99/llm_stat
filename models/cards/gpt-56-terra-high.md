...
radar:
  ...
  coding: { s: 84.8, z: 1.62, r: 74.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 120.0 t/s · TTFT 2.42s · 1M ctx`
...
| 코딩 | 74.2 | +1.62 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
