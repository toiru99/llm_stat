...
is_reasoning: true
radar:
  knowledge: { s: 73.2, z: 1.61, r: 74.1, estimated: false }  # 전문 지식
  reasoning: { s: 77.2, z: 2.1, r: 81.4, estimated: false }  # 추론
  coding: { s: 83.1, z: 1.51, r: 72.7, estimated: false }  # 코딩
  agentic: { s: 74.0, z: 1.42, r: 71.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 84.0 t/s · TTFT 2.73s · 1M ctx` · 가성비 28.7
...
| 추론 | 81.4 | +2.1 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 72.7 | +1.51 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 71.3 | +1.42 | 실측 | [[gdpval]] 50.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
