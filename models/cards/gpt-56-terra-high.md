...
radar:
  ...
  reasoning: { s: 76.8, z: 2.01, r: 80.1, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.72, r: 75.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 84.0 t/s · TTFT 10.29s · 1M ctx` · 가성비 23.6
...
| 추론 | 80.1 | +2.01 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 75.8 | +1.72 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
