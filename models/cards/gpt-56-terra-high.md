...
radar:
  ...
  agentic: { s: 74.9, z: 1.5, r: 72.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 96.0 t/s · TTFT 4.06s · 1M ctx` · 가성비 28.7
...
| 에이전트 | 72.5 | +1.5 | 실측 | [[gdpval]] 51.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
