...
is_reasoning: true
radar:
  knowledge: { s: 36.5, z: -0.24, r: 46.5, estimated: false }  # 전문 지식
  reasoning: { s: 28.3, z: -0.36, r: 44.5, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 46.5 | -0.24 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 44.5 | -0.36 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 43.3 | -0.45 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 9.0%×0.5 |
| 에이전트 | 39.1 | -0.72 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 9.0%×1.0 |
