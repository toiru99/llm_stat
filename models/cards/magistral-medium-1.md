...
radar:
  ...
  coding: { s: 37.9, z: -0.35, r: 44.7, estimated: false }  # 코딩
  ...
  instruction: { s: 18.3, z: -1.41, r: 28.8, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 44.7 | -0.35 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 9.0%×0.5 |
...
| 지시 따르기 | 28.8 | -1.41 | 실측 | [[ifbench]] 25.0%×1.0 |
