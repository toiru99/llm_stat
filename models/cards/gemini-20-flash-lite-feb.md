...
radar:
  ...
  coding: { s: 41.7, z: -0.24, r: 46.4, estimated: false }  # 코딩
  agentic: { s: 30.4, z: -0.22, r: 46.7, estimated: true }  # 에이전트
  trust: { s: 43.4, z: 0.79, r: 61.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 25.8, z: -0.72, r: 39.2, estimated: true }  # 긴문맥
  instruction: { s: 40.6, z: -0.54, r: 41.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 43.3 | -0.45 | 실측 | [[gpqa-diamond]] 54.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 44.9 | -0.34 | 실측 | [[gpqa-diamond]] 54.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 46.4 | -0.24 | 실측 | [[scicode]] 25.0%×1.0 |
