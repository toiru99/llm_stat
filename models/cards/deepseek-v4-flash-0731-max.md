...
radar:
  ...
  reasoning: { s: 72.9, z: 1.81, r: 77.2, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.42, r: 71.3, estimated: false }  # 코딩
  agentic: { s: 77.8, z: 1.57, r: 73.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.44 · 출력 $1.32 · 혼합 $0.2298/1M · 125.0 t/s · TTFT 1.13s · 1M ctx` · 가성비 226.3
...
| 추론 | 77.2 | +1.81 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 71.3 | +1.42 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 73.6 | +1.57 | 실측 | [[gdpval]] 53.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
