...
radar:
  ...
  reasoning: { s: 72.9, z: 1.94, r: 79.1, estimated: false }  # 추론
  ...
  instruction: { s: 80.7, z: 1.19, r: 67.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.44 · 출력 $1.32 · 혼합 $0.2298/1M · 118.0 t/s · TTFT 1.17s · 1M ctx` · 가성비 226.3
...
| 추론 | 79.1 | +1.94 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
