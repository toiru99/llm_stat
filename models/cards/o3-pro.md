...
radar:
  ...
  reasoning: { s: 88.2, z: 2.54, r: 88.2, estimated: false }  # 추론
  coding: { s: 91.6, z: 1.75, r: 76.3, estimated: true }  # 코딩
  agentic: { s: 83.1, z: 1.76, r: 76.5, estimated: true }  # 에이전트
...
| 추론 | 88.2 | +2.54 | 실측 | [[gpqa-diamond]] 85.0%×1.0 |
| 코딩 | 76.3 | +1.75 | 추정 | (추정) |
| 에이전트 | 76.5 | +1.76 | 추정 | (추정) |
| 신뢰성 | 37.4 | -0.84 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 68.6 | +1.24 | 추정 | (추정) |
