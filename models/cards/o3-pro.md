...
is_reasoning: true
radar:
  knowledge: { s: 89.3, z: 2.37, r: 85.6, estimated: false }  # 전문 지식
  reasoning: { s: 89.3, z: 2.95, r: 94.3, estimated: false }  # 추론
  coding: { s: 93.5, z: 2.01, r: 80.2, estimated: true }  # 코딩
  agentic: { s: 88.8, z: 2.05, r: 80.7, estimated: true }  # 에이전트
  trust: { s: 13.9, z: -0.66, r: 40.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 93.4, z: 1.34, r: 70.0, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $20.0 · 출력 $80.0 · 혼합 $26.0/1M · 36.0 t/s · TTFT 64.99s · 200k ctx` · 가성비 1.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.6 | +2.37 | 실측 | [[gpqa-diamond]] 85.0%×0.4 |
