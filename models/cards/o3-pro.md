...
radar:
  ...
  reasoning: { s: 88.2, z: 2.72, r: 90.8, estimated: false }  # 추론
  coding: { s: 91.6, z: 1.85, r: 77.7, estimated: true }  # 코딩
  agentic: { s: 83.4, z: 1.82, r: 77.4, estimated: true }  # 에이전트
  trust: { s: 7.8, z: -0.77, r: 38.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 92.3, z: 1.32, r: 69.8, estimated: true }  # 긴문맥
  instruction: { s: 83.9, z: 1.33, r: 70.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
