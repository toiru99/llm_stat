...
radar:
  ...
  coding: { s: 25.4, z: -0.95, r: 35.8, estimated: false }  # 코딩
  agentic: { s: 4.8, z: -1.26, r: 31.2, estimated: false }  # 에이전트
...
| 코딩 | 35.8 | -0.95 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 31.2 | -1.26 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
