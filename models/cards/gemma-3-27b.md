...
is_reasoning: false
radar:
  knowledge: { s: 21.1, z: -0.96, r: 35.7, estimated: false }  # 전문 지식
  reasoning: { s: 14.8, z: -1.01, r: 34.9, estimated: false }  # 추론
  coding: { s: 25.4, z: -0.94, r: 35.9, estimated: false }  # 코딩
  agentic: { s: 4.8, z: -1.25, r: 31.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 35.7 | -0.96 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.9 | -1.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 35.9 | -0.94 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 31.2 | -1.25 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
