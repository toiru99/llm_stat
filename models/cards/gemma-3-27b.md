...
radar:
  ...
  coding: { s: 24.6, z: -0.94, r: 36.0, estimated: false }  # 코딩
  agentic: { s: 4.8, z: -1.26, r: 31.1, estimated: false }  # 에이전트
...
| 코딩 | 36.0 | -0.94 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 31.1 | -1.26 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
