...
radar:
  ...
  coding: { s: 25.4, z: -0.88, r: 36.7, estimated: false }  # 코딩
  agentic: { s: 5.1, z: -1.22, r: 31.8, estimated: false }  # 에이전트
...
| 코딩 | 36.7 | -0.88 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 31.8 | -1.22 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
