...
is_reasoning: true
radar:
  knowledge: { s: 76.4, z: 1.74, r: 76.1, estimated: false }  # 전문 지식
  reasoning: { s: 48.7, z: 0.8, r: 62.0, estimated: false }  # 추론
  coding: { s: 72.7, z: 1.12, r: 66.9, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 76.1 | +1.74 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 62.0 | +0.8 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 66.9 | +1.12 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
