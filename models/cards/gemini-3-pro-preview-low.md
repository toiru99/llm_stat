...
radar:
  ...
  reasoning: { s: 48.3, z: 0.6, r: 59.0, estimated: false }  # 추론
  coding: { s: 72.7, z: 0.98, r: 64.6, estimated: false }  # 코딩
  agentic: { s: 60.1, z: 0.87, r: 63.1, estimated: false }  # 에이전트
...
| 추론 | 59.0 | +0.6 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
| 코딩 | 64.6 | +0.98 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 63.1 | +0.87 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
