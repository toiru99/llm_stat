...
is_reasoning: true
radar:
  knowledge: { s: 76.4, z: 1.65, r: 74.7, estimated: false }  # 전문 지식
  reasoning: { s: 48.7, z: 0.7, r: 60.4, estimated: false }  # 추론
  coding: { s: 72.7, z: 1.05, r: 65.8, estimated: false }  # 코딩
  agentic: { s: 60.1, z: 0.97, r: 64.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 74.7 | +1.65 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 60.4 | +0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 65.8 | +1.05 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 64.6 | +0.97 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
