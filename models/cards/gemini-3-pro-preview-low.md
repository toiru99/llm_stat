...
radar:
  ...
  reasoning: { s: 48.3, z: 0.6, r: 59.1, estimated: false }  # 추론
  coding: { s: 72.7, z: 0.98, r: 64.7, estimated: false }  # 코딩
...
| 추론 | 59.1 | +0.6 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
| 코딩 | 64.7 | +0.98 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
