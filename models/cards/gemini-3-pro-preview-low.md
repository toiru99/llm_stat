...
is_reasoning: true
radar:
  knowledge: { s: 74.5, z: 1.68, r: 75.2, estimated: false }  # 전문 지식
  reasoning: { s: 48.3, z: 0.7, r: 60.5, estimated: false }  # 추론
  coding: { s: 72.7, z: 1.05, r: 65.8, estimated: false }  # 코딩
  agentic: { s: 60.1, z: 0.91, r: 63.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 75.2 | +1.68 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
| 추론 | 60.5 | +0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
| 코딩 | 65.8 | +1.05 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 63.7 | +0.91 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
