...
is_reasoning: true
radar:
  knowledge: { s: 74.5, z: 1.62, r: 74.3, estimated: false }  # 전문 지식
  reasoning: { s: 48.6, z: 0.68, r: 60.2, estimated: false }  # 추론
  coding: { s: 72.7, z: 1.05, r: 65.8, estimated: false }  # 코딩
  agentic: { s: 60.1, z: 0.96, r: 64.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 74.3 | +1.62 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
...
| 에이전트 | 64.4 | +0.96 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
