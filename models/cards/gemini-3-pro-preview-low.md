...
is_reasoning: true
radar:
  knowledge: { s: 76.4, z: 1.75, r: 76.2, estimated: false }  # 전문 지식
  reasoning: { s: 48.7, z: 0.81, r: 62.1, estimated: false }  # 추론
  coding: { s: 72.7, z: 1.13, r: 67.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 76.2 | +1.75 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 62.1 | +0.81 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 67.0 | +1.13 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 64.0 | +0.93 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
