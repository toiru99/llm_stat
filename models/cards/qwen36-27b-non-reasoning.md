...
radar:
  ...
  coding: { s: 50.4, z: 0.16, r: 52.3, estimated: false }  # 코딩
  agentic: { s: 47.5, z: 0.4, r: 56.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 53.0 t/s · TTFT 3.67s · 262k ctx` · 가성비 34.4
...
| 코딩 | 52.3 | +0.16 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 56.1 | +0.4 | 실측 | [[gdpval]] 31.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
