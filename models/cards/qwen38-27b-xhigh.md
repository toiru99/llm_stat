...
radar:
  ...
  agentic: { s: 84.2, z: 1.79, r: 76.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 88.2, z: 1.49, r: 72.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 44.0 t/s · TTFT 3.99s · 256k ctx` · 가성비 94.3
...
| 에이전트 | 76.8 | +1.79 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 48.0%×1.0 |
