...
radar:
  ...
  instruction: { s: 85.9, z: 1.41, r: 71.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 46.0 t/s · TTFT 3.96s · 256k ctx` · 가성비 119.5
...
| 추론 | 67.3 | +1.15 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
