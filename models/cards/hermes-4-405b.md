...
radar:
  ...
  coding: { s: 33.3, z: -0.54, r: 41.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 34.0 t/s · TTFT 2.4s · 128k ctx` · 가성비 7.5
...
| 코딩 | 41.8 | -0.54 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
