...
radar:
  ...
  coding: { s: 33.3, z: -0.61, r: 40.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 34.0 t/s · TTFT 2.62s · 128k ctx` · 가성비 7.5
...
| 코딩 | 40.9 | -0.61 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 39.9 | -0.68 | 실측 | [[tau2-bench]] 22.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
