...
is_reasoning: true
radar:
  knowledge: { s: 46.8, z: 0.32, r: 54.9, estimated: false }  # 전문 지식
  reasoning: { s: 30.5, z: -0.2, r: 47.0, estimated: false }  # 추론
  coding: { s: 32.4, z: -0.6, r: 40.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 41.0 t/s · TTFT 2.69s · 128k ctx` · 가성비 7.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.9 | +0.32 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 47.0 | -0.2 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 40.9 | -0.6 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
