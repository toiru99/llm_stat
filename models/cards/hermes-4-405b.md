...
is_reasoning: false
radar:
  knowledge: { s: 49.1, z: 0.42, r: 56.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 40.0 t/s · TTFT 2.37s · 128k ctx` · 가성비 7.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.4 | +0.42 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
