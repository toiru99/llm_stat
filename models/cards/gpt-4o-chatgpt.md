...
radar:
  ...
  agentic: { s: 40.9, z: 0.14, r: 52.2, estimated: true }  # 에이전트
  trust: { s: 41.9, z: 0.59, r: 58.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 66.3, z: 0.47, r: 57.0, estimated: false }  # 긴문맥
  instruction: { s: 61.1, z: 0.28, r: 54.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 에이전트 | 52.2 | +0.14 | 추정 | (추정) |
| 신뢰성 | 58.9 | +0.59 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 57.0 | +0.47 | 실측 | [[aa-lcr]] 55.0%×1.0 |
| 지시 따르기 | 54.1 | +0.28 | 추정 | (추정) |
