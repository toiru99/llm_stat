...
radar:
  ...
  agentic: { s: 43.7, z: 0.28, r: 54.2, estimated: true }  # 에이전트
  trust: { s: 27.8, z: -0.03, r: 49.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 69.7, z: 0.6, r: 59.0, estimated: false }  # 긴문맥
  instruction: { s: 51.3, z: -0.08, r: 48.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
