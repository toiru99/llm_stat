...
radar:
  ...
  agentic: { s: 24.3, z: -1.07, r: 34.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $0.75 · 혼합 $0.28/1M · 276.0 t/s · TTFT 1.51s · 1M ctx` · 가성비 89.3
...
| 에이전트 | 34.0 | -1.07 | 실측 | [[apex-agents]] 2.0%×1.0, [[gdpval]] 8.0%×1.0, [[itbench]] 1.0%×1.0, [[tau2-bench]] 68.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
