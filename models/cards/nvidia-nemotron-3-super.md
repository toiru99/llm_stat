...
radar:
  ...
  agentic: { s: 24.8, z: -1.03, r: 34.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $0.78 · 혼합 $0.23/1M · 222.0 t/s · TTFT 1.55s · 1M ctx` · 가성비 108.7
...
| 에이전트 | 34.6 | -1.03 | 실측 | [[apex-agents]] 2.0%×1.0, [[gdpval]] 10.0%×1.0, [[itbench]] 1.0%×1.0, [[tau2-bench]] 68.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
