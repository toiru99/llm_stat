...
is_reasoning: true
radar:
  knowledge: { s: 85.6, z: 2.17, r: 82.5, estimated: true }  # 전문 지식
  reasoning: { s: 81.2, z: 2.49, r: 87.4, estimated: false }  # 추론
  coding: { s: 93.2, z: 1.97, r: 79.6, estimated: true }  # 코딩
  agentic: { s: 82.2, z: 1.78, r: 76.7, estimated: true }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 82.5 | +2.17 | 추정 | (추정) |
| 추론 | 87.4 | +2.49 | 실측 | [[critpt]] 26.0%×1.0 |
| 코딩 | 79.6 | +1.97 | 추정 | (추정) |
