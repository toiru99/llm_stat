...
radar:
  ...
  reasoning: { s: 81.2, z: 2.2, r: 83.0, estimated: false }  # 추론
  coding: { s: 89.5, z: 1.66, r: 74.9, estimated: true }  # 코딩
  agentic: { s: 79.1, z: 1.6, r: 74.0, estimated: true }  # 에이전트
...
| 추론 | 83.0 | +2.2 | 실측 | [[critpt]] 26.0%×1.0 |
| 코딩 | 74.9 | +1.66 | 추정 | (추정) |
| 에이전트 | 74.0 | +1.6 | 추정 | (추정) |
| 신뢰성 | 50.0 | +-0.0 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
