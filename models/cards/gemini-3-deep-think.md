...
radar:
  ...
  coding: { s: 90.8, z: 1.35, r: 70.3, estimated: true }  # 코딩
  agentic: { s: 82.6, z: 1.22, r: 68.3, estimated: true }  # 에이전트
  trust: { s: 24.8, z: -0.32, r: 45.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 98.8, z: 1.01, r: 65.1, estimated: true }  # 긴문맥
  instruction: { s: 86.0, z: 0.8, r: 61.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
