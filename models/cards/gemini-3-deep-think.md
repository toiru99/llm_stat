...
is_reasoning: true
radar:
  knowledge: { s: 85.6, z: 2.19, r: 82.8, estimated: true }  # 전문 지식
  reasoning: { s: 81.2, z: 2.53, r: 87.9, estimated: false }  # 추론
  coding: { s: 91.2, z: 1.91, r: 78.6, estimated: true }  # 코딩
  ...
  instruction: { s: 83.4, z: 1.28, r: 69.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
