...
radar:
  ...
  coding: { s: 28.9, z: -0.76, r: 38.6, estimated: false }  # 코딩
  agentic: { s: 49.5, z: 0.47, r: 57.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.4 · 혼합 $0.103/1M · 107.0 t/s · TTFT 1.58s · 200k ctx` · 가성비 155.3
...
| 코딩 | 38.6 | -0.76 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 57.0 | +0.47 | 실측 | [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
