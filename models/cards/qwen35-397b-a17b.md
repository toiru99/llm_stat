...
is_reasoning: false
radar:
  knowledge: { s: 60.4, z: 0.98, r: 64.6, estimated: false }  # 전문 지식
  reasoning: { s: 50.1, z: 0.89, r: 63.3, estimated: false }  # 추론
  coding: { s: 67.4, z: 0.91, r: 63.7, estimated: false }  # 코딩
  agentic: { s: 54.2, z: 0.71, r: 60.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 64.6 | +0.98 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 63.3 | +0.89 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 63.7 | +0.91 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 60.7 | +0.71 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 23.0%×1.0, [[itbench]] 34.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
