...
is_reasoning: false
radar:
  knowledge: { s: 60.4, z: 0.89, r: 63.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 73.0 t/s · TTFT 2.27s · 262k ctx` · 가성비 37.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.4 | +0.89 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 61.5 | +0.77 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 62.5 | +0.83 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 60.0 | +0.66 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 23.0%×1.0, [[itbench]] 34.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
