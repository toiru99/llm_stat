...
radar:
  ...
  reasoning: { s: 23.0, z: -0.58, r: 41.4, estimated: false }  # 추론
  ...
  long_context: { s: 14.5, z: -1.04, r: 34.4, estimated: false }  # 긴문맥
...
| 추론 | 41.4 | -0.58 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
...
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 34.4 | -1.04 | 실측 | [[aa-lcr]] 11.0%×1.0 |
