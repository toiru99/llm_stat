...
is_reasoning: true
radar:
  knowledge: { s: 81.5, z: 2.01, r: 80.2, estimated: false }  # 전문 지식
  reasoning: { s: 72.9, z: 1.88, r: 78.2, estimated: false }  # 추론
  coding: { s: 93.5, z: 1.95, r: 79.3, estimated: false }  # 코딩
  agentic: { s: 63.1, z: 1.0, r: 64.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $4.25 · 혼합 $0.78/1M · 176.0 t/s · TTFT 1.49s · 1M ctx` · 가성비 67.9
...
| 추론 | 78.2 | +1.88 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 46.0%×1.0 |
| 코딩 | 79.3 | +1.95 | 실측 | [[scicode]] 58.0%×1.0 |
| 에이전트 | 64.9 | +1.0 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 32.0%×1.0 |
