...
is_reasoning: true
radar:
  knowledge: { s: 76.6, z: 1.76, r: 76.3, estimated: false }  # 전문 지식
  reasoning: { s: 75.6, z: 2.23, r: 83.4, estimated: false }  # 추론
  coding: { s: 96.7, z: 2.15, r: 82.2, estimated: false }  # 코딩
  agentic: { s: 72.8, z: 1.43, r: 71.4, estimated: false }  # 에이전트
  trust: { s: 71.8, z: 2.06, r: 80.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.25 · 출력 $4.25 · 혼합 $0.78/1M · 122.0 t/s · TTFT 1.37s · 1M ctx` · 가성비 65.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 76.3 | +1.76 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 83.4 | +2.23 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
| 코딩 | 82.2 | +2.15 | 실측 | [[scicode]] 58.0%×1.0 |
| 에이전트 | 71.4 | +1.43 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
| 신뢰성 | 80.8 | +2.06 | 실측 | [[aa-omniscience]] 62.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
