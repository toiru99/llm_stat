...
is_reasoning: true
radar:
  knowledge: { s: 76.6, z: 1.75, r: 76.2, estimated: false }  # 전문 지식
  reasoning: { s: 75.6, z: 2.22, r: 83.3, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $4.25 · 혼합 $0.78/1M · 118.0 t/s · TTFT 1.52s · 1M ctx` · 가성비 65.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 76.2 | +1.75 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 83.3 | +2.22 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
