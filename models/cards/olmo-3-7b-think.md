...
is_reasoning: true
radar:
  knowledge: { s: 23.3, z: -0.84, r: 37.5, estimated: false }  # 전문 지식
  reasoning: { s: 19.9, z: -0.72, r: 39.1, estimated: false }  # 추론
  coding: { s: 23.8, z: -0.95, r: 35.8, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 37.5 | -0.84 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 39.1 | -0.72 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 35.8 | -0.95 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
