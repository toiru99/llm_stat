...
is_reasoning: true
radar:
  knowledge: { s: 22.6, z: -0.88, r: 36.9, estimated: false }  # 전문 지식
  reasoning: { s: 19.8, z: -0.75, r: 38.7, estimated: false }  # 추론
  coding: { s: 23.8, z: -0.98, r: 35.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 36.9 | -0.88 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 38.7 | -0.75 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 35.3 | -0.98 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
