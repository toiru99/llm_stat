...
is_reasoning: false
radar:
  knowledge: { s: 9.8, z: -1.54, r: 27.0, estimated: false }  # 전문 지식
  reasoning: { s: 8.2, z: -1.33, r: 30.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 27.0 | -1.54 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 23.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
