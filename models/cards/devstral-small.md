...
radar:
  ...
  reasoning: { s: 14.2, z: -1.01, r: 34.8, estimated: false }  # 추론
  coding: { s: 29.7, z: -0.69, r: 39.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 37.7 | -0.82 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.8 | -1.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.7 | -0.69 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 39.9 | -0.67 | 실측 | [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
