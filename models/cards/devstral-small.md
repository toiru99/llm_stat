...
radar:
  ...
  reasoning: { s: 14.2, z: -1.02, r: 34.8, estimated: false }  # 추론
  coding: { s: 29.7, z: -0.69, r: 39.6, estimated: false }  # 코딩
...
| 추론 | 34.8 | -1.02 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.6 | -0.69 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
