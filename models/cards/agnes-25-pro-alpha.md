...
radar:
  ...
  agentic: { s: 37.1, z: -0.0, r: 50.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.45 · 출력 $0.9 · 혼합 $0.1827/1M · 130.0 t/s · TTFT 2.05s · 1M ctx` · 가성비 218.9
...
| 에이전트 | 50.0 | +-0.0 | 실측 | [[gdpval]] 34.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
