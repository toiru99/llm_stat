...
is_reasoning: true
radar:
  knowledge: { s: 79.4, z: 1.91, r: 78.6, estimated: false }  # 전문 지식
  reasoning: { s: 83.3, z: 2.4, r: 86.0, estimated: false }  # 추론
  coding: { s: 95.2, z: 2.02, r: 80.3, estimated: false }  # 코딩
  agentic: { s: 86.5, z: 1.9, r: 78.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 38.0 t/s · TTFT 5.01s · 1M ctx` · 가성비 26.0
...
| 에이전트 | 78.6 | +1.9 | 실측 | [[apex-agents]] 41.0%×1.0, [[gdpval]] 58.0%×1.0, [[itbench]] 48.0%×1.0, [[tau3-banking]] 46.0%×1.0 |
