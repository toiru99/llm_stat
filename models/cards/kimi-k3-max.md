...
radar:
  ...
  agentic: { s: 87.7, z: 2.01, r: 80.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 39.0 t/s · TTFT 2.89s · 1M ctx` · 가성비 26.0
...
| 에이전트 | 80.2 | +2.01 | 실측 | [[apex-agents]] 41.0%×1.0, [[gdpval]] 59.0%×1.0, [[itbench]] 48.0%×1.0, [[tau3-banking]] 46.0%×1.0 |
