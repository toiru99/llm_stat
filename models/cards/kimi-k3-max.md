...
radar:
  ...
  agentic: { s: 89.1, z: 2.04, r: 80.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 35.0 t/s · TTFT 2.76s · 1M ctx`
...
| 에이전트 | 80.7 | +2.04 | 실측 | [[apex-agents]] 41.0%×1.0, [[gdpval]] 59.0%×1.0, [[itbench]] 48.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
