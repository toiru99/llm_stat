...
is_reasoning: false
radar:
  knowledge: { s: 19.3, z: -1.04, r: 34.3, estimated: false }  # 전문 지식
  reasoning: { s: 14.8, z: -1.01, r: 34.9, estimated: false }  # 추론
  coding: { s: 14.4, z: -1.39, r: 29.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 34.3 | -1.04 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 34.9 | -1.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 29.2 | -1.39 | 실측 | [[scicode]] 13.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
