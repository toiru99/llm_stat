...
radar:
  ...
  coding: { s: 26.4, z: -0.84, r: 37.5, estimated: false }  # 코딩
  agentic: { s: 11.6, z: -0.96, r: 35.7, estimated: false }  # 에이전트
  trust: { s: 24.7, z: -0.14, r: 47.8, estimated: false }  # 신뢰성
  multimodal: { s: 42.0, z: -1.41, r: 28.9, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 40.6 | -0.62 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 50.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 37.0 | -0.87 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 50.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 37.5 | -0.84 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 35.7 | -0.96 | 실측 | [[tau2-bench]] 14.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
| 신뢰성 | 47.8 | -0.14 | 실측 | [[aa-omniscience]] 22.0%×1.0 |
| 멀티모달 | 28.9 | -1.41 | 실측 | [[mmmu-pro]] 44.0%×1.0 |
