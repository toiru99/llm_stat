...
radar:
  ...
  coding: { s: 26.4, z: -0.87, r: 36.9, estimated: false }  # 코딩
  agentic: { s: 11.6, z: -0.97, r: 35.5, estimated: false }  # 에이전트
  trust: { s: 23.3, z: -0.14, r: 48.0, estimated: false }  # 신뢰성
  multimodal: { s: 41.4, z: -1.47, r: 28.0, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 39.7 | -0.68 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 50.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 36.8 | -0.88 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 50.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 36.9 | -0.87 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 35.5 | -0.97 | 실측 | [[tau2-bench]] 14.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
| 신뢰성 | 48.0 | -0.14 | 실측 | [[aa-omniscience]] 22.0%×1.0 |
| 멀티모달 | 28.0 | -1.47 | 실측 | [[mmmu-pro]] 44.0%×1.0 |
