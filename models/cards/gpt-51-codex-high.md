...
radar:
  ...
  agentic: { s: 68.4, z: 1.24, r: 68.7, estimated: false }  # 에이전트
  trust: { s: 28.7, z: 0.02, r: 50.2, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · None t/s · TTFT Nones · 400k ctx` · 가성비 16.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.5 | +1.17 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
...
| 에이전트 | 68.7 | +1.24 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
| 신뢰성 | 50.2 | +0.02 | 실측 | [[aa-omniscience]] 26.0%×1.0 |
