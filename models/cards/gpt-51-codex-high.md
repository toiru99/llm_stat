...
radar:
  ...
  agentic: { s: 68.4, z: 1.26, r: 68.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.13/1M · 166.0 t/s · TTFT 7.86s · 400k ctx` · 가성비 16.4
...
| 에이전트 | 68.8 | +1.26 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
