...
is_reasoning: true
radar:
  knowledge: { s: 65.1, z: 1.12, r: 66.9, estimated: false }  # 전문 지식
  reasoning: { s: 51.5, z: 0.76, r: 61.4, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.54, r: 58.2, estimated: false }  # 코딩
  agentic: { s: 68.4, z: 1.2, r: 68.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 66.9 | +1.12 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
...
| 에이전트 | 68.0 | +1.2 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
