...
radar:
  ...
  reasoning: { s: 51.5, z: 0.76, r: 61.4, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.54, r: 58.1, estimated: false }  # 코딩
  agentic: { s: 68.4, z: 1.19, r: 67.9, estimated: false }  # 에이전트
...
| 추론 | 61.4 | +0.76 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 67.9 | +1.19 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
