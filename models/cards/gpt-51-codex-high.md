...
is_reasoning: true
radar:
  knowledge: { s: 63.8, z: 1.17, r: 67.5, estimated: false }  # 전문 지식
  reasoning: { s: 50.4, z: 0.8, r: 62.0, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.59, r: 58.9, estimated: false }  # 코딩
  agentic: { s: 68.4, z: 1.22, r: 68.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 67.5 | +1.17 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 62.0 | +0.8 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 58.9 | +0.59 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 68.3 | +1.22 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
