...
radar:
  ...
  reasoning: { s: 50.1, z: 0.72, r: 60.9, estimated: false }  # 추론
  coding: { s: 53.0, z: 0.73, r: 60.9, estimated: false }  # 코딩
  agentic: { s: 68.4, z: 1.19, r: 67.8, estimated: false }  # 에이전트
...
OpenAI · Proprietary · Unknown · 컨텍스트 400k · 종합지능 **28.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · None t/s · TTFT Nones · 400k ctx` · 가성비 13.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.3 | +1.09 | 실측 | [[aa-omniscience]] 40.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 60.9 | +0.72 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 60.9 | +0.73 | 실측 | [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 67.8 | +1.19 | 실측 | [[tau2-bench]] 83.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
