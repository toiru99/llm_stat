...
radar:
  ...
  reasoning: { s: 50.5, z: 0.81, r: 62.1, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.63, r: 59.5, estimated: false }  # 코딩
...
| 추론 | 62.1 | +0.81 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 59.5 | +0.63 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
