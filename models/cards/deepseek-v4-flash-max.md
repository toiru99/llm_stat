...
is_reasoning: true
radar:
  knowledge: { s: 64.7, z: 1.21, r: 68.2, estimated: false }  # 전문 지식
  reasoning: { s: 57.8, z: 1.17, r: 67.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 68.2 | +1.21 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 35.0%×0.3 |
...
| 에이전트 | 65.4 | +1.03 | 실측 | [[gdpval]] 34.0%×1.0, [[itbench]] 32.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
