...
radar:
  ...
  agentic: { s: 68.5, z: 0.65, r: 59.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.06/1M · 119.0 t/s · TTFT 1.44s · 1M ctx` · 가성비 666.7
...
| 에이전트 | 59.8 | +0.65 | 실측 | [[gdpval]] 34.0%×1.0, [[itbench]] 32.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 23.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
