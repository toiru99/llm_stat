...
radar:
  ...
  reasoning: { s: 59.3, z: 1.15, r: 67.2, estimated: false }  # 추론
  coding: { s: 68.2, z: 0.8, r: 62.0, estimated: false }  # 코딩
  agentic: { s: 63.7, z: 1.02, r: 65.4, estimated: false }  # 에이전트
...
| 추론 | 67.2 | +1.15 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 62.0 | +0.8 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 65.4 | +1.02 | 실측 | [[gdpval]] 34.0%×1.0, [[itbench]] 32.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 31.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
