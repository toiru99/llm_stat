...
radar:
  ...
  coding: { s: 26.3, z: -0.86, r: 37.0, estimated: false }  # 코딩
  agentic: { s: 44.6, z: 0.29, r: 54.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 27.0 t/s · TTFT 0.75s · 262k ctx` · 가성비 476.2
...
| 코딩 | 37.0 | -0.86 | 실측 | [[scicode]] 16.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 54.4 | +0.29 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
