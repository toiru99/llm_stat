...
radar:
  ...
  agentic: { s: 44.6, z: 0.32, r: 54.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 39.0 t/s · TTFT 0.69s · 262k ctx` · 가성비 476.2
...
| 에이전트 | 54.8 | +0.32 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
