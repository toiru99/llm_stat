...
radar:
  ...
  reasoning: { s: 31.1, z: -0.12, r: 48.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.04/1M · 27.0 t/s · TTFT 0.67s · 262k ctx` · 가성비 500.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.6 | -0.36 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 48.1 | -0.12 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
