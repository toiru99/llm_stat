...
radar:
  ...
  long_context: { s: 73.7, z: 0.71, r: 60.7, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 39.0 t/s · TTFT 0.63s · 262k ctx` · 가성비 476.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.1 | -0.4 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
...
| 긴문맥 | 60.7 | +0.71 | 실측 | [[aa-lcr]] 56.0%×1.0 |
