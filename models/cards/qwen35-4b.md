...
radar:
  ...
  reasoning: { s: 31.1, z: -0.12, r: 48.2, estimated: false }  # 추론
  coding: { s: 26.9, z: -0.81, r: 37.9, estimated: false }  # 코딩
...
| 추론 | 48.2 | -0.12 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 37.9 | -0.81 | 실측 | [[scicode]] 16.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
