...
radar:
  ...
  coding: { s: 27.3, z: -1.48, r: 27.8, estimated: false }  # 코딩
  agentic: { s: 49.1, z: -0.13, r: 48.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 56.3, z: -0.53, r: 42.0, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.04/1M · 25.0 t/s · TTFT 0.8s · 262k ctx` · 가성비 500.0
...
| 코딩 | 27.8 | -1.48 | 실측 | [[scicode]] 16.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 48.0 | -0.13 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
| 신뢰성 | 42.3 | -0.51 | 실측 | [[aa-omniscience]] 20.0%×1.0 |
| 멀티모달 | 43.2 | -0.45 | 실측 | [[mmmu-pro]] 65.0%×1.0 |
| 긴문맥 | 52.5 | +0.16 | 실측 | [[aa-lcr]] 56.0%×1.0 |
| 지시 따르기 | 42.0 | -0.53 | 실측 | [[ifbench]] 52.0%×1.0 |
