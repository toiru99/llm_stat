...
radar:
  ...
  coding: { s: 26.3, z: -0.87, r: 36.9, estimated: false }  # 코딩
  agentic: { s: 44.6, z: 0.28, r: 54.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 26.0 t/s · TTFT 0.75s · 262k ctx` · 가성비 476.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.4 | -0.3 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
...
| 에이전트 | 54.1 | +0.28 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
