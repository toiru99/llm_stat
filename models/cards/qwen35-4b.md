...
radar:
  ...
  agentic: { s: 43.2, z: -0.31, r: 45.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.04/1M · 23.0 t/s · TTFT 0.93s · 262k ctx` · 가성비 500.0
...
| 에이전트 | 45.4 | -0.31 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
