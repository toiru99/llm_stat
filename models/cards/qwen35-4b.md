...
Alibaba · Open · Small(4.66B) · 컨텍스트 262k · 종합지능 **14.0**
...
## 실용 지표
`입력 $0.03 · 출력 $0.15 · 혼합 $0.042/1M · 22.0 t/s · TTFT 0.73s · 262k ctx` · 가성비 333.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.2 | -0.32 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 47.2 | -0.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 47.5 | -0.17 | 실측 | [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 54.1 | +0.27 | 실측 | [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
