...
radar:
  ...
  agentic: { s: 34.8, z: -0.05, r: 49.3, estimated: true }  # 에이전트
  trust: { s: 31.2, z: 0.23, r: 53.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 23.2, z: -0.8, r: 38.1, estimated: true }  # 긴문맥
  instruction: { s: 42.6, z: -0.46, r: 43.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 49.5 | -0.03 | 실측 | [[scicode]] 28.0%×1.0 |
