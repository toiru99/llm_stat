...
radar:
  ...
  agentic: { s: 30.0, z: -0.23, r: 46.5, estimated: true }  # 에이전트
  trust: { s: 32.7, z: 0.18, r: 52.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 21.3, z: -0.85, r: 37.3, estimated: true }  # 긴문맥
  instruction: { s: 32.9, z: -0.84, r: 37.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
