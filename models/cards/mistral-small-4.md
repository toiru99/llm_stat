...
radar:
  ...
  coding: { s: 50.8, z: 0.09, r: 51.4, estimated: false }  # 코딩
  agentic: { s: 20.7, z: -0.64, r: 40.4, estimated: false }  # 에이전트
  trust: { s: 36.0, z: 0.34, r: 55.1, estimated: false }  # 신뢰성
  multimodal: { s: 60.0, z: -0.6, r: 41.0, estimated: false }  # 멀티모달
  long_context: { s: 56.6, z: 0.18, r: 52.7, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 179.0 t/s · TTFT 0.76s · 256k ctx` · 가성비 102.6
...
| 코딩 | 51.4 | +0.09 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
...
| 멀티모달 | 41.0 | -0.6 | 실측 | [[mmmu-pro]] 57.0%×1.0 |
| 긴문맥 | 52.7 | +0.18 | 실측 | [[aa-lcr]] 47.0%×1.0 |
