...
radar:
  ...
  long_context: { s: 56.6, z: 0.19, r: 52.9, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 155.0 t/s · TTFT 0.84s · 256k ctx` · 가성비 102.6
...
| 긴문맥 | 52.9 | +0.19 | 실측 | [[aa-lcr]] 47.0%×1.0 |
