...
radar:
  ...
  coding: { s: 50.8, z: 0.1, r: 51.5, estimated: false }  # 코딩
  ...
  long_context: { s: 56.6, z: 0.18, r: 52.8, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 162.0 t/s · TTFT 0.8s · 256k ctx` · 가성비 102.6
...
| 긴문맥 | 52.8 | +0.18 | 실측 | [[aa-lcr]] 47.0%×1.0 |
