...
radar:
  ...
  reasoning: { s: 31.4, z: -0.15, r: 47.7, estimated: false }  # 추론
  coding: { s: 49.4, z: 0.12, r: 51.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 165.0 t/s · TTFT 0.81s · 256k ctx` · 가성비 102.6
...
| 추론 | 47.7 | -0.15 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 51.7 | +0.12 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
...
| 긴문맥 | 53.1 | +0.21 | 실측 | [[aa-lcr]] 47.0%×1.0 |
