...
radar:
  ...
  coding: { s: 50.8, z: 0.19, r: 52.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 170.0 t/s · TTFT 0.72s · 256k ctx`
...
| 코딩 | 52.8 | +0.19 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 41.7 | -0.55 | 실측 | [[gdpval]] 4.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
