...
## 실용 지표
`입력 $0.08 · 출력 $0.09 · 혼합 $0.0765/1M · 140.0 t/s · TTFT 0.96s · 128k ctx` · 가성비 104.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 29.7 | -1.35 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 26.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
