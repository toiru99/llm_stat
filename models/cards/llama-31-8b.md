...
radar:
  ...
  reasoning: { s: 8.9, z: -1.28, r: 30.8, estimated: false }  # 추론
  coding: { s: 14.9, z: -1.33, r: 30.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.08 · 출력 $0.09 · 혼합 $None/1M · 139.0 t/s · TTFT 0.94s · 128k ctx`
...
| 코딩 | 30.0 | -1.33 | 실측 | [[scicode]] 13.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
