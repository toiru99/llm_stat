...
is_reasoning: false
radar:
  knowledge: { s: 13.9, z: -1.33, r: 30.0, estimated: false }  # 전문 지식
  reasoning: { s: 8.7, z: -1.3, r: 30.5, estimated: false }  # 추론
  coding: { s: 14.9, z: -1.36, r: 29.5, estimated: false }  # 코딩
  agentic: { s: 5.9, z: -1.21, r: 31.8, estimated: false }  # 에이전트
  trust: { s: 56.7, z: 1.55, r: 73.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.02 · 출력 $0.05 · 혼합 $0.023/1M · 137.0 t/s · TTFT 0.84s · 128k ctx` · 가성비 304.3
...
| 코딩 | 29.5 | -1.36 | 실측 | [[scicode]] 13.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 31.8 | -1.21 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 16.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 73.3 | +1.55 | 실측 | [[aa-omniscience]] 57.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
