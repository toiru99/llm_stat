...
is_reasoning: true
radar:
  knowledge: { s: 38.8, z: -0.08, r: 48.8, estimated: false }  # 전문 지식
  reasoning: { s: 28.3, z: -0.27, r: 45.9, estimated: false }  # 추론
  coding: { s: 42.6, z: -0.15, r: 47.8, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 48.8 | -0.08 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 45.9 | -0.27 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 47.8 | -0.15 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
