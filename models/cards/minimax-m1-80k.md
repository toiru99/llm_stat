...
is_reasoning: true
radar:
  knowledge: { s: 38.5, z: -0.14, r: 48.0, estimated: false }  # 전문 지식
  reasoning: { s: 28.5, z: -0.35, r: 44.8, estimated: false }  # 추론
  coding: { s: 42.6, z: -0.24, r: 46.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 48.0 | -0.14 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
