...
radar:
  ...
  reasoning: { s: 15.4, z: -0.96, r: 35.7, estimated: false }  # 추론
  coding: { s: 33.1, z: -0.59, r: 41.2, estimated: false }  # 코딩
  agentic: { s: 14.5, z: -0.89, r: 36.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 137.0 t/s · TTFT 0.94s · 128k ctx` · 가성비 125.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 37.6 | -0.83 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 45.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 36.7 | -0.89 | 실측 | [[gdpval]] 5.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
