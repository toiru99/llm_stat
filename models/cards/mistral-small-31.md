...
is_reasoning: false
radar:
  knowledge: { s: 24.9, z: -0.77, r: 38.5, estimated: false }  # 전문 지식
  reasoning: { s: 16.5, z: -0.9, r: 36.5, estimated: false }  # 추론
  coding: { s: 34.0, z: -0.54, r: 42.0, estimated: false }  # 코딩
  agentic: { s: 16.5, z: -0.77, r: 38.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 144.0 t/s · TTFT 0.75s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.5 | -0.77 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 45.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 36.5 | -0.9 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 45.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 42.0 | -0.54 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
