...
radar:
  ...
  reasoning: { s: 15.6, z: -0.98, r: 35.2, estimated: false }  # 추론
  coding: { s: 34.0, z: -0.6, r: 40.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 159.0 t/s · TTFT 0.79s · 128k ctx` · 가성비 125.0
...
| 추론 | 35.2 | -0.98 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 45.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 40.9 | -0.6 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
