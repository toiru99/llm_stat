...
radar:
  ...
  coding: { s: 34.0, z: -0.5, r: 42.5, estimated: false }  # 코딩
  agentic: { s: 16.6, z: -0.75, r: 38.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 155.0 t/s · TTFT 0.74s · 128k ctx` · 가성비 125.0
...
| 추론 | 36.6 | -0.9 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 45.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 42.5 | -0.5 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 38.7 | -0.75 | 실측 | [[gdpval]] 5.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
