...
radar:
  ...
  coding: { s: 34.0, z: -0.51, r: 42.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 160.0 t/s · TTFT 0.76s · 128k ctx` · 가성비 125.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.7 | -0.76 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 45.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 36.4 | -0.9 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 45.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 42.3 | -0.51 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
