...
is_reasoning: true
radar:
  knowledge: { s: 99.7, z: 2.85, r: 92.8, estimated: false }  # 전문 지식
  reasoning: { s: 96.5, z: 3.29, r: 99.3, estimated: false }  # 추론
  coding: { s: 98.5, z: 2.2, r: 82.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $None/1M · 68.0 t/s · TTFT 116.24s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 92.8 | +2.85 | 실측 | [[aa-omniscience]] 61.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 53.0%×0.3 |
| 추론 | 99.3 | +3.29 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 53.0%×1.0 |
| 코딩 | 82.9 | +2.2 | 실측 | [[scicode]] 60.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
