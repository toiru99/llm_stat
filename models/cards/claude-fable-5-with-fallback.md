...
radar:
  ...
  reasoning: { s: 96.1, z: 2.96, r: 94.4, estimated: false }  # 추론
  coding: { s: 98.5, z: 2.05, r: 80.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 67.0 t/s · TTFT 151.92s · 1M ctx` · 가성비 8.1
...
| 추론 | 94.4 | +2.96 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 55.0%×1.0 |
| 코딩 | 80.8 | +2.05 | 실측 | [[scicode]] 60.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 81.6 | +2.11 | 실측 | [[gdpval]] 62.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 38.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
