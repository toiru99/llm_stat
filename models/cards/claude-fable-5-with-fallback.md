...
radar:
  ...
  coding: { s: 98.5, z: 2.03, r: 80.4, estimated: false }  # 코딩
  agentic: { s: 90.3, z: 2.03, r: 80.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 70.0 t/s · TTFT 95.42s · 1M ctx` · 가성비 8.1
...
| 코딩 | 80.4 | +2.03 | 실측 | [[scicode]] 60.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 80.4 | +2.03 | 실측 | [[gdpval]] 61.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 38.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
