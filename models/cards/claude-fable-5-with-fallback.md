...
radar:
  ...
  reasoning: { s: 96.1, z: 3.12, r: 96.8, estimated: false }  # 추론
  coding: { s: 98.5, z: 2.13, r: 82.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 65.0 t/s · TTFT 95.42s · 1M ctx` · 가성비 8.1
...
| 추론 | 96.8 | +3.12 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 55.0%×1.0 |
| 코딩 | 82.0 | +2.13 | 실측 | [[scicode]] 60.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
