...
radar:
  ...
  agentic: { s: 96.0, z: 1.77, r: 76.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 72.0 t/s · TTFT 173.36s · 1M ctx` · 가성비 7.8
...
| 에이전트 | 76.5 | +1.77 | 실측 | [[gdpval]] 63.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 27.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
