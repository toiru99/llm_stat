...
radar:
  ...
  coding: { s: 95.8, z: 2.22, r: 83.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 72.0 t/s · TTFT 107.86s · 1M ctx` · 가성비 6.9
...
| 코딩 | 83.3 | +2.22 | 실측 | [[scicode]] 61.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
