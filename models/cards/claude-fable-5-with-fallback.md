...
radar:
  knowledge: { s: 99.7, z: 2.18, r: 82.7, estimated: false }  # 전문 지식
  reasoning: { s: 97.4, z: 2.48, r: 87.2, estimated: false }  # 추론
  coding: { s: 100.0, z: 1.76, r: 76.3, estimated: false }  # 코딩
  agentic: { s: 96.0, z: 1.73, r: 76.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 82.7 | +2.18 | 실측 | [[aa-omniscience]] 61.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 53.0%×0.3 |
...
| 에이전트 | 76.0 | +1.73 | 실측 | [[gdpval]] 63.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 27.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
