...
radar:
  ...
  agentic: { s: 90.6, z: 2.12, r: 81.8, estimated: false }  # 에이전트
  trust: { s: 39.5, z: 0.56, r: 58.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 62.0 t/s · TTFT 101.84s · 1M ctx` · 가성비 8.1
...
| 에이전트 | 81.8 | +2.12 | 실측 | [[gdpval]] 62.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 38.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
| 신뢰성 | 58.3 | +0.56 | 실측 | [[aa-omniscience]] 36.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
