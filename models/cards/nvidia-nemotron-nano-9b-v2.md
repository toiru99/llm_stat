...
radar:
  ...
  coding: { s: 25.5, z: -0.93, r: 36.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.052/1M · 180.0 t/s · TTFT 4.5s · 131k ctx` · 가성비 173.1
...
| 코딩 | 36.1 | -0.93 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
