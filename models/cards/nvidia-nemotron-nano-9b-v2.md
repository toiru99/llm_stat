...
is_reasoning: true
radar:
  knowledge: { s: 24.3, z: -0.78, r: 38.4, estimated: false }  # 전문 지식
  reasoning: { s: 21.2, z: -0.65, r: 40.3, estimated: false }  # 추론
  coding: { s: 25.5, z: -0.87, r: 36.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.05/1M · 67.0 t/s · TTFT 5.92s · 131k ctx` · 가성비 180.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.4 | -0.78 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.3 | -0.65 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 36.9 | -0.87 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
