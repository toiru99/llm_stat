...
radar:
  ...
  coding: { s: 25.5, z: -0.93, r: 36.0, estimated: false }  # 코딩
  agentic: { s: 12.6, z: -0.94, r: 35.8, estimated: false }  # 에이전트
  trust: { s: 44.2, z: 0.76, r: 61.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.052/1M · 178.0 t/s · TTFT 3.44s · 131k ctx` · 가성비 173.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.1 | -0.8 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 신뢰성 | 61.4 | +0.76 | 실측 | [[aa-omniscience]] 40.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
