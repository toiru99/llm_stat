...
radar:
  ...
  coding: { s: 25.5, z: -0.88, r: 36.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.05/1M · 77.0 t/s · TTFT 9.07s · 131k ctx` · 가성비 180.0
...
| 코딩 | 36.8 | -0.88 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
