...
radar:
  ...
  reasoning: { s: 20.9, z: -0.72, r: 39.1, estimated: false }  # 추론
  coding: { s: 25.5, z: -0.95, r: 35.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.052/1M · 214.0 t/s · TTFT 3.23s · 131k ctx` · 가성비 173.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 37.9 | -0.81 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 39.1 | -0.72 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 35.7 | -0.95 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
