...
radar:
  ...
  coding: { s: 25.5, z: -0.91, r: 36.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.16 · 혼합 $0.052/1M · 131.0 t/s · TTFT 5.56s · 131k ctx` · 가성비 173.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.3 | -0.78 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 39.7 | -0.68 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 57.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 36.3 | -0.91 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
