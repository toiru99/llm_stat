...
radar:
  ...
  agentic: { s: 43.6, z: 0.27, r: 54.1, estimated: false }  # 에이전트
  trust: { s: 80.2, z: 2.36, r: 85.4, estimated: false }  # 신뢰성
...
| 에이전트 | 54.1 | +0.27 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[tau3-banking]] 17.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
| 신뢰성 | 85.4 | +2.36 | 실측 | [[aa-omniscience]] 71.0%×1.0 |
