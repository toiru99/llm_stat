...
radar:
  ...
  agentic: { s: 45.4, z: 0.35, r: 55.3, estimated: false }  # 에이전트
...
| 코딩 | 58.2 | +0.55 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
| 에이전트 | 55.3 | +0.35 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
