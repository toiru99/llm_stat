...
radar:
  ...
  agentic: { s: 43.6, z: 0.31, r: 54.7, estimated: false }  # 에이전트
  trust: { s: 80.2, z: 2.47, r: 87.1, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 51.3 | +0.09 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 48.8 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 58.0 | +0.53 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
| 에이전트 | 54.7 | +0.31 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[tau3-banking]] 17.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
| 신뢰성 | 87.1 | +2.47 | 실측 | [[aa-omniscience]] 71.0%×1.0 |
