...
is_reasoning: false
radar:
  knowledge: { s: 42.7, z: 0.06, r: 50.9, estimated: false }  # 전문 지식
  reasoning: { s: 32.8, z: -0.1, r: 48.5, estimated: false }  # 추론
  coding: { s: 60.1, z: 0.53, r: 57.9, estimated: false }  # 코딩
  agentic: { s: 43.5, z: 0.31, r: 54.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 50.9 | +0.06 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 48.5 | -0.1 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 57.9 | +0.53 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
| 에이전트 | 54.6 | +0.31 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
