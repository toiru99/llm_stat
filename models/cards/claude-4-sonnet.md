...
radar:
  ...
  reasoning: { s: 32.4, z: -0.1, r: 48.5, estimated: false }  # 추론
  coding: { s: 58.7, z: 0.51, r: 57.6, estimated: false }  # 코딩
  agentic: { s: 43.5, z: 0.25, r: 53.7, estimated: false }  # 에이전트
  trust: { s: 71.1, z: 2.23, r: 83.5, estimated: false }  # 신뢰성
...
| 추론 | 48.5 | -0.1 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
...
| 신뢰성 | 83.5 | +2.23 | 실측 | [[aa-omniscience]] 71.0%×1.0 |
