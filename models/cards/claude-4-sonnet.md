...
is_reasoning: false
radar:
  knowledge: { s: 42.7, z: 0.1, r: 51.4, estimated: false }  # 전문 지식
  reasoning: { s: 32.8, z: -0.05, r: 49.2, estimated: false }  # 추론
  coding: { s: 60.1, z: 0.57, r: 58.6, estimated: false }  # 코딩
  agentic: { s: 46.0, z: 0.37, r: 55.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 51.4 | +0.1 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
