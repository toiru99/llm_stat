...
radar:
  ...
  reasoning: { s: 38.1, z: 0.12, r: 51.8, estimated: false }  # 추론
  coding: { s: 52.5, z: 0.16, r: 52.4, estimated: false }  # 코딩
...
| 추론 | 51.8 | +0.12 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 52.4 | +0.16 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
