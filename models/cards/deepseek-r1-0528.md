...
radar:
  ...
  reasoning: { s: 38.2, z: 0.26, r: 53.9, estimated: false }  # 추론
  coding: { s: 52.5, z: 0.28, r: 54.3, estimated: false }  # 코딩
...
| 추론 | 53.9 | +0.26 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 54.3 | +0.28 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
