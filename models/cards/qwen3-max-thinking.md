...
is_reasoning: true
radar:
  knowledge: { s: 56.5, z: 0.73, r: 60.9, estimated: false }  # 전문 지식
  reasoning: { s: 48.6, z: 0.65, r: 59.7, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 60.9 | +0.73 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
