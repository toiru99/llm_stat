...
is_reasoning: true
radar:
  knowledge: { s: 58.2, z: 0.79, r: 61.9, estimated: false }  # 전문 지식
  reasoning: { s: 48.3, z: 0.68, r: 60.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 61.9 | +0.79 | 실측 | [[aa-omniscience]] 30.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 60.1 | +0.68 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 57.8 | +0.52 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 64.9 | +0.99 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
