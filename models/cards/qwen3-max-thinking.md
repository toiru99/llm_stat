...
radar:
  ...
  reasoning: { s: 48.6, z: 0.61, r: 59.2, estimated: false }  # 추론
  coding: { s: 59.9, z: 0.45, r: 56.8, estimated: false }  # 코딩
  agentic: { s: 60.6, z: 0.89, r: 63.4, estimated: false }  # 에이전트
...
| 추론 | 59.2 | +0.61 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 56.8 | +0.45 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 63.4 | +0.89 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
