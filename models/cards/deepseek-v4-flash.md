...
radar:
  ...
  reasoning: { s: 28.6, z: -0.34, r: 44.9, estimated: false }  # 추론
  coding: { s: 58.3, z: 0.4, r: 55.9, estimated: false }  # 코딩
...
| 추론 | 44.9 | -0.34 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 55.9 | +0.4 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 70.9 | +1.39 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
