...
radar:
  ...
  reasoning: { s: 28.4, z: -0.31, r: 45.3, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.058/1M · 121.0 t/s · TTFT 1.34s · 1M ctx` · 가성비 500.0
...
| 추론 | 45.3 | -0.31 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 56.8 | +0.45 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 34.0%×0.5 |
| 에이전트 | 72.5 | +1.5 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
