...
radar:
  ...
  agentic: { s: 74.5, z: 0.87, r: 63.1, estimated: false }  # 에이전트
  trust: { s: 2.5, z: -1.13, r: 33.0, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 44.6, z: -0.95, r: 35.8, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.06/1M · 106.0 t/s · TTFT 1.29s · 1M ctx` · 가성비 483.3
...
| 에이전트 | 63.1 | +0.87 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
| 신뢰성 | 33.0 | -1.13 | 실측 | [[aa-omniscience]] 5.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 35.8 | -0.95 | 실측 | [[aa-lcr]] 33.0%×1.0 |
