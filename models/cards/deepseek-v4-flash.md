...
radar:
  ...
  agentic: { s: 74.5, z: 0.9, r: 63.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.06/1M · 111.0 t/s · TTFT 1.43s · 1M ctx` · 가성비 483.3
...
| 에이전트 | 63.4 | +0.9 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 34.0%×1.0 |
