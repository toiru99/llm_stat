...
radar:
  ...
  coding: { s: 26.5, z: -0.86, r: 37.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $None/1M · 112.0 t/s · TTFT 2.34s · 256k ctx`
...
| 코딩 | 37.2 | -0.86 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
