...
is_reasoning: true
radar:
  knowledge: { s: 32.8, z: -0.4, r: 44.1, estimated: false }  # 전문 지식
  reasoning: { s: 20.3, z: -0.7, r: 39.4, estimated: false }  # 추론
  coding: { s: 26.5, z: -0.85, r: 37.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 44.1 | -0.4 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 39.4 | -0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 37.2 | -0.85 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
