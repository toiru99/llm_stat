...
is_reasoning: true
radar:
  knowledge: { s: 31.9, z: -0.42, r: 43.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.372/1M · 113.0 t/s · TTFT 2.4s · 256k ctx` · 가성비 26.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.6 | -0.42 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
