...
radar:
  ...
  multimodal: { s: 45.1, z: -1.25, r: 31.2, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.18 · 출력 $0.7 · 혼합 $0.232/1M · 113.0 t/s · TTFT 2.22s · 256k ctx` · 가성비 34.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.2 | -0.66 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
...
| 멀티모달 | 31.2 | -1.25 | 실측 | [[mmmu-pro]] 47.0%×1.0 |
