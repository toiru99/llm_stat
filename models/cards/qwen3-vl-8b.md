...
radar:
  ...
  reasoning: { s: 20.3, z: -0.7, r: 39.6, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.37/1M · 112.0 t/s · TTFT 2.34s · 256k ctx` · 가성비 29.7
...
| 추론 | 39.6 | -0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 37.5 | -0.83 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 37.5 | -0.84 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
