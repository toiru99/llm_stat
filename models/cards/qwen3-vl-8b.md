...
is_reasoning: true
radar:
  knowledge: { s: 31.7, z: -0.45, r: 43.2, estimated: false }  # 전문 지식
  reasoning: { s: 20.7, z: -0.72, r: 39.2, estimated: false }  # 추론
  coding: { s: 26.5, z: -0.9, r: 36.6, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 43.2 | -0.45 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 39.2 | -0.72 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 36.6 | -0.9 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
