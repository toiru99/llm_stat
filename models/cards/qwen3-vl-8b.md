...
radar:
  ...
  coding: { s: 26.5, z: -0.89, r: 36.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.372/1M · 109.0 t/s · TTFT 2.35s · 256k ctx` · 가성비 26.9
...
| 에이전트 | 37.0 | -0.86 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
