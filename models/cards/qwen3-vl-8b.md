...
is_reasoning: true
radar:
  knowledge: { s: 32.8, z: -0.36, r: 44.5, estimated: false }  # 전문 지식
  reasoning: { s: 20.3, z: -0.69, r: 39.6, estimated: false }  # 추론
  coding: { s: 26.5, z: -0.82, r: 37.6, estimated: false }  # 코딩
  agentic: { s: 14.6, z: -0.83, r: 37.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.37/1M · 113.0 t/s · TTFT 2.43s · 256k ctx` · 가성비 29.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.5 | -0.36 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 39.6 | -0.69 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 37.6 | -0.82 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 37.5 | -0.83 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
