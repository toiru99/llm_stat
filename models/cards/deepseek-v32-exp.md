...
is_reasoning: true
radar:
  knowledge: { s: 50.5, z: 0.48, r: 57.3, estimated: false }  # 전문 지식
  reasoning: { s: 37.2, z: 0.19, r: 52.9, estimated: false }  # 추론
  coding: { s: 57.9, z: 0.5, r: 57.4, estimated: false }  # 코딩
  agentic: { s: 40.7, z: 0.18, r: 52.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 57.3 | +0.48 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 52.9 | +0.19 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 57.4 | +0.5 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 31.0%×0.5 |
| 에이전트 | 52.6 | +0.18 | 실측 | [[tau2-bench]] 34.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
