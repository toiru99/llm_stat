...
radar:
  ...
  coding: { s: 43.0, z: -0.23, r: 46.6, estimated: false }  # 코딩
  agentic: { s: 8.4, z: -1.12, r: 33.3, estimated: false }  # 에이전트
...
| 코딩 | 46.6 | -0.23 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
| 에이전트 | 33.3 | -1.12 | 실측 | [[gdpval]] 1.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
