...
is_reasoning: true
radar:
  knowledge: { s: 47.6, z: 0.34, r: 55.1, estimated: false }  # 전문 지식
  reasoning: { s: 29.9, z: -0.23, r: 46.5, estimated: false }  # 추론
  coding: { s: 43.0, z: -0.19, r: 47.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 55.1 | +0.34 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 46.5 | -0.23 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 47.2 | -0.19 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
