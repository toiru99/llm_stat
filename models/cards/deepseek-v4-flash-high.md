...
radar:
  ...
  reasoning: { s: 51.1, z: 0.28, r: 54.2, estimated: false }  # 추론
  coding: { s: 67.3, z: 0.31, r: 54.7, estimated: false }  # 코딩
...
| 추론 | 54.2 | +0.28 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 54.7 | +0.31 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
