...
radar:
  knowledge: { s: 65.0, z: 0.39, r: 55.8, estimated: false }  # 전문 지식
  reasoning: { s: 51.0, z: 0.09, r: 51.4, estimated: false }  # 추론
  coding: { s: 66.4, z: 0.1, r: 51.5, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 55.8 | +0.39 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 51.4 | +0.09 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 51.5 | +0.1 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
