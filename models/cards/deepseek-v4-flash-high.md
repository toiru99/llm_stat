...
radar:
  knowledge: { s: 65.0, z: 0.59, r: 58.8, estimated: false }  # 전문 지식
  reasoning: { s: 51.1, z: 0.27, r: 54.1, estimated: false }  # 추론
  coding: { s: 67.3, z: 0.29, r: 54.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 58.8 | +0.59 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 54.1 | +0.27 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 54.4 | +0.29 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
