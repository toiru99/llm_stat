...
radar:
  knowledge: { s: 65.0, z: 0.62, r: 59.3, estimated: false }  # 전문 지식
  reasoning: { s: 51.1, z: 0.31, r: 54.6, estimated: false }  # 추론
  coding: { s: 67.3, z: 0.35, r: 55.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 59.3 | +0.62 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 54.6 | +0.31 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 55.2 | +0.35 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
