...
radar:
  ...
  reasoning: { s: 51.0, z: 0.83, r: 62.5, estimated: false }  # 추론
  coding: { s: 66.4, z: 0.81, r: 62.1, estimated: false }  # 코딩
  agentic: { s: 65.5, z: 1.13, r: 67.0, estimated: false }  # 에이전트
...
| 추론 | 62.5 | +0.83 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 62.1 | +0.81 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 67.0 | +1.13 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 20.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
