...
is_reasoning: true
radar:
  knowledge: { s: 60.9, z: 1.02, r: 65.4, estimated: false }  # 전문 지식
  reasoning: { s: 50.0, z: 0.78, r: 61.7, estimated: false }  # 추론
  coding: { s: 64.9, z: 0.77, r: 61.5, estimated: false }  # 코딩
  agentic: { s: 63.9, z: 1.04, r: 65.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 65.4 | +1.02 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 30.0%×0.3 |
| 추론 | 61.7 | +0.78 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
| 코딩 | 61.5 | +0.77 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
