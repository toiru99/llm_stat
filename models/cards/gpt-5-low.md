...
is_reasoning: true
radar:
  knowledge: { s: 61.0, z: 0.92, r: 63.8, estimated: false }  # 전문 지식
  reasoning: { s: 40.1, z: 0.27, r: 54.0, estimated: false }  # 추론
  coding: { s: 57.0, z: 0.4, r: 56.0, estimated: false }  # 코딩
  agentic: { s: 62.9, z: 1.08, r: 66.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 75.0 t/s · TTFT 10.99s · 400k ctx` · 가성비 23.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.8 | +0.92 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.0 | +0.27 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 56.0 | +0.4 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 66.3 | +1.08 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
