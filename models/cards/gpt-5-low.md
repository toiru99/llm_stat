...
radar:
  ...
  agentic: { s: 62.9, z: 1.07, r: 66.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 73.0 t/s · TTFT 6.71s · 400k ctx` · 가성비 23.9
...
| 에이전트 | 66.1 | +1.07 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
