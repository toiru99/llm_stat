...
is_reasoning: true
radar:
  knowledge: { s: 61.0, z: 0.93, r: 63.9, estimated: false }  # 전문 지식
  reasoning: { s: 40.1, z: 0.28, r: 54.2, estimated: false }  # 추론
  coding: { s: 57.0, z: 0.41, r: 56.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 82.0 t/s · TTFT 9.71s · 400k ctx` · 가성비 23.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 63.9 | +0.93 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.2 | +0.28 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 56.2 | +0.41 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
