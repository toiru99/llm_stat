...
radar:
  ...
  agentic: { s: 62.9, z: 1.04, r: 65.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 82.0 t/s · TTFT 7.07s · 400k ctx` · 가성비 23.1
...
| 에이전트 | 65.7 | +1.04 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
