...
radar:
  ...
  coding: { s: 57.0, z: 0.34, r: 55.1, estimated: false }  # 코딩
  agentic: { s: 62.9, z: 0.99, r: 64.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 94.0 t/s · TTFT 6.26s · 400k ctx` · 가성비 23.9
...
| 추론 | 53.6 | +0.24 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 55.1 | +0.34 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 64.9 | +0.99 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
