...
radar:
  ...
  agentic: { s: 62.9, z: 0.97, r: 64.6, estimated: false }  # 에이전트
  trust: { s: 19.6, z: -0.23, r: 46.5, estimated: false }  # 신뢰성
  multimodal: { s: 81.9, z: 0.58, r: 58.7, estimated: false }  # 멀티모달
  long_context: { s: 75.4, z: 0.81, r: 62.1, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 75.0 t/s · TTFT 9.33s · 400k ctx` · 가성비 17.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.8 | +0.85 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 53.2 | +0.21 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 54.6 | +0.3 | 실측 | [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 64.6 | +0.97 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 46.5 | -0.23 | 실측 | [[aa-omniscience]] 21.0%×1.0 |
