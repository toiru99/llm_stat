...
is_reasoning: true
radar:
  knowledge: { s: 94.1, z: 2.48, r: 87.3, estimated: false }  # 전문 지식
  reasoning: { s: 91.3, z: 2.86, r: 92.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 69.0 t/s · TTFT 49.15s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.3 | +2.48 | 실측 | [[aa-omniscience]] 58.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 92.8 | +2.86 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
