...
is_reasoning: true
radar:
  knowledge: { s: 88.8, z: 2.41, r: 86.2, estimated: false }  # 전문 지식
  reasoning: { s: 89.2, z: 2.74, r: 91.2, estimated: false }  # 추론
  coding: { s: 91.0, z: 1.88, r: 78.2, estimated: false }  # 코딩
  agentic: { s: 84.9, z: 1.86, r: 77.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 77.0 t/s · TTFT 35.39s · 1M ctx` · 가성비 19.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 86.2 | +2.41 | 실측 | [[aa-omniscience]] 59.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 47.0%×0.3 |
| 추론 | 91.2 | +2.74 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 47.0%×1.0 |
