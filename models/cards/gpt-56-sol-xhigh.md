...
radar:
  ...
  reasoning: { s: 91.2, z: 2.73, r: 91.0, estimated: false }  # 추론
  coding: { s: 93.0, z: 1.84, r: 77.5, estimated: false }  # 코딩
  agentic: { s: 85.2, z: 1.91, r: 78.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 70.0 t/s · TTFT 41.24s · 1M ctx` · 가성비 13.6
...
| 추론 | 91.0 | +2.73 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 47.0%×1.0 |
| 코딩 | 77.5 | +1.84 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
| 에이전트 | 78.7 | +1.91 | 실측 | [[gdpval]] 59.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 38.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
