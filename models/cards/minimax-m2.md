...
is_reasoning: true
radar:
  knowledge: { s: 43.4, z: 0.14, r: 52.2, estimated: false }  # 전문 지식
  reasoning: { s: 35.1, z: 0.08, r: 51.3, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 90.0 t/s · TTFT 1.88s · 205k ctx` · 가성비 71.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.2 | +0.14 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 51.3 | +0.08 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
