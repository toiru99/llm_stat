...
radar:
  ...
  coding: { s: 53.1, z: 0.2, r: 53.0, estimated: false }  # 코딩
  agentic: { s: 63.6, z: 1.06, r: 66.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 101.0 t/s · TTFT 1.67s · 205k ctx` · 가성비 74.4
...
| 에이전트 | 66.0 | +1.06 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 26.0%×1.0 |
