...
is_reasoning: true
radar:
  knowledge: { s: 43.3, z: 0.09, r: 51.3, estimated: false }  # 전문 지식
  reasoning: { s: 35.7, z: -0.0, r: 49.9, estimated: false }  # 추론
  coding: { s: 53.1, z: 0.18, r: 52.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.39/1M · 98.0 t/s · TTFT 1.77s · 205k ctx` · 가성비 74.4
...
| 코딩 | 52.7 | +0.18 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 26.0%×0.5 |
| 에이전트 | 65.2 | +1.02 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 26.0%×1.0 |
