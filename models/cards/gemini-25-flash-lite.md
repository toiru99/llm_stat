...
radar:
  ...
  coding: { s: 23.6, z: -1.01, r: 34.8, estimated: false }  # 코딩
  agentic: { s: 12.9, z: -0.94, r: 36.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.067/1M · 312.0 t/s · TTFT 24.64s · 1M ctx` · 가성비 164.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.6 | -0.43 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
...
| 에이전트 | 36.0 | -0.94 | 실측 | [[tau2-bench]] 18.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
