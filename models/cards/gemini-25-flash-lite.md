...
is_reasoning: true
radar:
  knowledge: { s: 33.2, z: -0.37, r: 44.4, estimated: false }  # 전문 지식
  reasoning: { s: 24.2, z: -0.51, r: 42.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $None/1M · 296.0 t/s · TTFT 25.89s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.4 | -0.37 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 42.4 | -0.51 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
