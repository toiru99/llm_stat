...
radar:
  ...
  agentic: { s: 12.9, z: -0.92, r: 36.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.067/1M · 321.0 t/s · TTFT 22.85s · 1M ctx` · 가성비 164.2
...
| 코딩 | 35.2 | -0.99 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 36.2 | -0.92 | 실측 | [[tau2-bench]] 18.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
