...
radar:
  ...
  reasoning: { s: 24.2, z: -0.5, r: 42.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $None/1M · 281.0 t/s · TTFT 28.68s · 1M ctx`
...
| 추론 | 42.5 | -0.5 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
