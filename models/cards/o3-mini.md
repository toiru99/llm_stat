...
radar:
  ...
  trust: { s: 8.2, z: -0.77, r: 38.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 56.9, z: 0.24, r: 53.6, estimated: true }  # 긴문맥
  instruction: { s: 47.9, z: -0.2, r: 47.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $1.045/1M · 217.0 t/s · TTFT 5.88s · 200k ctx` · 가성비 12.4
