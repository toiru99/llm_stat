...
is_reasoning: true
radar:
  knowledge: { s: 78.7, z: 1.87, r: 78.0, estimated: false }  # 전문 지식
  reasoning: { s: 68.4, z: 1.86, r: 77.9, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.49, r: 72.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 40.0 t/s · TTFT 14.24s · 1M ctx` · 가성비 11.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 78.0 | +1.87 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 77.9 | +1.86 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
