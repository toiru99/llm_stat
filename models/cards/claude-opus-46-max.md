...
radar:
  ...
  coding: { s: 81.0, z: 1.46, r: 72.0, estimated: false }  # 코딩
  agentic: { s: 77.4, z: 1.6, r: 73.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 39.0 t/s · TTFT 12.93s · 1M ctx` · 가성비 11.4
...
| 코딩 | 72.0 | +1.46 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 73.9 | +1.6 | 실측 | [[apex-agents]] 33.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
