...
radar:
  ...
  reasoning: { s: 69.0, z: 1.64, r: 74.6, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.34, r: 70.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 39.0 t/s · TTFT 9.55s · 1M ctx` · 가성비 11.7
...
| 추론 | 74.6 | +1.64 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 70.0 | +1.34 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
