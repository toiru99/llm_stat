...
radar:
  ...
  reasoning: { s: 69.4, z: 1.71, r: 75.7, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.4, r: 70.9, estimated: false }  # 코딩
  agentic: { s: 77.4, z: 1.65, r: 74.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 40.0 t/s · TTFT 15.68s · 1M ctx` · 가성비 11.7
...
| 추론 | 75.7 | +1.71 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 70.9 | +1.4 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 74.7 | +1.65 | 실측 | [[apex-agents]] 33.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
