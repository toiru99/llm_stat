...
radar:
  ...
  reasoning: { s: 68.4, z: 1.85, r: 77.7, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.48, r: 72.3, estimated: false }  # 코딩
  agentic: { s: 77.4, z: 1.6, r: 74.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 43.0 t/s · TTFT 24.98s · 1M ctx` · 가성비 11.4
...
| 추론 | 77.7 | +1.85 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 72.3 | +1.48 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 74.1 | +1.6 | 실측 | [[apex-agents]] 33.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
