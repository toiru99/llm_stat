...
radar:
  ...
  reasoning: { s: 68.4, z: 1.7, r: 75.5, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.41, r: 71.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 42.0 t/s · TTFT 19.58s · 1M ctx`
...
| 추론 | 75.5 | +1.7 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 71.2 | +1.41 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
