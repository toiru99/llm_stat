...
radar:
  ...
  reasoning: { s: 69.0, z: 1.61, r: 74.1, estimated: false }  # 추론
  coding: { s: 81.0, z: 1.31, r: 69.7, estimated: false }  # 코딩
  agentic: { s: 77.4, z: 1.54, r: 73.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 45.0 t/s · TTFT 14.56s · 1M ctx` · 가성비 11.7
...
| 코딩 | 69.7 | +1.31 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 73.0 | +1.54 | 실측 | [[apex-agents]] 33.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
