...
radar:
  ...
  reasoning: { s: 33.1, z: -0.07, r: 49.0, estimated: false }  # 추론
  coding: { s: 43.3, z: -0.14, r: 47.9, estimated: false }  # 코딩
...
| 추론 | 49.0 | -0.07 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 47.9 | -0.14 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
