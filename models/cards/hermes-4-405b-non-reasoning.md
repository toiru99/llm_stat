...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 43.0 t/s · TTFT 2.38s · 128k ctx` · 가성비 2.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.3 | -0.25 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 54.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
