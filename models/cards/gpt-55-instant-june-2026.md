...
radar:
  ...
  instruction: { s: 69.1, z: 0.71, r: 60.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 148.0 t/s · TTFT 1.19s · 400k ctx` · 가성비 6.7
...
| 추론 | 54.2 | +0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
