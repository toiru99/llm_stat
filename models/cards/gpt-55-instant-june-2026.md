...
radar:
  ...
  instruction: { s: 72.4, z: 0.77, r: 61.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 149.0 t/s · TTFT 1.35s · 400k ctx` · 가성비 6.7
...
| 추론 | 54.0 | +0.27 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 71.3 | +1.42 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 40.5 | -0.64 | 실측 | [[gdpval]] 11.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
