...
radar:
  ...
  coding: { s: 30.1, z: -0.07, r: 49.0, estimated: true }  # 코딩
  ...
  instruction: { s: 59.5, z: 0.29, r: 54.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 133.0 t/s · TTFT 1.04s · 400k ctx` · 가성비 5.1
...
| 코딩 | 49.0 | -0.07 | 추정 | (추정) |
| 에이전트 | 38.7 | -0.75 | 실측 | [[gdpval]] 8.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
