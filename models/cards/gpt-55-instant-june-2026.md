...
radar:
  ...
  reasoning: { s: 40.0, z: 0.23, r: 53.4, estimated: false }  # 추론
  ...
  instruction: { s: 68.7, z: 0.59, r: 58.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 159.0 t/s · TTFT 1.08s · 400k ctx` · 가성비 6.7
...
| 추론 | 53.4 | +0.23 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 70.6 | +1.37 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 40.2 | -0.65 | 실측 | [[gdpval]] 11.0%×1.0, [[tau3-banking]] 12.0%×1.0 |
