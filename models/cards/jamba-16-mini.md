...
radar:
  ...
  coding: { s: 16.7, z: -1.26, r: 31.2, estimated: false }  # 코딩
  agentic: { s: 8.0, z: -1.1, r: 33.6, estimated: true }  # 에이전트
  trust: { s: 29.9, z: 0.11, r: 51.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 4.1, z: -1.33, r: 30.0, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $0.4 · 혼합 $None/1M · 185.0 t/s · TTFT 0.82s · 256k ctx`
...
| 코딩 | 31.2 | -1.26 | 실측 | [[scicode]] 10.0%×1.0 |
| 에이전트 | 33.6 | -1.1 | 추정 | (추정) |
| 신뢰성 | 51.6 | +0.11 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 30.0 | -1.33 | 추정 | (추정) |
