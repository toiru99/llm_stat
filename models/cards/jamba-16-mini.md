...
radar:
  ...
  long_context: { s: 8.3, z: -1.2, r: 32.0, estimated: true }  # 긴문맥
  instruction: { s: 22.4, z: -1.25, r: 31.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $0.4 · 혼합 $None/1M · 181.0 t/s · TTFT 0.76s · 256k ctx`
