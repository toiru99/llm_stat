...
radar:
  ...
  trust: { s: 25.8, z: -0.07, r: 49.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 14.6, z: -1.08, r: 33.7, estimated: true }  # 긴문맥
  instruction: { s: 23.5, z: -1.26, r: 31.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
