...
radar:
  ...
  coding: { s: 16.7, z: -1.27, r: 31.0, estimated: false }  # 코딩
  agentic: { s: 9.2, z: -1.06, r: 34.1, estimated: true }  # 에이전트
  trust: { s: 29.0, z: 0.03, r: 50.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 3.8, z: -1.36, r: 29.7, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $0.4 · 혼합 $0.22/1M · 179.0 t/s · TTFT 0.83s · 256k ctx` · 가성비 13.6
...
| 추론 | 35.8 | -0.94 | 실측 | [[gpqa-diamond]] 30.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 31.0 | -1.27 | 실측 | [[scicode]] 10.0%×1.0 |
