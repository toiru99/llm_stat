...
radar:
  ...
  reasoning: { s: 37.4, z: 0.08, r: 51.2, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.59, r: 58.9, estimated: false }  # 코딩
  agentic: { s: 83.4, z: 1.78, r: 76.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 53.0 t/s · TTFT 3.49s · 256k ctx` · 가성비 101.1
...
| 추론 | 51.2 | +0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 58.9 | +0.59 | 실측 | [[scicode]] 38.0%×1.0 |
| 에이전트 | 76.6 | +1.78 | 실측 | [[gdpval]] 50.0%×1.0, [[tau3-banking]] 47.0%×1.0 |
