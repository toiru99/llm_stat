...
radar:
  ...
  coding: { s: 51.0, z: 0.67, r: 60.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 51.0 t/s · TTFT 3.88s · 256k ctx` · 가성비 80.5
...
| 에이전트 | 75.8 | +1.72 | 실측 | [[gdpval]] 47.0%×1.0, [[tau3-banking]] 47.0%×1.0 |
