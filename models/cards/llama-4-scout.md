...
radar:
  ...
  agentic: { s: 6.0, z: -1.21, r: 31.8, estimated: false }  # 에이전트
  trust: { s: 19.6, z: -0.23, r: 46.6, estimated: false }  # 신뢰성
  multimodal: { s: 54.3, z: -0.82, r: 37.7, estimated: false }  # 멀티모달
  long_context: { s: 36.1, z: -0.42, r: 43.7, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.18 · 출력 $0.66 · 혼합 $0.228/1M · 124.0 t/s · TTFT 0.81s · 10M ctx` · 가성비 43.9
...
| 에이전트 | 31.8 | -1.21 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 15.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
| 신뢰성 | 46.6 | -0.23 | 실측 | [[aa-omniscience]] 21.0%×1.0 |
| 멀티모달 | 37.7 | -0.82 | 실측 | [[mmmu-pro]] 53.0%×1.0 |
| 긴문맥 | 43.7 | -0.42 | 실측 | [[aa-lcr]] 30.0%×1.0 |
