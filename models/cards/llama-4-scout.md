...
radar:
  ...
  agentic: { s: 6.8, z: -1.16, r: 32.7, estimated: false }  # 에이전트
  trust: { s: 24.1, z: -0.19, r: 47.1, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.18 · 출력 $0.66 · 혼합 $None/1M · 97.0 t/s · TTFT 0.82s · 10M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.0 | -0.6 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 32.7 | -1.16 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 15.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
