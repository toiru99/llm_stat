...
radar:
  ...
  reasoning: { s: 24.0, z: -0.55, r: 41.7, estimated: false }  # 추론
  coding: { s: 47.6, z: -0.03, r: 49.6, estimated: false }  # 코딩
  agentic: { s: 20.0, z: -0.65, r: 40.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 47.5 | -0.17 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.7 | -0.55 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 49.6 | -0.03 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 40.2 | -0.65 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 47.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
