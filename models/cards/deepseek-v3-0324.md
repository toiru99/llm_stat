...
radar:
  ...
  reasoning: { s: 24.3, z: -0.53, r: 42.1, estimated: false }  # 추론
  coding: { s: 47.6, z: 0.01, r: 50.1, estimated: false }  # 코딩
  agentic: { s: 20.0, z: -0.64, r: 40.5, estimated: false }  # 에이전트
...
| 코딩 | 50.1 | +0.01 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 40.5 | -0.64 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 47.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
