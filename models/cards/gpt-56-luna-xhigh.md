...
is_reasoning: true
radar:
  knowledge: { s: 73.2, z: 1.5, r: 72.6, estimated: false }  # 전문 지식
  reasoning: { s: 75.7, z: 2.08, r: 81.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $None/1M · 184.0 t/s · TTFT 35.78s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.6 | +1.5 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 81.1 | +2.08 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 72.7 | +1.51 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 71.3 | +1.42 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
