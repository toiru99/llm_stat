...
radar:
  ...
  reasoning: { s: 75.7, z: 2.04, r: 80.6, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.49, r: 72.4, estimated: false }  # 코딩
  agentic: { s: 66.1, z: 1.21, r: 68.2, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.3, z: 1.03, r: 65.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 168.0 t/s · TTFT 42.72s · 1M ctx` · 가성비 281.6
...
| 추론 | 80.6 | +2.04 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 68.2 | +1.21 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
