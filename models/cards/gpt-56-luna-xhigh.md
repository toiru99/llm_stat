...
radar:
  ...
  reasoning: { s: 75.7, z: 2.19, r: 82.9, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.55, r: 73.3, estimated: false }  # 코딩
  agentic: { s: 78.3, z: 1.63, r: 74.4, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.3, z: 1.06, r: 65.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $None/1M · 176.0 t/s · TTFT 48.45s · 1M ctx`
...
| 추론 | 82.9 | +2.19 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 73.3 | +1.55 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 74.4 | +1.63 | 실측 | [[gdpval]] 52.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
