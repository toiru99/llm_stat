...
radar:
  ...
  agentic: { s: 66.5, z: 1.22, r: 68.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 179.0 t/s · TTFT 36.09s · 1M ctx` · 가성비 287.4
...
| 추론 | 80.1 | +2.01 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 68.3 | +1.22 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
