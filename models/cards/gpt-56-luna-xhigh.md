...
radar:
  ...
  reasoning: { s: 73.5, z: 1.96, r: 79.4, estimated: false }  # 추론
  coding: { s: 80.6, z: 1.44, r: 71.6, estimated: false }  # 코딩
  agentic: { s: 65.9, z: 1.12, r: 66.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 81.1, z: 1.19, r: 67.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 120.0 t/s · TTFT 58.99s · 1M ctx` · 가성비 287.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.0 | +1.46 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 79.4 | +1.96 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
