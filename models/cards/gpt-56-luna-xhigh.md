...
radar:
  ...
  reasoning: { s: 75.1, z: 2.06, r: 80.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 125.0 t/s · TTFT 47.05s · 1M ctx` · 가성비 287.4
...
| 추론 | 80.8 | +2.06 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
