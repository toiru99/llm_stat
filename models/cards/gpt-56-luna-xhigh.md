...
radar:
  ...
  reasoning: { s: 75.1, z: 1.9, r: 78.5, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.41, r: 71.1, estimated: false }  # 코딩
  agentic: { s: 66.5, z: 1.12, r: 66.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 121.0 t/s · TTFT 50.99s · 1M ctx` · 가성비 287.4
...
| 추론 | 78.5 | +1.9 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 71.1 | +1.41 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 66.8 | +1.12 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
