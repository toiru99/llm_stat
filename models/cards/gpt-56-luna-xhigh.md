...
is_reasoning: true
radar:
  knowledge: { s: 73.2, z: 1.57, r: 73.6, estimated: false }  # 전문 지식
  reasoning: { s: 75.7, z: 2.2, r: 83.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $None/1M · 208.0 t/s · TTFT 31.49s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.6 | +1.57 | 실측 | [[aa-omniscience]] 41.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 83.0 | +2.2 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 73.4 | +1.56 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 74.0 | +1.6 | 실측 | [[gdpval]] 52.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
