...
radar:
  ...
  agentic: { s: 66.5, z: 1.16, r: 67.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 158.0 t/s · TTFT 46.12s · 1M ctx` · 가성비 287.4
...
| 추론 | 79.0 | +1.93 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 71.5 | +1.43 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 67.4 | +1.16 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
