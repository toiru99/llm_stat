...
radar:
  ...
  reasoning: { s: 75.1, z: 1.92, r: 78.8, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.42, r: 71.3, estimated: false }  # 코딩
  agentic: { s: 66.5, z: 1.13, r: 67.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 139.0 t/s · TTFT 52.74s · 1M ctx` · 가성비 287.4
...
| 에이전트 | 67.0 | +1.13 | 실측 | [[gdpval]] 51.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
