...
radar:
  ...
  coding: { s: 71.7, z: 1.01, r: 65.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 187.0 t/s · TTFT 0.99s · 1M ctx` · 가성비 64.4
...
| 코딩 | 65.1 | +1.01 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
