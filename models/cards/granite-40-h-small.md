...
is_reasoning: false
radar:
  knowledge: { s: 21.8, z: -0.93, r: 36.0, estimated: false }  # 전문 지식
  reasoning: { s: 14.4, z: -1.04, r: 34.4, estimated: false }  # 추론
  coding: { s: 24.3, z: -1.0, r: 35.0, estimated: false }  # 코딩
  agentic: { s: 10.1, z: -1.04, r: 34.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.25 · 혼합 $0.079/1M · 22.0 t/s · TTFT 23.18s · 128k ctx` · 가성비 63.3
...
| 추론 | 34.4 | -1.04 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 42.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 35.0 | -1.0 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 34.3 | -1.04 | 실측 | [[tau2-bench]] 17.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
