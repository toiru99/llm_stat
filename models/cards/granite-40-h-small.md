...
radar:
  ...
  reasoning: { s: 14.4, z: -1.03, r: 34.5, estimated: false }  # 추론
  coding: { s: 24.3, z: -0.99, r: 35.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.06 · 출력 $0.25 · 혼합 $0.079/1M · 12.0 t/s · TTFT 41.73s · 128k ctx` · 가성비 63.3
...
| 추론 | 34.5 | -1.03 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 42.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
