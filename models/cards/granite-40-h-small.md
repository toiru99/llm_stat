...
is_reasoning: false
radar:
  knowledge: { s: 21.8, z: -0.93, r: 36.1, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.06 · 출력 $0.25 · 혼합 $0.079/1M · 25.0 t/s · TTFT 18.74s · 128k ctx` · 가성비 63.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 36.1 | -0.93 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 42.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
