...
radar:
  knowledge: { s: 38.9, z: -0.55, r: 41.8, estimated: false }  # 전문 지식
  reasoning: { s: 37.3, z: -0.34, r: 44.9, estimated: false }  # 추론
  coding: { s: 38.0, z: -0.91, r: 36.4, estimated: false }  # 코딩
  agentic: { s: 52.2, z: 0.03, r: 50.4, estimated: false }  # 에이전트
  trust: { s: 5.0, z: -1.0, r: 35.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 188.0 t/s · TTFT 2.21s · 262k ctx` · 가성비 54.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.8 | -0.55 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
| 추론 | 44.9 | -0.34 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 36.4 | -0.91 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 50.4 | +0.03 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
| 신뢰성 | 35.0 | -1.0 | 실측 | [[aa-omniscience]] 8.0%×1.0 |
