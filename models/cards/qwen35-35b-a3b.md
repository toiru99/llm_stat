...
radar:
  ...
  coding: { s: 55.9, z: 0.41, r: 56.2, estimated: false }  # 코딩
  agentic: { s: 56.3, z: 0.79, r: 61.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 156.0 t/s · TTFT 2.21s · 262k ctx` · 가성비 69.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.1 | +0.27 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 57.5 | +0.5 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 56.2 | +0.41 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 61.8 | +0.79 | 실측 | [[itbench]] 22.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
