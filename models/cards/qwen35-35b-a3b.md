...
radar:
  ...
  agentic: { s: 52.2, z: 0.02, r: 50.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 193.0 t/s · TTFT 2.17s · 262k ctx` · 가성비 54.8
...
| 에이전트 | 50.3 | +0.02 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
