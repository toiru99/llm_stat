...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 170.0 t/s · TTFT 2.24s · 262k ctx` · 가성비 69.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.1 | +0.28 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
