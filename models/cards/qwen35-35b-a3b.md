...
is_reasoning: false
radar:
  knowledge: { s: 45.0, z: 0.2, r: 53.0, estimated: false }  # 전문 지식
  reasoning: { s: 43.1, z: 0.41, r: 56.1, estimated: false }  # 추론
  coding: { s: 55.9, z: 0.35, r: 55.3, estimated: false }  # 코딩
  agentic: { s: 56.3, z: 0.81, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.425/1M · 148.0 t/s · TTFT 2.14s · 262k ctx` · 가성비 70.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.0 | +0.2 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 56.1 | +0.41 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 55.3 | +0.35 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 62.2 | +0.81 | 실측 | [[itbench]] 22.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
