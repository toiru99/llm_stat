...
radar:
  ...
  coding: { s: 55.9, z: 0.4, r: 56.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 136.0 t/s · TTFT 2.19s · 262k ctx` · 가성비 69.0
...
| 코딩 | 56.1 | +0.4 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
