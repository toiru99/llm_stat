...
radar:
  ...
  coding: { s: 55.9, z: 0.3, r: 54.5, estimated: false }  # 코딩
  agentic: { s: 56.3, z: 0.74, r: 61.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.425/1M · 149.0 t/s · TTFT 2.09s · 262k ctx` · 가성비 70.6
...
| 코딩 | 54.5 | +0.3 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 61.1 | +0.74 | 실측 | [[itbench]] 22.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
