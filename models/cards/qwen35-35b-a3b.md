...
radar:
  ...
  coding: { s: 38.0, z: -1.0, r: 35.0, estimated: false }  # 코딩
  agentic: { s: 52.2, z: 0.05, r: 50.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 190.0 t/s · TTFT 2.32s · 262k ctx` · 가성비 54.8
...
| 코딩 | 35.0 | -1.0 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 50.7 | +0.05 | 실측 | [[tau2-bench]] 86.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
