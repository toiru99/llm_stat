...
radar:
  ...
  reasoning: { s: 30.7, z: -0.19, r: 47.2, estimated: false }  # 추론
  coding: { s: 55.6, z: 0.38, r: 55.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 50.0 | +0.0 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 47.2 | -0.19 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 55.7 | +0.38 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 49.4 | -0.04 | 실측 | [[tau2-bench]] 34.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
