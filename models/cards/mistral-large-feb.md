...
radar:
  ...
  coding: { s: 35.0, z: -0.48, r: 42.7, estimated: false }  # 코딩
  agentic: { s: 16.5, z: -0.77, r: 38.5, estimated: true }  # 에이전트
  trust: { s: 40.9, z: 0.63, r: 59.4, estimated: true }  # 신뢰성
...
| 코딩 | 42.7 | -0.48 | 실측 | [[scicode]] 21.0%×1.0 |
