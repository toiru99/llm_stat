...
is_reasoning: false
radar:
  knowledge: { s: 19.0, z: -1.06, r: 34.1, estimated: false }  # 전문 지식
  reasoning: { s: 17.3, z: -0.86, r: 37.1, estimated: false }  # 추론
  coding: { s: 33.9, z: -0.54, r: 41.8, estimated: false }  # 코딩
  agentic: { s: 16.8, z: -0.79, r: 38.1, estimated: true }  # 에이전트
  trust: { s: 9.3, z: -0.72, r: 39.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.9, z: -1.01, r: 34.9, estimated: true }  # 긴문맥
  instruction: { s: 35.6, z: -0.72, r: 39.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
