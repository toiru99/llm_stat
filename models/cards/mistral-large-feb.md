...
radar:
  ...
  agentic: { s: 17.8, z: -0.72, r: 39.1, estimated: true }  # 에이전트
  trust: { s: 36.5, z: 0.38, r: 55.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.1, z: -0.99, r: 35.1, estimated: true }  # 긴문맥
  instruction: { s: 29.9, z: -0.96, r: 35.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
