...
radar:
  ...
  coding: { s: 35.0, z: -0.48, r: 42.8, estimated: false }  # 코딩
  agentic: { s: 17.4, z: -0.73, r: 39.0, estimated: true }  # 에이전트
  trust: { s: 22.0, z: -0.27, r: 45.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 29.7, z: -0.58, r: 41.4, estimated: true }  # 긴문맥
  instruction: { s: 29.7, z: -0.96, r: 35.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 코딩 | 42.8 | -0.48 | 실측 | [[scicode]] 21.0%×1.0 |
