...
radar:
  ...
  coding: { s: 35.7, z: -0.48, r: 42.9, estimated: false }  # 코딩
  agentic: { s: 16.9, z: -0.8, r: 38.1, estimated: false }  # 에이전트
...
| 코딩 | 42.9 | -0.48 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 9.0%×0.5 |
| 에이전트 | 38.1 | -0.8 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 9.0%×1.0 |
