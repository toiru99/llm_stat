...
radar:
  ...
  coding: { s: 36.8, z: -0.39, r: 44.2, estimated: false }  # 코딩
  agentic: { s: 16.9, z: -0.74, r: 38.8, estimated: false }  # 에이전트
  trust: { s: 42.4, z: 0.7, r: 60.4, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 42.2 | -0.52 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 37.3 | -0.85 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 44.2 | -0.39 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 9.0%×0.5 |
| 에이전트 | 38.8 | -0.74 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 9.0%×1.0 |
| 신뢰성 | 60.4 | +0.7 | 실측 | [[aa-omniscience]] 37.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
