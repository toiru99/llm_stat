...
is_reasoning: false
radar:
  knowledge: { s: 29.6, z: -0.52, r: 42.1, estimated: false }  # 전문 지식
  reasoning: { s: 17.4, z: -0.85, r: 37.2, estimated: false }  # 추론
  coding: { s: 36.8, z: -0.39, r: 44.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 42.1 | -0.52 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 37.2 | -0.85 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 44.1 | -0.39 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 9.0%×0.5 |
