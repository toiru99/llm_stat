...
radar:
  ...
  coding: { s: 61.7, z: 1.04, r: 65.6, estimated: true }  # 코딩
  agentic: { s: 50.5, z: 0.5, r: 57.5, estimated: true }  # 에이전트
  trust: { s: 31.8, z: 0.35, r: 55.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 86.6, z: 1.15, r: 67.3, estimated: true }  # 긴문맥
  instruction: { s: 82.2, z: 1.24, r: 68.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
