...
radar:
  ...
  trust: { s: 54.4, z: 1.21, r: 68.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 88.8, z: 1.16, r: 67.4, estimated: true }  # 긴문맥
  instruction: { s: 83.3, z: 1.18, r: 67.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
