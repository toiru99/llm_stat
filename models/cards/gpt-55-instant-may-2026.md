...
radar:
  ...
  reasoning: { s: 45.8, z: 0.55, r: 58.2, estimated: false }  # 추론
  coding: { s: 76.8, z: 1.22, r: 68.3, estimated: false }  # 코딩
  agentic: { s: 56.6, z: 0.83, r: 62.4, estimated: false }  # 에이전트
...
| 추론 | 58.2 | +0.55 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 68.3 | +1.22 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 62.4 | +0.83 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
