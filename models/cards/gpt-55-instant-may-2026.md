...
is_reasoning: true
radar:
  knowledge: { s: 70.6, z: 1.39, r: 70.8, estimated: false }  # 전문 지식
  reasoning: { s: 45.1, z: 0.54, r: 58.1, estimated: false }  # 추론
  coding: { s: 76.8, z: 1.25, r: 68.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.39 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 58.1 | +0.54 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 68.7 | +1.25 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
