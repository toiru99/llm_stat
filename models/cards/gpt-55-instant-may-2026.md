...
radar:
  ...
  reasoning: { s: 45.1, z: 0.61, r: 59.1, estimated: false }  # 추론
  coding: { s: 76.8, z: 1.3, r: 69.4, estimated: false }  # 코딩
  agentic: { s: 56.6, z: 0.8, r: 61.9, estimated: false }  # 에이전트
...
| 추론 | 59.1 | +0.61 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 69.4 | +1.3 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.9 | +0.8 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
