...
is_reasoning: true
radar:
  knowledge: { s: 67.5, z: 1.36, r: 70.3, estimated: false }  # 전문 지식
  reasoning: { s: 44.6, z: 0.51, r: 57.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 70.3 | +1.36 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 22.0%×0.3 |
| 추론 | 57.6 | +0.51 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 68.0 | +1.2 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.4 | +0.76 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
