...
radar:
  ...
  reasoning: { s: 66.5, z: 1.62, r: 74.3, estimated: false }  # 추론
  ...
  instruction: { s: 80.4, z: 1.18, r: 67.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.47 · 혼합 $0.0882/1M · 73.0 t/s · TTFT 2.99s · 256k ctx` · 가성비 634.9
...
| 추론 | 74.3 | +1.62 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
