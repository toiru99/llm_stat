...
radar:
  ...
  reasoning: { s: 66.5, z: 1.61, r: 74.2, estimated: false }  # 추론
  ...
  instruction: { s: 80.2, z: 1.17, r: 67.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.47 · 혼합 $0.0882/1M · 76.0 t/s · TTFT 2.83s · 256k ctx` · 가성비 634.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.5 | +0.83 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 74.2 | +1.61 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 69.3 | +1.29 | 실측 | [[scicode]] 47.0%×1.0 |
| 에이전트 | 81.9 | +2.13 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 45.0%×1.0 |
