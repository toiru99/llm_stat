...
radar:
  ...
  coding: { s: 75.5, z: 1.53, r: 72.9, estimated: false }  # 코딩
  agentic: { s: 89.3, z: 1.98, r: 79.7, estimated: false }  # 에이전트
  ...
  instruction: { s: 81.9, z: 1.23, r: 68.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.47 · 혼합 $0.0882/1M · 66.0 t/s · TTFT 2.74s · 256k ctx` · 가성비 521.5
...
| 코딩 | 72.9 | +1.53 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 79.7 | +1.98 | 실측 | [[gdpval]] 58.0%×1.0, [[tau3-banking]] 45.0%×1.0 |
