...
radar:
  ...
  reasoning: { s: 64.9, z: 1.49, r: 72.3, estimated: false }  # 추론
  coding: { s: 75.8, z: 1.21, r: 68.1, estimated: false }  # 코딩
  agentic: { s: 88.9, z: 1.99, r: 79.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 81.7, z: 1.2, r: 68.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.47 · 혼합 $0.0882/1M · 86.0 t/s · TTFT 2.81s · 256k ctx` · 가성비 634.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.3 | +0.75 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 72.3 | +1.49 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 68.1 | +1.21 | 실측 | [[scicode]] 47.0%×1.0 |
| 에이전트 | 79.9 | +1.99 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 45.0%×1.0 |
