...
radar:
  ...
  reasoning: { s: 45.7, z: 0.48, r: 57.2, estimated: false }  # 추론
  coding: { s: 61.4, z: 0.52, r: 57.7, estimated: false }  # 코딩
  agentic: { s: 32.1, z: -0.2, r: 47.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 133.0 t/s · TTFT 22.82s · 1M ctx` · 가성비 19.4
...
| 추론 | 57.2 | +0.48 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 57.7 | +0.52 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 47.0 | -0.2 | 실측 | [[gdpval]] 9.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
