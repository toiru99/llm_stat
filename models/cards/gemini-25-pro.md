...
radar:
  ...
  agentic: { s: 30.5, z: -0.8, r: 38.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 134.0 t/s · TTFT 20.65s · 1M ctx` · 가성비 19.4
...
| 에이전트 | 38.0 | -0.8 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
