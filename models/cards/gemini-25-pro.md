...
is_reasoning: true
radar:
  knowledge: { s: 61.4, z: 1.02, r: 65.4, estimated: false }  # 전문 지식
  reasoning: { s: 44.8, z: 0.5, r: 57.4, estimated: false }  # 추론
  coding: { s: 59.9, z: 0.54, r: 58.1, estimated: false }  # 코딩
  agentic: { s: 32.0, z: -0.21, r: 46.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 122.0 t/s · TTFT 24.06s · 1M ctx` · 가성비 19.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.4 | +1.02 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.4 | +0.5 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 46.8 | -0.21 | 실측 | [[gdpval]] 9.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
