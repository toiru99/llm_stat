...
radar:
  knowledge: { s: 64.7, z: 0.58, r: 58.6, estimated: false }  # 전문 지식
  reasoning: { s: 45.4, z: -0.0, r: 50.0, estimated: false }  # 추론
  coding: { s: 62.1, z: 0.06, r: 50.9, estimated: false }  # 코딩
  agentic: { s: 30.5, z: -0.83, r: 37.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 52.1, z: -0.69, r: 39.6, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 134.0 t/s · TTFT 21.12s · 1M ctx` · 가성비 19.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 58.6 | +0.58 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
...
| 에이전트 | 37.5 | -0.83 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
| 신뢰성 | 37.6 | -0.82 | 실측 | [[aa-omniscience]] 13.0%×1.0 |
| 멀티모달 | 56.7 | +0.44 | 실측 | [[mmmu-pro]] 75.0%×1.0 |
| 긴문맥 | 59.7 | +0.65 | 실측 | [[aa-lcr]] 66.0%×1.0 |
| 지시 따르기 | 39.6 | -0.69 | 실측 | [[ifbench]] 49.0%×1.0 |
