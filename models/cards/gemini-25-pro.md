...
is_reasoning: true
radar:
  knowledge: { s: 64.8, z: 1.19, r: 67.8, estimated: false }  # 전문 지식
  reasoning: { s: 45.3, z: 0.63, r: 59.5, estimated: false }  # 추론
  coding: { s: 61.4, z: 0.66, r: 59.9, estimated: false }  # 코딩
  agentic: { s: 33.9, z: -0.08, r: 48.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 145.0 t/s · TTFT 19.49s · 1M ctx` · 가성비 19.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.8 | +1.19 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 59.5 | +0.63 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 59.9 | +0.66 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 48.7 | -0.08 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
