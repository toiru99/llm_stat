...
radar:
  ...
  agentic: { s: 30.5, z: -0.81, r: 37.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 131.0 t/s · TTFT 20.86s · 1M ctx` · 가성비 19.4
...
| 에이전트 | 37.9 | -0.81 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 54.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
