...
radar:
  ...
  coding: { s: 63.3, z: 1.08, r: 66.3, estimated: false }  # 코딩
  agentic: { s: 49.9, z: 0.48, r: 57.1, estimated: false }  # 에이전트
  trust: { s: 76.3, z: 2.44, r: 86.7, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 83.1, z: 1.05, r: 65.7, estimated: false }  # 긴문맥
  instruction: { s: 90.7, z: 1.58, r: 73.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 84.0 t/s · TTFT 1.96s · 512k ctx` · 가성비 148.6
...
| 코딩 | 66.3 | +1.08 | 실측 | [[scicode]] 45.0%×1.0 |
| 에이전트 | 57.1 | +0.48 | 실측 | [[gdpval]] 35.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
| 신뢰성 | 86.7 | +2.44 | 실측 | [[aa-omniscience]] 76.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 65.7 | +1.05 | 실측 | [[aa-lcr]] 74.0%×1.0 |
| 지시 따르기 | 73.8 | +1.58 | 추정 | (추정) |
