...
radar:
  ...
  reasoning: { s: 53.5, z: 0.88, r: 63.2, estimated: false }  # 추론
  coding: { s: 73.3, z: 1.02, r: 65.3, estimated: false }  # 코딩
  agentic: { s: 51.7, z: 0.58, r: 58.7, estimated: false }  # 에이전트
  trust: { s: 86.0, z: 2.58, r: 88.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 50.0 t/s · TTFT 2.53s · 512k ctx` · 가성비 189.2
...
| 추론 | 63.2 | +0.88 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
| 코딩 | 65.3 | +1.02 | 실측 | [[scicode]] 44.0%×1.0 |
| 에이전트 | 58.7 | +0.58 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
| 신뢰성 | 88.7 | +2.58 | 실측 | [[aa-omniscience]] 76.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
