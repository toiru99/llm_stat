...
radar:
  ...
  agentic: { s: 51.7, z: 0.59, r: 58.9, estimated: false }  # 에이전트
  trust: { s: 86.0, z: 2.61, r: 89.1, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 85.5, z: 1.06, r: 65.9, estimated: false }  # 긴문맥
  instruction: { s: 90.7, z: 1.48, r: 72.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 58.0 t/s · TTFT 2.33s · 512k ctx` · 가성비 189.2
...
| 에이전트 | 58.9 | +0.59 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
| 신뢰성 | 89.1 | +2.61 | 실측 | [[aa-omniscience]] 76.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 65.9 | +1.06 | 실측 | [[aa-lcr]] 71.0%×1.0 |
| 지시 따르기 | 72.3 | +1.48 | 추정 | (추정) |
