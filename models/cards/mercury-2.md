...
is_reasoning: true
radar:
  knowledge: { s: 42.2, z: 0.03, r: 50.5, estimated: false }  # 전문 지식
  reasoning: { s: 37.2, z: 0.06, r: 51.0, estimated: false }  # 추론
  coding: { s: 57.0, z: 0.33, r: 55.0, estimated: false }  # 코딩
  agentic: { s: 36.3, z: -0.04, r: 49.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $0.75 · 혼합 $0.1425/1M · 1.0 t/s · TTFT 3.7s · 128k ctx` · 가성비 154.4
...
| 추론 | 51.0 | +0.06 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 55.0 | +0.33 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 49.4 | -0.04 | 실측 | [[gdpval]] 10.0%×1.0, [[tau2-bench]] 71.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
