...
is_reasoning: true
radar:
  knowledge: { s: 42.5, z: 0.1, r: 51.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.25 · 출력 $0.75 · 혼합 $0.14/1M · 763.0 t/s · TTFT 3.53s · 128k ctx` · 가성비 178.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.5 | +0.1 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
