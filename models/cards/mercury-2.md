...
radar:
  ...
  agentic: { s: 36.3, z: 0.02, r: 50.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $0.75 · 혼합 $0.1425/1M · 984.0 t/s · TTFT 4.45s · 128k ctx` · 가성비 154.4
...
| 추론 | 52.0 | +0.13 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 56.0 | +0.4 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 50.3 | +0.02 | 실측 | [[gdpval]] 10.0%×1.0, [[tau2-bench]] 71.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
