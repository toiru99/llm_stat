...
radar:
  ...
  reasoning: { s: 37.2, z: 0.15, r: 52.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $0.75 · 혼합 $None/1M · 794.0 t/s · TTFT 3.88s · 128k ctx`
...
| 추론 | 52.2 | +0.15 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 56.3 | +0.42 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 51.8 | +0.12 | 실측 | [[gdpval]] 10.0%×1.0, [[tau2-bench]] 71.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
