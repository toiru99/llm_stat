...
is_reasoning: true
radar:
  knowledge: { s: 42.5, z: 0.06, r: 50.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.25 · 출력 $0.75 · 혼합 $0.1425/1M · 770.0 t/s · TTFT 3.49s · 128k ctx` · 가성비 147.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.8 | +0.06 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
