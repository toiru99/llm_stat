...
radar:
  ...
  coding: { s: 20.4, z: -1.12, r: 33.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.4 · 혼합 $0.067/1M · 287.0 t/s · TTFT 0.29s · 1M ctx` · 가성비 104.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.0 | -0.8 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 34.7 | -1.02 | 실측 | [[tau2-bench]] 19.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
