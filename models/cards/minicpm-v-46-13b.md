...
is_reasoning: false
radar:
  knowledge: { s: 12.1, z: -1.38, r: 29.3, estimated: false }  # 전문 지식
  reasoning: { s: 10.9, z: -1.19, r: 32.2, estimated: false }  # 추론
  coding: { s: 2.2, z: -1.87, r: 22.0, estimated: false }  # 코딩
  agentic: { s: 24.6, z: -0.45, r: 43.3, estimated: false }  # 에이전트
  trust: { s: 2.3, z: -1.21, r: 31.8, estimated: false }  # 신뢰성
...
| 에이전트 | 43.3 | -0.45 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 88.0%×1.0, [[tau3-banking]] 4.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 31.8 | -1.21 | 실측 | [[aa-omniscience]] 3.0%×1.0 |
