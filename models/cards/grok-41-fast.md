...
radar:
  ...
  reasoning: { s: 43.8, z: 0.45, r: 56.8, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 65.2, z: 1.17, r: 67.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 56.3 | +0.42 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 56.8 | +0.45 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 58.5 | +0.57 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 67.6 | +1.17 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
