...
is_reasoning: false
radar:
  knowledge: { s: 50.3, z: 0.49, r: 57.3, estimated: false }  # 전문 지식
  reasoning: { s: 43.8, z: 0.55, r: 58.3, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.64, r: 59.7, estimated: false }  # 코딩
  agentic: { s: 65.2, z: 1.14, r: 67.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 57.3 | +0.49 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 58.3 | +0.55 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 59.7 | +0.64 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 67.0 | +1.14 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
