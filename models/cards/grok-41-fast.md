...
radar:
  ...
  reasoning: { s: 43.8, z: 0.54, r: 58.2, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.63, r: 59.5, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 57.2 | +0.48 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 58.2 | +0.54 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 59.5 | +0.63 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
