...
is_reasoning: false
radar:
  knowledge: { s: 48.7, z: 0.35, r: 55.3, estimated: false }  # 전문 지식
  reasoning: { s: 43.6, z: 0.4, r: 56.0, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.52, r: 57.8, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 55.3 | +0.35 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
