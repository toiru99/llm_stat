...
is_reasoning: true
radar:
  knowledge: { s: 48.2, z: 0.39, r: 55.9, estimated: false }  # 전문 지식
  reasoning: { s: 42.9, z: 0.42, r: 56.3, estimated: false }  # 추론
  coding: { s: 59.4, z: 0.54, r: 58.1, estimated: false }  # 코딩
  agentic: { s: 65.2, z: 1.09, r: 66.4, estimated: false }  # 에이전트
...
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 66.4 | +1.09 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
