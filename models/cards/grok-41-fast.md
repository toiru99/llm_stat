...
is_reasoning: true
radar:
  knowledge: { s: 50.3, z: 0.48, r: 57.3, estimated: false }  # 전문 지식
  reasoning: { s: 43.8, z: 0.55, r: 58.2, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.64, r: 59.5, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 57.3 | +0.48 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 58.2 | +0.55 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 59.5 | +0.64 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 66.9 | +1.13 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
