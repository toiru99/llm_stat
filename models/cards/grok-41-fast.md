...
is_reasoning: false
radar:
  knowledge: { s: 48.7, z: 0.36, r: 55.3, estimated: false }  # 전문 지식
  reasoning: { s: 43.6, z: 0.41, r: 56.1, estimated: false }  # 추론
  coding: { s: 61.0, z: 0.52, r: 57.9, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 55.3 | +0.36 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 56.1 | +0.41 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 57.9 | +0.52 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 66.9 | +1.12 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
