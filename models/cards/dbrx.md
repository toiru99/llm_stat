...
radar:
  ...
  long_context: { s: 10.6, z: -1.21, r: 31.8, estimated: true }  # 긴문맥
  instruction: { s: 28.2, z: -1.07, r: 33.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 32.6 | -1.16 | 실측 | [[gpqa-diamond]] 33.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 35.1 | -0.99 | 실측 | [[gpqa-diamond]] 33.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
