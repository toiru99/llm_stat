...
radar:
  ...
  trust: { s: 21.3, z: -0.29, r: 45.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 13.4, z: -1.07, r: 34.0, estimated: true }  # 긴문맥
  instruction: { s: 35.7, z: -0.71, r: 39.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
