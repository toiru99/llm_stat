...
is_reasoning: false
radar:
  knowledge: { s: 20.6, z: -0.98, r: 35.4, estimated: false }  # 전문 지식
  ...
  trust: { s: 23.3, z: -0.24, r: 46.5, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 35.4 | -0.98 | 실측 | [[gpqa-diamond]] 33.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
