...
radar:
  ...
  reasoning: { s: 25.8, z: -0.49, r: 42.7, estimated: false }  # 추론
  coding: { s: 39.1, z: -0.4, r: 44.0, estimated: false }  # 코딩
...
| 추론 | 42.7 | -0.49 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 44.0 | -0.4 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 63.4 | +0.89 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
