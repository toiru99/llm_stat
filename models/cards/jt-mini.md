...
is_reasoning: false
radar:
  knowledge: { s: 29.9, z: -0.53, r: 42.1, estimated: false }  # 전문 지식
  reasoning: { s: 25.6, z: -0.45, r: 43.2, estimated: false }  # 추론
  coding: { s: 38.1, z: -0.37, r: 44.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 42.1 | -0.53 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 43.2 | -0.45 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 44.4 | -0.37 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
