...
is_reasoning: false
radar:
  knowledge: { s: 29.8, z: -0.53, r: 42.1, estimated: false }  # 전문 지식
  reasoning: { s: 26.1, z: -0.44, r: 43.4, estimated: false }  # 추론
  coding: { s: 39.1, z: -0.34, r: 44.8, estimated: false }  # 코딩
...
| 코딩 | 44.8 | -0.34 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 64.7 | +0.98 | 실측 | [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
