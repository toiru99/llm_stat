...
radar:
  ...
  reasoning: { s: 26.9, z: -0.38, r: 44.4, estimated: false }  # 추론
  coding: { s: 39.1, z: -0.32, r: 45.1, estimated: false }  # 코딩
...
| 추론 | 44.4 | -0.38 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 45.1 | -0.32 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
