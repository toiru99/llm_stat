...
radar:
  ...
  reasoning: { s: 25.8, z: -0.47, r: 43.0, estimated: false }  # 추론
  coding: { s: 39.1, z: -0.37, r: 44.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 41.8 | -0.55 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
