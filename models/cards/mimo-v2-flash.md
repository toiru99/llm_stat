...
radar:
  ...
  coding: { s: 57.5, z: 0.47, r: 57.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 57.8 | +0.52 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 60.2 | +0.68 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 57.0 | +0.47 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 28.0%×0.5 |
