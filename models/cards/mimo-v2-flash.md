...
radar:
  ...
  reasoning: { s: 46.2, z: 0.59, r: 58.9, estimated: false }  # 추론
  coding: { s: 56.1, z: 0.4, r: 56.0, estimated: false }  # 코딩
  agentic: { s: 69.2, z: 1.25, r: 68.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 56.8 | +0.45 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 58.9 | +0.59 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 56.0 | +0.4 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 28.0%×0.5 |
| 에이전트 | 68.7 | +1.25 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 28.0%×1.0 |
