...
radar:
  ...
  reasoning: { s: 45.9, z: 0.52, r: 57.8, estimated: false }  # 추론
  coding: { s: 42.4, z: 0.36, r: 55.4, estimated: false }  # 코딩
...
Xiaomi · Open · Large(309B) · 컨텍스트 256k · 종합지능 **24.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · None t/s · TTFT Nones · 256k ctx` · 가성비 200.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.0 | +0.4 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.8 | +0.52 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 55.4 | +0.36 | 실측 | [[terminal-bench]] 28.0%×0.5 |
