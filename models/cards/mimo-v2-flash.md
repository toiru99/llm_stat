...
radar:
  ...
  reasoning: { s: 47.2, z: 0.57, r: 58.6, estimated: false }  # 추론
  coding: { s: 57.5, z: 0.37, r: 55.6, estimated: false }  # 코딩
  agentic: { s: 69.2, z: 1.27, r: 69.0, estimated: false }  # 에이전트
...
| 추론 | 58.6 | +0.57 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 55.6 | +0.37 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 28.0%×0.5 |
| 에이전트 | 69.0 | +1.27 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 28.0%×1.0 |
