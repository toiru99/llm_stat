...
is_reasoning: true
radar:
  knowledge: { s: 51.3, z: 0.47, r: 57.0, estimated: false }  # 전문 지식
  reasoning: { s: 46.7, z: 0.6, r: 59.0, estimated: false }  # 추론
  coding: { s: 57.5, z: 0.42, r: 56.3, estimated: false }  # 코딩
  agentic: { s: 69.2, z: 1.34, r: 70.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 57.0 | +0.47 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 59.0 | +0.6 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 56.3 | +0.42 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 28.0%×0.5 |
| 에이전트 | 70.0 | +1.34 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 28.0%×1.0 |
