...
radar:
  ...
  agentic: { s: 64.3, z: 1.08, r: 66.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 85.2, z: 1.26, r: 68.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 253.0 t/s · TTFT 0.74s · 1M ctx` · 가성비 88.3
...
| 에이전트 | 66.3 | +1.08 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
