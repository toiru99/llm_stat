...
is_reasoning: true
radar:
  knowledge: { s: 79.9, z: 1.93, r: 79.0, estimated: false }  # 전문 지식
  reasoning: { s: 57.2, z: 1.11, r: 66.6, estimated: false }  # 추론
  ...
  instruction: { s: 85.0, z: 1.34, r: 70.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 257.0 t/s · TTFT 0.91s · 1M ctx` · 가성비 88.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.0 | +1.93 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 35.0%×0.3 |
| 추론 | 66.6 | +1.11 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 75.2 | +1.68 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 64.6 | +0.97 | 실측 | [[gdpval]] 47.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
