...
is_reasoning: false
radar:
  knowledge: { s: 34.2, z: -0.35, r: 44.8, estimated: false }  # 전문 지식
  reasoning: { s: 25.6, z: -0.5, r: 42.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 92.0 t/s · TTFT 0.92s · 400k ctx` · 가성비 52.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.35 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 42.5 | -0.5 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
