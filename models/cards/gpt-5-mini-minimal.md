...
radar:
  ...
  coding: { s: 48.2, z: 0.1, r: 51.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.27/1M · 93.0 t/s · TTFT 0.94s · 400k ctx` · 가성비 51.9
...
| 코딩 | 51.5 | +0.1 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
