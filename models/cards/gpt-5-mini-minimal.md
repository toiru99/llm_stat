...
is_reasoning: false
radar:
  knowledge: { s: 34.6, z: -0.3, r: 45.6, estimated: false }  # 전문 지식
  reasoning: { s: 26.0, z: -0.41, r: 43.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $None/1M · 101.0 t/s · TTFT 0.9s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.6 | -0.3 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 43.9 | -0.41 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
