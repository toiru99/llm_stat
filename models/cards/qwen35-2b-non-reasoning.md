...
radar:
  ...
  reasoning: { s: 15.6, z: -0.94, r: 35.9, estimated: false }  # 추론
  coding: { s: 9.5, z: -1.57, r: 26.4, estimated: false }  # 코딩
...
| 추론 | 35.9 | -0.94 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 44.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 26.4 | -1.57 | 실측 | [[scicode]] 7.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 45.6 | -0.29 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
