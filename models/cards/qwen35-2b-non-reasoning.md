...
radar:
  ...
  reasoning: { s: 15.5, z: -0.94, r: 35.9, estimated: false }  # 추론
...
Alibaba · Open · Tiny(2.27B) · 컨텍스트 262k · 종합지능 **1.0**
...
|---|---|---|---|---|
| 전문 지식 | 32.5 | -1.17 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 44.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
