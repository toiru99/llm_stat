...
radar:
  ...
  coding: { s: 95.9, z: 2.24, r: 83.6, estimated: false }  # 코딩
  agentic: { s: 94.2, z: 2.17, r: 82.6, estimated: false }  # 에이전트
  trust: { s: 27.8, z: 0.16, r: 52.4, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 93.3, z: 1.36, r: 70.4, estimated: false }  # 긴문맥
  instruction: { s: 81.6, z: 1.22, r: 68.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.175/1M · 69.0 t/s · TTFT 143.09s · 1M ctx` · 가성비 7.5
...
| 코딩 | 83.6 | +2.24 | 실측 | [[scicode]] 61.0%×1.0 |
| 에이전트 | 82.6 | +2.17 | 실측 | [[gdpval]] 63.0%×1.0, [[tau3-banking]] 46.0%×1.0 |
