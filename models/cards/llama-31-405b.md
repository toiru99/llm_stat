...
## 실용 지표
`입력 $2.75 · 출력 $6.5 · 혼합 $3.13/1M · 69.0 t/s · TTFT 2.46s · 128k ctx` · 가성비 2.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.34 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
