...
radar:
  ...
  coding: { s: 36.9, z: -0.42, r: 43.6, estimated: false }  # 코딩
  agentic: { s: 14.9, z: -0.84, r: 37.5, estimated: false }  # 에이전트
...
| 코딩 | 43.6 | -0.42 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 37.5 | -0.84 | 실측 | [[tau2-bench]] 19.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
