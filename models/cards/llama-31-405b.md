...
radar:
  ...
  coding: { s: 36.9, z: -0.39, r: 44.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.75 · 출력 $6.5 · 혼합 $3.13/1M · 76.0 t/s · TTFT 2.43s · 128k ctx` · 가성비 2.9
...
| 코딩 | 44.2 | -0.39 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
