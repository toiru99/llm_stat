...
is_reasoning: false
radar:
  knowledge: { s: 32.7, z: -0.39, r: 44.2, estimated: false }  # 전문 지식
  reasoning: { s: 18.2, z: -0.82, r: 37.7, estimated: false }  # 추론
  coding: { s: 35.8, z: -0.47, r: 42.9, estimated: false }  # 코딩
  agentic: { s: 14.9, z: -0.87, r: 36.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 44.2 | -0.39 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 37.7 | -0.82 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 42.9 | -0.47 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 36.9 | -0.87 | 실측 | [[tau2-bench]] 19.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
