...
radar:
  ...
  agentic: { s: 63.5, z: 0.99, r: 64.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 191.0 t/s · TTFT 10.35s · 400k ctx` · 가성비 49.0
...
| 에이전트 | 64.9 | +0.99 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 35.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
