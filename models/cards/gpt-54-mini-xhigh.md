...
radar:
  ...
  coding: { s: 81.8, z: 1.49, r: 72.4, estimated: false }  # 코딩
  agentic: { s: 66.8, z: 1.18, r: 67.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $None/1M · 165.0 t/s · TTFT 8.94s · 400k ctx`
...
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
