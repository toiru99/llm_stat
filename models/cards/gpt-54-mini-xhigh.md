...
radar:
  ...
  agentic: { s: 63.9, z: 1.02, r: 65.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 166.0 t/s · TTFT 4.23s · 400k ctx` · 가성비 62.8
...
| 에이전트 | 65.3 | +1.02 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 33.0%×1.0, [[itbench]] 35.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
