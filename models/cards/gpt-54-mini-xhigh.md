...
is_reasoning: true
radar:
  knowledge: { s: 65.7, z: 1.2, r: 68.0, estimated: false }  # 전문 지식
  reasoning: { s: 57.6, z: 1.25, r: 68.7, estimated: false }  # 추론
  coding: { s: 81.8, z: 1.49, r: 72.3, estimated: false }  # 코딩
  agentic: { s: 66.9, z: 1.18, r: 67.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $None/1M · 166.0 t/s · TTFT 5.55s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.0 | +1.2 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 68.7 | +1.25 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 72.3 | +1.49 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
| 에이전트 | 67.7 | +1.18 | 실측 | [[apex-agents]] 28.0%×1.0, [[gdpval]] 34.0%×1.0, [[itbench]] 35.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
