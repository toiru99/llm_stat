...
radar:
  ...
  reasoning: { s: 57.6, z: 1.17, r: 67.5, estimated: false }  # 추론
  coding: { s: 81.8, z: 1.45, r: 71.8, estimated: false }  # 코딩
  agentic: { s: 65.6, z: 1.14, r: 67.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $None/1M · 176.0 t/s · TTFT 6.86s · 400k ctx`
...
| 추론 | 67.5 | +1.17 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 71.8 | +1.45 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
