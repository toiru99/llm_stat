...
radar:
  ...
  agentic: { s: 70.7, z: 0.75, r: 61.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 69.0 t/s · TTFT 1.77s · 922k ctx` · 가성비 9.9
...
| 에이전트 | 61.3 | +0.75 | 실측 | [[gdpval]] 35.0%×1.0, [[tau2-bench]] 84.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
