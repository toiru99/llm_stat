...
is_reasoning: true
radar:
  knowledge: { s: 84.8, z: 2.16, r: 82.4, estimated: false }  # 전문 지식
  reasoning: { s: 59.7, z: 1.39, r: 70.8, estimated: false }  # 추론
  coding: { s: 84.0, z: 1.61, r: 74.2, estimated: false }  # 코딩
  agentic: { s: 70.7, z: 1.34, r: 70.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 59.0 t/s · TTFT 2.01s · 922k ctx` · 가성비 9.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 82.4 | +2.16 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 70.8 | +1.39 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 74.2 | +1.61 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
| 에이전트 | 70.2 | +1.34 | 실측 | [[gdpval]] 35.0%×1.0, [[tau2-bench]] 84.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
