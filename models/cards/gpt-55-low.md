...
radar:
  ...
  reasoning: { s: 59.9, z: 1.17, r: 67.5, estimated: false }  # 추론
  coding: { s: 84.0, z: 1.44, r: 71.6, estimated: false }  # 코딩
  agentic: { s: 65.9, z: 1.1, r: 66.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 80.0 t/s · TTFT 1.87s · 922k ctx` · 가성비 10.1
...
| 추론 | 67.5 | +1.17 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.6 | +1.44 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
| 에이전트 | 66.5 | +1.1 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 84.0%×1.0, [[tau3-banking]] 25.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
