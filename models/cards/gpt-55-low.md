...
is_reasoning: true
radar:
  knowledge: { s: 84.8, z: 2.05, r: 80.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 64.0 t/s · TTFT 1.84s · 922k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.7 | +2.05 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
