...
radar:
  ...
  agentic: { s: 70.3, z: 0.76, r: 61.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 77.0 t/s · TTFT 1.74s · 922k ctx` · 가성비 9.9
...
| 에이전트 | 61.4 | +0.76 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 84.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 52.0%×1.0 |
