...
is_reasoning: true
radar:
  knowledge: { s: 84.8, z: 2.15, r: 82.2, estimated: false }  # 전문 지식
  reasoning: { s: 59.7, z: 1.38, r: 70.7, estimated: false }  # 추론
  coding: { s: 84.0, z: 1.6, r: 74.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 60.0 t/s · TTFT 1.87s · 922k ctx` · 가성비 9.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 82.2 | +2.15 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 70.7 | +1.38 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 74.0 | +1.6 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
