...
is_reasoning: true
radar:
  knowledge: { s: 84.8, z: 2.16, r: 82.5, estimated: false }  # 전문 지식
  reasoning: { s: 59.7, z: 1.4, r: 71.0, estimated: false }  # 추론
  coding: { s: 84.0, z: 1.62, r: 74.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 82.5 | +2.16 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 71.0 | +1.4 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 74.4 | +1.62 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 52.0%×0.5 |
