...
radar:
  ...
  agentic: { s: 23.4, z: -0.49, r: 42.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 49.0 t/s · TTFT 1.42s · 256k ctx`
...
| 에이전트 | 42.6 | -0.49 | 실측 | [[gdpval]] 12.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
