...
radar:
  ...
  agentic: { s: 22.8, z: -0.56, r: 41.5, estimated: false }  # 에이전트
...
Mistral · Open · Medium(125B) · 컨텍스트 256k · 종합지능 **13.0**
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 118.0 t/s · TTFT 2.26s · 256k ctx`
...
| 에이전트 | 41.5 | -0.56 | 실측 | [[gdpval]] 10.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
