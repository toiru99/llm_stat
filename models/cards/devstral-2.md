...
radar:
  ...
  coding: { s: 46.3, z: 0.01, r: 50.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.0/1M · 73.0 t/s · TTFT 1.18s · 256k ctx`
...
| 코딩 | 50.2 | +0.01 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
