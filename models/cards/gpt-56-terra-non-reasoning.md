...
radar:
  ...
  agentic: { s: 43.3, z: 0.3, r: 54.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 111.0 t/s · TTFT 0.78s · 1M ctx` · 가성비 20.1
...
| 에이전트 | 54.5 | +0.3 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
