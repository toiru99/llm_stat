...
radar:
  ...
  agentic: { s: 43.3, z: 0.26, r: 53.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 96.0 t/s · TTFT 0.81s · 1M ctx` · 가성비 20.1
...
| 에이전트 | 53.9 | +0.26 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
