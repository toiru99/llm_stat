...
radar:
  ...
  coding: { s: 75.0, z: 1.17, r: 67.5, estimated: false }  # 코딩
  agentic: { s: 46.3, z: 0.39, r: 55.8, estimated: false }  # 에이전트
  trust: { s: 5.7, z: -1.06, r: 34.1, estimated: false }  # 신뢰성
  multimodal: { s: 74.3, z: 0.13, r: 51.9, estimated: false }  # 멀티모달
  long_context: { s: 65.8, z: 0.48, r: 57.3, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $None/1M · 106.0 t/s · TTFT 0.71s · 1M ctx`
...
| 추론 | 49.9 | -0.01 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 67.5 | +1.17 | 실측 | [[scicode]] 45.0%×1.0 |
| 에이전트 | 55.8 | +0.39 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
| 신뢰성 | 34.1 | -1.06 | 실측 | [[aa-omniscience]] 6.0%×1.0 |
| 멀티모달 | 51.9 | +0.13 | 실측 | [[mmmu-pro]] 67.0%×1.0 |
| 긴문맥 | 57.3 | +0.48 | 실측 | [[aa-lcr]] 50.0%×1.0 |
