...
radar:
  ...
  coding: { s: 45.8, z: 0.47, r: 57.1, estimated: true }  # 코딩
  ...
  instruction: { s: 53.0, z: 0.01, r: 50.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 90.0 t/s · TTFT 0.79s · 1M ctx` · 가성비 14.9
