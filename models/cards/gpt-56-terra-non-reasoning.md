...
radar:
  ...
  reasoning: { s: 33.7, z: -0.08, r: 48.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 98.0 t/s · TTFT 0.85s · 1M ctx` · 가성비 20.1
...
| 추론 | 48.7 | -0.08 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 66.3 | +1.09 | 실측 | [[scicode]] 45.0%×1.0 |
| 에이전트 | 53.8 | +0.25 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
