...
radar:
  ...
  agentic: { s: 43.3, z: 0.24, r: 53.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 103.0 t/s · TTFT 0.77s · 1M ctx` · 가성비 20.1
...
| 추론 | 48.6 | -0.09 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 66.2 | +1.08 | 실측 | [[scicode]] 45.0%×1.0 |
| 에이전트 | 53.5 | +0.24 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
