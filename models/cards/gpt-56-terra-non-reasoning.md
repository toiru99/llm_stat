...
is_reasoning: false
radar:
  knowledge: { s: 55.9, z: 0.76, r: 61.4, estimated: false }  # 전문 지식
  reasoning: { s: 34.3, z: 0.05, r: 50.7, estimated: false }  # 추론
  coding: { s: 75.0, z: 1.24, r: 68.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.17/1M · 132.0 t/s · TTFT 0.74s · 1M ctx` · 가성비 15.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.4 | +0.76 | 실측 | [[aa-omniscience]] 36.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 50.7 | +0.05 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 68.6 | +1.24 | 실측 | [[scicode]] 45.0%×1.0 |
