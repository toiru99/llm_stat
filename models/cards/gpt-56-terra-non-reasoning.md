...
radar:
  ...
  coding: { s: 75.0, z: 1.07, r: 66.1, estimated: false }  # 코딩
  agentic: { s: 43.3, z: 0.23, r: 53.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 65.3, z: 0.44, r: 56.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 103.0 t/s · TTFT 0.89s · 1M ctx` · 가성비 20.1
