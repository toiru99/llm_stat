...
radar:
  ...
  agentic: { s: 43.3, z: 0.29, r: 54.4, estimated: false }  # 에이전트
  ...
  instruction: { s: 65.3, z: 0.48, r: 57.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 96.0 t/s · TTFT 0.89s · 1M ctx` · 가성비 20.1
...
| 에이전트 | 54.4 | +0.29 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
