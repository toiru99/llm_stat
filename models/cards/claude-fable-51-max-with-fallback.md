...
radar:
  ...
  coding: { s: 100.0, z: 2.37, r: 85.5, estimated: false }  # 코딩
  agentic: { s: 95.2, z: 2.21, r: 83.2, estimated: false }  # 에이전트
  trust: { s: 25.8, z: 0.06, r: 50.9, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 95.5, z: 1.43, r: 71.4, estimated: false }  # 긴문맥
  instruction: { s: 82.3, z: 1.23, r: 68.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.175/1M · 70.0 t/s · TTFT 264.91s · 1M ctx` · 가성비 7.9
...
| 코딩 | 85.5 | +2.37 | 실측 | [[scicode]] 63.0%×1.0 |
| 에이전트 | 83.2 | +2.21 | 실측 | [[gdpval]] 63.0%×1.0, [[tau3-banking]] 47.0%×1.0 |
