...
radar:
  ...
  reasoning: { s: 29.4, z: -0.25, r: 46.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 51.0 t/s · TTFT 1.61s · 1M ctx` · 가성비 181.3
...
| 추론 | 46.2 | -0.25 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 60.6 | +0.71 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 71.1 | +1.41 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
