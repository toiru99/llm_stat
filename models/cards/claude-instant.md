...
radar:
  ...
  reasoning: { s: 16.3, z: -0.94, r: 35.9, estimated: false }  # 추론
  coding: { s: 19.8, z: -1.17, r: 32.4, estimated: true }  # 코딩
  agentic: { s: 14.5, z: -0.88, r: 36.8, estimated: true }  # 에이전트
  trust: { s: 23.9, z: -0.18, r: 47.3, estimated: true }  # 신뢰성
