...
radar:
  ...
  coding: { s: 20.8, z: -1.1, r: 33.6, estimated: true }  # 코딩
  agentic: { s: 12.6, z: -0.93, r: 36.1, estimated: true }  # 에이전트
  trust: { s: 28.5, z: 0.0, r: 50.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 6.6, z: -1.27, r: 30.9, estimated: true }  # 긴문맥
