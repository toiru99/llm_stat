...
radar:
  ...
  reasoning: { s: 52.2, z: 0.82, r: 62.3, estimated: false }  # 추론
  coding: { s: 72.1, z: 0.97, r: 64.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $0.49/1M · 44.0 t/s · TTFT 2.85s · 256k ctx` · 가성비 73.5
...
| 추론 | 62.3 | +0.82 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 64.6 | +0.97 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 56.4 | +0.43 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 25.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
