...
radar:
  ...
  agentic: { s: 51.2, z: 0.58, r: 58.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $0.49/1M · 56.0 t/s · TTFT 2.86s · 256k ctx` · 가성비 71.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.7 | +1.12 | 실측 | [[aa-omniscience]] 34.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
| 추론 | 64.5 | +0.96 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
