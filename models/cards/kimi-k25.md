...
radar:
  ...
  agentic: { s: 51.3, z: 0.58, r: 58.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $None/1M · 43.0 t/s · TTFT 2.89s · 256k ctx`
...
| 에이전트 | 58.8 | +0.58 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 25.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
