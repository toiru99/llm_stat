...
is_reasoning: true
radar:
  knowledge: { s: 61.4, z: 1.03, r: 65.4, estimated: false }  # 전문 지식
  reasoning: { s: 51.0, z: 0.8, r: 62.0, estimated: false }  # 추론
  coding: { s: 70.4, z: 0.98, r: 64.7, estimated: false }  # 코딩
  agentic: { s: 47.5, z: 0.39, r: 55.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $0.49/1M · 55.0 t/s · TTFT 4.83s · 256k ctx` · 가성비 73.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.4 | +1.03 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
...
| 에이전트 | 55.9 | +0.39 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 25.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
