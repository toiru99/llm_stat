...
radar:
  ...
  agentic: { s: 47.2, z: 0.37, r: 55.5, estimated: false }  # 에이전트
...
| 에이전트 | 55.5 | +0.37 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 22.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
