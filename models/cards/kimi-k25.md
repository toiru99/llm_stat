...
radar:
  ...
  reasoning: { s: 52.2, z: 0.81, r: 62.1, estimated: false }  # 추론
  coding: { s: 72.1, z: 0.96, r: 64.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $0.49/1M · 58.0 t/s · TTFT 2.77s · 256k ctx` · 가성비 73.5
...
| 추론 | 62.1 | +0.81 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 64.4 | +0.96 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
