...
is_reasoning: true
radar:
  knowledge: { s: 63.1, z: 1.11, r: 66.7, estimated: false }  # 전문 지식
  reasoning: { s: 52.2, z: 0.9, r: 63.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.6 · 출력 $3.0 · 혼합 $0.49/1M · 66.0 t/s · TTFT 2.81s · 256k ctx` · 가성비 73.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.7 | +1.11 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 63.5 | +0.9 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 65.4 | +1.03 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 56.5 | +0.43 | 실측 | [[apex-agents]] 12.0%×1.0, [[gdpval]] 25.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
