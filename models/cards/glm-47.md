...
radar:
  ...
  reasoning: { s: 47.9, z: 0.6, r: 59.0, estimated: false }  # 추론
  coding: { s: 66.2, z: 0.72, r: 60.8, estimated: false }  # 코딩
  agentic: { s: 54.6, z: 0.67, r: 60.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.2 · 혼합 $0.7075/1M · 98.0 t/s · TTFT 1.19s · 200k ctx` · 가성비 48.1
...
| 추론 | 59.0 | +0.6 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 60.8 | +0.72 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
