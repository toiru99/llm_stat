...
radar:
  ...
  coding: { s: 66.2, z: 0.79, r: 61.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $2.2 · 혼합 $0.76/1M · 102.0 t/s · TTFT 0.97s · 200k ctx` · 가성비 44.7
...
| 코딩 | 61.9 | +0.79 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
