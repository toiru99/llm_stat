...
radar:
  ...
  reasoning: { s: 46.8, z: 0.6, r: 58.9, estimated: false }  # 추론
  coding: { s: 64.5, z: 0.73, r: 61.0, estimated: false }  # 코딩
  agentic: { s: 54.3, z: 0.65, r: 59.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.2 · 혼합 $0.76/1M · 93.0 t/s · TTFT 1.36s · 200k ctx` · 가성비 44.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.2 | +0.68 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 58.9 | +0.6 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 61.0 | +0.73 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
| 에이전트 | 59.8 | +0.65 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 32.0%×1.0 |
