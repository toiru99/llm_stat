...
radar:
  ...
  reasoning: { s: 48.3, z: 0.66, r: 60.0, estimated: false }  # 추론
  coding: { s: 66.2, z: 0.78, r: 61.7, estimated: false }  # 코딩
  agentic: { s: 54.6, z: 0.74, r: 61.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.2 · 혼합 $0.76/1M · 110.0 t/s · TTFT 0.95s · 200k ctx` · 가성비 44.7
...
| 추론 | 60.0 | +0.66 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 61.7 | +0.78 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
| 에이전트 | 61.1 | +0.74 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 32.0%×1.0 |
