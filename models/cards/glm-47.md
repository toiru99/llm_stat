...
radar:
  ...
  agentic: { s: 57.0, z: 0.82, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.2 · 혼합 $0.76/1M · 108.0 t/s · TTFT 0.82s · 200k ctx` · 가성비 44.7
...
| 에이전트 | 62.2 | +0.82 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 96.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 32.0%×1.0 |
