...
radar:
  ...
  reasoning: { s: 34.8, z: 0.08, r: 51.1, estimated: false }  # 추론
  coding: { s: 51.3, z: 0.23, r: 53.5, estimated: false }  # 코딩
...
| 추론 | 51.1 | +0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 53.5 | +0.23 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 47.6 | -0.16 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
