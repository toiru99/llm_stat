...
is_reasoning: true
radar:
  knowledge: { s: 36.4, z: -0.22, r: 46.7, estimated: false }  # 전문 지식
  reasoning: { s: 33.8, z: -0.06, r: 49.1, estimated: false }  # 추론
  coding: { s: 27.3, z: -0.17, r: 47.5, estimated: false }  # 코딩
  agentic: { s: 23.9, z: -0.52, r: 42.2, estimated: false }  # 에이전트
...
Google · Open · Small(12B) · 컨텍스트 256k · 종합지능 **16.0**
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 113.0 t/s · TTFT 2.33s · 256k ctx` · 가성비 133.3
...
| 추론 | 49.1 | -0.06 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 47.5 | -0.17 | 실측 | [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 42.2 | -0.52 | 실측 | [[gdpval]] 5.0%×1.0, [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
