...
is_reasoning: true
radar:
  knowledge: { s: 37.7, z: -0.17, r: 47.4, estimated: false }  # 전문 지식
  reasoning: { s: 34.8, z: 0.01, r: 50.2, estimated: false }  # 추론
  coding: { s: 51.3, z: 0.18, r: 52.6, estimated: false }  # 코딩
  agentic: { s: 25.1, z: -0.44, r: 43.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 111.0 t/s · TTFT 2.36s · 256k ctx` · 가성비 183.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.4 | -0.17 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 50.2 | +0.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 52.6 | +0.18 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
| 에이전트 | 43.4 | -0.44 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 36.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
