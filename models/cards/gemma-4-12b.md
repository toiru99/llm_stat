...
radar:
  ...
  agentic: { s: 24.7, z: -0.47, r: 43.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 115.0 t/s · TTFT 2.25s · 256k ctx` · 가성비 183.3
...
| 에이전트 | 43.0 | -0.47 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 18.0%×1.0 |
