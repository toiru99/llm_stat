...
is_reasoning: true
radar:
  knowledge: { s: 37.4, z: -0.16, r: 47.5, estimated: false }  # 전문 지식
  reasoning: { s: 34.7, z: 0.01, r: 50.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 111.0 t/s · TTFT 2.3s · 256k ctx` · 가성비 183.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.5 | -0.16 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
