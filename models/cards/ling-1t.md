...
is_reasoning: false
radar:
  knowledge: { s: 38.0, z: -0.11, r: 48.3, estimated: false }  # 전문 지식
  reasoning: { s: 29.5, z: -0.21, r: 46.9, estimated: false }  # 추론
  coding: { s: 44.4, z: -0.07, r: 49.0, estimated: false }  # 코딩
  agentic: { s: 25.0, z: -0.43, r: 43.5, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 48.3 | -0.11 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 72.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.9 | -0.21 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 49.0 | -0.07 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 43.5 | -0.43 | 실측 | [[tau2-bench]] 33.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
