...
radar:
  ...
  coding: { s: 61.1, z: 0.64, r: 59.5, estimated: false }  # 코딩
  agentic: { s: 55.2, z: 0.74, r: 61.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $1.16/1M · 109.0 t/s · TTFT 2.06s · 256k ctx` · 가성비 25.9
...
| 코딩 | 59.5 | +0.64 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 61.2 | +0.74 | 실측 | [[gdpval]] 21.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
