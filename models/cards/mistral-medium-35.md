...
radar:
  ...
  coding: { s: 61.1, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 51.8, z: 0.63, r: 59.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $1.155/1M · 133.0 t/s · TTFT 2.53s · 256k ctx` · 가성비 26.0
...
| 추론 | 49.2 | -0.05 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 58.5 | +0.57 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 59.5 | +0.63 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
