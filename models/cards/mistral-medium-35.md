...
radar:
  ...
  reasoning: { s: 32.7, z: -0.11, r: 48.3, estimated: false }  # 추론
  coding: { s: 52.0, z: 0.69, r: 60.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $1.155/1M · 147.0 t/s · TTFT 2.25s · 256k ctx` · 가성비 19.9
...
| 코딩 | 60.4 | +0.69 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
