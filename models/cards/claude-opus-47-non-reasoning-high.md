...
radar:
  ...
  agentic: { s: 81.0, z: 1.16, r: 67.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 48.0 t/s · TTFT 1.55s · 1M ctx` · 가성비 11.2
...
| 에이전트 | 67.4 | +1.16 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
