...
radar:
  ...
  reasoning: { s: 55.5, z: 1.06, r: 66.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 42.0 t/s · TTFT 0.91s · 1M ctx` · 가성비 11.4
...
| 추론 | 66.0 | +1.06 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 72.4 | +1.5 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
