...
radar:
  ...
  reasoning: { s: 55.5, z: 0.95, r: 64.3, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.41, r: 71.1, estimated: false }  # 코딩
  agentic: { s: 79.0, z: 1.6, r: 74.0, estimated: false }  # 에이전트
  trust: { s: 51.2, z: 0.94, r: 64.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 50.0 t/s · TTFT 1.14s · 1M ctx` · 가성비 11.4
...
| 추론 | 64.3 | +0.95 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.1 | +1.41 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
| 에이전트 | 74.0 | +1.6 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
| 신뢰성 | 64.0 | +0.94 | 실측 | [[aa-omniscience]] 46.0%×1.0 |
