...
is_reasoning: false
radar:
  knowledge: { s: 74.2, z: 1.65, r: 74.7, estimated: false }  # 전문 지식
  reasoning: { s: 55.4, z: 1.17, r: 67.5, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.59, r: 73.9, estimated: false }  # 코딩
  agentic: { s: 79.0, z: 1.68, r: 75.1, estimated: false }  # 에이전트
  trust: { s: 55.3, z: 1.31, r: 69.6, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 74.7 | +1.65 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 67.5 | +1.17 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 73.9 | +1.59 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
| 에이전트 | 75.1 | +1.68 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
| 신뢰성 | 69.6 | +1.31 | 실측 | [[aa-omniscience]] 48.0%×1.0 |
