...
radar:
  ...
  trust: { s: 55.3, z: 1.3, r: 69.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 45.0 t/s · TTFT 1.95s · 1M ctx` · 가성비 11.2
...
| 추론 | 67.1 | +1.14 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 73.4 | +1.56 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
| 에이전트 | 74.9 | +1.66 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
| 신뢰성 | 69.4 | +1.3 | 실측 | [[aa-omniscience]] 48.0%×1.0 |
