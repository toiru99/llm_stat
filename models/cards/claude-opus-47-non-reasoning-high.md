...
radar:
  ...
  agentic: { s: 79.0, z: 1.67, r: 75.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 45.0 t/s · TTFT 1.73s · 1M ctx` · 가성비 11.2
...
| 에이전트 | 75.1 | +1.67 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
