...
radar:
  ...
  reasoning: { s: 55.4, z: 1.13, r: 66.9, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.55, r: 73.2, estimated: false }  # 코딩
  agentic: { s: 79.0, z: 1.65, r: 74.8, estimated: false }  # 에이전트
  trust: { s: 55.3, z: 1.29, r: 69.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 46.0 t/s · TTFT 1.68s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 74.2 | +1.61 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 66.9 | +1.13 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 73.2 | +1.55 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
| 에이전트 | 74.8 | +1.65 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
| 신뢰성 | 69.3 | +1.29 | 실측 | [[aa-omniscience]] 48.0%×1.0 |
