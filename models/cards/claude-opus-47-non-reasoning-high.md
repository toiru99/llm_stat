...
radar:
  ...
  trust: { s: 54.0, z: 1.25, r: 68.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 45.0 t/s · TTFT 1.82s · 1M ctx`
...
| 코딩 | 73.3 | +1.55 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
