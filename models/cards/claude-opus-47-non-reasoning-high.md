...
radar:
  ...
  reasoning: { s: 55.5, z: 0.98, r: 64.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 44.0 t/s · TTFT 1.16s · 1M ctx` · 가성비 11.4
...
| 추론 | 64.7 | +0.98 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.5 | +1.43 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
