...
radar:
  ...
  trust: { s: 54.0, z: 1.27, r: 69.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 46.0 t/s · TTFT 1.92s · 1M ctx`
...
| 추론 | 67.0 | +1.13 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 73.3 | +1.55 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
| 에이전트 | 74.9 | +1.66 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 55.0%×1.0 |
| 신뢰성 | 69.0 | +1.27 | 실측 | [[aa-omniscience]] 48.0%×1.0 |
