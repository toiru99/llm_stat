...
is_reasoning: false
radar:
  knowledge: { s: 74.2, z: 1.56, r: 73.3, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 45.0 t/s · TTFT 1.73s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.3 | +1.56 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 65.9 | +1.06 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 72.9 | +1.52 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 55.0%×0.5 |
