...
radar:
  ...
  agentic: { s: 80.8, z: 1.15, r: 67.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 90.0 t/s · TTFT 1.73s · 1M ctx` · 가성비 227.8
...
| 에이전트 | 67.2 | +1.15 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
