...
radar:
  knowledge: { s: 74.1, z: 1.03, r: 65.4, estimated: false }  # 전문 지식
  reasoning: { s: 64.0, z: 0.91, r: 63.7, estimated: false }  # 추론
  coding: { s: 73.3, z: 0.61, r: 59.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 85.0 t/s · TTFT 1.87s · 1M ctx` · 가성비 227.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.4 | +1.03 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 63.7 | +0.91 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 59.1 | +0.61 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
