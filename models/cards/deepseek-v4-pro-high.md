...
radar:
  knowledge: { s: 74.1, z: 1.02, r: 65.2, estimated: false }  # 전문 지식
  reasoning: { s: 64.0, z: 0.9, r: 63.5, estimated: false }  # 추론
  coding: { s: 73.3, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 80.8, z: 1.12, r: 66.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 80.0 t/s · TTFT 1.66s · 1M ctx` · 가성비 227.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.2 | +1.02 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
...
| 에이전트 | 66.9 | +1.12 | 실측 | [[tau2-bench]] 94.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
