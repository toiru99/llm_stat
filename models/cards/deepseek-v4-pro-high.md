...
is_reasoning: true
radar:
  knowledge: { s: 74.1, z: 1.54, r: 73.1, estimated: false }  # 전문 지식
  reasoning: { s: 63.7, z: 1.45, r: 71.7, estimated: false }  # 추론
  coding: { s: 72.3, z: 1.04, r: 65.5, estimated: false }  # 코딩
  agentic: { s: 68.6, z: 1.31, r: 69.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 60.0 t/s · TTFT 1.63s · 1M ctx` · 가성비 243.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.1 | +1.54 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 71.7 | +1.45 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 65.5 | +1.04 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 69.7 | +1.31 | 실측 | [[gdpval]] 40.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 24.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
