...
radar:
  ...
  coding: { s: 72.3, z: 0.97, r: 64.5, estimated: false }  # 코딩
  agentic: { s: 67.3, z: 1.17, r: 67.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 73.0 t/s · TTFT 1.71s · 1M ctx` · 가성비 249.3
...
| 추론 | 70.1 | +1.34 | 실측 | [[critpt]] 10.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 64.5 | +0.97 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
