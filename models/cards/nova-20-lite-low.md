...
radar:
  ...
  agentic: { s: 39.4, z: 0.12, r: 51.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $None/1M · 151.0 t/s · TTFT 10.86s · 1M ctx`
...
| 에이전트 | 51.7 | +0.12 | 실측 | [[tau2-bench]] 72.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
