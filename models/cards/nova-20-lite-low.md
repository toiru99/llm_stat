...
radar:
  ...
  reasoning: { s: 25.3, z: -0.46, r: 43.1, estimated: false }  # 추론
  coding: { s: 37.5, z: -0.39, r: 44.2, estimated: false }  # 코딩
  agentic: { s: 39.4, z: 0.09, r: 51.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $2.5 · 혼합 $0.52/1M · 163.0 t/s · TTFT 8.48s · 1M ctx` · 가성비 34.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.35 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 51.3 | +0.09 | 실측 | [[tau2-bench]] 72.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
