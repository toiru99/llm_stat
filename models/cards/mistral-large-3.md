...
radar:
  ...
  reasoning: { s: 24.6, z: -0.53, r: 42.1, estimated: false }  # 추론
  coding: { s: 48.1, z: -0.01, r: 49.9, estimated: false }  # 코딩
  agentic: { s: 17.9, z: -0.74, r: 39.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $0.6/1M · 43.0 t/s · TTFT 1.22s · 256k ctx` · 가성비 26.7
...
| 추론 | 42.1 | -0.53 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 49.9 | -0.01 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
| 에이전트 | 39.0 | -0.74 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 16.0%×1.0 |
