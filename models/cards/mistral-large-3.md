...
radar:
  ...
  coding: { s: 48.1, z: 0.02, r: 50.3, estimated: false }  # 코딩
  agentic: { s: 18.0, z: -0.74, r: 38.9, estimated: false }  # 에이전트
  trust: { s: 12.4, z: -0.56, r: 41.6, estimated: false }  # 신뢰성
  multimodal: { s: 58.6, z: -0.61, r: 40.9, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $0.6/1M · 28.0 t/s · TTFT 2.17s · 256k ctx` · 가성비 26.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.2 | -0.05 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.5 | -0.5 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 50.3 | +0.02 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
...
| 멀티모달 | 40.9 | -0.61 | 실측 | [[mmmu-pro]] 56.0%×1.0 |
