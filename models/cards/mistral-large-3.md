...
radar:
  ...
  coding: { s: 48.1, z: 0.05, r: 50.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $None/1M · 47.0 t/s · TTFT 1.1s · 256k ctx`
...
| 코딩 | 50.7 | +0.05 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
