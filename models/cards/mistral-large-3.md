...
radar:
  ...
  coding: { s: 48.1, z: -0.02, r: 49.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $0.6/1M · 44.0 t/s · TTFT 1.17s · 256k ctx` · 가성비 26.7
...
| 추론 | 41.9 | -0.54 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 49.7 | -0.02 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
