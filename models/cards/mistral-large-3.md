...
radar:
  ...
  coding: { s: 48.1, z: 0.03, r: 50.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $0.6/1M · 39.0 t/s · TTFT 1.33s · 256k ctx` · 가성비 26.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.9 | -0.07 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.5 | -0.5 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 50.4 | +0.03 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 16.0%×0.5 |
| 에이전트 | 39.2 | -0.72 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 16.0%×1.0 |
