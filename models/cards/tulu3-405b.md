...
radar:
  ...
  trust: { s: 41.2, z: 0.66, r: 59.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 31.4, z: -0.53, r: 42.1, estimated: true }  # 긴문맥
  instruction: { s: 45.8, z: -0.29, r: 45.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
