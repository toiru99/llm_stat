...
radar:
  ...
  reasoning: { s: 26.6, z: -0.45, r: 43.2, estimated: false }  # 추론
  coding: { s: 50.0, z: 0.05, r: 50.7, estimated: false }  # 코딩
  agentic: { s: 31.8, z: -0.21, r: 46.8, estimated: true }  # 에이전트
  trust: { s: 45.5, z: 0.7, r: 60.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 31.5, z: -0.58, r: 41.2, estimated: true }  # 긴문맥
  instruction: { s: 48.4, z: -0.25, r: 46.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 43.2 | -0.45 | 실측 | [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 50.7 | +0.05 | 실측 | [[scicode]] 30.0%×1.0 |
| 에이전트 | 46.8 | -0.21 | 추정 | (추정) |
| 신뢰성 | 60.5 | +0.7 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 41.2 | -0.58 | 추정 | (추정) |
