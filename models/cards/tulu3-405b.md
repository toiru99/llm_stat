...
radar:
  ...
  agentic: { s: 42.6, z: 0.27, r: 54.1, estimated: true }  # 에이전트
  trust: { s: 44.5, z: 0.72, r: 60.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 35.1, z: -0.44, r: 43.4, estimated: true }  # 긴문맥
  instruction: { s: 49.6, z: -0.15, r: 47.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 44.2 | -0.39 | 실측 | [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
