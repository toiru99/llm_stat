...
is_reasoning: false
radar:
  knowledge: { s: 10.9, z: -1.43, r: 28.5, estimated: false }  # 전문 지식
  reasoning: { s: 10.8, z: -1.19, r: 32.2, estimated: false }  # 추론
  coding: { s: 3.8, z: -1.8, r: 22.9, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 28.5 | -1.43 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 31.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 32.2 | -1.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 31.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 22.9 | -1.8 | 실측 | [[scicode]] 3.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
