...
is_reasoning: true
radar:
  knowledge: { s: 14.8, z: -1.25, r: 31.3, estimated: false }  # 전문 지식
  ...
  trust: { s: 77.6, z: 2.34, r: 85.1, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 31.3 | -1.25 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 37.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 신뢰성 | 85.1 | +2.34 | 실측 | [[aa-omniscience]] 67.0%×1.0 |
