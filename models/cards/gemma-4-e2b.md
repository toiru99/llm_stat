...
radar:
  ...
  coding: { s: 24.8, z: -0.92, r: 36.2, estimated: false }  # 코딩
  agentic: { s: 10.2, z: -1.01, r: 34.8, estimated: false }  # 에이전트
  trust: { s: 75.9, z: 2.25, r: 83.7, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 32.2 | -1.19 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 35.3 | -0.98 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 41.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 36.2 | -0.92 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
| 에이전트 | 34.8 | -1.01 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 21.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
| 신뢰성 | 83.7 | +2.25 | 실측 | [[aa-omniscience]] 67.0%×1.0 |
