...
radar:
  ...
  agentic: { s: 13.0, z: -1.53, r: 27.0, estimated: false }  # 에이전트
  trust: { s: 78.8, z: 1.58, r: 73.8, estimated: false }  # 신뢰성
  multimodal: { s: 32.8, z: -2.12, r: 18.2, estimated: false }  # 멀티모달
...
| 에이전트 | 27.0 | -1.53 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
| 신뢰성 | 73.8 | +1.58 | 실측 | [[aa-omniscience]] 67.0%×1.0 |
| 멀티모달 | 18.2 | -2.12 | 실측 | [[mmmu-pro]] 45.0%×1.0 |
