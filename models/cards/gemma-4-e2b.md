...
radar:
  ...
  coding: { s: 24.8, z: -0.9, r: 36.6, estimated: false }  # 코딩
  agentic: { s: 12.9, z: -0.91, r: 36.4, estimated: false }  # 에이전트
  trust: { s: 77.6, z: 2.33, r: 85.0, estimated: false }  # 신뢰성
...
| 코딩 | 36.6 | -0.9 | 실측 | [[scicode]] 21.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
| 에이전트 | 36.4 | -0.91 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
| 신뢰성 | 85.0 | +2.33 | 실측 | [[aa-omniscience]] 67.0%×1.0 |
