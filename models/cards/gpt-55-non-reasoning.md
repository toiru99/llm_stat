...
radar:
  ...
  agentic: { s: 54.9, z: 0.75, r: 61.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 61.0 t/s · TTFT 0.97s · 922k ctx` · 가성비 8.3
...
| 에이전트 | 61.3 | +0.75 | 실측 | [[gdpval]] 31.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
