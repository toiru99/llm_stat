...
is_reasoning: false
radar:
  knowledge: { s: 66.0, z: 1.22, r: 68.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 73.0 t/s · TTFT 0.97s · 922k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.2 | +1.22 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
