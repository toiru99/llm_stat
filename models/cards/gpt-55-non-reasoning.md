...
radar:
  ...
  agentic: { s: 57.2, z: 0.24, r: 53.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 62.0 t/s · TTFT 0.99s · 922k ctx` · 가성비 8.0
...
| 에이전트 | 53.5 | +0.24 | 실측 | [[gdpval]] 31.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
