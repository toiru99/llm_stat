...
is_reasoning: false
radar:
  knowledge: { s: 66.0, z: 1.22, r: 68.4, estimated: false }  # 전문 지식
  reasoning: { s: 35.3, z: 0.08, r: 51.3, estimated: false }  # 추론
  coding: { s: 77.0, z: 1.29, r: 69.4, estimated: false }  # 코딩
  agentic: { s: 58.9, z: 0.88, r: 63.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 82.0 t/s · TTFT 0.85s · 922k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.4 | +1.22 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
| 추론 | 51.3 | +0.08 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 69.4 | +1.29 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 49.0%×0.5 |
| 에이전트 | 63.1 | +0.88 | 실측 | [[gdpval]] 31.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
