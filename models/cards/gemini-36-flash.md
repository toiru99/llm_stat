...
radar:
  ...
  reasoning: { s: 68.7, z: 1.62, r: 74.3, estimated: false }  # 추론
  ...
  instruction: { s: 80.9, z: 1.08, r: 66.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.63/1M · 199.0 t/s · TTFT 18.47s · 1M ctx` · 가성비 82.5
...
| 추론 | 74.3 | +1.62 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 74.5 | +1.64 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 65.8 | +1.05 | 실측 | [[gdpval]] 46.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
