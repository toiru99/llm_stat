...
radar:
  ...
  instruction: { s: 83.7, z: 1.25, r: 68.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $1.155/1M · 188.0 t/s · TTFT 17.27s · 1M ctx` · 가성비 43.3
...
| 추론 | 75.0 | +1.67 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 75.5 | +1.7 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 46.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
