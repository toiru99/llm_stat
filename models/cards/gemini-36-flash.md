...
is_reasoning: true
radar:
  knowledge: { s: 83.8, z: 2.08, r: 81.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $None/1M · 251.0 t/s · TTFT 12.83s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 81.2 | +2.08 | 실측 | [[aa-omniscience]] 50.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 77.0 | +1.8 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
