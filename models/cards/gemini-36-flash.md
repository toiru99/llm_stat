...
radar:
  ...
  agentic: { s: 63.7, z: 1.07, r: 66.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 80.8, z: 1.08, r: 66.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $1.155/1M · 230.0 t/s · TTFT 16.42s · 1M ctx` · 가성비 45.0
...
| 에이전트 | 66.0 | +1.07 | 실측 | [[gdpval]] 46.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
