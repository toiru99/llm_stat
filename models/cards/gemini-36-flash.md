...
is_reasoning: true
radar:
  knowledge: { s: 83.8, z: 2.07, r: 81.1, estimated: false }  # 전문 지식
  ...
  instruction: { s: 80.7, z: 1.16, r: 67.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $None/1M · 280.0 t/s · TTFT 11.71s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 81.1 | +2.07 | 실측 | [[aa-omniscience]] 50.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 76.9 | +1.79 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 76.4 | +1.76 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 72.4 | +1.49 | 실측 | [[gdpval]] 46.0%×1.0, [[tau3-banking]] 25.0%×1.0 |
