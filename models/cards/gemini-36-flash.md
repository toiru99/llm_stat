...
radar:
  ...
  reasoning: { s: 68.7, z: 1.6, r: 73.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.63/1M · 199.0 t/s · TTFT 16.68s · 1M ctx` · 가성비 82.5
...
| 추론 | 73.9 | +1.6 | 실측 | [[critpt]] 11.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
