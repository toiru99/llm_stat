...
radar:
  ...
  reasoning: { s: 31.8, z: -0.16, r: 47.6, estimated: false }  # 추론
  coding: { s: 30.3, z: -0.07, r: 49.0, estimated: false }  # 코딩
  agentic: { s: 31.8, z: -0.22, r: 46.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 59.0 t/s · TTFT 4.03s · 262k ctx` · 가성비 7.7
...
| 에이전트 | 46.8 | -0.22 | 실측 | [[tau2-bench]] 33.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
