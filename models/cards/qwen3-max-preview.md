...
radar:
  ...
  agentic: { s: 31.8, z: -0.19, r: 47.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 60.0 t/s · TTFT 4.15s · 262k ctx` · 가성비 11.3
...
| 추론 | 47.9 | -0.14 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 51.8 | +0.12 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
| 에이전트 | 47.2 | -0.19 | 실측 | [[tau2-bench]] 33.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
