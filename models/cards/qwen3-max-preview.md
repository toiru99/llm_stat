...
radar:
  ...
  reasoning: { s: 32.5, z: -0.15, r: 47.7, estimated: false }  # 추론
  coding: { s: 51.2, z: 0.11, r: 51.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.2 · 출력 $6.0 · 혼합 $1.68/1M · 62.0 t/s · TTFT 4.01s · 262k ctx` · 가성비 11.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.7 | +0.05 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 47.7 | -0.15 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 51.6 | +0.11 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
