...
radar:
  ...
  coding: { s: 48.3, z: 0.01, r: 50.1, estimated: false }  # 코딩
  agentic: { s: 37.4, z: 0.03, r: 50.4, estimated: false }  # 에이전트
  trust: { s: 35.0, z: 0.35, r: 55.3, estimated: true }  # 신뢰성
  multimodal: { s: 51.4, z: -1.0, r: 35.0, estimated: false }  # 멀티모달
  long_context: { s: 14.5, z: -1.08, r: 33.7, estimated: false }  # 긴문맥
...
| 코딩 | 50.1 | +0.01 | 실측 | [[scicode]] 29.0%×1.0 |
| 에이전트 | 50.4 | +0.03 | 실측 | [[tau2-bench]] 37.0%×1.0 |
| 신뢰성 | 55.3 | +0.35 | 추정 | (추정) |
| 멀티모달 | 35.0 | -1.0 | 실측 | [[mmmu-pro]] 51.0%×1.0 |
| 긴문맥 | 33.7 | -1.08 | 실측 | [[aa-lcr]] 12.0%×1.0 |
