...
radar:
  ...
  reasoning: { s: 44.8, z: 0.5, r: 57.5, estimated: false }  # 추론
  coding: { s: 44.3, z: -0.11, r: 48.3, estimated: false }  # 코딩
  agentic: { s: 44.3, z: 0.27, r: 54.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 52.6 | +0.17 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
...
| 에이전트 | 54.0 | +0.27 | 실측 | [[gdpval]] 20.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 9.0%×1.0 |
