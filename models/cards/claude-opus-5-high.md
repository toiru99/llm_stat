...
radar:
  ...
  reasoning: { s: 94.2, z: 2.83, r: 92.4, estimated: false }  # 추론
  coding: { s: 90.0, z: 1.68, r: 75.2, estimated: false }  # 코딩
  agentic: { s: 89.6, z: 2.01, r: 80.1, estimated: false }  # 에이전트
  ...
  instruction: { s: 79.1, z: 1.0, r: 65.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 14.44s · 1M ctx` · 가성비 15.8
...
| 에이전트 | 80.1 | +2.01 | 실측 | [[gdpval]] 61.0%×1.0, [[tau3-banking]] 45.0%×1.0 |
