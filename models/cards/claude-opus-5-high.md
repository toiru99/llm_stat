...
is_reasoning: true
radar:
  knowledge: { s: 90.9, z: 2.52, r: 87.8, estimated: false }  # 전문 지식
  reasoning: { s: 92.0, z: 2.88, r: 93.3, estimated: false }  # 추론
  coding: { s: 87.1, z: 1.71, r: 75.7, estimated: false }  # 코딩
  agentic: { s: 89.0, z: 2.02, r: 80.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.6, z: 1.09, r: 66.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 48.0 t/s · TTFT 12.84s · 1M ctx` · 가성비 15.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.8 | +2.52 | 실측 | [[aa-omniscience]] 59.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 53.0%×0.3 |
| 추론 | 93.3 | +2.88 | 실측 | [[critpt]] 28.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 53.0%×1.0 |
| 코딩 | 75.7 | +1.71 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 80.3 | +2.02 | 실측 | [[gdpval]] 61.0%×1.0, [[tau3-banking]] 45.0%×1.0 |
