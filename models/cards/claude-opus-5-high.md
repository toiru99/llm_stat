...
is_reasoning: true
radar:
  knowledge: { s: 91.5, z: 2.36, r: 85.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 53.0 t/s · TTFT 15.22s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.5 | +2.36 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 51.0%×0.3 |
| 추론 | 95.4 | +3.03 | 실측 | [[critpt]] 28.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 51.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 실측 | [[scicode]] 54.0%×1.0 |
| 에이전트 | 83.7 | +2.25 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 33.0%×1.0 |
