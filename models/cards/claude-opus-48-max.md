...
radar:
  knowledge: { s: 83.3, z: 1.44, r: 71.7, estimated: false }  # 전문 지식
  ...
  instruction: { s: 70.4, z: 0.15, r: 52.3, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 60.0 t/s · TTFT 20.55s · 1M ctx` · 가성비 14.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.7 | +1.44 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 46.0%×0.3 |
...
| 지시 따르기 | 52.3 | +0.15 | 실측 | [[ifbench]] 62.0%×1.0 |
