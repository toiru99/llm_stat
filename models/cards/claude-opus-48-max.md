...
radar:
  knowledge: { s: 83.3, z: 1.43, r: 71.5, estimated: false }  # 전문 지식
  reasoning: { s: 84.0, z: 1.86, r: 77.8, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.3, r: 69.5, estimated: false }  # 코딩
  agentic: { s: 90.2, z: 1.52, r: 72.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 70.0 t/s · TTFT 33.32s · 1M ctx` · 가성비 14.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.5 | +1.43 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 46.0%×0.3 |
