...
radar:
  ...
  agentic: { s: 90.6, z: 1.53, r: 72.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 58.0 t/s · TTFT 12.45s · 1M ctx` · 가성비 14.5
...
| 에이전트 | 72.9 | +1.53 | 실측 | [[gdpval]] 55.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 28.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
