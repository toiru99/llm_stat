...
radar:
  ...
  reasoning: { s: 83.7, z: 2.33, r: 85.0, estimated: false }  # 추론
  coding: { s: 88.2, z: 1.61, r: 74.2, estimated: false }  # 코딩
  agentic: { s: 82.5, z: 1.75, r: 76.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 59.0 t/s · TTFT 24.31s · 1M ctx` · 가성비 14.8
...
| 추론 | 85.0 | +2.33 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 49.0%×1.0 |
| 코딩 | 74.2 | +1.61 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 76.3 | +1.75 | 실측 | [[gdpval]] 54.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 34.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
