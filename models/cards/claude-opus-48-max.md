...
radar:
  ...
  agentic: { s: 86.5, z: 1.95, r: 79.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 53.0 t/s · TTFT 9.5s · 1M ctx`
...
| 에이전트 | 79.3 | +1.95 | 실측 | [[gdpval]] 55.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 28.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
