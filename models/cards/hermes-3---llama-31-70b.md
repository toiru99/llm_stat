...
radar:
  ...
  trust: { s: 21.9, z: -0.28, r: 45.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 26.3, z: -0.68, r: 39.8, estimated: true }  # 긴문맥
  instruction: { s: 29.3, z: -0.98, r: 35.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.7 · 출력 $0.7 · 혼합 $None/1M · 35.0 t/s · TTFT 1.88s · 128k ctx`
