...
radar:
  ...
  agentic: { s: 17.0, z: -0.79, r: 38.1, estimated: true }  # 에이전트
  trust: { s: 14.4, z: -0.48, r: 42.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 21.2, z: -0.88, r: 36.7, estimated: true }  # 긴문맥
  instruction: { s: 30.1, z: -0.95, r: 35.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
