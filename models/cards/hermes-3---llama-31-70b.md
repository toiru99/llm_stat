...
radar:
  ...
  long_context: { s: 28.7, z: -0.59, r: 41.1, estimated: true }  # 긴문맥
  instruction: { s: 31.5, z: -0.86, r: 37.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.7 · 출력 $0.7 · 혼합 $0.7/1M · 36.0 t/s · TTFT 1.9s · 128k ctx` · 가성비 7.1
