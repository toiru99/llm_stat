...
radar:
  ...
  trust: { s: 13.8, z: -0.5, r: 42.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 11.5, z: -1.16, r: 32.6, estimated: true }  # 긴문맥
  instruction: { s: 28.2, z: -1.02, r: 34.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.7 · 출력 $0.7 · 혼합 $0.7/1M · 33.0 t/s · TTFT 2.0s · 128k ctx` · 가성비 1.4
