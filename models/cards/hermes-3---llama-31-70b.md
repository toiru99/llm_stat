...
radar:
  ...
  trust: { s: 23.0, z: -0.24, r: 46.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 12.0, z: -1.17, r: 32.5, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.7 · 출력 $0.7 · 혼합 $0.7/1M · 35.0 t/s · TTFT 2.2s · 128k ctx` · 가성비 7.1
