...
radar:
  ...
  coding: { s: 92.5, z: 1.9, r: 78.5, estimated: false }  # 코딩
  agentic: { s: 85.2, z: 1.9, r: 78.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 63.0 t/s · TTFT 16.0s · 922k ctx`
...
| 코딩 | 78.5 | +1.9 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 60.0%×0.5 |
| 에이전트 | 78.5 | +1.9 | 실측 | [[gdpval]] 48.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 60.0%×1.0 |
