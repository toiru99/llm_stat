...
radar:
  ...
  reasoning: { s: 85.8, z: 2.44, r: 86.5, estimated: false }  # 추론
  coding: { s: 92.5, z: 1.79, r: 76.9, estimated: false }  # 코딩
  agentic: { s: 82.3, z: 1.74, r: 76.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 84.0 t/s · TTFT 15.9s · 922k ctx` · 가성비 12.6
...
| 추론 | 86.5 | +2.44 | 실측 | [[critpt]] 25.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 60.0%×0.5 |
| 에이전트 | 76.2 | +1.74 | 실측 | [[gdpval]] 48.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 37.0%×1.0, [[terminal-bench]] 60.0%×1.0 |
