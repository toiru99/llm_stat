...
is_reasoning: true
radar:
  knowledge: { s: 86.4, z: 2.3, r: 84.4, estimated: false }  # 전문 지식
  reasoning: { s: 83.9, z: 2.48, r: 87.2, estimated: false }  # 추론
  coding: { s: 90.5, z: 1.86, r: 77.8, estimated: false }  # 코딩
  agentic: { s: 82.0, z: 1.75, r: 76.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 84.4 | +2.3 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 45.0%×0.3 |
| 추론 | 87.2 | +2.48 | 실측 | [[critpt]] 25.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 45.0%×1.0 |
| 코딩 | 77.8 | +1.86 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 60.0%×0.5 |
| 에이전트 | 76.2 | +1.75 | 실측 | [[gdpval]] 48.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 37.0%×1.0, [[terminal-bench]] 60.0%×1.0 |
