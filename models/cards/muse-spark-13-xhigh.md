...
radar:
  ...
  reasoning: { s: 86.1, z: 2.46, r: 86.9, estimated: false }  # 추론
  ...
  instruction: { s: 75.1, z: 0.93, r: 64.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.25 · 출력 $4.25 · 혼합 $0.78/1M · 145.0 t/s · TTFT 46.13s · 1M ctx` · 가성비 66.7
...
| 추론 | 86.9 | +2.46 | 실측 | [[critpt]] 26.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 47.0%×1.0 |
