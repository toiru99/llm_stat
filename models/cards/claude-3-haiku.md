...
radar:
  ...
  reasoning: { s: 12.3, z: -1.11, r: 33.3, estimated: false }  # 추론
  coding: { s: 20.9, z: -1.1, r: 33.5, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -1.01, r: 34.8, estimated: false }  # 에이전트
  trust: { s: 18.6, z: -0.29, r: 45.7, estimated: false }  # 신뢰성
  multimodal: { s: 22.5, z: -2.37, r: 14.5, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 37.9 | -0.81 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 37.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 34.8 | -1.01 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 45.7 | -0.29 | 실측 | [[aa-omniscience]] 20.0%×1.0 |
| 멀티모달 | 14.5 | -2.37 | 실측 | [[mmmu-pro]] 31.0%×1.0 |
