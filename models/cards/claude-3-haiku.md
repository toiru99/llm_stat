...
radar:
  ...
  coding: { s: 21.6, z: -1.07, r: 33.9, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -0.98, r: 35.3, estimated: false }  # 에이전트
  trust: { s: 20.9, z: -0.24, r: 46.4, estimated: false }  # 신뢰성
  multimodal: { s: 22.9, z: -2.37, r: 14.5, estimated: false }  # 멀티모달
...
| 코딩 | 33.9 | -1.07 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 35.3 | -0.98 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
