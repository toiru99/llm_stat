...
radar:
  ...
  reasoning: { s: 12.4, z: -1.13, r: 33.1, estimated: false }  # 추론
  coding: { s: 21.6, z: -1.1, r: 33.5, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -1.0, r: 35.0, estimated: false }  # 에이전트
  trust: { s: 20.9, z: -0.31, r: 45.4, estimated: false }  # 신뢰성
  multimodal: { s: 22.9, z: -2.39, r: 14.1, estimated: false }  # 멀티모달
...
| 추론 | 33.1 | -1.13 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 37.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 33.5 | -1.1 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 35.0 | -1.0 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 45.4 | -0.31 | 실측 | [[aa-omniscience]] 20.0%×1.0 |
| 멀티모달 | 14.1 | -2.39 | 실측 | [[mmmu-pro]] 31.0%×1.0 |
