...
radar:
  ...
  reasoning: { s: 12.6, z: -1.09, r: 33.6, estimated: false }  # 추론
  coding: { s: 21.6, z: -1.05, r: 34.2, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -0.97, r: 35.5, estimated: false }  # 에이전트
  trust: { s: 24.1, z: -0.19, r: 47.2, estimated: false }  # 신뢰성
  multimodal: { s: 22.9, z: -2.34, r: 14.9, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 38.1 | -0.8 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 37.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 33.6 | -1.09 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 37.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 34.2 | -1.05 | 실측 | [[scicode]] 19.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 35.5 | -0.97 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 47.2 | -0.19 | 실측 | [[aa-omniscience]] 22.0%×1.0 |
| 멀티모달 | 14.9 | -2.34 | 실측 | [[mmmu-pro]] 31.0%×1.0 |
