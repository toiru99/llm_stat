...
radar:
  ...
  agentic: { s: 21.5, z: -0.61, r: 40.8, estimated: false }  # 에이전트
...
| 코딩 | 40.4 | -0.64 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 40.8 | -0.61 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
