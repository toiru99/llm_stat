...
radar:
  ...
  coding: { s: 32.5, z: -0.57, r: 41.5, estimated: false }  # 코딩
  agentic: { s: 21.5, z: -0.57, r: 41.5, estimated: false }  # 에이전트
...
| 코딩 | 41.5 | -0.57 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 41.5 | -0.57 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
