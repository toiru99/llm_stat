...
radar:
  ...
  long_context: { s: 12.0, z: -1.14, r: 32.9, estimated: true }  # 긴문맥
...
Alibaba · Open · Medium(72B) · 컨텍스트 131k · 종합지능 **4.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.47 · 출력 $0.49 · 혼합 $0.393/1M · None t/s · TTFT Nones · 131k ctx` · 가성비 10.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.6 | -0.69 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
