...
is_reasoning: true
radar:
  knowledge: { s: 47.1, z: 0.3, r: 54.6, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 54.6 | +0.3 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
...
| 에이전트 | 57.0 | +0.47 | 실측 | [[tau2-bench]] 66.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
