...
radar:
  ...
  coding: { s: 58.5, z: 0.42, r: 56.3, estimated: false }  # 코딩
  agentic: { s: 47.7, z: 0.43, r: 56.5, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 54.0 | +0.27 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 56.1 | +0.41 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 56.3 | +0.42 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 56.5 | +0.43 | 실측 | [[tau2-bench]] 66.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
