...
is_reasoning: true
radar:
  knowledge: { s: 46.4, z: 0.31, r: 54.6, estimated: false }  # 전문 지식
  reasoning: { s: 42.9, z: 0.42, r: 56.3, estimated: false }  # 추론
  coding: { s: 56.9, z: 0.43, r: 56.5, estimated: false }  # 코딩
  agentic: { s: 47.7, z: 0.41, r: 56.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 54.6 | +0.31 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 56.3 | +0.42 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 56.5 | +0.43 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 56.2 | +0.41 | 실측 | [[tau2-bench]] 66.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
