...
radar:
  ...
  instruction: { s: 45.6, z: -0.3, r: 45.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.902/1M · 122.0 t/s · TTFT 1.88s · 1M ctx` · 가성비 28.8
...
| 코딩 | 50.8 | +0.05 | 추정 | (추정) |
| 에이전트 | 56.6 | +0.44 | 실측 | [[gdpval]] 41.0%×1.0, [[tau3-banking]] 17.0%×1.0 |
| 신뢰성 | 79.4 | +1.96 | 실측 | [[aa-omniscience]] 66.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 49.1 | -0.06 | 실측 | [[aa-lcr]] 42.0%×1.0 |
| 지시 따르기 | 45.6 | -0.3 | 추정 | (추정) |
