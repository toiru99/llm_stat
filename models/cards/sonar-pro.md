...
radar:
  ...
  reasoning: { s: 34.1, z: -0.04, r: 49.4, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.38, r: 44.4, estimated: false }  # 코딩
  agentic: { s: 22.7, z: -0.53, r: 42.1, estimated: true }  # 에이전트
  trust: { s: 27.4, z: 0.06, r: 50.8, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 47.6 | -0.16 | 실측 | [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 49.4 | -0.04 | 실측 | [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
