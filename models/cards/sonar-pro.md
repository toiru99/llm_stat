...
radar:
  ...
  trust: { s: 9.9, z: -0.67, r: 39.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 63.1, z: 0.42, r: 56.4, estimated: true }  # 긴문맥
  instruction: { s: 58.6, z: 0.27, r: 54.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 49.5 | -0.03 | 실측 | [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
