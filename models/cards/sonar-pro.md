...
radar:
  ...
  reasoning: { s: 33.1, z: -0.09, r: 48.6, estimated: false }  # 추론
  coding: { s: 31.2, z: -0.03, r: 49.5, estimated: true }  # 코딩
  agentic: { s: 35.7, z: -0.07, r: 49.0, estimated: true }  # 에이전트
  trust: { s: 10.7, z: -0.65, r: 40.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 47.2, z: -0.06, r: 49.1, estimated: true }  # 긴문맥
  instruction: { s: 57.7, z: 0.21, r: 53.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
