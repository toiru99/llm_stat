...
is_reasoning: false
radar:
  knowledge: { s: 38.4, z: -0.13, r: 48.0, estimated: false }  # 전문 지식
  ...
  trust: { s: 28.5, z: 0.02, r: 50.2, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 48.0 | -0.13 | 실측 | [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
