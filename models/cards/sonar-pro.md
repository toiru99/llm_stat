...
is_reasoning: false
radar:
  knowledge: { s: 38.4, z: -0.13, r: 48.1, estimated: false }  # 전문 지식
  reasoning: { s: 35.3, z: 0.05, r: 50.7, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.36, r: 44.7, estimated: false }  # 코딩
  agentic: { s: 23.0, z: -0.52, r: 42.2, estimated: true }  # 에이전트
  trust: { s: 28.5, z: 0.02, r: 50.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 40.5, z: -0.26, r: 46.0, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 48.1 | -0.13 | 실측 | [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 50.7 | +0.05 | 실측 | [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
