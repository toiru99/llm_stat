...
radar:
  ...
  agentic: { s: 6.4, z: -1.17, r: 32.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $0.7 · 혼합 $0.25/1M · 1.0 t/s · TTFT 0.75s · 131k ctx` · 가성비 48.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.4 | -0.71 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 42.5 | -0.5 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 42.3 | -0.51 | 실측 | [[scicode]] 21.0%×1.0 |
| 에이전트 | 32.5 | -1.17 | 실측 | [[gdpval]] 2.0%×1.0, [[tau3-banking]] 5.0%×1.0 |
