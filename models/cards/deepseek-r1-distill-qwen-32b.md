...
radar:
  ...
  reasoning: { s: 34.7, z: -0.01, r: 49.8, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.66, r: 59.9, estimated: false }  # 코딩
  agentic: { s: 28.8, z: -0.28, r: 45.7, estimated: true }  # 에이전트
  trust: { s: 30.7, z: 0.21, r: 53.1, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 48.4 | -0.11 | 실측 | [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 49.8 | -0.01 | 실측 | [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
