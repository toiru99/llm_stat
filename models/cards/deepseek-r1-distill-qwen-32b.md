...
radar:
  ...
  reasoning: { s: 34.3, z: -0.08, r: 48.9, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.59, r: 58.9, estimated: false }  # 코딩
  agentic: { s: 31.0, z: -0.24, r: 46.3, estimated: true }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 47.6 | -0.16 | 실측 | [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 48.9 | -0.08 | 실측 | [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
