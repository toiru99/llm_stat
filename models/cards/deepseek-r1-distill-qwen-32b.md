...
radar:
  ...
  reasoning: { s: 34.0, z: -0.04, r: 49.5, estimated: false }  # 추론
  coding: { s: 61.3, z: 0.6, r: 59.0, estimated: false }  # 코딩
  agentic: { s: 21.7, z: -0.61, r: 40.8, estimated: true }  # 에이전트
  trust: { s: 25.8, z: 0.05, r: 50.8, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 48.0 | -0.13 | 실측 | [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 49.5 | -0.04 | 실측 | [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
