...
radar:
  ...
  agentic: { s: 47.1, z: 0.37, r: 55.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.4684/1M · 125.0 t/s · TTFT 14.84s · 256k ctx` · 가성비 10.9
...
| 에이전트 | 55.6 | +0.37 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
