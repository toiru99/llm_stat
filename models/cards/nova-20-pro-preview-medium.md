...
is_reasoning: true
radar:
  knowledge: { s: 40.7, z: -0.02, r: 49.6, estimated: false }  # 전문 지식
  reasoning: { s: 31.6, z: -0.19, r: 47.2, estimated: false }  # 추론
  coding: { s: 59.9, z: 0.47, r: 57.1, estimated: false }  # 코딩
  agentic: { s: 47.9, z: 0.43, r: 56.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.4684/1M · 115.0 t/s · TTFT 13.02s · 256k ctx` · 가성비 15.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.6 | -0.02 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 47.2 | -0.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 57.1 | +0.47 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 56.5 | +0.43 | 실측 | [[gdpval]] 9.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
