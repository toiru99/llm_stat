...
radar:
  ...
  coding: { s: 58.4, z: 0.49, r: 57.4, estimated: false }  # 코딩
  agentic: { s: 47.8, z: 0.42, r: 56.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.4684/1M · 118.0 t/s · TTFT 10.5s · 256k ctx` · 가성비 15.0
...
| 추론 | 47.6 | -0.16 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 57.4 | +0.49 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 24.0%×0.5 |
| 에이전트 | 56.3 | +0.42 | 실측 | [[gdpval]] 9.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[terminal-bench]] 24.0%×1.0 |
