...
radar:
  ...
  agentic: { s: 91.9, z: 2.08, r: 81.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 85.0 t/s · TTFT 162.99s · 1M ctx` · 가성비 16.6
...
| 코딩 | 81.5 | +2.1 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 66.0%×0.5 |
| 에이전트 | 81.2 | +2.08 | 실측 | [[gdpval]] 56.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 44.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
