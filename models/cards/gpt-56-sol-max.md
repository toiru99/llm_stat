...
radar:
  ...
  agentic: { s: 94.5, z: 2.26, r: 83.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 71.0 t/s · TTFT 139.09s · 1M ctx` · 가성비 13.6
...
| 에이전트 | 83.9 | +2.26 | 실측 | [[gdpval]] 61.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 33.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
