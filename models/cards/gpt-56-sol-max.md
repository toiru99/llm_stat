...
radar:
  ...
  reasoning: { s: 95.9, z: 2.91, r: 93.7, estimated: false }  # 추론
  coding: { s: 95.6, z: 1.91, r: 78.6, estimated: false }  # 코딩
  agentic: { s: 92.6, z: 2.12, r: 81.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 73.0 t/s · TTFT 112.71s · 1M ctx` · 가성비 19.8
...
| 추론 | 93.7 | +2.91 | 실측 | [[critpt]] 32.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 49.0%×1.0 |
| 코딩 | 78.6 | +1.91 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 66.0%×0.5 |
