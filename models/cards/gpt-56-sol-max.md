...
is_reasoning: true
radar:
  knowledge: { s: 89.4, z: 2.34, r: 85.0, estimated: false }  # 전문 지식
  reasoning: { s: 93.5, z: 2.81, r: 92.2, estimated: false }  # 추론
  coding: { s: 91.8, z: 2.08, r: 81.2, estimated: false }  # 코딩
  agentic: { s: 91.9, z: 2.08, r: 81.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 87.0 t/s · TTFT 162.99s · 1M ctx` · 가성비 16.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.0 | +2.34 | 실측 | [[aa-omniscience]] 59.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 49.0%×0.3 |
| 추론 | 92.2 | +2.81 | 실측 | [[critpt]] 32.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 49.0%×1.0 |
| 코딩 | 81.2 | +2.08 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 66.0%×0.5 |
| 에이전트 | 81.3 | +2.08 | 실측 | [[gdpval]] 56.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 44.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
