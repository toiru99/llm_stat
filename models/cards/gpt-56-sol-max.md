...
radar:
  ...
  agentic: { s: 97.2, z: 2.36, r: 85.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 63.0 t/s · TTFT 160.71s · 1M ctx`
...
| 에이전트 | 85.5 | +2.36 | 실측 | [[gdpval]] 62.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 33.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
