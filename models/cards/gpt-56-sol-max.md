...
radar:
  ...
  reasoning: { s: 96.2, z: 3.27, r: 99.1, estimated: false }  # 추론
  coding: { s: 95.6, z: 2.07, r: 81.1, estimated: false }  # 코딩
  agentic: { s: 96.9, z: 2.35, r: 85.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 63.0 t/s · TTFT 142.61s · 1M ctx`
...
| 추론 | 99.1 | +3.27 | 실측 | [[critpt]] 32.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 47.0%×1.0 |
| 코딩 | 81.1 | +2.07 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 66.0%×0.5 |
| 에이전트 | 85.2 | +2.35 | 실측 | [[gdpval]] 62.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 33.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
