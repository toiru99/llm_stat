...
radar:
  ...
  agentic: { s: 94.8, z: 2.28, r: 84.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 66.0 t/s · TTFT 147.3s · 1M ctx`
...
| 에이전트 | 84.1 | +2.28 | 실측 | [[gdpval]] 62.0%×1.0, [[itbench]] 56.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 33.0%×1.0, [[terminal-bench]] 66.0%×1.0 |
