...
is_reasoning: true
radar:
  knowledge: { s: 34.0, z: -0.33, r: 45.1, estimated: false }  # 전문 지식
  reasoning: { s: 27.0, z: -0.39, r: 44.2, estimated: false }  # 추론
  coding: { s: 45.1, z: -0.08, r: 48.8, estimated: false }  # 코딩
  agentic: { s: 28.0, z: -0.37, r: 44.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 155.0 t/s · TTFT 38.54s · 400k ctx` · 가성비 355.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.1 | -0.33 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 44.2 | -0.39 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 48.8 | -0.08 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 44.5 | -0.37 | 실측 | [[tau2-bench]] 30.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
