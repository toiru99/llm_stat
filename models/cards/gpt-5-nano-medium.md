...
radar:
  ...
  coding: { s: 46.4, z: -0.01, r: 49.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $None/1M · 168.0 t/s · TTFT 37.11s · 400k ctx`
...
| 코딩 | 49.9 | -0.01 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
