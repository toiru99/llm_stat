...
is_reasoning: true
radar:
  knowledge: { s: 33.0, z: -0.36, r: 44.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.05/1M · 148.0 t/s · TTFT 35.71s · 400k ctx` · 가성비 380.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.7 | -0.36 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
