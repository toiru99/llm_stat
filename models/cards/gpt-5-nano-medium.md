...
radar:
  ...
  coding: { s: 46.4, z: 0.02, r: 50.2, estimated: false }  # 코딩
  agentic: { s: 28.0, z: -0.32, r: 45.3, estimated: false }  # 에이전트
  trust: { s: 58.8, z: 1.45, r: 71.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.05/1M · 149.0 t/s · TTFT 49.74s · 400k ctx` · 가성비 380.0
...
| 코딩 | 50.2 | +0.02 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 45.3 | -0.32 | 실측 | [[tau2-bench]] 30.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
| 신뢰성 | 71.7 | +1.45 | 실측 | [[aa-omniscience]] 51.0%×1.0 |
