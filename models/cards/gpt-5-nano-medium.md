...
radar:
  ...
  reasoning: { s: 27.3, z: -0.4, r: 44.0, estimated: false }  # 추론
  coding: { s: 46.4, z: -0.08, r: 48.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 159.0 t/s · TTFT 47.33s · 400k ctx` · 가성비 355.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.34 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
