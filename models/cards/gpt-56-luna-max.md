...
is_reasoning: true
radar:
  knowledge: { s: 71.7, z: 1.57, r: 73.5, estimated: false }  # 전문 지식
  reasoning: { s: 75.5, z: 2.06, r: 80.9, estimated: false }  # 추론
  coding: { s: 85.5, z: 1.64, r: 74.6, estimated: false }  # 코딩
  agentic: { s: 71.4, z: 1.34, r: 70.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 128.0 t/s · TTFT 154.99s · 1M ctx` · 가성비 298.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.5 | +1.57 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 39.0%×0.3 |
| 추론 | 80.9 | +2.06 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 74.6 | +1.64 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 70.1 | +1.34 | 실측 | [[apex-agents]] 36.0%×1.0, [[gdpval]] 53.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 31.0%×1.0 |
