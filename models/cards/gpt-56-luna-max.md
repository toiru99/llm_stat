...
radar:
  ...
  agentic: { s: 76.5, z: 1.56, r: 73.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $None/1M · 184.0 t/s · TTFT 116.5s · 1M ctx`
...
| 에이전트 | 73.4 | +1.56 | 실측 | [[apex-agents]] 36.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 27.0%×1.0 |
