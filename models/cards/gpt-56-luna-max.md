...
radar:
  ...
  agentic: { s: 72.1, z: 1.39, r: 70.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 152.0 t/s · TTFT 157.72s · 1M ctx` · 가성비 298.9
...
| 에이전트 | 70.9 | +1.39 | 실측 | [[apex-agents]] 36.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 31.0%×1.0 |
