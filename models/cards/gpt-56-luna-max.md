...
is_reasoning: true
radar:
  knowledge: { s: 75.1, z: 1.69, r: 75.4, estimated: false }  # 전문 지식
  reasoning: { s: 77.1, z: 2.32, r: 84.8, estimated: false }  # 추론
  coding: { s: 88.3, z: 1.81, r: 77.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 75.4 | +1.69 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 84.8 | +2.32 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 77.1 | +1.81 | 실측 | [[scicode]] 53.0%×1.0 |
