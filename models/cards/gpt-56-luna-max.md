...
is_reasoning: true
radar:
  knowledge: { s: 75.1, z: 1.66, r: 75.0, estimated: false }  # 전문 지식
  reasoning: { s: 77.1, z: 2.27, r: 84.1, estimated: false }  # 추론
  coding: { s: 88.3, z: 1.77, r: 76.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $None/1M · 199.0 t/s · TTFT 78.97s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.0 | +1.66 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 84.1 | +2.27 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 76.5 | +1.77 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 74.6 | +1.64 | 실측 | [[apex-agents]] 36.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 27.0%×1.0 |
