...
is_reasoning: true
radar:
  knowledge: { s: 75.1, z: 1.69, r: 75.3, estimated: false }  # 전문 지식
  reasoning: { s: 77.1, z: 2.31, r: 84.6, estimated: false }  # 추론
  coding: { s: 88.3, z: 1.79, r: 76.9, estimated: false }  # 코딩
  agentic: { s: 80.0, z: 1.71, r: 75.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 232.0 t/s · TTFT 116.56s · 1M ctx` · 가성비 58.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.3 | +1.69 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 84.6 | +2.31 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 75.6 | +1.71 | 실측 | [[gdpval]] 55.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 27.0%×1.0 |
