...
radar:
  ...
  reasoning: { s: 77.1, z: 2.03, r: 80.5, estimated: false }  # 추론
  coding: { s: 88.3, z: 1.64, r: 74.5, estimated: false }  # 코딩
  agentic: { s: 72.1, z: 1.38, r: 70.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.2 · 혼합 $0.174/1M · 159.0 t/s · TTFT 150.23s · 1M ctx` · 가성비 298.9
...
| 추론 | 80.5 | +2.03 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 74.5 | +1.64 | 실측 | [[scicode]] 53.0%×1.0 |
| 에이전트 | 70.7 | +1.38 | 실측 | [[apex-agents]] 36.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 40.0%×1.0, [[tau3-banking]] 31.0%×1.0 |
