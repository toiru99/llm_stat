...
is_reasoning: true
radar:
  knowledge: { s: 75.1, z: 1.68, r: 75.1, estimated: false }  # 전문 지식
  reasoning: { s: 77.1, z: 2.3, r: 84.5, estimated: false }  # 추론
  coding: { s: 88.3, z: 1.78, r: 76.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.0 · 출력 $6.0 · 혼합 $0.87/1M · 210.0 t/s · TTFT 98.45s · 1M ctx` · 가성비 58.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.1 | +1.68 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 84.5 | +2.3 | 실측 | [[critpt]] 21.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 76.8 | +1.78 | 실측 | [[scicode]] 53.0%×1.0 |
