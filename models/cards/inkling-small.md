...
radar:
  ...
  reasoning: { s: 59.6, z: 1.26, r: 69.0, estimated: false }  # 추론
...
Thinking Machines · Open · Large(266B) · 컨텍스트 262k · 종합지능 **40.0**
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $None/1M · 93.0 t/s · TTFT 1.87s · 262k ctx`
...
| 추론 | 69.0 | +1.26 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
