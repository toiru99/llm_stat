...
radar:
  ...
  reasoning: { s: 59.1, z: 1.13, r: 66.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 116.0 t/s · TTFT 2.31s · 1M ctx` · 가성비 184.7
...
| 추론 | 66.9 | +1.13 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 70.2 | +1.34 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 55.6 | +0.37 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 19.0%×1.0 |
