...
radar:
  ...
  reasoning: { s: 59.4, z: 1.22, r: 68.3, estimated: false }  # 추론
  coding: { s: 81.7, z: 1.42, r: 71.3, estimated: false }  # 코딩
  agentic: { s: 47.0, z: 0.44, r: 56.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 141.0 t/s · TTFT 1.58s · 1M ctx` · 가성비 184.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.3 | +1.02 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 68.3 | +1.22 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 71.3 | +1.42 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 56.6 | +0.44 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 19.0%×1.0 |
