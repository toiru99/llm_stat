...
radar:
  ...
  reasoning: { s: 59.1, z: 1.25, r: 68.7, estimated: false }  # 추론
  ...
  instruction: { s: 81.8, z: 1.24, r: 68.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 74.0 t/s · TTFT 2.37s · 1M ctx` · 가성비 184.7
...
| 추론 | 68.7 | +1.25 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
