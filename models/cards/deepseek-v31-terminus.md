...
radar:
  ...
  reasoning: { s: 37.8, z: 0.15, r: 52.2, estimated: false }  # 추론
  coding: { s: 59.2, z: 0.51, r: 57.7, estimated: false }  # 코딩
  agentic: { s: 37.8, z: 0.01, r: 50.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 55.6 | +0.38 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
...
| 에이전트 | 50.2 | +0.01 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 37.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
