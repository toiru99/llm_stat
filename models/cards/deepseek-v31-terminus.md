...
radar:
  ...
  reasoning: { s: 38.4, z: 0.13, r: 51.9, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.49, r: 57.3, estimated: false }  # 코딩
...
| 추론 | 51.9 | +0.13 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.3 | +0.49 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
