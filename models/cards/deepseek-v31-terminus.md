...
radar:
  ...
  reasoning: { s: 38.4, z: 0.14, r: 52.1, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.51, r: 57.6, estimated: false }  # 코딩
...
| 추론 | 52.1 | +0.14 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.6 | +0.51 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
