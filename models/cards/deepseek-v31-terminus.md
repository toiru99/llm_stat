...
radar:
  ...
  agentic: { s: 37.1, z: 0.04, r: 50.7, estimated: false }  # 에이전트
...
| 추론 | 52.8 | +0.19 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 58.3 | +0.55 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 50.7 | +0.04 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
