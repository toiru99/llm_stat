...
is_reasoning: false
radar:
  knowledge: { s: 50.5, z: 0.49, r: 57.4, estimated: false }  # 전문 지식
  reasoning: { s: 38.4, z: 0.26, r: 53.9, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.62, r: 59.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 57.4 | +0.49 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 53.9 | +0.26 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 59.3 | +0.62 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
