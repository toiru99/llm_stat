...
is_reasoning: false
radar:
  knowledge: { s: 50.5, z: 0.43, r: 56.5, estimated: false }  # 전문 지식
  reasoning: { s: 38.4, z: 0.19, r: 52.8, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.55, r: 58.3, estimated: false }  # 코딩
  agentic: { s: 37.2, z: 0.06, r: 50.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.64 · 출력 $2.75 · 혼합 $0.343/1M · None t/s · TTFT Nones · 128k ctx` · 가성비 87.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.5 | +0.43 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 52.8 | +0.19 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 58.3 | +0.55 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 50.9 | +0.06 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
