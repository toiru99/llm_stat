...
radar:
  ...
  reasoning: { s: 38.7, z: 0.19, r: 52.9, estimated: false }  # 추론
  coding: { s: 60.7, z: 0.56, r: 58.3, estimated: false }  # 코딩
  agentic: { s: 35.6, z: -0.0, r: 49.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 56.0 | +0.4 | 실측 | [[aa-omniscience]] 28.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 52.9 | +0.19 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 58.3 | +0.56 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 49.9 | +-0.0 | 실측 | [[gdpval]] 19.0%×1.0, [[tau2-bench]] 37.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
