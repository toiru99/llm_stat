...
radar:
  ...
  coding: { s: 87.3, z: 1.58, r: 73.7, estimated: true }  # 코딩
  agentic: { s: 84.4, z: 1.83, r: 77.4, estimated: true }  # 에이전트
  trust: { s: 50.9, z: 0.98, r: 64.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 94.5, z: 1.31, r: 69.7, estimated: true }  # 긴문맥
...
| 추론 | 80.6 | +2.04 | 실측 | [[gpqa-diamond]] 76.0%×1.0 |
| 코딩 | 73.7 | +1.58 | 추정 | (추정) |
