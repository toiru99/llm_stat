...
radar:
  ...
  agentic: { s: 24.9, z: -1.07, r: 34.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 135.0 t/s · TTFT 2.58s · 262k ctx` · 가성비 108.3
...
| 에이전트 | 34.0 | -1.07 | 실측 | [[tau2-bench]] 32.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
