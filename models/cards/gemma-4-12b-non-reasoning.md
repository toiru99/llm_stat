...
radar:
  ...
  coding: { s: 38.9, z: -0.4, r: 43.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 116.0 t/s · TTFT 2.29s · 262k ctx` · 가성비 108.3
...
| 코딩 | 43.9 | -0.4 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
