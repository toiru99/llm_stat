...
radar:
  knowledge: { s: 28.1, z: -1.04, r: 34.3, estimated: false }  # 전문 지식
  reasoning: { s: 25.3, z: -0.9, r: 36.4, estimated: false }  # 추론
  coding: { s: 39.2, z: -0.87, r: 36.9, estimated: false }  # 코딩
  agentic: { s: 24.9, z: -1.07, r: 33.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 137.0 t/s · TTFT 2.81s · 262k ctx` · 가성비 108.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 34.3 | -1.04 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
...
| 에이전트 | 33.9 | -1.07 | 실측 | [[tau2-bench]] 32.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
