...
radar:
  ...
  coding: { s: 38.9, z: -0.36, r: 44.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.12/1M · 116.0 t/s · TTFT 2.45s · 262k ctx` · 가성비 108.3
...
| 코딩 | 44.6 | -0.36 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 42.7 | -0.48 | 실측 | [[tau2-bench]] 32.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
