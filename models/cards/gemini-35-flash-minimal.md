...
radar:
  ...
  coding: { s: 77.7, z: 1.33, r: 70.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 137.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 26.7
...
| 코딩 | 70.0 | +1.33 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
