...
radar:
  ...
  reasoning: { s: 44.1, z: 0.56, r: 58.5, estimated: false }  # 추론
  coding: { s: 77.7, z: 1.34, r: 70.1, estimated: false }  # 코딩
  agentic: { s: 64.6, z: 1.11, r: 66.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 152.0 t/s · TTFT 0.95s · 1M ctx` · 가성비 26.7
...
| 추론 | 58.5 | +0.56 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 70.1 | +1.34 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 66.6 | +1.11 | 실측 | [[tau2-bench]] 59.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
