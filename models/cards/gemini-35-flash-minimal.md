...
radar:
  ...
  coding: { s: 77.7, z: 1.2, r: 68.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 154.0 t/s · TTFT 0.8s · 1M ctx` · 가성비 27.6
...
| 추론 | 56.2 | +0.41 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 68.0 | +1.2 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
