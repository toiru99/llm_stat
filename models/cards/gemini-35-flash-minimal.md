...
is_reasoning: false
radar:
  knowledge: { s: 69.1, z: 1.31, r: 69.6, estimated: false }  # 전문 지식
  reasoning: { s: 44.1, z: 0.48, r: 57.2, estimated: false }  # 추론
  coding: { s: 77.7, z: 1.28, r: 69.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $None/1M · 169.0 t/s · TTFT 0.97s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.6 | +1.31 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.2 | +0.48 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 69.1 | +1.28 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
