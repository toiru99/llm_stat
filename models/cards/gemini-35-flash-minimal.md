...
radar:
  ...
  agentic: { s: 64.6, z: 1.14, r: 67.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 147.0 t/s · TTFT 0.92s · 1M ctx` · 가성비 27.6
...
| 추론 | 56.9 | +0.46 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 68.9 | +1.26 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
| 에이전트 | 67.1 | +1.14 | 실측 | [[tau2-bench]] 59.0%×1.0, [[terminal-bench]] 46.0%×1.0 |
