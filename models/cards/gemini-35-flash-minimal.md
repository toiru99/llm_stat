...
radar:
  knowledge: { s: 69.1, z: 0.79, r: 61.9, estimated: false }  # 전문 지식
  reasoning: { s: 44.1, z: -0.02, r: 49.7, estimated: false }  # 추론
  coding: { s: 78.8, z: 0.83, r: 62.5, estimated: false }  # 코딩
  ...
  long_context: { s: 71.6, z: 0.03, r: 50.5, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 177.0 t/s · TTFT 0.93s · 1M ctx` · 가성비 26.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.9 | +0.79 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 49.7 | -0.02 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 62.5 | +0.83 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 46.0%×0.5 |
...
| 긴문맥 | 50.5 | +0.03 | 실측 | [[aa-lcr]] 53.0%×1.0 |
