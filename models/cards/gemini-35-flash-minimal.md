...
radar:
  knowledge: { s: 69.1, z: 0.8, r: 62.1, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.31/1M · 160.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 26.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 62.1 | +0.8 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
