...
is_reasoning: true
radar:
  knowledge: { s: 26.8, z: -0.69, r: 39.6, estimated: false }  # 전문 지식
  reasoning: { s: 26.3, z: -0.46, r: 43.1, estimated: false }  # 추론
  coding: { s: 50.0, z: 0.05, r: 50.7, estimated: false }  # 코딩
  agentic: { s: 15.3, z: -0.84, r: 37.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.25 · 혼합 $0.0475/1M · 139.0 t/s · TTFT 0.63s · 131k ctx` · 가성비 421.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.6 | -0.69 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 43.1 | -0.46 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
| 코딩 | 50.7 | +0.05 | 실측 | [[scicode]] 30.0%×1.0 |
| 에이전트 | 37.3 | -0.84 | 실측 | [[gdpval]] 10.0%×1.0, [[tau3-banking]] 8.0%×1.0 |
