...
radar:
  ...
  agentic: { s: 54.5, z: 0.72, r: 60.7, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 48.1 | -0.12 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
...
| 에이전트 | 60.7 | +0.72 | 실측 | [[tau2-bench]] 78.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
