...
radar:
  ...
  coding: { s: 41.7, z: -0.84, r: 37.4, estimated: false }  # 코딩
  agentic: { s: 55.3, z: 0.11, r: 51.7, estimated: false }  # 에이전트
  trust: { s: 19.8, z: -0.55, r: 41.7, estimated: false }  # 신뢰성
  multimodal: { s: 70.7, z: -0.27, r: 45.9, estimated: false }  # 멀티모달
  long_context: { s: 66.2, z: -0.18, r: 47.4, estimated: false }  # 긴문맥
...
| 코딩 | 37.4 | -0.84 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 20.0%×0.5 |
| 에이전트 | 51.7 | +0.11 | 실측 | [[tau2-bench]] 78.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
| 신뢰성 | 41.7 | -0.55 | 실측 | [[aa-omniscience]] 19.0%×1.0 |
| 멀티모달 | 45.9 | -0.27 | 실측 | [[mmmu-pro]] 67.0%×1.0 |
| 긴문맥 | 47.4 | -0.18 | 실측 | [[aa-lcr]] 49.0%×1.0 |
