...
radar:
  ...
  agentic: { s: 40.8, z: 0.13, r: 51.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 47.2 | -0.19 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
...
| 에이전트 | 51.9 | +0.13 | 실측 | [[gdpval]] 9.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[terminal-bench]] 20.0%×1.0 |
