...
is_reasoning: true
radar:
  knowledge: { s: 37.8, z: -0.13, r: 48.0, estimated: false }  # 전문 지식
  ...
  long_context: { s: 64.5, z: 0.47, r: 57.1, estimated: false }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 48.0 | -0.13 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
...
| 긴문맥 | 57.1 | +0.47 | 실측 | [[aa-lcr]] 49.0%×1.0 |
