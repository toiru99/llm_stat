...
radar:
  ...
  coding: { s: 33.2, z: -0.64, r: 40.5, estimated: false }  # 코딩
  agentic: { s: 1.5, z: -1.38, r: 29.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 40.9 | -0.61 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 40.7 | -0.62 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 61.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 40.5 | -0.64 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 29.4 | -1.38 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
