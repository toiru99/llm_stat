...
radar:
  ...
  reasoning: { s: 45.5, z: 0.55, r: 58.3, estimated: false }  # 추론
  coding: { s: 60.0, z: 0.52, r: 57.8, estimated: false }  # 코딩
  agentic: { s: 64.6, z: 1.09, r: 66.3, estimated: true }  # 에이전트
  trust: { s: 17.8, z: -0.3, r: 45.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 75.7, z: 0.81, r: 62.1, estimated: true }  # 긴문맥
  instruction: { s: 71.1, z: 0.79, r: 61.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 58.3 | +0.55 | 실측 | [[gpqa-diamond]] 70.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
