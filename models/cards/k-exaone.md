...
radar:
  ...
  reasoning: { s: 35.7, z: -0.41, r: 43.8, estimated: false }  # 추론
  coding: { s: 52.2, z: -0.3, r: 45.5, estimated: false }  # 코딩
...
| 추론 | 43.8 | -0.41 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 45.5 | -0.3 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
