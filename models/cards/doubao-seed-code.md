...
is_reasoning: true
radar:
  knowledge: { s: 44.2, z: 0.19, r: 52.9, estimated: false }  # 전문 지식
  reasoning: { s: 33.4, z: -0.05, r: 49.2, estimated: false }  # 추론
  coding: { s: 57.7, z: 0.47, r: 57.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 52.9 | +0.19 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 49.2 | -0.05 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 57.0 | +0.47 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 57.4 | +0.49 | 실측 | [[tau2-bench]] 58.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
