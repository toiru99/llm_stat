...
radar:
  ...
  reasoning: { s: 33.9, z: 0.03, r: 50.4, estimated: false }  # 추론
  coding: { s: 59.2, z: 0.57, r: 58.5, estimated: false }  # 코딩
  agentic: { s: 49.7, z: 0.54, r: 58.0, estimated: false }  # 에이전트
...
| 추론 | 50.4 | +0.03 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 58.5 | +0.57 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 58.0 | +0.54 | 실측 | [[tau2-bench]] 58.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
