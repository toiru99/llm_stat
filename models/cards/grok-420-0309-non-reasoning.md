...
is_reasoning: false
radar:
  knowledge: { s: 49.0, z: 0.43, r: 56.5, estimated: false }  # 전문 지식
  reasoning: { s: 40.5, z: 0.3, r: 54.5, estimated: false }  # 추론
  coding: { s: 45.5, z: -0.05, r: 49.2, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 56.5 | +0.43 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 54.5 | +0.3 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 49.2 | -0.05 | 실측 | [[scicode]] 32.0%×1.0, [[terminal-bench]] 22.0%×0.5 |
| 에이전트 | 58.7 | +0.58 | 실측 | [[tau2-bench]] 70.0%×1.0, [[terminal-bench]] 22.0%×1.0 |
