...
radar:
  ...
  reasoning: { s: 37.6, z: 0.14, r: 52.1, estimated: false }  # 추론
  coding: { s: 62.9, z: 0.67, r: 60.0, estimated: false }  # 코딩
  agentic: { s: 56.8, z: 0.75, r: 61.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 53.3 | +0.22 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
...
| 에이전트 | 61.3 | +0.75 | 실측 | [[tau2-bench]] 63.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
