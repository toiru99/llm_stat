...
radar:
  ...
  reasoning: { s: 38.4, z: 0.27, r: 54.0, estimated: false }  # 추론
  coding: { s: 64.4, z: 0.79, r: 61.9, estimated: false }  # 코딩
  agentic: { s: 56.8, z: 0.81, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 213.0 t/s · TTFT 4.09s · 400k ctx` · 가성비 73.8
...
| 추론 | 54.0 | +0.27 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 61.9 | +0.79 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 62.2 | +0.81 | 실측 | [[tau2-bench]] 63.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
