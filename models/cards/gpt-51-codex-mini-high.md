...
is_reasoning: true
radar:
  knowledge: { s: 46.9, z: 0.31, r: 54.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.42/1M · 207.0 t/s · TTFT 10.25s · 400k ctx` · 가성비 73.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.7 | +0.31 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
