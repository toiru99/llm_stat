...
is_reasoning: true
radar:
  knowledge: { s: 50.2, z: 0.45, r: 56.8, estimated: false }  # 전문 지식
  reasoning: { s: 40.9, z: 0.3, r: 54.5, estimated: false }  # 추론
  coding: { s: 60.3, z: 0.54, r: 58.0, estimated: false }  # 코딩
  agentic: { s: 65.4, z: 1.17, r: 67.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 115.0 t/s · TTFT 6.67s · 1M ctx` · 가성비 56.2
...
| 추론 | 54.5 | +0.3 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 58.0 | +0.54 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 67.6 | +1.17 | 실측 | [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
