...
radar:
  ...
  coding: { s: 60.3, z: 0.47, r: 57.1, estimated: false }  # 코딩
  agentic: { s: 65.4, z: 1.08, r: 66.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 120.0 t/s · TTFT 6.44s · 1M ctx` · 가성비 56.2
...
| 추론 | 53.5 | +0.23 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 57.1 | +0.47 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 66.2 | +1.08 | 실측 | [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
