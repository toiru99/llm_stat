...
radar:
  ...
  agentic: { s: 65.4, z: 1.18, r: 67.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $2.5 · 혼합 $0.64/1M · 125.0 t/s · TTFT 5.67s · 1M ctx` · 가성비 56.2
...
| 에이전트 | 67.7 | +1.18 | 실측 | [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
