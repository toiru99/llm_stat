...
radar:
  ...
  agentic: { s: 47.3, z: 0.4, r: 55.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 58.0 t/s · TTFT 1.2s · 1M ctx` · 가성비 27.9
...
| 추론 | 53.3 | +0.22 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 70.5 | +1.37 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 55.9 | +0.4 | 실측 | [[gdpval]] 43.0%×1.0, [[tau3-banking]] 16.0%×1.0 |
