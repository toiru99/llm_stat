...
radar:
  ...
  reasoning: { s: 39.7, z: 0.32, r: 54.8, estimated: false }  # 추론
  coding: { s: 81.7, z: 1.49, r: 72.4, estimated: false }  # 코딩
  agentic: { s: 56.1, z: 0.77, r: 61.6, estimated: false }  # 에이전트
  ...
  instruction: { s: 69.0, z: 0.69, r: 60.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 61.7 | +0.78 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.8 | +0.32 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 61.6 | +0.77 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
