...
radar:
  ...
  agentic: { s: 50.9, z: -0.01, r: 49.9, estimated: false }  # 에이전트
  ...
  instruction: { s: 70.6, z: 0.09, r: 51.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 에이전트 | 49.9 | -0.01 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
