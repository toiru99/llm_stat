...
is_reasoning: false
radar:
  knowledge: { s: 56.7, z: 0.73, r: 61.0, estimated: false }  # 전문 지식
  reasoning: { s: 39.7, z: 0.27, r: 54.1, estimated: false }  # 추론
  coding: { s: 81.7, z: 1.45, r: 71.8, estimated: false }  # 코딩
  agentic: { s: 52.8, z: 0.64, r: 59.6, estimated: false }  # 에이전트
  trust: { s: 56.3, z: 1.33, r: 69.9, estimated: false }  # 신뢰성
  multimodal: { s: 81.4, z: 0.48, r: 57.2, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 58.0 t/s · TTFT 1.42s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.0 | +0.73 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.1 | +0.27 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 71.8 | +1.45 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 59.6 | +0.64 | 실측 | [[gdpval]] 43.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
