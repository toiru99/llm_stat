...
radar:
  ...
  agentic: { s: 56.1, z: 0.77, r: 61.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 64.5, z: 0.5, r: 57.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 67.0 t/s · TTFT 1.21s · 1M ctx`
