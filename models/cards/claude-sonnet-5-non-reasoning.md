...
radar:
  ...
  reasoning: { s: 39.7, z: 0.27, r: 54.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 65.0 t/s · TTFT 1.41s · 1M ctx`
...
| 추론 | 54.0 | +0.27 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 71.7 | +1.44 | 실측 | [[scicode]] 49.0%×1.0 |
| 에이전트 | 59.7 | +0.64 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
