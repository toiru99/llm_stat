...
is_reasoning: true
radar:
  knowledge: { s: 39.2, z: -0.06, r: 49.1, estimated: false }  # 전문 지식
  reasoning: { s: 32.0, z: -0.08, r: 48.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.0/1M · 98.0 t/s · TTFT 0.31s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.1 | -0.06 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 48.7 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
