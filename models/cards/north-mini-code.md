...
is_reasoning: true
radar:
  knowledge: { s: 38.3, z: -0.12, r: 48.3, estimated: false }  # 전문 지식
  reasoning: { s: 32.4, z: -0.12, r: 48.2, estimated: false }  # 추론
  coding: { s: 57.9, z: 0.44, r: 56.6, estimated: false }  # 코딩
  agentic: { s: 24.8, z: -0.44, r: 43.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 27.0 t/s · TTFT 0.58s · 256k ctx`
...
| 에이전트 | 43.5 | -0.44 | 실측 | [[gdpval]] 2.0%×1.0, [[tau2-bench]] 37.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 31.0%×1.0 |
