...
radar:
  ...
  reasoning: { s: 32.0, z: -0.1, r: 48.6, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 49.0 t/s · TTFT 0.37s · 256k ctx`
...
| 추론 | 48.6 | -0.1 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
