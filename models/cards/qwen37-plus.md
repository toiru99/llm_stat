...
is_reasoning: true
radar:
  knowledge: { s: 53.9, z: 0.65, r: 59.8, estimated: false }  # 전문 지식
  reasoning: { s: 61.6, z: 1.49, r: 72.3, estimated: false }  # 추론
  coding: { s: 73.7, z: 1.17, r: 67.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.27/1M · 53.0 t/s · TTFT 3.04s · 1M ctx` · 가성비 144.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.8 | +0.65 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 33.0%×0.3 |
| 추론 | 72.3 | +1.49 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 67.6 | +1.17 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
