...
is_reasoning: true
radar:
  knowledge: { s: 53.0, z: 0.63, r: 59.5, estimated: false }  # 전문 지식
  reasoning: { s: 60.9, z: 1.32, r: 69.9, estimated: false }  # 추론
  coding: { s: 72.1, z: 1.08, r: 66.2, estimated: false }  # 코딩
  agentic: { s: 55.7, z: 0.72, r: 60.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.268/1M · 57.0 t/s · TTFT 2.19s · 1M ctx` · 가성비 145.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.5 | +0.63 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 69.9 | +1.32 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 66.2 | +1.08 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
