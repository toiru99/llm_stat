...
radar:
  ...
  agentic: { s: 59.4, z: 0.3, r: 54.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.16 · 혼합 $0.25/1M · 49.0 t/s · TTFT 2.81s · 1M ctx` · 가성비 156.0
...
| 에이전트 | 54.4 | +0.3 | 실측 | [[apex-agents]] 22.0%×1.0, [[gdpval]] 22.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
