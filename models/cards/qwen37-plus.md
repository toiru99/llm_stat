...
radar:
  ...
  reasoning: { s: 61.9, z: 0.81, r: 62.2, estimated: false }  # 추론
  coding: { s: 74.9, z: 0.67, r: 60.1, estimated: false }  # 코딩
  agentic: { s: 59.4, z: 0.31, r: 54.6, estimated: false }  # 에이전트
  trust: { s: 88.8, z: 1.93, r: 78.9, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $1.16 · 혼합 $0.25/1M · 48.0 t/s · TTFT 2.96s · 1M ctx` · 가성비 156.0
...
| 추론 | 62.2 | +0.81 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 33.0%×1.0 |
| 코딩 | 60.1 | +0.67 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
| 에이전트 | 54.6 | +0.31 | 실측 | [[apex-agents]] 22.0%×1.0, [[gdpval]] 22.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
| 신뢰성 | 78.9 | +1.93 | 실측 | [[aa-omniscience]] 75.0%×1.0 |
