...
radar:
  ...
  coding: { s: 67.3, z: 1.22, r: 68.4, estimated: false }  # 코딩
  agentic: { s: 55.1, z: 0.68, r: 60.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.268/1M · 55.0 t/s · TTFT 2.21s · 1M ctx` · 가성비 115.7
...
| 코딩 | 68.4 | +1.22 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
| 에이전트 | 60.1 | +0.68 | 실측 | [[apex-agents]] 22.0%×1.0, [[gdpval]] 19.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
