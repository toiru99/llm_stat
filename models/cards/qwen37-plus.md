...
radar:
  ...
  agentic: { s: 55.8, z: 0.79, r: 61.8, estimated: false }  # 에이전트
  trust: { s: 81.4, z: 2.53, r: 88.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.268/1M · 56.0 t/s · TTFT 2.09s · 1M ctx` · 가성비 145.5
...
| 에이전트 | 61.8 | +0.79 | 실측 | [[apex-agents]] 22.0%×1.0, [[gdpval]] 22.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
