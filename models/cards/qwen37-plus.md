...
radar:
  ...
  agentic: { s: 59.4, z: 0.33, r: 55.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 93.0, z: 1.04, r: 65.7, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.4 · 출력 $1.16 · 혼합 $0.25/1M · 50.0 t/s · TTFT 3.01s · 1M ctx` · 가성비 156.0
...
| 에이전트 | 55.0 | +0.33 | 실측 | [[apex-agents]] 22.0%×1.0, [[gdpval]] 22.0%×1.0, [[tau2-bench]] 93.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
| 신뢰성 | 77.0 | +1.8 | 실측 | [[aa-omniscience]] 75.0%×1.0 |
| 멀티모달 | 63.4 | +0.89 | 실측 | [[mmmu-pro]] 80.0%×1.0 |
| 긴문맥 | 59.1 | +0.6 | 실측 | [[aa-lcr]] 65.0%×1.0 |
| 지시 따르기 | 65.7 | +1.04 | 실측 | [[ifbench]] 78.0%×1.0 |
