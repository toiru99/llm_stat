...
radar:
  ...
  long_context: { s: 16.9, z: -1.02, r: 34.8, estimated: false }  # 긴문맥
...
Alibaba · Open · Tiny(4.44B) · 컨텍스트 256k · 종합지능 **4.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 33.3 | -1.11 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 37.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 긴문맥 | 34.8 | -1.02 | 실측 | [[aa-lcr]] 14.0%×1.0 |
