...
radar:
  ...
  reasoning: { s: 47.9, z: 0.66, r: 59.8, estimated: false }  # 추론
  coding: { s: 67.4, z: 0.83, r: 62.5, estimated: false }  # 코딩
  agentic: { s: 79.0, z: 1.73, r: 76.0, estimated: false }  # 에이전트
  trust: { s: 79.3, z: 2.32, r: 84.8, estimated: false }  # 신뢰성
...
| 추론 | 59.8 | +0.66 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 62.5 | +0.83 | 실측 | [[scicode]] 42.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 76.0 | +1.73 | 실측 | [[tau2-bench]] 95.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
| 신뢰성 | 84.8 | +2.32 | 실측 | [[aa-omniscience]] 70.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
