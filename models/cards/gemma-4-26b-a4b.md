...
is_reasoning: true
radar:
  knowledge: { s: 41.3, z: 0.05, r: 50.7, estimated: false }  # 전문 지식
  reasoning: { s: 37.4, z: 0.15, r: 52.2, estimated: false }  # 추론
  coding: { s: 50.1, z: 0.14, r: 52.1, estimated: false }  # 코딩
  agentic: { s: 30.3, z: -0.27, r: 46.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 50.7 | +0.05 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 52.2 | +0.15 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 52.1 | +0.14 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 46.0 | -0.27 | 실측 | [[gdpval]] 14.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 44.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
