...
is_reasoning: false
radar:
  knowledge: { s: 41.8, z: 0.06, r: 51.0, estimated: false }  # 전문 지식
  reasoning: { s: 38.3, z: 0.25, r: 53.8, estimated: false }  # 추론
  coding: { s: 51.5, z: 0.23, r: 53.4, estimated: false }  # 코딩
  agentic: { s: 32.9, z: -0.12, r: 48.1, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 51.0 | +0.06 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 53.8 | +0.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 53.4 | +0.23 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 48.1 | -0.12 | 실측 | [[gdpval]] 13.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 44.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
