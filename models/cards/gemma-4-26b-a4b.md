...
is_reasoning: false
radar:
  knowledge: { s: 41.5, z: 0.02, r: 50.2, estimated: false }  # 전문 지식
  reasoning: { s: 38.2, z: 0.14, r: 52.1, estimated: false }  # 추론
  coding: { s: 51.5, z: 0.14, r: 52.0, estimated: false }  # 코딩
  agentic: { s: 30.1, z: -0.26, r: 46.2, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 50.2 | +0.02 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 52.1 | +0.14 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 52.0 | +0.14 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 46.2 | -0.26 | 실측 | [[gdpval]] 13.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 44.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
