...
radar:
  ...
  reasoning: { s: 37.4, z: 0.13, r: 51.9, estimated: false }  # 추론
  coding: { s: 50.1, z: 0.13, r: 51.9, estimated: false }  # 코딩
  agentic: { s: 30.2, z: -0.28, r: 45.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 50.5 | +0.03 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 51.9 | +0.13 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 51.9 | +0.13 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 45.8 | -0.28 | 실측 | [[gdpval]] 14.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 44.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
