...
is_reasoning: false
radar:
  knowledge: { s: 41.5, z: 0.01, r: 50.2, estimated: false }  # 전문 지식
  reasoning: { s: 38.2, z: 0.13, r: 52.0, estimated: false }  # 추론
  coding: { s: 51.5, z: 0.13, r: 51.9, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 50.2 | +0.01 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 52.0 | +0.13 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 51.9 | +0.13 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
