...
radar:
  ...
  agentic: { s: 31.6, z: -0.8, r: 38.0, estimated: false }  # 에이전트
...
| 에이전트 | 38.0 | -0.8 | 실측 | [[gdpval]] 11.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 44.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
