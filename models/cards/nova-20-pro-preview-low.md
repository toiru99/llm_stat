...
radar:
  ...
  reasoning: { s: 28.0, z: -0.33, r: 45.0, estimated: false }  # 추론
  coding: { s: 51.9, z: 0.18, r: 52.7, estimated: false }  # 코딩
  agentic: { s: 43.3, z: 0.25, r: 53.8, estimated: false }  # 에이전트
  trust: { s: 28.9, z: 0.23, r: 53.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · 122.0 t/s · TTFT 11.54s · 256k ctx` · 가성비 9.4
