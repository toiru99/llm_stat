...
radar:
  ...
  agentic: { s: 43.2, z: 0.22, r: 53.4, estimated: false }  # 에이전트
  trust: { s: 32.6, z: 0.16, r: 52.3, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · 120.0 t/s · TTFT 10.89s · 256k ctx` · 가성비 9.4
...
| 추론 | 44.2 | -0.38 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 51.9 | +0.13 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 53.4 | +0.22 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
| 신뢰성 | 52.3 | +0.16 | 실측 | [[aa-omniscience]] 30.0%×1.0 |
