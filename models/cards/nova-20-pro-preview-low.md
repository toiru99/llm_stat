...
radar:
  ...
  reasoning: { s: 28.4, z: -0.26, r: 46.0, estimated: false }  # 추론
  coding: { s: 51.9, z: 0.26, r: 53.9, estimated: false }  # 코딩
  agentic: { s: 39.0, z: 0.12, r: 51.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.13/1M · 119.0 t/s · TTFT 12.68s · 256k ctx` · 가성비 9.4
...
| 추론 | 46.0 | -0.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 53.9 | +0.26 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 51.8 | +0.12 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
