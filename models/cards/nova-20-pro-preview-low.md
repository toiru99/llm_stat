...
radar:
  ...
  reasoning: { s: 28.4, z: -0.28, r: 45.7, estimated: false }  # 추론
  coding: { s: 51.9, z: 0.23, r: 53.4, estimated: false }  # 코딩
  agentic: { s: 39.5, z: 0.12, r: 51.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 123.0 t/s · TTFT 12.44s · 256k ctx`
...
| 추론 | 45.7 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 53.4 | +0.23 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 51.9 | +0.12 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
