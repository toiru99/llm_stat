...
is_reasoning: true
radar:
  knowledge: { s: 40.2, z: -0.06, r: 49.1, estimated: false }  # 전문 지식
  reasoning: { s: 28.4, z: -0.32, r: 45.2, estimated: false }  # 추론
  coding: { s: 51.9, z: 0.19, r: 52.9, estimated: false }  # 코딩
  agentic: { s: 37.7, z: 0.08, r: 51.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.125/1M · 121.0 t/s · TTFT 11.63s · 256k ctx` · 가성비 9.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.1 | -0.06 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 45.2 | -0.32 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 52.9 | +0.19 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 51.2 | +0.08 | 실측 | [[gdpval]] 8.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
