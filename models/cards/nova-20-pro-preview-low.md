...
radar:
  ...
  coding: { s: 51.9, z: 0.24, r: 53.6, estimated: false }  # 코딩
  agentic: { s: 39.0, z: 0.11, r: 51.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.13/1M · 125.0 t/s · TTFT 12.16s · 256k ctx` · 가성비 9.4
...
| 코딩 | 53.6 | +0.24 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 51.6 | +0.11 | 실측 | [[gdpval]] 7.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
