...
is_reasoning: false
radar:
  knowledge: { s: 38.6, z: -0.09, r: 48.7, estimated: false }  # 전문 지식
  reasoning: { s: 30.1, z: -0.18, r: 47.3, estimated: false }  # 추론
  coding: { s: 37.5, z: -0.36, r: 44.5, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 48.7 | -0.09 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 47.3 | -0.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 44.5 | -0.36 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
