...
radar:
  ...
  reasoning: { s: 30.1, z: -0.18, r: 47.4, estimated: false }  # 추론
  coding: { s: 37.5, z: -0.36, r: 44.6, estimated: false }  # 코딩
...
| 추론 | 47.4 | -0.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 44.6 | -0.36 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 6.0%×0.5 |
