...
radar:
  ...
  reasoning: { s: 19.3, z: -0.8, r: 38.0, estimated: false }  # 추론
  coding: { s: 42.4, z: -0.25, r: 46.2, estimated: false }  # 코딩
...
| 추론 | 38.0 | -0.8 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 56.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 46.2 | -0.25 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
