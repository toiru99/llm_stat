...
radar:
  ...
  reasoning: { s: 19.5, z: -0.77, r: 38.5, estimated: false }  # 추론
  coding: { s: 42.4, z: -0.21, r: 46.9, estimated: false }  # 코딩
  agentic: { s: 10.9, z: -1.0, r: 35.0, estimated: false }  # 에이전트
...
| 코딩 | 46.9 | -0.21 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 35.0 | -1.0 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
