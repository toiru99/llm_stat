...
is_reasoning: true
radar:
  knowledge: { s: 57.7, z: 0.78, r: 61.8, estimated: false }  # 전문 지식
  reasoning: { s: 47.0, z: 0.56, r: 58.4, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 61.8 | +0.78 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 58.4 | +0.56 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 58.3 | +0.55 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 18.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
