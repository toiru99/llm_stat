...
is_reasoning: true
radar:
  knowledge: { s: 59.2, z: 0.91, r: 63.6, estimated: false }  # 전문 지식
  reasoning: { s: 46.0, z: 0.66, r: 59.8, estimated: false }  # 추론
  coding: { s: 61.5, z: 0.65, r: 59.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 63.6 | +0.91 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 22.0%×0.3 |
| 추론 | 59.8 | +0.66 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 59.7 | +0.65 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
