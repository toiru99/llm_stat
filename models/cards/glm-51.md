...
radar:
  ...
  agentic: { s: 67.3, z: 0.6, r: 59.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.9/1M · 88.0 t/s · TTFT 1.53s · 200k ctx` · 가성비 44.4
...
| 에이전트 | 59.1 | +0.6 | 실측 | [[gdpval]] 38.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
