...
radar:
  ...
  agentic: { s: 66.3, z: 1.16, r: 67.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $None/1M · 84.0 t/s · TTFT 1.47s · 200k ctx`
...
| 에이전트 | 67.5 | +1.16 | 실측 | [[gdpval]] 38.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
