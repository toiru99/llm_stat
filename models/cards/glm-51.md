...
is_reasoning: false
radar:
  knowledge: { s: 53.3, z: 0.63, r: 59.4, estimated: false }  # 전문 지식
  reasoning: { s: 53.1, z: 1.04, r: 65.6, estimated: false }  # 추론
  coding: { s: 70.6, z: 1.04, r: 65.6, estimated: false }  # 코딩
  agentic: { s: 66.3, z: 1.17, r: 67.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.9/1M · 83.0 t/s · TTFT 1.47s · 200k ctx` · 가성비 44.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.4 | +0.63 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
