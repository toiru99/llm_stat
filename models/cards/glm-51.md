...
radar:
  ...
  agentic: { s: 63.8, z: 1.11, r: 66.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.38 · 출력 $4.4 · 혼합 $0.898/1M · 65.0 t/s · TTFT 1.4s · 200k ctx` · 가성비 45.7
...
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 38.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
