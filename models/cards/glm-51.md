...
radar:
  knowledge: { s: 53.3, z: 0.08, r: 51.3, estimated: false }  # 전문 지식
  ...
  long_context: { s: 83.8, z: 0.47, r: 57.0, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.9/1M · 94.0 t/s · TTFT 1.55s · 200k ctx` · 가성비 44.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.3 | +0.08 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
...
| 에이전트 | 59.0 | +0.6 | 실측 | [[gdpval]] 38.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
| 신뢰성 | 76.4 | +1.76 | 실측 | [[aa-omniscience]] 71.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 57.0 | +0.47 | 실측 | [[aa-lcr]] 62.0%×1.0 |
