...
is_reasoning: false
radar:
  knowledge: { s: 52.2, z: 0.55, r: 58.2, estimated: false }  # 전문 지식
  reasoning: { s: 53.7, z: 0.93, r: 64.0, estimated: false }  # 추론
  coding: { s: 70.6, z: 0.97, r: 64.5, estimated: false }  # 코딩
  agentic: { s: 63.8, z: 1.12, r: 66.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.38 · 출력 $4.4 · 혼합 $0.898/1M · 73.0 t/s · TTFT 1.39s · 200k ctx` · 가성비 45.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 58.2 | +0.55 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 30.0%×0.3 |
| 추론 | 64.0 | +0.93 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
| 코딩 | 64.5 | +0.97 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
| 에이전트 | 66.8 | +1.12 | 실측 | [[gdpval]] 38.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 98.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
