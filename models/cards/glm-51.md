...
radar:
  ...
  coding: { s: 71.6, z: 0.54, r: 58.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.9/1M · 77.0 t/s · TTFT 1.41s · 200k ctx` · 가성비 44.4
...
| 코딩 | 58.0 | +0.54 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
