...
radar:
  ...
  coding: { s: 11.1, z: -1.49, r: 27.7, estimated: false }  # 코딩
  ...
  instruction: { s: 14.1, z: -1.6, r: 26.0, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.03 · 출력 $0.25 · 혼합 $None/1M · 354.0 t/s · TTFT 27.18s · 128k ctx`
...
| 코딩 | 27.7 | -1.49 | 실측 | [[scicode]] 10.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
...
| 지시 따르기 | 26.0 | -1.6 | 실측 | [[ifbench]] 22.0%×1.0 |
