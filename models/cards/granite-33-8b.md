...
is_reasoning: false
radar:
  knowledge: { s: 15.6, z: -1.2, r: 32.0, estimated: false }  # 전문 지식
  ...
  instruction: { s: 14.1, z: -1.58, r: 26.4, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
IBM · Open · Unknown · 컨텍스트 128k · 종합지능 **2.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.03 · 출력 $0.25 · 혼합 $0.05/1M · 347.0 t/s · TTFT 26.89s · 128k ctx` · 가성비 40.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 32.0 | -1.2 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 34.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 지시 따르기 | 26.4 | -1.58 | 실측 | [[ifbench]] 22.0%×1.0 |
