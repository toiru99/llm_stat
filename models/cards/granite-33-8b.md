...
radar:
  ...
  instruction: { s: 14.1, z: -1.59, r: 26.1, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.03 · 출력 $0.25 · 혼합 $None/1M · 345.0 t/s · TTFT 26.84s · 128k ctx`
...
| 에이전트 | 32.1 | -1.2 | 실측 | [[tau2-bench]] 11.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 35.3 | -0.98 | 실측 | [[aa-omniscience]] 7.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 30.6 | -1.29 | 실측 | [[aa-lcr]] 4.0%×1.0 |
| 지시 따르기 | 26.1 | -1.59 | 실측 | [[ifbench]] 22.0%×1.0 |
