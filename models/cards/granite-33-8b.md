...
radar:
  ...
  reasoning: { s: 11.0, z: -1.16, r: 32.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.03 · 출력 $0.25 · 혼합 $0.052/1M · 16.0 t/s · TTFT 26.08s · 128k ctx` · 가성비 19.2
...
| 추론 | 32.7 | -1.16 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 34.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
