...
is_reasoning: false
radar:
  knowledge: { s: 16.7, z: -1.19, r: 32.1, estimated: false }  # 전문 지식
  reasoning: { s: 11.3, z: -1.17, r: 32.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.03 · 출력 $0.25 · 혼합 $0.052/1M · 15.0 t/s · TTFT 27.1s · 128k ctx` · 가성비 19.2
...
| 추론 | 32.4 | -1.17 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 34.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
