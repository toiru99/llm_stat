...
radar:
  ...
  long_context: { s: 50.0, z: 0.02, r: 50.2, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 62.0 t/s · TTFT 0.93s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.7 | +0.25 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.0 | -0.27 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 58.5 | +0.57 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
...
| 긴문맥 | 50.2 | +0.02 | 실측 | [[aa-lcr]] 38.0%×1.0 |
