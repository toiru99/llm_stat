...
radar:
  ...
  coding: { s: 60.6, z: 0.55, r: 58.3, estimated: false }  # 코딩
  agentic: { s: 38.8, z: 0.12, r: 51.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 71.0 t/s · TTFT 1.19s · 400k ctx` · 가성비 14.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.5 | +0.3 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 46.1 | -0.26 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 58.3 | +0.55 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
| 에이전트 | 51.9 | +0.12 | 실측 | [[tau2-bench]] 46.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 32.0%×1.0 |
