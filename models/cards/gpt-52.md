...
radar:
  ...
  coding: { s: 60.6, z: 0.6, r: 58.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 64.0 t/s · TTFT 1.02s · 400k ctx`
...
| 코딩 | 58.9 | +0.6 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
