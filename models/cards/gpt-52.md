...
radar:
  ...
  coding: { s: 60.6, z: 0.6, r: 59.1, estimated: false }  # 코딩
  ...
  long_context: { s: 50.0, z: 0.04, r: 50.6, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.87/1M · 64.0 t/s · TTFT 0.88s · 400k ctx` · 가성비 13.9
...
| 코딩 | 59.1 | +0.6 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
...
| 긴문맥 | 50.6 | +0.04 | 실측 | [[aa-lcr]] 38.0%×1.0 |
