...
radar:
  ...
  coding: { s: 60.6, z: 0.5, r: 57.5, estimated: false }  # 코딩
  agentic: { s: 38.8, z: 0.08, r: 51.2, estimated: false }  # 에이전트
  trust: { s: 41.9, z: 0.64, r: 59.6, estimated: false }  # 신뢰성
  multimodal: { s: 72.9, z: 0.02, r: 50.4, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $1.8725/1M · 68.0 t/s · TTFT 1.02s · 400k ctx` · 가성비 14.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.9 | +0.26 | 실측 | [[aa-omniscience]] 31.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 45.5 | -0.3 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 57.5 | +0.5 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 32.0%×0.5 |
...
| 멀티모달 | 50.4 | +0.02 | 실측 | [[mmmu-pro]] 66.0%×1.0 |
