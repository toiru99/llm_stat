...
is_reasoning: false
radar:
  knowledge: { s: 46.6, z: 0.28, r: 54.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.75 · 출력 $14.0 · 혼합 $None/1M · 76.0 t/s · TTFT 0.97s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.2 | +0.28 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
