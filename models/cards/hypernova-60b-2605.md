...
radar:
  ...
  coding: { s: 48.3, z: 0.03, r: 50.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $0.05/1M · 353.0 t/s · TTFT 0.86s · 131k ctx` · 가성비 360.0
...
| 코딩 | 50.4 | +0.03 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
