...
radar:
  ...
  reasoning: { s: 35.0, z: 0.06, r: 51.0, estimated: false }  # 추론
  coding: { s: 48.3, z: 0.08, r: 51.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $None/1M · 398.0 t/s · TTFT 0.71s · 131k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.0 | -0.27 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 51.0 | +0.06 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 51.1 | +0.08 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
