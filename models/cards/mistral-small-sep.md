...
radar:
  ...
  trust: { s: 18.7, z: -0.42, r: 43.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.0, z: -0.92, r: 36.2, estimated: true }  # 긴문맥
  instruction: { s: 31.7, z: -0.87, r: 36.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $None/1M · 147.0 t/s · TTFT 0.75s · 32k ctx`
