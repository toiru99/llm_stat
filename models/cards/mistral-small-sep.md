...
radar:
  ...
  agentic: { s: 7.3, z: -1.12, r: 33.1, estimated: true }  # 에이전트
  trust: { s: 18.7, z: -0.41, r: 43.8, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $None/1M · 150.0 t/s · TTFT 0.78s · 32k ctx`
