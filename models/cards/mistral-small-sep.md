...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 159.0 t/s · TTFT 0.82s · 32k ctx` · 가성비 20.8
...
| 에이전트 | 33.3 | -1.12 | 추정 | (추정) |
| 신뢰성 | 42.1 | -0.53 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 38.9 | -0.74 | 추정 | (추정) |
| 지시 따르기 | 43.6 | -0.42 | 추정 | (추정) |
