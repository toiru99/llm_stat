...
radar:
  ...
  agentic: { s: 7.8, z: -1.14, r: 32.9, estimated: true }  # 에이전트
  trust: { s: 31.2, z: 0.14, r: 52.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.2, z: -1.04, r: 34.4, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 153.0 t/s · TTFT 0.89s · 32k ctx` · 가성비 16.7
...
| 추론 | 38.0 | -0.8 | 실측 | [[gpqa-diamond]] 38.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
