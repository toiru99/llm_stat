...
radar:
  ...
  agentic: { s: 7.5, z: -1.12, r: 33.2, estimated: true }  # 에이전트
  trust: { s: 16.7, z: -0.52, r: 42.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 23.3, z: -0.75, r: 38.7, estimated: true }  # 긴문맥
  instruction: { s: 42.0, z: -0.44, r: 43.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $None/1M · 149.0 t/s · TTFT 0.89s · 32k ctx`
