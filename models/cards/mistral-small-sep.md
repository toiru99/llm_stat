...
is_reasoning: false
radar:
  knowledge: { s: 21.0, z: -0.96, r: 35.5, estimated: false }  # 전문 지식
  reasoning: { s: 19.1, z: -0.78, r: 38.3, estimated: false }  # 추론
  coding: { s: 25.8, z: -0.89, r: 36.6, estimated: false }  # 코딩
  agentic: { s: 5.7, z: -1.23, r: 31.5, estimated: true }  # 에이전트
  trust: { s: 26.4, z: 0.08, r: 51.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.4, z: -0.79, r: 38.2, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $0.6 · 혼합 $0.24/1M · 144.0 t/s · TTFT 0.85s · 32k ctx` · 가성비 16.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 35.5 | -0.96 | 실측 | [[gpqa-diamond]] 38.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
