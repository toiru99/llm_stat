...
radar:
  ...
  coding: { s: 73.5, z: 1.14, r: 67.0, estimated: true }  # 코딩
  agentic: { s: 64.5, z: 1.09, r: 66.3, estimated: false }  # 에이전트
  trust: { s: 42.6, z: 0.69, r: 60.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 85.8, z: 1.09, r: 66.4, estimated: true }  # 긴문맥
  instruction: { s: 73.3, z: 0.85, r: 62.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 65.0 t/s · TTFT 1.85s · 1M ctx`
...
| 추론 | 67.2 | +1.14 | 추정 | (추정) |
| 코딩 | 67.0 | +1.14 | 추정 | (추정) |
| 에이전트 | 66.3 | +1.09 | 실측 | [[gdpval]] 40.0%×1.0 |
| 신뢰성 | 60.4 | +0.69 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 66.4 | +1.09 | 추정 | (추정) |
