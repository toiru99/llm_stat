...
is_reasoning: true
radar:
  knowledge: { s: 64.2, z: 1.09, r: 66.3, estimated: true }  # 전문 지식
  reasoning: { s: 58.9, z: 1.12, r: 66.8, estimated: true }  # 추론
  coding: { s: 70.9, z: 0.9, r: 63.5, estimated: true }  # 코딩
  agentic: { s: 59.7, z: 0.86, r: 63.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 65.0 t/s · TTFT 3.09s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.3 | +1.09 | 추정 | (추정) |
| 추론 | 66.8 | +1.12 | 추정 | (추정) |
| 코딩 | 63.5 | +0.9 | 추정 | (추정) |
| 에이전트 | 63.0 | +0.86 | 실측 | [[gdpval]] 40.0%×1.0 |
| 신뢰성 | 55.7 | +0.38 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 64.6 | +0.97 | 추정 | (추정) |
