...
radar:
  ...
  coding: { s: 72.9, z: 1.14, r: 67.0, estimated: true }  # 코딩
  agentic: { s: 63.5, z: 1.07, r: 66.0, estimated: false }  # 에이전트
  trust: { s: 24.5, z: -0.16, r: 47.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 89.5, z: 1.22, r: 68.3, estimated: true }  # 긴문맥
  instruction: { s: 78.5, z: 1.08, r: 66.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 60.0 t/s · TTFT 1.77s · 1M ctx`
