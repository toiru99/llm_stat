...
is_reasoning: true
radar:
  knowledge: { s: 46.4, z: 0.27, r: 54.0, estimated: true }  # 전문 지식
  reasoning: { s: 39.2, z: 0.2, r: 53.0, estimated: true }  # 추론
  coding: { s: 43.3, z: 0.4, r: 56.0, estimated: true }  # 코딩
  agentic: { s: 57.1, z: 0.75, r: 61.3, estimated: false }  # 에이전트
  trust: { s: 40.4, z: 0.76, r: 61.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 73.7, z: 0.76, r: 61.4, estimated: true }  # 긴문맥
  instruction: { s: 70.1, z: 0.74, r: 61.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 68.0 t/s · TTFT 3.08s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.0 | +0.27 | 추정 | (추정) |
| 추론 | 53.0 | +0.2 | 추정 | (추정) |
| 코딩 | 56.0 | +0.4 | 추정 | (추정) |
