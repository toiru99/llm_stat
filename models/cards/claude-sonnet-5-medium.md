...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 63.0 t/s · TTFT 2.06s · 1M ctx`
...
| 추론 | 67.2 | +1.15 | 추정 | (추정) |
| 코딩 | 67.1 | +1.14 | 추정 | (추정) |
| 에이전트 | 66.4 | +1.09 | 실측 | [[gdpval]] 40.0%×1.0 |
| 신뢰성 | 60.2 | +0.68 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 66.4 | +1.09 | 추정 | (추정) |
