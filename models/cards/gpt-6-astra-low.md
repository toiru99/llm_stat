...
is_reasoning: true
radar:
  knowledge: { s: 90.0, z: 2.37, r: 85.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.7/1M · 86.0 t/s · TTFT 6.64s · 1M ctx` · 가성비 6.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.5 | +2.37 | 실측 | [[aa-omniscience]] 60.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 49.0%×0.3 |
