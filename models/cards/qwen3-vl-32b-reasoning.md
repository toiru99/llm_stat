...
is_reasoning: true
radar:
  knowledge: { s: 35.8, z: -0.24, r: 46.3, estimated: false }  # 전문 지식
  reasoning: { s: 30.3, z: -0.21, r: 46.8, estimated: false }  # 추론
  coding: { s: 35.2, z: -0.52, r: 42.2, estimated: false }  # 코딩
  agentic: { s: 29.3, z: -0.3, r: 45.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 87.0 t/s · TTFT 2.66s · 256k ctx` · 가성비 86.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.3 | -0.24 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
...
| 에이전트 | 45.6 | -0.3 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
