...
radar:
  ...
  instruction: { s: 75.6, z: 0.9, r: 63.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $4.05 · 혼합 $0.724/1M · 77.0 t/s · TTFT 1.86s · 1M ctx` · 가성비 58.0
...
| 에이전트 | 62.0 | +0.8 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
