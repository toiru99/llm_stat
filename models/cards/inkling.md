...
radar:
  ...
  reasoning: { s: 53.2, z: 0.94, r: 64.1, estimated: false }  # 추론
  coding: { s: 74.2, z: 1.16, r: 67.5, estimated: false }  # 코딩
  agentic: { s: 55.6, z: 0.72, r: 60.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $4.05 · 혼합 $0.724/1M · 74.0 t/s · TTFT 2.41s · 1M ctx` · 가성비 58.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.4 | +1.36 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
