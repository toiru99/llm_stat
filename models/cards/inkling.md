...
radar:
  ...
  reasoning: { s: 54.5, z: 0.93, r: 64.0, estimated: false }  # 추론
  ...
  instruction: { s: 77.5, z: 0.94, r: 64.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $4.05 · 혼합 $0.724/1M · 69.0 t/s · TTFT 1.82s · 1M ctx` · 가성비 58.0
...
| 추론 | 64.0 | +0.93 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 67.4 | +1.16 | 실측 | [[scicode]] 46.0%×1.0 |
| 에이전트 | 61.3 | +0.75 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
