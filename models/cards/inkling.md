...
radar:
  ...
  instruction: { s: 74.5, z: 0.88, r: 63.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $4.05 · 혼합 $0.724/1M · 85.0 t/s · TTFT 1.83s · 1M ctx` · 가성비 56.6
...
| 에이전트 | 65.2 | +1.01 | 실측 | [[gdpval]] 37.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
