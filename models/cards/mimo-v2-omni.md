...
is_reasoning: true
radar:
  knowledge: { s: 43.3, z: 0.13, r: 52.0, estimated: false }  # 전문 지식
  reasoning: { s: 41.7, z: 0.34, r: 55.2, estimated: false }  # 추론
  coding: { s: 57.5, z: 0.44, r: 56.6, estimated: false }  # 코딩
  agentic: { s: 72.5, z: 1.36, r: 70.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 52.0 | +0.13 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 22.0%×0.3 |
| 추론 | 55.2 | +0.34 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 56.6 | +0.44 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 70.4 | +1.36 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
