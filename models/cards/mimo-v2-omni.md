...
radar:
  ...
  agentic: { s: 72.5, z: 1.46, r: 71.9, estimated: false }  # 에이전트
...
| 코딩 | 57.1 | +0.48 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 71.9 | +1.46 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
