...
radar:
  ...
  agentic: { s: 84.5, z: 1.88, r: 78.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 115.0 t/s · TTFT 204.34s · 1M ctx` · 가성비 32.8
...
| 에이전트 | 78.2 | +1.88 | 실측 | [[apex-agents]] 39.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 51.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 40.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
