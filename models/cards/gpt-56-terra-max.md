...
radar:
  ...
  reasoning: { s: 89.7, z: 2.65, r: 89.7, estimated: false }  # 추론
  coding: { s: 89.3, z: 1.67, r: 75.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 120.0 t/s · TTFT 203.25s · 1M ctx` · 가성비 32.8
...
| 추론 | 89.7 | +2.65 | 실측 | [[critpt]] 30.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 75.1 | +1.67 | 실측 | [[scicode]] 54.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 78.0 | +1.87 | 실측 | [[apex-agents]] 39.0%×1.0, [[gdpval]] 54.0%×1.0, [[itbench]] 51.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 40.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
