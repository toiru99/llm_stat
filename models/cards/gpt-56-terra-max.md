...
is_reasoning: true
radar:
  knowledge: { s: 81.3, z: 1.99, r: 79.9, estimated: false }  # 전문 지식
  reasoning: { s: 90.5, z: 3.03, r: 95.5, estimated: false }  # 추론
  coding: { s: 89.3, z: 1.85, r: 77.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 79.9 | +1.99 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 95.5 | +3.03 | 실측 | [[critpt]] 30.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 77.7 | +1.85 | 실측 | [[scicode]] 54.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
