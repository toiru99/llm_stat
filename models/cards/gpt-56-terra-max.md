...
radar:
  ...
  coding: { s: 85.1, z: 1.86, r: 77.9, estimated: false }  # 코딩
  agentic: { s: 83.8, z: 1.77, r: 76.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 111.0 t/s · TTFT 244.78s · 1M ctx` · 가성비 27.0
...
| 코딩 | 77.9 | +1.86 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 76.6 | +1.77 | 실측 | [[apex-agents]] 39.0%×1.0, [[gdpval]] 49.0%×1.0, [[itbench]] 51.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 40.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
