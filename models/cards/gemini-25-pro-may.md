...
radar:
  ...
  reasoning: { s: 59.9, z: 1.17, r: 67.6, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.87, r: 63.0, estimated: false }  # 코딩
  agentic: { s: 54.8, z: 0.67, r: 60.1, estimated: true }  # 에이전트
  trust: { s: 45.1, z: 0.69, r: 60.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 87.7, z: 1.1, r: 66.6, estimated: true }  # 긴문맥
  instruction: { s: 79.1, z: 1.01, r: 65.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 67.6 | +1.17 | 실측 | [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
