...
radar:
  ...
  agentic: { s: 58.0, z: 0.84, r: 62.6, estimated: true }  # 에이전트
  trust: { s: 52.6, z: 1.14, r: 67.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 79.0, z: 0.87, r: 63.0, estimated: true }  # 긴문맥
  instruction: { s: 75.3, z: 0.86, r: 62.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
