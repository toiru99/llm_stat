...
is_reasoning: false
radar:
  knowledge: { s: 9.2, z: -1.55, r: 26.8, estimated: false }  # 전문 지식
  reasoning: { s: 7.4, z: -1.36, r: 29.7, estimated: false }  # 추론
  coding: { s: 4.3, z: -1.8, r: 23.0, estimated: false }  # 코딩
  agentic: { s: 7.6, z: -1.15, r: 32.7, estimated: false }  # 에이전트
...
| 추론 | 29.7 | -1.36 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 23.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 23.0 | -1.8 | 실측 | [[scicode]] 4.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 32.7 | -1.15 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
