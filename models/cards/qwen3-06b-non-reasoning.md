...
is_reasoning: false
radar:
  knowledge: { s: 9.2, z: -1.53, r: 27.0, estimated: false }  # 전문 지식
  reasoning: { s: 7.3, z: -1.33, r: 30.0, estimated: false }  # 추론
  coding: { s: 0.0, z: -1.12, r: 33.2, estimated: false }  # 코딩
  agentic: { s: 7.6, z: -1.14, r: 32.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 27.0 | -1.53 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 23.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.0 | -1.33 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 23.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 33.2 | -1.12 | 실측 | [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 32.8 | -1.14 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
