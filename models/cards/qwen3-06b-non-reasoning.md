...
radar:
  ...
  reasoning: { s: 7.4, z: -1.35, r: 29.7, estimated: false }  # 추론
  coding: { s: 4.3, z: -1.8, r: 23.1, estimated: false }  # 코딩
  agentic: { s: 7.6, z: -1.16, r: 32.6, estimated: false }  # 에이전트
...
| 에이전트 | 32.6 | -1.16 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
