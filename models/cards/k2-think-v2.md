...
is_reasoning: true
radar:
  knowledge: { s: 34.5, z: -0.32, r: 45.1, estimated: false }  # 전문 지식
  reasoning: { s: 29.3, z: -0.27, r: 46.0, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 45.1 | -0.32 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 46.0 | -0.27 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 45.6 | -0.3 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 35.7 | -0.95 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
