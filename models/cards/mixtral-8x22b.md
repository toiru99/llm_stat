...
radar:
  ...
  agentic: { s: 16.1, z: -0.78, r: 38.2, estimated: true }  # 에이전트
  trust: { s: 48.2, z: 0.94, r: 64.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 25.7, z: -0.7, r: 39.5, estimated: true }  # 긴문맥
  instruction: { s: 29.5, z: -0.98, r: 35.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
