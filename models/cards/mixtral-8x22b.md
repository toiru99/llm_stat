...
radar:
  ...
  agentic: { s: 16.6, z: -0.76, r: 38.6, estimated: true }  # 에이전트
  trust: { s: 45.3, z: 0.84, r: 62.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 23.6, z: -0.76, r: 38.7, estimated: true }  # 긴문맥
  instruction: { s: 28.3, z: -1.01, r: 34.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
