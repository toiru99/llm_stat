...
radar:
  ...
  reasoning: { s: 7.3, z: -1.39, r: 29.2, estimated: false }  # 추론
  coding: { s: 12.7, z: -1.42, r: 28.8, estimated: false }  # 코딩
  agentic: { s: 8.3, z: -1.09, r: 33.7, estimated: false }  # 에이전트
  trust: { s: 20.0, z: -0.37, r: 44.5, estimated: false }  # 신뢰성
  multimodal: { s: 20.3, z: -2.45, r: 13.2, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.34 · 출력 $0.34 · 혼합 $0.35/1M · 47.0 t/s · TTFT 0.73s · 128k ctx` · 가성비 8.6
...
| 추론 | 29.2 | -1.39 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 22.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 28.8 | -1.42 | 실측 | [[scicode]] 11.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 33.7 | -1.09 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 44.5 | -0.37 | 실측 | [[aa-omniscience]] 18.0%×1.0 |
| 멀티모달 | 13.2 | -2.45 | 실측 | [[mmmu-pro]] 29.0%×1.0 |
