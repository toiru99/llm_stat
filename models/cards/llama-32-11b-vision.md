...
is_reasoning: false
radar:
  knowledge: { s: 14.1, z: -1.29, r: 30.7, estimated: false }  # 전문 지식
  ...
  multimodal: { s: 20.0, z: -2.52, r: 12.3, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.34 · 출력 $0.34 · 혼합 $0.345/1M · 46.0 t/s · TTFT 1.02s · 128k ctx` · 가성비 8.7
...
| 멀티모달 | 12.3 | -2.52 | 실측 | [[mmmu-pro]] 29.0%×1.0 |
