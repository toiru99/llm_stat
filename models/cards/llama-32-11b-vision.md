...
is_reasoning: false
radar:
  knowledge: { s: 14.1, z: -1.29, r: 30.6, estimated: false }  # 전문 지식
  reasoning: { s: 7.8, z: -1.36, r: 29.7, estimated: false }  # 추론
  ...
  multimodal: { s: 20.0, z: -2.53, r: 12.0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.34 · 출력 $0.34 · 혼합 $0.345/1M · 62.0 t/s · TTFT 0.99s · 128k ctx` · 가성비 8.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 30.6 | -1.29 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 22.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 29.7 | -1.36 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 22.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
...
| 멀티모달 | 12.0 | -2.53 | 실측 | [[mmmu-pro]] 29.0%×1.0 |
