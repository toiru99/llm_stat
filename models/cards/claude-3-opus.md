...
radar:
  ...
  reasoning: { s: 24.8, z: -0.54, r: 41.9, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.43, r: 43.6, estimated: false }  # 코딩
  agentic: { s: 32.5, z: -0.19, r: 47.2, estimated: true }  # 에이전트
  trust: { s: 18.9, z: -0.42, r: 43.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 38.1, z: -0.39, r: 44.2, estimated: true }  # 긴문맥
...
| 추론 | 41.9 | -0.54 | 실측 | [[gpqa-diamond]] 49.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
