...
radar:
  ...
  trust: { s: 22.6, z: -0.22, r: 46.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 33.6, z: -0.46, r: 43.0, estimated: true }  # 긴문맥
  instruction: { s: 43.6, z: -0.38, r: 44.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
