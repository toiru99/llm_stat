...
is_reasoning: false
radar:
  knowledge: { s: 28.2, z: -0.6, r: 41.1, estimated: false }  # 전문 지식
  ...
  instruction: { s: 44.7, z: -0.31, r: 45.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 41.1 | -0.6 | 실측 | [[gpqa-diamond]] 49.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
