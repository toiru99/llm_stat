...
radar:
  ...
  long_context: { s: 36.7, z: -0.42, r: 43.6, estimated: true }  # 긴문맥
  instruction: { s: 51.1, z: -0.14, r: 48.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 46.9 | -0.2 | 실측 | [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
