...
radar:
  ...
  agentic: { s: 34.6, z: -0.11, r: 48.4, estimated: true }  # 에이전트
  trust: { s: 25.0, z: 0.02, r: 50.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 35.6, z: -0.45, r: 43.3, estimated: true }  # 긴문맥
  instruction: { s: 51.1, z: -0.08, r: 48.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
