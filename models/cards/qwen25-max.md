...
radar:
  ...
  agentic: { s: 35.0, z: -0.07, r: 49.0, estimated: true }  # 에이전트
  trust: { s: 55.6, z: 1.27, r: 69.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 32.1, z: -0.55, r: 41.7, estimated: true }  # 긴문맥
  instruction: { s: 57.8, z: 0.14, r: 52.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
