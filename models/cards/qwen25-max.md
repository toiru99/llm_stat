...
radar:
  ...
  agentic: { s: 51.4, z: 0.58, r: 58.8, estimated: true }  # 에이전트
  trust: { s: 39.8, z: 0.57, r: 58.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 50.5, z: 0.05, r: 50.7, estimated: true }  # 긴문맥
  instruction: { s: 48.5, z: -0.17, r: 47.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
