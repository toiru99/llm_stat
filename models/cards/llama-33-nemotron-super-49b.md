...
is_reasoning: true
radar:
  knowledge: { s: 31.4, z: -0.45, r: 43.2, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 43.2 | -0.45 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
...
| 에이전트 | 36.1 | -0.92 | 실측 | [[tau2-bench]] 27.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
