...
is_reasoning: true
radar:
  knowledge: { s: 31.2, z: -0.47, r: 43.0, estimated: false }  # 전문 지식
...
NVIDIA · Open · Medium(49B) · 컨텍스트 128k · 종합지능 **6.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 43.0 | -0.47 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
