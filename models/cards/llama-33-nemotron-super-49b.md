...
radar:
  ...
  coding: { s: 31.1, z: -0.63, r: 40.6, estimated: false }  # 코딩
...
| 코딩 | 40.6 | -0.63 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 36.9 | -0.87 | 실측 | [[tau2-bench]] 27.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
