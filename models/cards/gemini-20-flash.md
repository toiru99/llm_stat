...
radar:
  ...
  agentic: { s: 18.2, z: -0.69, r: 39.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 48.7 | -0.09 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 39.6 | -0.69 | 실측 | [[tau2-bench]] 30.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
