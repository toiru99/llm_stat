...
radar:
  ...
  agentic: { s: 18.2, z: -0.71, r: 39.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 48.0 | -0.13 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 39.3 | -0.71 | 실측 | [[tau2-bench]] 30.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
