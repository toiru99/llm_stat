...
radar:
  ...
  reasoning: { s: 23.2, z: -0.56, r: 41.6, estimated: false }  # 추론
  coding: { s: 38.7, z: -0.34, r: 44.9, estimated: false }  # 코딩
  agentic: { s: 18.2, z: -0.7, r: 39.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 48.1 | -0.13 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.6 | -0.56 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 44.9 | -0.34 | 실측 | [[scicode]] 33.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 39.4 | -0.7 | 실측 | [[tau2-bench]] 30.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
