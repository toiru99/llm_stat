...
radar:
  ...
  reasoning: { s: 29.4, z: -0.29, r: 45.6, estimated: false }  # 추론
  coding: { s: 36.7, z: -0.47, r: 42.9, estimated: true }  # 코딩
  agentic: { s: 0.0, z: -1.44, r: 28.4, estimated: false }  # 에이전트
  trust: { s: 33.7, z: 0.3, r: 54.5, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 12.3, z: -1.15, r: 32.8, estimated: true }  # 긴문맥
...
| 추론 | 45.6 | -0.29 | 실측 | [[gpqa-diamond]] 35.0%×1.0 |
| 코딩 | 42.9 | -0.47 | 추정 | (추정) |
