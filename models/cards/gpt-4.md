...
radar:
  ...
  reasoning: { s: 16.1, z: -0.93, r: 36.1, estimated: true }  # 추론
  coding: { s: 16.7, z: -1.27, r: 30.9, estimated: true }  # 코딩
  agentic: { s: 0.0, z: -1.43, r: 28.5, estimated: false }  # 에이전트
  trust: { s: 9.2, z: -0.9, r: 36.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 0.8, z: -1.45, r: 28.2, estimated: true }  # 긴문맥
  instruction: { s: 17.2, z: -1.49, r: 27.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
