...
radar:
  ...
  coding: { s: 69.0, z: 0.95, r: 64.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $None/1M · 63.0 t/s · TTFT 3.88s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.1 | +0.2 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 62.3 | +0.82 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 64.3 | +0.95 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
