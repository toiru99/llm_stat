...
radar:
  ...
  reasoning: { s: 49.3, z: 0.73, r: 60.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.058/1M · 97.0 t/s · TTFT 2.56s · 1M ctx` · 가성비 637.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 52.4 | +0.16 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 60.9 | +0.73 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 63.5 | +0.9 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.4 | +0.76 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
