...
is_reasoning: true
radar:
  knowledge: { s: 44.2, z: 0.16, r: 52.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.058/1M · 80.0 t/s · TTFT 2.93s · 1M ctx` · 가성비 655.2
...
| 에이전트 | 61.7 | +0.78 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
