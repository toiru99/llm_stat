...
radar:
  ...
  agentic: { s: 55.6, z: 0.74, r: 61.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $0.058/1M · 93.0 t/s · TTFT 2.12s · 1M ctx` · 가성비 655.2
...
| 에이전트 | 61.2 | +0.74 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
