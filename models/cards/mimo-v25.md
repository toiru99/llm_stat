...
radar:
  ...
  reasoning: { s: 49.3, z: 0.75, r: 61.2, estimated: false }  # 추론
  coding: { s: 69.0, z: 0.92, r: 63.7, estimated: false }  # 코딩
  agentic: { s: 55.8, z: 0.76, r: 61.3, estimated: false }  # 에이전트
  trust: { s: 77.0, z: 2.31, r: 84.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.14 · 출력 $0.28 · 혼합 $None/1M · 91.0 t/s · TTFT 3.09s · 1M ctx`
...
| 추론 | 61.2 | +0.75 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 63.7 | +0.92 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.3 | +0.76 | 실측 | [[gdpval]] 32.0%×1.0, [[tau2-bench]] 91.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
