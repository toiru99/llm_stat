...
radar:
  ...
  agentic: { s: 46.1, z: 0.36, r: 55.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 62.0, z: 0.4, r: 56.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 53.0 t/s · TTFT 3.94s · 256k ctx` · 가성비 80.5
...
| 에이전트 | 55.5 | +0.36 | 실측 | [[gdpval]] 35.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
