...
is_reasoning: false
radar:
  knowledge: { s: 31.2, z: -0.45, r: 43.2, estimated: false }  # 전문 지식
  reasoning: { s: 34.6, z: 0.01, r: 50.1, estimated: false }  # 추론
  coding: { s: 58.1, z: 0.48, r: 57.2, estimated: false }  # 코딩
  agentic: { s: 45.3, z: 0.32, r: 54.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 43.2 | -0.45 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 50.1 | +0.01 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 57.2 | +0.48 | 실측 | [[scicode]] 36.0%×1.0 |
| 에이전트 | 54.8 | +0.32 | 실측 | [[gdpval]] 35.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
