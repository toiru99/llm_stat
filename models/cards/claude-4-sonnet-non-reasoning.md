...
radar:
  ...
  reasoning: { s: 25.5, z: -0.45, r: 43.3, estimated: false }  # 추론
  coding: { s: 53.4, z: 0.28, r: 54.3, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 47.7 | -0.16 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 43.3 | -0.45 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 54.3 | +0.28 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
| 에이전트 | 55.6 | +0.37 | 실측 | [[tau2-bench]] 52.0%×1.0, [[terminal-bench]] 27.0%×1.0 |
