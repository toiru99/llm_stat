...
radar:
  ...
  agentic: { s: 2.8, z: -1.3, r: 30.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 45.0 t/s · TTFT 0.83s · 128k ctx`
...
| 에이전트 | 30.4 | -1.3 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 8.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
