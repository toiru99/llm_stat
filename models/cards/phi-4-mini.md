...
radar:
  ...
  reasoning: { s: 10.7, z: -1.19, r: 32.2, estimated: false }  # 추론
  coding: { s: 11.8, z: -1.48, r: 27.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 46.0 t/s · TTFT 0.87s · 128k ctx`
...
| 에이전트 | 29.8 | -1.34 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 8.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
