...
radar:
  ...
  coding: { s: 33.7, z: -0.55, r: 41.7, estimated: false }  # 코딩
  agentic: { s: 13.9, z: -0.91, r: 36.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $2.4 · 혼합 $0.42/1M · 112.0 t/s · TTFT 2.11s · 256k ctx` · 가성비 31.0
...
| 추론 | 45.8 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 41.7 | -0.55 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 36.4 | -0.91 | 실측 | [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
