...
radar:
  ...
  agentic: { s: 12.0, z: -0.95, r: 35.7, estimated: false }  # 에이전트
  trust: { s: 78.2, z: 2.32, r: 84.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.028/1M · 86.0 t/s · TTFT 0.81s · 128k ctx` · 가성비 428.6
...
| 에이전트 | 35.7 | -0.95 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 21.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
| 신뢰성 | 84.8 | +2.32 | 실측 | [[aa-omniscience]] 69.0%×1.0 |
