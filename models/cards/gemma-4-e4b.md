...
is_reasoning: true
radar:
  knowledge: { s: 21.8, z: -0.91, r: 36.3, estimated: false }  # 전문 지식
  reasoning: { s: 21.9, z: -0.64, r: 40.3, estimated: false }  # 추론
  coding: { s: 30.7, z: -0.69, r: 39.6, estimated: false }  # 코딩
  agentic: { s: 11.1, z: -0.99, r: 35.2, estimated: false }  # 에이전트
  trust: { s: 77.9, z: 2.37, r: 85.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.028/1M · 73.0 t/s · TTFT 0.91s · 128k ctx` · 가성비 428.6
...
| 추론 | 40.3 | -0.64 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.6 | -0.69 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 35.2 | -0.99 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
