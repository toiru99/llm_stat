...
radar:
  ...
  reasoning: { s: 21.6, z: -0.64, r: 40.3, estimated: false }  # 추론
  coding: { s: 29.8, z: -0.71, r: 39.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.028/1M · 40.0 t/s · TTFT 0.91s · 128k ctx` · 가성비 428.6
...
| 코딩 | 39.3 | -0.71 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 34.8 | -1.02 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
