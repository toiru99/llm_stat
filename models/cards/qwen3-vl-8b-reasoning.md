...
is_reasoning: true
radar:
  knowledge: { s: 32.4, z: -0.41, r: 43.8, estimated: false }  # 전문 지식
  reasoning: { s: 20.7, z: -0.7, r: 39.5, estimated: false }  # 추론
  coding: { s: 26.5, z: -0.88, r: 36.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.18 · 출력 $2.1 · 혼합 $0.372/1M · 114.0 t/s · TTFT 2.32s · 256k ctx` · 가성비 26.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.8 | -0.41 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 39.5 | -0.7 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 36.8 | -0.88 | 실측 | [[scicode]] 22.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 37.0 | -0.87 | 실측 | [[tau2-bench]] 23.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
