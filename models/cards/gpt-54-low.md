...
is_reasoning: true
radar:
  knowledge: { s: 76.2, z: 1.65, r: 74.7, estimated: false }  # 전문 지식
  reasoning: { s: 55.8, z: 1.08, r: 66.2, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 74.7 | +1.65 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
| 추론 | 66.2 | +1.08 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
