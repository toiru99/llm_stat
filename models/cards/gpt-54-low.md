...
radar:
  ...
  reasoning: { s: 54.4, z: 0.93, r: 64.0, estimated: false }  # 추론
  coding: { s: 65.2, z: 1.16, r: 67.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 97.0 t/s · TTFT 1.61s · 1M ctx` · 가성비 14.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.7 | +1.51 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 64.0 | +0.93 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
| 코딩 | 67.4 | +1.16 | 실측 | [[terminal-bench]] 43.0%×0.5 |
