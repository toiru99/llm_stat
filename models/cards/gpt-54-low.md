...
is_reasoning: true
radar:
  knowledge: { s: 74.3, z: 1.57, r: 73.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 94.0 t/s · TTFT 1.92s · 1M ctx` · 가성비 18.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.6 | +1.57 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 65.0 | +1.0 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
