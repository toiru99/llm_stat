...
is_reasoning: true
radar:
  knowledge: { s: 76.2, z: 1.72, r: 75.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 102.0 t/s · TTFT 1.63s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.7 | +1.72 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
...
| 에이전트 | 69.9 | +1.32 | 실측 | [[tau2-bench]] 75.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
