...
is_reasoning: true
radar:
  knowledge: { s: 74.6, z: 1.68, r: 75.2, estimated: false }  # 전문 지식
  reasoning: { s: 56.0, z: 1.09, r: 66.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 102.0 t/s · TTFT 1.68s · 1M ctx` · 가성비 18.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.2 | +1.68 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 31.0%×0.3 |
| 추론 | 66.4 | +1.09 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 31.0%×1.0 |
