...
is_reasoning: true
radar:
  knowledge: { s: 51.4, z: 0.47, r: 57.1, estimated: false }  # 전문 지식
  reasoning: { s: 45.2, z: 0.52, r: 57.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.064/1M · 140.0 t/s · TTFT 1.08s · 256k ctx` · 가성비 406.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.1 | +0.47 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.8 | +0.52 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 57.9 | +0.52 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 69.9 | +1.33 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
