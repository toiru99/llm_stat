...
radar:
  ...
  reasoning: { s: 45.2, z: 0.62, r: 59.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.06/1M · 229.0 t/s · TTFT 1.04s · 256k ctx` · 가성비 433.3
...
| 추론 | 59.2 | +0.62 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
