...
is_reasoning: true
radar:
  knowledge: { s: 51.4, z: 0.52, r: 57.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 302.0 t/s · TTFT 1.04s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.8 | +0.52 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
