...
radar:
  ...
  reasoning: { s: 45.2, z: 0.53, r: 58.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 218.0 t/s · TTFT 1.02s · 256k ctx`
...
| 추론 | 58.0 | +0.53 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
