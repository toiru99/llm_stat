...
radar:
  ...
  reasoning: { s: 44.9, z: 0.45, r: 56.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.064/1M · 235.0 t/s · TTFT 1.12s · 256k ctx` · 가성비 421.9
...
| 추론 | 56.7 | +0.45 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 57.0 | +0.47 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 68.4 | +1.23 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
