...
radar:
  ...
  coding: { s: 35.8, z: -0.51, r: 42.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 137.0 t/s · TTFT 0.81s · 400k ctx` · 가성비 149.5
...
| 코딩 | 42.3 | -0.51 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
