...
is_reasoning: false
radar:
  knowledge: { s: 21.5, z: -0.94, r: 35.9, estimated: false }  # 전문 지식
  reasoning: { s: 14.7, z: -0.99, r: 35.1, estimated: false }  # 추론
  coding: { s: 34.7, z: -0.51, r: 42.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 161.0 t/s · TTFT 0.84s · 400k ctx` · 가성비 149.5
...
| 코딩 | 42.4 | -0.51 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 39.0 | -0.73 | 실측 | [[tau2-bench]] 26.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
