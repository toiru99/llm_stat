...
radar:
  ...
  coding: { s: 35.8, z: -0.52, r: 42.3, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.72, r: 39.2, estimated: false }  # 에이전트
  trust: { s: 10.5, z: -0.74, r: 38.9, estimated: false }  # 신뢰성
  multimodal: { s: 24.3, z: -2.31, r: 15.3, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 161.0 t/s · TTFT 0.88s · 400k ctx` · 가성비 149.5
