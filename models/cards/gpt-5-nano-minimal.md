...
radar:
  ...
  coding: { s: 35.8, z: -0.45, r: 43.2, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.69, r: 39.6, estimated: false }  # 에이전트
  trust: { s: 17.2, z: -0.49, r: 42.6, estimated: false }  # 신뢰성
  multimodal: { s: 24.6, z: -2.26, r: 16.1, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $None/1M · 155.0 t/s · TTFT 0.79s · 400k ctx`
