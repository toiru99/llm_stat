...
radar:
  ...
  coding: { s: 35.8, z: -0.51, r: 42.4, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.71, r: 39.3, estimated: false }  # 에이전트
  trust: { s: 10.5, z: -0.74, r: 39.0, estimated: false }  # 신뢰성
  multimodal: { s: 24.3, z: -2.3, r: 15.4, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 140.0 t/s · TTFT 0.83s · 400k ctx` · 가성비 149.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 35.7 | -0.95 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 멀티모달 | 15.4 | -2.3 | 실측 | [[mmmu-pro]] 32.0%×1.0 |
