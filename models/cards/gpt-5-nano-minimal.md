...
radar:
  ...
  multimodal: { s: 23.6, z: -2.3, r: 15.4, estimated: false }  # 멀티모달
...
OpenAI · Proprietary · Unknown · 컨텍스트 400k · 종합지능 **2.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 158.0 t/s · TTFT 0.87s · 400k ctx` · 가성비 37.4
