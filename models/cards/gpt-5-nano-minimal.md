...
radar:
  ...
  coding: { s: 35.8, z: -0.48, r: 42.7, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.7, r: 39.5, estimated: false }  # 에이전트
  trust: { s: 10.5, z: -0.72, r: 39.2, estimated: false }  # 신뢰성
  multimodal: { s: 24.3, z: -2.3, r: 15.5, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 141.0 t/s · TTFT 0.88s · 400k ctx` · 가성비 149.5
...
| 코딩 | 42.7 | -0.48 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
