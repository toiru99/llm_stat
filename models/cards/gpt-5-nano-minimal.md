...
radar:
  ...
  coding: { s: 35.8, z: -0.49, r: 42.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 154.0 t/s · TTFT 0.82s · 400k ctx` · 가성비 149.5
...
| 코딩 | 42.6 | -0.49 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
