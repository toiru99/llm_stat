...
radar:
  ...
  coding: { s: 35.8, z: -0.52, r: 42.2, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.73, r: 39.1, estimated: false }  # 에이전트
  trust: { s: 10.5, z: -0.75, r: 38.7, estimated: false }  # 신뢰성
  multimodal: { s: 24.3, z: -2.32, r: 15.1, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 206.0 t/s · TTFT 0.81s · 400k ctx` · 가성비 149.5
...
| 멀티모달 | 15.1 | -2.32 | 실측 | [[mmmu-pro]] 32.0%×1.0 |
