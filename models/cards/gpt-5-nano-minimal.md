...
radar:
  ...
  coding: { s: 35.8, z: -0.45, r: 43.3, estimated: false }  # 코딩
  agentic: { s: 18.4, z: -0.7, r: 39.6, estimated: false }  # 에이전트
  trust: { s: 17.6, z: -0.48, r: 42.8, estimated: false }  # 신뢰성
  multimodal: { s: 24.6, z: -2.25, r: 16.3, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $None/1M · 172.0 t/s · TTFT 0.8s · 400k ctx`
