...
radar:
  ...
  multimodal: { s: 24.6, z: -2.24, r: 16.3, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.05/1M · 155.0 t/s · TTFT 0.82s · 400k ctx` · 가성비 160.0
...
| 멀티모달 | 16.3 | -2.24 | 실측 | [[mmmu-pro]] 32.0%×1.0 |
