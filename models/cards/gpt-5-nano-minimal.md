...
radar:
  ...
  coding: { s: 35.8, z: -0.44, r: 43.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.05/1M · 170.0 t/s · TTFT 0.77s · 400k ctx` · 가성비 160.0
...
| 코딩 | 43.3 | -0.44 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
