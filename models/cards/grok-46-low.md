...
is_reasoning: true
radar:
  knowledge: { s: 69.3, z: 1.42, r: 71.4, estimated: false }  # 전문 지식
  reasoning: { s: 53.5, z: 0.96, r: 64.5, estimated: false }  # 추론
  ...
  instruction: { s: 82.0, z: 1.25, r: 68.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 55.0 t/s · TTFT 6.35s · 500k ctx` · 가성비 38.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.4 | +1.42 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 64.5 | +0.96 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
