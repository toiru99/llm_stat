...
radar:
  ...
  agentic: { s: 76.8, z: 1.53, r: 73.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 62.0 t/s · TTFT 7.76s · 500k ctx` · 가성비 38.5
...
| 에이전트 | 73.0 | +1.53 | 실측 | [[gdpval]] 53.0%×1.0, [[tau3-banking]] 38.0%×1.0 |
