...
radar:
  ...
  agentic: { s: 91.2, z: 2.14, r: 82.1, estimated: false }  # 에이전트
  ...
  instruction: { s: 82.8, z: 1.16, r: 67.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 53.0 t/s · TTFT 60.03s · 1M ctx` · 가성비 16.4
...
| 에이전트 | 82.1 | +2.14 | 실측 | [[gdpval]] 67.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
