...
is_reasoning: true
radar:
  knowledge: { s: 95.8, z: 2.58, r: 88.7, estimated: false }  # 전문 지식
  reasoning: { s: 96.1, z: 2.94, r: 94.1, estimated: false }  # 추론
  coding: { s: 93.3, z: 1.83, r: 77.4, estimated: false }  # 코딩
  agentic: { s: 91.2, z: 2.09, r: 81.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 79.8, z: 1.04, r: 65.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 47.83s · 1M ctx` · 가성비 16.4
...
| 에이전트 | 81.3 | +2.09 | 실측 | [[gdpval]] 67.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
