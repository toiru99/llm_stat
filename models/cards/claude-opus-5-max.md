...
radar:
  ...
  instruction: { s: 82.8, z: 1.16, r: 67.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 53.0 t/s · TTFT 59.54s · 1M ctx` · 가성비 16.4
...
| 에이전트 | 81.9 | +2.13 | 실측 | [[gdpval]] 67.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
