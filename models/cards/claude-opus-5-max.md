...
is_reasoning: true
radar:
  knowledge: { s: 96.0, z: 2.65, r: 89.7, estimated: false }  # 전문 지식
  reasoning: { s: 96.5, z: 3.05, r: 95.7, estimated: false }  # 추론
  coding: { s: 93.3, z: 1.91, r: 78.6, estimated: false }  # 코딩
  agentic: { s: 91.2, z: 2.2, r: 83.1, estimated: false }  # 에이전트
  ...
  instruction: { s: 79.8, z: 1.08, r: 66.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 51.13s · 1M ctx` · 가성비 16.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 89.7 | +2.65 | 실측 | [[aa-omniscience]] 61.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 55.0%×0.3 |
| 추론 | 95.7 | +3.05 | 실측 | [[critpt]] 29.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 55.0%×1.0 |
| 코딩 | 78.6 | +1.91 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 83.1 | +2.2 | 실측 | [[gdpval]] 67.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
