...
radar:
  ...
  agentic: { s: 91.2, z: 2.07, r: 81.1, estimated: false }  # 에이전트
  ...
  instruction: { s: 79.7, z: 1.03, r: 65.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 42.34s · 1M ctx` · 가성비 16.4
...
| 에이전트 | 81.1 | +2.07 | 실측 | [[gdpval]] 67.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
