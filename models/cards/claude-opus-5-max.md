...
radar:
  ...
  instruction: { s: 76.9, z: 1.02, r: 65.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 59.0 t/s · TTFT 91.2s · 1M ctx` · 가성비 14.0
...
| 에이전트 | 79.9 | +1.99 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
