...
is_reasoning: true
radar:
  knowledge: { s: 45.2, z: 0.23, r: 53.4, estimated: false }  # 전문 지식
...
|---|---|---|---|---|
| 전문 지식 | 53.4 | +0.23 | 실측 | [[gpqa-diamond]] 68.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 56.1 | +0.41 | 실측 | [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 48.1 | -0.12 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
