...
radar:
  ...
  agentic: { s: 17.7, z: -0.74, r: 38.8, estimated: false }  # 에이전트
  trust: { s: 17.4, z: -0.43, r: 43.6, estimated: true }  # 신뢰성
...
| 에이전트 | 38.8 | -0.74 | 실측 | [[tau2-bench]] 32.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
| 신뢰성 | 43.6 | -0.43 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
