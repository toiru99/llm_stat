...
radar:
  ...
  coding: { s: 40.8, z: -0.25, r: 46.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 27.0 t/s · TTFT 1.35s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.6 | -0.69 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 53.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 37.9 | -0.8 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 46.2 | -0.25 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
| 에이전트 | 43.0 | -0.47 | 실측 | [[gdpval]] 12.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
