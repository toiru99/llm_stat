...
is_reasoning: false
radar:
  knowledge: { s: 26.3, z: -0.72, r: 39.3, estimated: false }  # 전문 지식
  reasoning: { s: 18.1, z: -0.86, r: 37.1, estimated: false }  # 추론
  coding: { s: 40.8, z: -0.33, r: 45.1, estimated: false }  # 코딩
  agentic: { s: 22.1, z: -0.58, r: 41.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 134.0 t/s · TTFT 2.2s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.3 | -0.72 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 53.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
...
| 에이전트 | 41.3 | -0.58 | 실측 | [[gdpval]] 12.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
