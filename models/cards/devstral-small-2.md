...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 79.0 t/s · TTFT 1.73s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.4 | -0.7 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 53.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
...
| 에이전트 | 41.9 | -0.54 | 실측 | [[gdpval]] 11.0%×1.0, [[tau2-bench]] 23.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 17.0%×1.0 |
