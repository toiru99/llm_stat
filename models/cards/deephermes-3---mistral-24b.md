...
radar:
  ...
  agentic: { s: 15.9, z: -0.79, r: 38.2, estimated: true }  # 에이전트
  trust: { s: 27.7, z: 0.0, r: 50.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.3, z: -0.97, r: 35.4, estimated: true }  # 긴문맥
  instruction: { s: 29.0, z: -0.98, r: 35.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
