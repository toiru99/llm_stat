...
radar:
  ...
  agentic: { s: 14.8, z: -0.88, r: 36.9, estimated: true }  # 에이전트
  trust: { s: 15.6, z: -0.43, r: 43.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 25.6, z: -0.75, r: 38.7, estimated: true }  # 긴문맥
  instruction: { s: 28.6, z: -1.02, r: 34.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
