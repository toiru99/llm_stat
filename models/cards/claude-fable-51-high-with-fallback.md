...
is_reasoning: true
radar:
  knowledge: { s: 96.2, z: 2.74, r: 91.1, estimated: false }  # 전문 지식
  reasoning: { s: 94.6, z: 2.96, r: 94.4, estimated: false }  # 추론
  coding: { s: 93.5, z: 1.95, r: 79.3, estimated: false }  # 코딩
  agentic: { s: 86.9, z: 1.92, r: 78.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.175/1M · 55.0 t/s · TTFT 34.57s · 1M ctx` · 가성비 8.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 91.1 | +2.74 | 실측 | [[aa-omniscience]] 65.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 56.0%×0.3 |
| 추론 | 94.4 | +2.96 | 실측 | [[critpt]] 30.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 56.0%×1.0 |
| 코딩 | 79.3 | +1.95 | 실측 | [[scicode]] 58.0%×1.0 |
| 에이전트 | 78.8 | +1.92 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 43.0%×1.0 |
