...
radar:
  ...
  reasoning: { s: 94.3, z: 2.85, r: 92.7, estimated: false }  # 추론
  ...
  instruction: { s: 77.7, z: 1.05, r: 65.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.175/1M · 57.0 t/s · TTFT 31.09s · 1M ctx` · 가성비 7.2
...
| 추론 | 92.7 | +2.85 | 실측 | [[critpt]] 30.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 56.0%×1.0 |
