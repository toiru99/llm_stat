...
radar:
  ...
  coding: { s: 21.7, z: -1.06, r: 34.2, estimated: false }  # 코딩
  agentic: { s: 10.6, z: -1.01, r: 34.9, estimated: true }  # 에이전트
  trust: { s: 34.4, z: 0.29, r: 54.4, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 142.0 t/s · TTFT 0.78s · 32k ctx`
...
| 코딩 | 34.2 | -1.06 | 실측 | [[scicode]] 13.0%×1.0 |
