...
radar:
  ...
  agentic: { s: 9.5, z: -1.08, r: 33.8, estimated: true }  # 에이전트
  trust: { s: 25.5, z: 0.06, r: 50.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 15.8, z: -1.04, r: 34.4, estimated: true }  # 긴문맥
  instruction: { s: 31.4, z: -0.9, r: 36.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 146.0 t/s · TTFT 0.83s · 32k ctx` · 가성비 15.4
...
| 코딩 | 33.6 | -1.09 | 실측 | [[scicode]] 13.0%×1.0 |
