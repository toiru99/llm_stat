...
radar:
  ...
  coding: { s: 1.5, z: -1.07, r: 34.0, estimated: true }  # 코딩
  ...
  instruction: { s: 31.0, z: -0.9, r: 36.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 144.0 t/s · TTFT 0.76s · 32k ctx` · 가성비 5.1
