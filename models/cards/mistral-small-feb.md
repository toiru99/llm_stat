...
is_reasoning: false
radar:
  knowledge: { s: 16.1, z: -1.19, r: 32.1, estimated: false }  # 전문 지식
  reasoning: { s: 14.8, z: -0.99, r: 35.1, estimated: false }  # 추론
  coding: { s: 21.7, z: -1.06, r: 34.1, estimated: false }  # 코딩
  agentic: { s: 10.2, z: -1.02, r: 34.7, estimated: true }  # 에이전트
  trust: { s: 33.9, z: 0.24, r: 53.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 1.8, z: -1.42, r: 28.7, estimated: true }  # 긴문맥
  instruction: { s: 29.4, z: -0.99, r: 35.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 146.0 t/s · TTFT 0.93s · 32k ctx` · 가성비 20.5
