...
radar:
  ...
  agentic: { s: 11.1, z: -0.98, r: 35.4, estimated: true }  # 에이전트
  trust: { s: 32.6, z: 0.22, r: 53.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 4.7, z: -1.3, r: 30.5, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $1.2/1M · 144.0 t/s · TTFT 0.84s · 32k ctx` · 가성비 3.3
