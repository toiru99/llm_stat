...
radar:
  ...
  coding: { s: 21.7, z: -1.09, r: 33.6, estimated: false }  # 코딩
  agentic: { s: 12.4, z: -0.96, r: 35.7, estimated: true }  # 에이전트
  trust: { s: 34.2, z: 0.31, r: 54.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 11.0, z: -1.19, r: 32.1, estimated: true }  # 긴문맥
  instruction: { s: 29.3, z: -1.02, r: 34.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.195/1M · 154.0 t/s · TTFT 0.8s · 32k ctx` · 가성비 15.4
