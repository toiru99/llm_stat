...
radar:
  ...
  trust: { s: 33.1, z: 0.24, r: 53.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 4.1, z: -1.34, r: 29.9, estimated: true }  # 긴문맥
  instruction: { s: 29.6, z: -0.96, r: 35.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $3.0 · 혼합 $None/1M · 146.0 t/s · TTFT 0.83s · 32k ctx`
