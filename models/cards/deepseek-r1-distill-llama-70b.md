...
is_reasoning: true
radar:
  knowledge: { s: 27.7, z: -0.61, r: 40.9, estimated: false }  # 전문 지식
  reasoning: { s: 15.1, z: -0.97, r: 35.5, estimated: false }  # 추론
  coding: { s: 35.5, z: -0.44, r: 43.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 40.9 | -0.61 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 40.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 35.5 | -0.97 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 40.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 43.4 | -0.44 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
