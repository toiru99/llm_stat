...
radar:
  ...
  coding: { s: 34.3, z: -0.52, r: 42.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.7 · 출력 $1.1 · 혼합 $0.74/1M · 26.0 t/s · TTFT 1.1s · 128k ctx` · 가성비 13.5
...
| 코딩 | 42.1 | -0.52 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
