...
radar:
  ...
  coding: { s: 35.5, z: -0.48, r: 42.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.7 · 출력 $1.05 · 혼합 $None/1M · 29.0 t/s · TTFT 0.9s · 128k ctx`
...
| 코딩 | 42.8 | -0.48 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
