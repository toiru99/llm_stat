...
is_reasoning: false
radar:
  knowledge: { s: 48.6, z: 0.34, r: 55.1, estimated: false }  # 전문 지식
  reasoning: { s: 35.7, z: 0.05, r: 50.8, estimated: false }  # 추론
  coding: { s: 54.8, z: 0.31, r: 54.7, estimated: false }  # 코딩
  agentic: { s: 41.8, z: 0.24, r: 53.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.55 · 출력 $2.2 · 혼합 $0.7375/1M · 48.0 t/s · TTFT 1.86s · 200k ctx` · 가성비 39.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 55.1 | +0.34 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
...
| 에이전트 | 53.6 | +0.24 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 70.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
