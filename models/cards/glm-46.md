...
is_reasoning: true
radar:
  knowledge: { s: 46.5, z: 0.29, r: 54.3, estimated: false }  # 전문 지식
  reasoning: { s: 35.2, z: 0.02, r: 50.3, estimated: false }  # 추론
  coding: { s: 53.5, z: 0.27, r: 54.1, estimated: false }  # 코딩
  agentic: { s: 41.5, z: 0.16, r: 52.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.55 · 출력 $2.2 · 혼합 $0.715/1M · 51.0 t/s · TTFT 2.57s · 200k ctx` · 가성비 40.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.3 | +0.29 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 50.3 | +0.02 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 54.1 | +0.27 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 52.4 | +0.16 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 70.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
