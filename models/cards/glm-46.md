...
is_reasoning: true
radar:
  knowledge: { s: 47.5, z: 0.34, r: 55.1, estimated: false }  # 전문 지식
  reasoning: { s: 35.7, z: 0.06, r: 51.0, estimated: false }  # 추론
  coding: { s: 54.8, z: 0.31, r: 54.6, estimated: false }  # 코딩
  agentic: { s: 41.9, z: 0.2, r: 52.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.55 · 출력 $2.2 · 혼합 $0.715/1M · 50.0 t/s · TTFT 2.53s · 200k ctx` · 가성비 40.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 55.1 | +0.34 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 51.0 | +0.06 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 54.6 | +0.31 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 52.9 | +0.2 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 70.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
