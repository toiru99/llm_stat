...
radar:
  ...
  reasoning: { s: 35.7, z: 0.02, r: 50.3, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.55 · 출력 $2.2 · 혼합 $0.7375/1M · 53.0 t/s · TTFT 2.39s · 200k ctx` · 가성비 39.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.1 | +0.27 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
...
| 에이전트 | 53.0 | +0.2 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 70.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
