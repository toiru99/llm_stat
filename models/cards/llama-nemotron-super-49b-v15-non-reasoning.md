...
is_reasoning: false
radar:
  knowledge: { s: 23.3, z: -0.87, r: 37.0, estimated: false }  # 전문 지식
  reasoning: { s: 16.8, z: -0.9, r: 36.6, estimated: false }  # 추론
  coding: { s: 28.7, z: -0.79, r: 38.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.4 · 출력 $0.4 · 혼합 $0.4/1M · 48.0 t/s · TTFT 19.73s · 128k ctx` · 가성비 22.5
...
| 코딩 | 38.1 | -0.79 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 37.6 | -0.83 | 실측 | [[tau2-bench]] 25.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
