...
is_reasoning: false
radar:
  knowledge: { s: 22.8, z: -0.88, r: 36.9, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.4 · 출력 $0.4 · 혼합 $0.4/1M · 38.0 t/s · TTFT 7.31s · 128k ctx` · 가성비 22.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 36.9 | -0.88 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 36.5 | -0.9 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 37.9 | -0.81 | 실측 | [[scicode]] 24.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
