...
radar:
  ...
  reasoning: { s: 54.2, z: 0.9, r: 63.5, estimated: false }  # 추론
  coding: { s: 72.8, z: 0.99, r: 64.8, estimated: false }  # 코딩
  agentic: { s: 69.9, z: 1.27, r: 69.0, estimated: false }  # 에이전트
...
| 추론 | 63.5 | +0.9 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 64.8 | +0.99 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
| 에이전트 | 69.0 | +1.27 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
