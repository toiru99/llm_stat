...
radar:
  ...
  reasoning: { s: 54.5, z: 0.98, r: 64.6, estimated: false }  # 추론
  coding: { s: 72.8, z: 1.06, r: 65.8, estimated: false }  # 코딩
  agentic: { s: 69.9, z: 1.35, r: 70.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 66.6 | +1.11 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 64.6 | +0.98 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 65.8 | +1.06 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
| 에이전트 | 70.3 | +1.35 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
