...
is_reasoning: true
radar:
  knowledge: { s: 63.8, z: 1.1, r: 66.6, estimated: false }  # 전문 지식
  reasoning: { s: 54.5, z: 0.98, r: 64.6, estimated: false }  # 추론
  coding: { s: 72.8, z: 1.06, r: 65.9, estimated: false }  # 코딩
  agentic: { s: 69.9, z: 1.36, r: 70.4, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 66.6 | +1.1 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
...
| 에이전트 | 70.4 | +1.36 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
