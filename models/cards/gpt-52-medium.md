...
radar:
  ...
  reasoning: { s: 53.9, z: 1.06, r: 65.8, estimated: false }  # 추론
  coding: { s: 72.8, z: 1.12, r: 66.7, estimated: false }  # 코딩
  agentic: { s: 69.9, z: 1.3, r: 69.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 68.2 | +1.21 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 65.8 | +1.06 | 실측 | [[critpt]] 8.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 66.7 | +1.12 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
| 에이전트 | 69.6 | +1.3 | 실측 | [[tau2-bench]] 74.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
