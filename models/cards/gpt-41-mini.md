...
radar:
  ...
  coding: { s: 48.5, z: 0.09, r: 51.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $None/1M · 82.0 t/s · TTFT 0.89s · 1M ctx`
...
| 코딩 | 51.3 | +0.09 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
