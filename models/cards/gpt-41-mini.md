...
radar:
  ...
  coding: { s: 47.1, z: 0.01, r: 50.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.31/1M · 86.0 t/s · TTFT 0.91s · 1M ctx` · 가성비 48.4
...
| 추론 | 42.3 | -0.51 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
