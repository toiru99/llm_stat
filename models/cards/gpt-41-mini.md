...
is_reasoning: false
radar:
  knowledge: { s: 33.7, z: -0.32, r: 45.1, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.31/1M · 71.0 t/s · TTFT 0.9s · 1M ctx` · 가성비 48.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.1 | -0.32 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
