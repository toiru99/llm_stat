...
radar:
  ...
  agentic: { s: 20.1, z: -0.63, r: 40.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $None/1M · 84.0 t/s · TTFT 0.88s · 1M ctx`
...
| 에이전트 | 40.5 | -0.63 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 53.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
