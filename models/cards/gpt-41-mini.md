...
radar:
  ...
  coding: { s: 48.5, z: 0.11, r: 51.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.31/1M · 78.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 48.4
...
| 코딩 | 51.6 | +0.11 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
