...
radar:
  ...
  coding: { s: 37.2, z: -0.47, r: 42.9, estimated: false }  # 코딩
  agentic: { s: 53.0, z: 0.61, r: 59.1, estimated: false }  # 에이전트
...
| 코딩 | 42.9 | -0.47 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 12.0%×0.5 |
| 에이전트 | 59.1 | +0.61 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
