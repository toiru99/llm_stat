...
radar:
  ...
  coding: { s: 37.2, z: -0.45, r: 43.2, estimated: false }  # 코딩
  agentic: { s: 53.0, z: 0.64, r: 59.6, estimated: false }  # 에이전트
...
| 코딩 | 43.2 | -0.45 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 12.0%×0.5 |
| 에이전트 | 59.6 | +0.64 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
