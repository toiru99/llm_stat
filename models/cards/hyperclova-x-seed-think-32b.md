...
radar:
  ...
  coding: { s: 36.2, z: -0.46, r: 43.1, estimated: false }  # 코딩
  agentic: { s: 53.0, z: 0.6, r: 59.1, estimated: false }  # 에이전트
...
| 에이전트 | 59.1 | +0.6 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
