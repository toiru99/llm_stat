...
radar:
  ...
  reasoning: { s: 48.9, z: 0.82, r: 62.2, estimated: false }  # 추론
  coding: { s: 71.9, z: 1.09, r: 66.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.22/1M · 61.0 t/s · TTFT 1.89s · 205k ctx` · 가성비 172.7
...
| 추론 | 62.2 | +0.82 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 66.4 | +1.09 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
