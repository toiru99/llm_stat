...
radar:
  ...
  coding: { s: 70.2, z: 0.97, r: 64.6, estimated: false }  # 코딩
  agentic: { s: 46.7, z: 0.36, r: 55.4, estimated: false }  # 에이전트
  trust: { s: 63.9, z: 1.86, r: 77.8, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 73.0 t/s · TTFT 1.53s · 205k ctx` · 가성비 175.7
...
| 에이전트 | 55.4 | +0.36 | 실측 | [[apex-agents]] 11.0%×1.0, [[gdpval]] 33.0%×1.0, [[itbench]] 26.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
| 신뢰성 | 77.8 | +1.86 | 실측 | [[aa-omniscience]] 64.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
