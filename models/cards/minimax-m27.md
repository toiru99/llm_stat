...
is_reasoning: true
radar:
  knowledge: { s: 55.2, z: 0.71, r: 60.7, estimated: false }  # 전문 지식
  reasoning: { s: 48.9, z: 0.81, r: 62.2, estimated: false }  # 추론
  coding: { s: 71.9, z: 1.09, r: 66.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.22/1M · 60.0 t/s · TTFT 1.9s · 205k ctx` · 가성비 172.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.7 | +0.71 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 62.2 | +0.81 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 66.3 | +1.09 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
