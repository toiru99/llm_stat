...
radar:
  ...
  reasoning: { s: 49.5, z: 0.72, r: 60.9, estimated: false }  # 추론
  coding: { s: 71.9, z: 1.02, r: 65.3, estimated: false }  # 코딩
  agentic: { s: 46.8, z: 0.43, r: 56.5, estimated: false }  # 에이전트
  trust: { s: 72.1, z: 2.11, r: 81.6, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 54.0 t/s · TTFT 1.79s · 205k ctx` · 가성비 175.7
...
| 추론 | 60.9 | +0.72 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 30.0%×1.0 |
| 코딩 | 65.3 | +1.02 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 56.5 | +0.43 | 실측 | [[apex-agents]] 11.0%×1.0, [[gdpval]] 33.0%×1.0, [[itbench]] 26.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
| 신뢰성 | 81.6 | +2.11 | 실측 | [[aa-omniscience]] 64.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
