...
radar:
  ...
  agentic: { s: 12.2, z: -0.98, r: 35.3, estimated: true }  # 에이전트
  trust: { s: 18.3, z: -0.3, r: 45.5, estimated: true }  # 신뢰성
  multimodal: { s: 33.8, z: -1.81, r: 22.8, estimated: false }  # 멀티모달
  long_context: { s: 13.1, z: -1.13, r: 33.0, estimated: true }  # 긴문맥
  instruction: { s: 23.9, z: -1.21, r: 31.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
