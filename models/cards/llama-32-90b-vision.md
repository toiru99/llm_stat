...
radar:
  ...
  trust: { s: 31.1, z: 0.16, r: 52.4, estimated: true }  # 신뢰성
  multimodal: { s: 34.8, z: -1.75, r: 23.8, estimated: false }  # 멀티모달
  long_context: { s: 14.7, z: -0.99, r: 35.1, estimated: true }  # 긴문맥
  instruction: { s: 22.5, z: -1.22, r: 31.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.38 · 출력 $1.38 · 혼합 $1.38/1M · 59.0 t/s · TTFT 1.16s · 128k ctx` · 가성비 4.3
