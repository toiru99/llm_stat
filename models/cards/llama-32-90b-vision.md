...
radar:
  ...
  trust: { s: 23.3, z: -0.21, r: 46.9, estimated: true }  # 신뢰성
  multimodal: { s: 34.8, z: -1.77, r: 23.4, estimated: false }  # 멀티모달
  long_context: { s: 24.9, z: -0.72, r: 39.2, estimated: true }  # 긴문맥
  instruction: { s: 32.8, z: -0.83, r: 37.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
