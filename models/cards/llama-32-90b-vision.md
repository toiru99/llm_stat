...
radar:
  ...
  reasoning: { s: 23.5, z: -0.53, r: 42.1, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.25, r: 46.2, estimated: false }  # 코딩
  agentic: { s: 20.1, z: -0.62, r: 40.6, estimated: true }  # 에이전트
  trust: { s: 34.6, z: 0.31, r: 54.7, estimated: true }  # 신뢰성
  multimodal: { s: 34.8, z: -1.75, r: 23.8, estimated: false }  # 멀티모달
  long_context: { s: 11.1, z: -1.1, r: 33.4, estimated: true }  # 긴문맥
  instruction: { s: 25.6, z: -1.1, r: 33.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 42.1 | -0.53 | 실측 | [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
