...
radar:
  ...
  multimodal: { s: 34.3, z: -1.79, r: 23.1, estimated: false }  # 멀티모달
  long_context: { s: 24.9, z: -0.73, r: 39.1, estimated: true }  # 긴문맥
  instruction: { s: 32.9, z: -0.84, r: 37.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 39.1 | -0.73 | 실측 | [[gpqa-diamond]] 43.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.8 | -0.55 | 실측 | [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 45.7 | -0.29 | 실측 | [[scicode]] 24.0%×1.0 |
| 에이전트 | 44.1 | -0.39 | 추정 | (추정) |
| 신뢰성 | 46.6 | -0.23 | 추정 | (추정) |
| 멀티모달 | 23.1 | -1.79 | 실측 | [[mmmu-pro]] 39.0%×1.0 |
| 긴문맥 | 39.1 | -0.73 | 추정 | (추정) |
