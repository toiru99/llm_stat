...
radar:
  ...
  agentic: { s: 24.3, z: -0.5, r: 42.5, estimated: true }  # 에이전트
  trust: { s: 23.0, z: -0.22, r: 46.8, estimated: true }  # 신뢰성
  multimodal: { s: 34.3, z: -1.84, r: 22.4, estimated: false }  # 멀티모달
  long_context: { s: 23.0, z: -0.83, r: 37.5, estimated: true }  # 긴문맥
  instruction: { s: 32.3, z: -0.9, r: 36.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 에이전트 | 42.5 | -0.5 | 추정 | (추정) |
| 신뢰성 | 46.8 | -0.22 | 추정 | (추정) |
| 멀티모달 | 22.4 | -1.84 | 실측 | [[mmmu-pro]] 39.0%×1.0 |
| 긴문맥 | 37.5 | -0.83 | 추정 | (추정) |
