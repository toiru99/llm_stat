...
radar:
  ...
  reasoning: { s: 23.5, z: -0.54, r: 42.0, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.27, r: 45.9, estimated: false }  # 코딩
  agentic: { s: 26.3, z: -0.39, r: 44.2, estimated: true }  # 에이전트
  trust: { s: 23.3, z: -0.19, r: 47.1, estimated: true }  # 신뢰성
  multimodal: { s: 34.8, z: -1.77, r: 23.4, estimated: false }  # 멀티모달
  long_context: { s: 27.2, z: -0.66, r: 40.2, estimated: true }  # 긴문맥
  instruction: { s: 33.6, z: -0.79, r: 38.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 42.0 | -0.54 | 실측 | [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
