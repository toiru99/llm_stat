...
radar:
  ...
  agentic: { s: 18.2, z: -0.74, r: 38.9, estimated: true }  # 에이전트
  trust: { s: 21.7, z: -0.12, r: 48.1, estimated: true }  # 신뢰성
  multimodal: { s: 34.3, z: -1.8, r: 23.0, estimated: false }  # 멀티모달
  long_context: { s: 8.5, z: -1.26, r: 31.0, estimated: true }  # 긴문맥
  instruction: { s: 24.1, z: -1.2, r: 32.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
