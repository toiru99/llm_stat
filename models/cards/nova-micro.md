...
radar:
  ...
  coding: { s: 11.0, z: -1.5, r: 27.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $0.0271/1M · 280.0 t/s · TTFT 0.9s · 130k ctx` · 가성비 184.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 33.1 | -1.13 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 36.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 33.7 | -1.09 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 27.4 | -1.5 | 실측 | [[scicode]] 9.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
