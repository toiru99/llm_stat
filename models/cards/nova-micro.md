...
radar:
  ...
  coding: { s: 10.7, z: -1.53, r: 27.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $0.0271/1M · 263.0 t/s · TTFT 0.83s · 130k ctx` · 가성비 147.6
...
| 에이전트 | 33.3 | -1.11 | 실측 | [[tau2-bench]] 14.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
