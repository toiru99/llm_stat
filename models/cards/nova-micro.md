...
radar:
  ...
  agentic: { s: 8.6, z: -1.07, r: 34.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $0.03/1M · 285.0 t/s · TTFT 1.05s · 130k ctx` · 가성비 166.7
...
| 에이전트 | 34.0 | -1.07 | 실측 | [[tau2-bench]] 14.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
