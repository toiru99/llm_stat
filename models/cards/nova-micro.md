...
radar:
  ...
  coding: { s: 11.0, z: -1.48, r: 27.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $0.03/1M · 290.0 t/s · TTFT 1.08s · 130k ctx` · 가성비 166.7
...
| 코딩 | 27.7 | -1.48 | 실측 | [[scicode]] 9.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
