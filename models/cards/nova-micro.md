...
radar:
  ...
  reasoning: { s: 12.9, z: -1.08, r: 33.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.04 · 출력 $0.14 · 혼합 $None/1M · 281.0 t/s · TTFT 0.96s · 130k ctx`
...
| 추론 | 33.8 | -1.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
