...
is_reasoning: false
radar:
  knowledge: { s: 23.2, z: -0.86, r: 37.0, estimated: false }  # 전문 지식
  ...
  trust: { s: 31.6, z: 0.12, r: 51.8, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.065/1M · 106.0 t/s · TTFT 2.14s · 1M ctx` · 가성비 92.3
