...
is_reasoning: false
radar:
  knowledge: { s: 23.6, z: -0.81, r: 37.8, estimated: false }  # 전문 지식
  ...
  long_context: { s: 18.8, z: -0.88, r: 36.9, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 37.8 | -0.81 | 실측 | [[gpqa-diamond]] 41.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
