...
radar:
  ...
  reasoning: { s: 33.4, z: -0.08, r: 48.9, estimated: false }  # 추론
  coding: { s: 50.0, z: 0.11, r: 51.6, estimated: false }  # 코딩
  agentic: { s: 35.6, z: -0.01, r: 49.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $0.91/1M · 57.0 t/s · TTFT 3.25s · 262k ctx` · 가성비 23.1
...
| 추론 | 48.9 | -0.08 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 77.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 51.6 | +0.11 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 49.8 | -0.01 | 실측 | [[tau2-bench]] 54.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
