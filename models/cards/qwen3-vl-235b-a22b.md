...
is_reasoning: false
radar:
  knowledge: { s: 41.4, z: 0.03, r: 50.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $None/1M · 56.0 t/s · TTFT 2.85s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.5 | +0.03 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 77.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
