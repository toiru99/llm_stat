...
radar:
  ...
  agentic: { s: 35.6, z: -0.07, r: 49.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $4.0 · 혼합 $0.52/1M · 55.0 t/s · TTFT 2.92s · 262k ctx` · 가성비 40.4
...
| 에이전트 | 49.0 | -0.07 | 실측 | [[tau2-bench]] 54.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
