...
radar:
  ...
  agentic: { s: 23.0, z: -0.56, r: 41.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.52/1M · 51.0 t/s · TTFT 2.65s · 262k ctx` · 가성비 15.4
...
| 에이전트 | 41.7 | -0.56 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
