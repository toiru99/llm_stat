...
is_reasoning: false
radar:
  knowledge: { s: 36.3, z: -0.21, r: 46.8, estimated: false }  # 전문 지식
  reasoning: { s: 27.4, z: -0.37, r: 44.5, estimated: false }  # 추론
  coding: { s: 42.2, z: -0.2, r: 47.0, estimated: false }  # 코딩
  agentic: { s: 23.0, z: -0.56, r: 41.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $1.6 · 혼합 $0.52/1M · 51.0 t/s · TTFT 2.75s · 262k ctx` · 가성비 26.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.8 | -0.21 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 71.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 44.5 | -0.37 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 71.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 47.0 | -0.2 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 41.6 | -0.56 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
