...
radar:
  ...
  agentic: { s: 35.6, z: -0.04, r: 49.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $0.91/1M · 55.0 t/s · TTFT 3.2s · 262k ctx` · 가성비 23.1
...
| 코딩 | 51.1 | +0.07 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 49.4 | -0.04 | 실측 | [[tau2-bench]] 54.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
