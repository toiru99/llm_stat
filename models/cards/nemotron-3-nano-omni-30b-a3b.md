...
is_reasoning: true
radar:
  knowledge: { s: 24.5, z: -0.78, r: 38.3, estimated: false }  # 전문 지식
  reasoning: { s: 17.2, z: -0.88, r: 36.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $0.0975/1M · 328.0 t/s · TTFT 1.02s · 256k ctx` · 가성비 153.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.3 | -0.78 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 36.8 | -0.88 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
