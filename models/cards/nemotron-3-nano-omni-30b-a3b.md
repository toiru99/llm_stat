...
radar:
  ...
  reasoning: { s: 17.0, z: -0.91, r: 36.4, estimated: false }  # 추론
  coding: { s: 35.2, z: -0.55, r: 41.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $0.0975/1M · 323.0 t/s · TTFT 1.02s · 256k ctx` · 가성비 153.8
...
| 코딩 | 41.8 | -0.55 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
