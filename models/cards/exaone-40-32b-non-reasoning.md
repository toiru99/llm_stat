...
radar:
  ...
  coding: { s: 27.9, z: -0.8, r: 38.0, estimated: false }  # 코딩
  agentic: { s: 3.5, z: -1.31, r: 30.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 39.0 | -0.74 | 실측 | [[aa-omniscience]] 11.0%×1.0, [[gpqa-diamond]] 63.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.5 | -0.57 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 63.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 38.0 | -0.8 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 30.3 | -1.31 | 실측 | [[tau2-bench]] 4.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
