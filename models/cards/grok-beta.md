...
radar:
  ...
  agentic: { s: 42.4, z: 0.23, r: 53.4, estimated: true }  # 에이전트
  trust: { s: 40.3, z: 0.59, r: 58.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 39.3, z: -0.33, r: 45.0, estimated: true }  # 긴문맥
  instruction: { s: 54.1, z: -0.01, r: 49.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
