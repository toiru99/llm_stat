...
radar:
  ...
  coding: { s: 5.4, z: -2.32, r: 15.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.03/1M · 38.0 t/s · TTFT 0.7s · 262k ctx` · 가성비 333.3
...
| 코딩 | 15.1 | -2.32 | 실측 | [[scicode]] 3.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
