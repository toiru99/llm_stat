...
radar:
  ...
  agentic: { s: 25.3, z: -0.47, r: 43.0, estimated: false }  # 에이전트
...
Alibaba · Open · Tiny(2.27B) · 컨텍스트 262k · 종합지능 **2.0**
...
| 에이전트 | 43.0 | -0.47 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
