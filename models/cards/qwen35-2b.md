...
radar:
  knowledge: { s: 14.2, z: -1.66, r: 25.1, estimated: false }  # 전문 지식
  reasoning: { s: 14.7, z: -1.4, r: 29.1, estimated: false }  # 추론
  coding: { s: 5.4, z: -2.31, r: 15.3, estimated: false }  # 코딩
  ...
  long_context: { s: 32.4, z: -1.36, r: 29.6, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.03/1M · 38.0 t/s · TTFT 0.83s · 262k ctx` · 가성비 333.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 25.1 | -1.66 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 2.0%×0.3 |
| 추론 | 29.1 | -1.4 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 2.0%×1.0 |
| 코딩 | 15.3 | -2.31 | 실측 | [[scicode]] 3.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
...
| 긴문맥 | 29.6 | -1.36 | 실측 | [[aa-lcr]] 24.0%×1.0 |
