...
is_reasoning: true
radar:
  knowledge: { s: 17.6, z: -1.13, r: 33.0, estimated: false }  # 전문 지식
  reasoning: { s: 15.3, z: -0.96, r: 35.5, estimated: false }  # 추론
  coding: { s: 5.2, z: -1.76, r: 23.7, estimated: false }  # 코딩
  agentic: { s: 25.3, z: -0.47, r: 42.9, estimated: false }  # 에이전트
...
| 추론 | 35.5 | -0.96 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 23.7 | -1.76 | 실측 | [[scicode]] 3.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 42.9 | -0.47 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
