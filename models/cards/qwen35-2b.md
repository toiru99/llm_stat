...
is_reasoning: true
radar:
  knowledge: { s: 17.1, z: -1.15, r: 32.7, estimated: false }  # 전문 지식
  reasoning: { s: 15.4, z: -0.99, r: 35.2, estimated: false }  # 추론
  coding: { s: 5.4, z: -1.76, r: 23.6, estimated: false }  # 코딩
  agentic: { s: 25.3, z: -0.46, r: 43.1, estimated: false }  # 에이전트
  trust: { s: 27.9, z: -0.01, r: 49.9, estimated: false }  # 신뢰성
  multimodal: { s: 40.0, z: -1.57, r: 26.5, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 32.7 | -1.15 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 35.2 | -0.99 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 23.6 | -1.76 | 실측 | [[scicode]] 3.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 43.1 | -0.46 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 69.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
| 신뢰성 | 49.9 | -0.01 | 실측 | [[aa-omniscience]] 26.0%×1.0 |
| 멀티모달 | 26.5 | -1.57 | 실측 | [[mmmu-pro]] 43.0%×1.0 |
