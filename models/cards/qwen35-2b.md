...
radar:
  ...
  agentic: { s: 25.3, z: -1.04, r: 34.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.02 · 출력 $0.1 · 혼합 $0.03/1M · 37.0 t/s · TTFT 0.96s · 262k ctx` · 가성비 333.3
...
| 에이전트 | 34.3 | -1.04 | 실측 | [[tau2-bench]] 69.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
