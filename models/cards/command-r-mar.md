...
radar:
  ...
  agentic: { s: 6.2, z: -1.18, r: 32.4, estimated: true }  # 에이전트
  trust: { s: 20.0, z: -0.38, r: 44.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 4.7, z: -1.33, r: 30.1, estimated: true }  # 긴문맥
  instruction: { s: 28.7, z: -1.01, r: 34.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $1.5 · 혼합 $None/1M · None t/s · TTFT Nones · 128k ctx`
...
| 코딩 | 26.9 | -1.54 | 실측 | [[scicode]] 6.0%×1.0 |
