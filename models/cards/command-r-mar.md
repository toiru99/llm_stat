...
radar:
  ...
  agentic: { s: 6.2, z: -1.18, r: 32.2, estimated: true }  # 에이전트
  trust: { s: 20.0, z: -0.4, r: 44.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 3.4, z: -1.38, r: 29.3, estimated: true }  # 긴문맥
  instruction: { s: 19.9, z: -1.38, r: 29.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
