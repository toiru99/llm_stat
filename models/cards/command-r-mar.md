...
is_reasoning: false
radar:
  knowledge: { s: 15.3, z: -1.24, r: 31.5, estimated: false }  # 전문 지식
  ...
  trust: { s: 23.5, z: -0.17, r: 47.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 14.2, z: -1.1, r: 33.5, estimated: true }  # 긴문맥
  instruction: { s: 21.6, z: -1.33, r: 30.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 31.5 | -1.24 | 실측 | [[gpqa-diamond]] 28.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
