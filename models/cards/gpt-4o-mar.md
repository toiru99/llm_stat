...
radar:
  ...
  agentic: { s: 42.0, z: 0.21, r: 53.2, estimated: true }  # 에이전트
  trust: { s: 34.6, z: 0.34, r: 55.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 56.9, z: 0.2, r: 53.0, estimated: true }  # 긴문맥
  instruction: { s: 45.7, z: -0.35, r: 44.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
