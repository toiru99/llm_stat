...
is_reasoning: false
radar:
  knowledge: { s: 40.7, z: 0.0, r: 50.1, estimated: false }  # 전문 지식
  ...
  instruction: { s: 51.0, z: -0.07, r: 49.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 50.1 | +0.0 | 실측 | [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
