...
radar:
  ...
  agentic: { s: 59.0, z: 0.84, r: 62.5, estimated: true }  # 에이전트
  trust: { s: 31.5, z: 0.33, r: 54.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 47.2, z: -0.09, r: 48.6, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 48.9 | -0.07 | 실측 | [[gpqa-diamond]] 65.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 50.1 | +0.01 | 실측 | [[gpqa-diamond]] 65.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 58.0 | +0.53 | 실측 | [[scicode]] 37.0%×1.0 |
| 에이전트 | 62.5 | +0.84 | 추정 | (추정) |
| 신뢰성 | 54.9 | +0.33 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 48.6 | -0.09 | 추정 | (추정) |
