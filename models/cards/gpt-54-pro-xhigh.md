...
radar:
  ...
  reasoning: { s: 93.8, z: 2.81, r: 92.2, estimated: false }  # 추론
  coding: { s: 92.7, z: 1.79, r: 76.9, estimated: true }  # 코딩
  agentic: { s: 89.9, z: 2.02, r: 80.4, estimated: true }  # 에이전트
  trust: { s: 28.8, z: 0.0, r: 50.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 92.5, z: 1.25, r: 68.7, estimated: true }  # 긴문맥
...
| 추론 | 92.2 | +2.81 | 실측 | [[critpt]] 30.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 추정 | (추정) |
| 에이전트 | 80.4 | +2.02 | 추정 | (추정) |
| 신뢰성 | 50.0 | +0.0 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 68.7 | +1.25 | 추정 | (추정) |
