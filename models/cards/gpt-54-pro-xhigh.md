...
radar:
  ...
  reasoning: { s: 93.8, z: 3.14, r: 97.1, estimated: false }  # 추론
  coding: { s: 93.8, z: 1.99, r: 79.9, estimated: true }  # 코딩
  agentic: { s: 91.1, z: 2.13, r: 81.9, estimated: true }  # 에이전트
  trust: { s: 13.1, z: -0.68, r: 39.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 94.7, z: 1.36, r: 70.4, estimated: true }  # 긴문맥
  instruction: { s: 84.8, z: 1.33, r: 69.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 97.1 | +3.14 | 실측 | [[critpt]] 30.0%×1.0 |
| 코딩 | 79.9 | +1.99 | 추정 | (추정) |
