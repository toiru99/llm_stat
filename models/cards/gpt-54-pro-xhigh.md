...
radar:
  ...
  agentic: { s: 91.3, z: 2.13, r: 82.0, estimated: true }  # 에이전트
  trust: { s: 13.1, z: -0.69, r: 39.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 94.7, z: 1.36, r: 70.3, estimated: true }  # 긴문맥
  instruction: { s: 84.8, z: 1.32, r: 69.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
