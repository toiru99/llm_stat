...
is_reasoning: true
radar:
  knowledge: { s: 92.1, z: 2.48, r: 87.3, estimated: true }  # 전문 지식
  reasoning: { s: 93.8, z: 3.15, r: 97.2, estimated: false }  # 추론
  coding: { s: 93.8, z: 2.0, r: 80.0, estimated: true }  # 코딩
  agentic: { s: 91.1, z: 2.13, r: 81.9, estimated: true }  # 에이전트
  trust: { s: 13.4, z: -0.68, r: 39.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 94.7, z: 1.36, r: 70.4, estimated: true }  # 긴문맥
  instruction: { s: 84.8, z: 1.34, r: 70.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 87.3 | +2.48 | 추정 | (추정) |
| 추론 | 97.2 | +3.15 | 실측 | [[critpt]] 30.0%×1.0 |
| 코딩 | 80.0 | +2.0 | 추정 | (추정) |
