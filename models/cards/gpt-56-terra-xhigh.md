...
radar:
  ...
  reasoning: { s: 85.2, z: 2.4, r: 86.0, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.67, r: 75.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 106.0 t/s · TTFT 29.78s · 1M ctx` · 가성비 30.5
...
| 추론 | 86.0 | +2.4 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 75.0 | +1.67 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 73.8 | +1.59 | 실측 | [[gdpval]] 53.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
