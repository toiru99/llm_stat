...
radar:
  ...
  reasoning: { s: 85.2, z: 2.43, r: 86.4, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.69, r: 75.3, estimated: false }  # 코딩
  agentic: { s: 78.9, z: 1.65, r: 74.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 102.0 t/s · TTFT 22.27s · 1M ctx` · 가성비 30.5
...
| 추론 | 86.4 | +2.43 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 75.3 | +1.69 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 74.7 | +1.65 | 실측 | [[gdpval]] 54.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
