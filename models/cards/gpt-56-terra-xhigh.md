...
radar:
  ...
  agentic: { s: 78.9, z: 1.67, r: 75.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 116.0 t/s · TTFT 21.66s · 1M ctx` · 가성비 30.5
...
| 에이전트 | 75.0 | +1.67 | 실측 | [[gdpval]] 54.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
