...
radar:
  ...
  reasoning: { s: 85.6, z: 2.52, r: 87.7, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.75, r: 76.3, estimated: false }  # 코딩
  agentic: { s: 78.9, z: 1.71, r: 75.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 108.0 t/s · TTFT 27.32s · 1M ctx` · 가성비 30.5
...
| 추론 | 87.7 | +2.52 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 76.3 | +1.75 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 75.7 | +1.71 | 실측 | [[gdpval]] 54.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
