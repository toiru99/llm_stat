...
radar:
  ...
  reasoning: { s: 83.5, z: 2.41, r: 86.1, estimated: false }  # 추론
  coding: { s: 87.7, z: 1.71, r: 75.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 83.0 t/s · TTFT 21.65s · 1M ctx` · 가성비 30.5
...
| 코딩 | 75.6 | +1.71 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 73.6 | +1.57 | 실측 | [[gdpval]] 53.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
