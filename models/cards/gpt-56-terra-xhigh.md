...
is_reasoning: true
radar:
  knowledge: { s: 79.1, z: 1.77, r: 76.6, estimated: false }  # 전문 지식
  reasoning: { s: 85.3, z: 2.52, r: 87.8, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.75, r: 76.3, estimated: false }  # 코딩
  agentic: { s: 78.2, z: 1.7, r: 75.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 116.0 t/s · TTFT 32.24s · 1M ctx` · 가성비 29.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 76.6 | +1.77 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 87.8 | +2.52 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 76.3 | +1.75 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 75.5 | +1.7 | 실측 | [[gdpval]] 54.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 24.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
