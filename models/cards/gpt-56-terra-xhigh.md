...
is_reasoning: true
radar:
  knowledge: { s: 79.1, z: 1.86, r: 77.8, estimated: false }  # 전문 지식
  reasoning: { s: 85.3, z: 2.7, r: 90.5, estimated: false }  # 추론
  coding: { s: 89.6, z: 1.82, r: 77.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 137.0 t/s · TTFT 10.63s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 77.8 | +1.86 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 90.5 | +2.7 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 77.3 | +1.82 | 실측 | [[scicode]] 52.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
