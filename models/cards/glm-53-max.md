...
radar:
  ...
  agentic: { s: 94.4, z: 2.21, r: 83.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.902/1M · 63.0 t/s · TTFT 2.13s · 1M ctx` · 가성비 66.5
...
| 추론 | 80.2 | +2.01 | 실측 | [[critpt]] 19.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 77.3 | +1.82 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 83.1 | +2.21 | 실측 | [[gdpval]] 63.0%×1.0, [[tau3-banking]] 50.0%×1.0 |
