...
is_reasoning: true
radar:
  knowledge: { s: 66.4, z: 1.2, r: 68.0, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.902/1M · 85.0 t/s · TTFT 1.88s · 1M ctx` · 가성비 66.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.0 | +1.2 | 실측 | [[aa-omniscience]] 34.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 80.6 | +2.04 | 실측 | [[critpt]] 19.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 77.6 | +1.84 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 84.8 | +2.32 | 실측 | [[gdpval]] 63.0%×1.0, [[tau3-banking]] 50.0%×1.0 |
