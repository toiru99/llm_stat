...
radar:
  ...
  instruction: { s: 73.7, z: 0.9, r: 63.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.4 · 출력 $4.4 · 혼합 $0.902/1M · 66.0 t/s · TTFT 1.62s · 1M ctx` · 가성비 66.5
...
| 추론 | 82.5 | +2.17 | 실측 | [[critpt]] 19.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
