...
is_reasoning: false
radar:
  knowledge: { s: 8.2, z: -1.55, r: 26.7, estimated: false }  # 전문 지식
  reasoning: { s: 8.1, z: -1.32, r: 30.2, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 26.7 | -1.55 | 실측 | [[aa-omniscience]] 4.0%×1.0, [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.2 | -1.32 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 24.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
