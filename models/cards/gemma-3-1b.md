...
is_reasoning: false
radar:
  knowledge: { s: 7.9, z: -1.58, r: 26.2, estimated: false }  # 전문 지식
  reasoning: { s: 8.0, z: -1.34, r: 29.8, estimated: false }  # 추론
...
| 추론 | 29.8 | -1.34 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 24.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
