...
OpenAI · Proprietary · Unknown · 컨텍스트 200k · 종합지능 **17.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $15.0 · 출력 $60.0 · 혼합 $14.25/1M · None t/s · TTFT Nones · 200k ctx` · 가성비 1.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.8 | +0.45 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 45.4 | -0.31 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 43.5 | -0.43 | 실측 | [[terminal-bench]] 13.0%×0.5 |
| 에이전트 | 52.4 | +0.16 | 실측 | [[tau2-bench]] 63.0%×1.0, [[terminal-bench]] 13.0%×1.0 |
