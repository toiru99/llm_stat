...
is_reasoning: true
radar:
  knowledge: { s: 12.9, z: -1.33, r: 30.0, estimated: false }  # 전문 지식
  reasoning: { s: 11.0, z: -1.18, r: 32.3, estimated: false }  # 추론
  coding: { s: 7.2, z: -1.67, r: 25.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 30.0 | -1.33 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 33.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 32.3 | -1.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 33.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 25.0 | -1.67 | 실측 | [[scicode]] 6.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
