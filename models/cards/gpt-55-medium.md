...
radar:
  ...
  reasoning: { s: 77.6, z: 2.18, r: 82.7, estimated: false }  # 추론
  coding: { s: 88.2, z: 1.7, r: 75.5, estimated: false }  # 코딩
  agentic: { s: 76.2, z: 1.54, r: 73.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 76.0 t/s · TTFT 9.22s · 922k ctx` · 가성비 11.7
...
| 추론 | 82.7 | +2.18 | 실측 | [[critpt]] 19.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 75.5 | +1.7 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 58.0%×0.5 |
| 에이전트 | 73.1 | +1.54 | 실측 | [[gdpval]] 43.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
