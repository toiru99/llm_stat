...
is_reasoning: true
radar:
  knowledge: { s: 88.0, z: 2.35, r: 85.2, estimated: false }  # 전문 지식
  reasoning: { s: 77.6, z: 2.19, r: 82.8, estimated: false }  # 추론
  coding: { s: 88.2, z: 1.7, r: 75.5, estimated: false }  # 코딩
  agentic: { s: 76.6, z: 1.56, r: 73.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 77.0 t/s · TTFT 9.22s · 922k ctx` · 가성비 11.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.2 | +2.35 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 82.8 | +2.19 | 실측 | [[critpt]] 19.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
