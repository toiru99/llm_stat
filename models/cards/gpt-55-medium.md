...
is_reasoning: true
radar:
  knowledge: { s: 88.1, z: 2.28, r: 84.1, estimated: false }  # 전문 지식
  reasoning: { s: 78.0, z: 2.14, r: 82.1, estimated: false }  # 추론
  coding: { s: 88.2, z: 1.69, r: 75.4, estimated: false }  # 코딩
  agentic: { s: 76.3, z: 1.61, r: 74.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 71.0 t/s · TTFT 6.51s · 922k ctx` · 가성비 11.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 84.1 | +2.28 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
...
| 에이전트 | 74.1 | +1.61 | 실측 | [[gdpval]] 44.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
