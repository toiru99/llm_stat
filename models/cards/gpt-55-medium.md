...
radar:
  ...
  agentic: { s: 75.5, z: 1.46, r: 71.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 72.0 t/s · TTFT 9.96s · 922k ctx` · 가성비 9.7
...
| 에이전트 | 71.8 | +1.46 | 실측 | [[gdpval]] 40.0%×1.0, [[tau2-bench]] 92.0%×1.0, [[tau3-banking]] 30.0%×1.0, [[terminal-bench]] 58.0%×1.0 |
