...
radar:
  ...
  reasoning: { s: 61.4, z: 1.35, r: 70.3, estimated: false }  # 추론
  coding: { s: 74.5, z: 1.18, r: 67.7, estimated: false }  # 코딩
  agentic: { s: 59.9, z: 0.89, r: 63.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 180.0 t/s · TTFT 5.88s · 1M ctx` · 가성비 89.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.4 | +1.96 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 70.3 | +1.35 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 67.7 | +1.18 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 63.3 | +0.89 | 실측 | [[apex-agents]] 28.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
