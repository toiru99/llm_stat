...
radar:
  ...
  reasoning: { s: 63.0, z: 1.34, r: 70.1, estimated: false }  # 추론
  coding: { s: 76.4, z: 1.15, r: 67.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 161.0 t/s · TTFT 6.24s · 1M ctx` · 가성비 89.7
...
| 추론 | 70.1 | +1.34 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 67.2 | +1.15 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
