...
is_reasoning: true
radar:
  knowledge: { s: 85.9, z: 2.18, r: 82.6, estimated: false }  # 전문 지식
  reasoning: { s: 62.9, z: 1.52, r: 72.8, estimated: false }  # 추론
  coding: { s: 76.4, z: 1.26, r: 68.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $None/1M · 170.0 t/s · TTFT 7.07s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 82.6 | +2.18 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 35.0%×0.3 |
| 추론 | 72.8 | +1.52 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 68.9 | +1.26 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
