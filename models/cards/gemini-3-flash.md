...
is_reasoning: true
radar:
  knowledge: { s: 82.0, z: 1.98, r: 79.6, estimated: false }  # 전문 지식
  reasoning: { s: 63.3, z: 1.41, r: 71.2, estimated: false }  # 추론
  coding: { s: 76.4, z: 1.21, r: 68.1, estimated: false }  # 코딩
  agentic: { s: 59.9, z: 0.96, r: 64.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 188.0 t/s · TTFT 6.55s · 1M ctx` · 가성비 89.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.6 | +1.98 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 71.2 | +1.41 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 68.1 | +1.21 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 64.4 | +0.96 | 실측 | [[apex-agents]] 28.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
