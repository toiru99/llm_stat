...
radar:
  ...
  reasoning: { s: 61.4, z: 1.32, r: 69.8, estimated: false }  # 추론
  coding: { s: 74.5, z: 1.15, r: 67.3, estimated: false }  # 코딩
  agentic: { s: 59.7, z: 0.87, r: 63.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 185.0 t/s · TTFT 6.07s · 1M ctx` · 가성비 89.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 78.8 | +1.92 | 실측 | [[aa-omniscience]] 53.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
