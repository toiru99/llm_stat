...
radar:
  ...
  coding: { s: 76.4, z: 1.22, r: 68.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $None/1M · 185.0 t/s · TTFT 7.04s · 1M ctx`
...
| 추론 | 71.5 | +1.43 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 35.0%×1.0 |
| 코딩 | 68.4 | +1.22 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 39.0%×0.5 |
| 에이전트 | 65.5 | +1.03 | 실측 | [[apex-agents]] 28.0%×1.0, [[tau2-bench]] 80.0%×1.0, [[tau3-banking]] 18.0%×1.0, [[terminal-bench]] 39.0%×1.0 |
