...
radar:
  ...
  reasoning: { s: 80.3, z: 2.15, r: 82.3, estimated: false }  # 추론
  coding: { s: 86.7, z: 1.54, r: 73.2, estimated: false }  # 코딩
  agentic: { s: 89.2, z: 1.99, r: 79.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 61.0 t/s · TTFT 38.22s · 500k ctx` · 가성비 44.4
...
| 추론 | 82.3 | +2.15 | 실측 | [[critpt]] 20.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 44.0%×1.0 |
| 코딩 | 73.2 | +1.54 | 실측 | [[scicode]] 52.0%×1.0 |
| 에이전트 | 79.8 | +1.99 | 실측 | [[gdpval]] 63.0%×1.0, [[tau3-banking]] 43.0%×1.0 |
