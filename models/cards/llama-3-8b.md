...
is_reasoning: false
radar:
  knowledge: { s: 15.9, z: -1.23, r: 31.5, estimated: false }  # 전문 지식
  reasoning: { s: 10.3, z: -1.22, r: 31.7, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 31.5 | -1.23 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 30.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
