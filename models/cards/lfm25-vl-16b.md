...
is_reasoning: false
radar:
  knowledge: { s: 10.6, z: -1.44, r: 28.4, estimated: false }  # 전문 지식
  reasoning: { s: 10.1, z: -1.23, r: 31.5, estimated: false }  # 추론
  coding: { s: 3.3, z: -1.81, r: 22.9, estimated: false }  # 코딩
  agentic: { s: 4.0, z: -1.24, r: 31.3, estimated: false }  # 에이전트
...
Liquid AI · Open · Unknown · 컨텍스트 32k · 종합지능 **1.0**
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.0/1M · 427.0 t/s · TTFT 11.54s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 28.4 | -1.44 | 실측 | [[aa-omniscience]] 5.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 31.3 | -1.24 | 실측 | [[tau2-bench]] 8.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
