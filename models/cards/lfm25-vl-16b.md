...
radar:
  ...
  agentic: { s: 4.0, z: -1.29, r: 30.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 418.0 t/s · TTFT 1.41s · 32k ctx`
...
| 에이전트 | 30.6 | -1.29 | 실측 | [[tau2-bench]] 8.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
