...
radar:
  ...
  reasoning: { s: 10.1, z: -1.22, r: 31.7, estimated: false }  # 추론
  ...
  multimodal: { s: 17.1, z: -2.62, r: 10.7, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 388.0 t/s · TTFT 10.9s · 32k ctx`
...
| 멀티모달 | 10.7 | -2.62 | 실측 | [[mmmu-pro]] 27.0%×1.0 |
