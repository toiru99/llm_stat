...
is_reasoning: false
radar:
  knowledge: { s: 11.2, z: -1.41, r: 28.8, estimated: false }  # 전문 지식
  reasoning: { s: 10.0, z: -1.23, r: 31.6, estimated: false }  # 추론
  coding: { s: 3.3, z: -1.83, r: 22.6, estimated: false }  # 코딩
  agentic: { s: 4.0, z: -1.26, r: 31.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 391.0 t/s · TTFT 0.79s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 28.8 | -1.41 | 실측 | [[aa-omniscience]] 6.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 31.1 | -1.26 | 실측 | [[tau2-bench]] 8.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
