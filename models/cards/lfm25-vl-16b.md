...
is_reasoning: false
radar:
  knowledge: { s: 11.2, z: -1.43, r: 28.5, estimated: false }  # 전문 지식
  reasoning: { s: 9.9, z: -1.25, r: 31.2, estimated: false }  # 추론
  coding: { s: 3.3, z: -1.85, r: 22.3, estimated: false }  # 코딩
  agentic: { s: 4.0, z: -1.28, r: 30.7, estimated: false }  # 에이전트
  trust: { s: 2.3, z: -1.1, r: 33.4, estimated: false }  # 신뢰성
  multimodal: { s: 17.1, z: -2.67, r: 10.0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0/1M · 352.0 t/s · TTFT 1.2s · 32k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 28.5 | -1.43 | 실측 | [[aa-omniscience]] 6.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 30.7 | -1.28 | 실측 | [[tau2-bench]] 8.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 33.4 | -1.1 | 실측 | [[aa-omniscience]] 4.0%×1.0 |
| 멀티모달 | 10.0 | -2.67 | 실측 | [[mmmu-pro]] 27.0%×1.0 |
