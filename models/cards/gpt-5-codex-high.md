...
is_reasoning: true
radar:
  knowledge: { s: 66.5, z: 1.19, r: 67.8, estimated: false }  # 전문 지식
  reasoning: { s: 50.6, z: 0.81, r: 62.2, estimated: false }  # 추론
  coding: { s: 64.7, z: 0.74, r: 61.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 67.8 | +1.19 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 62.2 | +0.81 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 61.1 | +0.74 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
