...
radar:
  ...
  reasoning: { s: 49.7, z: 0.77, r: 61.5, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.7, r: 60.5, estimated: false }  # 코딩
  agentic: { s: 72.7, z: 1.39, r: 70.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 66.9 | +1.13 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 61.5 | +0.77 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 60.5 | +0.7 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 70.8 | +1.39 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
