...
is_reasoning: true
radar:
  knowledge: { s: 66.5, z: 1.18, r: 67.8, estimated: false }  # 전문 지식
  reasoning: { s: 50.6, z: 0.81, r: 62.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 67.8 | +1.18 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 62.1 | +0.81 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
