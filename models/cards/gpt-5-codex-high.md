...
radar:
  ...
  reasoning: { s: 49.4, z: 0.69, r: 60.4, estimated: false }  # 추론
  coding: { s: 57.6, z: 0.9, r: 63.4, estimated: false }  # 코딩
  agentic: { s: 72.7, z: 1.35, r: 70.2, estimated: false }  # 에이전트
...
OpenAI · Proprietary · Unknown · 컨텍스트 400k · 종합지능 **29.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · None t/s · TTFT Nones · 400k ctx` · 가성비 21.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.7 | +1.05 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 60.4 | +0.69 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 63.4 | +0.9 | 실측 | [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 70.2 | +1.35 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
