...
is_reasoning: true
radar:
  knowledge: { s: 66.5, z: 1.25, r: 68.7, estimated: false }  # 전문 지식
  reasoning: { s: 50.6, z: 0.88, r: 63.3, estimated: false }  # 추론
  coding: { s: 64.7, z: 0.78, r: 61.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 189.0 t/s · TTFT 15.59s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.7 | +1.25 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 63.3 | +0.88 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 61.6 | +0.78 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
