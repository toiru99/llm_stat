...
is_reasoning: true
radar:
  knowledge: { s: 64.6, z: 1.19, r: 67.8, estimated: false }  # 전문 지식
  reasoning: { s: 50.9, z: 0.83, r: 62.5, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 67.8 | +1.19 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 62.5 | +0.83 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
