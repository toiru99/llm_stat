...
radar:
  ...
  reasoning: { s: 29.6, z: -0.25, r: 46.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.4 · 출력 $0.4 · 혼합 $0.4/1M · 68.0 t/s · TTFT 6.38s · 128k ctx` · 가성비 30.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.1 | -0.26 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.2 | -0.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
