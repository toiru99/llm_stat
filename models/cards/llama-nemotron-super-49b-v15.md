...
## 실용 지표
`입력 $0.4 · 출력 $0.4 · 혼합 $0.4/1M · 101.0 t/s · TTFT 3.85s · 128k ctx` · 가성비 30.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.7 | -0.28 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
