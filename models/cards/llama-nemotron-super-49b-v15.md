...
radar:
  ...
  reasoning: { s: 29.6, z: -0.21, r: 46.8, estimated: false }  # 추론
  coding: { s: 41.4, z: -0.21, r: 46.9, estimated: false }  # 코딩
  agentic: { s: 17.9, z: -0.72, r: 39.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $0.4 · 혼합 $None/1M · 108.0 t/s · TTFT 4.4s · 128k ctx`
...
| 추론 | 46.8 | -0.21 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 46.9 | -0.21 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 39.3 | -0.72 | 실측 | [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
