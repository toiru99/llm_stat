...
radar:
  ...
  agentic: { s: 44.2, z: 0.31, r: 54.6, estimated: true }  # 에이전트
  trust: { s: 12.5, z: -0.73, r: 39.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 62.4, z: 0.41, r: 56.1, estimated: true }  # 긴문맥
  instruction: { s: 60.0, z: 0.32, r: 54.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 50.0 | +-0.0 | 실측 | [[gpqa-diamond]] 60.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
