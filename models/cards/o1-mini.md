...
radar:
  ...
  agentic: { s: 37.0, z: 0.04, r: 50.6, estimated: true }  # 에이전트
  trust: { s: 31.9, z: 0.26, r: 53.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 54.8, z: 0.16, r: 52.4, estimated: true }  # 긴문맥
  instruction: { s: 51.8, z: -0.08, r: 48.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
