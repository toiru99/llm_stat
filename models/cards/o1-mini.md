...
radar:
  ...
  agentic: { s: 37.0, z: 0.01, r: 50.2, estimated: true }  # 에이전트
  trust: { s: 31.9, z: 0.22, r: 53.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 54.6, z: 0.13, r: 51.9, estimated: true }  # 긴문맥
  instruction: { s: 50.3, z: -0.16, r: 47.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
