...
radar:
  ...
  agentic: { s: 39.6, z: 0.16, r: 52.3, estimated: true }  # 에이전트
  trust: { s: 27.4, z: 0.05, r: 50.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 50.6, z: 0.04, r: 50.6, estimated: true }  # 긴문맥
  instruction: { s: 59.5, z: 0.24, r: 53.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
