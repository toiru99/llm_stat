...
is_reasoning: false
radar:
  knowledge: { s: 4.4, z: -1.73, r: 24.0, estimated: false }  # 전문 지식
  reasoning: { s: 6.7, z: -1.39, r: 29.1, estimated: false }  # 추론
  ...
  instruction: { s: 0.0, z: -2.2, r: 17.1, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 29.1 | -1.39 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 22.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
...
| 지시 따르기 | 17.1 | -2.2 | 실측 | [[ifbench]] 12.0%×1.0 |
