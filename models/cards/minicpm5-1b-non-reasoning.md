...
is_reasoning: false
radar:
  knowledge: { s: 5.9, z: -1.71, r: 24.3, estimated: false }  # 전문 지식
  reasoning: { s: 9.0, z: -1.28, r: 30.8, estimated: false }  # 추론
  coding: { s: 1.1, z: -1.93, r: 21.0, estimated: false }  # 코딩
  agentic: { s: 41.4, z: 0.17, r: 52.5, estimated: false }  # 에이전트
  trust: { s: 100.0, z: 3.61, r: 100, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 24.3 | -1.71 | 실측 | [[aa-omniscience]] 0.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 52.5 | +0.17 | 실측 | [[tau2-bench]] 82.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 100 | +3.61 | 실측 | [[aa-omniscience]] 99.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
