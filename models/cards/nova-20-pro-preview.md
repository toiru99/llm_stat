...
radar:
  ...
  coding: { s: 39.7, z: -0.26, r: 46.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $2.13/1M · 116.0 t/s · TTFT 1.13s · 256k ctx` · 가성비 6.6
...
| 코딩 | 46.1 | -0.26 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 17.0%×0.5 |
