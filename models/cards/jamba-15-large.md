...
radar:
  ...
  reasoning: { s: 22.5, z: -0.58, r: 41.2, estimated: false }  # 추론
  coding: { s: 26.7, z: -0.83, r: 37.6, estimated: false }  # 코딩
  agentic: { s: 10.7, z: -0.99, r: 35.1, estimated: true }  # 에이전트
  trust: { s: 21.7, z: -0.28, r: 45.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.1, z: -0.73, r: 39.1, estimated: true }  # 긴문맥
  instruction: { s: 35.0, z: -0.73, r: 39.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 41.2 | -0.58 | 실측 | [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
