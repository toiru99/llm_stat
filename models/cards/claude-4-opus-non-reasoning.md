...
radar:
  ...
  agentic: { s: 53.6, z: 0.66, r: 59.9, estimated: true }  # 에이전트
  trust: { s: 26.4, z: 0.11, r: 51.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 48.2, z: -0.03, r: 49.5, estimated: false }  # 긴문맥
...
| 신뢰성 | 51.6 | +0.11 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 49.5 | -0.03 | 실측 | [[aa-lcr]] 40.0%×1.0 |
