...
radar:
  ...
  coding: { s: 36.5, z: -0.46, r: 43.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.322/1M · 101.0 t/s · TTFT 1.88s · 65k ctx` · 가성비 31.1
...
| 코딩 | 43.0 | -0.46 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
