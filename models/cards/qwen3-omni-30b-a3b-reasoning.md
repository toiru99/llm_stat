...
Alibaba · Open · Small(35.3B) · 컨텍스트 65k · 종합지능 **4.0**
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.322/1M · 100.0 t/s · TTFT 1.88s · 65k ctx` · 가성비 12.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.7 | -0.42 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
