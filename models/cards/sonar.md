...
radar:
  ...
  agentic: { s: 31.1, z: -0.2, r: 46.9, estimated: true }  # 에이전트
  trust: { s: 24.4, z: -0.16, r: 47.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 45.1, z: -0.12, r: 48.2, estimated: true }  # 긴문맥
  instruction: { s: 48.8, z: -0.17, r: 47.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
