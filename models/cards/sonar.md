...
radar:
  ...
  reasoning: { s: 27.8, z: -0.31, r: 45.3, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.34, r: 44.9, estimated: false }  # 코딩
  agentic: { s: 31.1, z: -0.2, r: 47.0, estimated: true }  # 에이전트
  trust: { s: 23.8, z: -0.18, r: 47.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 45.1, z: -0.12, r: 48.3, estimated: true }  # 긴문맥
  instruction: { s: 48.4, z: -0.18, r: 47.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 45.3 | -0.31 | 실측 | [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
