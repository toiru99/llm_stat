...
is_reasoning: true
radar:
  knowledge: { s: 10.9, z: -1.48, r: 27.8, estimated: false }  # 전문 지식
  reasoning: { s: 8.6, z: -1.31, r: 30.4, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 27.8 | -1.48 | 실측 | [[aa-omniscience]] 6.0%×1.0, [[gpqa-diamond]] 24.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
