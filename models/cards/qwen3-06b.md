...
is_reasoning: true
radar:
  knowledge: { s: 7.9, z: -1.57, r: 26.5, estimated: false }  # 전문 지식
  reasoning: { s: 7.7, z: -1.36, r: 29.6, estimated: false }  # 추론
  coding: { s: 4.4, z: -1.76, r: 23.6, estimated: false }  # 코딩
  agentic: { s: 7.6, z: -1.11, r: 33.4, estimated: false }  # 에이전트
...
Alibaba · Open · Unknown · 컨텍스트 32k · 종합지능 **1.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 26.5 | -1.57 | 실측 | [[aa-omniscience]] 4.0%×1.0, [[gpqa-diamond]] 23.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 33.4 | -1.11 | 실측 | [[tau2-bench]] 15.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
