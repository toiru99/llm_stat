...
radar:
  ...
  instruction: { s: 7.0, z: -1.9, r: 21.4, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 28.0 | -1.47 | 실측 | [[aa-omniscience]] 4.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 32.2 | -1.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 29.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
...
| 지시 따르기 | 21.4 | -1.9 | 실측 | [[ifbench]] 17.0%×1.0 |
