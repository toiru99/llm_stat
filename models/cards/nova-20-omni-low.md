...
radar:
  ...
  agentic: { s: 37.4, z: 0.06, r: 51.0, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 45.1 | -0.33 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 51.0 | +0.06 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
