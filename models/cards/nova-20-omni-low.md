...
radar:
  ...
  agentic: { s: 37.4, z: 0.05, r: 50.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 45.8 | -0.28 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 70.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 50.8 | +0.05 | 실측 | [[tau2-bench]] 68.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
