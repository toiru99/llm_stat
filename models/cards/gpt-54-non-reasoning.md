...
radar:
  ...
  agentic: { s: 47.0, z: 0.37, r: 55.5, estimated: false }  # 에이전트
  trust: { s: 15.1, z: -0.58, r: 41.4, estimated: false }  # 신뢰성
  multimodal: { s: 80.0, z: 0.35, r: 55.3, estimated: false }  # 멀티모달
  long_context: { s: 65.1, z: 0.42, r: 56.3, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 101.0 t/s · TTFT 0.81s · 1M ctx` · 가성비 12.9
...
| 에이전트 | 55.5 | +0.37 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
| 신뢰성 | 41.4 | -0.58 | 실측 | [[aa-omniscience]] 15.0%×1.0 |
| 멀티모달 | 55.3 | +0.35 | 실측 | [[mmmu-pro]] 71.0%×1.0 |
| 긴문맥 | 56.3 | +0.42 | 실측 | [[aa-lcr]] 54.0%×1.0 |
