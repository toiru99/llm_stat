...
is_reasoning: false
radar:
  knowledge: { s: 54.3, z: 0.62, r: 59.2, estimated: false }  # 전문 지식
  ...
  long_context: { s: 65.1, z: 0.43, r: 56.4, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 102.0 t/s · TTFT 0.8s · 1M ctx` · 가성비 12.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.2 | +0.62 | 실측 | [[aa-omniscience]] 37.0%×1.0, [[gpqa-diamond]] 75.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 47.7 | -0.15 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 63.9 | +0.92 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 55.6 | +0.37 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
| 신뢰성 | 41.4 | -0.57 | 실측 | [[aa-omniscience]] 15.0%×1.0 |
| 멀티모달 | 55.3 | +0.36 | 실측 | [[mmmu-pro]] 71.0%×1.0 |
| 긴문맥 | 56.4 | +0.43 | 실측 | [[aa-lcr]] 54.0%×1.0 |
