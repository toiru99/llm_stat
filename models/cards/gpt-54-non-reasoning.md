...
radar:
  ...
  reasoning: { s: 32.7, z: -0.14, r: 47.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 91.0 t/s · TTFT 0.9s · 1M ctx` · 가성비 12.9
...
| 추론 | 47.8 | -0.14 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 64.0 | +0.93 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 55.7 | +0.38 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
