...
radar:
  ...
  reasoning: { s: 33.2, z: -0.06, r: 49.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 85.0 t/s · TTFT 0.8s · 1M ctx`
...
| 추론 | 49.1 | -0.06 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
