...
radar:
  ...
  agentic: { s: 47.0, z: 0.36, r: 55.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 92.0 t/s · TTFT 0.89s · 1M ctx` · 가성비 9.7
...
| 에이전트 | 55.4 | +0.36 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
