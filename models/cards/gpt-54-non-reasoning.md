...
radar:
  ...
  reasoning: { s: 32.7, z: -0.13, r: 48.1, estimated: false }  # 추론
  coding: { s: 71.4, z: 0.95, r: 64.3, estimated: false }  # 코딩
  agentic: { s: 47.0, z: 0.4, r: 56.1, estimated: false }  # 에이전트
  trust: { s: 15.1, z: -0.53, r: 42.1, estimated: false }  # 신뢰성
  multimodal: { s: 80.0, z: 0.37, r: 55.5, estimated: false }  # 멀티모달
  long_context: { s: 65.1, z: 0.45, r: 56.7, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.175/1M · 92.0 t/s · TTFT 0.89s · 1M ctx` · 가성비 12.9
...
| 추론 | 48.1 | -0.13 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 75.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 64.3 | +0.95 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 38.0%×0.5 |
| 에이전트 | 56.1 | +0.4 | 실측 | [[tau2-bench]] 36.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
| 신뢰성 | 42.1 | -0.53 | 실측 | [[aa-omniscience]] 15.0%×1.0 |
| 멀티모달 | 55.5 | +0.37 | 실측 | [[mmmu-pro]] 71.0%×1.0 |
| 긴문맥 | 56.7 | +0.45 | 실측 | [[aa-lcr]] 54.0%×1.0 |
