...
is_reasoning: false
radar:
  knowledge: { s: 13.9, z: -1.29, r: 30.7, estimated: false }  # 전문 지식
  reasoning: { s: 9.6, z: -1.25, r: 31.3, estimated: false }  # 추론
  coding: { s: 14.3, z: -1.37, r: 29.5, estimated: false }  # 코딩
  agentic: { s: 6.3, z: -1.17, r: 32.5, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 30.7 | -1.29 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 31.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 31.3 | -1.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 31.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 29.5 | -1.37 | 실측 | [[scicode]] 12.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 32.5 | -1.17 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 20.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
