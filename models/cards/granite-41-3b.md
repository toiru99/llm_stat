...
radar:
  ...
  coding: { s: 14.3, z: -1.37, r: 29.4, estimated: false }  # 코딩
  agentic: { s: 7.7, z: -1.12, r: 33.2, estimated: false }  # 에이전트
...
| 코딩 | 29.4 | -1.37 | 실측 | [[scicode]] 12.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 33.2 | -1.12 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 20.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
