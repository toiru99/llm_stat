...
is_reasoning: true
radar:
  knowledge: { s: 1.6, z: -1.86, r: 22.1, estimated: false }  # 전문 지식
  reasoning: { s: 1.9, z: -1.63, r: 25.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 22.1 | -1.86 | 실측 | [[gpqa-diamond]] 10.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 25.6 | -1.63 | 실측 | [[gpqa-diamond]] 10.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
