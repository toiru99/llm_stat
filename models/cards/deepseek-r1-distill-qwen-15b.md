...
is_reasoning: true
radar:
  knowledge: { s: 1.6, z: -1.87, r: 21.9, estimated: false }  # 전문 지식
  reasoning: { s: 1.9, z: -1.64, r: 25.5, estimated: false }  # 추론
  coding: { s: 11.7, z: -1.48, r: 27.8, estimated: false }  # 코딩
  agentic: { s: 5.3, z: -1.22, r: 31.7, estimated: true }  # 에이전트
  trust: { s: 29.4, z: 0.03, r: 50.5, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 21.9 | -1.87 | 실측 | [[gpqa-diamond]] 10.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 25.5 | -1.64 | 실측 | [[gpqa-diamond]] 10.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
