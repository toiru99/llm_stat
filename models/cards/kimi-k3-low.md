...
radar:
  ...
  agentic: { s: 77.9, z: 1.61, r: 74.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 36.0 t/s · TTFT 3.53s · 1M ctx` · 가성비 20.3
...
| 에이전트 | 74.2 | +1.61 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 34.0%×1.0 |
