...
radar:
  ...
  agentic: { s: 70.3, z: 1.27, r: 69.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 36.0 t/s · TTFT 4.92s · 1M ctx` · 가성비 20.8
...
| 에이전트 | 69.1 | +1.27 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
