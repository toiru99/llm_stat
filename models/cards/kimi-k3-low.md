...
radar:
  ...
  instruction: { s: 70.7, z: 0.75, r: 61.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 41.0 t/s · TTFT 3.73s · 1M ctx` · 가성비 16.9
...
| 에이전트 | 67.6 | +1.18 | 실측 | [[gdpval]] 35.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
