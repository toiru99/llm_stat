...
radar:
  ...
  agentic: { s: 69.5, z: 1.29, r: 69.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 38.0 t/s · TTFT 3.5s · 1M ctx` · 가성비 20.8
...
| 에이전트 | 69.4 | +1.29 | 실측 | [[gdpval]] 38.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
