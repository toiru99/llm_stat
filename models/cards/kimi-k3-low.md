...
is_reasoning: true
radar:
  knowledge: { s: 68.2, z: 1.39, r: 70.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 38.0 t/s · TTFT 2.91s · 1M ctx` · 가성비 20.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.39 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
| 추론 | 58.6 | +0.58 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 25.0%×1.0 |
| 코딩 | 72.6 | +1.51 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 69.1 | +1.28 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 42.0%×1.0 |
