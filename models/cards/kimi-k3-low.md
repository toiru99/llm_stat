...
radar:
  ...
  reasoning: { s: 47.2, z: 0.64, r: 59.7, estimated: false }  # 추론
  ...
  instruction: { s: 73.5, z: 0.84, r: 62.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 33.0 t/s · TTFT 4.71s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.8 | +1.39 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 24.0%×0.3 |
| 추론 | 59.7 | +0.64 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 73.7 | +1.58 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 74.7 | +1.65 | 실측 | [[gdpval]] 39.0%×1.0, [[tau3-banking]] 34.0%×1.0 |
