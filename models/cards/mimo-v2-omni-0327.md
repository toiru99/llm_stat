...
is_reasoning: true
radar:
  knowledge: { s: 44.2, z: 0.18, r: 52.6, estimated: false }  # 전문 지식
  reasoning: { s: 44.0, z: 0.48, r: 57.3, estimated: false }  # 추론
  coding: { s: 61.5, z: 0.58, r: 58.8, estimated: false }  # 코딩
  agentic: { s: 71.7, z: 1.37, r: 70.5, estimated: false }  # 에이전트
  trust: { s: 59.8, z: 1.69, r: 75.3, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 52.6 | +0.18 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.3 | +0.48 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
