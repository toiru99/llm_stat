...
is_reasoning: true
radar:
  knowledge: { s: 43.6, z: 0.1, r: 51.5, estimated: false }  # 전문 지식
  reasoning: { s: 44.0, z: 0.4, r: 56.0, estimated: false }  # 추론
...
| 추론 | 56.0 | +0.4 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 57.8 | +0.52 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 69.9 | +1.33 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
