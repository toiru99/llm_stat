...
is_reasoning: true
radar:
  knowledge: { s: 44.1, z: 0.17, r: 52.5, estimated: false }  # 전문 지식
  reasoning: { s: 43.0, z: 0.48, r: 57.2, estimated: false }  # 추론
  coding: { s: 61.5, z: 0.63, r: 59.5, estimated: false }  # 코딩
  agentic: { s: 71.7, z: 1.38, r: 70.6, estimated: false }  # 에이전트
  trust: { s: 67.8, z: 1.9, r: 78.5, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 52.5 | +0.17 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 57.2 | +0.48 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 59.5 | +0.63 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 70.6 | +1.38 | 실측 | [[tau2-bench]] 88.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
| 신뢰성 | 78.5 | +1.9 | 실측 | [[aa-omniscience]] 60.0%×1.0 |
