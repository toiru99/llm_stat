...
radar:
  ...
  instruction: { s: 72.7, z: 0.86, r: 62.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 58.0 t/s · TTFT 42.98s · 500k ctx` · 가성비 45.2
...
| 추론 | 82.3 | +2.15 | 실측 | [[critpt]] 17.0%×1.0, [[gpqa-diamond]] 95.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
