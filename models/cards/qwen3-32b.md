...
radar:
  ...
  coding: { s: 39.1, z: -0.32, r: 45.2, estimated: false }  # 코딩
  agentic: { s: 11.2, z: -1.01, r: 34.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.16 · 출력 $0.64 · 혼합 $0.208/1M · 105.0 t/s · TTFT 2.46s · 32k ctx` · 가성비 52.9
...
| 에이전트 | 34.8 | -1.01 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
