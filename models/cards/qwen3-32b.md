...
is_reasoning: false
radar:
  knowledge: { s: 32.6, z: -0.39, r: 44.1, estimated: false }  # 전문 지식
  reasoning: { s: 26.3, z: -0.43, r: 43.6, estimated: false }  # 추론
  coding: { s: 40.4, z: -0.29, r: 45.6, estimated: false }  # 코딩
  agentic: { s: 11.2, z: -0.99, r: 35.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $0.91/1M · 92.0 t/s · TTFT 2.45s · 32k ctx` · 가성비 12.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.1 | -0.39 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 43.6 | -0.43 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 67.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 45.6 | -0.29 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 3.0%×0.5 |
| 에이전트 | 35.2 | -0.99 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
