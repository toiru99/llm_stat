...
radar:
  ...
  agentic: { s: 11.7, z: -0.96, r: 35.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.7 · 출력 $8.4 · 혼합 $0.91/1M · 94.0 t/s · TTFT 2.45s · 32k ctx` · 가성비 13.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.8 | -0.35 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 67.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
...
| 에이전트 | 35.6 | -0.96 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 30.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 3.0%×1.0 |
