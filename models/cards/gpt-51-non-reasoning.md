...
is_reasoning: false
radar:
  knowledge: { s: 41.6, z: 0.07, r: 51.0, estimated: false }  # 전문 지식
  reasoning: { s: 23.5, z: -0.55, r: 41.7, estimated: false }  # 추론
  coding: { s: 50.3, z: 0.15, r: 52.3, estimated: false }  # 코딩
  agentic: { s: 40.7, z: 0.14, r: 52.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 94.0 t/s · TTFT 1.17s · 400k ctx` · 가성비 15.7
...
| 코딩 | 52.3 | +0.15 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 23.0%×0.5 |
| 에이전트 | 52.0 | +0.14 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 23.0%×1.0 |
