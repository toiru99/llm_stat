...
is_reasoning: false
radar:
  knowledge: { s: 41.6, z: 0.05, r: 50.7, estimated: false }  # 전문 지식
  reasoning: { s: 23.5, z: -0.56, r: 41.6, estimated: false }  # 추론
  coding: { s: 50.3, z: 0.14, r: 52.1, estimated: false }  # 코딩
  agentic: { s: 40.7, z: 0.12, r: 51.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 88.0 t/s · TTFT 1.17s · 400k ctx` · 가성비 15.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 50.7 | +0.05 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 51.9 | +0.12 | 실측 | [[tau2-bench]] 46.0%×1.0, [[terminal-bench]] 23.0%×1.0 |
