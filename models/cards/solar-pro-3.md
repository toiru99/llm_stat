...
is_reasoning: true
radar:
  knowledge: { s: 37.1, z: -0.16, r: 47.5, estimated: false }  # 전문 지식
  ...
  long_context: { s: 35.5, z: -0.38, r: 44.2, estimated: false }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 47.5 | -0.16 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 72.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
| 추론 | 47.5 | -0.17 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 72.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
...
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 44.2 | -0.38 | 실측 | [[aa-lcr]] 27.0%×1.0 |
