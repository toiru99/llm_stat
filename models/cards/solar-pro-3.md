...
radar:
  ...
  agentic: { s: 30.6, z: -0.22, r: 46.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 80.0 t/s · TTFT 2.46s · 128k ctx`
...
| 에이전트 | 46.6 | -0.22 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
