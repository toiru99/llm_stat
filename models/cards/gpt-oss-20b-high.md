...
radar:
  knowledge: { s: 34.2, z: -0.77, r: 38.5, estimated: false }  # 전문 지식
  reasoning: { s: 30.1, z: -0.68, r: 39.8, estimated: false }  # 추론
  coding: { s: 43.6, z: -0.68, r: 39.8, estimated: false }  # 코딩
  agentic: { s: 16.4, z: -1.41, r: 28.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.07/1M · 224.0 t/s · TTFT 0.91s · 131k ctx` · 가성비 214.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 38.5 | -0.77 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
...
| 에이전트 | 28.9 | -1.41 | 실측 | [[apex-agents]] 1.0%×1.0, [[gdpval]] 1.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
