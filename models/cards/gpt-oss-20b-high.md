...
radar:
  ...
  reasoning: { s: 30.4, z: -0.24, r: 46.3, estimated: false }  # 추론
  coding: { s: 43.3, z: -0.2, r: 47.0, estimated: false }  # 코딩
  agentic: { s: 19.1, z: -0.69, r: 39.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.19 · 혼합 $0.073/1M · 134.0 t/s · TTFT 0.99s · 131k ctx` · 가성비 205.5
...
| 추론 | 46.3 | -0.24 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 47.0 | -0.2 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 39.7 | -0.69 | 실측 | [[apex-agents]] 1.0%×1.0, [[gdpval]] 3.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
