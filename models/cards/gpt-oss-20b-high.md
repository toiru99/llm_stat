...
radar:
  ...
  reasoning: { s: 30.2, z: -0.18, r: 47.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $None/1M · 205.0 t/s · TTFT 0.79s · 131k ctx`
...
| 추론 | 47.2 | -0.18 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 10.0%×1.0 |
