...
radar:
  ...
  agentic: { s: 16.7, z: -1.36, r: 29.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.2 · 혼합 $0.07/1M · 228.0 t/s · TTFT 0.89s · 131k ctx` · 가성비 214.3
...
| 에이전트 | 29.5 | -1.36 | 실측 | [[apex-agents]] 1.0%×1.0, [[gdpval]] 1.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 7.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
