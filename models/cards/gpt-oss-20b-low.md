...
radar:
  ...
  reasoning: { s: 22.8, z: -0.59, r: 41.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.07 · 출력 $0.23 · 혼합 $0.0855/1M · 171.0 t/s · TTFT 0.94s · 131k ctx` · 가성비 163.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.8 | -0.61 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 41.1 | -0.59 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 61.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
