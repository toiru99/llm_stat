...
OpenAI · Open · Small(21B) · 컨텍스트 131k · 종합지능 **8.0**
...
## 실용 지표
`입력 $0.07 · 출력 $0.2 · 혼합 $0.083/1M · 209.0 t/s · TTFT 0.88s · 131k ctx` · 가성비 96.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.9 | -0.61 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
