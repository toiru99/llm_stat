...
radar:
  ...
  agentic: { s: 29.2, z: -0.85, r: 37.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.2 · 혼합 $0.07/1M · 243.0 t/s · TTFT 0.86s · 131k ctx` · 가성비 200.0
...
| 에이전트 | 37.2 | -0.85 | 실측 | [[tau2-bench]] 50.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
