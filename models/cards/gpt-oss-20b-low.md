...
radar:
  ...
  coding: { s: 40.3, z: -0.3, r: 45.4, estimated: false }  # 코딩
  agentic: { s: 29.0, z: -0.31, r: 45.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.2 · 혼합 $0.083/1M · 158.0 t/s · TTFT 1.17s · 131k ctx` · 가성비 168.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.3 | -0.58 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 40.9 | -0.61 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 61.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 45.4 | -0.3 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 45.4 | -0.31 | 실측 | [[tau2-bench]] 50.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
