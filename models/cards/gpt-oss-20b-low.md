...
is_reasoning: true
radar:
  knowledge: { s: 28.5, z: -0.59, r: 41.1, estimated: false }  # 전문 지식
  reasoning: { s: 22.7, z: -0.61, r: 40.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.07 · 출력 $0.2 · 혼합 $0.083/1M · 126.0 t/s · TTFT 1.05s · 131k ctx` · 가성비 168.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.1 | -0.59 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
