...
is_reasoning: true
radar:
  knowledge: { s: 40.4, z: -0.01, r: 49.8, estimated: false }  # 전문 지식
  reasoning: { s: 37.4, z: 0.15, r: 52.3, estimated: false }  # 추론
  coding: { s: 66.7, z: 0.8, r: 62.0, estimated: false }  # 코딩
  agentic: { s: 69.3, z: 1.27, r: 69.1, estimated: false }  # 에이전트
  ...
  instruction: { s: 76.6, z: 1.02, r: 65.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 56.0 t/s · TTFT 3.8s · 256k ctx` · 가성비 98.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.8 | -0.01 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 52.3 | +0.15 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 85.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 62.0 | +0.8 | 실측 | [[scicode]] 40.0%×1.0 |
| 에이전트 | 69.1 | +1.27 | 실측 | [[gdpval]] 50.0%×1.0, [[tau3-banking]] 32.0%×1.0 |
