...
radar:
  ...
  agentic: { s: 68.5, z: 1.24, r: 68.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 56.0 t/s · TTFT 3.82s · 256k ctx` · 가성비 98.9
...
| 에이전트 | 68.6 | +1.24 | 실측 | [[gdpval]] 49.0%×1.0, [[tau3-banking]] 32.0%×1.0 |
