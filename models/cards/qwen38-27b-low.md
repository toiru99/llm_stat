...
radar:
  ...
  coding: { s: 53.1, z: 0.74, r: 61.1, estimated: false }  # 코딩
  ...
  instruction: { s: 68.7, z: 0.68, r: 60.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.5 · 출력 $3.0 · 혼합 $0.435/1M · 51.0 t/s · TTFT 3.92s · 256k ctx` · 가성비 78.2
...
| 에이전트 | 66.6 | +1.11 | 실측 | [[gdpval]] 45.0%×1.0, [[tau3-banking]] 32.0%×1.0 |
