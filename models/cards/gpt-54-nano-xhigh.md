...
is_reasoning: true
radar:
  knowledge: { s: 52.2, z: 0.58, r: 58.7, estimated: false }  # 전문 지식
  reasoning: { s: 54.0, z: 1.09, r: 66.4, estimated: false }  # 추론
  coding: { s: 73.4, z: 1.17, r: 67.6, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 58.7 | +0.58 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 66.4 | +1.09 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 67.6 | +1.17 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
