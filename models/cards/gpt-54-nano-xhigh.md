...
radar:
  ...
  reasoning: { s: 54.3, z: 0.91, r: 63.6, estimated: false }  # 추론
  coding: { s: 73.4, z: 1.01, r: 65.2, estimated: false }  # 코딩
  agentic: { s: 55.4, z: 0.7, r: 60.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 184.0 t/s · TTFT 3.9s · 400k ctx` · 가성비 223.5
...
| 코딩 | 65.2 | +1.01 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 60.5 | +0.7 | 실측 | [[apex-agents]] 25.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 27.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
