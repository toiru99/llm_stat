...
radar:
  ...
  reasoning: { s: 54.3, z: 0.92, r: 63.8, estimated: false }  # 추론
  coding: { s: 73.4, z: 1.03, r: 65.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 185.0 t/s · TTFT 3.75s · 400k ctx` · 가성비 223.5
...
| 추론 | 63.8 | +0.92 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 65.4 | +1.03 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
