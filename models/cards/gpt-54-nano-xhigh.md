...
is_reasoning: true
radar:
  knowledge: { s: 52.3, z: 0.58, r: 58.6, estimated: false }  # 전문 지식
  reasoning: { s: 54.3, z: 1.0, r: 65.0, estimated: false }  # 추론
  coding: { s: 73.4, z: 1.08, r: 66.2, estimated: false }  # 코딩
  agentic: { s: 55.5, z: 0.73, r: 60.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 168.0 t/s · TTFT 6.33s · 400k ctx` · 가성비 223.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 58.6 | +0.58 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 65.0 | +1.0 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 66.2 | +1.08 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 60.9 | +0.73 | 실측 | [[apex-agents]] 25.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 27.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
