...
is_reasoning: true
radar:
  knowledge: { s: 52.2, z: 0.51, r: 57.6, estimated: false }  # 전문 지식
  reasoning: { s: 54.0, z: 0.96, r: 64.4, estimated: false }  # 추론
  coding: { s: 73.4, z: 1.08, r: 66.2, estimated: false }  # 코딩
  agentic: { s: 54.8, z: 0.76, r: 61.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 161.0 t/s · TTFT 4.84s · 400k ctx` · 가성비 212.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.6 | +0.51 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 26.0%×0.3 |
| 추론 | 64.4 | +0.96 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 26.0%×1.0 |
| 코딩 | 66.2 | +1.08 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.4 | +0.76 | 실측 | [[apex-agents]] 25.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
