...
radar:
  ...
  coding: { s: 73.4, z: 1.08, r: 66.3, estimated: false }  # 코딩
  agentic: { s: 55.4, z: 0.78, r: 61.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 154.0 t/s · TTFT 4.86s · 400k ctx` · 가성비 223.5
...
| 코딩 | 66.3 | +1.08 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 61.7 | +0.78 | 실측 | [[apex-agents]] 25.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 27.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
