...
radar:
  ...
  agentic: { s: 58.9, z: 0.27, r: 54.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.18/1M · 160.0 t/s · TTFT 3.67s · 400k ctx` · 가성비 211.1
...
| 에이전트 | 54.1 | +0.27 | 실측 | [[apex-agents]] 25.0%×1.0, [[gdpval]] 30.0%×1.0, [[itbench]] 24.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 21.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
