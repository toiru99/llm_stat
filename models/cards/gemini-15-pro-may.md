...
is_reasoning: false
radar:
  knowledge: { s: 19.6, z: -1.03, r: 34.5, estimated: false }  # 전문 지식
  reasoning: { s: 17.6, z: -0.85, r: 37.3, estimated: false }  # 추론
  coding: { s: 43.5, z: -0.15, r: 47.8, estimated: false }  # 코딩
  agentic: { s: 19.0, z: -0.72, r: 39.3, estimated: true }  # 에이전트
  trust: { s: 19.4, z: -0.25, r: 46.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 21.8, z: -0.86, r: 37.0, estimated: true }  # 긴문맥
  instruction: { s: 28.8, z: -1.01, r: 34.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
