...
radar:
  ...
  coding: { s: 43.3, z: -0.22, r: 46.6, estimated: false }  # 코딩
  agentic: { s: 20.3, z: -0.65, r: 40.2, estimated: false }  # 에이전트
  trust: { s: 15.1, z: -0.58, r: 41.4, estimated: false }  # 신뢰성
  multimodal: { s: 55.7, z: -0.83, r: 37.6, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 113.0 t/s · TTFT 1.45s · 128k ctx` · 가성비 26.8
...
| 코딩 | 46.6 | -0.22 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
...
| 멀티모달 | 37.6 | -0.83 | 실측 | [[mmmu-pro]] 54.0%×1.0 |
