...
radar:
  ...
  multimodal: { s: 55.7, z: -0.8, r: 38.0, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 107.0 t/s · TTFT 1.47s · 128k ctx` · 가성비 26.8
...
| 추론 | 39.9 | -0.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 46.9 | -0.21 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 40.5 | -0.63 | 실측 | [[gdpval]] 6.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
| 신뢰성 | 42.0 | -0.53 | 실측 | [[aa-omniscience]] 15.0%×1.0 |
| 멀티모달 | 38.0 | -0.8 | 실측 | [[mmmu-pro]] 54.0%×1.0 |
