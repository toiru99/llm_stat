...
radar:
  ...
  multimodal: { s: 55.7, z: -0.81, r: 37.9, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 108.0 t/s · TTFT 1.43s · 128k ctx` · 가성비 26.8
...
| 추론 | 39.8 | -0.68 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 46.8 | -0.21 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 40.4 | -0.64 | 실측 | [[gdpval]] 6.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 8.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
| 신뢰성 | 41.7 | -0.56 | 실측 | [[aa-omniscience]] 15.0%×1.0 |
| 멀티모달 | 37.9 | -0.81 | 실측 | [[mmmu-pro]] 54.0%×1.0 |
