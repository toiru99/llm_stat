...
is_reasoning: false
radar:
  knowledge: { s: 15.8, z: -1.22, r: 31.6, estimated: false }  # 전문 지식
  reasoning: { s: 11.7, z: -1.14, r: 32.9, estimated: false }  # 추론
  coding: { s: 13.9, z: -1.39, r: 29.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 31.6 | -1.22 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 34.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 32.9 | -1.14 | 실측 | [[tau2-bench]] 13.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
