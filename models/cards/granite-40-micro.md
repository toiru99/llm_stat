...
is_reasoning: false
radar:
  knowledge: { s: 14.5, z: -1.26, r: 31.1, estimated: false }  # 전문 지식
  reasoning: { s: 10.1, z: -1.24, r: 31.4, estimated: false }  # 추론
  coding: { s: 14.3, z: -1.35, r: 29.7, estimated: false }  # 코딩
  ...
  instruction: { s: 15.5, z: -1.54, r: 26.8, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 31.1 | -1.26 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 31.4 | -1.24 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 29.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 29.7 | -1.35 | 실측 | [[scicode]] 12.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
...
| 지시 따르기 | 26.8 | -1.54 | 실측 | [[ifbench]] 23.0%×1.0 |
