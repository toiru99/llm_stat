...
radar:
  ...
  long_context: { s: 2.7, z: -1.39, r: 29.1, estimated: true }  # 긴문맥
  instruction: { s: 26.4, z: -1.11, r: 33.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 30.0 | -1.34 | 실측 | [[gpqa-diamond]] 23.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
