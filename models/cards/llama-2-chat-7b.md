...
radar:
  ...
  agentic: { s: 9.0, z: -1.07, r: 33.9, estimated: true }  # 에이전트
  trust: { s: 16.8, z: -0.55, r: 41.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 2.2, z: -1.41, r: 28.8, estimated: true }  # 긴문맥
  instruction: { s: 25.0, z: -1.17, r: 32.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 29.9 | -1.34 | 실측 | [[gpqa-diamond]] 23.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 33.4 | -1.11 | 실측 | [[gpqa-diamond]] 23.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
