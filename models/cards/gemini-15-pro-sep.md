...
radar:
  ...
  coding: { s: 22.0, z: -0.36, r: 44.6, estimated: true }  # 코딩
  ...
  instruction: { s: 50.7, z: -0.08, r: 48.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 47.8 | -0.15 | 실측 | [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 44.6 | -0.36 | 추정 | (추정) |
