...
radar:
  ...
  trust: { s: 13.6, z: -0.51, r: 42.3, estimated: true }  # 신뢰성
  multimodal: { s: 57.1, z: -0.68, r: 39.8, estimated: false }  # 멀티모달
  long_context: { s: 50.1, z: 0.01, r: 50.1, estimated: true }  # 긴문맥
  instruction: { s: 66.5, z: 0.58, r: 58.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 48.4 | -0.11 | 실측 | [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
