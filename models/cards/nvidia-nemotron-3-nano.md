...
radar:
  ...
  agentic: { s: 21.2, z: -1.21, r: 31.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.22 · 혼합 $0.07/1M · 78.0 t/s · TTFT 2.89s · 1M ctx` · 가성비 257.1
...
| 에이전트 | 31.9 | -1.21 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
