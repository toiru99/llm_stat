...
radar:
  ...
  coding: { s: 40.7, z: -0.88, r: 36.8, estimated: false }  # 코딩
  agentic: { s: 15.9, z: -1.38, r: 29.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.06 · 출력 $0.22 · 혼합 $0.07/1M · 100.0 t/s · TTFT 3.08s · 1M ctx` · 가성비 200.0
...
| 코딩 | 36.8 | -0.88 | 실측 | [[scicode]] 30.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 29.4 | -1.38 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 41.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
