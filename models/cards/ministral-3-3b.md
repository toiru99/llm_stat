...
is_reasoning: false
radar:
  knowledge: { s: 15.9, z: -1.22, r: 31.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 189.0 t/s · TTFT 0.62s · 256k ctx` · 가성비 70.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 31.7 | -1.22 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 36.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
