...
radar:
  ...
  coding: { s: 15.6, z: -1.31, r: 30.3, estimated: false }  # 코딩
  agentic: { s: 10.0, z: -1.03, r: 34.6, estimated: false }  # 에이전트
  ...
  instruction: { s: 21.1, z: -1.32, r: 30.1, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 203.0 t/s · TTFT 0.66s · 256k ctx` · 가성비 70.0
...
| 코딩 | 30.3 | -1.31 | 실측 | [[scicode]] 14.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
| 에이전트 | 34.6 | -1.03 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
| 신뢰성 | 47.0 | -0.2 | 실측 | [[aa-omniscience]] 22.0%×1.0 |
| 멀티모달 | 21.9 | -1.87 | 실측 | [[mmmu-pro]] 38.0%×1.0 |
| 긴문맥 | 35.0 | -1.0 | 실측 | [[aa-lcr]] 12.0%×1.0 |
| 지시 따르기 | 30.1 | -1.32 | 실측 | [[ifbench]] 27.0%×1.0 |
