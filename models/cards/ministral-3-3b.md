...
radar:
  ...
  coding: { s: 15.6, z: -1.3, r: 30.6, estimated: false }  # 코딩
  ...
  instruction: { s: 21.1, z: -1.3, r: 30.5, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 167.0 t/s · TTFT 0.6s · 256k ctx` · 가성비 70.0
...
| 코딩 | 30.6 | -1.3 | 실측 | [[scicode]] 14.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
...
| 지시 따르기 | 30.5 | -1.3 | 실측 | [[ifbench]] 27.0%×1.0 |
