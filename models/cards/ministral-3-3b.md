...
radar:
  ...
  coding: { s: 15.6, z: -1.35, r: 29.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 204.0 t/s · TTFT 0.6s · 256k ctx` · 가성비 70.0
...
| 코딩 | 29.8 | -1.35 | 실측 | [[scicode]] 14.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
