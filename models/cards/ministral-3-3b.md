...
is_reasoning: false
radar:
  knowledge: { s: 16.3, z: -1.19, r: 32.1, estimated: false }  # 전문 지식
  reasoning: { s: 12.5, z: -1.1, r: 33.5, estimated: false }  # 추론
  coding: { s: 15.1, z: -1.34, r: 29.9, estimated: false }  # 코딩
  agentic: { s: 8.8, z: -1.11, r: 33.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 183.0 t/s · TTFT 0.61s · 256k ctx` · 가성비 70.0
...
| 에이전트 | 33.4 | -1.11 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 25.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 0.0%×1.0 |
