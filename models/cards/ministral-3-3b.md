...
radar:
  ...
  coding: { s: 15.6, z: -1.29, r: 30.6, estimated: false }  # 코딩
  ...
  instruction: { s: 21.1, z: -1.28, r: 30.9, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.1 · 출력 $0.1 · 혼합 $0.1/1M · 171.0 t/s · TTFT 0.64s · 256k ctx` · 가성비 70.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 31.9 | -1.21 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 36.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 33.7 | -1.09 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 36.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 30.6 | -1.29 | 실측 | [[scicode]] 14.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
...
| 지시 따르기 | 30.9 | -1.28 | 실측 | [[ifbench]] 27.0%×1.0 |
