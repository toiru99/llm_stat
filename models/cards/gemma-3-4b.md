...
radar:
  ...
  coding: { s: 8.3, z: -1.64, r: 25.5, estimated: false }  # 코딩
  agentic: { s: 2.2, z: -1.35, r: 29.7, estimated: false }  # 에이전트
  trust: { s: 0.0, z: -1.2, r: 32.0, estimated: false }  # 신뢰성
  multimodal: { s: 21.4, z: -2.44, r: 13.4, estimated: false }  # 멀티모달
