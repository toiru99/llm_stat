...
is_reasoning: false
radar:
  knowledge: { s: 13.4, z: -1.32, r: 30.1, estimated: false }  # 전문 지식
  ...
  multimodal: { s: 20.8, z: -2.44, r: 13.4, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 30.1 | -1.32 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
