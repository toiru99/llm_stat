...
radar:
  ...
  trust: { s: 0.0, z: -1.32, r: 30.1, estimated: false }  # 신뢰성
  multimodal: { s: 21.4, z: -2.41, r: 13.8, estimated: false }  # 멀티모달
...
| 신뢰성 | 30.1 | -1.32 | 실측 | [[aa-omniscience]] 1.0%×1.0 |
| 멀티모달 | 13.8 | -2.41 | 실측 | [[mmmu-pro]] 30.0%×1.0 |
