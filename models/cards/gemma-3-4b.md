...
is_reasoning: false
radar:
  knowledge: { s: 13.1, z: -1.33, r: 30.0, estimated: false }  # 전문 지식
  reasoning: { s: 10.0, z: -1.24, r: 31.5, estimated: false }  # 추론
  coding: { s: 8.3, z: -1.62, r: 25.6, estimated: false }  # 코딩
  agentic: { s: 2.2, z: -1.34, r: 29.8, estimated: false }  # 에이전트
  trust: { s: 0.0, z: -1.2, r: 32.0, estimated: false }  # 신뢰성
  multimodal: { s: 21.4, z: -2.44, r: 13.5, estimated: false }  # 멀티모달
...
| 코딩 | 25.6 | -1.62 | 실측 | [[scicode]] 7.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
| 에이전트 | 29.8 | -1.34 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
