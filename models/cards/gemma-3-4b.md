...
radar:
  ...
  agentic: { s: 2.2, z: -1.36, r: 29.5, estimated: false }  # 에이전트
  trust: { s: 0.0, z: -1.16, r: 32.6, estimated: false }  # 신뢰성
  multimodal: { s: 21.4, z: -2.43, r: 13.5, estimated: false }  # 멀티모달
...
|---|---|---|---|---|
| 전문 지식 | 30.0 | -1.33 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 29.5 | -1.36 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
| 신뢰성 | 32.6 | -1.16 | 실측 | [[aa-omniscience]] 2.0%×1.0 |
| 멀티모달 | 13.5 | -2.43 | 실측 | [[mmmu-pro]] 30.0%×1.0 |
