...
is_reasoning: false
radar:
  knowledge: { s: 13.8, z: -1.34, r: 30.0, estimated: false }  # 전문 지식
  reasoning: { s: 9.9, z: -1.24, r: 31.4, estimated: false }  # 추론
  coding: { s: 8.3, z: -1.64, r: 25.3, estimated: false }  # 코딩
  agentic: { s: 2.2, z: -1.36, r: 29.6, estimated: false }  # 에이전트
...
| 에이전트 | 29.6 | -1.36 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
