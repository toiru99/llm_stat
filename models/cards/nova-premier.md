...
is_reasoning: false
radar:
  knowledge: { s: 32.4, z: -0.43, r: 43.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $12.5 · 혼합 $2.1875/1M · 31.0 t/s · TTFT 2.81s · 1M ctx` · 가성비 5.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.5 | -0.43 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
