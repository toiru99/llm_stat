...
is_reasoning: false
radar:
  knowledge: { s: 32.4, z: -0.41, r: 43.9, estimated: false }  # 전문 지식
  ...
  trust: { s: 26.8, z: 0.1, r: 51.5, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 43.9 | -0.41 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 57.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 신뢰성 | 51.5 | +0.1 | 실측 | [[aa-omniscience]] 28.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
