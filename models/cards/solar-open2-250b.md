...
radar:
  ...
  reasoning: { s: 53.3, z: 0.96, r: 64.3, estimated: false }  # 추론
  ...
  instruction: { s: 89.4, z: 1.56, r: 73.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 64.3 | +0.96 | 실측 | [[critpt]] 6.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
