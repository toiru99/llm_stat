...
radar:
  ...
  coding: { s: 49.3, z: 0.1, r: 51.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $None/1M · 108.0 t/s · TTFT 0.9s · 1M ctx`
...
| 코딩 | 51.4 | +0.1 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
