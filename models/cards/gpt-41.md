...
radar:
  ...
  coding: { s: 49.3, z: 0.15, r: 52.2, estimated: false }  # 코딩
  agentic: { s: 34.3, z: -0.06, r: 49.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $1.55/1M · 104.0 t/s · TTFT 1.03s · 1M ctx` · 가성비 12.3
...
| 코딩 | 52.2 | +0.15 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 49.0 | -0.06 | 실측 | [[tau2-bench]] 47.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
