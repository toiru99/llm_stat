...
radar:
  ...
  coding: { s: 49.3, z: 0.14, r: 52.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $1.55/1M · 101.0 t/s · TTFT 0.97s · 1M ctx` · 가성비 12.3
...
| 코딩 | 52.1 | +0.14 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
