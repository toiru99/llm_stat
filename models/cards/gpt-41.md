...
radar:
  ...
  agentic: { s: 34.3, z: -0.06, r: 49.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $1.55/1M · 109.0 t/s · TTFT 1.05s · 1M ctx` · 가성비 12.3
...
| 에이전트 | 49.1 | -0.06 | 실측 | [[tau2-bench]] 47.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
