...
radar:
  ...
  coding: { s: 49.3, z: 0.13, r: 52.0, estimated: false }  # 코딩
  agentic: { s: 34.3, z: -0.07, r: 48.9, estimated: false }  # 에이전트
  trust: { s: 22.4, z: -0.26, r: 46.1, estimated: false }  # 신뢰성
  multimodal: { s: 66.7, z: -0.23, r: 46.5, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $1.55/1M · 100.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 12.3
...
| 코딩 | 52.0 | +0.13 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 14.0%×0.5 |
| 에이전트 | 48.9 | -0.07 | 실측 | [[tau2-bench]] 47.0%×1.0, [[terminal-bench]] 14.0%×1.0 |
| 신뢰성 | 46.1 | -0.26 | 실측 | [[aa-omniscience]] 20.0%×1.0 |
| 멀티모달 | 46.5 | -0.23 | 실측 | [[mmmu-pro]] 61.0%×1.0 |
