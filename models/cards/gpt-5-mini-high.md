...
radar:
  ...
  reasoning: { s: 41.0, z: 0.28, r: 54.1, estimated: false }  # 추론
  coding: { s: 60.0, z: 0.48, r: 57.2, estimated: false }  # 코딩
  agentic: { s: 45.2, z: 0.34, r: 55.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 96.0 t/s · TTFT 84.01s · 400k ctx` · 가성비 97.2
...
| 추론 | 54.1 | +0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 57.2 | +0.48 | 실측 | [[scicode]] 39.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 55.1 | +0.34 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 68.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
