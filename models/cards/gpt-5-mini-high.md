...
radar:
  ...
  agentic: { s: 45.2, z: 0.34, r: 55.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $2.0 · 혼합 $0.2675/1M · 95.0 t/s · TTFT 95.25s · 400k ctx` · 가성비 97.2
...
| 에이전트 | 55.0 | +0.34 | 실측 | [[gdpval]] 22.0%×1.0, [[tau2-bench]] 68.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
