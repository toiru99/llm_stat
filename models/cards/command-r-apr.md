...
radar:
  ...
  agentic: { s: 11.5, z: -0.95, r: 35.7, estimated: true }  # 에이전트
  trust: { s: 26.4, z: -0.06, r: 49.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 10.6, z: -1.11, r: 33.3, estimated: true }  # 긴문맥
  instruction: { s: 26.0, z: -1.08, r: 33.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
