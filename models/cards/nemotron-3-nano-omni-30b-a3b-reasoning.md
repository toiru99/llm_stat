...
radar:
  ...
  coding: { s: 35.2, z: -0.48, r: 42.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $None/1M · 313.0 t/s · TTFT 0.99s · 256k ctx`
...
| 코딩 | 42.9 | -0.48 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
