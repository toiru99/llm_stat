...
radar:
  ...
  coding: { s: 35.2, z: -0.47, r: 42.9, estimated: false }  # 코딩
  agentic: { s: 28.8, z: -0.29, r: 45.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $None/1M · 323.0 t/s · TTFT 0.98s · 256k ctx`
...
| 코딩 | 42.9 | -0.47 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 45.6 | -0.29 | 실측 | [[tau2-bench]] 45.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
