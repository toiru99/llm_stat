...
radar:
  ...
  agentic: { s: 29.1, z: -0.86, r: 37.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $0.1/1M · 290.0 t/s · TTFT 1.02s · 256k ctx` · 가성비 150.0
...
| 에이전트 | 37.1 | -0.86 | 실측 | [[tau2-bench]] 45.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
