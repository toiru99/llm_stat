...
radar:
  ...
  reasoning: { s: 17.2, z: -0.86, r: 37.2, estimated: false }  # 추론
  coding: { s: 35.2, z: -0.46, r: 43.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $0.1/1M · 305.0 t/s · TTFT 0.98s · 256k ctx` · 가성비 150.0
...
| 추론 | 37.2 | -0.86 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 47.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 43.1 | -0.46 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
