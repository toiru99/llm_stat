...
is_reasoning: true
radar:
  knowledge: { s: 25.4, z: -0.72, r: 39.1, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.07 · 출력 $0.3 · 혼합 $0.1/1M · 316.0 t/s · TTFT 1.0s · 256k ctx` · 가성비 150.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.1 | -0.72 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
