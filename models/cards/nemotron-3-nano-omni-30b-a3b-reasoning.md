...
radar:
  knowledge: { s: 25.3, z: -1.17, r: 32.4, estimated: false }  # 전문 지식
  reasoning: { s: 17.0, z: -1.29, r: 30.6, estimated: false }  # 추론
  coding: { s: 35.3, z: -1.04, r: 34.4, estimated: false }  # 코딩
  agentic: { s: 29.1, z: -0.88, r: 36.7, estimated: false }  # 에이전트
  trust: { s: 16.2, z: -0.62, r: 40.8, estimated: false }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 32.4 | -1.17 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 47.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 36.7 | -0.88 | 실측 | [[tau2-bench]] 45.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
| 신뢰성 | 40.8 | -0.62 | 실측 | [[aa-omniscience]] 17.0%×1.0 |
