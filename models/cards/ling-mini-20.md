...
is_reasoning: false
radar:
  knowledge: { s: 21.4, z: -0.95, r: 35.8, estimated: false }  # 전문 지식
  reasoning: { s: 20.5, z: -0.74, r: 38.9, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 35.8 | -0.95 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 56.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
