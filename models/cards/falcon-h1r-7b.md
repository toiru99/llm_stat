...
is_reasoning: true
radar:
  knowledge: { s: 31.8, z: -0.42, r: 43.8, estimated: false }  # 전문 지식
  reasoning: { s: 28.6, z: -0.26, r: 46.2, estimated: false }  # 추론
  coding: { s: 28.8, z: -0.73, r: 39.0, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 43.8 | -0.42 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 46.2 | -0.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 39.0 | -0.73 | 실측 | [[scicode]] 25.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
