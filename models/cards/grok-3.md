...
radar:
  ...
  agentic: { s: 33.1, z: -0.16, r: 47.5, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 51.1 | +0.08 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 47.5 | -0.16 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
