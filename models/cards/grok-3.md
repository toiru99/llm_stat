...
is_reasoning: false
radar:
  knowledge: { s: 43.6, z: 0.14, r: 52.1, estimated: false }  # 전문 지식
  reasoning: { s: 25.0, z: -0.48, r: 42.8, estimated: false }  # 추론
  coding: { s: 46.7, z: -0.04, r: 49.4, estimated: false }  # 코딩
  agentic: { s: 33.1, z: -0.15, r: 47.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 52.1 | +0.14 | 실측 | [[aa-omniscience]] 29.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.8 | -0.48 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 69.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 49.4 | -0.04 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 47.8 | -0.15 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
