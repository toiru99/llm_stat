...
radar:
  ...
  reasoning: { s: 74.9, z: 1.92, r: 78.7, estimated: false }  # 추론
  coding: { s: 85.7, z: 1.88, r: 78.3, estimated: false }  # 코딩
  agentic: { s: 87.5, z: 1.92, r: 78.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 63.0 t/s · TTFT 39.09s · 500k ctx` · 가성비 35.6
...
| 추론 | 78.7 | +1.92 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 78.3 | +1.88 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 78.7 | +1.92 | 실측 | [[gdpval]] 57.0%×1.0, [[tau3-banking]] 44.0%×1.0 |
