...
is_reasoning: true
radar:
  knowledge: { s: 74.3, z: 1.57, r: 73.5, estimated: false }  # 전문 지식
  reasoning: { s: 77.0, z: 2.0, r: 80.0, estimated: false }  # 추론
  coding: { s: 91.7, z: 1.75, r: 76.3, estimated: false }  # 코딩
  agentic: { s: 89.4, z: 2.01, r: 80.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $6.0 · 혼합 $1.35/1M · 58.0 t/s · TTFT 34.53s · 500k ctx` · 가성비 43.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.5 | +1.57 | 실측 | [[aa-omniscience]] 42.0%×1.0, [[gpqa-diamond]] 94.0%×0.4, [[humanitys-last-exam]] 42.0%×0.3 |
| 추론 | 80.0 | +2.0 | 실측 | [[critpt]] 18.0%×1.0, [[gpqa-diamond]] 94.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 76.3 | +1.75 | 실측 | [[scicode]] 55.0%×1.0 |
| 에이전트 | 80.1 | +2.01 | 실측 | [[gdpval]] 62.0%×1.0, [[tau3-banking]] 44.0%×1.0 |
