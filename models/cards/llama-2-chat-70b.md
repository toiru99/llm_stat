...
radar:
  ...
  coding: { s: 22.3, z: -1.04, r: 34.5, estimated: true }  # 코딩
  agentic: { s: 12.8, z: -0.92, r: 36.2, estimated: true }  # 에이전트
  trust: { s: 20.4, z: -0.38, r: 44.3, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 20.8, z: -0.86, r: 37.1, estimated: true }  # 긴문맥
  instruction: { s: 40.0, z: -0.55, r: 41.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
