...
radar:
  ...
  coding: { s: 22.3, z: -1.02, r: 34.7, estimated: true }  # 코딩
  agentic: { s: 13.5, z: -0.88, r: 36.8, estimated: true }  # 에이전트
  trust: { s: 19.1, z: -0.4, r: 44.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.5, z: -0.97, r: 35.5, estimated: true }  # 긴문맥
  instruction: { s: 39.6, z: -0.55, r: 41.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
