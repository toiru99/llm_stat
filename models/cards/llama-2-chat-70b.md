...
radar:
  ...
  reasoning: { s: 17.2, z: -0.9, r: 36.5, estimated: false }  # 추론
  coding: { s: 21.0, z: -1.14, r: 33.0, estimated: true }  # 코딩
  agentic: { s: 14.0, z: -0.9, r: 36.6, estimated: true }  # 에이전트
  trust: { s: 21.6, z: -0.3, r: 45.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 16.4, z: -1.03, r: 34.5, estimated: true }  # 긴문맥
  instruction: { s: 29.0, z: -1.03, r: 34.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
