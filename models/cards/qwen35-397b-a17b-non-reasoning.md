...
radar:
  ...
  coding: { s: 63.7, z: 0.68, r: 60.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $3.6 · 혼합 $0.9/1M · 89.0 t/s · TTFT 2.24s · 262k ctx` · 가성비 36.7
...
| 추론 | 56.2 | +0.41 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 60.2 | +0.68 | 실측 | [[scicode]] 41.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
