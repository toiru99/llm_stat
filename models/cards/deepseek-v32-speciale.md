...
radar:
  ...
  reasoning: { s: 53.2, z: 0.87, r: 63.1, estimated: false }  # 추론
...
DeepSeek · Open · Large(685B) · 컨텍스트 128k · 종합지능 **16.0** · ⚠️ past(구세대)
...
|---|---|---|---|---|
| 전문 지식 | 65.9 | +1.06 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
| 추론 | 63.1 | +0.87 | 실측 | [[critpt]] 7.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 29.0%×1.0 |
| 코딩 | 61.1 | +0.74 | 실측 | [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 43.7 | -0.42 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
