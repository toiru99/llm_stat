...
radar:
  ...
  coding: { s: 66.6, z: 0.87, r: 63.0, estimated: false }  # 코딩
  agentic: { s: 26.5, z: -0.37, r: 44.4, estimated: false }  # 에이전트
...
| 코딩 | 63.0 | +0.87 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 35.0%×0.5 |
| 에이전트 | 44.4 | -0.37 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 35.0%×1.0 |
