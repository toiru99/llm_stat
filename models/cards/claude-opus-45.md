...
radar:
  ...
  agentic: { s: 80.6, z: 1.72, r: 75.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 47.0 t/s · TTFT 9.84s · 200k ctx` · 가성비 10.9
...
| 에이전트 | 75.9 | +1.72 | 실측 | [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
