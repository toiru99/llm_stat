...
radar:
  ...
  coding: { s: 79.3, z: 1.27, r: 69.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 49.0 t/s · TTFT 10.77s · 200k ctx` · 가성비 10.9
...
| 코딩 | 69.1 | +1.27 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
