...
is_reasoning: false
radar:
  knowledge: { s: 73.3, z: 1.56, r: 73.5, estimated: false }  # 전문 지식
  reasoning: { s: 53.7, z: 0.93, r: 64.0, estimated: false }  # 추론
  coding: { s: 79.3, z: 1.32, r: 69.9, estimated: false }  # 코딩
  agentic: { s: 80.6, z: 1.78, r: 76.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 48.0 t/s · TTFT 11.18s · 200k ctx` · 가성비 10.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.5 | +1.56 | 실측 | [[aa-omniscience]] 47.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 30.0%×0.3 |
...
| 에이전트 | 76.6 | +1.78 | 실측 | [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 47.0%×1.0 |
