...
radar:
  ...
  coding: { s: 79.3, z: 1.35, r: 70.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 47.0 t/s · TTFT 12.16s · 200k ctx`
...
| 코딩 | 70.2 | +1.35 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
