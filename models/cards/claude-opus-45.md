...
is_reasoning: false
radar:
  knowledge: { s: 74.8, z: 1.68, r: 75.2, estimated: false }  # 전문 지식
  reasoning: { s: 53.1, z: 1.05, r: 65.7, estimated: false }  # 추론
  coding: { s: 79.3, z: 1.42, r: 71.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 47.0 t/s · TTFT 15.3s · 200k ctx` · 가성비 10.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 75.2 | +1.68 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 65.7 | +1.05 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 71.3 | +1.42 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
