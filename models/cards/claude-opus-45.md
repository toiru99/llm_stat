...
is_reasoning: false
radar:
  knowledge: { s: 74.8, z: 1.59, r: 73.8, estimated: false }  # 전문 지식
  reasoning: { s: 53.1, z: 0.94, r: 64.1, estimated: false }  # 추론
  coding: { s: 79.3, z: 1.35, r: 70.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 47.0 t/s · TTFT 12.84s · 200k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 73.8 | +1.59 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 64.1 | +0.94 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 70.3 | +1.35 | 실측 | [[scicode]] 50.0%×1.0, [[terminal-bench]] 47.0%×0.5 |
