...
radar:
  ...
  agentic: { s: 19.3, z: -0.68, r: 39.7, estimated: true }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $2.1/1M · 135.0 t/s · TTFT 2.26s · 32k ctx` · 가성비 1.4
...
| 추론 | 36.8 | -0.88 | 실측 | [[gpqa-diamond]] 35.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
