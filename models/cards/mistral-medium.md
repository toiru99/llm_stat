...
radar:
  ...
  trust: { s: 30.7, z: 0.3, r: 54.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 4.3, z: -1.38, r: 29.3, estimated: true }  # 긴문맥
  instruction: { s: 31.5, z: -0.88, r: 36.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $2.1/1M · 127.0 t/s · TTFT 2.27s · 32k ctx` · 가성비 0.5
