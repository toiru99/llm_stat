...
radar:
  ...
  long_context: { s: 13.4, z: -1.04, r: 34.5, estimated: true }  # 긴문맥
  instruction: { s: 28.6, z: -0.97, r: 35.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.75 · 출력 $8.1 · 혼합 $3.29/1M · 140.0 t/s · TTFT 2.02s · 32k ctx` · 가성비 1.2
