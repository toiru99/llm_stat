...
radar:
  ...
  long_context: { s: 12.7, z: -1.08, r: 33.8, estimated: true }  # 긴문맥
  instruction: { s: 27.6, z: -1.05, r: 34.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.75 · 출력 $8.1 · 혼합 $None/1M · 72.0 t/s · TTFT 2.21s · 32k ctx`
