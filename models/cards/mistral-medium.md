...
radar:
  ...
  agentic: { s: 10.8, z: -1.03, r: 34.5, estimated: true }  # 에이전트
  trust: { s: 8.7, z: -0.75, r: 38.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 22.7, z: -0.84, r: 37.4, estimated: true }  # 긴문맥
  instruction: { s: 34.4, z: -0.78, r: 38.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $2.1/1M · 131.0 t/s · TTFT 2.25s · 32k ctx` · 가성비 1.4
