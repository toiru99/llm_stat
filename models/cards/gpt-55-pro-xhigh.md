...
radar:
  ...
  reasoning: { s: 96.9, z: 2.96, r: 94.5, estimated: false }  # 추론
  coding: { s: 92.7, z: 1.79, r: 76.9, estimated: true }  # 코딩
  agentic: { s: 90.8, z: 2.06, r: 80.9, estimated: true }  # 에이전트
  trust: { s: 33.2, z: 0.19, r: 52.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 92.0, z: 1.23, r: 68.5, estimated: true }  # 긴문맥
  instruction: { s: 77.1, z: 0.92, r: 63.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 94.5 | +2.96 | 실측 | [[critpt]] 31.0%×1.0 |
| 코딩 | 76.9 | +1.79 | 추정 | (추정) |
