...
is_reasoning: true
radar:
  knowledge: { s: 95.4, z: 2.63, r: 89.4, estimated: true }  # 전문 지식
  reasoning: { s: 96.9, z: 3.08, r: 96.2, estimated: false }  # 추론
  ...
  instruction: { s: 78.5, z: 1.02, r: 65.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 89.4 | +2.63 | 추정 | (추정) |
| 추론 | 96.2 | +3.08 | 실측 | [[critpt]] 31.0%×1.0 |
| 코딩 | 78.0 | +1.87 | 추정 | (추정) |
| 에이전트 | 83.0 | +2.2 | 추정 | (추정) |
| 신뢰성 | 54.8 | +0.32 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
