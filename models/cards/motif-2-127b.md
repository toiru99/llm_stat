...
radar:
  ...
  reasoning: { s: 27.5, z: -0.37, r: 44.5, estimated: false }  # 추론
  ...
  long_context: { s: 16.9, z: -0.99, r: 35.1, estimated: false }  # 긴문맥
...
Motif Technologies · Proprietary · Small(12.7B) · 컨텍스트 128k · 종합지능 **7.0**
...
|---|---|---|---|---|
| 전문 지식 | 43.4 | -0.44 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 69.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
...
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 35.1 | -0.99 | 실측 | [[aa-lcr]] 15.0%×1.0 |
