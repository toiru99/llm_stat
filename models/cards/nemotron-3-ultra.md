...
radar:
  ...
  reasoning: { s: 50.0, z: 0.7, r: 60.5, estimated: false }  # 추론
  coding: { s: 62.6, z: 0.57, r: 58.6, estimated: false }  # 코딩
  agentic: { s: 53.8, z: 0.64, r: 59.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.75 · 혼합 $0.535/1M · 157.0 t/s · TTFT 1.61s · 262k ctx` · 가성비 71.0
...
| 추론 | 60.5 | +0.7 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
