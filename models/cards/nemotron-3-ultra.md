...
radar:
  ...
  agentic: { s: 53.8, z: 0.71, r: 60.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.75 · 혼합 $0.535/1M · 132.0 t/s · TTFT 2.41s · 262k ctx` · 가성비 71.0
...
| 에이전트 | 60.6 | +0.71 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
