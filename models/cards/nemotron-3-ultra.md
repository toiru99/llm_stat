...
radar:
  ...
  agentic: { s: 56.3, z: 0.18, r: 52.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.68 · 출력 $2.67 · 혼합 $0.58/1M · 141.0 t/s · TTFT 1.17s · 262k ctx` · 가성비 65.5
...
| 에이전트 | 52.6 | +0.18 | 실측 | [[gdpval]] 34.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
