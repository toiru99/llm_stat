...
radar:
  ...
  coding: { s: 53.6, z: 0.75, r: 61.2, estimated: false }  # 코딩
  agentic: { s: 53.2, z: 0.6, r: 59.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $2.6 · 혼합 $0.52/1M · 164.0 t/s · TTFT 2.49s · 262k ctx` · 가성비 57.7
...
| 코딩 | 61.2 | +0.75 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 59.1 | +0.6 | 실측 | [[gdpval]] 30.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
