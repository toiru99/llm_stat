...
radar:
  ...
  agentic: { s: 55.9, z: 0.16, r: 52.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.68 · 출력 $2.67 · 혼합 $0.58/1M · 136.0 t/s · TTFT 1.19s · 262k ctx` · 가성비 65.5
...
| 에이전트 | 52.4 | +0.16 | 실측 | [[gdpval]] 33.0%×1.0, [[tau2-bench]] 83.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
