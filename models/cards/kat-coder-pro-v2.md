...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 108.0 t/s · TTFT 1.76s · 256k ctx` · 가성비 153.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 53.8 | +0.25 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 85.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
