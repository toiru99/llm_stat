...
radar:
  ...
  coding: { s: 67.0, z: 0.89, r: 63.3, estimated: false }  # 코딩
  agentic: { s: 60.8, z: 0.96, r: 64.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.22/1M · None t/s · TTFT Nones · 256k ctx` · 가성비 159.1
...
| 코딩 | 63.3 | +0.89 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 49.0%×0.5 |
| 에이전트 | 64.4 | +0.96 | 실측 | [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
