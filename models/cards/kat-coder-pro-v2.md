...
radar:
  ...
  agentic: { s: 64.7, z: 1.1, r: 66.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 104.0 t/s · TTFT 1.51s · 256k ctx` · 가성비 157.7
...
| 에이전트 | 66.5 | +1.1 | 실측 | [[gdpval]] 20.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
