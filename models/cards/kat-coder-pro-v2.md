...
radar:
  ...
  agentic: { s: 53.6, z: 0.68, r: 60.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $None/1M · 98.0 t/s · TTFT 1.61s · 256k ctx`
...
| 에이전트 | 60.1 | +0.68 | 실측 | [[gdpval]] 20.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 6.0%×1.0, [[terminal-bench]] 49.0%×1.0 |
