...
radar:
  ...
  reasoning: { s: 65.0, z: 1.54, r: 73.1, estimated: false }  # 추론
  ...
  instruction: { s: 85.7, z: 1.4, r: 71.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 320.0 t/s · TTFT 6.87s · 1M ctx` · 가성비 91.8
...
| 추론 | 73.1 | +1.54 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
