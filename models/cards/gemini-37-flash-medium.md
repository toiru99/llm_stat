...
is_reasoning: true
radar:
  knowledge: { s: 83.8, z: 2.02, r: 80.2, estimated: false }  # 전문 지식
  reasoning: { s: 65.0, z: 1.41, r: 71.2, estimated: false }  # 추론
  coding: { s: 96.7, z: 1.95, r: 79.3, estimated: false }  # 코딩
  agentic: { s: 71.6, z: 1.31, r: 69.7, estimated: false }  # 에이전트
  ...
  instruction: { s: 84.2, z: 1.21, r: 68.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 352.0 t/s · TTFT 6.48s · 1M ctx` · 가성비 91.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.2 | +2.02 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 39.0%×0.3 |
| 추론 | 71.2 | +1.41 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 79.3 | +1.95 | 실측 | [[scicode]] 58.0%×1.0 |
| 에이전트 | 69.7 | +1.31 | 실측 | [[gdpval]] 50.0%×1.0, [[tau3-banking]] 35.0%×1.0 |
