...
radar:
  ...
  reasoning: { s: 63.4, z: 1.45, r: 71.7, estimated: false }  # 추론
  coding: { s: 93.5, z: 1.99, r: 79.8, estimated: false }  # 코딩
  agentic: { s: 71.1, z: 1.32, r: 69.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 282.0 t/s · TTFT 5.7s · 1M ctx` · 가성비 91.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.9 | +2.06 | 실측 | [[aa-omniscience]] 54.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 39.0%×0.3 |
| 추론 | 71.7 | +1.45 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
