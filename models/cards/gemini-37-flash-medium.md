...
radar:
  ...
  reasoning: { s: 63.0, z: 1.35, r: 70.2, estimated: false }  # 추론
  coding: { s: 93.9, z: 2.15, r: 82.3, estimated: false }  # 코딩
  ...
  instruction: { s: 77.2, z: 1.02, r: 65.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.75 · 출력 $3.75 · 혼합 $0.5775/1M · 347.0 t/s · TTFT 5.15s · 1M ctx` · 가성비 74.5
...
| 추론 | 70.2 | +1.35 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 82.3 | +2.15 | 실측 | [[scicode]] 60.0%×1.0 |
