...
is_reasoning: false
radar:
  knowledge: { s: 16.1, z: -1.2, r: 31.9, estimated: false }  # 전문 지식
  reasoning: { s: 9.1, z: -1.3, r: 30.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 31.9 | -1.2 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.6 | -1.3 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 27.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
