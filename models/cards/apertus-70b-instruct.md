...
is_reasoning: false
radar:
  knowledge: { s: 17.9, z: -1.11, r: 33.4, estimated: false }  # 전문 지식
  reasoning: { s: 9.3, z: -1.27, r: 31.0, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 33.4 | -1.11 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 31.0 | -1.27 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 27.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 24.7 | -1.68 | 실측 | [[scicode]] 6.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
