...
is_reasoning: false
radar:
  knowledge: { s: 16.1, z: -1.2, r: 32.1, estimated: false }  # 전문 지식
  reasoning: { s: 9.1, z: -1.29, r: 30.7, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 32.1 | -1.2 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.7 | -1.29 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 27.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 24.4 | -1.7 | 실측 | [[scicode]] 6.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
