...
is_reasoning: false
radar:
  knowledge: { s: 17.9, z: -1.1, r: 33.6, estimated: false }  # 전문 지식
  reasoning: { s: 9.3, z: -1.26, r: 31.1, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 33.6 | -1.1 | 실측 | [[aa-omniscience]] 13.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
