...
is_reasoning: false
radar:
  knowledge: { s: 16.2, z: -1.18, r: 32.2, estimated: false }  # 전문 지식
  reasoning: { s: 9.2, z: -1.28, r: 30.9, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 32.2 | -1.18 | 실측 | [[aa-omniscience]] 12.0%×1.0, [[gpqa-diamond]] 27.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 30.9 | -1.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 27.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 24.6 | -1.69 | 실측 | [[scicode]] 6.0%×1.0, [[terminal-bench]] 0.0%×0.5 |
