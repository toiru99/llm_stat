...
is_reasoning: true
radar:
  knowledge: { s: 43.7, z: 0.16, r: 52.3, estimated: false }  # 전문 지식
  reasoning: { s: 35.7, z: 0.11, r: 51.7, estimated: false }  # 추론
  coding: { s: 54.8, z: 0.37, r: 55.5, estimated: false }  # 코딩
  agentic: { s: 61.4, z: 0.98, r: 64.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 52.3 | +0.16 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 13.0%×0.3 |
...
| 에이전트 | 64.8 | +0.98 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
