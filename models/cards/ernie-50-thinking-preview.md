...
is_reasoning: true
radar:
  knowledge: { s: 42.3, z: 0.07, r: 51.1, estimated: false }  # 전문 지식
  reasoning: { s: 35.4, z: 0.03, r: 50.4, estimated: false }  # 추론
  coding: { s: 54.8, z: 0.31, r: 54.6, estimated: false }  # 코딩
  agentic: { s: 61.4, z: 1.01, r: 65.2, estimated: false }  # 에이전트
...
| 추론 | 50.4 | +0.03 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 13.0%×1.0 |
| 코딩 | 54.6 | +0.31 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 25.0%×0.5 |
| 에이전트 | 65.2 | +1.01 | 실측 | [[tau2-bench]] 84.0%×1.0, [[terminal-bench]] 25.0%×1.0 |
