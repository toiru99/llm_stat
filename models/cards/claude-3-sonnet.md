...
radar:
  ...
  agentic: { s: 12.6, z: -0.95, r: 35.8, estimated: true }  # 에이전트
  trust: { s: 15.2, z: -0.42, r: 43.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.7, z: -0.94, r: 35.9, estimated: true }  # 긴문맥
  instruction: { s: 28.6, z: -1.0, r: 35.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
