...
radar:
  ...
  agentic: { s: 15.8, z: -0.8, r: 37.9, estimated: true }  # 에이전트
  trust: { s: 24.3, z: -0.19, r: 47.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 25.3, z: -0.72, r: 39.2, estimated: true }  # 긴문맥
  instruction: { s: 28.3, z: -1.03, r: 34.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
