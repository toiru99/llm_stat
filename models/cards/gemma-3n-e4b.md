...
radar:
  ...
  coding: { s: 9.9, z: -1.58, r: 26.3, estimated: false }  # 코딩
  agentic: { s: 2.7, z: -1.34, r: 30.0, estimated: false }  # 에이전트
  trust: { s: 1.2, z: -1.15, r: 32.7, estimated: false }  # 신뢰성
  multimodal: { s: 15.7, z: -2.74, r: 8.9, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.06 · 출력 $0.12 · 혼합 $0.066/1M · 57.0 t/s · TTFT 1.25s · 32k ctx` · 가성비 15.2
...
| 추론 | 31.1 | -1.26 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 30.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 26.3 | -1.58 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 30.0 | -1.34 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
| 신뢰성 | 32.7 | -1.15 | 실측 | [[aa-omniscience]] 3.0%×1.0 |
| 멀티모달 | 8.9 | -2.74 | 실측 | [[mmmu-pro]] 26.0%×1.0 |
