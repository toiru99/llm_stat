...
radar:
  ...
  coding: { s: 9.9, z: -1.54, r: 26.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.02 · 출력 $0.04 · 혼합 $None/1M · 55.0 t/s · TTFT 1.16s · 32k ctx`
...
| 코딩 | 26.9 | -1.54 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
