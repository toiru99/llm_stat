...
is_reasoning: false
radar:
  knowledge: { s: 13.5, z: -1.34, r: 29.9, estimated: false }  # 전문 지식
  reasoning: { s: 9.6, z: -1.25, r: 31.3, estimated: false }  # 추론
  coding: { s: 9.6, z: -1.57, r: 26.4, estimated: false }  # 코딩
  agentic: { s: 2.7, z: -1.35, r: 29.8, estimated: false }  # 에이전트
  trust: { s: 1.0, z: -1.12, r: 33.3, estimated: false }  # 신뢰성
  multimodal: { s: 15.5, z: -2.71, r: 9.3, estimated: false }  # 멀티모달
...
| 코딩 | 26.4 | -1.57 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 29.8 | -1.35 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
