...
radar:
  ...
  coding: { s: 9.9, z: -1.53, r: 27.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.02 · 출력 $0.04 · 혼합 $0.02/1M · 56.0 t/s · TTFT 1.24s · 32k ctx` · 가성비 50.0
...
| 코딩 | 27.1 | -1.53 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
