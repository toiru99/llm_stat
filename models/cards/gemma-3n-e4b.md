...
is_reasoning: false
radar:
  knowledge: { s: 13.0, z: -1.34, r: 30.0, estimated: false }  # 전문 지식
  reasoning: { s: 9.8, z: -1.25, r: 31.3, estimated: false }  # 추론
  coding: { s: 9.9, z: -1.56, r: 26.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.06 · 출력 $0.12 · 혼합 $0.066/1M · 58.0 t/s · TTFT 1.22s · 32k ctx` · 가성비 15.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 30.0 | -1.34 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 30.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 31.3 | -1.25 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 30.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 26.6 | -1.56 | 실측 | [[scicode]] 8.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
| 에이전트 | 30.1 | -1.32 | 실측 | [[tau2-bench]] 5.0%×1.0, [[tau3-banking]] 0.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
