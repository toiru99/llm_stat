...
radar:
  ...
  multimodal: { s: 15.9, z: -2.66, r: 10.1, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.02 · 출력 $0.04 · 혼합 $0.02/1M · 47.0 t/s · TTFT 1.26s · 32k ctx` · 가성비 50.0
...
| 멀티모달 | 10.1 | -2.66 | 실측 | [[mmmu-pro]] 26.0%×1.0 |
