...
radar:
  ...
  reasoning: { s: 18.5, z: -0.83, r: 37.6, estimated: false }  # 추론
  coding: { s: 21.3, z: -1.11, r: 33.4, estimated: false }  # 코딩
...
| 추론 | 37.6 | -0.83 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 51.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 33.4 | -1.11 | 실측 | [[scicode]] 16.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
