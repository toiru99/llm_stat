...
is_reasoning: true
radar:
  knowledge: { s: 21.3, z: -0.95, r: 35.8, estimated: false }  # 전문 지식
  reasoning: { s: 18.4, z: -0.81, r: 37.8, estimated: false }  # 추론
  coding: { s: 20.7, z: -1.11, r: 33.4, estimated: false }  # 코딩
  agentic: { s: 13.0, z: -0.95, r: 35.8, estimated: false }  # 에이전트
...
| 에이전트 | 35.8 | -0.95 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 28.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
