...
is_reasoning: true
radar:
  knowledge: { s: 34.1, z: -0.35, r: 44.8, estimated: false }  # 전문 지식
  reasoning: { s: 31.8, z: -0.15, r: 47.8, estimated: false }  # 추론
...
| 추론 | 47.8 | -0.15 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 45.3 | -0.31 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 35.5 | -0.97 | 실측 | [[tau2-bench]] 17.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
