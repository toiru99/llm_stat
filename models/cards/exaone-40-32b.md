...
is_reasoning: true
radar:
  knowledge: { s: 34.1, z: -0.33, r: 45.0, estimated: false }  # 전문 지식
  reasoning: { s: 31.8, z: -0.13, r: 48.1, estimated: false }  # 추론
  coding: { s: 39.8, z: -0.3, r: 45.6, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 45.0 | -0.33 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 74.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 48.1 | -0.13 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 74.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 45.6 | -0.3 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
