...
radar:
  ...
  agentic: { s: 11.8, z: -1.61, r: 25.8, estimated: false }  # 에이전트
...
| 코딩 | 36.2 | -0.92 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 25.8 | -1.61 | 실측 | [[tau2-bench]] 17.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
