...
is_reasoning: false
radar:
  knowledge: { s: 25.7, z: -0.74, r: 39.0, estimated: false }  # 전문 지식
  reasoning: { s: 22.9, z: -0.59, r: 41.2, estimated: false }  # 추론
  coding: { s: 43.5, z: -0.15, r: 47.8, estimated: false }  # 코딩
  agentic: { s: 22.0, z: -0.6, r: 41.0, estimated: true }  # 에이전트
  trust: { s: 29.7, z: 0.24, r: 53.6, estimated: true }  # 신뢰성
  multimodal: { s: 46.5, z: -1.18, r: 32.2, estimated: false }  # 멀티모달
  long_context: { s: 8.1, z: -1.28, r: 30.8, estimated: true }  # 긴문맥
  instruction: { s: 23.1, z: -1.25, r: 31.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 41.2 | -0.59 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
