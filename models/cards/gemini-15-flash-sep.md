...
radar:
  ...
  agentic: { s: 28.8, z: -0.29, r: 45.6, estimated: true }  # 에이전트
  trust: { s: 20.9, z: -0.32, r: 45.2, estimated: true }  # 신뢰성
  multimodal: { s: 47.8, z: -1.15, r: 32.8, estimated: false }  # 멀티모달
  long_context: { s: 29.5, z: -0.58, r: 41.3, estimated: true }  # 긴문맥
...
| 추론 | 41.8 | -0.55 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
