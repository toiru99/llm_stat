...
radar:
  ...
  agentic: { s: 35.6, z: -0.04, r: 49.4, estimated: true }  # 에이전트
  trust: { s: 30.8, z: 0.17, r: 52.5, estimated: true }  # 신뢰성
  multimodal: { s: 47.1, z: -1.21, r: 31.9, estimated: false }  # 멀티모달
  long_context: { s: 14.6, z: -1.08, r: 33.8, estimated: true }  # 긴문맥
  instruction: { s: 31.2, z: -0.94, r: 36.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 39.0 | -0.73 | 실측 | [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 41.0 | -0.6 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
| 코딩 | 48.0 | -0.13 | 실측 | [[scicode]] 27.0%×1.0 |
| 에이전트 | 49.4 | -0.04 | 추정 | (추정) |
| 신뢰성 | 52.5 | +0.17 | 추정 | (추정) |
| 멀티모달 | 31.9 | -1.21 | 실측 | [[mmmu-pro]] 48.0%×1.0 |
| 긴문맥 | 33.8 | -1.08 | 추정 | (추정) |
| 지시 따르기 | 36.0 | -0.94 | 추정 | (추정) |
