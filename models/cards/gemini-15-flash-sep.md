...
radar:
  ...
  trust: { s: 28.0, z: 0.01, r: 50.1, estimated: true }  # 신뢰성
  multimodal: { s: 47.8, z: -1.13, r: 33.1, estimated: false }  # 멀티모달
  long_context: { s: 33.2, z: -0.45, r: 43.3, estimated: true }  # 긴문맥
  instruction: { s: 40.8, z: -0.47, r: 42.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
