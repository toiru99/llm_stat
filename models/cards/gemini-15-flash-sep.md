...
radar:
  ...
  agentic: { s: 36.8, z: 0.04, r: 50.6, estimated: true }  # 에이전트
  trust: { s: 33.8, z: 0.35, r: 55.2, estimated: true }  # 신뢰성
  multimodal: { s: 47.1, z: -1.19, r: 32.2, estimated: false }  # 멀티모달
  long_context: { s: 15.7, z: -1.02, r: 34.8, estimated: true }  # 긴문맥
...
| 추론 | 41.4 | -0.57 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
