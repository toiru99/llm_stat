...
radar:
  ...
  agentic: { s: 28.6, z: -0.31, r: 45.4, estimated: true }  # 에이전트
  trust: { s: 20.5, z: -0.37, r: 44.5, estimated: true }  # 신뢰성
  multimodal: { s: 47.1, z: -1.18, r: 32.2, estimated: false }  # 멀티모달
  long_context: { s: 30.3, z: -0.57, r: 41.4, estimated: true }  # 긴문맥
  instruction: { s: 35.8, z: -0.72, r: 39.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 39.3 | -0.71 | 실측 | [[gpqa-diamond]] 46.0%×0.4, [[humanitys-last-exam]] 3.0%×0.3 |
| 추론 | 41.6 | -0.56 | 실측 | [[gpqa-diamond]] 46.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
