...
Google · Open · Small(30.7B) · 컨텍스트 256k · 종합지능 **15.0**
...
## 실용 지표
`입력 $0.14 · 출력 $0.4 · 혼합 $0.166/1M · 58.0 t/s · TTFT 1.39s · 256k ctx` · 가성비 90.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.7 | -0.22 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 12.0%×0.3 |
| 추론 | 47.7 | -0.15 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 12.0%×1.0 |
| 코딩 | 56.9 | +0.46 | 실측 | [[terminal-bench]] 30.0%×0.5 |
| 에이전트 | 49.2 | -0.05 | 실측 | [[gdpval]] 10.0%×1.0, [[tau2-bench]] 65.0%×1.0, [[tau3-banking]] 9.0%×1.0, [[terminal-bench]] 30.0%×1.0 |
