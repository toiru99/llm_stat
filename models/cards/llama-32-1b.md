...
is_reasoning: false
radar:
  knowledge: { s: 9.6, z: -1.51, r: 27.3, estimated: false }  # 전문 지식
  reasoning: { s: 6.4, z: -1.43, r: 28.6, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 27.3 | -1.51 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 20.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
