...
is_reasoning: false
radar:
  knowledge: { s: 10.3, z: -1.45, r: 28.2, estimated: false }  # 전문 지식
  reasoning: { s: 6.9, z: -1.38, r: 29.3, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 28.2 | -1.45 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 21.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 29.3 | -1.38 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 21.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
