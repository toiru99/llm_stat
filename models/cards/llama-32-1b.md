...
is_reasoning: false
radar:
  knowledge: { s: 9.6, z: -1.5, r: 27.5, estimated: false }  # 전문 지식
  reasoning: { s: 6.4, z: -1.41, r: 28.8, estimated: false }  # 추론
...
| 추론 | 28.8 | -1.41 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 20.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
