...
is_reasoning: false
radar:
  knowledge: { s: 10.0, z: -1.48, r: 27.9, estimated: false }  # 전문 지식
  reasoning: { s: 6.5, z: -1.41, r: 28.9, estimated: false }  # 추론
  ...
  long_context: { s: 6.6, z: -1.28, r: 30.8, estimated: false }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 27.9 | -1.48 | 실측 | [[aa-omniscience]] 7.0%×1.0, [[gpqa-diamond]] 20.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 28.9 | -1.41 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 20.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
...
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 30.8 | -1.28 | 실측 | [[aa-lcr]] 5.0%×1.0 |
