...
radar:
  ...
  coding: { s: 43.5, z: -0.11, r: 48.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.25/1M · 35.0 t/s · TTFT 3.06s · 512k ctx` · 가성비 72.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.5 | -0.17 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 47.3 | -0.18 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 48.3 | -0.11 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
