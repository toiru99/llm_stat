...
radar:
  ...
  agentic: { s: 30.1, z: -0.23, r: 46.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.246/1M · 36.0 t/s · TTFT 3.03s · 512k ctx` · 가성비 73.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 46.9 | -0.21 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
...
| 에이전트 | 46.6 | -0.23 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
