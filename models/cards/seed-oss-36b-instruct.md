...
is_reasoning: true
radar:
  knowledge: { s: 37.0, z: -0.18, r: 47.4, estimated: false }  # 전문 지식
  reasoning: { s: 30.1, z: -0.19, r: 47.1, estimated: false }  # 추론
  coding: { s: 43.5, z: -0.12, r: 48.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $None/1M · 35.0 t/s · TTFT 3.02s · 512k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 47.4 | -0.18 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 9.0%×0.3 |
| 추론 | 47.1 | -0.19 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 9.0%×1.0 |
| 코딩 | 48.1 | -0.12 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
