...
radar:
  ...
  coding: { s: 43.5, z: -0.1, r: 48.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.25/1M · 35.0 t/s · TTFT 3.05s · 512k ctx` · 가성비 72.0
...
| 코딩 | 48.5 | -0.1 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 46.5 | -0.23 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
