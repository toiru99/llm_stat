...
radar:
  ...
  coding: { s: 43.5, z: -0.19, r: 47.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.246/1M · 25.0 t/s · TTFT 3.08s · 512k ctx` · 가성비 77.2
...
| 코딩 | 47.1 | -0.19 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
| 에이전트 | 46.1 | -0.26 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
