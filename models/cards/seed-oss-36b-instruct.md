...
radar:
  ...
  coding: { s: 43.5, z: -0.2, r: 47.0, estimated: false }  # 코딩
  agentic: { s: 30.1, z: -0.26, r: 46.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.246/1M · 29.0 t/s · TTFT 2.94s · 512k ctx` · 가성비 77.2
...
| 에이전트 | 46.0 | -0.26 | 실측 | [[tau2-bench]] 49.0%×1.0, [[terminal-bench]] 7.0%×1.0 |
