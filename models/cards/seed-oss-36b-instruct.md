...
radar:
  ...
  coding: { s: 43.5, z: -0.12, r: 48.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.21 · 출력 $0.57 · 혼합 $0.25/1M · 34.0 t/s · TTFT 2.97s · 512k ctx` · 가성비 72.0
...
| 코딩 | 48.3 | -0.12 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 7.0%×0.5 |
