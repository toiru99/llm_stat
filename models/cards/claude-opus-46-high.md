...
is_reasoning: false
radar:
  knowledge: { s: 70.0, z: 1.43, r: 71.4, estimated: false }  # 전문 지식
  reasoning: { s: 44.0, z: 0.55, r: 58.3, estimated: false }  # 추론
  coding: { s: 75.4, z: 1.24, r: 68.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 38.0 t/s · TTFT 2.63s · 1M ctx` · 가성비 9.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.4 | +1.43 | 실측 | [[aa-omniscience]] 45.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 58.3 | +0.55 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 68.5 | +1.24 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 48.0%×0.5 |
