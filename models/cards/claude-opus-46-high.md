...
radar:
  ...
  coding: { s: 75.4, z: 1.22, r: 68.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 38.0 t/s · TTFT 2.65s · 1M ctx` · 가성비 9.9
...
| 코딩 | 68.4 | +1.22 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 48.0%×0.5 |
