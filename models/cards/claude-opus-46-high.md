...
is_reasoning: false
radar:
  knowledge: { s: 67.7, z: 1.25, r: 68.8, estimated: false }  # 전문 지식
  reasoning: { s: 43.3, z: 0.36, r: 55.4, estimated: false }  # 추론
  coding: { s: 75.4, z: 1.09, r: 66.3, estimated: false }  # 코딩
  agentic: { s: 79.3, z: 1.62, r: 74.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 43.0 t/s · TTFT 2.18s · 1M ctx` · 가성비 10.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 68.8 | +1.25 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
| 추론 | 55.4 | +0.36 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 19.0%×1.0 |
| 코딩 | 66.3 | +1.09 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 48.0%×0.5 |
| 에이전트 | 74.3 | +1.62 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 48.0%×1.0 |
