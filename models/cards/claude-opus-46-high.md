...
is_reasoning: false
radar:
  knowledge: { s: 68.0, z: 1.31, r: 69.6, estimated: false }  # 전문 지식
  reasoning: { s: 43.6, z: 0.43, r: 56.5, estimated: false }  # 추론
  coding: { s: 75.4, z: 1.16, r: 67.4, estimated: false }  # 코딩
  agentic: { s: 79.3, z: 1.73, r: 75.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 37.0 t/s · TTFT 2.58s · 1M ctx` · 가성비 10.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.6 | +1.31 | 실측 | [[aa-omniscience]] 46.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
...
| 에이전트 | 75.9 | +1.73 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 48.0%×1.0 |
