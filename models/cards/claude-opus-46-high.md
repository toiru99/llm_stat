...
radar:
  ...
  coding: { s: 75.4, z: 1.08, r: 66.2, estimated: false }  # 코딩
  agentic: { s: 79.3, z: 1.61, r: 74.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 43.0 t/s · TTFT 2.17s · 1M ctx` · 가성비 10.1
...
| 코딩 | 66.2 | +1.08 | 실측 | [[scicode]] 46.0%×1.0, [[terminal-bench]] 48.0%×0.5 |
| 에이전트 | 74.1 | +1.61 | 실측 | [[tau2-bench]] 85.0%×1.0, [[terminal-bench]] 48.0%×1.0 |
