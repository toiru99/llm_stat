...
radar:
  knowledge: { s: 47.4, z: -0.23, r: 46.6, estimated: false }  # 전문 지식
  reasoning: { s: 45.3, z: -0.0, r: 49.9, estimated: false }  # 추론
  coding: { s: 66.8, z: 0.27, r: 54.1, estimated: false }  # 코딩
  agentic: { s: 51.2, z: -0.02, r: 49.6, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 46.6 | -0.23 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 49.9 | +-0.0 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 54.1 | +0.27 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 49.6 | -0.02 | 실측 | [[gdpval]] 15.0%×1.0, [[itbench]] 37.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
