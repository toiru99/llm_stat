...
radar:
  ...
  coding: { s: 66.0, z: 0.71, r: 60.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.168/1M · 36.0 t/s · TTFT 1.09s · 256k ctx` · 가성비 178.6
...
| 코딩 | 60.6 | +0.71 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
