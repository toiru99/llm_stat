...
is_reasoning: false
radar:
  knowledge: { s: 47.4, z: 0.32, r: 54.9, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $None/1M · 35.0 t/s · TTFT 1.15s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.9 | +0.32 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
