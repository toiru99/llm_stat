...
radar:
  ...
  agentic: { s: 50.5, z: -0.05, r: 49.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.0/1M · 35.0 t/s · TTFT 1.13s · 256k ctx`
...
| 에이전트 | 49.2 | -0.05 | 실측 | [[gdpval]] 14.0%×1.0, [[itbench]] 37.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
