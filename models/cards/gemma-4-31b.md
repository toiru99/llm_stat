...
radar:
  ...
  reasoning: { s: 45.0, z: 0.47, r: 57.0, estimated: false }  # 추론
  coding: { s: 66.0, z: 0.72, r: 60.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.168/1M · 36.0 t/s · TTFT 1.11s · 256k ctx` · 가성비 178.6
...
| 추론 | 57.0 | +0.47 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 24.0%×1.0 |
| 코딩 | 60.8 | +0.72 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
