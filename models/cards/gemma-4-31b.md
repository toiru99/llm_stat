...
is_reasoning: false
radar:
  knowledge: { s: 47.4, z: 0.28, r: 54.2, estimated: false }  # 전문 지식
  reasoning: { s: 45.3, z: 0.53, r: 57.9, estimated: false }  # 추론
  coding: { s: 66.0, z: 0.77, r: 61.6, estimated: false }  # 코딩
  agentic: { s: 47.7, z: 0.48, r: 57.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.0 · 출력 $0.0 · 혼합 $0.167/1M · 35.0 t/s · TTFT 1.07s · 256k ctx` · 가성비 173.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.2 | +0.28 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 86.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
| 추론 | 57.9 | +0.53 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 86.0%×1.0, [[humanitys-last-exam]] 23.0%×1.0 |
| 코딩 | 61.6 | +0.77 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 57.1 | +0.48 | 실측 | [[gdpval]] 15.0%×1.0, [[itbench]] 37.0%×1.0, [[tau2-bench]] 60.0%×1.0, [[tau3-banking]] 15.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
