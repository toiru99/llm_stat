...
is_reasoning: false
radar:
  knowledge: { s: 31.1, z: -0.47, r: 42.9, estimated: false }  # 전문 지식
  reasoning: { s: 21.0, z: -0.67, r: 39.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $None/1M · 48.0 t/s · TTFT 1.48s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.9 | -0.47 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 39.9 | -0.67 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
