...
is_reasoning: false
radar:
  knowledge: { s: 29.9, z: -0.54, r: 41.9, estimated: false }  # 전문 지식
  reasoning: { s: 20.7, z: -0.72, r: 39.2, estimated: false }  # 추론
  coding: { s: 38.7, z: -0.39, r: 44.1, estimated: false }  # 코딩
  agentic: { s: 15.2, z: -0.84, r: 37.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 51.0 t/s · TTFT 1.57s · 128k ctx` · 가성비 21.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.9 | -0.54 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 37.3 | -0.84 | 실측 | [[tau2-bench]] 24.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
