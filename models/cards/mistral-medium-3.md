...
is_reasoning: false
radar:
  knowledge: { s: 29.8, z: -0.53, r: 42.0, estimated: false }  # 전문 지식
...
Mistral · Proprietary · Unknown · 컨텍스트 128k · 종합지능 **7.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 139.0 t/s · TTFT 2.28s · 128k ctx` · 가성비 12.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.0 | -0.53 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
