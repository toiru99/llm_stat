...
radar:
  ...
  coding: { s: 37.5, z: -0.39, r: 44.2, estimated: false }  # 코딩
  agentic: { s: 15.2, z: -0.86, r: 37.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.4 · 출력 $2.0 · 혼합 $0.56/1M · 94.0 t/s · TTFT 2.14s · 128k ctx` · 가성비 21.4
...
| 에이전트 | 37.1 | -0.86 | 실측 | [[tau2-bench]] 24.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
