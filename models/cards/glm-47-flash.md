...
radar:
  ...
  coding: { s: 47.7, z: 0.03, r: 50.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.4 · 혼합 $0.103/1M · 87.0 t/s · TTFT 1.33s · 200k ctx` · 가성비 223.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.8 | -0.55 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 58.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 41.2 | -0.59 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 50.4 | +0.03 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 22.0%×0.5 |
