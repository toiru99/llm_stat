...
radar:
  ...
  coding: { s: 47.7, z: 0.04, r: 50.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.4 · 혼합 $0.103/1M · 88.0 t/s · TTFT 1.35s · 200k ctx` · 가성비 223.3
...
| 추론 | 41.3 | -0.58 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 58.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 50.6 | +0.04 | 실측 | [[scicode]] 34.0%×1.0, [[terminal-bench]] 22.0%×0.5 |
| 에이전트 | 67.3 | +1.15 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 22.0%×1.0 |
