...
radar:
  ...
  coding: { s: 48.9, z: 0.03, r: 50.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.07 · 출력 $0.4 · 혼합 $0.103/1M · 98.0 t/s · TTFT 1.14s · 200k ctx` · 가성비 223.3
...
| 에이전트 | 67.8 | +1.18 | 실측 | [[tau2-bench]] 99.0%×1.0, [[terminal-bench]] 22.0%×1.0 |
