...
is_reasoning: false
radar:
  knowledge: { s: 10.1, z: -1.48, r: 27.8, estimated: false }  # 전문 지식
  reasoning: { s: 6.9, z: -1.39, r: 29.2, estimated: false }  # 추론
  coding: { s: 6.1, z: -1.73, r: 24.1, estimated: false }  # 코딩
  ...
  instruction: { s: 14.1, z: -1.64, r: 25.5, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 29.2 | -1.39 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 23.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
...
| 지시 따르기 | 25.5 | -1.64 | 실측 | [[ifbench]] 22.0%×1.0 |
