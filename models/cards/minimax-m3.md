...
radar:
  ...
  reasoning: { s: 60.2, z: 1.39, r: 70.8, estimated: false }  # 추론
  coding: { s: 71.2, z: 1.05, r: 65.7, estimated: false }  # 코딩
  agentic: { s: 66.1, z: 1.15, r: 67.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $None/1M · 108.0 t/s · TTFT 1.38s · 1M ctx`
...
| 추론 | 70.8 | +1.39 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 65.7 | +1.05 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 67.3 | +1.15 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
