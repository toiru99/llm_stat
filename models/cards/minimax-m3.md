...
radar:
  ...
  coding: { s: 66.1, z: 1.2, r: 67.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 87.0 t/s · TTFT 1.62s · 1M ctx` · 가성비 162.2
...
| 코딩 | 67.9 | +1.2 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
