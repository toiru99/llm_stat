...
radar:
  ...
  agentic: { s: 64.0, z: 0.51, r: 57.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.22/1M · 97.0 t/s · TTFT 1.48s · 1M ctx` · 가성비 200.0
...
| 에이전트 | 57.7 | +0.51 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
