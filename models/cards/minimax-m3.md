...
radar:
  ...
  agentic: { s: 62.2, z: 1.0, r: 65.0, estimated: false }  # 에이전트
  trust: { s: 93.0, z: 2.93, r: 94.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.222/1M · 83.0 t/s · TTFT 1.57s · 1M ctx` · 가성비 202.7
...
| 신뢰성 | 94.0 | +2.93 | 실측 | [[aa-omniscience]] 82.0%×1.0 |
