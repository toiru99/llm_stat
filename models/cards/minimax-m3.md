...
radar:
  ...
  agentic: { s: 63.6, z: 0.49, r: 57.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $0.22/1M · 97.0 t/s · TTFT 2.42s · 1M ctx` · 가성비 200.0
...
| 에이전트 | 57.3 | +0.49 | 실측 | [[gdpval]] 44.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
