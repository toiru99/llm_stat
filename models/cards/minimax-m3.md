...
radar:
  ...
  reasoning: { s: 60.2, z: 1.3, r: 69.4, estimated: false }  # 추론
  coding: { s: 71.2, z: 1.01, r: 65.1, estimated: false }  # 코딩
  agentic: { s: 64.5, z: 1.09, r: 66.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.3 · 출력 $1.2 · 혼합 $None/1M · 71.0 t/s · TTFT 1.36s · 1M ctx`
...
| 추론 | 69.4 | +1.3 | 실측 | [[critpt]] 4.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 65.1 | +1.01 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 66.4 | +1.09 | 실측 | [[gdpval]] 45.0%×1.0, [[tau2-bench]] 89.0%×1.0, [[tau3-banking]] 13.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
