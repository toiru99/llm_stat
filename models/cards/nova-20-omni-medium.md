...
radar:
  ...
  agentic: { s: 44.2, z: 0.33, r: 54.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 46.6 | -0.23 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
...
| 에이전트 | 54.9 | +0.33 | 실측 | [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
