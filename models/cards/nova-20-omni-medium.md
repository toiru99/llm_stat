...
radar:
  ...
  reasoning: { s: 30.0, z: -0.23, r: 46.5, estimated: false }  # 추론
  coding: { s: 42.5, z: -0.2, r: 47.0, estimated: false }  # 코딩
  agentic: { s: 44.2, z: 0.34, r: 55.1, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 47.0 | -0.2 | 실측 | [[aa-omniscience]] 18.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.5 | -0.23 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 47.0 | -0.2 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 5.0%×0.5 |
| 에이전트 | 55.1 | +0.34 | 실측 | [[tau2-bench]] 80.0%×1.0, [[terminal-bench]] 5.0%×1.0 |
