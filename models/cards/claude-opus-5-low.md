...
is_reasoning: true
radar:
  knowledge: { s: 86.1, z: 2.13, r: 81.9, estimated: false }  # 전문 지식
  reasoning: { s: 80.9, z: 2.18, r: 82.7, estimated: false }  # 추론
  ...
  instruction: { s: 85.5, z: 1.26, r: 68.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 3.05s · 1M ctx` · 가성비 13.5
...
| 추론 | 82.7 | +2.18 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.1 | +1.27 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 66.0 | +1.07 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
