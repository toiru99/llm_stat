...
radar:
  ...
  reasoning: { s: 80.9, z: 2.19, r: 82.8, estimated: false }  # 추론
  ...
  instruction: { s: 84.7, z: 1.24, r: 68.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 82.8 | +2.19 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.1 | +1.28 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 66.1 | +1.08 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
