...
is_reasoning: true
radar:
  knowledge: { s: 83.7, z: 2.0, r: 80.1, estimated: false }  # 전문 지식
  reasoning: { s: 80.9, z: 2.34, r: 85.1, estimated: false }  # 추론
  coding: { s: 80.0, z: 1.38, r: 70.8, estimated: false }  # 코딩
  agentic: { s: 70.1, z: 1.31, r: 69.6, estimated: false }  # 에이전트
  ...
  instruction: { s: 81.8, z: 1.19, r: 67.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 54.0 t/s · TTFT 4.08s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.1 | +2.0 | 실측 | [[aa-omniscience]] 50.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 41.0%×0.3 |
| 추론 | 85.1 | +2.34 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
| 코딩 | 70.8 | +1.38 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 69.6 | +1.31 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
