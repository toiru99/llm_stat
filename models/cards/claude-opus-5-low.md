...
is_reasoning: true
radar:
  knowledge: { s: 86.1, z: 2.12, r: 81.9, estimated: false }  # 전문 지식
  reasoning: { s: 80.9, z: 2.2, r: 83.0, estimated: false }  # 추론
  coding: { s: 80.0, z: 1.28, r: 69.2, estimated: false }  # 코딩
  agentic: { s: 65.2, z: 1.08, r: 66.3, estimated: false }  # 에이전트
  ...
  instruction: { s: 84.3, z: 1.22, r: 68.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 81.9 | +2.12 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 43.0%×0.3 |
| 추론 | 83.0 | +2.2 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.2 | +1.28 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 66.3 | +1.08 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
