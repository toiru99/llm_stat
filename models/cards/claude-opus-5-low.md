...
radar:
  ...
  reasoning: { s: 80.9, z: 2.22, r: 83.3, estimated: false }  # 추론
  ...
  instruction: { s: 85.1, z: 1.25, r: 68.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 49.0 t/s · TTFT 3.45s · 1M ctx` · 가성비 13.5
...
| 추론 | 83.3 | +2.22 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.4 | +1.29 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 30.0%×1.0 |
