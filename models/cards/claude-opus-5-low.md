...
radar:
  ...
  reasoning: { s: 80.9, z: 2.34, r: 85.0, estimated: false }  # 추론
  ...
  instruction: { s: 81.8, z: 1.18, r: 67.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 54.0 t/s · TTFT 2.75s · 1M ctx` · 가성비 13.2
...
| 추론 | 85.0 | +2.34 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 41.0%×1.0 |
