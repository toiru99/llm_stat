...
radar:
  ...
  coding: { s: 80.0, z: 1.38, r: 70.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 54.0 t/s · TTFT 2.94s · 1M ctx`
...
| 코딩 | 70.6 | +1.38 | 실측 | [[scicode]] 48.0%×1.0 |
| 에이전트 | 69.1 | +1.27 | 실측 | [[gdpval]] 48.0%×1.0, [[tau3-banking]] 23.0%×1.0 |
