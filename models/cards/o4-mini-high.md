...
radar:
  ...
  agentic: { s: 39.6, z: 0.08, r: 51.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.8525/1M · 142.0 t/s · TTFT 22.85s · 200k ctx` · 가성비 22.3
...
| 에이전트 | 51.2 | +0.08 | 실측 | [[tau2-bench]] 56.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
