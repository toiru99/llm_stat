...
radar:
  ...
  coding: { s: 59.8, z: 0.53, r: 57.9, estimated: false }  # 코딩
  agentic: { s: 39.6, z: 0.12, r: 51.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.8525/1M · 168.0 t/s · TTFT 21.89s · 200k ctx` · 가성비 30.5
...
| 코딩 | 57.9 | +0.53 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 51.9 | +0.12 | 실측 | [[tau2-bench]] 56.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
