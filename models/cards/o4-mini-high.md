...
radar:
  ...
  reasoning: { s: 37.6, z: 0.09, r: 51.4, estimated: false }  # 추론
  coding: { s: 59.8, z: 0.46, r: 56.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.8525/1M · 179.0 t/s · TTFT 28.43s · 200k ctx` · 가성비 30.5
...
| 추론 | 51.4 | +0.09 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 56.9 | +0.46 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
