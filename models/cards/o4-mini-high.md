...
radar:
  ...
  coding: { s: 59.8, z: 0.58, r: 58.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.85/1M · 171.0 t/s · TTFT 24.37s · 200k ctx` · 가성비 30.6
...
| 코딩 | 58.8 | +0.58 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
