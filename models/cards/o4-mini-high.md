...
is_reasoning: true
radar:
  knowledge: { s: 45.6, z: 0.27, r: 54.0, estimated: false }  # 전문 지식
  reasoning: { s: 36.9, z: 0.12, r: 51.8, estimated: false }  # 추론
  coding: { s: 58.1, z: 0.48, r: 57.3, estimated: false }  # 코딩
  agentic: { s: 39.6, z: 0.1, r: 51.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.8525/1M · 148.0 t/s · TTFT 24.13s · 200k ctx` · 가성비 30.5
...
| 추론 | 51.8 | +0.12 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 57.3 | +0.48 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 51.5 | +0.1 | 실측 | [[tau2-bench]] 56.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
