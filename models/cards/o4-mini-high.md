...
is_reasoning: true
radar:
  knowledge: { s: 48.3, z: 0.34, r: 55.1, estimated: false }  # 전문 지식
  reasoning: { s: 38.9, z: 0.23, r: 53.5, estimated: false }  # 추론
  coding: { s: 59.8, z: 0.54, r: 58.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $None/1M · 165.0 t/s · TTFT 23.94s · 200k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 55.1 | +0.34 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 53.5 | +0.23 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 58.1 | +0.54 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
