...
radar:
  ...
  coding: { s: 59.8, z: 0.58, r: 58.7, estimated: false }  # 코딩
  agentic: { s: 39.6, z: 0.14, r: 52.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $0.85/1M · 161.0 t/s · TTFT 28.28s · 200k ctx` · 가성비 30.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 55.7 | +0.38 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 78.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 54.3 | +0.28 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 78.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 58.7 | +0.58 | 실측 | [[scicode]] 47.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 52.0 | +0.14 | 실측 | [[tau2-bench]] 56.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
