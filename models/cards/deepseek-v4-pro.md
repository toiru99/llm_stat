...
radar:
  ...
  agentic: { s: 74.5, z: 0.89, r: 63.3, estimated: false }  # 에이전트
  trust: { s: 10.0, z: -0.84, r: 37.5, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 77.0 t/s · TTFT 1.68s · 1M ctx` · 가성비 172.2
...
| 에이전트 | 63.3 | +0.89 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
| 신뢰성 | 37.5 | -0.84 | 실측 | [[aa-omniscience]] 12.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
