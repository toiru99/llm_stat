...
radar:
  ...
  agentic: { s: 74.5, z: 0.88, r: 63.1, estimated: false }  # 에이전트
  trust: { s: 11.1, z: -0.84, r: 37.3, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 60.8, z: -0.37, r: 44.5, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 71.0 t/s · TTFT 2.03s · 1M ctx` · 가성비 172.2
...
| 에이전트 | 63.1 | +0.88 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
| 신뢰성 | 37.3 | -0.84 | 실측 | [[aa-omniscience]] 12.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 44.5 | -0.37 | 실측 | [[aa-lcr]] 45.0%×1.0 |
