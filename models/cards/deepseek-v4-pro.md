...
radar:
  ...
  agentic: { s: 74.5, z: 0.92, r: 63.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.18/1M · 56.0 t/s · TTFT 1.73s · 1M ctx` · 가성비 172.2
...
| 에이전트 | 63.9 | +0.92 | 실측 | [[tau2-bench]] 91.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
