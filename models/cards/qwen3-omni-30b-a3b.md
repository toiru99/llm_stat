...
is_reasoning: true
radar:
  knowledge: { s: 33.4, z: -0.36, r: 44.5, estimated: false }  # 전문 지식
  reasoning: { s: 28.8, z: -0.28, r: 45.9, estimated: false }  # 추론
  coding: { s: 36.5, z: -0.43, r: 43.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $None/1M · 95.0 t/s · TTFT 1.94s · 65k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 44.5 | -0.36 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 45.9 | -0.28 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 43.5 | -0.43 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 36.8 | -0.88 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
