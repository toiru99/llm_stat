...
radar:
  ...
  coding: { s: 36.6, z: -0.97, r: 35.4, estimated: false }  # 코딩
  agentic: { s: 13.8, z: -1.47, r: 28.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 43.7, z: -0.96, r: 35.6, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.32/1M · 97.0 t/s · TTFT 1.93s · 65k ctx` · 가성비 31.2
...
| 코딩 | 35.4 | -0.97 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
| 에이전트 | 28.0 | -1.47 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
| 신뢰성 | 36.9 | -0.87 | 실측 | [[aa-omniscience]] 11.0%×1.0 |
| 멀티모달 | 37.5 | -0.83 | 실측 | [[mmmu-pro]] 60.0%×1.0 |
| 긴문맥 | 12.3 | -2.51 | 실측 | [[aa-lcr]] 0.0%×1.0 |
| 지시 따르기 | 35.6 | -0.96 | 실측 | [[ifbench]] 43.0%×1.0 |
