...
radar:
  ...
  coding: { s: 36.5, z: -0.49, r: 42.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.322/1M · 100.0 t/s · TTFT 1.91s · 65k ctx` · 가성비 31.1
...
| 에이전트 | 36.3 | -0.91 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
