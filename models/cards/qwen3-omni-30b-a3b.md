...
radar:
  ...
  agentic: { s: 13.8, z: -1.51, r: 27.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.32/1M · 82.0 t/s · TTFT 2.08s · 65k ctx` · 가성비 31.2
...
| 에이전트 | 27.3 | -1.51 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 4.0%×1.0 |
