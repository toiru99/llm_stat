...
radar:
  ...
  coding: { s: 36.5, z: -0.42, r: 43.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $None/1M · 100.0 t/s · TTFT 1.9s · 65k ctx`
...
| 코딩 | 43.8 | -0.42 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
