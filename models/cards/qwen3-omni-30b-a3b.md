...
is_reasoning: true
radar:
  knowledge: { s: 33.4, z: -0.34, r: 45.0, estimated: false }  # 전문 지식
  reasoning: { s: 28.8, z: -0.24, r: 46.4, estimated: false }  # 추론
  coding: { s: 36.5, z: -0.4, r: 43.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.25 · 출력 $0.97 · 혼합 $0.32/1M · 98.0 t/s · TTFT 1.99s · 65k ctx` · 가성비 31.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.0 | -0.34 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
| 추론 | 46.4 | -0.24 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 7.0%×1.0 |
| 코딩 | 43.9 | -0.4 | 실측 | [[scicode]] 31.0%×1.0, [[terminal-bench]] 4.0%×0.5 |
