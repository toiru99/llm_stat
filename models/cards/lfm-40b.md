...
radar:
  ...
  agentic: { s: 5.1, z: -1.22, r: 31.7, estimated: true }  # 에이전트
  trust: { s: 18.8, z: -0.34, r: 44.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 8.7, z: -1.23, r: 31.6, estimated: true }  # 긴문맥
  instruction: { s: 25.4, z: -1.16, r: 32.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
