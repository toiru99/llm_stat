...
is_reasoning: true
radar:
  knowledge: { s: 38.7, z: -0.1, r: 48.6, estimated: false }  # 전문 지식
  reasoning: { s: 29.5, z: -0.22, r: 46.7, estimated: false }  # 추론
  coding: { s: 39.9, z: -0.28, r: 45.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $None/1M · 52.0 t/s · TTFT 2.36s · 128k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 48.6 | -0.1 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 8.0%×0.3 |
| 추론 | 46.7 | -0.22 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 73.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 45.9 | -0.28 | 실측 | [[scicode]] 35.0%×1.0, [[terminal-bench]] 2.0%×0.5 |
