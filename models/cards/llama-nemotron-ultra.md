...
radar:
  ...
  coding: { s: 38.6, z: -0.35, r: 44.7, estimated: false }  # 코딩
  agentic: { s: 7.1, z: -1.18, r: 32.3, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 47.2 | -0.19 | 실측 | [[aa-omniscience]] 20.0%×1.0, [[gpqa-diamond]] 73.0%×0.4, [[humanitys-last-exam]] 7.0%×0.3 |
...
| 에이전트 | 32.3 | -1.18 | 실측 | [[tau2-bench]] 11.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
