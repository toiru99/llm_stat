...
radar:
  ...
  agentic: { s: 7.1, z: -1.76, r: 23.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.6 · 출력 $1.8 · 혼합 $0.72/1M · 52.0 t/s · TTFT 2.42s · 128k ctx` · 가성비 12.5
...
| 에이전트 | 23.6 | -1.76 | 실측 | [[tau2-bench]] 11.0%×1.0, [[terminal-bench]] 2.0%×1.0 |
