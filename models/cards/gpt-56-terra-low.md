...
radar:
  ...
  reasoning: { s: 55.4, z: 1.06, r: 65.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $None/1M · 99.0 t/s · TTFT 1.4s · 1M ctx`
...
| 추론 | 65.8 | +1.06 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 68.5 | +1.24 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 44.0%×0.5 |
