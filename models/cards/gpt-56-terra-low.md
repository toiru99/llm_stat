...
is_reasoning: true
radar:
  knowledge: { s: 70.7, z: 1.45, r: 71.7, estimated: false }  # 전문 지식
  reasoning: { s: 55.4, z: 1.13, r: 67.0, estimated: false }  # 추론
  coding: { s: 76.7, z: 1.27, r: 69.1, estimated: false }  # 코딩
  agentic: { s: 59.5, z: 0.9, r: 63.5, estimated: false }  # 에이전트
  ...
  instruction: { s: 67.6, z: 0.61, r: 59.1, estimated: false }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 112.0 t/s · TTFT 1.6s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.7 | +1.45 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 67.0 | +1.13 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 69.1 | +1.27 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 44.0%×0.5 |
| 에이전트 | 63.5 | +0.9 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 61.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
| 신뢰성 | 39.4 | -0.71 | 실측 | [[aa-omniscience]] 12.0%×1.0 |
| 멀티모달 | 61.8 | +0.79 | 실측 | [[mmmu-pro]] 76.0%×1.0 |
| 긴문맥 | 65.7 | +1.04 | 실측 | [[aa-lcr]] 64.0%×1.0 |
| 지시 따르기 | 59.1 | +0.61 | 실측 | [[ifbench]] 60.0%×1.0 |
