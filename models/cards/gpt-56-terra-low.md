...
is_reasoning: true
radar:
  knowledge: { s: 70.7, z: 1.47, r: 72.0, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $2.17/1M · 108.0 t/s · TTFT 1.5s · 1M ctx` · 가성비 18.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 72.0 | +1.47 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
