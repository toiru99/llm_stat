...
is_reasoning: true
radar:
  knowledge: { s: 70.7, z: 1.45, r: 71.8, estimated: false }  # 전문 지식
  reasoning: { s: 55.4, z: 1.14, r: 67.0, estimated: false }  # 추론
  coding: { s: 76.7, z: 1.28, r: 69.2, estimated: false }  # 코딩
  agentic: { s: 58.9, z: 0.87, r: 63.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.5 · 출력 $15.0 · 혼합 $None/1M · 136.0 t/s · TTFT 1.32s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 71.8 | +1.45 | 실측 | [[aa-omniscience]] 43.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 27.0%×0.3 |
| 추론 | 67.0 | +1.14 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 27.0%×1.0 |
| 코딩 | 69.2 | +1.28 | 실측 | [[scicode]] 49.0%×1.0, [[terminal-bench]] 44.0%×0.5 |
| 에이전트 | 63.1 | +0.87 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 61.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
