...
is_reasoning: true
radar:
  knowledge: { s: 69.4, z: 1.38, r: 70.6, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $2.0 · 출력 $12.0 · 혼합 $1.74/1M · 110.0 t/s · TTFT 1.51s · 1M ctx` · 가성비 23.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.6 | +1.38 | 실측 | [[aa-omniscience]] 44.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 29.0%×0.3 |
...
| 에이전트 | 61.7 | +0.78 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 61.0%×1.0, [[tau3-banking]] 19.0%×1.0, [[terminal-bench]] 44.0%×1.0 |
