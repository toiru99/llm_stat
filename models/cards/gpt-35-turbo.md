...
radar:
  ...
  reasoning: { s: 23.8, z: -0.52, r: 42.3, estimated: false }  # 추론
  coding: { s: 33.3, z: -0.54, r: 41.8, estimated: true }  # 코딩
  agentic: { s: 12.4, z: -0.93, r: 36.1, estimated: true }  # 에이전트
  trust: { s: 29.5, z: 0.08, r: 51.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 21.3, z: -0.8, r: 37.9, estimated: true }  # 긴문맥
...
| 추론 | 42.3 | -0.52 | 실측 | [[gpqa-diamond]] 30.0%×1.0 |
| 코딩 | 41.8 | -0.54 | 추정 | (추정) |
