...
radar:
  ...
  reasoning: { s: 23.8, z: -0.54, r: 42.0, estimated: false }  # 추론
  coding: { s: 33.3, z: -0.57, r: 41.5, estimated: true }  # 코딩
  agentic: { s: 11.5, z: -0.97, r: 35.4, estimated: true }  # 에이전트
  trust: { s: 29.8, z: 0.08, r: 51.2, estimated: true }  # 신뢰성
...
| 추론 | 42.0 | -0.54 | 실측 | [[gpqa-diamond]] 30.0%×1.0 |
| 코딩 | 41.5 | -0.57 | 추정 | (추정) |
