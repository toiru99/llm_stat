...
is_reasoning: false
radar:
  knowledge: { s: 23.8, z: -0.8, r: 38.0, estimated: false }  # 전문 지식
  reasoning: { s: 23.8, z: -0.51, r: 42.4, estimated: false }  # 추론
  coding: { s: 33.3, z: -0.53, r: 42.0, estimated: true }  # 코딩
  agentic: { s: 12.4, z: -0.92, r: 36.2, estimated: true }  # 에이전트
  trust: { s: 29.5, z: 0.09, r: 51.3, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 38.0 | -0.8 | 실측 | [[gpqa-diamond]] 30.0%×0.4 |
| 추론 | 42.4 | -0.51 | 실측 | [[gpqa-diamond]] 30.0%×1.0 |
| 코딩 | 42.0 | -0.53 | 추정 | (추정) |
