...
is_reasoning: false
radar:
  knowledge: { s: 10.1, z: -1.47, r: 27.9, estimated: false }  # 전문 지식
  reasoning: { s: 5.1, z: -1.51, r: 27.4, estimated: false }  # 추론
...
Mistral · Open · Unknown · 컨텍스트 8k · 종합지능 **2.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.25 · 출력 $0.25 · 혼합 $0.25/1M · 97.0 t/s · TTFT 0.88s · 8k ctx` · 가성비 8.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 27.9 | -1.47 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 18.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 27.4 | -1.51 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 18.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 22.8 | -1.81 | 실측 | [[scicode]] 2.0%×1.0 |
| 에이전트 | 28.8 | -1.41 | 실측 | [[tau2-bench]] 0.0%×1.0 |
