...
radar:
  ...
  reasoning: { s: 5.6, z: -1.47, r: 28.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $0.25 · 혼합 $0.25/1M · 123.0 t/s · TTFT 0.77s · 8k ctx` · 가성비 8.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 28.2 | -1.45 | 실측 | [[aa-omniscience]] 9.0%×1.0, [[gpqa-diamond]] 18.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 28.0 | -1.47 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 18.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 22.1 | -1.86 | 실측 | [[scicode]] 2.0%×1.0 |
