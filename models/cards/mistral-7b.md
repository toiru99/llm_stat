...
is_reasoning: false
radar:
  knowledge: { s: 10.9, z: -1.44, r: 28.4, estimated: false }  # 전문 지식
  reasoning: { s: 5.6, z: -1.46, r: 28.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $0.25 · 혼합 $0.25/1M · 126.0 t/s · TTFT 0.79s · 8k ctx` · 가성비 8.0
...
| 추론 | 28.2 | -1.46 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 18.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
