...
radar:
  ...
  reasoning: { s: 5.6, z: -1.44, r: 28.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $0.25 · 혼합 $0.25/1M · 125.0 t/s · TTFT 0.82s · 8k ctx` · 가성비 8.0
...
| 추론 | 28.4 | -1.44 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 18.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 22.6 | -1.83 | 실측 | [[scicode]] 2.0%×1.0 |
| 에이전트 | 28.7 | -1.42 | 실측 | [[tau2-bench]] 0.0%×1.0 |
