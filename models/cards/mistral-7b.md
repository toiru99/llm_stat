...
is_reasoning: false
radar:
  knowledge: { s: 10.1, z: -1.46, r: 28.1, estimated: false }  # 전문 지식
  reasoning: { s: 5.1, z: -1.47, r: 27.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.25 · 출력 $0.25 · 혼합 $None/1M · 111.0 t/s · TTFT 0.73s · 8k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 28.1 | -1.46 | 실측 | [[aa-omniscience]] 8.0%×1.0, [[gpqa-diamond]] 18.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 27.9 | -1.47 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 18.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 22.7 | -1.82 | 실측 | [[scicode]] 2.0%×1.0 |
| 에이전트 | 28.9 | -1.41 | 실측 | [[tau2-bench]] 0.0%×1.0 |
