...
is_reasoning: true
radar:
  knowledge: { s: 28.3, z: -0.6, r: 41.1, estimated: false }  # 전문 지식
  ...
  trust: { s: 34.5, z: 0.31, r: 54.7, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 41.1 | -0.6 | 실측 | [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
