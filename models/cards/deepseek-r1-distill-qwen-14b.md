...
radar:
  ...
  agentic: { s: 17.5, z: -0.77, r: 38.4, estimated: true }  # 에이전트
  trust: { s: 27.3, z: 0.13, r: 51.9, estimated: true }  # 신뢰성
...
| 추론 | 42.7 | -0.49 | 실측 | [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
