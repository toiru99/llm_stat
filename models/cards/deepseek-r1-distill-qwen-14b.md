...
radar:
  ...
  agentic: { s: 14.3, z: -0.86, r: 37.1, estimated: true }  # 에이전트
  trust: { s: 33.7, z: 0.26, r: 53.9, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 40.9 | -0.61 | 실측 | [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
