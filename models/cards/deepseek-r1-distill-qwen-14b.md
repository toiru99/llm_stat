...
radar:
  ...
  agentic: { s: 18.8, z: -0.72, r: 39.2, estimated: true }  # 에이전트
  trust: { s: 28.0, z: 0.18, r: 52.6, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 40.6 | -0.62 | 실측 | [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 42.8 | -0.48 | 실측 | [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
