...
radar:
  ...
  agentic: { s: 11.6, z: -0.97, r: 35.5, estimated: true }  # 에이전트
  trust: { s: 28.3, z: -0.02, r: 49.7, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 40.8 | -0.62 | 실측 | [[gpqa-diamond]] 48.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 43.1 | -0.46 | 실측 | [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
