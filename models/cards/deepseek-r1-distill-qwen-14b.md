...
is_reasoning: true
radar:
  knowledge: { s: 28.2, z: -0.6, r: 40.9, estimated: false }  # 전문 지식
  reasoning: { s: 25.4, z: -0.47, r: 42.9, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.31, r: 45.4, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -0.98, r: 35.4, estimated: true }  # 에이전트
  trust: { s: 29.9, z: 0.17, r: 52.5, estimated: true }  # 신뢰성
...
| 추론 | 42.9 | -0.47 | 실측 | [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
