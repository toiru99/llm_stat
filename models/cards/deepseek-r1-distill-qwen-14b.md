...
radar:
  ...
  reasoning: { s: 25.1, z: -0.5, r: 42.4, estimated: false }  # 추론
  coding: { s: 40.0, z: -0.34, r: 44.9, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -0.99, r: 35.1, estimated: true }  # 에이전트
  trust: { s: 28.4, z: 0.05, r: 50.7, estimated: true }  # 신뢰성
...
| 추론 | 42.4 | -0.5 | 실측 | [[gpqa-diamond]] 48.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
