...
radar:
  ...
  reasoning: { s: 50.9, z: 0.8, r: 62.0, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 86.0 t/s · TTFT 37.49s · 272k ctx` · 가성비 27.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.5 | +1.1 | 실측 | [[aa-omniscience]] 38.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 28.0%×0.3 |
| 추론 | 62.0 | +0.8 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 87.0%×1.0, [[humanitys-last-exam]] 28.0%×1.0 |
| 코딩 | 63.8 | +0.92 | 실측 | [[scicode]] 43.0%×1.0, [[terminal-bench]] 45.0%×0.5 |
| 에이전트 | 60.0 | +0.67 | 실측 | [[gdpval]] 25.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 16.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
