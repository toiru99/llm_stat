...
radar:
  ...
  agentic: { s: 57.9, z: 0.84, r: 62.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 103.0 t/s · TTFT 48.97s · 272k ctx`
...
| 에이전트 | 62.5 | +0.84 | 실측 | [[gdpval]] 24.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
