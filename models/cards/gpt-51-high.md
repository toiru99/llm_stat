...
radar:
  ...
  agentic: { s: 57.9, z: 0.85, r: 62.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.34/1M · 104.0 t/s · TTFT 43.36s · 272k ctx` · 가성비 27.6
...
| 에이전트 | 62.7 | +0.85 | 실측 | [[gdpval]] 24.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 14.0%×1.0, [[terminal-bench]] 45.0%×1.0 |
