...
radar:
  ...
  agentic: { s: 76.3, z: 1.49, r: 72.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.38 · 출력 $4.4 · 혼합 $0.898/1M · 48.0 t/s · TTFT 1.84s · 200k ctx` · 가성비 31.2
...
| 에이전트 | 72.3 | +1.49 | 실측 | [[tau2-bench]] 97.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
