...
is_reasoning: true
radar:
  knowledge: { s: 88.9, z: 2.42, r: 86.3, estimated: false }  # 전문 지식
  reasoning: { s: 87.3, z: 2.65, r: 89.8, estimated: false }  # 추론
...
## 실용 지표
`입력 $10.0 · 출력 $50.0 · 혼합 $7.175/1M · 60.0 t/s · TTFT 5.75s · 1M ctx` · 가성비 8.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 86.3 | +2.42 | 실측 | [[aa-omniscience]] 60.0%×1.0, [[gpqa-diamond]] 88.0%×0.4, [[humanitys-last-exam]] 49.0%×0.3 |
| 추론 | 89.8 | +2.65 | 실측 | [[critpt]] 28.0%×1.0, [[gpqa-diamond]] 88.0%×1.0, [[humanitys-last-exam]] 49.0%×1.0 |
| 코딩 | 77.7 | +1.85 | 실측 | [[scicode]] 56.0%×1.0 |
| 에이전트 | 73.9 | +1.59 | 실측 | [[gdpval]] 54.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
