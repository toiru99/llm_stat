...
radar:
  ...
  reasoning: { s: 11.8, z: -1.14, r: 32.9, estimated: false }  # 추론
  coding: { s: 19.4, z: -1.16, r: 32.6, estimated: false }  # 코딩
  agentic: { s: 3.6, z: -1.28, r: 30.9, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 32.4 | -1.17 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 35.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 30.9 | -1.28 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
