...
radar:
  ...
  agentic: { s: 3.8, z: -1.28, r: 30.8, estimated: false }  # 에이전트
...
|---|---|---|---|---|
| 전문 지식 | 32.9 | -1.14 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 35.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
...
| 에이전트 | 30.8 | -1.28 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 11.0%×1.0, [[tau3-banking]] 1.0%×1.0, [[terminal-bench]] 1.0%×1.0 |
