...
is_reasoning: true
radar:
  knowledge: { s: 78.8, z: 1.92, r: 78.7, estimated: false }  # 전문 지식
  reasoning: { s: 61.6, z: 1.36, r: 70.4, estimated: false }  # 추론
  coding: { s: 80.6, z: 1.44, r: 71.6, estimated: false }  # 코딩
  agentic: { s: 39.2, z: 0.08, r: 51.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 63.0 t/s · TTFT 0.54s · 256k ctx` · 가성비 75.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 78.7 | +1.92 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 70.4 | +1.36 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 71.6 | +1.44 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 51.2 | +0.08 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
