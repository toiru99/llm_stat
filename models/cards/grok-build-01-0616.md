...
is_reasoning: true
radar:
  knowledge: { s: 78.8, z: 1.88, r: 78.2, estimated: false }  # 전문 지식
  reasoning: { s: 61.6, z: 1.33, r: 69.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 68.0 t/s · TTFT 0.52s · 256k ctx` · 가성비 75.9
...
| 에이전트 | 50.9 | +0.06 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
