...
radar:
  ...
  instruction: { s: 71.5, z: 0.74, r: 61.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 81.0 t/s · TTFT 0.54s · 256k ctx` · 가성비 75.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.1 | +1.94 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 71.3 | +1.42 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 52.2 | +0.15 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
| 신뢰성 | 36.0 | -0.94 | 실측 | [[aa-omniscience]] 7.0%×1.0 |
| 멀티모달 | 62.1 | +0.81 | 실측 | [[mmmu-pro]] 77.0%×1.0 |
| 긴문맥 | 65.9 | +1.06 | 실측 | [[aa-lcr]] 70.0%×1.0 |
| 지시 따르기 | 61.0 | +0.74 | 추정 | (추정) |
