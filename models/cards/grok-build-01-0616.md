...
radar:
  ...
  coding: { s: 55.8, z: 0.83, r: 62.5, estimated: true }  # 코딩
  ...
  instruction: { s: 82.8, z: 1.27, r: 69.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 66.0 t/s · TTFT 0.5s · 256k ctx` · 가성비 59.3
