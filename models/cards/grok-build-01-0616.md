...
is_reasoning: true
radar:
  knowledge: { s: 83.0, z: 2.05, r: 80.7, estimated: false }  # 전문 지식
  reasoning: { s: 63.2, z: 1.54, r: 73.1, estimated: false }  # 추론
  coding: { s: 83.3, z: 1.56, r: 73.4, estimated: false }  # 코딩
  agentic: { s: 45.2, z: 0.34, r: 55.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $None/1M · 79.0 t/s · TTFT 0.54s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 80.7 | +2.05 | 실측 | [[aa-omniscience]] 51.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 73.1 | +1.54 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
| 코딩 | 73.4 | +1.56 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 55.2 | +0.34 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 11.0%×1.0 |
