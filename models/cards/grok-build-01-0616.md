...
is_reasoning: true
radar:
  knowledge: { s: 81.1, z: 1.93, r: 79.0, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 100.0 t/s · TTFT 0.55s · 256k ctx` · 가성비 75.9

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.0 | +1.93 | 실측 | [[aa-omniscience]] 52.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 38.0%×0.3 |
| 추론 | 71.3 | +1.42 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 72.4 | +1.49 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 52.3 | +0.15 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
