...
radar:
  ...
  agentic: { s: 45.2, z: 0.36, r: 55.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 63.0 t/s · TTFT 0.55s · 256k ctx` · 가성비 74.1
...
| 에이전트 | 55.3 | +0.36 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 11.0%×1.0 |
