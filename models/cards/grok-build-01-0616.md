...
is_reasoning: true
radar:
  knowledge: { s: 83.0, z: 2.07, r: 81.0, estimated: false }  # 전문 지식
  reasoning: { s: 63.2, z: 1.57, r: 73.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 69.0 t/s · TTFT 0.55s · 256k ctx` · 가성비 74.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 81.0 | +2.07 | 실측 | [[aa-omniscience]] 51.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 36.0%×0.3 |
| 추론 | 73.5 | +1.57 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 36.0%×1.0 |
