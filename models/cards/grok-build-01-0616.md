...
radar:
  ...
  reasoning: { s: 63.2, z: 1.32, r: 69.9, estimated: false }  # 추론
  ...
  instruction: { s: 71.5, z: 0.7, r: 60.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 56.0 t/s · TTFT 0.52s · 256k ctx` · 가성비 75.9
...
| 추론 | 69.9 | +1.32 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 38.0%×1.0 |
| 코딩 | 71.1 | +1.41 | 실측 | [[scicode]] 50.0%×1.0 |
| 에이전트 | 51.3 | +0.09 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
| 신뢰성 | 35.5 | -0.97 | 실측 | [[aa-omniscience]] 7.0%×1.0 |
| 멀티모달 | 61.5 | +0.77 | 실측 | [[mmmu-pro]] 77.0%×1.0 |
| 긴문맥 | 65.0 | +1.0 | 실측 | [[aa-lcr]] 70.0%×1.0 |
| 지시 따르기 | 60.4 | +0.7 | 추정 | (추정) |
