...
radar:
  ...
  agentic: { s: 39.6, z: 0.12, r: 51.7, estimated: false }  # 에이전트
  ...
  instruction: { s: 71.5, z: 0.71, r: 60.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $1.0 · 출력 $2.0 · 혼합 $0.54/1M · 72.0 t/s · TTFT 0.56s · 256k ctx` · 가성비 75.9
...
| 에이전트 | 51.7 | +0.12 | 실측 | [[gdpval]] 36.0%×1.0, [[tau3-banking]] 13.0%×1.0 |
