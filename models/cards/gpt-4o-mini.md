...
radar:
  ...
  trust: { s: 22.1, z: -0.27, r: 45.9, estimated: true }  # 신뢰성
  multimodal: { s: 39.1, z: -1.56, r: 26.5, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $None/1M · 82.0 t/s · TTFT 0.99s · 128k ctx`
...
| 신뢰성 | 45.9 | -0.27 | 추정 | (추정) |
| 멀티모달 | 26.5 | -1.56 | 실측 | [[mmmu-pro]] 42.0%×1.0 |
| 긴문맥 | 36.5 | -0.9 | 추정 | (추정) |
