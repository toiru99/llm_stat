...
radar:
  ...
  trust: { s: 17.9, z: -0.41, r: 43.8, estimated: true }  # 신뢰성
  multimodal: { s: 38.6, z: -1.62, r: 25.6, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.1425/1M · 102.0 t/s · TTFT 1.03s · 128k ctx` · 가성비 49.1
...
| 신뢰성 | 43.8 | -0.41 | 추정 | (추정) |
| 멀티모달 | 25.6 | -1.62 | 실측 | [[mmmu-pro]] 42.0%×1.0 |
| 긴문맥 | 32.3 | -1.18 | 추정 | (추정) |
