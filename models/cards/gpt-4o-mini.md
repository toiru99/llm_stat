...
radar:
  ...
  trust: { s: 18.8, z: -0.45, r: 43.2, estimated: true }  # 신뢰성
  multimodal: { s: 38.6, z: -1.6, r: 26.0, estimated: false }  # 멀티모달
  long_context: { s: 14.2, z: -1.06, r: 34.2, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.1425/1M · 75.0 t/s · TTFT 1.02s · 128k ctx` · 가성비 49.1
...
| 에이전트 | 30.7 | -1.29 | 실측 | [[gdpval]] 0.0%×1.0, [[tau3-banking]] 3.0%×1.0 |
| 신뢰성 | 43.2 | -0.45 | 추정 | (추정) |
