...
radar:
  ...
  reasoning: { s: 22.5, z: -0.57, r: 41.4, estimated: false }  # 추론
  coding: { s: 38.3, z: -0.32, r: 45.2, estimated: false }  # 코딩
  agentic: { s: 4.5, z: -1.23, r: 31.6, estimated: false }  # 에이전트
  trust: { s: 21.6, z: -0.28, r: 45.7, estimated: true }  # 신뢰성
  multimodal: { s: 39.1, z: -1.54, r: 26.9, estimated: false }  # 멀티모달
  long_context: { s: 18.9, z: -0.87, r: 37.0, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.14/1M · 72.0 t/s · TTFT 1.33s · 128k ctx` · 가성비 50.0
...
| 추론 | 41.4 | -0.57 | 실측 | [[gpqa-diamond]] 43.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 45.2 | -0.32 | 실측 | [[scicode]] 23.0%×1.0 |
| 에이전트 | 31.6 | -1.23 | 실측 | [[gdpval]] 0.0%×1.0, [[tau3-banking]] 3.0%×1.0 |
| 신뢰성 | 45.7 | -0.28 | 추정 | (추정) |
| 멀티모달 | 26.9 | -1.54 | 실측 | [[mmmu-pro]] 42.0%×1.0 |
| 긴문맥 | 37.0 | -0.87 | 추정 | (추정) |
