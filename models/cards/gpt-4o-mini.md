...
radar:
  ...
  agentic: { s: 2.9, z: -1.3, r: 30.4, estimated: false }  # 에이전트
  trust: { s: 15.1, z: -0.51, r: 42.3, estimated: true }  # 신뢰성
  multimodal: { s: 38.6, z: -1.6, r: 26.0, estimated: false }  # 멀티모달
  long_context: { s: 17.9, z: -0.95, r: 35.8, estimated: true }  # 긴문맥
...
## 실용 지표
`입력 $0.15 · 출력 $0.6 · 혼합 $0.1425/1M · 101.0 t/s · TTFT 1.03s · 128k ctx` · 가성비 49.1
...
| 에이전트 | 30.4 | -1.3 | 실측 | [[gdpval]] 0.0%×1.0, [[tau3-banking]] 3.0%×1.0 |
| 신뢰성 | 42.3 | -0.51 | 추정 | (추정) |
