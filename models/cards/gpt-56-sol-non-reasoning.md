...
radar:
  ...
  reasoning: { s: 42.5, z: 0.38, r: 55.6, estimated: false }  # 추론
  coding: { s: 78.3, z: 1.28, r: 69.3, estimated: false }  # 코딩
  agentic: { s: 52.4, z: 0.66, r: 59.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 58.9, z: 0.21, r: 53.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 59.0 t/s · TTFT 1.21s · 1M ctx` · 가성비 9.7
...
| 추론 | 55.6 | +0.38 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 69.3 | +1.28 | 실측 | [[scicode]] 47.0%×1.0 |
| 에이전트 | 59.8 | +0.66 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
