...
radar:
  ...
  coding: { s: 78.3, z: 1.38, r: 70.7, estimated: false }  # 코딩
  ...
  instruction: { s: 62.8, z: 0.44, r: 56.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 72.0 | +1.47 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 57.0 | +0.47 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 70.7 | +1.38 | 실측 | [[scicode]] 47.0%×1.0 |
