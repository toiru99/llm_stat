...
radar:
  ...
  coding: { s: 57.9, z: 0.9, r: 63.4, estimated: true }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 70.0 t/s · TTFT 0.96s · 1M ctx` · 가성비 10.7
...
| 코딩 | 63.4 | +0.9 | 추정 | (추정) |
| 에이전트 | 57.8 | +0.52 | 실측 | [[gdpval]] 40.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
