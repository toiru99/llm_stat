...
is_reasoning: false
radar:
  knowledge: { s: 67.0, z: 1.3, r: 69.5, estimated: false }  # 전문 지식
  reasoning: { s: 41.5, z: 0.33, r: 55.0, estimated: false }  # 추론
  coding: { s: 75.8, z: 1.21, r: 68.1, estimated: false }  # 코딩
  agentic: { s: 51.6, z: 0.55, r: 58.2, estimated: false }  # 에이전트
  ...
  instruction: { s: 60.3, z: 0.31, r: 54.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 67.0 t/s · TTFT 1.1s · 1M ctx` · 가성비 13.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 69.5 | +1.3 | 실측 | [[aa-omniscience]] 49.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 55.0 | +0.33 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
| 코딩 | 68.1 | +1.21 | 실측 | [[scicode]] 47.0%×1.0 |
| 에이전트 | 58.2 | +0.55 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
