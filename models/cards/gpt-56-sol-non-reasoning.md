...
radar:
  ...
  agentic: { s: 52.4, z: 0.62, r: 59.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 59.0 t/s · TTFT 1.38s · 1M ctx` · 가성비 9.7
...
| 에이전트 | 59.3 | +0.62 | 실측 | [[gdpval]] 44.0%×1.0, [[tau3-banking]] 20.0%×1.0 |
