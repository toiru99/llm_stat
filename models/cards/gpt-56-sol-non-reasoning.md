...
is_reasoning: false
radar:
  knowledge: { s: 70.5, z: 1.38, r: 70.6, estimated: false }  # 전문 지식
  reasoning: { s: 42.2, z: 0.39, r: 55.9, estimated: false }  # 추론
  coding: { s: 78.3, z: 1.31, r: 69.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 52.0 t/s · TTFT 0.99s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 70.6 | +1.38 | 실측 | [[aa-omniscience]] 48.0%×1.0, [[gpqa-diamond]] 79.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 55.9 | +0.39 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 79.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 69.6 | +1.31 | 실측 | [[scicode]] 47.0%×1.0 |
