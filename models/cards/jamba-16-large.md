...
is_reasoning: false
radar:
  knowledge: { s: 21.7, z: -0.93, r: 36.0, estimated: false }  # 전문 지식
  reasoning: { s: 19.6, z: -0.75, r: 38.8, estimated: false }  # 추론
  coding: { s: 29.0, z: -0.76, r: 38.6, estimated: false }  # 코딩
  agentic: { s: 11.4, z: -1.01, r: 34.9, estimated: true }  # 에이전트
  trust: { s: 29.4, z: 0.23, r: 53.4, estimated: true }  # 신뢰성
...
| 추론 | 38.8 | -0.75 | 실측 | [[gpqa-diamond]] 39.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
