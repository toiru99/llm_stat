...
is_reasoning: false
radar:
  knowledge: { s: 21.9, z: -0.93, r: 36.1, estimated: false }  # 전문 지식
  reasoning: { s: 19.8, z: -0.78, r: 38.4, estimated: false }  # 추론
  coding: { s: 30.0, z: -0.77, r: 38.5, estimated: false }  # 코딩
  agentic: { s: 7.0, z: -1.16, r: 32.5, estimated: true }  # 에이전트
  trust: { s: 35.5, z: 0.28, r: 54.2, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 12.1, z: -1.16, r: 32.5, estimated: true }  # 긴문맥
  instruction: { s: 31.0, z: -0.95, r: 35.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
| 추론 | 38.4 | -0.78 | 실측 | [[gpqa-diamond]] 39.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
