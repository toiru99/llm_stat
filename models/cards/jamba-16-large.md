...
radar:
  ...
  trust: { s: 35.5, z: 0.32, r: 54.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 12.1, z: -1.16, r: 32.6, estimated: true }  # 긴문맥
  instruction: { s: 30.7, z: -0.96, r: 35.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
