...
is_reasoning: false
radar:
  knowledge: { s: 22.1, z: -0.9, r: 36.5, estimated: false }  # 전문 지식
  reasoning: { s: 20.0, z: -0.74, r: 38.9, estimated: false }  # 추론
  coding: { s: 30.0, z: -0.72, r: 39.2, estimated: false }  # 코딩
  agentic: { s: 8.5, z: -1.09, r: 33.6, estimated: true }  # 에이전트
  trust: { s: 26.0, z: -0.01, r: 49.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 26.0, z: -0.71, r: 39.3, estimated: true }  # 긴문맥
  instruction: { s: 32.7, z: -0.86, r: 37.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $2.6/1M · 56.0 t/s · TTFT 1.45s · 256k ctx` · 가성비 1.9
