...
radar:
  ...
  long_context: { s: 23.1, z: -0.79, r: 38.1, estimated: true }  # 긴문맥
  instruction: { s: 33.8, z: -0.82, r: 37.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $8.0 · 혼합 $2.6/1M · 56.0 t/s · TTFT 1.35s · 256k ctx` · 가성비 1.9
...
| 추론 | 39.0 | -0.73 | 실측 | [[gpqa-diamond]] 39.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.2 | -0.72 | 실측 | [[scicode]] 18.0%×1.0 |
| 에이전트 | 33.5 | -1.1 | 추정 | (추정) |
| 신뢰성 | 49.8 | -0.01 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 38.1 | -0.79 | 추정 | (추정) |
| 지시 따르기 | 37.8 | -0.82 | 추정 | (추정) |
