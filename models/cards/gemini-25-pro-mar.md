...
is_reasoning: true
radar:
  knowledge: { s: 63.5, z: 1.12, r: 66.8, estimated: false }  # 전문 지식
  reasoning: { s: 59.4, z: 1.37, r: 70.6, estimated: false }  # 추론
  ...
  long_context: { s: 84.8, z: 1.08, r: 66.2, estimated: true }  # 긴문맥
...
|---|---|---|---|---|
| 전문 지식 | 66.8 | +1.12 | 실측 | [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 70.6 | +1.37 | 실측 | [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
