...
radar:
  ...
  agentic: { s: 52.0, z: 0.6, r: 59.0, estimated: true }  # 에이전트
  trust: { s: 40.9, z: 0.58, r: 58.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 85.7, z: 1.07, r: 66.0, estimated: true }  # 긴문맥
  instruction: { s: 76.8, z: 0.98, r: 64.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
