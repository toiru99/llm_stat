...
radar:
  ...
  agentic: { s: 59.7, z: 0.91, r: 63.6, estimated: true }  # 에이전트
  trust: { s: 34.1, z: 0.32, r: 54.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 78.0, z: 0.86, r: 62.9, estimated: true }  # 긴문맥
  instruction: { s: 76.8, z: 0.99, r: 64.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
