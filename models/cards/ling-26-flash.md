...
radar:
  ...
  coding: { s: 40.6, z: -0.23, r: 46.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.06/1M · 166.0 t/s · TTFT 1.23s · 262k ctx` · 가성비 233.3
...
| 코딩 | 46.6 | -0.23 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
