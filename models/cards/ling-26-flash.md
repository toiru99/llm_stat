...
is_reasoning: false
radar:
  knowledge: { s: 29.1, z: -0.54, r: 41.8, estimated: false }  # 전문 지식
  reasoning: { s: 22.6, z: -0.57, r: 41.4, estimated: false }  # 추론
  coding: { s: 40.6, z: -0.23, r: 46.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.06/1M · 174.0 t/s · TTFT 1.17s · 262k ctx` · 가성비 233.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.8 | -0.54 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 41.4 | -0.57 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 46.5 | -0.23 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
