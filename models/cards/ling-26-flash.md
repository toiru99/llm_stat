...
radar:
  ...
  coding: { s: 40.6, z: -0.24, r: 46.5, estimated: false }  # 코딩
  agentic: { s: 32.7, z: -0.13, r: 48.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $0.06/1M · 175.0 t/s · TTFT 1.18s · 262k ctx` · 가성비 233.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.8 | -0.55 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 59.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 41.3 | -0.58 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 59.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 46.5 | -0.24 | 실측 | [[scicode]] 27.0%×1.0, [[terminal-bench]] 21.0%×0.5 |
| 에이전트 | 48.0 | -0.13 | 실측 | [[gdpval]] 2.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
