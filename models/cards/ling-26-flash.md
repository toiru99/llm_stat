...
radar:
  ...
  agentic: { s: 33.2, z: -0.12, r: 48.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 123.0 t/s · TTFT 1.15s · 262k ctx`
...
| 에이전트 | 48.2 | -0.12 | 실측 | [[gdpval]] 3.0%×1.0, [[tau2-bench]] 86.0%×1.0, [[tau3-banking]] 3.0%×1.0, [[terminal-bench]] 21.0%×1.0 |
