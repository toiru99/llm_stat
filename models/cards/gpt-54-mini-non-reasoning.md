...
radar:
  ...
  coding: { s: 53.5, z: 0.25, r: 53.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.75 · 출력 $4.5 · 혼합 $0.6525/1M · 145.0 t/s · TTFT 0.87s · 400k ctx` · 가성비 26.1
...
| 코딩 | 53.7 | +0.25 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 18.0%×0.5 |
