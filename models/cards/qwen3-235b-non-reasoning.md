...
is_reasoning: false
radar:
  knowledge: { s: 31.7, z: -0.43, r: 43.6, estimated: false }  # 전문 지식
  reasoning: { s: 21.7, z: -0.64, r: 40.4, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.7 · 출력 $2.8 · 혼합 $0.91/1M · 64.0 t/s · TTFT 2.69s · 32k ctx` · 가성비 12.1

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 43.6 | -0.43 | 실측 | [[aa-omniscience]] 19.0%×1.0, [[gpqa-diamond]] 61.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 40.4 | -0.64 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 61.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
