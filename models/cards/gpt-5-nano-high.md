...
radar:
  ...
  coding: { s: 47.2, z: 0.0, r: 50.1, estimated: false }  # 코딩
  agentic: { s: 27.8, z: -0.34, r: 44.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.05 · 출력 $0.4 · 혼합 $0.0535/1M · 148.0 t/s · TTFT 115.91s · 400k ctx` · 가성비 373.8
...
| 추론 | 44.7 | -0.35 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 68.0%×1.0, [[humanitys-last-exam]] 8.0%×1.0 |
| 코딩 | 50.1 | +0.0 | 실측 | [[scicode]] 37.0%×1.0, [[terminal-bench]] 12.0%×0.5 |
| 에이전트 | 44.9 | -0.34 | 실측 | [[tau2-bench]] 37.0%×1.0, [[terminal-bench]] 12.0%×1.0 |
