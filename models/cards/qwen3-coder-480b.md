...
radar:
  ...
  coding: { s: 49.6, z: 0.11, r: 51.6, estimated: false }  # 코딩
  agentic: { s: 36.6, z: 0.01, r: 50.1, estimated: false }  # 에이전트
  trust: { s: 64.4, z: 1.71, r: 75.7, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $None/1M · 64.0 t/s · TTFT 2.87s · 262k ctx`
...
| 코딩 | 51.6 | +0.11 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
| 에이전트 | 50.1 | +0.01 | 실측 | [[tau2-bench]] 44.0%×1.0, [[terminal-bench]] 19.0%×1.0 |
| 신뢰성 | 75.7 | +1.71 | 실측 | [[aa-omniscience]] 57.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
