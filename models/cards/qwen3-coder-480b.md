...
radar:
  ...
  reasoning: { s: 22.6, z: -0.59, r: 41.1, estimated: false }  # 추론
  coding: { s: 49.6, z: 0.11, r: 51.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $7.5 · 혼합 $None/1M · 62.0 t/s · TTFT 3.01s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.6 | -0.56 | 실측 | [[aa-omniscience]] 15.0%×1.0, [[gpqa-diamond]] 62.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 41.1 | -0.59 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 62.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 51.7 | +0.11 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 19.0%×0.5 |
