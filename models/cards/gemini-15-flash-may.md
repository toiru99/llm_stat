...
radar:
  ...
  agentic: { s: 13.6, z: -0.88, r: 36.8, estimated: true }  # 에이전트
  trust: { s: 41.8, z: 0.66, r: 59.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 15.0, z: -0.99, r: 35.1, estimated: true }  # 긴문맥
  instruction: { s: 27.1, z: -1.04, r: 34.5, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
