...
radar:
  ...
  agentic: { s: 13.6, z: -0.87, r: 36.9, estimated: true }  # 에이전트
  trust: { s: 41.8, z: 0.67, r: 60.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 14.8, z: -0.99, r: 35.2, estimated: true }  # 긴문맥
  instruction: { s: 27.3, z: -1.03, r: 34.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
