...
radar:
  ...
  agentic: { s: 14.2, z: -0.86, r: 37.1, estimated: true }  # 에이전트
  trust: { s: 54.3, z: 1.17, r: 67.5, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 27.2, z: -0.67, r: 39.9, estimated: true }  # 긴문맥
  instruction: { s: 33.9, z: -0.8, r: 38.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
