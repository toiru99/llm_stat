...
radar:
  ...
  coding: { s: 22.9, z: -1.03, r: 34.5, estimated: false }  # 코딩
  agentic: { s: 6.1, z: -1.21, r: 31.9, estimated: false }  # 에이전트
...
| 에이전트 | 31.9 | -1.21 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
