...
radar:
  ...
  coding: { s: 22.9, z: -1.02, r: 34.8, estimated: false }  # 코딩
  agentic: { s: 6.1, z: -1.19, r: 32.1, estimated: false }  # 에이전트
...
| 코딩 | 34.8 | -1.02 | 실측 | [[scicode]] 17.0%×1.0, [[terminal-bench]] 8.0%×0.5 |
| 에이전트 | 32.1 | -1.19 | 실측 | [[tau2-bench]] 0.0%×1.0, [[terminal-bench]] 8.0%×1.0 |
