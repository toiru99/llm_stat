...
radar:
  ...
  agentic: { s: 51.8, z: 0.63, r: 59.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 157.0 t/s · TTFT 3.77s · 400k ctx` · 가성비 173.2
...
| 에이전트 | 59.4 | +0.63 | 실측 | [[tau2-bench]] 53.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
