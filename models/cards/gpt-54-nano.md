...
is_reasoning: true
radar:
  knowledge: { s: 43.1, z: 0.12, r: 51.8, estimated: false }  # 전문 지식
  reasoning: { s: 40.3, z: 0.3, r: 54.5, estimated: false }  # 추론
  coding: { s: 58.9, z: 0.47, r: 57.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 171.0 t/s · TTFT 5.21s · 400k ctx` · 가성비 173.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.8 | +0.12 | 실측 | [[aa-omniscience]] 22.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 16.0%×0.3 |
| 추론 | 54.5 | +0.3 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 57.1 | +0.47 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 58.8 | +0.59 | 실측 | [[tau2-bench]] 53.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
