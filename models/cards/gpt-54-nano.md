...
radar:
  ...
  reasoning: { s: 40.4, z: 0.35, r: 55.2, estimated: false }  # 추론
  coding: { s: 58.9, z: 0.53, r: 57.9, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $None/1M · 164.0 t/s · TTFT 4.98s · 400k ctx`
...
| 추론 | 55.2 | +0.35 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
| 코딩 | 57.9 | +0.53 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
