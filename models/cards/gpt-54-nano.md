...
radar:
  ...
  reasoning: { s: 39.7, z: 0.26, r: 54.0, estimated: false }  # 추론
  coding: { s: 57.5, z: 0.46, r: 56.9, estimated: false }  # 코딩
  agentic: { s: 51.8, z: 0.57, r: 58.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 185.0 t/s · TTFT 3.73s · 400k ctx` · 가성비 173.2
...
| 추론 | 54.0 | +0.26 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 56.9 | +0.46 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 58.5 | +0.57 | 실측 | [[tau2-bench]] 53.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
