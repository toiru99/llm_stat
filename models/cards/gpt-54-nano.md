...
radar:
  ...
  reasoning: { s: 39.4, z: 0.21, r: 53.1, estimated: false }  # 추론
  coding: { s: 50.0, z: 0.62, r: 59.3, estimated: false }  # 코딩
  agentic: { s: 51.8, z: 0.55, r: 58.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 165.0 t/s · TTFT 5.09s · 400k ctx` · 가성비 134.1
...
| 추론 | 53.1 | +0.21 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 59.3 | +0.62 | 실측 | [[terminal-bench]] 33.0%×0.5 |
| 에이전트 | 58.2 | +0.55 | 실측 | [[tau2-bench]] 53.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
