...
is_reasoning: false
radar:
  knowledge: { s: 42.8, z: 0.07, r: 51.0, estimated: false }  # 전문 지식
  reasoning: { s: 40.4, z: 0.28, r: 54.2, estimated: false }  # 추론
  ...
  long_context: { s: 75.0, z: 0.75, r: 61.2, estimated: false }  # 긴문맥
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 167.0 t/s · TTFT 5.86s · 400k ctx` · 가성비 167.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 51.0 | +0.07 | 실측 | [[aa-omniscience]] 21.0%×1.0, [[gpqa-diamond]] 76.0%×0.4, [[humanitys-last-exam]] 15.0%×0.3 |
| 추론 | 54.2 | +0.28 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 15.0%×1.0 |
...
| 긴문맥 | 61.2 | +0.75 | 실측 | [[aa-lcr]] 57.0%×1.0 |
