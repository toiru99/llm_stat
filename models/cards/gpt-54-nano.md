...
radar:
  ...
  agentic: { s: 53.0, z: 0.04, r: 50.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.18/1M · 163.0 t/s · TTFT 4.33s · 400k ctx` · 가성비 166.7
...
| 에이전트 | 50.7 | +0.04 | 실측 | [[tau2-bench]] 53.0%×1.0, [[terminal-bench]] 33.0%×1.0 |
