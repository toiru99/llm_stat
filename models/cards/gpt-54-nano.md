...
radar:
  ...
  coding: { s: 58.9, z: 0.43, r: 56.5, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $1.25 · 혼합 $0.179/1M · 177.0 t/s · TTFT 4.32s · 400k ctx` · 가성비 173.2
...
| 추론 | 53.6 | +0.24 | 실측 | [[critpt]] 5.0%×1.0, [[gpqa-diamond]] 76.0%×1.0, [[humanitys-last-exam]] 16.0%×1.0 |
| 코딩 | 56.5 | +0.43 | 실측 | [[scicode]] 38.0%×1.0, [[terminal-bench]] 33.0%×0.5 |
