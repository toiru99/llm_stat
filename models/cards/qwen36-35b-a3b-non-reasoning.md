...
is_reasoning: false
radar:
  knowledge: { s: 39.6, z: -0.06, r: 49.2, estimated: false }  # 전문 지식
  reasoning: { s: 36.3, z: 0.09, r: 51.3, estimated: false }  # 추론
  coding: { s: 14.2, z: -1.39, r: 29.1, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.38 · 출력 $2.25 · 혼합 $0.5625/1M · 135.0 t/s · TTFT 2.02s · 262k ctx` · 가성비 44.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 49.2 | -0.06 | 실측 | [[aa-omniscience]] 17.0%×1.0, [[gpqa-diamond]] 82.0%×0.4, [[humanitys-last-exam]] 14.0%×0.3 |
| 추론 | 51.3 | +0.09 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 82.0%×1.0, [[humanitys-last-exam]] 14.0%×1.0 |
| 코딩 | 29.1 | -1.39 | 실측 | [[scicode]] 1.0%×1.0, [[terminal-bench]] 26.0%×0.5 |
| 에이전트 | 54.0 | +0.27 | 실측 | [[gdpval]] 26.0%×1.0, [[tau2-bench]] 85.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 26.0%×1.0 |
