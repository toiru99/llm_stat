...
is_reasoning: true
radar:
  knowledge: { s: 47.6, z: 0.3, r: 54.5, estimated: true }  # 전문 지식
  reasoning: { s: 38.2, z: 0.19, r: 52.8, estimated: true }  # 추론
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $None/1M · 61.0 t/s · TTFT 1.85s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.5 | +0.3 | 추정 | (추정) |
| 추론 | 52.8 | +0.19 | 추정 | (추정) |
| 코딩 | 57.6 | +0.51 | 추정 | (추정) |
| 에이전트 | 59.7 | +0.64 | 실측 | [[gdpval]] 36.0%×1.0 |
| 신뢰성 | 59.4 | +0.63 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 59.3 | +0.62 | 추정 | (추정) |
