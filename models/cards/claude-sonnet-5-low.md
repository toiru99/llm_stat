...
is_reasoning: true
radar:
  knowledge: { s: 54.3, z: 0.68, r: 60.1, estimated: true }  # 전문 지식
  reasoning: { s: 45.4, z: 0.63, r: 59.5, estimated: true }  # 추론
  coding: { s: 63.6, z: 0.74, r: 61.2, estimated: true }  # 코딩
  agentic: { s: 57.1, z: 0.82, r: 62.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 58.0 t/s · TTFT 1.44s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 60.1 | +0.68 | 추정 | (추정) |
| 추론 | 59.5 | +0.63 | 추정 | (추정) |
| 코딩 | 61.2 | +0.74 | 추정 | (추정) |
| 에이전트 | 62.2 | +0.82 | 실측 | [[gdpval]] 36.0%×1.0 |
| 신뢰성 | 49.4 | -0.04 | 추정 | (추정) |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 63.4 | +0.89 | 추정 | (추정) |
