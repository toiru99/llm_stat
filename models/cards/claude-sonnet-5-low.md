...
radar:
  ...
  trust: { s: 35.8, z: 0.39, r: 55.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 75.7, z: 0.77, r: 61.5, estimated: true }  # 긴문맥
  instruction: { s: 69.0, z: 0.6, r: 59.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $2.0 · 출력 $10.0 · 혼합 $1.54/1M · 64.0 t/s · TTFT 2.74s · 1M ctx`
