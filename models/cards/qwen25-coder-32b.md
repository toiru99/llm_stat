...
radar:
  ...
  trust: { s: 25.0, z: -0.14, r: 47.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.7, z: -0.88, r: 36.7, estimated: true }  # 긴문맥
  instruction: { s: 26.9, z: -1.05, r: 34.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
