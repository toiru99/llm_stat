...
radar:
  ...
  agentic: { s: 23.2, z: -0.54, r: 41.9, estimated: true }  # 에이전트
  trust: { s: 22.5, z: -0.24, r: 46.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 28.0, z: -0.69, r: 39.7, estimated: true }  # 긴문맥
  instruction: { s: 34.5, z: -0.81, r: 37.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
