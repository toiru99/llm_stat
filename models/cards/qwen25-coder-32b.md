...
radar:
  ...
  agentic: { s: 27.4, z: -0.33, r: 45.0, estimated: true }  # 에이전트
  trust: { s: 17.2, z: -0.53, r: 42.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.5, z: -0.75, r: 38.7, estimated: true }  # 긴문맥
  instruction: { s: 33.6, z: -0.81, r: 37.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 37.9 | -0.81 | 실측 | [[gpqa-diamond]] 42.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
