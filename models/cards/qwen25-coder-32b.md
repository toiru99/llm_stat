...
radar:
  ...
  agentic: { s: 28.1, z: -0.32, r: 45.3, estimated: true }  # 에이전트
  trust: { s: 17.2, z: -0.49, r: 42.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 24.5, z: -0.73, r: 39.1, estimated: true }  # 긴문맥
