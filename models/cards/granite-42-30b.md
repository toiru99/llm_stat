...
## 실용 지표
`입력 $0.16 · 출력 $0.65 · 혼합 $0.125/1M · 75.0 t/s · TTFT 0.81s · 131k ctx` · 가성비 192.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.9 | -0.67 | 실측 | [[aa-omniscience]] 10.0%×1.0, [[gpqa-diamond]] 64.0%×0.4, [[humanitys-last-exam]] 11.0%×0.3 |
| 추론 | 44.3 | -0.38 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 58.2 | +0.55 | 실측 | [[scicode]] 37.0%×1.0 |
| 에이전트 | 42.3 | -0.51 | 실측 | [[gdpval]] 14.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
