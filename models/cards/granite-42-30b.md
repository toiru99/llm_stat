...
radar:
  ...
  coding: { s: 49.0, z: 0.59, r: 58.8, estimated: false }  # 코딩
  agentic: { s: 22.2, z: -0.59, r: 41.2, estimated: false }  # 에이전트
  trust: { s: 74.2, z: 2.35, r: 85.2, estimated: false }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 55.1, z: 0.18, r: 52.8, estimated: false }  # 긴문맥
  instruction: { s: 43.1, z: -0.4, r: 44.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.16 · 출력 $0.65 · 혼합 $0.125/1M · 72.0 t/s · TTFT 1.02s · 131k ctx` · 가성비 136.0
...
| 추론 | 44.0 | -0.4 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 64.0%×1.0, [[humanitys-last-exam]] 11.0%×1.0 |
| 코딩 | 58.8 | +0.59 | 실측 | [[scicode]] 38.0%×1.0 |
| 에이전트 | 41.2 | -0.59 | 실측 | [[gdpval]] 11.0%×1.0, [[tau3-banking]] 14.0%×1.0 |
| 신뢰성 | 85.2 | +2.35 | 실측 | [[aa-omniscience]] 74.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
| 긴문맥 | 52.8 | +0.18 | 실측 | [[aa-lcr]] 49.0%×1.0 |
