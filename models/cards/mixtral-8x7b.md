...
is_reasoning: false
radar:
  knowledge: { s: 15.9, z: -1.2, r: 31.9, estimated: false }  # 전문 지식
  ...
  trust: { s: 19.1, z: -0.36, r: 44.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 3.2, z: -1.43, r: 28.5, estimated: true }  # 긴문맥
  instruction: { s: 24.3, z: -1.22, r: 31.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 31.9 | -1.2 | 실측 | [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
