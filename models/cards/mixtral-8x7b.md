...
radar:
  ...
  trust: { s: 19.1, z: -0.35, r: 44.7, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 3.2, z: -1.43, r: 28.6, estimated: true }  # 긴문맥
  instruction: { s: 24.3, z: -1.22, r: 31.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
