...
is_reasoning: false
radar:
  knowledge: { s: 15.7, z: -1.22, r: 31.6, estimated: false }  # 전문 지식
  reasoning: { s: 14.6, z: -0.99, r: 35.1, estimated: false }  # 추론
  coding: { s: 4.8, z: -1.77, r: 23.4, estimated: false }  # 코딩
  agentic: { s: 11.7, z: -0.99, r: 35.1, estimated: true }  # 에이전트
  trust: { s: 8.7, z: -0.75, r: 38.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 0.2, z: -1.52, r: 27.2, estimated: true }  # 긴문맥
  instruction: { s: 26.2, z: -1.11, r: 33.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 31.6 | -1.22 | 실측 | [[gpqa-diamond]] 29.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
