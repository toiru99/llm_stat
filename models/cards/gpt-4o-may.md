...
radar:
  ...
  agentic: { s: 36.8, z: 0.0, r: 50.1, estimated: true }  # 에이전트
  trust: { s: 45.1, z: 0.8, r: 62.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 37.3, z: -0.39, r: 44.1, estimated: true }  # 긴문맥
  instruction: { s: 57.7, z: 0.14, r: 52.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $6/1M · 81.0 t/s · TTFT 1.03s · 128k ctx` · 가성비 1.3
