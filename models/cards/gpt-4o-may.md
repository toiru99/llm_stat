...
radar:
  ...
  reasoning: { s: 26.2, z: -0.45, r: 43.2, estimated: false }  # 추론
  coding: { s: 51.7, z: 0.14, r: 52.0, estimated: false }  # 코딩
  agentic: { s: 36.8, z: -0.0, r: 50.0, estimated: true }  # 에이전트
  trust: { s: 45.1, z: 0.78, r: 61.8, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $6/1M · 92.0 t/s · TTFT 1.24s · 128k ctx` · 가성비 1.3
...
| 추론 | 43.2 | -0.45 | 실측 | [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 2.0%×1.0 |
