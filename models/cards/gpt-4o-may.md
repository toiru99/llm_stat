...
radar:
  ...
  coding: { s: 13.3, z: -0.66, r: 40.1, estimated: true }  # 코딩
  ...
  instruction: { s: 51.3, z: -0.06, r: 49.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $6/1M · 116.0 t/s · TTFT 1.16s · 128k ctx` · 가성비 0.5
