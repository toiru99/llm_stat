...
radar:
  ...
  trust: { s: 38.6, z: 0.5, r: 57.4, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $None/1M · 81.0 t/s · TTFT 1.08s · 128k ctx`
...
| 추론 | 44.8 | -0.35 | 실측 | [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 3.0%×1.0 |
