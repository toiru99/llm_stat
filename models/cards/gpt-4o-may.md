...
radar:
  ...
  long_context: { s: 31.8, z: -0.5, r: 42.5, estimated: true }  # 긴문맥
  instruction: { s: 46.5, z: -0.25, r: 46.2, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $None/1M · 92.0 t/s · TTFT 1.1s · 128k ctx`
