...
radar:
  ...
  agentic: { s: 40.8, z: 0.2, r: 53.1, estimated: true }  # 에이전트
  trust: { s: 45.1, z: 0.86, r: 62.9, estimated: true }  # 신뢰성
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $6/1M · 70.0 t/s · TTFT 1.38s · 128k ctx` · 가성비 1.3
