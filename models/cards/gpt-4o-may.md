...
radar:
  ...
  trust: { s: 38.6, z: 0.48, r: 57.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 31.8, z: -0.52, r: 42.1, estimated: true }  # 긴문맥
  instruction: { s: 44.8, z: -0.34, r: 44.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $15.0 · 혼합 $6/1M · 103.0 t/s · TTFT 1.21s · 128k ctx` · 가성비 1.5
