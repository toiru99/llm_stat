...
radar:
  ...
  agentic: { s: 12.6, z: -0.93, r: 36.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $1.045/1M · 233.0 t/s · TTFT 21.74s · 200k ctx` · 가성비 15.3
...
| 에이전트 | 36.0 | -0.93 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
