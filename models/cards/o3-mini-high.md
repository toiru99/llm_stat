...
radar:
  ...
  coding: { s: 46.0, z: -0.03, r: 49.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.1 · 출력 $4.4 · 혼합 $1.045/1M · 243.0 t/s · TTFT 17.96s · 200k ctx` · 가성비 15.3
...
| 에이전트 | 35.6 | -0.96 | 실측 | [[gdpval]] 0.0%×1.0, [[tau2-bench]] 31.0%×1.0, [[tau3-banking]] 5.0%×1.0, [[terminal-bench]] 6.0%×1.0 |
