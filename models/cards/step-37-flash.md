...
is_reasoning: true
radar:
  knowledge: { s: 49.9, z: 0.44, r: 56.7, estimated: false }  # 전문 지식
  reasoning: { s: 42.4, z: 0.46, r: 56.8, estimated: false }  # 추론
  coding: { s: 62.6, z: 0.68, r: 60.2, estimated: false }  # 코딩
  agentic: { s: 52.2, z: 0.62, r: 59.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $None/1M · 396.0 t/s · TTFT 0.83s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.7 | +0.44 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 56.8 | +0.46 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 60.2 | +0.68 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 59.2 | +0.62 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 26.0%×1.0, [[itbench]] 30.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 11.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
