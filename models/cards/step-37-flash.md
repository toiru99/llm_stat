...
is_reasoning: true
radar:
  knowledge: { s: 49.9, z: 0.4, r: 56.0, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $None/1M · 408.0 t/s · TTFT 0.91s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.0 | +0.4 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
