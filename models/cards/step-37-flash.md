...
radar:
  ...
  coding: { s: 62.6, z: 0.63, r: 59.4, estimated: false }  # 코딩
  agentic: { s: 50.1, z: 0.52, r: 57.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $0.183/1M · 88.0 t/s · TTFT 2.71s · 262k ctx` · 가성비 169.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.7 | +0.45 | 실측 | [[aa-omniscience]] 26.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 55.9 | +0.39 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 59.4 | +0.63 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
