...
radar:
  ...
  coding: { s: 62.6, z: 0.7, r: 60.5, estimated: false }  # 코딩
  agentic: { s: 52.1, z: 0.62, r: 59.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $0.18/1M · 384.0 t/s · TTFT 0.91s · 262k ctx` · 가성비 166.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 56.9 | +0.46 | 실측 | [[aa-omniscience]] 25.0%×1.0, [[gpqa-diamond]] 81.0%×0.4, [[humanitys-last-exam]] 20.0%×0.3 |
| 추론 | 57.1 | +0.47 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 20.0%×1.0 |
| 코딩 | 60.5 | +0.7 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
