...
radar:
  ...
  coding: { s: 59.0, z: 0.94, r: 64.0, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $0.183/1M · 84.0 t/s · TTFT 3.0s · 262k ctx` · 가성비 125.7
...
| 코딩 | 64.0 | +0.94 | 실측 | [[scicode]] 44.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
