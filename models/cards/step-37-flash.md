...
radar:
  ...
  reasoning: { s: 42.3, z: 0.31, r: 54.7, estimated: false }  # 추론
  coding: { s: 62.6, z: 0.56, r: 58.4, estimated: false }  # 코딩
  agentic: { s: 50.0, z: 0.49, r: 57.3, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $0.183/1M · 88.0 t/s · TTFT 2.86s · 262k ctx` · 가성비 169.4
...
| 추론 | 54.7 | +0.31 | 실측 | [[critpt]] 2.0%×1.0, [[gpqa-diamond]] 81.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 58.4 | +0.56 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 57.3 | +0.49 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 26.0%×1.0, [[itbench]] 30.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
