...
radar:
  ...
  agentic: { s: 50.0, z: 0.49, r: 57.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $1.15 · 혼합 $0.183/1M · 92.0 t/s · TTFT 2.84s · 262k ctx` · 가성비 169.4
...
| 에이전트 | 57.4 | +0.49 | 실측 | [[apex-agents]] 15.0%×1.0, [[gdpval]] 26.0%×1.0, [[itbench]] 30.0%×1.0, [[tau2-bench]] 99.0%×1.0, [[tau3-banking]] 12.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
