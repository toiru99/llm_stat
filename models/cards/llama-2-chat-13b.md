...
radar:
  ...
  agentic: { s: 11.5, z: -0.97, r: 35.5, estimated: true }  # 에이전트
  trust: { s: 24.3, z: -0.2, r: 47.0, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 9.9, z: -1.18, r: 32.3, estimated: true }  # 긴문맥
  instruction: { s: 25.8, z: -1.13, r: 33.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
