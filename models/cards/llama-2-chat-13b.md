...
radar:
  ...
  agentic: { s: 11.0, z: -1.02, r: 34.7, estimated: true }  # 에이전트
  trust: { s: 12.8, z: -0.55, r: 41.8, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.4, z: -0.96, r: 35.6, estimated: true }  # 긴문맥
  instruction: { s: 41.5, z: -0.47, r: 42.9, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
