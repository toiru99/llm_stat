...
radar:
  ...
  trust: { s: 12.8, z: -0.56, r: 41.6, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.4, z: -0.97, r: 35.5, estimated: true }  # 긴문맥
  instruction: { s: 41.5, z: -0.48, r: 42.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
