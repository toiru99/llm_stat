...
is_reasoning: false
radar:
  knowledge: { s: 18.3, z: -1.08, r: 33.9, estimated: false }  # 전문 지식
  reasoning: { s: 16.9, z: -0.88, r: 36.8, estimated: false }  # 추론
  coding: { s: 20.0, z: -1.11, r: 33.4, estimated: false }  # 코딩
  agentic: { s: 12.1, z: -0.94, r: 35.9, estimated: true }  # 에이전트
  trust: { s: 23.7, z: -0.19, r: 47.1, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 11.5, z: -1.1, r: 33.6, estimated: true }  # 긴문맥
  instruction: { s: 25.2, z: -1.12, r: 33.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 33.9 | -1.08 | 실측 | [[gpqa-diamond]] 32.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
