...
is_reasoning: true
radar:
  knowledge: { s: 83.5, z: 2.15, r: 82.2, estimated: false }  # 전문 지식
  reasoning: { s: 63.6, z: 1.46, r: 71.9, estimated: false }  # 추론
  coding: { s: 81.4, z: 1.47, r: 72.1, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 82.2 | +2.15 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 71.9 | +1.46 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 72.1 | +1.47 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 72.6 | +1.51 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
