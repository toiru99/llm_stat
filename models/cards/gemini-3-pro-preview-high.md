...
radar:
  ...
  reasoning: { s: 65.2, z: 1.42, r: 71.3, estimated: false }  # 추론
  coding: { s: 83.4, z: 1.41, r: 71.2, estimated: false }  # 코딩
  agentic: { s: 75.8, z: 1.47, r: 72.1, estimated: false }  # 에이전트
...
| 코딩 | 71.2 | +1.41 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 72.1 | +1.47 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
