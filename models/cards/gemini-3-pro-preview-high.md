...
is_reasoning: true
radar:
  knowledge: { s: 88.8, z: 2.23, r: 83.5, estimated: false }  # 전문 지식
  reasoning: { s: 64.6, z: 1.49, r: 72.4, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 83.5 | +2.23 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 72.4 | +1.49 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 72.4 | +1.5 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 74.0 | +1.6 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
