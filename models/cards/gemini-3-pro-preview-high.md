...
is_reasoning: true
radar:
  knowledge: { s: 85.8, z: 2.24, r: 83.6, estimated: false }  # 전문 지식
  reasoning: { s: 65.2, z: 1.55, r: 73.3, estimated: false }  # 추론
...
|---|---|---|---|---|
| 전문 지식 | 83.6 | +2.24 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 91.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 73.3 | +1.55 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
