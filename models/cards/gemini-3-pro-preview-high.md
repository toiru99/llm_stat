...
is_reasoning: true
radar:
  knowledge: { s: 85.7, z: 2.11, r: 81.6, estimated: false }  # 전문 지식
  reasoning: { s: 65.2, z: 1.43, r: 71.4, estimated: false }  # 추론
  coding: { s: 83.4, z: 1.42, r: 71.2, estimated: false }  # 코딩
...
| 추론 | 71.4 | +1.43 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 91.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 71.2 | +1.42 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 42.0%×0.5 |
| 에이전트 | 72.2 | +1.48 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 42.0%×1.0 |
