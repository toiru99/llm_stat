...
is_reasoning: true
radar:
  knowledge: { s: 33.9, z: -0.32, r: 45.3, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.3 · 출력 $0.9 · 혼합 $0.36/1M · 64.0 t/s · TTFT 3.79s · 128k ctx` · 가성비 47.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 45.3 | -0.32 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 72.0%×0.4, [[humanitys-last-exam]] 10.0%×0.3 |
