...
radar:
  ...
  reasoning: { s: 40.2, z: 0.21, r: 53.1, estimated: false }  # 추론
  coding: { s: 68.2, z: 0.79, r: 61.8, estimated: false }  # 코딩
  agentic: { s: 56.0, z: 0.72, r: 60.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 50.0 t/s · TTFT 18.83s · 1M ctx` · 가성비 16.0
...
| 추론 | 53.1 | +0.21 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 61.8 | +0.79 | 실측 | [[scicode]] 45.0%×1.0, [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 60.7 | +0.72 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 25.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
