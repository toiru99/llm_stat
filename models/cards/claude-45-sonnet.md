...
is_reasoning: true
radar:
  knowledge: { s: 54.1, z: 0.64, r: 59.5, estimated: false }  # 전문 지식
  reasoning: { s: 39.1, z: 0.2, r: 52.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 48.0 t/s · TTFT 14.07s · 1M ctx` · 가성비 12.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.5 | +0.64 | 실측 | [[aa-omniscience]] 33.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 18.0%×0.3 |
| 추론 | 52.9 | +0.2 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 18.0%×1.0 |
| 코딩 | 61.7 | +0.78 | 실측 | [[terminal-bench]] 36.0%×0.5 |
| 에이전트 | 60.2 | +0.68 | 실측 | [[gdpval]] 25.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 25.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
