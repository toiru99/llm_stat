...
radar:
  ...
  reasoning: { s: 40.3, z: 0.37, r: 55.5, estimated: false }  # 추론
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 42.0 t/s · TTFT 9.6s · 1M ctx` · 가성비 15.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.7 | +0.78 | 실측 | [[aa-omniscience]] 32.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
| 추론 | 55.5 | +0.37 | 실측 | [[critpt]] 1.0%×1.0, [[gpqa-diamond]] 83.0%×1.0, [[humanitys-last-exam]] 17.0%×1.0 |
