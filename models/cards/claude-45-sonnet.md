...
is_reasoning: true
radar:
  knowledge: { s: 56.3, z: 0.77, r: 61.6, estimated: false }  # 전문 지식
  reasoning: { s: 40.3, z: 0.36, r: 55.4, estimated: false }  # 추론
  coding: { s: 68.2, z: 0.94, r: 64.1, estimated: false }  # 코딩
  agentic: { s: 58.8, z: 0.88, r: 63.2, estimated: false }  # 에이전트
  trust: { s: 61.2, z: 1.56, r: 73.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $2.31/1M · 42.0 t/s · TTFT 14.97s · 1M ctx` · 가성비 15.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 61.6 | +0.77 | 실측 | [[aa-omniscience]] 32.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 17.0%×0.3 |
...
| 신뢰성 | 73.4 | +1.56 | 실측 | [[aa-omniscience]] 53.0%×1.0 |
