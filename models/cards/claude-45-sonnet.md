...
radar:
  ...
  agentic: { s: 59.0, z: 0.88, r: 63.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $3.0 · 출력 $15.0 · 혼합 $None/1M · 43.0 t/s · TTFT 12.28s · 1M ctx`
...
| 에이전트 | 63.2 | +0.88 | 실측 | [[gdpval]] 28.0%×1.0, [[tau2-bench]] 78.0%×1.0, [[tau3-banking]] 19.0%×1.0, [[terminal-bench]] 36.0%×1.0 |
| 신뢰성 | 73.1 | +1.54 | 실측 | [[aa-omniscience]] 53.0%×1.0 |
