...
is_reasoning: true
radar:
  knowledge: { s: 80.3, z: 1.99, r: 79.8, estimated: false }  # 전문 지식
  reasoning: { s: 69.8, z: 1.77, r: 76.6, estimated: false }  # 추론
  coding: { s: 77.7, z: 1.31, r: 69.7, estimated: false }  # 코딩
  agentic: { s: 75.6, z: 1.5, r: 72.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 189.0 t/s · TTFT 13.89s · 1M ctx` · 가성비 39.8

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 79.8 | +1.99 | 실측 | [[aa-omniscience]] 51.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 43.0%×0.3 |
| 추론 | 76.6 | +1.77 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.7 | +1.31 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 72.5 | +1.5 | 실측 | [[apex-agents]] 47.0%×1.0, [[gdpval]] 42.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 32.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
