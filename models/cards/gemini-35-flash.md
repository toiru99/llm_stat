...
radar:
  ...
  reasoning: { s: 71.6, z: 1.75, r: 76.2, estimated: false }  # 추론
  coding: { s: 79.6, z: 1.26, r: 69.0, estimated: false }  # 코딩
  agentic: { s: 75.7, z: 1.49, r: 72.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 207.0 t/s · TTFT 17.02s · 1M ctx` · 가성비 39.8
...
| 추론 | 76.2 | +1.75 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 69.0 | +1.26 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 72.4 | +1.49 | 실측 | [[apex-agents]] 47.0%×1.0, [[gdpval]] 42.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 32.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
