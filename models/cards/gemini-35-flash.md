...
radar:
  ...
  coding: { s: 79.6, z: 1.35, r: 70.3, estimated: false }  # 코딩
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 181.0 t/s · TTFT 17.15s · 1M ctx` · 가성비 38.3
...
| 코딩 | 70.3 | +1.35 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
