...
radar:
  ...
  reasoning: { s: 71.6, z: 1.74, r: 76.1, estimated: false }  # 추론
  coding: { s: 79.6, z: 1.26, r: 68.9, estimated: false }  # 코딩
  agentic: { s: 75.7, z: 1.48, r: 72.2, estimated: false }  # 에이전트
  trust: { s: 41.9, z: 0.55, r: 58.2, estimated: false }  # 신뢰성
  multimodal: { s: 98.6, z: 1.26, r: 68.8, estimated: false }  # 멀티모달
...
## 실용 지표
`입력 $1.5 · 출력 $9.0 · 혼합 $1.305/1M · 201.0 t/s · TTFT 20.29s · 1M ctx` · 가성비 39.8
...
| 추론 | 76.1 | +1.74 | 실측 | [[critpt]] 13.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 43.0%×1.0 |
| 코딩 | 68.9 | +1.26 | 실측 | [[scicode]] 53.0%×1.0, [[terminal-bench]] 41.0%×0.5 |
| 에이전트 | 72.2 | +1.48 | 실측 | [[apex-agents]] 47.0%×1.0, [[gdpval]] 42.0%×1.0, [[itbench]] 40.0%×1.0, [[tau2-bench]] 95.0%×1.0, [[tau3-banking]] 32.0%×1.0, [[terminal-bench]] 41.0%×1.0 |
