...
radar:
  ...
  reasoning: { s: 13.4, z: -1.08, r: 33.8, estimated: false }  # 추론
  coding: { s: 20.0, z: -1.16, r: 32.6, estimated: false }  # 코딩
  agentic: { s: 10.3, z: -1.04, r: 34.5, estimated: true }  # 에이전트
  trust: { s: 40.8, z: 0.6, r: 58.9, estimated: true }  # 신뢰성
...
|---|---|---|---|---|
| 전문 지식 | 30.9 | -1.27 | 실측 | [[gpqa-diamond]] 28.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 33.8 | -1.08 | 실측 | [[gpqa-diamond]] 28.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
