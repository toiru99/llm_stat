...
radar:
  ...
  agentic: { s: 9.4, z: -1.08, r: 33.8, estimated: true }  # 에이전트
  trust: { s: 17.9, z: -0.31, r: 45.4, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 18.9, z: -0.95, r: 35.8, estimated: true }  # 긴문맥
  instruction: { s: 32.6, z: -0.84, r: 37.3, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
|---|---|---|---|---|
| 전문 지식 | 30.6 | -1.29 | 실측 | [[gpqa-diamond]] 28.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
