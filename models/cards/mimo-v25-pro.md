...
radar:
  ...
  coding: { s: 72.1, z: 1.4, r: 71.1, estimated: false }  # 코딩
  agentic: { s: 50.7, z: 0.51, r: 57.6, estimated: false }  # 에이전트
  trust: { s: 75.3, z: 2.4, r: 86.0, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 36.0 t/s · TTFT 4.96s · 1M ctx` · 가성비 187.0
...
| 코딩 | 71.1 | +1.4 | 실측 | [[scicode]] 51.0%×1.0, [[terminal-bench]] 43.0%×0.5 |
| 에이전트 | 57.6 | +0.51 | 실측 | [[apex-agents]] 2.0%×1.0, [[gdpval]] 35.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
| 신뢰성 | 86.0 | +2.4 | 실측 | [[aa-omniscience]] 75.0%×1.0 |
| 멀티모달 | — | — | 측정 안 됨 | — |
