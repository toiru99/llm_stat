...
radar:
  ...
  agentic: { s: 51.0, z: 0.6, r: 59.0, estimated: false }  # 에이전트
  trust: { s: 84.9, z: 2.69, r: 90.4, estimated: false }  # 신뢰성
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $0.1765/1M · 59.0 t/s · TTFT 3.3s · 1M ctx` · 가성비 243.6
...
| 에이전트 | 59.0 | +0.6 | 실측 | [[apex-agents]] 2.0%×1.0, [[gdpval]] 38.0%×1.0, [[itbench]] 38.0%×1.0, [[tau2-bench]] 94.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 43.0%×1.0 |
