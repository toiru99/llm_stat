...
radar:
  ...
  agentic: { s: 52.0, z: 0.61, r: 59.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.43 · 출력 $0.87 · 혼합 $None/1M · 51.0 t/s · TTFT 3.16s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 59.2 | +0.62 | 실측 | [[aa-omniscience]] 23.0%×1.0, [[gpqa-diamond]] 87.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
