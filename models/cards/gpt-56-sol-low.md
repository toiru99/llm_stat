...
is_reasoning: true
radar:
  knowledge: { s: 88.5, z: 2.34, r: 85.2, estimated: false }  # 전문 지식
  reasoning: { s: 70.4, z: 1.97, r: 79.5, estimated: false }  # 추론
  coding: { s: 91.9, z: 1.96, r: 79.4, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 85.2 | +2.34 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 79.5 | +1.97 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
| 코딩 | 79.4 | +1.96 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
