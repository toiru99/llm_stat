...
is_reasoning: true
radar:
  knowledge: { s: 88.5, z: 2.31, r: 84.7, estimated: false }  # 전문 지식
  reasoning: { s: 70.4, z: 1.92, r: 78.9, estimated: false }  # 추론
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 54.0 t/s · TTFT 2.95s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 84.7 | +2.31 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 78.9 | +1.92 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
