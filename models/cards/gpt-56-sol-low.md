...
is_reasoning: true
radar:
  knowledge: { s: 88.5, z: 2.31, r: 84.6, estimated: false }  # 전문 지식
  reasoning: { s: 70.4, z: 1.92, r: 78.8, estimated: false }  # 추론
  coding: { s: 91.9, z: 1.91, r: 78.7, estimated: false }  # 코딩
  agentic: { s: 79.4, z: 1.67, r: 75.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 52.0 t/s · TTFT 3.21s · 1M ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 84.6 | +2.31 | 실측 | [[aa-omniscience]] 56.0%×1.0, [[gpqa-diamond]] 90.0%×0.4, [[humanitys-last-exam]] 37.0%×0.3 |
| 추론 | 78.8 | +1.92 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 37.0%×1.0 |
