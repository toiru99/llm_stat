...
radar:
  ...
  reasoning: { s: 70.5, z: 1.68, r: 75.1, estimated: false }  # 추론
  coding: { s: 91.9, z: 1.76, r: 76.4, estimated: false }  # 코딩
  agentic: { s: 74.1, z: 1.41, r: 71.1, estimated: false }  # 에이전트
...
| 추론 | 75.1 | +1.68 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 76.4 | +1.76 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
| 에이전트 | 71.1 | +1.41 | 실측 | [[gdpval]] 47.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 29.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
