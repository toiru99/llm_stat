...
radar:
  ...
  agentic: { s: 79.1, z: 1.66, r: 75.0, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 52.0 t/s · TTFT 3.44s · 1M ctx` · 가성비 11.3
...
| 에이전트 | 75.0 | +1.66 | 실측 | [[gdpval]] 47.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 24.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
