...
radar:
  ...
  reasoning: { s: 70.5, z: 1.69, r: 75.4, estimated: false }  # 추론
  coding: { s: 91.9, z: 1.77, r: 76.5, estimated: false }  # 코딩
  agentic: { s: 74.1, z: 1.43, r: 71.4, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 68.0 t/s · TTFT 2.83s · 1M ctx` · 가성비 11.7
...
| 추론 | 75.4 | +1.69 | 실측 | [[critpt]] 15.0%×1.0, [[gpqa-diamond]] 90.0%×1.0, [[humanitys-last-exam]] 39.0%×1.0 |
| 코딩 | 76.5 | +1.77 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
