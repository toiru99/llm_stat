...
radar:
  ...
  coding: { s: 91.9, z: 1.86, r: 77.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 68.0 t/s · TTFT 2.67s · 1M ctx` · 가성비 16.6
...
| 코딩 | 77.8 | +1.86 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
