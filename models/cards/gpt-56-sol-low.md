...
radar:
  ...
  coding: { s: 91.9, z: 1.87, r: 78.1, estimated: false }  # 코딩
  agentic: { s: 77.2, z: 1.59, r: 73.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 57.0 t/s · TTFT 3.06s · 1M ctx`
...
| 코딩 | 78.1 | +1.87 | 실측 | [[scicode]] 55.0%×1.0, [[terminal-bench]] 61.0%×0.5 |
| 에이전트 | 73.9 | +1.59 | 실측 | [[gdpval]] 47.0%×1.0, [[tau2-bench]] 76.0%×1.0, [[tau3-banking]] 24.0%×1.0, [[terminal-bench]] 61.0%×1.0 |
