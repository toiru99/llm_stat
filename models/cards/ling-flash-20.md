...
radar:
  ...
  coding: { s: 37.8, z: -0.35, r: 44.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.14 · 출력 $0.57 · 혼합 $0.18/1M · 72.0 t/s · TTFT 2.18s · 128k ctx` · 가성비 55.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.6 | -0.5 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
| 추론 | 43.6 | -0.42 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 66.0%×1.0, [[humanitys-last-exam]] 6.0%×1.0 |
| 코딩 | 44.8 | -0.35 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
