...
radar:
  ...
  coding: { s: 37.8, z: -0.36, r: 44.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.14 · 출력 $0.57 · 혼합 $0.18/1M · 71.0 t/s · TTFT 2.06s · 128k ctx` · 가성비 55.6
...
| 코딩 | 44.7 | -0.36 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
