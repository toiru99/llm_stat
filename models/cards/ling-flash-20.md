...
is_reasoning: false
radar:
  knowledge: { s: 30.1, z: -0.5, r: 42.4, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.14 · 출력 $0.57 · 혼합 $0.18/1M · 70.0 t/s · TTFT 1.58s · 128k ctx` · 가성비 55.6

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 42.4 | -0.5 | 실측 | [[aa-omniscience]] 14.0%×1.0, [[gpqa-diamond]] 66.0%×0.4, [[humanitys-last-exam]] 6.0%×0.3 |
