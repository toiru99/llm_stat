...
radar:
  ...
  coding: { s: 37.8, z: -0.36, r: 44.6, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.14 · 출력 $0.57 · 혼합 $None/1M · 58.0 t/s · TTFT 2.11s · 128k ctx`
...
| 코딩 | 44.6 | -0.36 | 실측 | [[scicode]] 29.0%×1.0, [[terminal-bench]] 11.0%×0.5 |
| 에이전트 | 39.9 | -0.68 | 실측 | [[tau2-bench]] 21.0%×1.0, [[terminal-bench]] 11.0%×1.0 |
