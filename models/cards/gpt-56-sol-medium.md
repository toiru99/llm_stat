...
radar:
  ...
  coding: { s: 90.3, z: 2.03, r: 80.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 77.0 t/s · TTFT 6.41s · 1M ctx` · 가성비 14.9
...
| 코딩 | 80.4 | +2.03 | 실측 | [[scicode]] 57.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
