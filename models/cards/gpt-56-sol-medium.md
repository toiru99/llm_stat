...
radar:
  ...
  reasoning: { s: 81.8, z: 2.4, r: 85.9, estimated: false }  # 추론
  coding: { s: 94.0, z: 1.95, r: 79.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 72.0 t/s · TTFT 6.03s · 1M ctx` · 가성비 18.2
...
| 추론 | 85.9 | +2.4 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 79.2 | +1.95 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
