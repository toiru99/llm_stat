...
radar:
  ...
  reasoning: { s: 81.9, z: 2.38, r: 85.8, estimated: false }  # 추론
  coding: { s: 94.0, z: 1.96, r: 79.3, estimated: false }  # 코딩
  agentic: { s: 82.9, z: 1.81, r: 77.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 64.0 t/s · TTFT 6.09s · 1M ctx` · 가성비 12.4

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.4 | +2.36 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 85.8 | +2.38 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 79.3 | +1.96 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 77.1 | +1.81 | 실측 | [[gdpval]] 53.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
