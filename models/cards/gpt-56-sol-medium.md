...
radar:
  ...
  reasoning: { s: 81.9, z: 2.58, r: 88.6, estimated: false }  # 추론
  coding: { s: 94.0, z: 2.05, r: 80.7, estimated: false }  # 코딩
...
|---|---|---|---|---|
| 전문 지식 | 87.2 | +2.48 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 93.0%×0.4, [[humanitys-last-exam]] 40.0%×0.3 |
| 추론 | 88.6 | +2.58 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 80.7 | +2.05 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
