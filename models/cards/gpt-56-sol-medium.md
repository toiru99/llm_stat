...
radar:
  ...
  reasoning: { s: 81.9, z: 2.38, r: 85.7, estimated: false }  # 추론
  coding: { s: 94.0, z: 1.96, r: 79.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $None/1M · 55.0 t/s · TTFT 4.57s · 1M ctx`
...
| 추론 | 85.7 | +2.38 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 40.0%×1.0 |
| 코딩 | 79.4 | +1.96 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
