...
radar:
  ...
  reasoning: { s: 80.1, z: 2.24, r: 83.6, estimated: false }  # 추론
  coding: { s: 92.0, z: 1.89, r: 78.3, estimated: false }  # 코딩
  agentic: { s: 80.7, z: 1.68, r: 75.2, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 67.0 t/s · TTFT 4.15s · 1M ctx` · 가성비 18.2
...
| 추론 | 83.6 | +2.24 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 78.3 | +1.89 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 75.2 | +1.68 | 실측 | [[gdpval]] 52.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 36.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
