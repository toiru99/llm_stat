...
radar:
  ...
  reasoning: { s: 81.8, z: 2.23, r: 83.5, estimated: false }  # 추론
  coding: { s: 94.0, z: 1.85, r: 77.7, estimated: false }  # 코딩
  agentic: { s: 81.4, z: 1.7, r: 75.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $4.0 · 출력 $20.0 · 혼합 $3.08/1M · 73.0 t/s · TTFT 4.69s · 1M ctx` · 가성비 18.2
...
| 추론 | 83.5 | +2.23 | 실측 | [[critpt]] 23.0%×1.0, [[gpqa-diamond]] 93.0%×1.0, [[humanitys-last-exam]] 42.0%×1.0 |
| 코딩 | 77.7 | +1.85 | 실측 | [[scicode]] 56.0%×1.0, [[terminal-bench]] 63.0%×0.5 |
| 에이전트 | 75.5 | +1.7 | 실측 | [[gdpval]] 52.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 36.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
