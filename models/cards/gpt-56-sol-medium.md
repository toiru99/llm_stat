...
radar:
  ...
  agentic: { s: 85.0, z: 1.91, r: 78.7, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $5.0 · 출력 $30.0 · 혼합 $4.35/1M · 55.0 t/s · TTFT 4.56s · 1M ctx` · 가성비 12.4
...
| 에이전트 | 78.7 | +1.91 | 실측 | [[gdpval]] 53.0%×1.0, [[tau2-bench]] 81.0%×1.0, [[tau3-banking]] 26.0%×1.0, [[terminal-bench]] 63.0%×1.0 |
