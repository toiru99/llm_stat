...
## 실용 지표
`입력 $0.45 · 출력 $2.25 · 혼합 $0.63/1M · 101.0 t/s · TTFT 2.73s · 262k ctx` · 가성비 22.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 40.7 | -0.62 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
| 추론 | 38.3 | -0.78 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 52.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 45.4 | -0.31 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 15.0%×0.5 |
| 에이전트 | 45.9 | -0.27 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
