...
is_reasoning: false
radar:
  knowledge: { s: 26.4, z: -0.72, r: 39.3, estimated: false }  # 전문 지식
  reasoning: { s: 18.3, z: -0.85, r: 37.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.45 · 출력 $2.25 · 혼합 $0.63/1M · 88.0 t/s · TTFT 2.61s · 262k ctx` · 가성비 22.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.3 | -0.72 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
...
| 에이전트 | 45.2 | -0.32 | 실측 | [[tau2-bench]] 35.0%×1.0, [[terminal-bench]] 15.0%×1.0 |
