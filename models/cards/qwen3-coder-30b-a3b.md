...
radar:
  ...
  reasoning: { s: 18.0, z: -0.82, r: 37.7, estimated: false }  # 추론
...
Alibaba · Open · Small(30.5B) · 컨텍스트 262k · 종합지능 **8.0** · ⚠️ past(구세대)
...
## 실용 지표
`입력 $0.45 · 출력 $2.25 · 혼합 $0.63/1M · 87.0 t/s · TTFT 2.59s · 262k ctx` · 가성비 12.7

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 39.5 | -0.7 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 52.0%×0.4, [[humanitys-last-exam]] 4.0%×0.3 |
