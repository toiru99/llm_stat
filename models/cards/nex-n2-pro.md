...
is_reasoning: true
radar:
  knowledge: { s: 64.3, z: 1.17, r: 67.6, estimated: false }  # 전문 지식
  reasoning: { s: 60.7, z: 1.33, r: 69.9, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.94, r: 64.1, estimated: false }  # 코딩
  agentic: { s: 58.1, z: 0.83, r: 62.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 132.0 t/s · TTFT 1.62s · 262k ctx` · 가성비 80.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.6 | +1.17 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 69.9 | +1.33 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 64.1 | +0.94 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 62.5 | +0.83 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
