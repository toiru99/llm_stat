...
radar:
  ...
  reasoning: { s: 60.6, z: 1.32, r: 69.7, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $None/1M · 127.0 t/s · TTFT 1.75s · 262k ctx`
...
| 추론 | 69.7 | +1.32 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 64.4 | +0.96 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 65.5 | +1.03 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 17.0%×1.0 |
