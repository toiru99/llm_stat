...
is_reasoning: true
radar:
  knowledge: { s: 64.2, z: 1.12, r: 66.9, estimated: false }  # 전문 지식
  reasoning: { s: 61.1, z: 1.3, r: 69.5, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.94, r: 64.1, estimated: false }  # 코딩
  agentic: { s: 69.0, z: 1.32, r: 69.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 135.0 t/s · TTFT 1.69s · 262k ctx` · 가성비 80.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.9 | +1.12 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 69.5 | +1.3 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 64.1 | +0.94 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 69.8 | +1.32 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0 |
