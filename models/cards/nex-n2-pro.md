...
is_reasoning: true
radar:
  knowledge: { s: 63.9, z: 1.08, r: 66.2, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 138.0 t/s · TTFT 1.61s · 262k ctx` · 가성비 80.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.2 | +1.08 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 68.5 | +1.23 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 63.3 | +0.89 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 62.3 | +0.82 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
