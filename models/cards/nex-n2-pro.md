...
is_reasoning: true
radar:
  knowledge: { s: 65.0, z: 1.12, r: 66.7, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $None/1M · 127.0 t/s · TTFT 1.63s · 262k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.7 | +1.12 | 실측 | [[aa-omniscience]] 34.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 32.0%×0.3 |
| 추론 | 69.7 | +1.31 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 64.3 | +0.96 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 65.4 | +1.03 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 17.0%×1.0 |
