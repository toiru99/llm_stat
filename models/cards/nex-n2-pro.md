...
radar:
  ...
  reasoning: { s: 60.6, z: 1.32, r: 69.8, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.97, r: 64.5, estimated: false }  # 코딩
  agentic: { s: 63.4, z: 1.05, r: 65.7, estimated: false }  # 에이전트
...
| 추론 | 69.8 | +1.32 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 64.5 | +0.97 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 65.7 | +1.05 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 17.0%×1.0 |
