...
radar:
  ...
  reasoning: { s: 60.7, z: 1.21, r: 68.1, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.87, r: 63.0, estimated: false }  # 코딩
  agentic: { s: 57.8, z: 0.79, r: 61.8, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 130.0 t/s · TTFT 1.56s · 262k ctx` · 가성비 80.0
...
| 추론 | 68.1 | +1.21 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 63.0 | +0.87 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 61.8 | +0.79 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
