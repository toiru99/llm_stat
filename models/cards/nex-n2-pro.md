...
is_reasoning: true
radar:
  knowledge: { s: 62.6, z: 1.08, r: 66.3, estimated: false }  # 전문 지식
  reasoning: { s: 59.3, z: 1.21, r: 68.2, estimated: false }  # 추론
  coding: { s: 67.7, z: 0.87, r: 63.0, estimated: false }  # 코딩
  agentic: { s: 57.3, z: 0.77, r: 61.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 136.0 t/s · TTFT 1.71s · 262k ctx` · 가성비 80.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 66.3 | +1.08 | 실측 | [[aa-omniscience]] 35.0%×1.0, [[gpqa-diamond]] 89.0%×0.4, [[humanitys-last-exam]] 34.0%×0.3 |
| 추론 | 68.2 | +1.21 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 63.0 | +0.87 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 61.5 | +0.77 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 18.0%×1.0 |
