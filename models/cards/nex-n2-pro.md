...
radar:
  ...
  reasoning: { s: 60.7, z: 1.24, r: 68.6, estimated: false }  # 추론
  coding: { s: 70.0, z: 0.89, r: 63.4, estimated: false }  # 코딩
  agentic: { s: 69.0, z: 1.27, r: 69.1, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.525/1M · 140.0 t/s · TTFT 1.68s · 262k ctx` · 가성비 80.0
...
| 추론 | 68.6 | +1.24 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 34.0%×1.0 |
| 코딩 | 63.4 | +0.89 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 69.1 | +1.27 | 실측 | [[gdpval]] 37.0%×1.0, [[tau2-bench]] 82.0%×1.0 |
