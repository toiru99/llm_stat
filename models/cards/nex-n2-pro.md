...
radar:
  ...
  reasoning: { s: 60.6, z: 1.41, r: 71.2, estimated: false }  # 추론
...
## 실용 지표
`입력 $0.5 · 출력 $2.5 · 혼합 $0.53/1M · 139.0 t/s · TTFT 1.63s · 262k ctx` · 가성비 77.4
...
| 추론 | 71.2 | +1.41 | 실측 | [[critpt]] 9.0%×1.0, [[gpqa-diamond]] 89.0%×1.0, [[humanitys-last-exam]] 32.0%×1.0 |
| 코딩 | 65.0 | +1.0 | 실측 | [[scicode]] 42.0%×1.0 |
| 에이전트 | 66.7 | +1.11 | 실측 | [[gdpval]] 38.0%×1.0, [[tau2-bench]] 82.0%×1.0, [[tau3-banking]] 17.0%×1.0 |
