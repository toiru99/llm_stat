...
radar:
  ...
  reasoning: { s: 42.1, z: 0.38, r: 55.7, estimated: false }  # 추론
  coding: { s: 53.4, z: 0.28, r: 54.2, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 142.0 t/s · TTFT 1.93s · 1M ctx` · 가성비 100.0
...
| 추론 | 55.7 | +0.38 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 54.2 | +0.28 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
