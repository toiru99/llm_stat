...
radar:
  ...
  reasoning: { s: 42.1, z: 0.36, r: 55.4, estimated: false }  # 추론
  coding: { s: 53.4, z: 0.26, r: 54.0, estimated: false }  # 코딩
  agentic: { s: 24.8, z: -0.49, r: 42.6, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 142.0 t/s · TTFT 2.23s · 1M ctx` · 가성비 100.0

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 54.4 | +0.29 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 80.0%×0.4, [[humanitys-last-exam]] 21.0%×0.3 |
| 추론 | 55.4 | +0.36 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 54.0 | +0.26 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
| 에이전트 | 42.6 | -0.49 | 실측 | [[apex-agents]] 2.0%×1.0, [[gdpval]] 10.0%×1.0, [[itbench]] 1.0%×1.0, [[tau2-bench]] 68.0%×1.0, [[tau3-banking]] 10.0%×1.0, [[terminal-bench]] 29.0%×1.0 |
