...
radar:
  ...
  reasoning: { s: 42.9, z: 0.35, r: 55.3, estimated: false }  # 추론
  coding: { s: 54.6, z: 0.25, r: 53.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.2 · 출력 $0.8 · 혼합 $0.26/1M · 143.0 t/s · TTFT 1.78s · 1M ctx` · 가성비 100.0
...
| 추론 | 55.3 | +0.35 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 80.0%×1.0, [[humanitys-last-exam]] 21.0%×1.0 |
| 코딩 | 53.7 | +0.25 | 실측 | [[scicode]] 36.0%×1.0, [[terminal-bench]] 29.0%×0.5 |
