...
is_reasoning: true
radar:
  knowledge: { s: 65.4, z: 1.19, r: 67.8, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $None/1M · 83.0 t/s · TTFT 41.52s · 400k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 67.8 | +1.19 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 23.0%×0.3 |
