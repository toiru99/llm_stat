...
radar:
  ...
  reasoning: { s: 42.8, z: 0.4, r: 56.0, estimated: false }  # 추론
  coding: { s: 63.3, z: 0.68, r: 60.2, estimated: false }  # 코딩
  agentic: { s: 72.7, z: 1.37, r: 70.5, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $1.25 · 출력 $10.0 · 혼합 $1.3375/1M · 72.0 t/s · TTFT 36.57s · 400k ctx` · 가성비 26.2

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 65.8 | +1.05 | 실측 | [[aa-omniscience]] 39.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 25.0%×0.3 |
...
| 에이전트 | 70.5 | +1.37 | 실측 | [[tau2-bench]] 87.0%×1.0, [[terminal-bench]] 38.0%×1.0 |
