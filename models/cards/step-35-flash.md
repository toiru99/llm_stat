...
is_reasoning: true
radar:
  knowledge: { s: 49.1, z: 0.37, r: 55.5, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 241.0 t/s · TTFT 1.11s · 256k ctx`

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 55.5 | +0.37 | 실측 | [[aa-omniscience]] 24.0%×1.0, [[gpqa-diamond]] 83.0%×0.4, [[humanitys-last-exam]] 19.0%×0.3 |
