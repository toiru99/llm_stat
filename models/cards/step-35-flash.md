...
radar:
  ...
  coding: { s: 58.1, z: 0.49, r: 57.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $0.1 · 출력 $0.3 · 혼합 $None/1M · 293.0 t/s · TTFT 1.0s · 256k ctx`
...
| 코딩 | 57.4 | +0.49 | 실측 | [[scicode]] 40.0%×1.0, [[terminal-bench]] 27.0%×0.5 |
