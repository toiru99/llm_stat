...
radar:
  ...
  reasoning: { s: 91.4, z: 2.86, r: 92.9, estimated: false }  # 추론
  coding: { s: 85.0, z: 1.58, r: 73.7, estimated: false }  # 코딩
  agentic: { s: 84.6, z: 1.87, r: 78.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 75.3, z: 0.91, r: 63.7, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $None/1M · 50.0 t/s · TTFT 5.21s · 1M ctx`
...
| 추론 | 92.9 | +2.86 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 49.0%×1.0 |
| 코딩 | 73.7 | +1.58 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 78.0 | +1.87 | 실측 | [[gdpval]] 57.0%×1.0, [[tau3-banking]] 29.0%×1.0 |
