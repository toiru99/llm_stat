...
radar:
  ...
  instruction: { s: 79.4, z: 1.02, r: 65.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 53.0 t/s · TTFT 6.75s · 1M ctx` · 가성비 15.3
...
| 에이전트 | 75.5 | +1.7 | 실측 | [[gdpval]] 56.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
