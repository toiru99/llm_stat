...
is_reasoning: true
radar:
  knowledge: { s: 88.0, z: 2.33, r: 85.0, estimated: false }  # 전문 지식
  reasoning: { s: 89.0, z: 2.68, r: 90.2, estimated: false }  # 추론
  coding: { s: 82.3, z: 1.48, r: 72.2, estimated: false }  # 코딩
  agentic: { s: 78.7, z: 1.6, r: 74.0, estimated: false }  # 에이전트
  ...
  instruction: { s: 78.6, z: 1.07, r: 66.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 51.0 t/s · TTFT 4.54s · 1M ctx` · 가성비 15.3
...
| 에이전트 | 74.0 | +1.6 | 실측 | [[gdpval]] 56.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
