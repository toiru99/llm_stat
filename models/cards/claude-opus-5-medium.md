...
is_reasoning: true
radar:
  knowledge: { s: 90.6, z: 2.48, r: 87.2, estimated: false }  # 전문 지식
  reasoning: { s: 91.1, z: 2.86, r: 92.9, estimated: false }  # 추론
  coding: { s: 85.0, z: 1.57, r: 73.5, estimated: false }  # 코딩
  agentic: { s: 80.7, z: 1.72, r: 75.8, estimated: false }  # 에이전트
  ...
  instruction: { s: 77.1, z: 1.04, r: 65.6, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 53.0 t/s · TTFT 6.61s · 1M ctx` · 가성비 15.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 87.2 | +2.48 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 51.0%×0.3 |
| 추론 | 92.9 | +2.86 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 51.0%×1.0 |
| 코딩 | 73.5 | +1.57 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 75.8 | +1.72 | 실측 | [[gdpval]] 56.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
