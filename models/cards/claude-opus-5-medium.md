...
is_reasoning: true
radar:
  knowledge: { s: 90.5, z: 2.34, r: 85.1, estimated: false }  # 전문 지식
  reasoning: { s: 91.1, z: 2.73, r: 91.0, estimated: false }  # 추론
  ...
  instruction: { s: 77.8, z: 0.96, r: 64.4, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $5.0 · 출력 $25.0 · 혼합 $3.85/1M · 55.0 t/s · TTFT 4.93s · 1M ctx` · 가성비 15.3

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 85.1 | +2.34 | 실측 | [[aa-omniscience]] 57.0%×1.0, [[gpqa-diamond]] 92.0%×0.4, [[humanitys-last-exam]] 51.0%×0.3 |
| 추론 | 91.0 | +2.73 | 실측 | [[critpt]] 27.0%×1.0, [[gpqa-diamond]] 92.0%×1.0, [[humanitys-last-exam]] 51.0%×1.0 |
| 코딩 | 72.6 | +1.51 | 실측 | [[scicode]] 51.0%×1.0 |
| 에이전트 | 75.7 | +1.71 | 실측 | [[gdpval]] 56.0%×1.0, [[tau3-banking]] 39.0%×1.0 |
