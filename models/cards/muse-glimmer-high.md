...
radar:
  ...
  instruction: { s: 82.3, z: 1.13, r: 67.0, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.32 · 출력 $1.35 · 혼합 $0.228/1M · 107.0 t/s · TTFT 0.81s · 131k ctx` · 가성비 153.5
...
| 추론 | 56.7 | +0.45 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 65.0 | +1.0 | 실측 | [[scicode]] 44.0%×1.0 |
| 에이전트 | 51.9 | +0.13 | 실측 | [[gdpval]] 23.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
