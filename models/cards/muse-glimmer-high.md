...
is_reasoning: true
radar:
  knowledge: { s: 50.6, z: 0.51, r: 57.7, estimated: false }  # 전문 지식
  reasoning: { s: 44.2, z: 0.49, r: 57.3, estimated: false }  # 추론
  coding: { s: 71.0, z: 1.03, r: 65.4, estimated: false }  # 코딩
  agentic: { s: 40.4, z: 0.13, r: 51.9, estimated: false }  # 에이전트
...
## 실용 지표
`입력 $0.32 · 출력 $1.35 · 혼합 $0.228/1M · 106.0 t/s · TTFT 0.82s · 131k ctx` · 가성비 153.5
...
| 추론 | 57.3 | +0.49 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
