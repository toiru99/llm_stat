...
radar:
  ...
  instruction: { s: 82.3, z: 1.26, r: 68.8, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
...
## 실용 지표
`입력 $0.32 · 출력 $1.35 · 혼합 $0.228/1M · 97.0 t/s · TTFT 0.9s · 131k ctx` · 가성비 153.5
...
| 추론 | 58.0 | +0.54 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
