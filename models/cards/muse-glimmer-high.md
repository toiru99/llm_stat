...
is_reasoning: true
radar:
  knowledge: { s: 51.2, z: 0.48, r: 57.1, estimated: false }  # 전문 지식
...
## 실용 지표
`입력 $0.32 · 출력 $1.35 · 혼합 $0.228/1M · 113.0 t/s · TTFT 0.8s · 131k ctx` · 가성비 153.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 57.1 | +0.48 | 실측 | [[aa-omniscience]] 27.0%×1.0, [[gpqa-diamond]] 84.0%×0.4, [[humanitys-last-exam]] 22.0%×0.3 |
| 추론 | 57.1 | +0.47 | 실측 | [[critpt]] 3.0%×1.0, [[gpqa-diamond]] 84.0%×1.0, [[humanitys-last-exam]] 22.0%×1.0 |
| 코딩 | 65.3 | +1.02 | 실측 | [[scicode]] 44.0%×1.0 |
| 에이전트 | 52.3 | +0.15 | 실측 | [[gdpval]] 23.0%×1.0, [[tau3-banking]] 24.0%×1.0 |
