...
is_reasoning: false
radar:
  knowledge: { s: 28.1, z: -0.6, r: 41.1, estimated: false }  # 전문 지식
  reasoning: { s: 19.6, z: -0.73, r: 39.0, estimated: false }  # 추론
  coding: { s: 31.6, z: -0.61, r: 40.8, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $3.25/1M · 58.0 t/s · TTFT 1.65s · 256k ctx` · 가성비 2.5

## 레이더 8축 (평균=50 기준선)

| 축 | 점수(r) | 평균대비(z) | 상태 | 구성 벤치마크(raw%) |
|---|---|---|---|---|
| 전문 지식 | 41.1 | -0.6 | 실측 | [[aa-omniscience]] 16.0%×1.0, [[gpqa-diamond]] 53.0%×0.4, [[humanitys-last-exam]] 5.0%×0.3 |
| 추론 | 39.0 | -0.73 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 5.0%×1.0 |
| 코딩 | 40.8 | -0.61 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
