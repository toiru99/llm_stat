...
is_reasoning: false
radar:
  knowledge: { s: 26.9, z: -0.67, r: 40.0, estimated: false }  # 전문 지식
  reasoning: { s: 18.6, z: -0.8, r: 38.1, estimated: false }  # 추론
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $3.25/1M · 64.0 t/s · TTFT 1.63s · 256k ctx` · 가성비 2.2
...
| 추론 | 38.1 | -0.8 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
