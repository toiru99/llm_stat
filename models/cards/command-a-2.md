...
radar:
  ...
  coding: { s: 31.6, z: -0.68, r: 39.7, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $3.25/1M · 55.0 t/s · TTFT 1.86s · 256k ctx` · 가성비 2.2
...
| 코딩 | 39.7 | -0.68 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
