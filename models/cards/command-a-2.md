...
radar:
  ...
  reasoning: { s: 18.7, z: -0.83, r: 37.5, estimated: false }  # 추론
  coding: { s: 31.6, z: -0.7, r: 39.4, estimated: false }  # 코딩
...
## 실용 지표
`입력 $2.5 · 출력 $10.0 · 혼합 $3.25/1M · 63.0 t/s · TTFT 1.56s · 256k ctx` · 가성비 2.2
...
| 추론 | 37.5 | -0.83 | 실측 | [[critpt]] 0.0%×1.0, [[gpqa-diamond]] 53.0%×1.0, [[humanitys-last-exam]] 4.0%×1.0 |
| 코딩 | 39.4 | -0.7 | 실측 | [[scicode]] 28.0%×1.0, [[terminal-bench]] 1.0%×0.5 |
