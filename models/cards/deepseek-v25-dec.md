...
radar:
  ...
  agentic: { s: 46.4, z: 0.35, r: 55.3, estimated: true }  # 에이전트
  trust: { s: 49.3, z: 0.86, r: 62.9, estimated: true }  # 신뢰성
  multimodal: { s: null, z: null, r: null, estimated: false }  # 멀티모달
  long_context: { s: 51.3, z: 0.01, r: 50.2, estimated: true }  # 긴문맥
  instruction: { s: 57.8, z: 0.14, r: 52.1, estimated: true }  # 지시 따르기
sources:
  - type: leaderboard
